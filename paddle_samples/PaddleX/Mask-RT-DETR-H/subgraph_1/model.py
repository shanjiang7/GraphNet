...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        del parameter_19, reshape_3

        # pd_op.add: (1x-1x512xf32) <- (1x-1x512xf32, 512xf32)
        add_4 = paddle._C_ops.add(matmul_5, parameter_18)
        del matmul_5, parameter_18
        ...
        del add_5, parameter_16, parameter_17
        ...
        del gelu_0, parameter_13

        # pd_op.add: (1x-1x512xf32) <- (1x-1x512xf32, 512xf32)
        add_7 = paddle._C_ops.add(matmul_7, parameter_12)
        del matmul_7, parameter_12
        ...
        del add_8, parameter_10, parameter_11
        ...
        del add_14, parameter_6, parameter_7
        ...
        del add_17, parameter_0, parameter_1
