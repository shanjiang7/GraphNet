...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x256x84x84xf32) <- (1x512x84x84xf32, 256x512x1x1xf32)
        ...
        # pd_op.conv2d: (1x256x42x42xf32) <- (1x512x42x42xf32, 256x512x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            data_14, parameter_153, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_14, parameter_153

        # pd_op.batch_norm_: (1x256x42x42xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (1x256x42x42xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.conv2d: (1x256x21x21xf32) <- (1x512x21x21xf32, 256x512x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            data_15, parameter_148, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_15, parameter_148

        # pd_op.batch_norm_: (1x256x21x21xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (1x256x21x21xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.flatten: (1x256x7056xf32) <- (1x256x84x84xf32)
        flatten_0 = paddle._C_ops.flatten(batch_norm__0, 2, 3)

        # pd_op.transpose: (1x7056x256xf32) <- (1x256x7056xf32)
        transpose_0 = paddle._C_ops.transpose(flatten_0, [0, 2, 1])
        del flatten_0

        # pd_op.flatten: (1x256x1764xf32) <- (1x256x42x42xf32)
        flatten_1 = paddle._C_ops.flatten(batch_norm__6, 2, 3)

        # pd_op.transpose: (1x1764x256xf32) <- (1x256x1764xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_1, [0, 2, 1])
        del flatten_1

        # pd_op.flatten: (1x256x441xf32) <- (1x256x21x21xf32)
        flatten_2 = paddle._C_ops.flatten(batch_norm__12, 2, 3)

        # pd_op.transpose: (1x441x256xf32) <- (1x256x441xf32)
        ...
        # builtin.combine: ([1x7056x256xf32, 1x1764x256xf32, 1x441x256xf32]) <- (1x7056x256xf32, 1x1764x256xf32, 1x441x256xf32)
        combine_0 = [transpose_0, transpose_1, transpose_2]

        # pd_op.concat: (1x9261x256xf32) <- ([1x7056x256xf32, 1x1764x256xf32, 1x441x256xf32], 1xi32)
        ...
        # pd_op.full_like: (1x9261x256xf32) <- (1x9261x256xf32, 1xf32)
        ...
        # pd_op.add: (1x9261x256xf32) <- (1x9261x256xf32, xf32)
        add_8 = paddle._C_ops.add(full_like_6, full_like_7)
        del full_like_6, full_like_7

        # pd_op.add: (1x9261x256xf32) <- (1x9261x256xf32, 1x9261x1xf32)
        add_9 = paddle._C_ops.add(add_8, cast_8)
        del add_8, cast_8

        # pd_op.add: (1x9261x256xf32) <- (1x9261x256xf32, 1x9261x256xf32)
        add_10 = paddle._C_ops.add(concat_0, add_9)

        # pd_op.add: (1x9261x256xf32) <- (xf32, 1x9261x256xf32)
        add_11 = paddle._C_ops.add(assign_value__4, add_9)
        del assign_value__4

        # pd_op.add: (1x9261x256xf32) <- (1x9261x1xf32, 1x9261x256xf32)
        add_12 = paddle._C_ops.add(cast_9, add_9)
        del cast_9

        # pd_op.cast: (1x9261x256xb) <- (1x9261x256xf32)
        cast_10 = paddle._C_ops.cast(add_12, paddle.bool)
        del add_12

        # pd_op.where: (1x9261x256xf32) <- (1x9261x256xb, 1x9261x256xf32, 1x9261x256xf32)
        ...
        # pd_op.layer_norm: (1x9261x256xf32, 1x9261xf32, 1x9261xf32) <- (1x9261x256xf32, 256xf32, 256xf32)
        ...
        # pd_op.matmul: (1x9261x2xf32) <- (1x9261x256xf32, 256x2xf32)
        matmul_1 = paddle._C_ops.matmul(layer_norm_0, parameter_139, False, False)

        # pd_op.add: (1x9261x2xf32) <- (1x9261x2xf32, 2xf32)
        ...
        # pd_op.relu: (1x9261x256xf32) <- (1x9261x256xf32)
        ...
        # pd_op.topk: (1x300xf32, 1x300xi64) <- (1x9261xf32, 1xi32)
        ...
        # pd_op.gather_nd: (1x300x256xf32) <- (1x9261x256xf32, 1x300x2xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(layer_norm_0, stack_7)

        # pd_op.gather_nd: (1x300x4xf32) <- (1x9261x4xf32, 1x300x2xi64)
        ...
        # pd_op.flatten: (1x128x28224xf32) <- (1x128x168x168xf32)
        flatten_6 = paddle._C_ops.flatten(data_16, 2, 3)
        del data_16

        # pd_op.assign: (1x128x28224xf32) <- (1x128x28224xf32)
        ...
        # pd_op.bmm: (1x300x28224xf32) <- (1x300x128xf32, 1x128x28224xf32)
        bmm_0 = paddle._C_ops.bmm(add_21, flatten_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_413 = [1, 300, 168, 168]

        # pd_op.reshape: (1x300x168x168xf32) <- (1x300x28224xf32, 4xi64)
        ...
        # pd_op.greater_than: (1x300x168x168xb) <- (1x300x168x168xf32, xf32)
        ...
        # pd_op.cast: (1x300x168x168xf32) <- (1x300x168x168xb)
        cast_11 = paddle._C_ops.cast(greater_than_1, paddle.float32)

        # pd_op.multiply: (1x300x168x168xf32) <- (168x168xf32, 1x300x168x168xf32)
        multiply_3 = paddle._C_ops.multiply(split_9, cast_11)
        del cast_11, split_9

        # pd_op.flatten: (1x300x28224xf32) <- (1x300x168x168xf32)
        flatten_7 = paddle._C_ops.flatten(multiply_3, 2, 3)

        # pd_op.max: (1x300xf32) <- (1x300x28224xf32, 1xi64)
        ...
        # pd_op.full_like: (1x300x168x168xf32) <- (1x300x168x168xf32, 1xf32)
        ...
        # pd_op.full_like: (1x300x168x168xb) <- (1x300x168x168xb, 1xf32)
        ...
        # pd_op.add: (1x300x168x168xf32) <- (1x300x168x168xf32, xf32)
        add_22 = paddle._C_ops.add(full_like_9, full_like_10)
        del full_like_10, full_like_9

        # pd_op.add: (1x300x168x168xf32) <- (1x300x168x168xf32, 1x300x168x168xf32)
        ...
        # pd_op.add: (1x300x168x168xf32) <- (xf32, 1x300x168x168xf32)
        ...
        # pd_op.cast: (1x300x168x168xb) <- (1x300x168x168xf32)
        cast_14 = paddle._C_ops.cast(add_26, paddle.bool)
        del add_26

        # pd_op.where: (1x300x168x168xf32) <- (1x300x168x168xb, 1x300x168x168xf32, 1x300x168x168xf32)
        ...
        # pd_op.min: (1x300xf32) <- (1x300x28224xf32, 1xi64)
        ...
        # pd_op.any: (1x300xb) <- (1x300x168x168xb)
        ...
        # pd_op.bmm: (1x400x28224xf32) <- (1x400x128xf32, 1x128x28224xf32)
        bmm_1 = paddle._C_ops.bmm(add_36, flatten_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_414 = [1, 400, 168, 168]

        # pd_op.reshape: (1x400x168x168xf32) <- (1x400x28224xf32, 4xi64)
        ...
        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_419 = [1, 9261, 8, 32]
        ...
        # builtin.combine: ([1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32]) <- (1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32)
        combine_52 = [
            reshape_21,
            reshape_35,
            reshape_49,
        ...
        # pd_op.stack: (6x1x400x168x168xf32) <- ([1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32, 1x400x168x168xf32])
