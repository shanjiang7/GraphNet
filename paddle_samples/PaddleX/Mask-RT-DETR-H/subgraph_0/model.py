...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (361x128xf32) <- (361x1xf32, 1x128xf32)
        ...
        # pd_op.sin: (361x128xf32) <- (361x128xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (361x128xf32) <- (361x128xf32)
        ...
        # builtin.combine: ([361x128xf32, 361x128xf32, 361x128xf32, 361x128xf32]) <- (361x128xf32, 361x128xf32, 361x128xf32, 361x128xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]
        del cos_0, cos_1, sin_0, sin_1

        # pd_op.concat: (361x512xf32) <- ([361x128xf32, 361x128xf32, 361x128xf32, 361x128xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.unsqueeze: (1x361x512xf32) <- (361x512xf32, 1xi64)
