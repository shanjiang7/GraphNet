...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_359, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_359
        ...
        conv2d_1 = paddle._C_ops.conv2d(
            relu_0, parameter_354, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_354
        ...
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_349, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_349
        ...
        conv2d_3 = paddle._C_ops.conv2d(
            pool2d_0, parameter_344, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_344
        ...
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_339, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_339
        ...
        conv2d_5 = paddle._C_ops.conv2d(
            relu_4, parameter_334, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_334
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            pool2d_0, parameter_329, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_329
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            relu_5, parameter_324, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_324
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            relu_6, parameter_319, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_319
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_7, parameter_314, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_314
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_8, parameter_309, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_309
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            relu_9, parameter_304, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_304
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            relu_10, parameter_299, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_299
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            relu_11, parameter_294, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_294
        ...
        conv2d_14 = paddle._C_ops.conv2d(
            relu_12, parameter_289, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_289
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            relu_13, parameter_284, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_284
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            pool2d_1, parameter_279, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_279
        ...
        conv2d_17 = paddle._C_ops.conv2d(
            relu_14, parameter_274, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_274
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            relu_15, parameter_269, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_269
        ...
        conv2d_20 = paddle._C_ops.conv2d(
            relu_17, parameter_259, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_259
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            relu_18, parameter_254, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_254
        ...
        conv2d_22 = paddle._C_ops.conv2d(
            relu_19, parameter_249, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_249
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            relu_20, parameter_244, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_244
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            relu_21, parameter_239, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_239
        ...
        conv2d_25 = paddle._C_ops.conv2d(
            relu_22, parameter_234, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_234
        ...
        conv2d_26 = paddle._C_ops.conv2d(
            relu_23, parameter_229, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_229
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            relu_24, parameter_224, [1, 1], [2, 2], "EXPLICIT", [2, 2], 1, "NCHW"
        )
        del parameter_224
        ...
        conv2d_28 = paddle._C_ops.conv2d(
            relu_25, parameter_219, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_219
        ...
        conv2d_29 = paddle._C_ops.conv2d(
            relu_23, parameter_214, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_214
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            relu_26, parameter_209, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_209
        ...
        conv2d_31 = paddle._C_ops.conv2d(
            relu_27, parameter_204, [1, 1], [2, 2], "EXPLICIT", [2, 2], 1, "NCHW"
        )
        del parameter_204
        ...
        conv2d_32 = paddle._C_ops.conv2d(
            relu_28, parameter_199, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_199
        ...
        conv2d_33 = paddle._C_ops.conv2d(
            relu_29, parameter_194, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_194
        ...
        conv2d_34 = paddle._C_ops.conv2d(
            relu_30, parameter_189, [1, 1], [2, 2], "EXPLICIT", [2, 2], 1, "NCHW"
        )
        del parameter_189
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            relu_32, parameter_179, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_179
        ...
        conv2d_37 = paddle._C_ops.conv2d(
            relu_33, parameter_174, [1, 1], [2, 2], "EXPLICIT", [2, 2], 1, "NCHW"
        )
        del parameter_174
        ...
        conv2d_38 = paddle._C_ops.conv2d(
            relu_34, parameter_169, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_169
        ...
        conv2d_39 = paddle._C_ops.conv2d(
            relu_35, parameter_164, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_164
        ...
        conv2d_40 = paddle._C_ops.conv2d(
            relu_36, parameter_159, [1, 1], [2, 2], "EXPLICIT", [2, 2], 1, "NCHW"
        )
        del parameter_159
        ...
        conv2d_41 = paddle._C_ops.conv2d(
            relu_37, parameter_154, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_154
        ...
        conv2d_42 = paddle._C_ops.conv2d(
            relu_38, parameter_149, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_149
        ...
        conv2d_43 = paddle._C_ops.conv2d(
            relu_39, parameter_144, [1, 1], [2, 2], "EXPLICIT", [2, 2], 1, "NCHW"
        )
        del parameter_144
        ...
        conv2d_44 = paddle._C_ops.conv2d(
            relu_40, parameter_139, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_139
        ...
        conv2d_45 = paddle._C_ops.conv2d(
            relu_41, parameter_134, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_134
        ...
        conv2d_46 = paddle._C_ops.conv2d(
            relu_42, parameter_129, [1, 1], [4, 4], "EXPLICIT", [4, 4], 1, "NCHW"
        )
        del parameter_129
        ...
        conv2d_47 = paddle._C_ops.conv2d(
            relu_43, parameter_124, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_124
        ...
        conv2d_48 = paddle._C_ops.conv2d(
            relu_41, parameter_119, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_119
        ...
        conv2d_49 = paddle._C_ops.conv2d(
            relu_44, parameter_114, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_114
        ...
        conv2d_50 = paddle._C_ops.conv2d(
            relu_45, parameter_109, [1, 1], [8, 8], "EXPLICIT", [8, 8], 1, "NCHW"
        )
        del parameter_109
        ...
        conv2d_51 = paddle._C_ops.conv2d(
            relu_46, parameter_104, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_104
        ...
        conv2d_52 = paddle._C_ops.conv2d(
            relu_47, parameter_99, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_99
        ...
        conv2d_53 = paddle._C_ops.conv2d(
            relu_48, parameter_94, [1, 1], [16, 16], "EXPLICIT", [16, 16], 1, "NCHW"
        )
        del parameter_94
        ...
        conv2d_54 = paddle._C_ops.conv2d(
            relu_49, parameter_89, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_89
        ...
        conv2d_55 = paddle._C_ops.conv2d(
            relu_50, parameter_84, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_84
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_50, parameter_78, [1, 1], [12, 12], "EXPLICIT", 2048, [12, 12], "NCHW"
        )
        del parameter_78
        ...
        add_17 = paddle._C_ops.add(depthwise_conv2d_0, reshape_1)
        ...
        conv2d_56 = paddle._C_ops.conv2d(
            batch_norm__336, parameter_72, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        del parameter_72
        ...
        # pd_op.add: (2x256x64x128xf32) <- (2x256x64x128xf32, 1x256x1x1xf32)
        add_18 = paddle._C_ops.add(conv2d_56, reshape_2)
        ...
        # pd_op.relu: (2x256x64x128xf32) <- (2x256x64x128xf32)
        relu_52 = paddle._C_ops.relu(batch_norm__342)
        del batch_norm__342

        # pd_op.depthwise_conv2d: (2x2048x64x128xf32) <- (2x2048x64x128xf32, 2048x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_50, parameter_66, [1, 1], [24, 24], "EXPLICIT", 2048, [24, 24], "NCHW"
        )
        del parameter_66
        ...
        # pd_op.add: (2x2048x64x128xf32) <- (2x2048x64x128xf32, 1x2048x1x1xf32)
        add_19 = paddle._C_ops.add(depthwise_conv2d_1, reshape_3)
        ...
        conv2d_57 = paddle._C_ops.conv2d(
            batch_norm__348, parameter_60, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        del parameter_60
        ...
        # pd_op.add: (2x256x64x128xf32) <- (2x256x64x128xf32, 1x256x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_57, reshape_4)
        ...
        # pd_op.relu: (2x256x64x128xf32) <- (2x256x64x128xf32)
        relu_53 = paddle._C_ops.relu(batch_norm__354)
        del batch_norm__354

        # pd_op.depthwise_conv2d: (2x2048x64x128xf32) <- (2x2048x64x128xf32, 2048x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_50, parameter_54, [1, 1], [36, 36], "EXPLICIT", 2048, [36, 36], "NCHW"
        )
        del parameter_54
        ...
        # pd_op.add: (2x2048x64x128xf32) <- (2x2048x64x128xf32, 1x2048x1x1xf32)
        add_21 = paddle._C_ops.add(depthwise_conv2d_2, reshape_5)
        ...
        conv2d_58 = paddle._C_ops.conv2d(
            batch_norm__360, parameter_48, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        del parameter_48
        ...
        # pd_op.add: (2x256x64x128xf32) <- (2x256x64x128xf32, 1x256x1x1xf32)
        add_22 = paddle._C_ops.add(conv2d_58, reshape_6)
        ...
        # pd_op.relu: (2x256x64x128xf32) <- (2x256x64x128xf32)
        relu_54 = paddle._C_ops.relu(batch_norm__366)
        del batch_norm__366
        ...
        relu_55 = paddle._C_ops.relu(batch_norm__372)
        del batch_norm__372
        ...
        # pd_op.add: (2x256x64x128xf32) <- (2x256x64x128xf32, 1x256x1x1xf32)
        add_23 = paddle._C_ops.add(conv2d_60, reshape_7)
        ...
        # pd_op.relu: (2x256x64x128xf32) <- (2x256x64x128xf32)
        relu_56 = paddle._C_ops.relu(batch_norm__378)
        del batch_norm__378
        ...
        add_24 = paddle._C_ops.add(conv2d_61, reshape_8)
        ...
        relu_57 = paddle._C_ops.relu(batch_norm__384)
        del batch_norm__384
        ...
        combine_1 = [bilinear_interp_2, relu_57]
        ...
        add_25 = paddle._C_ops.add(depthwise_conv2d_3, reshape_9)
        ...
        conv2d_62 = paddle._C_ops.conv2d(
            batch_norm__390, parameter_19, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        del parameter_19
        ...
        add_26 = paddle._C_ops.add(conv2d_62, reshape_10)
        ...
        # pd_op.relu: (2x256x128x256xf32) <- (2x256x128x256xf32)
        relu_58 = paddle._C_ops.relu(batch_norm__396)
        del batch_norm__396
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu_58, parameter_13, [1, 1], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_13
        ...
        # pd_op.add: (2x256x128x256xf32) <- (2x256x128x256xf32, 1x256x1x1xf32)
        add_27 = paddle._C_ops.add(depthwise_conv2d_4, reshape_11)
        ...
        conv2d_63 = paddle._C_ops.conv2d(
            batch_norm__402, parameter_7, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        del parameter_7
        ...
        # pd_op.add: (2x256x128x256xf32) <- (2x256x128x256xf32, 1x256x1x1xf32)
        add_28 = paddle._C_ops.add(conv2d_63, reshape_12)
