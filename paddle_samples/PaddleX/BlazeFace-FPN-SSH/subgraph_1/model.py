...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.relu: (4x24x320x320xf32) <- (4x24x320x320xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__6)
        del batch_norm__6

        # pd_op.conv2d: (4x24x320x320xf32) <- (4x24x320x320xf32, 24x24x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            relu_3, parameter_244, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_244
        ...
        add_0 = paddle._C_ops.add(relu_2, batch_norm__12)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_4, parameter_239, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_239
        ...
        # pd_op.relu: (4x24x320x320xf32) <- (4x24x320x320xf32)
        relu_5 = paddle._C_ops.relu(batch_norm__18)
        del batch_norm__18

        # pd_op.conv2d: (4x24x320x320xf32) <- (4x24x320x320xf32, 24x24x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_5, parameter_234, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_234
        ...
        # pd_op.add: (4x24x320x320xf32) <- (4x24x320x320xf32, 4x24x320x320xf32)
        add_1 = paddle._C_ops.add(relu_4, batch_norm__24)
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_229, [2, 2], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_229
        ...
        relu_7 = paddle._C_ops.relu(batch_norm__30)
        del batch_norm__30
        ...
        add_2 = paddle._C_ops.add(relu_8, batch_norm__36)
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_9, parameter_214, [1, 1], [2, 2], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del parameter_214
        ...
        # pd_op.relu: (4x48x160x160xf32) <- (4x48x160x160xf32)
        relu_10 = paddle._C_ops.relu(batch_norm__48)
        del batch_norm__48
        ...
        # pd_op.add: (4x48x160x160xf32) <- (4x48x160x160xf32, 4x48x160x160xf32)
        add_3 = paddle._C_ops.add(relu_9, batch_norm__54)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu_11, parameter_204, [1, 1], [2, 2], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del parameter_204
        ...
        # pd_op.relu: (4x48x160x160xf32) <- (4x48x160x160xf32)
        relu_12 = paddle._C_ops.relu(batch_norm__60)
        del batch_norm__60
        ...
        # pd_op.add: (4x48x160x160xf32) <- (4x48x160x160xf32, 4x48x160x160xf32)
        add_4 = paddle._C_ops.add(relu_11, batch_norm__66)

        # pd_op.relu: (4x48x160x160xf32) <- (4x48x160x160xf32)
        relu_13 = paddle._C_ops.relu(add_4)
        del add_4

        # pd_op.depthwise_conv2d: (4x48x80x80xf32) <- (4x48x160x160xf32, 48x1x5x5xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu_13, parameter_194, [2, 2], [2, 2], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del parameter_194
        ...
        relu_14 = paddle._C_ops.relu(batch_norm__72)
        del batch_norm__72
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            scale_1, parameter_184, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_184
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            relu_18, parameter_169, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_169
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_19, parameter_164, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_164
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            scale_3, parameter_159, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_159
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            relu_20, parameter_154, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_154
        ...
        # pd_op.add: (4x96x80x80xf32) <- (4x96x80x80xf32, 4x96x80x80xf32)
        add_6 = paddle._C_ops.add(relu_18, relu_21)
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            relu_22, parameter_149, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_149
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            scale_5, parameter_139, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_139
        ...
        # pd_op.relu: (4x24x80x80xf32) <- (4x24x80x80xf32)
        relu_24 = paddle._C_ops.relu(batch_norm__138)
        del batch_norm__138
        ...
        # pd_op.relu: (4x96x80x80xf32) <- (4x96x80x80xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__144)
        del batch_norm__144

        # pd_op.add: (4x96x80x80xf32) <- (4x96x80x80xf32, 4x96x80x80xf32)
        add_7 = paddle._C_ops.add(relu_22, relu_25)
        ...
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            relu_26, parameter_129, [2, 2], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_129
        ...
        relu_27 = paddle._C_ops.relu(batch_norm__150)
        del batch_norm__150

        # pd_op.conv2d: (4x24x40x40xf32) <- (4x96x40x40xf32, 24x96x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_27, parameter_124, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_124
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            scale_7, parameter_119, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_119
        ...
        relu_28 = paddle._C_ops.relu(batch_norm__162)
        del batch_norm__162

        # pd_op.conv2d: (4x96x40x40xf32) <- (4x24x40x40xf32, 96x24x1x1xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            relu_28, parameter_114, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_114
        ...
        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_29 = paddle._C_ops.relu(batch_norm__168)
        del batch_norm__168
        ...
        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_32 = paddle._C_ops.relu(batch_norm__180)
        del batch_norm__180

        # pd_op.conv2d: (4x24x40x40xf32) <- (4x96x40x40xf32, 24x96x1x1xf32)
        conv2d_17 = paddle._C_ops.conv2d(
            relu_32, parameter_99, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_99
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            scale_9, parameter_94, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_94
        ...
        # pd_op.relu: (4x24x40x40xf32) <- (4x24x40x40xf32)
        relu_33 = paddle._C_ops.relu(batch_norm__192)
        del batch_norm__192
        ...
        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_34 = paddle._C_ops.relu(batch_norm__198)
        del batch_norm__198

        # pd_op.add: (4x96x40x40xf32) <- (4x96x40x40xf32, 4x96x40x40xf32)
        add_9 = paddle._C_ops.add(relu_31, relu_34)

        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_35 = paddle._C_ops.relu(add_9)
        del add_9

        # pd_op.depthwise_conv2d: (4x96x40x40xf32) <- (4x96x40x40xf32, 96x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            relu_35, parameter_84, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_84
        ...
        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_36 = paddle._C_ops.relu(batch_norm__204)
        del batch_norm__204

        # pd_op.conv2d: (4x24x40x40xf32) <- (4x96x40x40xf32, 24x96x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            relu_36, parameter_79, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_79
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            scale_11, parameter_74, [1, 1], [2, 2], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_74
        ...
        # pd_op.relu: (4x24x40x40xf32) <- (4x24x40x40xf32)
        relu_37 = paddle._C_ops.relu(batch_norm__216)
        del batch_norm__216

        # pd_op.conv2d: (4x96x40x40xf32) <- (4x24x40x40xf32, 96x24x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            relu_37, parameter_69, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_69
        ...
        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_38 = paddle._C_ops.relu(batch_norm__222)
        del batch_norm__222

        # pd_op.add: (4x96x40x40xf32) <- (4x96x40x40xf32, 4x96x40x40xf32)
        add_10 = paddle._C_ops.add(relu_35, relu_38)

        # pd_op.relu: (4x96x40x40xf32) <- (4x96x40x40xf32)
        relu_39 = paddle._C_ops.relu(add_10)
        del add_10

        # pd_op.conv2d: (4x48x80x80xf32) <- (4x96x80x80xf32, 48x96x1x1xf32)
        conv2d_21 = paddle._C_ops.conv2d(
            relu_26, parameter_64, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_64
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            add_11, parameter_54, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_54
        ...
        conv2d_25 = paddle._C_ops.conv2d(
            batch_norm__246, parameter_44, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_44
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            batch_norm__258, parameter_34, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_34
        ...
        combine_0 = [batch_norm__246, batch_norm__258, batch_norm__270]
        ...
        # pd_op.relu: (4x48x80x80xf32) <- (4x48x80x80xf32)
        relu_0 = paddle._C_ops.relu(concat_0)
        del concat_0
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            batch_norm__276, parameter_19, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_19
        ...
        conv2d_32 = paddle._C_ops.conv2d(
            batch_norm__288, parameter_9, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_9
        ...
        combine_1 = [batch_norm__276, batch_norm__288, batch_norm__300]
        ...
        relu_1 = paddle._C_ops.relu(concat_1)
        del (
            add_11,
            assign_0,
            assign_1,
