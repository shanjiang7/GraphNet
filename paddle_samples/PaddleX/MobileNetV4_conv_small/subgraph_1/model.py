...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        del conv2d_0, parameter_227, parameter_228, parameter_229, parameter_230
        ...
        del conv2d_1, parameter_222, parameter_223, parameter_224, parameter_225
        ...
        del conv2d_2, parameter_217, parameter_218, parameter_219, parameter_220

        # pd_op.relu: (-1x32x-1x-1xf32) <- (-1x32x-1x-1xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__12)
        del batch_norm__12

        # pd_op.conv2d: (-1x96x-1x-1xf32) <- (-1x32x-1x-1xf32, 96x32x3x3xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            relu_2, parameter_216, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_216, relu_2
        ...
        del conv2d_3, parameter_212, parameter_213, parameter_214, parameter_215

        # pd_op.relu: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__18)
        del batch_norm__18

        # pd_op.conv2d: (-1x64x-1x-1xf32) <- (-1x96x-1x-1xf32, 64x96x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_211, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_211, relu_3
        ...
        del conv2d_4, parameter_207, parameter_208, parameter_209, parameter_210
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_4, parameter_206, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del parameter_206, relu_4
        ...
        # pd_op.conv2d: (-1x192x-1x-1xf32) <- (-1x64x-1x-1xf32, 192x64x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            batch_norm__30, parameter_201, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del batch_norm__30, parameter_201
        ...
        del conv2d_5, parameter_197, parameter_198, parameter_199, parameter_200
        ...
        del conv2d_6, parameter_187, parameter_188, parameter_189, parameter_190
        ...
        del conv2d_7, parameter_182, parameter_183, parameter_184, parameter_185
        ...
        del conv2d_8, parameter_172, parameter_173, parameter_174, parameter_175

        # pd_op.add: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, -1x96x-1x-1xf32)
        add_1 = paddle._C_ops.add(batch_norm__48, batch_norm__66)
        del batch_norm__48, batch_norm__66

        # pd_op.conv2d: (-1x192x-1x-1xf32) <- (-1x96x-1x-1xf32, 192x96x1x1xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            add_1, parameter_171, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_171
        ...
        del conv2d_9, parameter_167, parameter_168, parameter_169, parameter_170
        ...
        del conv2d_10, parameter_157, parameter_158, parameter_159, parameter_160

        # pd_op.add: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, -1x96x-1x-1xf32)
        add_2 = paddle._C_ops.add(add_1, batch_norm__84)
        del add_1, batch_norm__84

        # pd_op.conv2d: (-1x192x-1x-1xf32) <- (-1x96x-1x-1xf32, 192x96x1x1xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            add_2, parameter_156, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_156
        ...
        del conv2d_11, parameter_152, parameter_153, parameter_154, parameter_155
        ...
        del conv2d_12, parameter_142, parameter_143, parameter_144, parameter_145

        # pd_op.add: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, -1x96x-1x-1xf32)
        add_3 = paddle._C_ops.add(add_2, batch_norm__102)
        del add_2, batch_norm__102

        # pd_op.conv2d: (-1x192x-1x-1xf32) <- (-1x96x-1x-1xf32, 192x96x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            add_3, parameter_141, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_141
        ...
        del conv2d_13, parameter_137, parameter_138, parameter_139, parameter_140
        ...
        del conv2d_14, parameter_127, parameter_128, parameter_129, parameter_130

        # pd_op.add: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, -1x96x-1x-1xf32)
        add_4 = paddle._C_ops.add(add_3, batch_norm__120)
        del add_3, batch_norm__120

        # pd_op.depthwise_conv2d: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, 96x1x3x3xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            add_4, parameter_126, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_126
        ...
        del conv2d_15, parameter_117, parameter_118, parameter_119, parameter_120
        ...
        del conv2d_16, parameter_112, parameter_113, parameter_114, parameter_115

        # pd_op.add: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, -1x96x-1x-1xf32)
        add_5 = paddle._C_ops.add(add_4, batch_norm__138)
        del add_4, batch_norm__138

        # pd_op.depthwise_conv2d: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32, 96x1x3x3xf32)
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            add_5, parameter_111, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del add_5, parameter_111
        ...
        # pd_op.conv2d: (-1x576x-1x-1xf32) <- (-1x96x-1x-1xf32, 576x96x1x1xf32)
        ...
        del batch_norm__144, parameter_106

        # pd_op.batch_norm_: (-1x576x-1x-1xf32, 576xf32, 576xf32, 576xf32, 576xf32, -1xui8) <- (-1x576x-1x-1xf32, 576xf32, 576xf32, 576xf32, 576xf32)
        (
            batch_norm__150,
            batch_norm__151,
            batch_norm__152,
        ...
        del conv2d_17, parameter_102, parameter_103, parameter_104, parameter_105

        # pd_op.relu: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32)
        relu_16 = paddle._C_ops.relu(batch_norm__150)
        del batch_norm__150

        # pd_op.depthwise_conv2d: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32, 576x1x3x3xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            relu_16, parameter_101, [2, 2], [1, 1], "EXPLICIT", 576, [1, 1], "NCHW"
        )
        del parameter_101, relu_16
        ...
        del depthwise_conv2d_8, parameter_100, parameter_97, parameter_98, parameter_99

        # pd_op.relu: (-1x576x-1x-1xf32) <- (-1x576x-1x-1xf32)
        relu_17 = paddle._C_ops.relu(batch_norm__156)
        del batch_norm__156

        # pd_op.conv2d: (-1x128x-1x-1xf32) <- (-1x576x-1x-1xf32, 128x576x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            relu_17, parameter_96, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_96, relu_17
        ...
        del conv2d_18, parameter_92, parameter_93, parameter_94, parameter_95
        ...
        del depthwise_conv2d_9, parameter_87, parameter_88, parameter_89, parameter_90
        ...
        del batch_norm__168, parameter_86
        ...
        del conv2d_19, parameter_82, parameter_83, parameter_84, parameter_85
        ...
        del depthwise_conv2d_10, parameter_77, parameter_78, parameter_79, parameter_80
        ...
        del conv2d_20, parameter_72, parameter_73, parameter_74, parameter_75

        # pd_op.add: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x128x-1x-1xf32)
        add_6 = paddle._C_ops.add(batch_norm__162, batch_norm__186)
        del batch_norm__162, batch_norm__186

        # pd_op.conv2d: (-1x512x-1x-1xf32) <- (-1x128x-1x-1xf32, 512x128x1x1xf32)
        conv2d_21 = paddle._C_ops.conv2d(
            add_6, parameter_71, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_71
        ...
        del conv2d_21, parameter_67, parameter_68, parameter_69, parameter_70
        ...
        del depthwise_conv2d_11, parameter_62, parameter_63, parameter_64, parameter_65
        ...
        del conv2d_22, parameter_57, parameter_58, parameter_59, parameter_60

        # pd_op.add: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x128x-1x-1xf32)
        add_7 = paddle._C_ops.add(add_6, batch_norm__204)
        del add_6, batch_norm__204

        # pd_op.conv2d: (-1x384x-1x-1xf32) <- (-1x128x-1x-1xf32, 384x128x1x1xf32)
        conv2d_23 = paddle._C_ops.conv2d(
            add_7, parameter_56, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_56
        ...
        del conv2d_23, parameter_52, parameter_53, parameter_54, parameter_55
        ...
        del depthwise_conv2d_12, parameter_47, parameter_48, parameter_49, parameter_50
        ...
        del conv2d_24, parameter_42, parameter_43, parameter_44, parameter_45

        # pd_op.add: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x128x-1x-1xf32)
        add_8 = paddle._C_ops.add(add_7, batch_norm__222)
        del add_7, batch_norm__222

        # pd_op.conv2d: (-1x512x-1x-1xf32) <- (-1x128x-1x-1xf32, 512x128x1x1xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            add_8, parameter_41, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_41
        ...
        del conv2d_25, parameter_37, parameter_38, parameter_39, parameter_40
        ...
        del depthwise_conv2d_13, parameter_32, parameter_33, parameter_34, parameter_35
        ...
        del conv2d_26, parameter_27, parameter_28, parameter_29, parameter_30

        # pd_op.add: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x128x-1x-1xf32)
        add_9 = paddle._C_ops.add(add_8, batch_norm__240)
        del add_8, batch_norm__240

        # pd_op.conv2d: (-1x512x-1x-1xf32) <- (-1x128x-1x-1xf32, 512x128x1x1xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            add_9, parameter_26, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_26
        ...
        del conv2d_27, parameter_22, parameter_23, parameter_24, parameter_25
        ...
        del conv2d_28, parameter_12, parameter_13, parameter_14, parameter_15

        # pd_op.add: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32, -1x128x-1x-1xf32)
        add_10 = paddle._C_ops.add(add_9, batch_norm__258)
        del add_9, batch_norm__258

        # pd_op.conv2d: (-1x960x-1x-1xf32) <- (-1x128x-1x-1xf32, 960x128x1x1xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            add_10, parameter_11, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del add_10, parameter_11
        ...
        del conv2d_29, parameter_10, parameter_7, parameter_8, parameter_9
        ...
        del conv2d_30, parameter_2, parameter_3, parameter_4, parameter_5
