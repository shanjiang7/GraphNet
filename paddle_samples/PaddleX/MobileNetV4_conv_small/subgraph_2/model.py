...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        shape64_0 = paddle._C_ops.shape64(relu_2)
        ...
        # pd_op.conv2d: (-1x96x28x28xf32) <- (-1x32x56x56xf32, 96x32x3x3xf32)
        ...
        shape64_1 = paddle._C_ops.shape64(relu_3)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_2 = paddle._C_ops.add(full_4, uniform_1)
        del uniform_1
        ...
        # pd_op.divide: (-1x96x28x28xf32) <- (-1x96x28x28xf32, xf32)
        divide_1 = paddle._C_ops.divide(relu_3, full_4)

        # pd_op.multiply: (-1x96x28x28xf32) <- (-1x96x28x28xf32, -1x1x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(divide_1, floor_1)

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x96x28x28xf32, 64x96x1x1xf32)
        ...
        shape64_2 = paddle._C_ops.shape64(relu_4)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_3 = paddle._C_ops.add(full_5, uniform_2)
        del uniform_2
        ...
        divide_2 = paddle._C_ops.divide(relu_4, full_5)
        ...
        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x64x28x28xf32, 192x64x1x1xf32)
        ...
        shape64_3 = paddle._C_ops.shape64(batch_norm__66)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_4 = paddle._C_ops.add(full_6, uniform_3)
        del uniform_3
        ...
        # pd_op.divide: (-1x96x14x14xf32) <- (-1x96x14x14xf32, xf32)
        divide_3 = paddle._C_ops.divide(batch_norm__66, full_6)

        # pd_op.multiply: (-1x96x14x14xf32) <- (-1x96x14x14xf32, -1x1x1x1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x96x14x14xf32)
        shape64_4 = paddle._C_ops.shape64(batch_norm__84)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_6 = paddle._C_ops.add(full_7, uniform_4)
        del uniform_4
        ...
        # pd_op.divide: (-1x96x14x14xf32) <- (-1x96x14x14xf32, xf32)
        divide_4 = paddle._C_ops.divide(batch_norm__84, full_7)
        ...
        # pd_op.shape64: (4xi64) <- (-1x96x14x14xf32)
        shape64_5 = paddle._C_ops.shape64(batch_norm__102)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_8 = paddle._C_ops.add(full_8, uniform_5)
        del uniform_5
        ...
        # pd_op.divide: (-1x96x14x14xf32) <- (-1x96x14x14xf32, xf32)
        divide_5 = paddle._C_ops.divide(batch_norm__102, full_8)
        ...
        # pd_op.shape64: (4xi64) <- (-1x96x14x14xf32)
        shape64_6 = paddle._C_ops.shape64(batch_norm__120)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_10 = paddle._C_ops.add(full_9, uniform_6)
        del uniform_6
        ...
        # pd_op.divide: (-1x96x14x14xf32) <- (-1x96x14x14xf32, xf32)
        divide_6 = paddle._C_ops.divide(batch_norm__120, full_9)
        ...
        # pd_op.shape64: (4xi64) <- (-1x96x14x14xf32)
        shape64_7 = paddle._C_ops.shape64(batch_norm__138)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_12 = paddle._C_ops.add(full_10, uniform_7)
        del uniform_7
        ...
        # pd_op.divide: (-1x96x14x14xf32) <- (-1x96x14x14xf32, xf32)
        divide_7 = paddle._C_ops.divide(batch_norm__138, full_10)
        ...
        # pd_op.relu: (-1x576x14x14xf32) <- (-1x576x14x14xf32)
        ...
        # pd_op.relu: (-1x576x7x7xf32) <- (-1x576x7x7xf32)
        relu_17 = paddle._C_ops.relu(batch_norm__156)
        del batch_norm__156

        # pd_op.conv2d: (-1x128x7x7xf32) <- (-1x576x7x7xf32, 128x576x1x1xf32)
        ...
        shape64_8 = paddle._C_ops.shape64(batch_norm__186)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_14 = paddle._C_ops.add(full_11, uniform_8)
        del uniform_8
        ...
        # pd_op.divide: (-1x128x7x7xf32) <- (-1x128x7x7xf32, xf32)
        divide_8 = paddle._C_ops.divide(batch_norm__186, full_11)

        # pd_op.multiply: (-1x128x7x7xf32) <- (-1x128x7x7xf32, -1x1x1x1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x128x7x7xf32)
        shape64_9 = paddle._C_ops.shape64(batch_norm__204)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_16 = paddle._C_ops.add(full_12, uniform_9)
        del uniform_9
        ...
        # pd_op.divide: (-1x128x7x7xf32) <- (-1x128x7x7xf32, xf32)
        divide_9 = paddle._C_ops.divide(batch_norm__204, full_12)
        ...
        # pd_op.conv2d: (-1x384x7x7xf32) <- (-1x128x7x7xf32, 384x128x1x1xf32)
        ...
        # pd_op.conv2d: (-1x128x7x7xf32) <- (-1x384x7x7xf32, 128x384x1x1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x128x7x7xf32)
        shape64_10 = paddle._C_ops.shape64(batch_norm__222)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_18 = paddle._C_ops.add(full_13, uniform_10)
        del uniform_10
        ...
        # pd_op.divide: (-1x128x7x7xf32) <- (-1x128x7x7xf32, xf32)
        divide_10 = paddle._C_ops.divide(batch_norm__222, full_13)
        ...
        # pd_op.shape64: (4xi64) <- (-1x128x7x7xf32)
        shape64_11 = paddle._C_ops.shape64(batch_norm__240)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_20 = paddle._C_ops.add(full_14, uniform_11)
        del uniform_11
        ...
        # pd_op.divide: (-1x128x7x7xf32) <- (-1x128x7x7xf32, xf32)
        divide_11 = paddle._C_ops.divide(batch_norm__240, full_14)
        ...
        # pd_op.shape64: (4xi64) <- (-1x128x7x7xf32)
        shape64_12 = paddle._C_ops.shape64(batch_norm__258)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_22 = paddle._C_ops.add(full_15, uniform_12)
        del uniform_12
        ...
        # pd_op.divide: (-1x128x7x7xf32) <- (-1x128x7x7xf32, xf32)
        divide_12 = paddle._C_ops.divide(batch_norm__258, full_15)
        ...
        # pd_op.conv2d: (-1x960x7x7xf32) <- (-1x128x7x7xf32, 960x128x1x1xf32)
        ...
        # pd_op.relu: (-1x960x7x7xf32) <- (-1x960x7x7xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x960x7x7xf32)
        shape64_13 = paddle._C_ops.shape64(relu_28)

        # pd_op.slice: (xi64) <- (4xi64, 1xi64, 1xi64)
        slice_13 = paddle._C_ops.slice(
            shape64_13, [0], full_int_array_0, full_int_array_1, [1], [0]
        )
        del full_int_array_0, full_int_array_1, shape64_13
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_24 = paddle._C_ops.add(full_16, uniform_13)
        del uniform_13
        ...
        # pd_op.divide: (-1x960x7x7xf32) <- (-1x960x7x7xf32, xf32)
        divide_13 = paddle._C_ops.divide(relu_28, full_16)

        # pd_op.multiply: (-1x960x7x7xf32) <- (-1x960x7x7xf32, -1x1x1x1xf32)
