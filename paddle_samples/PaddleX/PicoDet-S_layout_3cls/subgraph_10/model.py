...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x16x224x224xf32) <- (2x3x448x448xf32, 16x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_441, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_441

        # pd_op.batch_norm_: (2x16x224x224xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (2x16x224x224xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (2x16x224x224xf32) <- (2x16x224x224xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (2x16x224x224xf32) <- (2x16x224x224xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x24x224x224xf32) <- (2x16x224x224xf32, 24x16x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_431, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_431

        # pd_op.batch_norm_: (2x24x224x224xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (2x24x224x224xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (2x24x224x224xf32) <- (2x24x224x224xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (2x24x112x112xf32) <- (2x24x224x224xf32, 24x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_426, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_426

        # pd_op.batch_norm_: (2x24x112x112xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (2x24x112x112xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (2x24x112x112xf32) <- (2x24x112x112xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (2x48x112x112xf32) <- (2x24x112x112xf32, 48x24x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_421, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_421

        # pd_op.batch_norm_: (2x48x112x112xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (2x48x112x112xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (2x48x112x112xf32) <- (2x48x112x112xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (2x48x112x112xf32) <- (2x48x112x112xf32, 48x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x48x112x112xf32) <- (2x48x112x112xf32, 48x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x48x56x56xf32) <- (2x48x112x112xf32, 48x1x3x3xf32)
        ...
        # pd_op.hardswish: (2x48x56x56xf32) <- (2x48x56x56xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (2x96x56x56xf32) <- (2x48x56x56xf32, 96x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x56x56xf32) <- (2x96x56x56xf32, 96x1x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x28x28xf32) <- (2x96x56x56xf32, 96x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x192x28x28xf32) <- (2x96x28x28xf32, 192x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x192x14x14xf32) <- (2x192x28x28xf32, 192x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x192x1x1xf32) <- (2x192x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x384x14x14xf32) <- (2x192x14x14xf32, 384x192x1x1xf32)
        ...
        # pd_op.hardswish: (2x384x14x14xf32) <- (2x384x14x14xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (2x384x14x14xf32) <- (2x384x14x14xf32, 384x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x384x1x1xf32) <- (2x384x14x14xf32, 2xi64)
        ...
        # pd_op.multiply: (2x384x14x14xf32) <- (2x384x14x14xf32, 2x384x1x1xf32)
