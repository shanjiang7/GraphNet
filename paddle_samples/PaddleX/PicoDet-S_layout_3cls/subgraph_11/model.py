...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.topk: (2x3x9xf32, 2x3x9xi64) <- (2x3x3136xf32, 1xi32)
        ...
        # pd_op.one_hot: (2x3x9x3136xf32) <- (2x3x9xi64, 1xi32)
        ...
        # pd_op.sum: (2x3x3136xf32) <- (2x3x9x3136xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)
        del one_hot_0

        # pd_op.multiply: (2x3x3136xf32) <- (2x3x3136xf32, 2x3x1xf32)
        multiply_0 = paddle._C_ops.multiply(sum_0, data_4)
        del sum_0

        # pd_op.topk: (2x3x9xf32, 2x3x9xi64) <- (2x3x784xf32, 1xi32)
        ...
        # builtin.combine: ([2x3x3136xf32, 2x3x784xf32, 2x3x196xf32, 2x3x49xf32]) <- (2x3x3136xf32, 2x3x784xf32, 2x3x196xf32, 2x3x49xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]
        del multiply_0, multiply_1, multiply_2, multiply_3

        # pd_op.concat: (2x3x4165xf32) <- ([2x3x3136xf32, 2x3x784xf32, 2x3x196xf32, 2x3x49xf32], 1xi32)
