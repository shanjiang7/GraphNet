...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        arange_6 = paddle.arange(full_7, full_8, full_9, dtype="int64")
        ...
        # pd_op.scale: (7xf32) <- (7xf32, 1xf32)
        scale_25 = paddle._C_ops.scale(scale_24, full_10, float("0"), True)
        del full_10, scale_24

        # builtin.combine: ([7xf32, 7xf32]) <- (7xf32, 7xf32)
        combine_12 = [scale_25, scale_25]
        del scale_25
        ...
        scale_26 = paddle._C_ops.scale(split_7, full_2, float("-160"), True)

        # pd_op.scale: (7x7xf32) <- (7x7xf32, 1xf32)
        scale_27 = paddle._C_ops.scale(split_6, full_2, float("-160"), True)
        ...
        combine_13 = [scale_26, scale_27, scale_28, scale_29]
        del scale_26, scale_27, scale_28, scale_29
        ...
        # builtin.combine: ([-1x4xf32, -1x4xf32, -1x4xf32, 49x4xf32]) <- (-1x4xf32, -1x4xf32, -1x4xf32, 49x4xf32)
        combine_15 = [reshape_0, reshape_2, reshape_4, reshape_6]
        del reshape_0, reshape_2, reshape_4

        # pd_op.concat: (-1x4xf32) <- ([-1x4xf32, -1x4xf32, -1x4xf32, 49x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_15, full_12)
        del combine_15

        # builtin.combine: ([-1x2xf32, -1x2xf32, -1x2xf32, 49x2xf32]) <- (-1x2xf32, -1x2xf32, -1x2xf32, 49x2xf32)
        combine_16 = [reshape_1, reshape_3, reshape_5, reshape_7]
        del reshape_1, reshape_3, reshape_5, reshape_7

        # pd_op.concat: (-1x2xf32) <- ([-1x2xf32, -1x2xf32, -1x2xf32, 49x2xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_16, full_12)
        del combine_16

        # builtin.combine: ([-1x1xf32, -1x1xf32, -1x1xf32, 49x1xf32]) <- (-1x1xf32, -1x1xf32, -1x1xf32, 49x1xf32)
        combine_17 = [
            full_with_tensor_0,
            full_with_tensor_1,
            full_with_tensor_2,
        ...
        del full_11, full_with_tensor_0, full_with_tensor_1, full_with_tensor_2

        # pd_op.concat: (-1x1xf32) <- ([-1x1xf32, -1x1xf32, -1x1xf32, 49x1xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_17, full_12)
        ...
        add_0 = paddle._C_ops.add(slice_3, slice_4)
        del slice_3, slice_4
        ...
        # pd_op.scale: (-1xf32) <- (-1xf32, 1xf32)
        scale_30 = paddle._C_ops.scale(add_0, full_13, float("0"), True)
        del add_0
        ...
        # pd_op.scale: (-1xf32) <- (-1xf32, 1xf32)
        scale_31 = paddle._C_ops.scale(add_1, full_13, float("0"), True)
        del add_1, full_13

        # builtin.combine: ([-1xf32, -1xf32]) <- (-1xf32, -1xf32)
        combine_18 = [scale_30, scale_31]
        del scale_30, scale_31

        # pd_op.stack: (-1x2xf32) <- ([-1xf32, -1xf32])
        stack_0 = paddle._C_ops.stack(combine_18, -1)
        del combine_18
        ...
        del concat_0, concat_2, reshape_6, share_data__0, slice_0, slice_1, slice_2
