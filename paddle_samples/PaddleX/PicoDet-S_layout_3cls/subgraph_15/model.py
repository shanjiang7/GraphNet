...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.flatten: (-1x-1xf32) <- (2x-1x-1xf32)
        flatten_0 = paddle._C_ops.flatten(multiply_0, 0, 1)

        # pd_op.flatten: (-1x36xi64) <- (2x-1x36xi64)
        ...
        # pd_op.reshape: (2x-1x-1xf32) <- (-1x36xf32, 3xi64)
        ...
        # pd_op.mean: (2x-1x1xf32) <- (2x-1x-1xf32, 1xi64)
        mean_0 = paddle._C_ops.mean(reshape_0, full_int_array_0, True)

        # pd_op.subtract: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x1xf32)
        ...
        # pd_op.divide: (2x-1x1xf32) <- (2x-1x1xf32, xf32)
        divide_1 = paddle._C_ops.divide(sum_0, maximum_0)
        del maximum_0, sum_0

        # pd_op.sqrt: (2x-1x1xf32) <- (2x-1x1xf32)
        ...
        # pd_op.greater_than: (2x-1x-1xb) <- (2x-1x-1xf32, 2x-1x1xf32)
