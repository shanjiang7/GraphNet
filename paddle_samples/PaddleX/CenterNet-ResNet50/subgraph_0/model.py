...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_4, parameter_388, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_4, parameter_388
        ...
        conv2d_1 = paddle._C_ops.conv2d(
            relu_0, parameter_383, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_383
        ...
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_378, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_378
        ...
        conv2d_3 = paddle._C_ops.conv2d(
            pool2d_0, parameter_373, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_373
        ...
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_368, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_368
        ...
        conv2d_5 = paddle._C_ops.conv2d(
            relu_4, parameter_363, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_363
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            pool2d_0, parameter_358, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_358
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            relu_5, parameter_353, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_353
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            relu_6, parameter_348, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_348
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_7, parameter_343, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_343
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_8, parameter_338, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_338
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            relu_9, parameter_333, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_333
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            relu_10, parameter_328, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_328
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            relu_11, parameter_323, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_323
        ...
        conv2d_14 = paddle._C_ops.conv2d(
            relu_12, parameter_318, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_318
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            relu_13, parameter_313, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_313
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            pool2d_1, parameter_308, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_308
        ...
        conv2d_17 = paddle._C_ops.conv2d(
            relu_14, parameter_303, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_303
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            relu_15, parameter_298, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_298
        ...
        conv2d_19 = paddle._C_ops.conv2d(
            relu_16, parameter_293, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_293
        ...
        conv2d_20 = paddle._C_ops.conv2d(
            relu_17, parameter_288, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_288
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            relu_18, parameter_283, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_283
        ...
        conv2d_22 = paddle._C_ops.conv2d(
            relu_19, parameter_278, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_278
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            relu_20, parameter_273, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_273
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            relu_21, parameter_268, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_268
        ...
        conv2d_25 = paddle._C_ops.conv2d(
            relu_22, parameter_263, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_263
        ...
        conv2d_26 = paddle._C_ops.conv2d(
            relu_23, parameter_258, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_258
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            relu_24, parameter_253, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_253
        ...
        conv2d_28 = paddle._C_ops.conv2d(
            relu_25, parameter_248, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_248
        ...
        conv2d_29 = paddle._C_ops.conv2d(
            pool2d_2, parameter_243, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_243
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            relu_26, parameter_238, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_238
        ...
        conv2d_31 = paddle._C_ops.conv2d(
            relu_27, parameter_233, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_233
        ...
        conv2d_32 = paddle._C_ops.conv2d(
            relu_28, parameter_228, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_228
        ...
        conv2d_33 = paddle._C_ops.conv2d(
            relu_29, parameter_223, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_223
        ...
        conv2d_34 = paddle._C_ops.conv2d(
            relu_30, parameter_218, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_218
        ...
        conv2d_35 = paddle._C_ops.conv2d(
            relu_31, parameter_213, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_213
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            relu_32, parameter_208, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_208
        ...
        conv2d_37 = paddle._C_ops.conv2d(
            relu_33, parameter_203, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_203
        ...
        conv2d_38 = paddle._C_ops.conv2d(
            relu_34, parameter_198, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_198
        ...
        conv2d_39 = paddle._C_ops.conv2d(
            relu_35, parameter_193, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_193
        ...
        conv2d_40 = paddle._C_ops.conv2d(
            relu_36, parameter_188, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_188
        ...
        conv2d_41 = paddle._C_ops.conv2d(
            relu_37, parameter_183, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_183
        ...
        conv2d_42 = paddle._C_ops.conv2d(
            relu_38, parameter_178, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_178
        ...
        conv2d_43 = paddle._C_ops.conv2d(
            relu_39, parameter_173, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_173
        ...
        conv2d_44 = paddle._C_ops.conv2d(
            relu_40, parameter_168, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_168
        ...
        conv2d_45 = paddle._C_ops.conv2d(
            relu_41, parameter_163, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_163
        ...
        conv2d_46 = paddle._C_ops.conv2d(
            relu_42, parameter_158, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_158
        ...
        reshape_0 = paddle._C_ops.reshape(parameter_157, full_int_array_2)
        del parameter_157
        ...
        conv2d_47 = paddle._C_ops.conv2d(
            relu_43, parameter_152, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_152
        ...
        conv2d_48 = paddle._C_ops.conv2d(
            pool2d_3, parameter_147, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_147
        ...
        conv2d_49 = paddle._C_ops.conv2d(
            relu_44, parameter_142, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_142
        ...
        conv2d_50 = paddle._C_ops.conv2d(
            relu_45, parameter_137, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_137

        # pd_op.reshape: (1x27x1x1xf32) <- (27xf32, 4xi64)
        reshape_1 = paddle._C_ops.reshape(parameter_136, full_int_array_2)
        del parameter_136
        ...
        conv2d_51 = paddle._C_ops.conv2d(
            relu_46, parameter_131, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_131
        ...
        conv2d_52 = paddle._C_ops.conv2d(
            relu_47, parameter_126, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_126
        ...
        conv2d_53 = paddle._C_ops.conv2d(
            relu_48, parameter_121, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_121

        # pd_op.reshape: (1x27x1x1xf32) <- (27xf32, 4xi64)
        reshape_2 = paddle._C_ops.reshape(parameter_120, full_int_array_2)
        del parameter_120
        ...
        conv2d_54 = paddle._C_ops.conv2d(
            relu_49, parameter_115, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_115
        ...
        conv2d_55 = paddle._C_ops.conv2d(
            relu_50, parameter_110, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_110
        ...
        # pd_op.add: (4x1024x32x32xf32) <- (4x1024x32x32xf32, 4x1024x32x32xf32)
        add_20 = paddle._C_ops.add(depthwise_conv2d_transpose_0, relu_41)

        # pd_op.conv2d: (4x1024x32x32xf32) <- (4x1024x32x32xf32, 1024x1024x3x3xf32)
        conv2d_56 = paddle._C_ops.conv2d(
            add_20, parameter_104, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_104
        ...
        conv2d_57 = paddle._C_ops.conv2d(
            relu_41, parameter_99, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_99
        ...
        # pd_op.add: (4x512x64x64xf32) <- (4x512x64x64xf32, 4x512x64x64xf32)
        add_21 = paddle._C_ops.add(depthwise_conv2d_transpose_1, relu_23)

        # pd_op.conv2d: (4x512x64x64xf32) <- (4x512x64x64xf32, 512x512x3x3xf32)
        conv2d_58 = paddle._C_ops.conv2d(
            add_21, parameter_93, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_93
        ...
        conv2d_59 = paddle._C_ops.conv2d(
            relu_52, parameter_88, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_88
        ...
        # pd_op.add: (4x512x64x64xf32) <- (4x512x64x64xf32, 4x512x64x64xf32)
        add_22 = paddle._C_ops.add(depthwise_conv2d_transpose_2, relu_54)

        # pd_op.conv2d: (4x512x64x64xf32) <- (4x512x64x64xf32, 512x512x3x3xf32)
        conv2d_60 = paddle._C_ops.conv2d(
            add_22, parameter_82, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_82
        ...
        conv2d_61 = paddle._C_ops.conv2d(
            relu_23, parameter_77, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_77
        ...
        # pd_op.relu: (4x256x64x64xf32) <- (4x256x64x64xf32)
        relu_57 = paddle._C_ops.relu(batch_norm__366)
        del batch_norm__366
        ...
        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 4x256x128x128xf32)
        add_23 = paddle._C_ops.add(depthwise_conv2d_transpose_3, relu_11)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_62 = paddle._C_ops.conv2d(
            add_23, parameter_71, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_71
        ...
        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_58 = paddle._C_ops.relu(batch_norm__372)
        del batch_norm__372
        ...
        # pd_op.relu: (4x256x64x64xf32) <- (4x256x64x64xf32)
        relu_59 = paddle._C_ops.relu(batch_norm__378)
        del batch_norm__378
        ...
        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 4x256x128x128xf32)
        add_24 = paddle._C_ops.add(depthwise_conv2d_transpose_4, relu_58)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_64 = paddle._C_ops.conv2d(
            add_24, parameter_60, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_60
        ...
        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_60 = paddle._C_ops.relu(batch_norm__384)
        del batch_norm__384

        # pd_op.conv2d: (4x256x64x64xf32) <- (4x512x64x64xf32, 256x512x3x3xf32)
        conv2d_65 = paddle._C_ops.conv2d(
            relu_56, parameter_55, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_55
        ...
        # pd_op.relu: (4x256x64x64xf32) <- (4x256x64x64xf32)
        relu_61 = paddle._C_ops.relu(batch_norm__390)
        del batch_norm__390
        ...
        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 4x256x128x128xf32)
        add_25 = paddle._C_ops.add(depthwise_conv2d_transpose_5, relu_60)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_66 = paddle._C_ops.conv2d(
            add_25, parameter_49, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_49
        ...
        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_62 = paddle._C_ops.relu(batch_norm__396)
        del batch_norm__396
        ...
        conv2d_67 = paddle._C_ops.conv2d(
            assign_17, parameter_44, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_44
        ...
        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 4x256x128x128xf32)
        add_26 = paddle._C_ops.add(depthwise_conv2d_transpose_6, assign_16)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_68 = paddle._C_ops.conv2d(
            add_26, parameter_38, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_38
        ...
        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_64 = paddle._C_ops.relu(batch_norm__408)
        del batch_norm__408

        # pd_op.conv2d: (4x256x32x32xf32) <- (4x1024x32x32xf32, 256x1024x3x3xf32)
        conv2d_69 = paddle._C_ops.conv2d(
            assign_18, parameter_33, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_33
        ...
        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 4x256x128x128xf32)
        add_27 = paddle._C_ops.add(depthwise_conv2d_transpose_7, relu_64)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_70 = paddle._C_ops.conv2d(
            add_27, parameter_27, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_27
        ...
        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_66 = paddle._C_ops.relu(batch_norm__420)
        del batch_norm__420

        # pd_op.conv2d: (4x256x16x16xf32) <- (4x2048x16x16xf32, 256x2048x3x3xf32)
        conv2d_71 = paddle._C_ops.conv2d(
            assign_19, parameter_22, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_22
        ...
        depthwise_conv2d_transpose_8 = paddle._C_ops.depthwise_conv2d_transpose(
            relu_67,
            parameter_17,
            [8, 8],
            [4, 4],
        ...
        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 4x256x128x128xf32)
        add_28 = paddle._C_ops.add(depthwise_conv2d_transpose_8, relu_66)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_72 = paddle._C_ops.conv2d(
            add_28, parameter_16, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_16
        ...
        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_68 = paddle._C_ops.relu(batch_norm__432)
        del batch_norm__432

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_73 = paddle._C_ops.conv2d(
            relu_68, parameter_11, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_11

        # pd_op.reshape: (1x256x1x1xf32) <- (256xf32, 4xi64)
        reshape_3 = paddle._C_ops.reshape(parameter_10, full_int_array_2)
        del parameter_10

        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 1x256x1x1xf32)
        add_29 = paddle._C_ops.add(conv2d_73, reshape_3)

        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_69 = paddle._C_ops.relu(add_29)
        del add_29

        # pd_op.conv2d: (4x4x128x128xf32) <- (4x256x128x128xf32, 4x256x1x1xf32)
        conv2d_74 = paddle._C_ops.conv2d(
            relu_69, parameter_9, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_9

        # pd_op.reshape: (1x4x1x1xf32) <- (4xf32, 4xi64)
        reshape_4 = paddle._C_ops.reshape(parameter_8, full_int_array_2)
        del parameter_8

        # pd_op.add: (4x4x128x128xf32) <- (4x4x128x128xf32, 1x4x1x1xf32)
        add_30 = paddle._C_ops.add(conv2d_74, reshape_4)

        # pd_op.sigmoid: (4x4x128x128xf32) <- (4x4x128x128xf32)
        sigmoid_3 = paddle._C_ops.sigmoid(add_30)
        del add_30
        ...
        # pd_op.reshape: (1x256x1x1xf32) <- (256xf32, 4xi64)
        reshape_5 = paddle._C_ops.reshape(parameter_6, full_int_array_2)
        del parameter_6

        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 1x256x1x1xf32)
        add_31 = paddle._C_ops.add(conv2d_75, reshape_5)

        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_70 = paddle._C_ops.relu(add_31)
        del add_31

        # pd_op.conv2d: (4x2x128x128xf32) <- (4x256x128x128xf32, 2x256x1x1xf32)
        conv2d_76 = paddle._C_ops.conv2d(
            relu_70, parameter_5, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_5

        # pd_op.reshape: (1x2x1x1xf32) <- (2xf32, 4xi64)
        reshape_6 = paddle._C_ops.reshape(parameter_4, full_int_array_2)
        del parameter_4

        # pd_op.add: (4x2x128x128xf32) <- (4x2x128x128xf32, 1x2x1x1xf32)
        add_32 = paddle._C_ops.add(conv2d_76, reshape_6)

        # pd_op.conv2d: (4x256x128x128xf32) <- (4x256x128x128xf32, 256x256x3x3xf32)
        conv2d_77 = paddle._C_ops.conv2d(
            relu_68, parameter_3, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_3

        # pd_op.reshape: (1x256x1x1xf32) <- (256xf32, 4xi64)
        reshape_7 = paddle._C_ops.reshape(parameter_2, full_int_array_2)
        del parameter_2

        # pd_op.add: (4x256x128x128xf32) <- (4x256x128x128xf32, 1x256x1x1xf32)
        add_33 = paddle._C_ops.add(conv2d_77, reshape_7)

        # pd_op.relu: (4x256x128x128xf32) <- (4x256x128x128xf32)
        relu_71 = paddle._C_ops.relu(add_33)
        del add_33

        # pd_op.conv2d: (4x2x128x128xf32) <- (4x256x128x128xf32, 2x256x1x1xf32)
        conv2d_78 = paddle._C_ops.conv2d(
            relu_71, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_1

        # pd_op.reshape: (1x2x1x1xf32) <- (2xf32, 4xi64)
        reshape_8 = paddle._C_ops.reshape(parameter_0, full_int_array_2)
        del full_int_array_2, parameter_0

        # pd_op.add: (4x2x128x128xf32) <- (4x2x128x128xf32, 1x2x1x1xf32)
        add_34 = paddle._C_ops.add(conv2d_78, reshape_8)
        ...
        clip_0 = paddle._C_ops.clip(sigmoid_3, full_1, full_2)
        ...
        equal_0 = paddle._C_ops.equal(data_7, full_3)
        ...
        less_than_0 = paddle._C_ops.less_than(data_7, full_3)
        del full_3
        ...
        scale_0 = paddle._C_ops.scale(data_7, full_4, float("1"), True)
        del data_7

        # pd_op.pow: (4x4x128x128xf32) <- (4x4x128x128xf32)
        pow_0 = paddle._C_ops.pow(scale_0, float("4"))
        del scale_0
        ...
        # pd_op.scale: (4x4x128x128xf32) <- (4x4x128x128xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(clip_0, full_4, float("1"), True)

        # pd_op.pow: (4x4x128x128xf32) <- (4x4x128x128xf32)
        pow_1 = paddle._C_ops.pow(scale_1, float("2"))
        ...
        # pd_op.scale: (4x4x128x128xf32) <- (4x4x128x128xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(multiply_1, full_4, float("0"), True)
        del multiply_1

        # pd_op.scale: (4x4x128x128xf32) <- (4x4x128x128xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(clip_0, full_4, float("1"), True)

        # pd_op.log: (4x4x128x128xf32) <- (4x4x128x128xf32)
        log_1 = paddle._C_ops.log(scale_3)

        # pd_op.pow: (4x4x128x128xf32) <- (4x4x128x128xf32)
        pow_2 = paddle._C_ops.pow(clip_0, float("2"))

        # pd_op.multiply: (4x4x128x128xf32) <- (4x4x128x128xf32, 4x4x128x128xf32)
        multiply_2 = paddle._C_ops.multiply(log_1, pow_2)

        # pd_op.multiply: (4x4x128x128xf32) <- (4x4x128x128xf32, 4x4x128x128xf32)
        multiply_3 = paddle._C_ops.multiply(multiply_2, pow_0)

        # pd_op.multiply: (4x4x128x128xf32) <- (4x4x128x128xf32, 4x4x128x128xf32)
        multiply_4 = paddle._C_ops.multiply(multiply_3, cast_1)

        # pd_op.scale: (4x4x128x128xf32) <- (4x4x128x128xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(multiply_4, full_4, float("0"), True)
        del full_4, multiply_4

        # pd_op.sum: (xf32) <- (4x4x128x128xf32, 0xi64)
        sum_0 = paddle._C_ops.sum(scale_2, full_int_array_4, None, False)

        # pd_op.sum: (xf32) <- (4x4x128x128xf32, 0xi64)
        sum_1 = paddle._C_ops.sum(scale_4, full_int_array_4, None, False)

        # pd_op.sum: (xf32) <- (4x4x128x128xf32, 0xi64)
        sum_2 = paddle._C_ops.sum(cast_0, full_int_array_4, None, False)

        # pd_op.add: (xf32) <- (xf32, xf32)
        add_35 = paddle._C_ops.add(sum_0, sum_1)
        ...
        equal_1 = paddle._C_ops.equal(sum_2, full_5)
        del full_5

        # pd_op.cast: (xf32) <- (xb)
        cast_2 = paddle._C_ops.cast(equal_1, paddle.float32)
        del equal_1

        # pd_op.add: (xf32) <- (xf32, xf32)
        add_36 = paddle._C_ops.add(sum_2, cast_2)
        del cast_2, sum_2

        # pd_op.divide: (xf32) <- (xf32, xf32)
        divide_0 = paddle._C_ops.divide(add_35, add_36)
        ...
        scale_5 = paddle._C_ops.scale(divide_0, full_6, float("0"), True)

        # pd_op.transpose: (4x128x128x2xf32) <- (4x2x128x128xf32)
        transpose_0 = paddle._C_ops.transpose(add_32, [0, 2, 3, 1])
        del add_32

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_5 = [4, -1, 2]

        # pd_op.reshape: (4x16384x2xf32) <- (4x128x128x2xf32, 3xi64)
        reshape_9 = paddle._C_ops.reshape(transpose_0, full_int_array_5)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_6 = [2]

        # pd_op.unsqueeze: (4x128x1xi64) <- (4x128xi64, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_5, full_int_array_6)
        del data_5
        ...
        combine_0 = [full_7, full_8, full_9, full_10]
        del full_10, full_7, full_8, full_9
        ...
        del combine_1, full_12

        # pd_op.gather_nd: (4x128x2xf32) <- (4x16384x2xf32, 4x128x2xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(reshape_9, concat_1)

        # pd_op.unsqueeze: (4x128x1xi32) <- (4x128xi32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_6, full_int_array_6)
        del data_6, full_int_array_6
        ...
        cast_3 = paddle._C_ops.cast(expand_as_0, paddle.float32)
        del expand_as_0

        # pd_op.sum: (xf32) <- (4x128x2xf32, 0xi64)
        sum_3 = paddle._C_ops.sum(cast_3, full_int_array_4, None, False)

        # pd_op.multiply: (4x128x2xf32) <- (4x128x2xf32, 4x128x2xf32)
        multiply_5 = paddle._C_ops.multiply(gather_nd_0, cast_3)

        # pd_op.multiply: (4x128x2xf32) <- (4x128x2xf32, 4x128x2xf32)
        multiply_6 = paddle._C_ops.multiply(data_8, cast_3)
        del data_8

        # pd_op.subtract: (4x128x2xf32) <- (4x128x2xf32, 4x128x2xf32)
        subtract_0 = paddle._C_ops.subtract(multiply_5, multiply_6)

        # pd_op.abs: (4x128x2xf32) <- (4x128x2xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)

        # pd_op.sum: (xf32) <- (4x128x2xf32, 0xi64)
        sum_4 = paddle._C_ops.sum(abs_0, full_int_array_4, None, False)

        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(sum_3, full_6, float("0.0001"), True)
        del sum_3

        # pd_op.divide: (xf32) <- (xf32, xf32)
        divide_1 = paddle._C_ops.divide(sum_4, scale_6)

        # pd_op.transpose: (4x128x128x2xf32) <- (4x2x128x128xf32)
        transpose_1 = paddle._C_ops.transpose(add_34, [0, 2, 3, 1])
        del add_34

        # pd_op.reshape: (4x16384x2xf32) <- (4x128x128x2xf32, 3xi64)
        reshape_10 = paddle._C_ops.reshape(transpose_1, full_int_array_5)
        del full_int_array_5

        # pd_op.gather_nd: (4x128x2xf32) <- (4x16384x2xf32, 4x128x2xi64)
        gather_nd_1 = paddle._C_ops.gather_nd(reshape_10, concat_1)
        ...
        # pd_op.cast: (4x128x2xf32) <- (4x128x2xi32)
        cast_4 = paddle._C_ops.cast(expand_as_1, paddle.float32)
        del expand_as_1

        # pd_op.sum: (xf32) <- (4x128x2xf32, 0xi64)
        sum_5 = paddle._C_ops.sum(cast_4, full_int_array_4, None, False)

        # pd_op.multiply: (4x128x2xf32) <- (4x128x2xf32, 4x128x2xf32)
        multiply_7 = paddle._C_ops.multiply(gather_nd_1, cast_4)

        # pd_op.multiply: (4x128x2xf32) <- (4x128x2xf32, 4x128x2xf32)
        multiply_8 = paddle._C_ops.multiply(data_3, cast_4)
        del data_3

        # pd_op.subtract: (4x128x2xf32) <- (4x128x2xf32, 4x128x2xf32)
        subtract_1 = paddle._C_ops.subtract(multiply_7, multiply_8)

        # pd_op.abs: (4x128x2xf32) <- (4x128x2xf32)
        abs_1 = paddle._C_ops.abs(subtract_1)

        # pd_op.sum: (xf32) <- (4x128x2xf32, 0xi64)
        sum_6 = paddle._C_ops.sum(abs_1, full_int_array_4, None, False)

        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(sum_5, full_6, float("0.0001"), True)
        del sum_5

        # pd_op.divide: (xf32) <- (xf32, xf32)
        divide_2 = paddle._C_ops.divide(sum_6, scale_7)

        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(scale_5, full_6, float("0"), True)
        ...
        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_9 = paddle._C_ops.scale(divide_1, full_13, float("0"), True)

        # pd_op.add: (xf32) <- (xf32, xf32)
        add_37 = paddle._C_ops.add(scale_8, scale_9)

        # pd_op.scale: (xf32) <- (xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(divide_2, full_6, float("0"), True)

        # pd_op.add: (xf32) <- (xf32, xf32)
        add_0 = paddle._C_ops.add(add_37, scale_10)
        del (
            abs_0,
            abs_1,
            add_20,
