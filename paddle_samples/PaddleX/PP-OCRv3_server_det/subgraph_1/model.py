...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x32x480x480xf32) <- (4x3x960x960xf32, 32x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_315, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_315
        ...
        # pd_op.conv2d: (4x32x480x480xf32) <- (4x32x480x480xf32, 32x32x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            relu_0, parameter_310, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_310
        ...
        # pd_op.conv2d: (4x64x480x480xf32) <- (4x32x480x480xf32, 64x32x3x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_305, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_305

        # pd_op.batch_norm_: (4x64x480x480xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (4x64x480x480xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.relu: (4x64x480x480xf32) <- (4x64x480x480xf32)
        ...
        # pd_op.pool2d: (4x64x240x240xf32) <- (4x64x480x480xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x64x240x240xf32) <- (4x64x240x240xf32, 64x64x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            pool2d_0, parameter_300, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_300

        # pd_op.batch_norm_: (4x64x240x240xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (4x64x240x240xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.relu: (4x64x240x240xf32) <- (4x64x240x240xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__18)
        del batch_norm__18

        # pd_op.conv2d: (4x64x240x240xf32) <- (4x64x240x240xf32, 64x64x3x3xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_295, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_295
        ...
        # pd_op.conv2d: (4x256x240x240xf32) <- (4x64x240x240xf32, 256x64x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            relu_4, parameter_290, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_290

        # pd_op.batch_norm_: (4x256x240x240xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x240x240xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__30,
            batch_norm__31,
            batch_norm__32,
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            pool2d_0, parameter_285, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_285
        ...
        # pd_op.add: (4x256x240x240xf32) <- (4x256x240x240xf32, 4x256x240x240xf32)
        add_0 = paddle._C_ops.add(batch_norm__36, batch_norm__30)

        # pd_op.relu: (4x256x240x240xf32) <- (4x256x240x240xf32)
        relu_5 = paddle._C_ops.relu(add_0)
        del add_0

        # pd_op.conv2d: (4x64x240x240xf32) <- (4x256x240x240xf32, 64x256x1x1xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            relu_5, parameter_280, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_280
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            relu_6, parameter_275, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_275
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_7, parameter_270, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_270
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_8, parameter_265, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_265
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            relu_9, parameter_260, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_260
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            relu_10, parameter_255, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_255
        ...
        # pd_op.conv2d: (4x128x240x240xf32) <- (4x256x240x240xf32, 128x256x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_11, parameter_250, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_250

        # pd_op.batch_norm_: (4x128x240x240xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x240x240xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__78,
            batch_norm__79,
            batch_norm__80,
        ...
        # pd_op.relu: (4x128x240x240xf32) <- (4x128x240x240xf32)
        relu_12 = paddle._C_ops.relu(batch_norm__78)
        del batch_norm__78

        # pd_op.conv2d: (4x128x120x120xf32) <- (4x128x240x240xf32, 128x128x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_12, parameter_245, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_245

        # pd_op.batch_norm_: (4x128x120x120xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x120x120xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__84,
            batch_norm__85,
            batch_norm__86,
        ...
        # pd_op.relu: (4x128x120x120xf32) <- (4x128x120x120xf32)
        relu_13 = paddle._C_ops.relu(batch_norm__84)
        del batch_norm__84

        # pd_op.conv2d: (4x512x120x120xf32) <- (4x128x120x120xf32, 512x128x1x1xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            relu_13, parameter_240, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_240

        # pd_op.batch_norm_: (4x512x120x120xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (4x512x120x120xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__90,
            batch_norm__91,
            batch_norm__92,
        ...
        # pd_op.pool2d: (4x256x120x120xf32) <- (4x256x240x240xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x512x120x120xf32) <- (4x256x120x120xf32, 512x256x1x1xf32)
        conv2d_16 = paddle._C_ops.conv2d(
            pool2d_1, parameter_235, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_235
        ...
        # pd_op.add: (4x512x120x120xf32) <- (4x512x120x120xf32, 4x512x120x120xf32)
        add_3 = paddle._C_ops.add(batch_norm__96, batch_norm__90)

        # pd_op.relu: (4x512x120x120xf32) <- (4x512x120x120xf32)
        relu_14 = paddle._C_ops.relu(add_3)
        del add_3

        # pd_op.conv2d: (4x128x120x120xf32) <- (4x512x120x120xf32, 128x512x1x1xf32)
        conv2d_17 = paddle._C_ops.conv2d(
            relu_14, parameter_230, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_230
        ...
        # pd_op.conv2d: (4x128x120x120xf32) <- (4x128x120x120xf32, 128x128x3x3xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            relu_15, parameter_225, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_225
        ...
        conv2d_19 = paddle._C_ops.conv2d(
            relu_16, parameter_220, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_220
        ...
        conv2d_20 = paddle._C_ops.conv2d(
            relu_17, parameter_215, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_215
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            relu_18, parameter_210, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_210
        ...
        conv2d_22 = paddle._C_ops.conv2d(
            relu_19, parameter_205, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_205
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            relu_20, parameter_200, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_200
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            relu_21, parameter_195, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_195
        ...
        conv2d_25 = paddle._C_ops.conv2d(
            relu_22, parameter_190, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_190
        ...
        # pd_op.conv2d: (4x256x120x120xf32) <- (4x512x120x120xf32, 256x512x1x1xf32)
        conv2d_26 = paddle._C_ops.conv2d(
            relu_23, parameter_185, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_185

        # pd_op.batch_norm_: (4x256x120x120xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x120x120xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__156,
            batch_norm__157,
            batch_norm__158,
        ...
        # pd_op.relu: (4x256x120x120xf32) <- (4x256x120x120xf32)
        relu_24 = paddle._C_ops.relu(batch_norm__156)
        del batch_norm__156

        # pd_op.conv2d: (4x256x60x60xf32) <- (4x256x120x120xf32, 256x256x3x3xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            relu_24, parameter_180, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_180
        ...
        # pd_op.relu: (4x256x60x60xf32) <- (4x256x60x60xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__162)
        del batch_norm__162

        # pd_op.conv2d: (4x1024x60x60xf32) <- (4x256x60x60xf32, 1024x256x1x1xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            relu_25, parameter_175, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_175

        # pd_op.batch_norm_: (4x1024x60x60xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32, -1xui8) <- (4x1024x60x60xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.pool2d: (4x512x60x60xf32) <- (4x512x120x120xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x1024x60x60xf32) <- (4x512x60x60xf32, 1024x512x1x1xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            pool2d_2, parameter_170, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_170
        ...
        # pd_op.add: (4x1024x60x60xf32) <- (4x1024x60x60xf32, 4x1024x60x60xf32)
        add_7 = paddle._C_ops.add(batch_norm__174, batch_norm__168)

        # pd_op.relu: (4x1024x60x60xf32) <- (4x1024x60x60xf32)
        relu_26 = paddle._C_ops.relu(add_7)
        del add_7

        # pd_op.conv2d: (4x256x60x60xf32) <- (4x1024x60x60xf32, 256x1024x1x1xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            relu_26, parameter_165, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_165
        ...
        # pd_op.conv2d: (4x256x60x60xf32) <- (4x256x60x60xf32, 256x256x3x3xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            relu_27, parameter_160, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_160
        ...
        conv2d_32 = paddle._C_ops.conv2d(
            relu_28, parameter_155, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_155
        ...
        conv2d_33 = paddle._C_ops.conv2d(
            relu_29, parameter_150, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_150
        ...
        conv2d_34 = paddle._C_ops.conv2d(
            relu_30, parameter_145, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_145
        ...
        conv2d_35 = paddle._C_ops.conv2d(
            relu_31, parameter_140, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_140
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            relu_32, parameter_135, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_135
        ...
        conv2d_37 = paddle._C_ops.conv2d(
            relu_33, parameter_130, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_130
        ...
        conv2d_38 = paddle._C_ops.conv2d(
            relu_34, parameter_125, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_125
        ...
        conv2d_39 = paddle._C_ops.conv2d(
            relu_35, parameter_120, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_120
        ...
        conv2d_40 = paddle._C_ops.conv2d(
            relu_36, parameter_115, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_115
        ...
        conv2d_41 = paddle._C_ops.conv2d(
            relu_37, parameter_110, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_110
        ...
        conv2d_42 = paddle._C_ops.conv2d(
            relu_38, parameter_105, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_105
        ...
        conv2d_43 = paddle._C_ops.conv2d(
            relu_39, parameter_100, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_100
        ...
        conv2d_44 = paddle._C_ops.conv2d(
            relu_40, parameter_95, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_95
        ...
        # pd_op.conv2d: (4x512x60x60xf32) <- (4x1024x60x60xf32, 512x1024x1x1xf32)
        conv2d_45 = paddle._C_ops.conv2d(
            relu_41, parameter_90, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_90

        # pd_op.batch_norm_: (4x512x60x60xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (4x512x60x60xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__270,
            batch_norm__271,
            batch_norm__272,
        ...
        # pd_op.relu: (4x512x60x60xf32) <- (4x512x60x60xf32)
        relu_42 = paddle._C_ops.relu(batch_norm__270)
        del batch_norm__270

        # pd_op.conv2d: (4x512x30x30xf32) <- (4x512x60x60xf32, 512x512x3x3xf32)
        conv2d_46 = paddle._C_ops.conv2d(
            relu_42, parameter_85, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_85

        # pd_op.batch_norm_: (4x512x30x30xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (4x512x30x30xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.relu: (4x512x30x30xf32) <- (4x512x30x30xf32)
        relu_43 = paddle._C_ops.relu(batch_norm__276)
        del batch_norm__276

        # pd_op.conv2d: (4x2048x30x30xf32) <- (4x512x30x30xf32, 2048x512x1x1xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            relu_43, parameter_80, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_80

        # pd_op.batch_norm_: (4x2048x30x30xf32, 2048xf32, 2048xf32, 2048xf32, 2048xf32, -1xui8) <- (4x2048x30x30xf32, 2048xf32, 2048xf32, 2048xf32, 2048xf32)
        (
            batch_norm__282,
            batch_norm__283,
            batch_norm__284,
        ...
        # pd_op.pool2d: (4x1024x30x30xf32) <- (4x1024x60x60xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x2048x30x30xf32) <- (4x1024x30x30xf32, 2048x1024x1x1xf32)
        conv2d_48 = paddle._C_ops.conv2d(
            pool2d_3, parameter_75, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_75
        ...
        # pd_op.add: (4x2048x30x30xf32) <- (4x2048x30x30xf32, 4x2048x30x30xf32)
        add_13 = paddle._C_ops.add(batch_norm__288, batch_norm__282)

        # pd_op.relu: (4x2048x30x30xf32) <- (4x2048x30x30xf32)
        relu_44 = paddle._C_ops.relu(add_13)
        del add_13

        # pd_op.conv2d: (4x512x30x30xf32) <- (4x2048x30x30xf32, 512x2048x1x1xf32)
        conv2d_49 = paddle._C_ops.conv2d(
            relu_44, parameter_70, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_70
        ...
        # pd_op.conv2d: (4x512x30x30xf32) <- (4x512x30x30xf32, 512x512x3x3xf32)
        conv2d_50 = paddle._C_ops.conv2d(
            relu_45, parameter_65, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_65
        ...
        conv2d_51 = paddle._C_ops.conv2d(
            relu_46, parameter_60, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_60
        ...
        conv2d_52 = paddle._C_ops.conv2d(
            relu_47, parameter_55, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_55
        ...
        conv2d_53 = paddle._C_ops.conv2d(
            relu_48, parameter_50, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_50
        ...
        conv2d_54 = paddle._C_ops.conv2d(
            relu_49, parameter_45, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_45
        ...
        # pd_op.conv2d: (4x256x30x30xf32) <- (4x2048x30x30xf32, 256x2048x1x1xf32)
        conv2d_55 = paddle._C_ops.conv2d(
            relu_50, parameter_40, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_40
        ...
        conv2d_57 = paddle._C_ops.conv2d(
            relu_23, parameter_38, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_38

        # pd_op.conv2d: (4x256x240x240xf32) <- (4x256x240x240xf32, 256x256x1x1xf32)
        conv2d_58 = paddle._C_ops.conv2d(
            relu_11, parameter_37, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_37

        # pd_op.nearest_interp: (4x256x60x60xf32) <- (4x256x30x30xf32, None, None, None)
        ...
        # pd_op.add: (4x256x60x60xf32) <- (4x256x60x60xf32, 4x256x60x60xf32)
        add_16 = paddle._C_ops.add(conv2d_56, nearest_interp_0)

        # pd_op.nearest_interp: (4x256x120x120xf32) <- (4x256x60x60xf32, None, None, None)
        ...
        # pd_op.add: (4x256x120x120xf32) <- (4x256x120x120xf32, 4x256x120x120xf32)
        add_17 = paddle._C_ops.add(conv2d_57, nearest_interp_1)

        # pd_op.nearest_interp: (4x256x240x240xf32) <- (4x256x120x120xf32, None, None, None)
        ...
        # pd_op.conv2d: (4x64x30x30xf32) <- (4x256x30x30xf32, 64x256x9x9xf32)
        conv2d_59 = paddle._C_ops.conv2d(
            conv2d_55, parameter_36, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_36

        # pd_op.conv2d: (4x64x60x60xf32) <- (4x256x60x60xf32, 64x256x9x9xf32)
        conv2d_60 = paddle._C_ops.conv2d(
            add_16, parameter_35, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_35

        # pd_op.conv2d: (4x64x120x120xf32) <- (4x256x120x120xf32, 64x256x9x9xf32)
        conv2d_61 = paddle._C_ops.conv2d(
            add_17, parameter_34, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_34

        # pd_op.conv2d: (4x64x240x240xf32) <- (4x256x240x240xf32, 64x256x9x9xf32)
        conv2d_62 = paddle._C_ops.conv2d(
            add_18, parameter_33, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_33

        # pd_op.conv2d: (4x64x120x120xf32) <- (4x64x240x240xf32, 64x64x3x3xf32)
        conv2d_63 = paddle._C_ops.conv2d(
            conv2d_62, parameter_32, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_32

        # pd_op.add: (4x64x120x120xf32) <- (4x64x120x120xf32, 4x64x120x120xf32)
        add_19 = paddle._C_ops.add(conv2d_61, conv2d_63)

        # pd_op.conv2d: (4x64x60x60xf32) <- (4x64x120x120xf32, 64x64x3x3xf32)
        conv2d_64 = paddle._C_ops.conv2d(
            add_19, parameter_31, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_31

        # pd_op.add: (4x64x60x60xf32) <- (4x64x60x60xf32, 4x64x60x60xf32)
        add_20 = paddle._C_ops.add(conv2d_60, conv2d_64)

        # pd_op.conv2d: (4x64x30x30xf32) <- (4x64x60x60xf32, 64x64x3x3xf32)
        conv2d_65 = paddle._C_ops.conv2d(
            add_20, parameter_30, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_30

        # pd_op.add: (4x64x30x30xf32) <- (4x64x30x30xf32, 4x64x30x30xf32)
        add_21 = paddle._C_ops.add(conv2d_59, conv2d_65)

        # pd_op.conv2d: (4x64x240x240xf32) <- (4x64x240x240xf32, 64x64x9x9xf32)
        conv2d_66 = paddle._C_ops.conv2d(
            conv2d_62, parameter_29, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_29

        # pd_op.conv2d: (4x64x120x120xf32) <- (4x64x120x120xf32, 64x64x9x9xf32)
        conv2d_67 = paddle._C_ops.conv2d(
            add_19, parameter_28, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_28

        # pd_op.conv2d: (4x64x60x60xf32) <- (4x64x60x60xf32, 64x64x9x9xf32)
        conv2d_68 = paddle._C_ops.conv2d(
            add_20, parameter_27, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_27

        # pd_op.conv2d: (4x64x30x30xf32) <- (4x64x30x30xf32, 64x64x9x9xf32)
        conv2d_69 = paddle._C_ops.conv2d(
            add_21, parameter_26, [1, 1], [4, 4], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_26

        # pd_op.nearest_interp: (4x64x240x240xf32) <- (4x64x30x30xf32, None, None, None)
        ...
        # pd_op.nearest_interp: (4x64x240x240xf32) <- (4x64x60x60xf32, None, None, None)
        ...
        # pd_op.nearest_interp: (4x64x240x240xf32) <- (4x64x120x120xf32, None, None, None)
        ...
        # builtin.combine: ([4x64x240x240xf32, 4x64x240x240xf32, 4x64x240x240xf32, 4x64x240x240xf32]) <- (4x64x240x240xf32, 4x64x240x240xf32, 4x64x240x240xf32, 4x64x240x240xf32)
        combine_0 = [nearest_interp_3, nearest_interp_4, nearest_interp_5, conv2d_66]

        # pd_op.concat: (4x256x240x240xf32) <- ([4x64x240x240xf32, 4x64x240x240xf32, 4x64x240x240xf32, 4x64x240x240xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0

        # pd_op.conv2d: (4x64x240x240xf32) <- (4x256x240x240xf32, 64x256x7x7xf32)
        conv2d_70 = paddle._C_ops.conv2d(
            concat_1, parameter_25, [1, 1], [3, 3], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_25
        ...
        # pd_op.conv2d_transpose: (4x64x480x480xf32) <- (4x64x240x240xf32, 64x64x2x2xf32, 0xi64)
        ...
        reshape_0 = paddle._C_ops.reshape(parameter_19, full_int_array_3)
        del parameter_19

        # pd_op.add: (4x64x480x480xf32) <- (4x64x480x480xf32, 1x64x1x1xf32)
        ...
        # pd_op.conv2d_transpose: (4x1x960x960xf32) <- (4x64x480x480xf32, 64x1x2x2xf32, 0xi64)
        ...
        reshape_1 = paddle._C_ops.reshape(parameter_13, full_int_array_4)
        del parameter_13
        ...
        conv2d_71 = paddle._C_ops.conv2d(
            concat_1, parameter_12, [1, 1], [3, 3], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_12
        ...
        # pd_op.reshape: (1x64x1x1xf32) <- (64xf32, 4xi64)
        reshape_2 = paddle._C_ops.reshape(parameter_6, full_int_array_3)
        del full_int_array_3, parameter_6

        # pd_op.add: (4x64x480x480xf32) <- (4x64x480x480xf32, 1x64x1x1xf32)
        add_24 = paddle._C_ops.add(conv2d_transpose_2, reshape_2)
        ...
        # pd_op.reshape: (1x1x1x1xf32) <- (1xf32, 4xi64)
        reshape_3 = paddle._C_ops.reshape(parameter_0, full_int_array_4)
        del full_int_array_4, parameter_0

        # pd_op.add: (4x1x960x960xf32) <- (4x1x960x960xf32, 1x1x1x1xf32)
        add_25 = paddle._C_ops.add(conv2d_transpose_3, reshape_3)

        # pd_op.sigmoid: (4x1x960x960xf32) <- (4x1x960x960xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(add_25)
        del add_25
