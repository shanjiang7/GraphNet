...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.unsqueeze: (16x1x2577x4xf32) <- (16x2577x4xf32, 1xi64)
        ...
        # pd_op.slice: (16x1x2577x2xf32) <- (16x1x2577x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (16x5x2577x2xf32) <- (16x5x1x2xf32, 16x1x2577x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (16x5x2577x2xf32) <- (16x5x1x2xf32, 16x1x2577x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (16x5x2577x2xf32) <- (16x5x2577x2xf32, 16x5x2577x2xf32)
        ...
        # pd_op.clip: (16x5x2577x2xf32) <- (16x5x2577x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (16x5x2577xf32) <- (16x5x2577x2xf32, 1xi64)
        ...
        # pd_op.subtract: (16x1x2577x2xf32) <- (16x1x2577x2xf32, 16x1x2577x2xf32)
        subtract_2 = paddle._C_ops.subtract(slice_3, slice_2)
        del slice_2, slice_3

        # pd_op.clip: (16x1x2577x2xf32) <- (16x1x2577x2xf32, 1xf32, 1xf32)
        clip_2 = paddle._C_ops.clip(subtract_2, full_0, full_1)
        del full_0, full_1, subtract_2

        # pd_op.prod: (16x1x2577xf32) <- (16x1x2577x2xf32, 1xi64)
        prod_2 = paddle._C_ops.prod(clip_2, full_int_array_4, False, False)
        del clip_2

        # pd_op.add: (16x5x2577xf32) <- (16x5x1xf32, 16x1x2577xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (16x5x2577xf32) <- (16x5x2577xf32, 16x5x2577xf32)
        ...
        # pd_op.scale: (16x5x2577xf32) <- (16x5x2577xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)
        del full_2, subtract_3

        # pd_op.divide: (16x5x2577xf32) <- (16x5x2577xf32, 16x5x2577xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.transpose: (16x4x2577xf32) <- (16x2577x4xf32)
        ...
        # pd_op.subtract: (16x5x2577x1xf32) <- (1x1x2577x1xf32, 16x5x1x1xf32)
        ...
        # pd_op.subtract: (16x5x2577x1xf32) <- (16x5x1x1xf32, 1x1x2577x1xf32)
        ...
        # builtin.combine: ([16x5x2577x1xf32, 16x5x2577x1xf32, 16x5x2577x1xf32, 16x5x2577x1xf32]) <- (16x5x2577x1xf32, 16x5x2577x1xf32, 16x5x2577x1xf32, 16x5x2577x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (16x5x2577x4xf32) <- ([16x5x2577x1xf32, 16x5x2577x1xf32, 16x5x2577x1xf32, 16x5x2577x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.min: (16x5x2577xf32) <- (16x5x2577x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (16x5x2577xb) <- (16x5x2577xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)
        del full_8, min_0

        # pd_op.cast: (16x5x2577xf32) <- (16x5x2577xb)
        ...
        # pd_op.topk: (16x5x13xf32, 16x5x13xi64) <- (16x5x2577xf32, 1xi32)
        ...
        # pd_op.one_hot: (16x5x13x2577xf32) <- (16x5x13xi64, 1xi32)
        ...
        # pd_op.sum: (16x5x2577xf32) <- (16x5x13x2577xf32, 1xi64)
        ...
        # pd_op.sum: (16x2577xf32) <- (16x5x2577xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (16x2577xf32, 0xi64)
