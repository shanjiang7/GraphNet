...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.maximum: (48x3060x2xf32) <- (48x1x2xf32, 1x3060x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (48x3060x2xf32) <- (48x1x2xf32, 1x3060x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (48x3060x2xf32) <- (48x3060x2xf32, 48x3060x2xf32)
        ...
        # pd_op.clip: (48x3060x2xf32) <- (48x3060x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (48x3060xf32) <- (48x3060x2xf32, 1xi64)
        ...
        # pd_op.add: (48x3060xf32) <- (48x1xf32, 1x3060xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (48x3060xf32) <- (48x3060xf32, 48x3060xf32)
        ...
        # pd_op.scale: (48x3060xf32) <- (48x3060xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-10"), True)
        del full_2, subtract_3

        # pd_op.divide: (48x3060xf32) <- (48x3060xf32, 48x3060xf32)
        ...
        # pd_op.reshape: (16x3x3060xf32) <- (48x3060xf32, 3xi64)
        ...
        # pd_op.subtract: (48x3060x2xf32) <- (48x1x2xf32, 1x3060x2xf32)
        subtract_4 = paddle._C_ops.subtract(unsqueeze_2, unsqueeze_3)
        del unsqueeze_2, unsqueeze_3

        # pd_op.p_norm: (48x3060xf32) <- (48x3060x2xf32)
