...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.unsqueeze: (1x3060x4xf32) <- (3060x4xf32, 1xi64)
        ...
        # pd_op.slice: (1x3060x2xf32) <- (1x3060x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (-1x3060x2xf32) <- (-1x1x2xf32, 1x3060x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (-1x3060x2xf32) <- (-1x1x2xf32, 1x3060x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (-1x3060x2xf32) <- (-1x3060x2xf32, -1x3060x2xf32)
        ...
        # pd_op.clip: (-1x3060x2xf32) <- (-1x3060x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (-1x3060xf32) <- (-1x3060x2xf32, 1xi64)
        ...
        # pd_op.add: (-1x3060xf32) <- (-1x1xf32, 1x3060xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (-1x3060xf32) <- (-1x3060xf32, -1x3060xf32)
        ...
        # pd_op.scale: (-1x3060xf32) <- (-1x3060xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_3, float("1e-10"), True)
        del full_3, subtract_3

        # pd_op.divide: (-1x3060xf32) <- (-1x3060xf32, -1x3060xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [16, -1, 3060]

        # pd_op.reshape: (16x-1x3060xf32) <- (-1x3060xf32, 3xi64)
        ...
        scale_1 = paddle._C_ops.scale(add_1, full_4, float("0"), True)
        del add_1
        ...
        # pd_op.scale: (-1xf32) <- (-1xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(add_2, full_4, float("0"), True)
        del add_2
        ...
        slice_8 = paddle._C_ops.slice(
            data_1, [1], full_int_array_2, full_int_array_1, [1], [1]
        )

        # pd_op.slice: (3060xf32) <- (3060x4xf32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            data_1, [1], full_int_array_3, full_int_array_7, [1], [1]
        )
        ...
        scale_3 = paddle._C_ops.scale(add_3, full_4, float("0"), True)
        del add_3
        ...
        slice_11 = paddle._C_ops.slice(
            data_1, [1], full_int_array_7, full_int_array_8, [1], [1]
        )
        del data_1, full_int_array_7, full_int_array_8
        ...
        # pd_op.scale: (3060xf32) <- (3060xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(add_4, full_4, float("0"), True)
        del add_4, full_4
