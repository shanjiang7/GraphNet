...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        # pd_op.multiply: (16x3x3060xf32) <- (16x3x3060xf32, 16x3x3060xf32)
        multiply_0 = paddle._C_ops.multiply(data_2, data_0)
        del data_2

        # pd_op.flatten: (48x3060xf32) <- (16x3x3060xf32)
        ...
        # pd_op.index_sample: (48x36xf32) <- (48x3060xf32, 48x36xi64)
        ...
        # pd_op.mean: (16x3x1xf32) <- (16x3x36xf32, 1xi64)
        ...
        # pd_op.subtract: (16x3x3060x1xf32) <- (1x1x3060x1xf32, 16x3x1x1xf32)
        ...
        # pd_op.subtract: (16x3x3060x1xf32) <- (16x3x1x1xf32, 1x1x3060x1xf32)
        ...
        # builtin.combine: ([16x3x3060x1xf32, 16x3x3060x1xf32, 16x3x3060x1xf32, 16x3x3060x1xf32]) <- (16x3x3060x1xf32, 16x3x3060x1xf32, 16x3x3060x1xf32, 16x3x3060x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]
        del subtract_1, subtract_2, subtract_3, subtract_4

        # pd_op.concat: (16x3x3060x4xf32) <- ([16x3x3060x1xf32, 16x3x3060x1xf32, 16x3x3060x1xf32, 16x3x3060x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_3)
        del combine_0, full_3

        # pd_op.min: (16x3x3060xf32) <- (16x3x3060x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (16x3x3060xb) <- (16x3x3060xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_0, full_4)
        del full_4, min_0

        # pd_op.cast: (16x3x3060xf32) <- (16x3x3060xb)
        ...
        # pd_op.multiply: (16x3x3060xf32) <- (16x3x3060xf32, 16x3x1xf32)
        ...
        # pd_op.sum: (16x3060xf32) <- (16x3x3060xf32, 1xi64)
