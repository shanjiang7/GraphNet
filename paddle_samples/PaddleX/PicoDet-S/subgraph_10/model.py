...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.topk: (16x-1x9xf32, 16x-1x9xi64) <- (16x-1x2304xf32, 1xi32)
        ...
        full_2 = paddle._C_ops.full(
            [1], float("2304"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (16x-1x9x2304xf32) <- (16x-1x9xi64, 1xi32)
        ...
        # pd_op.sum: (16x-1x2304xf32) <- (16x-1x9x2304xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)
        del one_hot_0

        # pd_op.multiply: (16x-1x2304xf32) <- (16x-1x2304xf32, 16x-1x1xf32)
        multiply_0 = paddle._C_ops.multiply(sum_0, data_4)
        del sum_0

        # pd_op.topk: (16x-1x9xf32, 16x-1x9xi64) <- (16x-1x576xf32, 1xi32)
        ...
        # pd_op.scale: (16x-1x9xi64) <- (16x-1x9xi64, 1xf32)
        scale_1 = paddle._C_ops.scale(topk_3, full_1, float("2304"), True)

        # pd_op.full: (1xi32) <- ()
        full_3 = paddle._C_ops.full(
            [1], float("576"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (16x-1x9x576xf32) <- (16x-1x9xi64, 1xi32)
        one_hot_1 = paddle._C_ops.one_hot(
            topk_3 % paddle.cast(full_3, topk_3.dtype), full_3
        )
        del full_3, topk_3

        # pd_op.sum: (16x-1x576xf32) <- (16x-1x9x576xf32, 1xi64)
        sum_1 = paddle._C_ops.sum(one_hot_1, full_int_array_0, None, False)
        del one_hot_1

        # pd_op.multiply: (16x-1x576xf32) <- (16x-1x576xf32, 16x-1x1xf32)
        multiply_1 = paddle._C_ops.multiply(sum_1, data_4)
        del sum_1

        # pd_op.topk: (16x-1x9xf32, 16x-1x9xi64) <- (16x-1x144xf32, 1xi32)
        ...
        # pd_op.scale: (16x-1x9xi64) <- (16x-1x9xi64, 1xf32)
        scale_2 = paddle._C_ops.scale(topk_5, full_1, float("2880"), True)

        # pd_op.full: (1xi32) <- ()
        full_4 = paddle._C_ops.full(
            [1], float("144"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (16x-1x9x144xf32) <- (16x-1x9xi64, 1xi32)
        one_hot_2 = paddle._C_ops.one_hot(
            topk_5 % paddle.cast(full_4, topk_5.dtype), full_4
        )
        del full_4, topk_5

        # pd_op.sum: (16x-1x144xf32) <- (16x-1x9x144xf32, 1xi64)
        sum_2 = paddle._C_ops.sum(one_hot_2, full_int_array_0, None, False)
        del one_hot_2

        # pd_op.multiply: (16x-1x144xf32) <- (16x-1x144xf32, 16x-1x1xf32)
        multiply_2 = paddle._C_ops.multiply(sum_2, data_4)
        del sum_2

        # pd_op.topk: (16x-1x9xf32, 16x-1x9xi64) <- (16x-1x36xf32, 1xi32)
        ...
        # pd_op.scale: (16x-1x9xi64) <- (16x-1x9xi64, 1xf32)
        scale_3 = paddle._C_ops.scale(topk_7, full_1, float("3024"), True)
        del full_1
        ...
        # builtin.combine: ([16x-1x2304xf32, 16x-1x576xf32, 16x-1x144xf32, 16x-1x36xf32]) <- (16x-1x2304xf32, 16x-1x576xf32, 16x-1x144xf32, 16x-1x36xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]
        del multiply_0, multiply_1, multiply_2, multiply_3

        # pd_op.concat: (16x-1x3060xf32) <- ([16x-1x2304xf32, 16x-1x576xf32, 16x-1x144xf32, 16x-1x36xf32], 1xi32)
