...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.transpose: (16x4x-1xf32) <- (16x-1x4xf32)
        ...
        # pd_op.tile: (16x-1xi32) <- (16x1xi32, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_2, stack_0)
        del stack_0

        # pd_op.squeeze: (16x-1xi32) <- (16x-1x1xi32, 1xi64)
        squeeze_0 = paddle._C_ops.squeeze(data_4, full_int_array_4)
        del data_4

        # builtin.combine: ([16x-1xi32, 16x-1xi32]) <- (16x-1xi32, 16x-1xi32)
        combine_1 = [tile_0, squeeze_0]
        del squeeze_0, tile_0

        # pd_op.stack: (16x-1x2xi32) <- ([16x-1xi32, 16x-1xi32])
        stack_1 = paddle._C_ops.stack(combine_1, -1)
        del combine_1

        # pd_op.gather_nd: (16x-1x-1xf32) <- (16x4x-1xf32, 16x-1x2xi32)
        ...
        # pd_op.subtract: (16x-1x-1x1xf32) <- (1x1x-1x1xf32, 16x-1x1x1xf32)
        ...
        # pd_op.subtract: (16x-1x-1x1xf32) <- (16x-1x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([16x-1x-1x1xf32, 16x-1x-1x1xf32, 16x-1x-1x1xf32, 16x-1x-1x1xf32]) <- (16x-1x-1x1xf32, 16x-1x-1x1xf32, 16x-1x-1x1xf32, 16x-1x-1x1xf32)
        combine_2 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (16x-1x-1x4xf32) <- ([16x-1x-1x1xf32, 16x-1x-1x1xf32, 16x-1x-1x1xf32, 16x-1x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_2, full_9)
        del combine_2, full_9

        # pd_op.min: (16x-1x-1xf32) <- (16x-1x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (16x-1x-1xb) <- (16x-1x-1xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_10)
        del full_10, min_0

        # pd_op.cast: (16x-1x-1xf32) <- (16x-1x-1xb)
        ...
        # pd_op.topk: (16x-1x13xf32, 16x-1x13xi64) <- (16x-1x-1xf32, 1xi32)
        ...
        # pd_op.one_hot: (16x-1x13x-1xf32) <- (16x-1x13xi64, xi64)
        ...
        # pd_op.sum: (16x-1x-1xf32) <- (16x-1x13x-1xf32, 1xi64)
        ...
        # pd_op.sum: (16x-1xf32) <- (16x-1x-1xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (16x-1xf32, 0xi64)
