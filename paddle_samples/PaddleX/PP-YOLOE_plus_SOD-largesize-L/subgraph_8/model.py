...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        # pd_op.cast: (1x24276xi32) <- (1x24276xb)
        ...
        # pd_op.unsqueeze: (1x24276x1xi32) <- (1x24276xi32, 1xi64)
        ...
        # pd_op.tile: (1x24276x4xi32) <- (1x24276x1xi32, 3xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_0, full_int_array_1)
        del full_int_array_1, unsqueeze_0

        # pd_op.cast: (1x24276x4xb) <- (1x24276x4xi32)
        cast_1 = paddle._C_ops.cast(tile_0, paddle.bool)
        del tile_0

        # pd_op.masked_select: (-1xf32) <- (1x24276x4xf32, 1x24276x4xb)
        ...
        # pd_op.sum: (1x24276xf32) <- (1x24276x10xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(data_3, full_int_array_0, None, False)
        del data_3

        # pd_op.masked_select: (-1xf32) <- (1x24276xf32, 1x24276xb)
        ...
        # pd_op.unsqueeze: (1x24276x1xb) <- (1x24276xb, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(data_0, full_int_array_0)
        del data_0

        # pd_op.cast: (1x24276x1xi32) <- (1x24276x1xb)
        ...
        # pd_op.tile: (1x24276x88xi32) <- (1x24276x1xi32, 3xi64)
        tile_1 = paddle._C_ops.tile(cast_2, full_int_array_4)
        del cast_2, full_int_array_4

        # pd_op.cast: (1x24276x88xb) <- (1x24276x88xi32)
        cast_3 = paddle._C_ops.cast(tile_1, paddle.bool)
        del tile_1

        # pd_op.masked_select: (-1xf32) <- (1x24276x88xf32, 1x24276x88xb)
        ...
        # pd_op.split_with_num: ([1x24276x2xf32, 1x24276x2xf32]) <- (1x24276x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(data_2, 2, full_5)
        del data_2, full_5

        # builtin.split: (1x24276x2xf32, 1x24276x2xf32) <- ([1x24276x2xf32, 1x24276x2xf32])
        (
            split_8,
            split_9,
        ) = split_with_num_2
        ...
        # pd_op.subtract: (1x24276x2xf32) <- (24276x2xf32, 1x24276x2xf32)
        subtract_12 = paddle._C_ops.subtract(data_6, split_8)
        del split_8

        # pd_op.subtract: (1x24276x2xf32) <- (1x24276x2xf32, 24276x2xf32)
        ...
        # builtin.combine: ([1x24276x2xf32, 1x24276x2xf32]) <- (1x24276x2xf32, 1x24276x2xf32)
        combine_0 = [subtract_12, subtract_13]
        del subtract_12, subtract_13

        # pd_op.concat: (1x24276x4xf32) <- ([1x24276x2xf32, 1x24276x2xf32], 1xi32)
        ...
        # pd_op.clip: (1x24276x4xf32) <- (1x24276x4xf32, 1xf32, 1xf32)
