...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        full_1 = paddle._C_ops.full(
            [], float("21"), paddle.int64, paddle.core.CPUPlace()
        )
        ...
        # pd_op.full_with_tensor: (1x-1x21x1xf32) <- (1xf32, 4xi64)
        ...
        # pd_op.set_value_: (1x-1x21x1xf32) <- (1x-1x21x1xf32, 2xi64, 2xi64, 2xi64)
        ...
        # pd_op.shape64: (4xi64) <- (1x-1x21x1xf32)
        ...
        combine_1 = [full_4, floor_divide_0, full_5, full_6, full_5, full_0]
        del floor_divide_0, full_0, full_4, full_5, full_6

        # pd_op.stack: (6xi64) <- ([xi64, xi64, xi64, xi64, xi64, xi64])
        stack_1 = paddle._C_ops.stack(combine_1, 0)
        del combine_1

        # pd_op.reshape: (-1x-1x7x3x7x1xf32) <- (1x-1x21x1xf32, 6xi64)
        reshape_0 = paddle._C_ops.reshape(set_value__8, stack_1)
        del stack_1

        # pd_op.transpose: (-1x-1x3x7x7x1xf32) <- (-1x-1x7x3x7x1xf32)
        ...
        # pd_op.reshape: (-1x7x7x1xf32) <- (-1x-1x3x7x7x1xf32, 4xi64)
        ...
        scale_0 = paddle._C_ops.scale(full_like_0, full_8, float("0"), True)
        del full_8, full_like_0
        ...
        not_equal_0 = paddle._C_ops.not_equal(subtract_0, full_9)
        del full_9, subtract_0
