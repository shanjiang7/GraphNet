class Program_weight_tensor_data_0:
    ...
    shape = [169, 12]
    dtype = "float32"
    min_val = float("-9.66443")
    max_val = float("2.40637")
    mean = float("-0.42563")
    std = float("0.886512")
    data = None
...
class Program_weight_tensor_data_2:
    name = "data_2"
    original_name = "var_8192"
    shape = [2, 1920, 384]
    dtype = "float32"
    min_val = float("-138.555")
    max_val = float("77.1573")
    mean = float("0.0821678")
    std = float("1.61354")
    data = None
