...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        scale_1 = paddle._C_ops.scale(square_2, full_1, float("1"), True)
        del square_2
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(scale_1, full_2, float("1e-06"), True)
        del scale_1
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(matmul_0, full_3, float("0"), True)
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(sqrt_2, full_4, float("0"), True)

        # pd_op.subtract: (-1x93431xf32) <- (-1x93431xf32, -1x93431xf32)
        subtract_0 = paddle._C_ops.subtract(scale_3, scale_4)

        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(matmul_0, full_2, float("-0.239713"), True)
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(cast_0, full_1, float("1"), True)
        ...
        one_hot_0 = paddle._C_ops.one_hot(
            data_2 % paddle.cast(full_6, data_2.dtype), full_6
        )
        del data_2, full_6
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(squeeze_0, full_1, float("1"), True)
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(add_13, full_7, float("0"), True)
        del (
            add_0,
            add_1,
            add_10,
