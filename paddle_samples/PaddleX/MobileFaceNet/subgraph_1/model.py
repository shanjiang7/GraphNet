...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        del conv2d_2, parameter_254, parameter_255, parameter_256, parameter_257
        ...
        del conv2d_3, parameter_249, parameter_250, parameter_251, parameter_252

        # pd_op.prelu: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128xf32)
        prelu_4 = paddle._C_ops.prelu(batch_norm__30, parameter_248, "NCHW", "channel")
        del batch_norm__30, parameter_248
        ...
        del batch_norm__36, parameter_242

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x128x28x28xf32, 64x128x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            prelu_5, parameter_241, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_241, prelu_5
        ...
        del batch_norm__72, parameter_208

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x128x28x28xf32, 64x128x1x1xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            prelu_9, parameter_207, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_207, prelu_9
        ...
        del conv2d_8, parameter_203, parameter_204, parameter_205, parameter_206

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, -1x64x28x28xf32)
        add_2 = paddle._C_ops.add(add_1, batch_norm__78)
        del add_1, batch_norm__78
        ...
        del batch_norm__90, parameter_191

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x128x28x28xf32, 64x128x1x1xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            prelu_11, parameter_190, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_190, prelu_11
        ...
        del conv2d_11, parameter_181, parameter_182, parameter_183, parameter_184
        ...
        del batch_norm__102, parameter_180
        ...
        del conv2d_12, parameter_169, parameter_170, parameter_171, parameter_172
        ...
        del conv2d_13, parameter_164, parameter_165, parameter_166, parameter_167

        # pd_op.prelu: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256xf32)
        prelu_14 = paddle._C_ops.prelu(
            batch_norm__120, parameter_163, "NCHW", "channel"
        )
        del batch_norm__120, parameter_163
        ...
        del batch_norm__126, parameter_157

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x256x14x14xf32, 128x256x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            prelu_15, parameter_156, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_156, prelu_15
        ...
        del conv2d_16, parameter_135, parameter_136, parameter_137, parameter_138

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, -1x128x14x14xf32)
        add_5 = paddle._C_ops.add(add_4, batch_norm__150)
        del add_4, batch_norm__150
        ...
        del conv2d_18, parameter_118, parameter_119, parameter_120, parameter_121

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, -1x128x14x14xf32)
        add_6 = paddle._C_ops.add(add_5, batch_norm__168)
        del add_5, batch_norm__168
        ...
        del conv2d_22, parameter_84, parameter_85, parameter_86, parameter_87

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, -1x128x14x14xf32)
        add_8 = paddle._C_ops.add(add_7, batch_norm__204)
        del add_7, batch_norm__204
        ...
        del batch_norm__228, parameter_61
        ...
        del conv2d_26, parameter_50, parameter_51, parameter_52, parameter_53
        ...
        del depthwise_conv2d_14, parameter_39, parameter_40, parameter_41, parameter_42

        # pd_op.prelu: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256xf32)
        prelu_29 = paddle._C_ops.prelu(batch_norm__252, parameter_38, "NCHW", "channel")
        del batch_norm__252, parameter_38
        ...
        del batch_norm__240, batch_norm__258
        ...
        del conv2d_30, parameter_16, parameter_17, parameter_18, parameter_19

        # pd_op.add: (-1x128x7x7xf32) <- (-1x128x7x7xf32, -1x128x7x7xf32)
        add_11 = paddle._C_ops.add(add_10, batch_norm__276)
        del add_10, batch_norm__276
        ...
        del conv2d_31, parameter_11, parameter_12, parameter_13, parameter_14

        # pd_op.prelu: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512xf32)
        prelu_32 = paddle._C_ops.prelu(batch_norm__282, parameter_10, "NCHW", "channel")
        del batch_norm__282, parameter_10
        ...
        del depthwise_conv2d_16, parameter_5, parameter_6, parameter_7, parameter_8
        ...
        del batch_norm__288, parameter_4
        ...
        del conv2d_32, parameter_0, parameter_1, parameter_2, parameter_3
        ...
        del divide_0, divide_1, reshape_0
