...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.scatter: (185691xi32) <- (185691xi32, 252xi32, 252xi32)
        ...
        # pd_op.scatter: (185691xi32) <- (185691xi32, 4xi32, 4xi32)
        ...
        # pd_op.gather: (185691x4xf32) <- (1x4xf32, 185691xi64, 1xi32)
        ...
        # pd_op.scale: (185691xf32) <- (185691xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_0, full_4, float("0"), True)

        # pd_op.add: (185691xf32) <- (185691xf32, 185691xf32)
        ...
        # pd_op.divide: (185691xf32) <- (185691xf32, 185691xf32)
        ...
        # pd_op.log: (185691xf32) <- (185691xf32)
        ...
        # builtin.combine: ([185691xf32, 185691xf32, 185691xf32, 185691xf32]) <- (185691xf32, 185691xf32, 185691xf32, 185691xf32)
        combine_0 = [divide_0, divide_1, scale_6, scale_7]
        del divide_0, divide_1, scale_6, scale_7

        # pd_op.stack: (185691x4xf32) <- ([185691xf32, 185691xf32, 185691xf32, 185691xf32])
