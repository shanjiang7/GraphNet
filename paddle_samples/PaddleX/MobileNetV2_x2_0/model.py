...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (128x64x112x112xf32) <- (128x3x224x224xf32, 64x3x3x3xf32)
        ...
        # pd_op.relu6: (128x64x112x112xf32) <- (128x64x112x112xf32)
        relu6_0 = paddle._C_ops.relu6(batch_norm__0)
        del batch_norm__0

        # pd_op.conv2d: (128x64x112x112xf32) <- (128x64x112x112xf32, 64x64x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x64x112x112xf32) <- (128x64x112x112xf32, 64x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x32x112x112xf32) <- (128x64x112x112xf32, 32x64x1x1xf32)
        ...
        # pd_op.conv2d: (128x192x112x112xf32) <- (128x32x112x112xf32, 192x32x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            batch_norm__18, parameter_246, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_246

        # pd_op.batch_norm_: (128x192x112x112xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (128x192x112x112xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.relu6: (128x192x112x112xf32) <- (128x192x112x112xf32)
        relu6_3 = paddle._C_ops.relu6(batch_norm__24)
        del batch_norm__24

        # pd_op.depthwise_conv2d: (128x192x56x56xf32) <- (128x192x112x112xf32, 192x1x3x3xf32)
        ...
        # pd_op.relu6: (128x192x56x56xf32) <- (128x192x56x56xf32)
        relu6_4 = paddle._C_ops.relu6(batch_norm__30)
        del batch_norm__30

        # pd_op.conv2d: (128x48x56x56xf32) <- (128x192x56x56xf32, 48x192x1x1xf32)
        ...
        # pd_op.conv2d: (128x288x56x56xf32) <- (128x48x56x56xf32, 288x48x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            batch_norm__36, parameter_231, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_231

        # pd_op.batch_norm_: (128x288x56x56xf32, 288xf32, 288xf32, 288xf32, 288xf32, -1xui8) <- (128x288x56x56xf32, 288xf32, 288xf32, 288xf32, 288xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.relu6: (128x288x56x56xf32) <- (128x288x56x56xf32)
        relu6_5 = paddle._C_ops.relu6(batch_norm__42)
        del batch_norm__42

        # pd_op.depthwise_conv2d: (128x288x56x56xf32) <- (128x288x56x56xf32, 288x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x48x56x56xf32) <- (128x288x56x56xf32, 48x288x1x1xf32)
        ...
        # pd_op.add: (128x48x56x56xf32) <- (128x48x56x56xf32, 128x48x56x56xf32)
        ...
        # pd_op.depthwise_conv2d: (128x288x28x28xf32) <- (128x288x56x56xf32, 288x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu6_7, parameter_211, [2, 2], [1, 1], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        del parameter_211

        # pd_op.batch_norm_: (128x288x28x28xf32, 288xf32, 288xf32, 288xf32, 288xf32, -1xui8) <- (128x288x28x28xf32, 288xf32, 288xf32, 288xf32, 288xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.relu6: (128x288x28x28xf32) <- (128x288x28x28xf32)
        relu6_8 = paddle._C_ops.relu6(batch_norm__66)
        del batch_norm__66

        # pd_op.conv2d: (128x64x28x28xf32) <- (128x288x28x28xf32, 64x288x1x1xf32)
        ...
        # pd_op.conv2d: (128x384x28x28xf32) <- (128x64x28x28xf32, 384x64x1x1xf32)
        ...
        # pd_op.relu6: (128x384x28x28xf32) <- (128x384x28x28xf32)
        relu6_9 = paddle._C_ops.relu6(batch_norm__78)
        del batch_norm__78

        # pd_op.depthwise_conv2d: (128x384x28x28xf32) <- (128x384x28x28xf32, 384x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x64x28x28xf32) <- (128x384x28x28xf32, 64x384x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x384x14x14xf32) <- (128x384x28x28xf32, 384x1x3x3xf32)
        ...
        # pd_op.relu6: (128x384x14x14xf32) <- (128x384x14x14xf32)
        relu6_14 = paddle._C_ops.relu6(batch_norm__120)
        del batch_norm__120

        # pd_op.conv2d: (128x128x14x14xf32) <- (128x384x14x14xf32, 128x384x1x1xf32)
        ...
        # pd_op.conv2d: (128x768x14x14xf32) <- (128x128x14x14xf32, 768x128x1x1xf32)
        ...
        # pd_op.relu6: (128x768x14x14xf32) <- (128x768x14x14xf32)
        relu6_15 = paddle._C_ops.relu6(batch_norm__132)
        del batch_norm__132

        # pd_op.depthwise_conv2d: (128x768x14x14xf32) <- (128x768x14x14xf32, 768x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x128x14x14xf32) <- (128x768x14x14xf32, 128x768x1x1xf32)
        ...
        # pd_op.conv2d: (128x192x14x14xf32) <- (128x768x14x14xf32, 192x768x1x1xf32)
        ...
        # pd_op.conv2d: (128x1152x14x14xf32) <- (128x192x14x14xf32, 1152x192x1x1xf32)
        conv2d_23 = paddle._C_ops.conv2d(
            batch_norm__198, parameter_96, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_96

        # pd_op.batch_norm_: (128x1152x14x14xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32, -1xui8) <- (128x1152x14x14xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.relu6: (128x1152x14x14xf32) <- (128x1152x14x14xf32)
        relu6_23 = paddle._C_ops.relu6(batch_norm__204)
        del batch_norm__204

        # pd_op.depthwise_conv2d: (128x1152x14x14xf32) <- (128x1152x14x14xf32, 1152x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x192x14x14xf32) <- (128x1152x14x14xf32, 192x1152x1x1xf32)
        ...
        # pd_op.add: (128x192x14x14xf32) <- (128x192x14x14xf32, 128x192x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (128x1152x7x7xf32) <- (128x1152x14x14xf32, 1152x1x3x3xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            relu6_27, parameter_61, [2, 2], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        del parameter_61

        # pd_op.batch_norm_: (128x1152x7x7xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32, -1xui8) <- (128x1152x7x7xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32)
        (
            batch_norm__246,
            batch_norm__247,
            batch_norm__248,
        ...
        # pd_op.relu6: (128x1152x7x7xf32) <- (128x1152x7x7xf32)
        relu6_28 = paddle._C_ops.relu6(batch_norm__246)
        del batch_norm__246

        # pd_op.conv2d: (128x320x7x7xf32) <- (128x1152x7x7xf32, 320x1152x1x1xf32)
        ...
        # pd_op.conv2d: (128x1920x7x7xf32) <- (128x320x7x7xf32, 1920x320x1x1xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            batch_norm__252, parameter_51, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_51

        # pd_op.batch_norm_: (128x1920x7x7xf32, 1920xf32, 1920xf32, 1920xf32, 1920xf32, -1xui8) <- (128x1920x7x7xf32, 1920xf32, 1920xf32, 1920xf32, 1920xf32)
        (
            batch_norm__258,
            batch_norm__259,
            batch_norm__260,
        ...
        # pd_op.relu6: (128x1920x7x7xf32) <- (128x1920x7x7xf32)
        relu6_29 = paddle._C_ops.relu6(batch_norm__258)
        del batch_norm__258

        # pd_op.depthwise_conv2d: (128x1920x7x7xf32) <- (128x1920x7x7xf32, 1920x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x320x7x7xf32) <- (128x1920x7x7xf32, 320x1920x1x1xf32)
        ...
        # pd_op.conv2d: (128x640x7x7xf32) <- (128x1920x7x7xf32, 640x1920x1x1xf32)
        ...
        # pd_op.conv2d: (128x2560x7x7xf32) <- (128x640x7x7xf32, 2560x640x1x1xf32)
        conv2d_35 = paddle._C_ops.conv2d(
            batch_norm__306, parameter_6, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_6

        # pd_op.batch_norm_: (128x2560x7x7xf32, 2560xf32, 2560xf32, 2560xf32, 2560xf32, -1xui8) <- (128x2560x7x7xf32, 2560xf32, 2560xf32, 2560xf32, 2560xf32)
        (
            batch_norm__312,
            batch_norm__313,
            batch_norm__314,
        ...
        # pd_op.relu6: (128x2560x7x7xf32) <- (128x2560x7x7xf32)
        ...
        # pd_op.pool2d: (128x2560x1x1xf32) <- (128x2560x7x7xf32, 2xi64)
        ...
        # pd_op.flatten: (128x2560xf32) <- (128x2560x1x1xf32)
        flatten_0 = paddle._C_ops.flatten(pool2d_0, 1, 3)

        # pd_op.matmul: (128x102xf32) <- (128x2560xf32, 2560x102xf32)
