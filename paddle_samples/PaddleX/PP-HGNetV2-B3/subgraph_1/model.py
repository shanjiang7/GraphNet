...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        multiply_0 = paddle._C_ops.multiply(data_92, relu_0)
        del data_92

        # pd_op.add: (-1x24x112x112xf32) <- (-1x24x112x112xf32, 1xf32)
        add_1 = paddle._C_ops.add(multiply_0, data_93)
        del data_93
        ...
        multiply_1 = paddle._C_ops.multiply(data_94, relu_1)
        del data_94

        # pd_op.add: (-1x12x112x112xf32) <- (-1x12x112x112xf32, 1xf32)
        add_2 = paddle._C_ops.add(multiply_1, data_95)
        del data_95
        ...
        # pd_op.multiply: (-1x24x112x112xf32) <- (1xf32, -1x24x112x112xf32)
        multiply_2 = paddle._C_ops.multiply(data_0, relu_2)
        del data_0

        # pd_op.add: (-1x24x112x112xf32) <- (-1x24x112x112xf32, 1xf32)
        add_3 = paddle._C_ops.add(multiply_2, data_1)
        del data_1
        ...
        multiply_3 = paddle._C_ops.multiply(data_2, relu_3)
        del data_2

        # pd_op.add: (-1x24x56x56xf32) <- (-1x24x56x56xf32, 1xf32)
        add_4 = paddle._C_ops.add(multiply_3, data_3)
        del data_3
        ...
        multiply_4 = paddle._C_ops.multiply(data_4, relu_4)
        del data_4

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_5 = paddle._C_ops.add(multiply_4, data_5)
        del data_5
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_5 = paddle._C_ops.multiply(data_6, relu_5)
        del data_6

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_6 = paddle._C_ops.add(multiply_5, data_7)
        del data_7
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_6 = paddle._C_ops.multiply(data_8, relu_6)
        del data_8

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_7 = paddle._C_ops.add(multiply_6, data_9)
        del data_9
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_7 = paddle._C_ops.multiply(data_10, relu_7)
        del data_10

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_8 = paddle._C_ops.add(multiply_7, data_11)
        del data_11
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_8 = paddle._C_ops.multiply(data_12, relu_8)
        del data_12

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_9 = paddle._C_ops.add(multiply_8, data_13)
        del data_13
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_9 = paddle._C_ops.multiply(data_14, relu_9)
        del data_14

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_10 = paddle._C_ops.add(multiply_9, data_15)
        del data_15
        ...
        multiply_10 = paddle._C_ops.multiply(data_16, relu_10)
        del data_16

        # pd_op.add: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 1xf32)
        add_11 = paddle._C_ops.add(multiply_10, data_17)
        del data_17
        ...
        multiply_11 = paddle._C_ops.multiply(data_18, relu_11)
        del data_18

        # pd_op.add: (-1x128x56x56xf32) <- (-1x128x56x56xf32, 1xf32)
        add_12 = paddle._C_ops.add(multiply_11, data_19)
        del data_19
        ...
        multiply_12 = paddle._C_ops.multiply(data_20, relu_12)
        del data_20

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_13 = paddle._C_ops.add(multiply_12, data_21)
        del data_21
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_13 = paddle._C_ops.multiply(data_22, relu_13)
        del data_22

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_14 = paddle._C_ops.add(multiply_13, data_23)
        del data_23
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_14 = paddle._C_ops.multiply(data_24, relu_14)
        del data_24

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_15 = paddle._C_ops.add(multiply_14, data_25)
        del data_25
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_15 = paddle._C_ops.multiply(data_26, relu_15)
        del data_26

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_16 = paddle._C_ops.add(multiply_15, data_27)
        del data_27
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_16 = paddle._C_ops.multiply(data_28, relu_16)
        del data_28

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_17 = paddle._C_ops.add(multiply_16, data_29)
        del data_29
        ...
        multiply_17 = paddle._C_ops.multiply(data_30, relu_17)
        del data_30

        # pd_op.add: (-1x256x28x28xf32) <- (-1x256x28x28xf32, 1xf32)
        add_18 = paddle._C_ops.add(multiply_17, data_31)
        del data_31
        ...
        multiply_18 = paddle._C_ops.multiply(data_32, relu_18)
        del data_32

        # pd_op.add: (-1x512x28x28xf32) <- (-1x512x28x28xf32, 1xf32)
        add_19 = paddle._C_ops.add(multiply_18, data_33)
        del data_33
        ...
        multiply_19 = paddle._C_ops.multiply(data_34, relu_19)
        del data_34

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_20 = paddle._C_ops.add(multiply_19, data_35)
        del data_35
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_20 = paddle._C_ops.multiply(data_36, relu_20)
        del data_36

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_21 = paddle._C_ops.add(multiply_20, data_37)
        del data_37
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_21 = paddle._C_ops.multiply(data_38, relu_21)
        del data_38

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_22 = paddle._C_ops.add(multiply_21, data_39)
        del data_39
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_22 = paddle._C_ops.multiply(data_40, relu_22)
        del data_40

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_23 = paddle._C_ops.add(multiply_22, data_41)
        del data_41
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_23 = paddle._C_ops.multiply(data_42, relu_23)
        del data_42

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_24 = paddle._C_ops.add(multiply_23, data_43)
        del data_43
        ...
        multiply_24 = paddle._C_ops.multiply(data_44, relu_24)
        del data_44

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_25 = paddle._C_ops.add(multiply_24, data_45)
        del data_45
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_30 = paddle._C_ops.multiply(data_56, relu_30)
        del data_56

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_31 = paddle._C_ops.add(multiply_30, data_57)
        del data_57
        ...
        # pd_op.multiply: (-1x512x14x14xf32) <- (1xf32, -1x512x14x14xf32)
        multiply_31 = paddle._C_ops.multiply(data_58, relu_31)
        del data_58

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_32 = paddle._C_ops.add(multiply_31, data_59)
        del data_59
        ...
        # pd_op.multiply: (-1x1024x14x14xf32) <- (1xf32, -1x1024x14x14xf32)
        multiply_32 = paddle._C_ops.multiply(data_60, relu_32)
        del data_60

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, 1xf32)
        add_33 = paddle._C_ops.add(multiply_32, data_61)
        del data_61
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_33 = paddle._C_ops.multiply(data_62, relu_33)
        del data_62

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_35 = paddle._C_ops.add(multiply_33, data_63)
        del data_63
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_34 = paddle._C_ops.multiply(data_64, relu_34)
        del data_64

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_36 = paddle._C_ops.add(multiply_34, data_65)
        del data_65
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_35 = paddle._C_ops.multiply(data_66, relu_35)
        del data_66

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_37 = paddle._C_ops.add(multiply_35, data_67)
        del data_67
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_36 = paddle._C_ops.multiply(data_68, relu_36)
        del data_68

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_38 = paddle._C_ops.add(multiply_36, data_69)
        del data_69
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_37 = paddle._C_ops.multiply(data_70, relu_37)
        del data_70

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_39 = paddle._C_ops.add(multiply_37, data_71)
        del data_71
        ...
        # pd_op.multiply: (-1x512x14x14xf32) <- (1xf32, -1x512x14x14xf32)
        multiply_38 = paddle._C_ops.multiply(data_72, relu_38)
        del data_72

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_40 = paddle._C_ops.add(multiply_38, data_73)
        del data_73
        ...
        # pd_op.multiply: (-1x1024x14x14xf32) <- (1xf32, -1x1024x14x14xf32)
        multiply_39 = paddle._C_ops.multiply(data_74, relu_39)
        del data_74

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, 1xf32)
        add_41 = paddle._C_ops.add(multiply_39, data_75)
        del data_75
        ...
        multiply_40 = paddle._C_ops.multiply(data_76, relu_40)
        del data_76

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_43 = paddle._C_ops.add(multiply_40, data_77)
        del data_77
        ...
        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_41 = paddle._C_ops.multiply(data_78, relu_41)
        del data_78

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_44 = paddle._C_ops.add(multiply_41, data_79)
        del data_79
        ...
        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_42 = paddle._C_ops.multiply(data_80, relu_42)
        del data_80

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_45 = paddle._C_ops.add(multiply_42, data_81)
        del data_81
        ...
        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_43 = paddle._C_ops.multiply(data_82, relu_43)
        del data_82

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_46 = paddle._C_ops.add(multiply_43, data_83)
        del data_83
        ...
        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_44 = paddle._C_ops.multiply(data_84, relu_44)
        del data_84

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_47 = paddle._C_ops.add(multiply_44, data_85)
        del data_85
        ...
        multiply_45 = paddle._C_ops.multiply(data_86, relu_45)
        del data_86

        # pd_op.add: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32, 1xf32)
        add_48 = paddle._C_ops.add(multiply_45, data_87)
        del data_87
        ...
        multiply_46 = paddle._C_ops.multiply(data_88, relu_46)
        del data_88

        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, 1xf32)
        add_49 = paddle._C_ops.add(multiply_46, data_89)
        del data_89
        ...
        multiply_47 = paddle._C_ops.multiply(data_90, relu_47)
        del data_90

        # pd_op.add: (-1x2048x1x1xf32) <- (-1x2048x1x1xf32, 1xf32)
        add_50 = paddle._C_ops.add(multiply_47, data_91)
        del data_91
