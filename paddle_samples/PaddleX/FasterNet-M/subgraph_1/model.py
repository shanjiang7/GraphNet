...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_4 = paddle._C_ops.add(full_4, uniform_1)
        del uniform_1
        ...
        # pd_op.divide: (64x144x56x56xf32) <- (64x144x56x56xf32, xf32)
        divide_1 = paddle._C_ops.divide(conv2d_9, full_4)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_2 = [72, 216]

        # pd_op.split: ([64x72x28x28xf32, 64x216x28x28xf32]) <- (64x288x28x28xf32, 2xi64, 1xi32)
        split_9 = paddle._C_ops.split(batch_norm__24, full_int_array_2, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_6 = paddle._C_ops.add(full_5, uniform_2)
        del uniform_2
        ...
        divide_2 = paddle._C_ops.divide(conv2d_13, full_5)
        ...
        # pd_op.split: ([64x72x28x28xf32, 64x216x28x28xf32]) <- (64x288x28x28xf32, 2xi64, 1xi32)
        split_12 = paddle._C_ops.split(add_7, full_int_array_2, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_8 = paddle._C_ops.add(full_6, uniform_3)
        del uniform_3
        ...
        # pd_op.divide: (64x288x28x28xf32) <- (64x288x28x28xf32, xf32)
        divide_3 = paddle._C_ops.divide(conv2d_16, full_6)
        ...
        # pd_op.split: ([64x72x28x28xf32, 64x216x28x28xf32]) <- (64x288x28x28xf32, 2xi64, 1xi32)
        split_15 = paddle._C_ops.split(add_9, full_int_array_2, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_10 = paddle._C_ops.add(full_7, uniform_4)
        del uniform_4
        ...
        # pd_op.divide: (64x288x28x28xf32) <- (64x288x28x28xf32, xf32)
        divide_4 = paddle._C_ops.divide(conv2d_19, full_7)
        ...
        # pd_op.split: ([64x72x28x28xf32, 64x216x28x28xf32]) <- (64x288x28x28xf32, 2xi64, 1xi32)
        split_18 = paddle._C_ops.split(add_11, full_int_array_2, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_12 = paddle._C_ops.add(full_8, uniform_5)
        del uniform_5
        ...
        # pd_op.divide: (64x288x28x28xf32) <- (64x288x28x28xf32, xf32)
        divide_5 = paddle._C_ops.divide(conv2d_22, full_8)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_3 = [144, 432]

        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_21 = paddle._C_ops.split(batch_norm__54, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_14 = paddle._C_ops.add(full_9, uniform_6)
        del uniform_6
        ...
        divide_6 = paddle._C_ops.divide(conv2d_26, full_9)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_24 = paddle._C_ops.split(add_15, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_16 = paddle._C_ops.add(full_10, uniform_7)
        del uniform_7
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_7 = paddle._C_ops.divide(conv2d_29, full_10)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_27 = paddle._C_ops.split(add_17, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_18 = paddle._C_ops.add(full_11, uniform_8)
        del uniform_8
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_8 = paddle._C_ops.divide(conv2d_32, full_11)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_30 = paddle._C_ops.split(add_19, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_20 = paddle._C_ops.add(full_12, uniform_9)
        del uniform_9
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_9 = paddle._C_ops.divide(conv2d_35, full_12)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_33 = paddle._C_ops.split(add_21, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_22 = paddle._C_ops.add(full_13, uniform_10)
        del uniform_10
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_10 = paddle._C_ops.divide(conv2d_38, full_13)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_36 = paddle._C_ops.split(add_23, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_24 = paddle._C_ops.add(full_14, uniform_11)
        del uniform_11
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_11 = paddle._C_ops.divide(conv2d_41, full_14)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_39 = paddle._C_ops.split(add_25, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_26 = paddle._C_ops.add(full_15, uniform_12)
        del uniform_12
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_12 = paddle._C_ops.divide(conv2d_44, full_15)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_42 = paddle._C_ops.split(add_27, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_28 = paddle._C_ops.add(full_16, uniform_13)
        del uniform_13
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_13 = paddle._C_ops.divide(conv2d_47, full_16)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_45 = paddle._C_ops.split(add_29, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_30 = paddle._C_ops.add(full_17, uniform_14)
        del uniform_14
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_14 = paddle._C_ops.divide(conv2d_50, full_17)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_48 = paddle._C_ops.split(add_31, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_32 = paddle._C_ops.add(full_18, uniform_15)
        del uniform_15
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_15 = paddle._C_ops.divide(conv2d_53, full_18)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_51 = paddle._C_ops.split(add_33, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_34 = paddle._C_ops.add(full_19, uniform_16)
        del uniform_16
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_16 = paddle._C_ops.divide(conv2d_56, full_19)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_54 = paddle._C_ops.split(add_35, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_36 = paddle._C_ops.add(full_20, uniform_17)
        del uniform_17
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_17 = paddle._C_ops.divide(conv2d_59, full_20)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_57 = paddle._C_ops.split(add_37, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_38 = paddle._C_ops.add(full_21, uniform_18)
        del uniform_18
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_18 = paddle._C_ops.divide(conv2d_62, full_21)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_60 = paddle._C_ops.split(add_39, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_40 = paddle._C_ops.add(full_22, uniform_19)
        del uniform_19
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_19 = paddle._C_ops.divide(conv2d_65, full_22)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_63 = paddle._C_ops.split(add_41, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_42 = paddle._C_ops.add(full_23, uniform_20)
        del uniform_20
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_20 = paddle._C_ops.divide(conv2d_68, full_23)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_66 = paddle._C_ops.split(add_43, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_44 = paddle._C_ops.add(full_24, uniform_21)
        del uniform_21
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_21 = paddle._C_ops.divide(conv2d_71, full_24)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_69 = paddle._C_ops.split(add_45, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_46 = paddle._C_ops.add(full_25, uniform_22)
        del uniform_22
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_22 = paddle._C_ops.divide(conv2d_74, full_25)
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_72 = paddle._C_ops.split(add_47, full_int_array_3, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_48 = paddle._C_ops.add(full_26, uniform_23)
        del uniform_23
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_23 = paddle._C_ops.divide(conv2d_77, full_26)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_4 = [288, 864]

        # pd_op.split: ([64x288x7x7xf32, 64x864x7x7xf32]) <- (64x1152x7x7xf32, 2xi64, 1xi32)
        split_75 = paddle._C_ops.split(batch_norm__168, full_int_array_4, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_50 = paddle._C_ops.add(full_27, uniform_24)
        del uniform_24
        ...
        divide_24 = paddle._C_ops.divide(conv2d_81, full_27)
        ...
        # pd_op.split: ([64x288x7x7xf32, 64x864x7x7xf32]) <- (64x1152x7x7xf32, 2xi64, 1xi32)
        split_78 = paddle._C_ops.split(add_51, full_int_array_4, full_0)
        ...
        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_52 = paddle._C_ops.add(full_28, uniform_25)
        del uniform_25
        ...
        # pd_op.divide: (64x1152x7x7xf32) <- (64x1152x7x7xf32, xf32)
        divide_25 = paddle._C_ops.divide(conv2d_84, full_28)
        ...
        # pd_op.split: ([64x288x7x7xf32, 64x864x7x7xf32]) <- (64x1152x7x7xf32, 2xi64, 1xi32)
        split_81 = paddle._C_ops.split(add_53, full_int_array_4, full_0)
        ...
        del full_2, full_3, full_int_array_1

        # pd_op.add: (64x1x1x1xf32) <- (xf32, 64x1x1x1xf32)
        add_54 = paddle._C_ops.add(full_29, uniform_26)
        del uniform_26
        ...
        # pd_op.divide: (64x1152x7x7xf32) <- (64x1152x7x7xf32, xf32)
        divide_26 = paddle._C_ops.divide(conv2d_87, full_29)
