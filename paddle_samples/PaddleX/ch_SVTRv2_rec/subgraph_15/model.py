...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        del full_int_array_4, transpose_4
        ...
        del full_int_array_5, transpose_6
        ...
        del full_int_array_6, layer_norm_12
