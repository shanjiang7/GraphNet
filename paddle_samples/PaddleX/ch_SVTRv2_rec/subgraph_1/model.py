...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.reshape: (8x-1x3x-1x32xf32) <- (8x-1x768xf32, 5xi64)
        ...
        slice_2 = paddle._C_ops.slice(
            transpose_5, [0], full_int_array_4, full_int_array_1, [1], [0]
        )
        ...
        transpose_6 = paddle._C_ops.transpose(slice_3, [0, 1, 3, 2])
        del slice_3

        # pd_op.matmul: (8x-1x-1x-1xf32) <- (8x-1x-1x32xf32, 8x-1x32x-1xf32)
        matmul_5 = paddle._C_ops.matmul(slice_2, transpose_6, False, False)
        del slice_2, transpose_6
        ...
        matmul_6 = paddle._C_ops.matmul(softmax_0, slice_4, False, False)
        ...
        # pd_op.matmul: (8x-1x256xf32) <- (8x-1x-1xf32, 256x256xf32)
        ...
        slice_5 = paddle._C_ops.slice(
            transpose_8, [0], full_int_array_4, full_int_array_1, [1], [0]
        )
        ...
        # pd_op.transpose: (8x-1x32x-1xf32) <- (8x-1x-1x32xf32)
        transpose_9 = paddle._C_ops.transpose(slice_6, [0, 1, 3, 2])
        del slice_6

        # pd_op.matmul: (8x-1x-1x-1xf32) <- (8x-1x-1x32xf32, 8x-1x32x-1xf32)
        matmul_11 = paddle._C_ops.matmul(slice_5, transpose_9, False, False)
        del slice_5, transpose_9
        ...
        # pd_op.matmul: (8x-1x-1x32xf32) <- (8x-1x-1x-1xf32, 8x-1x-1x32xf32)
        matmul_12 = paddle._C_ops.matmul(softmax_1, slice_7, False, False)
        del slice_7, softmax_1
        ...
        slice_8 = paddle._C_ops.slice(
            transpose_11, [0], full_int_array_4, full_int_array_1, [1], [0]
        )
        ...
        # pd_op.transpose: (8x-1x32x-1xf32) <- (8x-1x-1x32xf32)
        transpose_12 = paddle._C_ops.transpose(slice_9, [0, 1, 3, 2])
        del slice_9

        # pd_op.matmul: (8x-1x-1x-1xf32) <- (8x-1x-1x32xf32, 8x-1x32x-1xf32)
        matmul_17 = paddle._C_ops.matmul(slice_8, transpose_12, False, False)
        del slice_8, transpose_12
        ...
        # pd_op.matmul: (8x-1x-1x32xf32) <- (8x-1x-1x-1xf32, 8x-1x-1x32xf32)
        matmul_18 = paddle._C_ops.matmul(softmax_2, slice_10, False, False)
        ...
        slice_11 = paddle._C_ops.slice(
            transpose_14, [0], full_int_array_4, full_int_array_1, [1], [0]
        )
        ...
        del full_int_array_3, transpose_14

        # pd_op.transpose: (8x8x32x-1xf32) <- (8x8x-1x32xf32)
        transpose_15 = paddle._C_ops.transpose(slice_12, [0, 1, 3, 2])
        del slice_12

        # pd_op.matmul: (8x8x-1x-1xf32) <- (8x8x-1x32xf32, 8x8x32x-1xf32)
        matmul_23 = paddle._C_ops.matmul(slice_11, transpose_15, False, False)
        del slice_11, transpose_15
        ...
        matmul_24 = paddle._C_ops.matmul(softmax_3, slice_13, False, False)
        del slice_13, softmax_3
        ...
        del full_int_array_1, full_int_array_2, shape64_1
        ...
        # pd_op.reshape: (8x256x6x80xf32) <- (8x256x-1xf32, 4xi64)
        reshape_12 = paddle._C_ops.reshape(transpose_17, full_int_array_7)
        del full_int_array_7, transpose_17

        # pd_op.conv2d: (8x384x3x80xf32) <- (8x256x6x80xf32, 384x256x3x3xf32)
        ...
        # pd_op.flatten: (8x384x240xf32) <- (8x384x3x80xf32)
        flatten_3 = paddle._C_ops.flatten(add_34, 2, 3)
        del add_34

        # pd_op.transpose: (8x240x384xf32) <- (8x384x240xf32)
        transpose_18 = paddle._C_ops.transpose(flatten_3, [0, 2, 1])
        del flatten_3

        # pd_op.layer_norm: (8x240x384xf32, 8x240xf32, 8x240xf32) <- (8x240x384xf32, 384xf32, 384xf32)
