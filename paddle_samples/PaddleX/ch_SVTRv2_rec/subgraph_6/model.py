...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_2 = [full_0, slice_4, slice_5, full_1]
        del slice_4, slice_5
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_3 = [full_0, slice_7, slice_8, full_1]
        del slice_7, slice_8
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_4 = [full_0, slice_10, slice_11, full_1]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_5 = [full_0, slice_13, slice_14, full_1]
        ...
        # pd_op.conv2d: (-1x256x-1x80xf32) <- (-1x-1x-1x80xf32, 256x128x3x3xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x256x-1x80xf32)
        ...
        del full_int_array_3, full_int_array_4, shape64_5
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_6 = [full_0, full_2, slice_16, full_1]
        ...
        # pd_op.reshape: (-1x256x-1x80xf32) <- (-1x256x-1xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(transpose_13, stack_6)
        del slice_16, stack_6, transpose_13
