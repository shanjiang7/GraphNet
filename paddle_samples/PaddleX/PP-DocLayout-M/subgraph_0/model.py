...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.topk: (1x-1x9xf32, 1x-1x9xi64) <- (1x-1x6400xf32, 1xi32)
        ...
        # pd_op.one_hot: (1x-1x9x6400xf32) <- (1x-1x9xi64, 1xi32)
        ...
        # pd_op.sum: (1x-1x6400xf32) <- (1x-1x9x6400xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)
        del one_hot_0

        # pd_op.multiply: (1x-1x6400xf32) <- (1x-1x6400xf32, 1x-1x1xf32)
        multiply_0 = paddle._C_ops.multiply(sum_0, data_4)
        del sum_0

        # pd_op.topk: (1x-1x9xf32, 1x-1x9xi64) <- (1x-1x1600xf32, 1xi32)
        ...
        # pd_op.one_hot: (1x-1x9x1600xf32) <- (1x-1x9xi64, 1xi32)
        one_hot_1 = paddle._C_ops.one_hot(
            topk_3 % paddle.cast(full_3, topk_3.dtype), full_3
        )
        del full_3, topk_3

        # pd_op.sum: (1x-1x1600xf32) <- (1x-1x9x1600xf32, 1xi64)
        sum_1 = paddle._C_ops.sum(one_hot_1, full_int_array_0, None, False)
        del one_hot_1

        # pd_op.multiply: (1x-1x1600xf32) <- (1x-1x1600xf32, 1x-1x1xf32)
        multiply_1 = paddle._C_ops.multiply(sum_1, data_4)
        del sum_1

        # pd_op.topk: (1x-1x9xf32, 1x-1x9xi64) <- (1x-1x400xf32, 1xi32)
        ...
        # pd_op.one_hot: (1x-1x9x400xf32) <- (1x-1x9xi64, 1xi32)
        one_hot_2 = paddle._C_ops.one_hot(
            topk_5 % paddle.cast(full_4, topk_5.dtype), full_4
        )
        del full_4, topk_5

        # pd_op.sum: (1x-1x400xf32) <- (1x-1x9x400xf32, 1xi64)
        sum_2 = paddle._C_ops.sum(one_hot_2, full_int_array_0, None, False)
        del one_hot_2

        # pd_op.multiply: (1x-1x400xf32) <- (1x-1x400xf32, 1x-1x1xf32)
        multiply_2 = paddle._C_ops.multiply(sum_2, data_4)
        del sum_2

        # pd_op.topk: (1x-1x9xf32, 1x-1x9xi64) <- (1x-1x100xf32, 1xi32)
        ...
        # builtin.combine: ([1x-1x6400xf32, 1x-1x1600xf32, 1x-1x400xf32, 1x-1x100xf32]) <- (1x-1x6400xf32, 1x-1x1600xf32, 1x-1x400xf32, 1x-1x100xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]
        del multiply_0, multiply_1, multiply_2, multiply_3

        # pd_op.concat: (1x-1x8500xf32) <- ([1x-1x6400xf32, 1x-1x1600xf32, 1x-1x400xf32, 1x-1x100xf32], 1xi32)
