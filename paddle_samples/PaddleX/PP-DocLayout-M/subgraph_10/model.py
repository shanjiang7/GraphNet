...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.hardswish: (1x64x-1x-1xf32) <- (1x64x-1x-1xf32)
        ...
        # pd_op.hardswish: (1x128x-1x-1xf32) <- (1x128x-1x-1xf32)
        ...
        # pd_op.hardswish: (1x256x-1x-1xf32) <- (1x256x-1x-1xf32)
        ...
        # pd_op.hardswish: (1x512x-1x-1xf32) <- (1x512x-1x-1xf32)
        ...
        # pd_op.hardswish: (1x1024x-1x-1xf32) <- (1x1024x-1x-1xf32)
        ...
        # pd_op.conv2d: (1x160x-1x-1xf32) <- (1x256x-1x-1xf32, 160x256x1x1xf32)
        ...
        # pd_op.hardswish: (1x160x-1x-1xf32) <- (1x160x-1x-1xf32)
        hardswish_27 = paddle._C_ops.hardswish(batch_norm__162)

        # pd_op.conv2d: (1x160x-1x-1xf32) <- (1x512x-1x-1xf32, 160x512x1x1xf32)
        ...
        # pd_op.conv2d: (1x160x-1x-1xf32) <- (1x1024x-1x-1xf32, 160x1024x1x1xf32)
        ...
        # pd_op.nearest_interp: (1x160x-1x-1xf32) <- (1x160x-1x-1xf32, None, None, None)
        ...
        # builtin.combine: ([1x160x-1x-1xf32, 1x160x-1x-1xf32]) <- (1x160x-1x-1xf32, 1x160x-1x-1xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (1x320x-1x-1xf32) <- ([1x160x-1x-1xf32, 1x160x-1x-1xf32], 1xi32)
        ...
        # pd_op.hardswish: (1x320x-1x-1xf32) <- (1x320x-1x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (1x160x-1x-1xf32)
        ...
        # pd_op.multiply: (1x160x-1x-1xf32) <- (1x160x-1x-1xf32, 1x160x1x1xf32)
        ...
        # pd_op.conv2d: (1x11x-1x-1xf32) <- (1x160x-1x-1xf32, 11x160x1x1xf32)
        ...
        # pd_op.conv2d: (1x32x-1x-1xf32) <- (1x160x-1x-1xf32, 32x160x1x1xf32)
        ...
        # pd_op.conv2d: (1x1x-1x-1xf32) <- (1x160x-1x-1xf32, 1x160x5x5xf32)
