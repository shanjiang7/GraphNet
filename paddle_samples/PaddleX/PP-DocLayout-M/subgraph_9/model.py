...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x11x80x80xf32) <- (1x160x80x80xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (1x11x80x80xf32) <- (1x11x80x80xf32, 1x11x1x1xf32)
        ...
        # pd_op.sigmoid: (1x11x80x80xf32) <- (1x11x80x80xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_6)
        del add_6

        # pd_op.multiply: (1x11x80x80xf32) <- (1x11x80x80xf32, 1x1x80x80xf32)
        ...
        # pd_op.scale: (1x11x80x80xf32) <- (1x11x80x80xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(multiply_3, full_1, float("1e-09"), True)
        del multiply_3

        # pd_op.sqrt: (1x11x80x80xf32) <- (1x11x80x80xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_0)
        del scale_0

        # pd_op.transpose: (1x80x80x11xf32) <- (1x11x80x80xf32)
        ...
        # pd_op.reshape: (1x6400x11xf32) <- (1x80x80x11xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([1x6400x2xf32, 1x6400x2xf32]) <- (1x6400x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_10, 2, full_6)
        del reshape_10

        # builtin.split: (1x6400x2xf32, 1x6400x2xf32) <- ([1x6400x2xf32, 1x6400x2xf32])
        (
            split_2,
            split_3,
        ) = split_with_num_0
        ...
        # pd_op.scale: (1x6400x2xf32) <- (1x6400x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_2, full_7, float("0"), True)
        del split_2

        # pd_op.add: (1x6400x2xf32) <- (1x6400x2xf32, 6400x2xf32)
        ...
        # builtin.combine: ([1x6400x2xf32, 1x6400x2xf32]) <- (1x6400x2xf32, 1x6400x2xf32)
        combine_6 = [add_8, add_9]

        # pd_op.concat: (1x6400x4xf32) <- ([1x6400x2xf32, 1x6400x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_8)
        del combine_6

        # pd_op.flatten: (1x11x6400xf32) <- (1x11x80x80xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (1x6400x11xf32) <- (1x11x6400xf32)
        transpose_2 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])
        del flatten_2

        # pd_op.flatten: (1x32x6400xf32) <- (1x32x80x80xf32)
        flatten_3 = paddle._C_ops.flatten(add_7, 2, 3)

        # pd_op.transpose: (1x6400x32xf32) <- (1x32x6400xf32)
        ...
        # pd_op.scale: (1x6400x4xf32) <- (1x6400x4xf32, 1xf32)
        ...
        # pd_op.conv2d: (1x11x40x40xf32) <- (1x160x40x40xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (1x11x40x40xf32) <- (1x11x40x40xf32, 1x11x1x1xf32)
        ...
        # pd_op.sigmoid: (1x11x40x40xf32) <- (1x11x40x40xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_11)
        del add_11

        # pd_op.multiply: (1x11x40x40xf32) <- (1x11x40x40xf32, 1x1x40x40xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (1x11x40x40xf32) <- (1x11x40x40xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)
        del multiply_5

        # pd_op.sqrt: (1x11x40x40xf32) <- (1x11x40x40xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_6)
        del scale_6

        # pd_op.transpose: (1x40x40x11xf32) <- (1x11x40x40xf32)
        ...
        # pd_op.scale: (1x1600x2xf32) <- (1x1600x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_6, full_7, float("0"), True)
        del split_6

        # pd_op.add: (1x1600x2xf32) <- (1x1600x2xf32, 1600x2xf32)
        add_13 = paddle._C_ops.add(scale_10, stack_1)

        # pd_op.add: (1x1600x2xf32) <- (1x1600x2xf32, 1600x2xf32)
        add_14 = paddle._C_ops.add(split_7, stack_1)

        # builtin.combine: ([1x1600x2xf32, 1x1600x2xf32]) <- (1x1600x2xf32, 1x1600x2xf32)
        combine_9 = [add_13, add_14]

        # pd_op.concat: (1x1600x4xf32) <- ([1x1600x2xf32, 1x1600x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_8)
        del combine_9

        # pd_op.flatten: (1x11x1600xf32) <- (1x11x40x40xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (1x1600x11xf32) <- (1x11x1600xf32)
        transpose_6 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])
        del flatten_6

        # pd_op.flatten: (1x32x1600xf32) <- (1x32x40x40xf32)
        flatten_7 = paddle._C_ops.flatten(add_12, 2, 3)

        # pd_op.transpose: (1x1600x32xf32) <- (1x32x1600xf32)
        ...
        # pd_op.scale: (1x1600x4xf32) <- (1x1600x4xf32, 1xf32)
        ...
        # pd_op.conv2d: (1x11x20x20xf32) <- (1x160x20x20xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (1x11x20x20xf32) <- (1x11x20x20xf32, 1x11x1x1xf32)
        ...
        # pd_op.sigmoid: (1x11x20x20xf32) <- (1x11x20x20xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_16)
        del add_16

        # pd_op.multiply: (1x11x20x20xf32) <- (1x11x20x20xf32, 1x1x20x20xf32)
        multiply_7 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (1x11x20x20xf32) <- (1x11x20x20xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_7, full_1, float("1e-09"), True)
        del multiply_7

        # pd_op.sqrt: (1x11x20x20xf32) <- (1x11x20x20xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_12)
        del scale_12

        # pd_op.transpose: (1x20x20x11xf32) <- (1x11x20x20xf32)
        ...
        # pd_op.reshape: (1x400x11xf32) <- (1x20x20x11xf32, 3xi64)
        reshape_21 = paddle._C_ops.reshape(transpose_8, full_int_array_7)
        del transpose_8

        # pd_op.reshape: (1600x8xf32) <- (1x20x20x32xf32, 2xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_12 = [1, 400, 4]

        # pd_op.reshape: (1x400x4xf32) <- (400x4xf32, 3xi64)
        reshape_24 = paddle._C_ops.reshape(scale_15, full_int_array_12)
        del full_int_array_12

        # pd_op.split_with_num: ([1x400x2xf32, 1x400x2xf32]) <- (1x400x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(reshape_24, 2, full_6)
        del reshape_24

        # builtin.split: (1x400x2xf32, 1x400x2xf32) <- ([1x400x2xf32, 1x400x2xf32])
        (
            split_10,
            split_11,
        ) = split_with_num_2
        ...
        # pd_op.scale: (1x400x2xf32) <- (1x400x2xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(split_10, full_7, float("0"), True)
        del split_10

        # pd_op.add: (1x400x2xf32) <- (1x400x2xf32, 400x2xf32)
        add_18 = paddle._C_ops.add(scale_16, stack_2)

        # pd_op.add: (1x400x2xf32) <- (1x400x2xf32, 400x2xf32)
        add_19 = paddle._C_ops.add(split_11, stack_2)

        # builtin.combine: ([1x400x2xf32, 1x400x2xf32]) <- (1x400x2xf32, 1x400x2xf32)
        combine_12 = [add_18, add_19]

        # pd_op.concat: (1x400x4xf32) <- ([1x400x2xf32, 1x400x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_8)
        del combine_12

        # pd_op.flatten: (1x11x400xf32) <- (1x11x20x20xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (1x400x11xf32) <- (1x11x400xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])
        del flatten_10

        # pd_op.flatten: (1x32x400xf32) <- (1x32x20x20xf32)
        flatten_11 = paddle._C_ops.flatten(add_17, 2, 3)

        # pd_op.transpose: (1x400x32xf32) <- (1x32x400xf32)
        ...
        # pd_op.conv2d: (1x11x10x10xf32) <- (1x160x10x10xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (1x11x10x10xf32) <- (1x11x10x10xf32, 1x11x1x1xf32)
        ...
        # pd_op.sigmoid: (1x11x10x10xf32) <- (1x11x10x10xf32)
        sigmoid_11 = paddle._C_ops.sigmoid(add_21)
        del add_21

        # pd_op.multiply: (1x11x10x10xf32) <- (1x11x10x10xf32, 1x1x10x10xf32)
        multiply_9 = paddle._C_ops.multiply(sigmoid_11, sigmoid_10)

        # pd_op.scale: (1x11x10x10xf32) <- (1x11x10x10xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(multiply_9, full_1, float("1e-09"), True)
        del multiply_9

        # pd_op.sqrt: (1x11x10x10xf32) <- (1x11x10x10xf32)
        sqrt_3 = paddle._C_ops.sqrt(scale_18)
        del scale_18

        # pd_op.transpose: (1x10x10x11xf32) <- (1x11x10x10xf32)
        ...
        # pd_op.add: (1x100x2xf32) <- (1x100x2xf32, 100x2xf32)
        ...
        # pd_op.flatten: (1x11x100xf32) <- (1x11x10x10xf32)
        flatten_14 = paddle._C_ops.flatten(sqrt_3, 2, 3)

        # pd_op.transpose: (1x100x11xf32) <- (1x11x100xf32)
        transpose_14 = paddle._C_ops.transpose(flatten_14, [0, 2, 1])
        del flatten_14

        # pd_op.flatten: (1x32x100xf32) <- (1x32x10x10xf32)
        flatten_15 = paddle._C_ops.flatten(add_22, 2, 3)

        # pd_op.transpose: (1x100x32xf32) <- (1x32x100xf32)
        ...
        # builtin.combine: ([1x6400x11xf32, 1x1600x11xf32, 1x400x11xf32, 1x100x11xf32]) <- (1x6400x11xf32, 1x1600x11xf32, 1x400x11xf32, 1x100x11xf32)
        combine_16 = [transpose_2, transpose_6, transpose_10, transpose_14]

        # pd_op.concat: (1x8500x11xf32) <- ([1x6400x11xf32, 1x1600x11xf32, 1x400x11xf32, 1x100x11xf32], 1xi32)
        ...
        # builtin.combine: ([1x6400x32xf32, 1x1600x32xf32, 1x400x32xf32, 1x100x32xf32]) <- (1x6400x32xf32, 1x1600x32xf32, 1x400x32xf32, 1x100x32xf32)
        combine_18 = [transpose_3, transpose_7, transpose_11, transpose_15]

        # pd_op.concat: (1x8500x32xf32) <- ([1x6400x32xf32, 1x1600x32xf32, 1x400x32xf32, 1x100x32xf32], 1xi32)
