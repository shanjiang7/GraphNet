...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        slice_4 = paddle._C_ops.slice(data_3, [0], full_int_array_1, stack_1, [-1], [])
        del data_3, stack_1
        ...
        combine_5 = [full_5, slice_6, full_10]
        del slice_6
        ...
        slice_10 = paddle._C_ops.slice(
            shape64_3, [0], full_int_array_1, full_int_array_3, [1], [0]
        )
        del shape64_3
        ...
        slice_12 = paddle._C_ops.slice(
            shape64_5, [0], full_int_array_1, full_int_array_3, [1], [0]
        )
        del shape64_5
        ...
        combine_6 = [full_5, slice_11, full_7, full_8]
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_7 = [full_5, slice_11, full_10]
        del slice_11
        ...
        slice_15 = paddle._C_ops.slice(
            shape64_6, [0], full_int_array_1, full_int_array_3, [1], [0]
        )
        del shape64_6
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_8 = [full_5, slice_16, full_6, full_7, full_8]
        del full_6
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_9 = [full_5, slice_16, full_10]
        del slice_16
        ...
        slice_20 = paddle._C_ops.slice(
            shape64_8, [0], full_int_array_1, full_int_array_3, [1], [0]
        )
        del shape64_8
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [full_5, slice_21, full_7, full_8]
        del full_7, full_8
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_11 = [full_5, slice_21, full_10]
        del full_10, full_5, slice_21
