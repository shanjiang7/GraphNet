...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        full_0 = paddle._C_ops.full(
            [], float("290"), paddle.int64, paddle.framework._current_expected_place()
        )

        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_0 = paddle._C_ops.equal(data_2, full_0)
        del data_2, full_0

        # pd_op.cast: (290x1xf32) <- (290x1xf64)
        ...
        # pd_op.greater_than: (290x1xb) <- (290x1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_1)

        # pd_op.cast: (290x1xf32) <- (290x1xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)
        del greater_than_0

        # pd_op.multiply: (290x1xf32) <- (290x1xf32, 290x1xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)
        del cast_1

        # pd_op.subtract: (290x1xf32) <- (-1x1xf32, 290x1xf32)
        subtract_0 = paddle._C_ops.subtract(data_4, cast_0)

        # pd_op.abs: (290x1xf32) <- (290x1xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)
        del subtract_0

        # pd_op.pow: (290x1xf32) <- (290x1xf32)
        ...
        # pd_op.scale: (290x1xf32) <- (290x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_2, float("0"), True)
        del full_2, pow_0

        # pd_op.less_equal: (290x1xb) <- (290x1xf32, xf32)
        ...
        # pd_op.add: (290x1xf32) <- (290x1xf32, 290x1xf32)
        add_1 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (-1x1xf32) <- (-1x1xf32, 290x1xf32)
        bce_loss_0 = paddle._C_ops.bce_loss(data_4, cast_0)
        del cast_0, data_4

        # pd_op.multiply: (290x1xf32) <- (-1x1xf32, 290x1xf32)
        ...
        # pd_op.sum: (290xf32) <- (290x1xf32, 1xi64)
        ...
        # pd_op.reshape: (-1x1xf32) <- (290xf32, 2xi64)
        ...
        greater_than_1 = paddle._C_ops.greater_than(data_3, full_4)
        ...
        not_equal_0 = paddle._C_ops.not_equal(cast_3, full_4)
        del cast_3
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_1 = paddle._C_ops.equal(cast_4, full_4)
        del cast_4
        ...
        scale_1 = paddle._C_ops.scale(data_3, full_5, float("0"), True)

        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_2 = paddle._C_ops.equal(scale_1, full_4)
        del scale_1

        # pd_op.cast: (xi64) <- (xb)
        cast_5 = paddle._C_ops.cast(equal_2, paddle.int64)
        del equal_2

        # pd_op.not_equal: (xb) <- (xi64, xi64)
        not_equal_1 = paddle._C_ops.not_equal(cast_5, full_4)
        del cast_5
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_3 = paddle._C_ops.equal(cast_6, full_4)
        del cast_6, full_4
        ...
        slice_1 = paddle._C_ops.slice(
            data_5, [1], full_int_array_3, full_int_array_0, [1], [1]
        )
        ...
        slice_2 = paddle._C_ops.slice(
            data_5, [1], full_int_array_2, full_int_array_4, [1], [1]
        )
        ...
        slice_4 = paddle._C_ops.slice(
            data_6, [1], full_int_array_1, full_int_array_2, [1], [1]
        )
        ...
        slice_6 = paddle._C_ops.slice(
            data_6, [1], full_int_array_2, full_int_array_4, [1], [1]
        )
        del full_int_array_2, full_int_array_4

        # pd_op.slice: (1xf32) <- (1x4xf32, 1xi64, 1xi64)
        slice_7 = paddle._C_ops.slice(
            data_6, [1], full_int_array_0, full_int_array_1, [1], [1]
        )
        ...
        slice_8 = paddle._C_ops.slice(
            data_5, [1], full_int_array_3, full_int_array_1, [1], []
        )
        ...
        combine_1 = [data_3, full_3, full_6]
        del full_6
        ...
        slice_9 = paddle._C_ops.slice(
            data_6, [1], full_int_array_3, full_int_array_1, [1], []
        )

        # pd_op.maximum: (-1x1x2xf32) <- (-1x1x2xf32, 1x2xf32)
        ...
        slice_10 = paddle._C_ops.slice(
            data_5, [1], full_int_array_1, full_int_array_5, [1], []
        )
        del data_5
        ...
        slice_11 = paddle._C_ops.slice(
            data_6, [1], full_int_array_1, full_int_array_5, [1], []
        )
        del data_6, full_int_array_5

        # pd_op.minimum: (-1x1x2xf32) <- (-1x1x2xf32, 1x2xf32)
        ...
        clip_0 = paddle._C_ops.clip(subtract_5, full_7, full_8)
        del subtract_5

        # pd_op.slice: (-1x1xf32) <- (-1x1x2xf32, 1xi64, 1xi64)
        ...
        reshape_3 = paddle._C_ops.reshape(multiply_3, stack_2)
        del multiply_3, stack_2

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [1, 1]

        # pd_op.reshape: (1x1xf32) <- (1xf32, 2xi64)
        reshape_4 = paddle._C_ops.reshape(multiply_4, full_int_array_6)
        del full_int_array_6, multiply_4
        ...
        # pd_op.maximum: (-1x1xf32) <- (-1x1xf32, 1xf32)
        ...
        # pd_op.clip: (-1x1x2xf32) <- (-1x1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_7, full_7, full_8)
        del full_7, full_8, subtract_7
        ...
        scale_2 = paddle._C_ops.scale(subtract_9, full_10, float("1"), True)
        del full_10, subtract_9

        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(reshape_0, full_5, float("0"), True)
        del full_5, reshape_0
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(scale_2, full_11, float("0"), True)
        del full_11, scale_2

        # pd_op.add: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        add_3 = paddle._C_ops.add(scale_3, scale_4)
        del scale_3, scale_4

        # pd_op.logical_not: (-1x1xb) <- (-1x1xb)
        logical_not_0 = paddle._C_ops.logical_not(data_7)
        del data_7

        # pd_op.cast: (-1x1xf32) <- (-1x1xb)
        cast_7 = paddle._C_ops.cast(logical_not_0, paddle.float32)
        del logical_not_0
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(cast_7, full_12, float("0"), True)
        del cast_7, full_12

        # pd_op.add: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        add_0 = paddle._C_ops.add(add_3, scale_5)
        del add_3, scale_5
