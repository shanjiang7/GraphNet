...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.tile: (-1x1xf32) <- (-1x1xf32, 2xi64)
        ...
        slice_4 = paddle._C_ops.slice(
            data_2, [1], full_int_array_4, full_int_array_5, [1], [1]
        )
        del data_2
        ...
        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, 1xf32)
        subtract_0 = paddle._C_ops.subtract(tile_0, slice_5)

        # pd_op.slice: (1xf32) <- (1x4xf32, 1xi64, 1xi64)
        slice_6 = paddle._C_ops.slice(
            data_4, [1], full_int_array_1, full_int_array_3, [1], [1]
        )
        ...
        # pd_op.subtract: (-1x1xf32) <- (1xf32, -1x1xf32)
        subtract_2 = paddle._C_ops.subtract(slice_7, tile_0)

        # pd_op.slice: (1xf32) <- (1x4xf32, 1xi64, 1xi64)
        slice_8 = paddle._C_ops.slice(
            data_4, [1], full_int_array_4, full_int_array_5, [1], [1]
        )
        del data_4, full_int_array_4, full_int_array_5
        ...
        # pd_op.stack: (-1x4x1xf32) <- ([-1x1xf32, -1x1xf32, -1x1xf32, -1x1xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 1)
        del combine_0

        # pd_op.min: (-1x1xf32) <- (-1x4x1xf32, 1xi64)
        ...
        # pd_op.add: (-1x1xf32) <- (1xf32, -1x1xf32)
        ...
        # pd_op.gather: (-1x1xi64) <- (-1x1xi64, -1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(cast_2, squeeze_0, full_4)
        del cast_2

        # pd_op.cast: (-1x1xb) <- (-1x1xi64)
        cast_3 = paddle._C_ops.cast(gather_0, paddle.bool)
        del gather_0
        ...
        # pd_op.gather: (-1x1xi64) <- (-1x1xi64, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(cast_4, squeeze_0, full_4)
        del cast_4, full_4

        # pd_op.cast: (-1x1xb) <- (-1x1xi64)
        cast_5 = paddle._C_ops.cast(gather_1, paddle.bool)
        del gather_1

        # pd_op.logical_and: (-1x1xb) <- (-1x1xb, -1x1xb)
        logical_and_0 = paddle._C_ops.logical_and(cast_3, cast_5)
        del cast_3, cast_5
