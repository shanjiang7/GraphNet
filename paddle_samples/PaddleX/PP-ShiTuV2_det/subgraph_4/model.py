...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_1 = paddle._C_ops.equal(scale_0, full_0)
        del scale_0

        # pd_op.cast: (xi64) <- (xb)
        cast_2 = paddle._C_ops.cast(equal_1, paddle.int64)
        del equal_1
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_2 = paddle._C_ops.equal(cast_3, full_0)
        del cast_3, full_0
        ...
        combine_0 = [data_0, full_2, full_3]
        del full_3
        ...
        clip_0 = paddle._C_ops.clip(subtract_4, full_4, full_5)
        del full_4, full_5, subtract_4
        ...
        reshape_2 = paddle._C_ops.reshape(multiply_0, stack_1)
        del multiply_0, stack_1

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [1, 1]

        # pd_op.reshape: (1x1xf32) <- (1xf32, 2xi64)
        reshape_3 = paddle._C_ops.reshape(multiply_1, full_int_array_6)
