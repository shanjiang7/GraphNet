...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x32x288x288xf32) <- (2x3x576x576xf32, 32x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_521, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_521

        # pd_op.batch_norm_: (2x32x288x288xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (2x32x288x288xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (2x32x288x288xf32) <- (2x32x288x288xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (2x32x288x288xf32) <- (2x32x288x288xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x64x288x288xf32) <- (2x32x288x288xf32, 64x32x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_511, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_511

        # pd_op.batch_norm_: (2x64x288x288xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (2x64x288x288xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (2x64x288x288xf32) <- (2x64x288x288xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (2x64x144x144xf32) <- (2x64x288x288xf32, 64x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_506, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del parameter_506

        # pd_op.batch_norm_: (2x64x144x144xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (2x64x144x144xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (2x64x144x144xf32) <- (2x64x144x144xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (2x128x144x144xf32) <- (2x64x144x144xf32, 128x64x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_501, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_501

        # pd_op.batch_norm_: (2x128x144x144xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (2x128x144x144xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (2x128x144x144xf32) <- (2x128x144x144xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (2x128x144x144xf32) <- (2x128x144x144xf32, 128x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x128x144x144xf32) <- (2x128x144x144xf32, 128x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x128x72x72xf32) <- (2x128x144x144xf32, 128x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_486, [2, 2], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_486

        # pd_op.batch_norm_: (2x128x72x72xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (2x128x72x72xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (2x128x72x72xf32) <- (2x128x72x72xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (2x256x72x72xf32) <- (2x128x72x72xf32, 256x128x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            hardswish_7, parameter_481, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_481

        # pd_op.batch_norm_: (2x256x72x72xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (2x256x72x72xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.hardswish: (2x256x72x72xf32) <- (2x256x72x72xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)

        # pd_op.depthwise_conv2d: (2x256x72x72xf32) <- (2x256x72x72xf32, 256x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x256x72x72xf32) <- (2x256x72x72xf32, 256x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x256x36x36xf32) <- (2x256x72x72xf32, 256x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_466, [2, 2], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_466

        # pd_op.batch_norm_: (2x256x36x36xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (2x256x36x36xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (2x256x36x36xf32) <- (2x256x36x36xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (2x512x36x36xf32) <- (2x256x36x36xf32, 512x256x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_461, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_461

        # pd_op.batch_norm_: (2x512x36x36xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (2x512x36x36xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (2x512x36x36xf32) <- (2x512x36x36xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (2x512x36x36xf32) <- (2x512x36x36xf32, 512x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x512x36x36xf32) <- (2x512x36x36xf32, 512x512x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x512x18x18xf32) <- (2x512x36x36xf32, 512x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_406, [2, 2], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        del parameter_406

        # pd_op.batch_norm_: (2x512x18x18xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (2x512x18x18xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (2x512x18x18xf32) <- (2x512x18x18xf32)
        ...
        # pd_op.pool2d: (2x512x1x1xf32) <- (2x512x18x18xf32, 2xi64)
        ...
        # pd_op.multiply: (2x512x18x18xf32) <- (2x512x18x18xf32, 2x512x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (2x1024x18x18xf32) <- (2x512x18x18xf32, 1024x512x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_397, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_397

        # pd_op.batch_norm_: (2x1024x18x18xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32, -1xui8) <- (2x1024x18x18xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (2x1024x18x18xf32) <- (2x1024x18x18xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (2x1024x18x18xf32) <- (2x1024x18x18xf32, 1024x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x1024x1x1xf32) <- (2x1024x18x18xf32, 2xi64)
        ...
        # pd_op.multiply: (2x1024x18x18xf32) <- (2x1024x18x18xf32, 2x1024x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (2x1024x18x18xf32) <- (2x1024x18x18xf32, 1024x1024x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x72x72xf32) <- (2x256x72x72xf32, 160x256x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            hardswish_10, parameter_378, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_378

        # pd_op.batch_norm_: (2x160x72x72xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x72x72xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.hardswish: (2x160x72x72xf32) <- (2x160x72x72xf32)
        hardswish_27 = paddle._C_ops.hardswish(batch_norm__162)

        # pd_op.conv2d: (2x160x36x36xf32) <- (2x512x36x36xf32, 160x512x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            hardswish_22, parameter_373, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_373

        # pd_op.batch_norm_: (2x160x36x36xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x36x36xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.hardswish: (2x160x36x36xf32) <- (2x160x36x36xf32)
        hardswish_28 = paddle._C_ops.hardswish(batch_norm__168)

        # pd_op.conv2d: (2x160x18x18xf32) <- (2x1024x18x18xf32, 160x1024x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_26, parameter_368, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_368

        # pd_op.batch_norm_: (2x160x18x18xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x18x18xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (2x160x18x18xf32) <- (2x160x18x18xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.nearest_interp: (2x160x36x36xf32) <- (2x160x18x18xf32, None, None, None)
        ...
        # builtin.combine: ([2x160x36x36xf32, 2x160x36x36xf32]) <- (2x160x36x36xf32, 2x160x36x36xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (2x320x36x36xf32) <- ([2x160x36x36xf32, 2x160x36x36xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0

        # pd_op.depthwise_conv2d: (2x320x36x36xf32) <- (2x320x36x36xf32, 320x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_363, [1, 1], [2, 2], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        del parameter_363

        # pd_op.batch_norm_: (2x320x36x36xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (2x320x36x36xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        (
            batch_norm__180,
            batch_norm__181,
            batch_norm__182,
        ...
        # pd_op.hardswish: (2x320x36x36xf32) <- (2x320x36x36xf32)
        hardswish_30 = paddle._C_ops.hardswish(batch_norm__180)

        # pd_op.conv2d: (2x320x36x36xf32) <- (2x320x36x36xf32, 320x320x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x36x36xf32) <- (2x320x36x36xf32, 160x320x1x1xf32)
        ...
        # pd_op.nearest_interp: (2x160x72x72xf32) <- (2x160x36x36xf32, None, None, None)
        ...
        # builtin.combine: ([2x160x72x72xf32, 2x160x72x72xf32]) <- (2x160x72x72xf32, 2x160x72x72xf32)
        combine_1 = [nearest_interp_1, hardswish_27]

        # pd_op.concat: (2x320x72x72xf32) <- ([2x160x72x72xf32, 2x160x72x72xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (2x320x72x72xf32) <- (2x320x72x72xf32, 320x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            concat_4, parameter_343, [1, 1], [2, 2], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        del parameter_343

        # pd_op.batch_norm_: (2x320x72x72xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (2x320x72x72xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (2x320x72x72xf32) <- (2x320x72x72xf32)
        hardswish_34 = paddle._C_ops.hardswish(batch_norm__204)

        # pd_op.conv2d: (2x320x72x72xf32) <- (2x320x72x72xf32, 320x320x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x72x72xf32) <- (2x320x72x72xf32, 160x320x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x36x36xf32) <- (2x160x72x72xf32, 160x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x160x36x36xf32) <- (2x160x36x36xf32, 160x160x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x18x18xf32) <- (2x160x36x36xf32, 160x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x160x18x18xf32) <- (2x160x18x18xf32, 160x160x1x1xf32)
        ...
        # builtin.combine: ([2x160x18x18xf32, 2x160x18x18xf32]) <- (2x160x18x18xf32, 2x160x18x18xf32)
        combine_3 = [hardswish_45, hardswish_29]

        # pd_op.concat: (2x320x18x18xf32) <- ([2x160x18x18xf32, 2x160x18x18xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_3, full_0)
        del combine_3

        # pd_op.depthwise_conv2d: (2x320x18x18xf32) <- (2x320x18x18xf32, 320x1x5x5xf32)
        depthwise_conv2d_21 = paddle._C_ops.depthwise_conv2d(
            concat_6, parameter_283, [1, 1], [2, 2], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        del parameter_283

        # pd_op.batch_norm_: (2x320x18x18xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (2x320x18x18xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.hardswish: (2x320x18x18xf32) <- (2x320x18x18xf32)
        hardswish_46 = paddle._C_ops.hardswish(batch_norm__276)

        # pd_op.conv2d: (2x320x18x18xf32) <- (2x320x18x18xf32, 320x320x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x18x18xf32) <- (2x320x18x18xf32, 160x320x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x9x9xf32) <- (2x160x18x18xf32, 160x1x5x5xf32)
        depthwise_conv2d_23 = paddle._C_ops.depthwise_conv2d(
            hardswish_29, parameter_263, [2, 2], [2, 2], "EXPLICIT", 160, [1, 1], "NCHW"
        )
        del parameter_263

        # pd_op.batch_norm_: (2x160x9x9xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x9x9xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__300,
            batch_norm__301,
            batch_norm__302,
        ...
        # pd_op.hardswish: (2x160x9x9xf32) <- (2x160x9x9xf32)
        hardswish_50 = paddle._C_ops.hardswish(batch_norm__300)

        # pd_op.conv2d: (2x160x9x9xf32) <- (2x160x9x9xf32, 160x160x1x1xf32)
        ...
        # pd_op.add: (2x160x9x9xf32) <- (2x160x9x9xf32, 2x160x9x9xf32)
        add_4 = paddle._C_ops.add(hardswish_51, hardswish_53)

        # pd_op.shape64: (4xi64) <- (2x160x72x72xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x72x72xf32) <- (2x160x72x72xf32, 160x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x160x72x72xf32) <- (2x160x72x72xf32, 160x160x1x1xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x72x72xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x72x72xf32) <- (2x160x72x72xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x72x72xf32) <- (2x160x72x72xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x72x72xf32) <- (2x11x72x72xf32, 1x11x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_39, reshape_5)

        # pd_op.conv2d: (2x32x72x72xf32) <- (2x160x72x72xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x72x72xf32) <- (2x32x72x72xf32, 1x32x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_40, reshape_6)

        # pd_op.conv2d: (2x1x72x72xf32) <- (2x160x72x72xf32, 1x160x5x5xf32)
        conv2d_41 = paddle._C_ops.conv2d(
            hardswish_61, parameter_192, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_192

        # pd_op.batch_norm_: (2x1x72x72xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x72x72xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__378,
            batch_norm__379,
            batch_norm__380,
        ...
        # pd_op.hardswish: (2x1x72x72xf32) <- (2x1x72x72xf32)
        hardswish_63 = paddle._C_ops.hardswish(batch_norm__378)

        # pd_op.conv2d: (2x1x72x72xf32) <- (2x1x72x72xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x72x72xf32) <- (2x1x72x72xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__384)
        del batch_norm__384

        # pd_op.sigmoid: (2x11x72x72xf32) <- (2x11x72x72xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_6)
        del add_6

        # pd_op.multiply: (2x11x72x72xf32) <- (2x11x72x72xf32, 2x1x72x72xf32)
        ...
        # pd_op.scale: (2x11x72x72xf32) <- (2x11x72x72xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(multiply_3, full_1, float("1e-09"), True)
        del multiply_3

        # pd_op.sqrt: (2x11x72x72xf32) <- (2x11x72x72xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_0)
        del scale_0

        # pd_op.transpose: (2x72x72x11xf32) <- (2x11x72x72xf32)
        transpose_0 = paddle._C_ops.transpose(sqrt_0, [0, 2, 3, 1])

        # pd_op.transpose: (2x72x72x32xf32) <- (2x32x72x72xf32)
        ...
        # pd_op.reshape: (2x5184x11xf32) <- (2x72x72x11xf32, 3xi64)
        ...
        # pd_op.reshape: (41472x8xf32) <- (2x72x72x32xf32, 2xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_10 = [2, 5184, 4]

        # pd_op.reshape: (2x5184x4xf32) <- (10368x4xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([2x5184x2xf32, 2x5184x2xf32]) <- (2x5184x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_10, 2, full_6)
        del reshape_10

        # builtin.split: (2x5184x2xf32, 2x5184x2xf32) <- ([2x5184x2xf32, 2x5184x2xf32])
        (
            split_2,
            split_3,
        ) = split_with_num_0
        ...
        # pd_op.scale: (2x5184x2xf32) <- (2x5184x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_2, full_7, float("0"), True)
        del split_2

        # pd_op.add: (2x5184x2xf32) <- (2x5184x2xf32, 5184x2xf32)
        ...
        # builtin.combine: ([2x5184x2xf32, 2x5184x2xf32]) <- (2x5184x2xf32, 2x5184x2xf32)
        combine_6 = [add_8, add_9]

        # pd_op.concat: (2x5184x4xf32) <- ([2x5184x2xf32, 2x5184x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_8)
        del combine_6

        # pd_op.flatten: (2x11x5184xf32) <- (2x11x72x72xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (2x5184x11xf32) <- (2x11x5184xf32)
        transpose_2 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])
        del flatten_2

        # pd_op.flatten: (2x32x5184xf32) <- (2x32x72x72xf32)
        flatten_3 = paddle._C_ops.flatten(add_7, 2, 3)

        # pd_op.transpose: (2x5184x32xf32) <- (2x32x5184xf32)
        ...
        # pd_op.scale: (2x5184x4xf32) <- (2x5184x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_7, full_9, float("0"), True)
        del concat_7

        # pd_op.shape64: (4xi64) <- (2x160x36x36xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x36x36xf32) <- (2x160x36x36xf32, 160x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x36x36xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x36x36xf32) <- (2x160x36x36xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x36x36xf32) <- (2x160x36x36xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x36x36xf32) <- (2x11x36x36xf32, 1x11x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_49, reshape_12)

        # pd_op.conv2d: (2x32x36x36xf32) <- (2x160x36x36xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x36x36xf32) <- (2x32x36x36xf32, 1x32x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_50, reshape_13)

        # pd_op.conv2d: (2x1x36x36xf32) <- (2x160x36x36xf32, 1x160x5x5xf32)
        conv2d_51 = paddle._C_ops.conv2d(
            hardswish_71, parameter_131, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_131

        # pd_op.batch_norm_: (2x1x36x36xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x36x36xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__444,
            batch_norm__445,
            batch_norm__446,
        ...
        # pd_op.hardswish: (2x1x36x36xf32) <- (2x1x36x36xf32)
        hardswish_73 = paddle._C_ops.hardswish(batch_norm__444)

        # pd_op.conv2d: (2x1x36x36xf32) <- (2x1x36x36xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x36x36xf32) <- (2x1x36x36xf32)
        sigmoid_4 = paddle._C_ops.sigmoid(batch_norm__450)
        del batch_norm__450

        # pd_op.sigmoid: (2x11x36x36xf32) <- (2x11x36x36xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_11)
        del add_11

        # pd_op.multiply: (2x11x36x36xf32) <- (2x11x36x36xf32, 2x1x36x36xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (2x11x36x36xf32) <- (2x11x36x36xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)
        del multiply_5

        # pd_op.sqrt: (2x11x36x36xf32) <- (2x11x36x36xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_6)
        del scale_6

        # pd_op.transpose: (2x36x36x11xf32) <- (2x11x36x36xf32)
        transpose_4 = paddle._C_ops.transpose(sqrt_1, [0, 2, 3, 1])

        # pd_op.transpose: (2x36x36x32xf32) <- (2x32x36x36xf32)
        ...
        # pd_op.reshape: (2x1296x11xf32) <- (2x36x36x11xf32, 3xi64)
        reshape_14 = paddle._C_ops.reshape(transpose_4, full_int_array_7)
        del transpose_4

        # pd_op.reshape: (10368x8xf32) <- (2x36x36x32xf32, 2xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_11 = [2, 1296, 4]

        # pd_op.reshape: (2x1296x4xf32) <- (2592x4xf32, 3xi64)
        reshape_17 = paddle._C_ops.reshape(scale_9, full_int_array_11)
        del full_int_array_11

        # pd_op.split_with_num: ([2x1296x2xf32, 2x1296x2xf32]) <- (2x1296x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(reshape_17, 2, full_6)
        del reshape_17

        # builtin.split: (2x1296x2xf32, 2x1296x2xf32) <- ([2x1296x2xf32, 2x1296x2xf32])
        (
            split_6,
            split_7,
        ) = split_with_num_1
        ...
        # pd_op.scale: (2x1296x2xf32) <- (2x1296x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_6, full_7, float("0"), True)
        del split_6

        # pd_op.add: (2x1296x2xf32) <- (2x1296x2xf32, 1296x2xf32)
        add_13 = paddle._C_ops.add(scale_10, stack_1)

        # pd_op.add: (2x1296x2xf32) <- (2x1296x2xf32, 1296x2xf32)
        add_14 = paddle._C_ops.add(split_7, stack_1)

        # builtin.combine: ([2x1296x2xf32, 2x1296x2xf32]) <- (2x1296x2xf32, 2x1296x2xf32)
        combine_9 = [add_13, add_14]

        # pd_op.concat: (2x1296x4xf32) <- ([2x1296x2xf32, 2x1296x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_8)
        del combine_9

        # pd_op.flatten: (2x11x1296xf32) <- (2x11x36x36xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (2x1296x11xf32) <- (2x11x1296xf32)
        transpose_6 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])
        del flatten_6

        # pd_op.flatten: (2x32x1296xf32) <- (2x32x36x36xf32)
        flatten_7 = paddle._C_ops.flatten(add_12, 2, 3)

        # pd_op.transpose: (2x1296x32xf32) <- (2x32x1296xf32)
        ...
        # pd_op.scale: (2x1296x4xf32) <- (2x1296x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_8, full_12, float("0"), True)
        del concat_8

        # pd_op.shape64: (4xi64) <- (2x160x18x18xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x18x18xf32) <- (2x160x18x18xf32, 160x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x18x18xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x18x18xf32) <- (2x160x18x18xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x18x18xf32) <- (2x160x18x18xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x18x18xf32) <- (2x11x18x18xf32, 1x11x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_59, reshape_19)

        # pd_op.conv2d: (2x32x18x18xf32) <- (2x160x18x18xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x18x18xf32) <- (2x32x18x18xf32, 1x32x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_60, reshape_20)

        # pd_op.conv2d: (2x1x18x18xf32) <- (2x160x18x18xf32, 1x160x5x5xf32)
        conv2d_61 = paddle._C_ops.conv2d(
            hardswish_81, parameter_70, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_70

        # pd_op.batch_norm_: (2x1x18x18xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x18x18xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__510,
            batch_norm__511,
            batch_norm__512,
        ...
        # pd_op.hardswish: (2x1x18x18xf32) <- (2x1x18x18xf32)
        hardswish_83 = paddle._C_ops.hardswish(batch_norm__510)

        # pd_op.conv2d: (2x1x18x18xf32) <- (2x1x18x18xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x18x18xf32) <- (2x1x18x18xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__516)
        del batch_norm__516

        # pd_op.sigmoid: (2x11x18x18xf32) <- (2x11x18x18xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_16)
        del add_16

        # pd_op.multiply: (2x11x18x18xf32) <- (2x11x18x18xf32, 2x1x18x18xf32)
        multiply_7 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (2x11x18x18xf32) <- (2x11x18x18xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_7, full_1, float("1e-09"), True)
        del multiply_7

        # pd_op.sqrt: (2x11x18x18xf32) <- (2x11x18x18xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_12)
        del scale_12

        # pd_op.transpose: (2x18x18x11xf32) <- (2x11x18x18xf32)
        transpose_8 = paddle._C_ops.transpose(sqrt_2, [0, 2, 3, 1])

        # pd_op.transpose: (2x18x18x32xf32) <- (2x32x18x18xf32)
        ...
        # pd_op.reshape: (2x324x11xf32) <- (2x18x18x11xf32, 3xi64)
        reshape_21 = paddle._C_ops.reshape(transpose_8, full_int_array_7)
        del transpose_8

        # pd_op.reshape: (2592x8xf32) <- (2x18x18x32xf32, 2xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_12 = [2, 324, 4]

        # pd_op.reshape: (2x324x4xf32) <- (648x4xf32, 3xi64)
        reshape_24 = paddle._C_ops.reshape(scale_15, full_int_array_12)
        del full_int_array_12

        # pd_op.split_with_num: ([2x324x2xf32, 2x324x2xf32]) <- (2x324x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(reshape_24, 2, full_6)
        del reshape_24

        # builtin.split: (2x324x2xf32, 2x324x2xf32) <- ([2x324x2xf32, 2x324x2xf32])
        (
            split_10,
            split_11,
        ) = split_with_num_2
        ...
        # pd_op.scale: (2x324x2xf32) <- (2x324x2xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(split_10, full_7, float("0"), True)
        del split_10

        # pd_op.add: (2x324x2xf32) <- (2x324x2xf32, 324x2xf32)
        add_18 = paddle._C_ops.add(scale_16, stack_2)

        # pd_op.add: (2x324x2xf32) <- (2x324x2xf32, 324x2xf32)
        add_19 = paddle._C_ops.add(split_11, stack_2)

        # builtin.combine: ([2x324x2xf32, 2x324x2xf32]) <- (2x324x2xf32, 2x324x2xf32)
        combine_12 = [add_18, add_19]

        # pd_op.concat: (2x324x4xf32) <- ([2x324x2xf32, 2x324x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_8)
        del combine_12

        # pd_op.flatten: (2x11x324xf32) <- (2x11x18x18xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (2x324x11xf32) <- (2x11x324xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])
        del flatten_10

        # pd_op.flatten: (2x32x324xf32) <- (2x32x18x18xf32)
        flatten_11 = paddle._C_ops.flatten(add_17, 2, 3)

        # pd_op.transpose: (2x324x32xf32) <- (2x32x324xf32)
        ...
        # pd_op.scale: (2x324x4xf32) <- (2x324x4xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(concat_9, full_15, float("0"), True)
        del concat_9

        # pd_op.shape64: (4xi64) <- (2x160x9x9xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x9x9xf32) <- (2x160x9x9xf32, 160x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x9x9xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x9x9xf32) <- (2x160x9x9xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x9x9xf32) <- (2x160x9x9xf32, 11x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x32x9x9xf32) <- (2x160x9x9xf32, 32x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x1x9x9xf32) <- (2x160x9x9xf32, 1x160x5x5xf32)
        ...
        # builtin.combine: ([2x5184x11xf32, 2x1296x11xf32, 2x324x11xf32, 2x81x11xf32]) <- (2x5184x11xf32, 2x1296x11xf32, 2x324x11xf32, 2x81x11xf32)
        combine_16 = [transpose_2, transpose_6, transpose_10, transpose_14]

        # pd_op.concat: (2x6885x11xf32) <- ([2x5184x11xf32, 2x1296x11xf32, 2x324x11xf32, 2x81x11xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_16, full_0)
        del combine_16

        # builtin.combine: ([2x5184x4xf32, 2x1296x4xf32, 2x324x4xf32, 2x81x4xf32]) <- (2x5184x4xf32, 2x1296x4xf32, 2x324x4xf32, 2x81x4xf32)
        combine_17 = [scale_5, scale_11, scale_17, scale_23]

        # pd_op.concat: (2x6885x4xf32) <- ([2x5184x4xf32, 2x1296x4xf32, 2x324x4xf32, 2x81x4xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_17, full_0)
        del combine_17

        # builtin.combine: ([2x5184x32xf32, 2x1296x32xf32, 2x324x32xf32, 2x81x32xf32]) <- (2x5184x32xf32, 2x1296x32xf32, 2x324x32xf32, 2x81x32xf32)
        combine_18 = [transpose_3, transpose_7, transpose_11, transpose_15]

        # pd_op.concat: (2x6885x32xf32) <- ([2x5184x32xf32, 2x1296x32xf32, 2x324x32xf32, 2x81x32xf32], 1xi32)
