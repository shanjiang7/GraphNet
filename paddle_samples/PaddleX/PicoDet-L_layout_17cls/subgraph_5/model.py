...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.maximum: (4x6885x2xf32) <- (4x1x2xf32, 1x6885x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (4x6885x2xf32) <- (4x1x2xf32, 1x6885x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (4x6885x2xf32) <- (4x6885x2xf32, 4x6885x2xf32)
        ...
        # pd_op.clip: (4x6885x2xf32) <- (4x6885x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (4x6885xf32) <- (4x6885x2xf32, 1xi64)
        ...
        # pd_op.add: (4x6885xf32) <- (4x1xf32, 1x6885xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (4x6885xf32) <- (4x6885xf32, 4x6885xf32)
        ...
        # pd_op.scale: (4x6885xf32) <- (4x6885xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-10"), True)
        del full_2, subtract_3

        # pd_op.divide: (4x6885xf32) <- (4x6885xf32, 4x6885xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [2, -1, 6885]

        # pd_op.reshape: (2x2x6885xf32) <- (4x6885xf32, 3xi64)
        ...
        # pd_op.subtract: (4x6885x2xf32) <- (4x1x2xf32, 1x6885x2xf32)
        subtract_4 = paddle._C_ops.subtract(unsqueeze_2, unsqueeze_3)
        del unsqueeze_2, unsqueeze_3

        # pd_op.p_norm: (4x6885xf32) <- (4x6885x2xf32)
