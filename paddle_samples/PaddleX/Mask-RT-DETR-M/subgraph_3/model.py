...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x256x68x68xf32) <- (1x256x68x68xf32, 256x256x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_13, parameter_158, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_13, parameter_158

        # pd_op.batch_norm_: (1x256x68x68xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (1x256x68x68xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.conv2d: (1x256x34x34xf32) <- (1x256x34x34xf32, 256x256x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            data_14, parameter_153, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_14, parameter_153

        # pd_op.batch_norm_: (1x256x34x34xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (1x256x34x34xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.conv2d: (1x256x17x17xf32) <- (1x256x17x17xf32, 256x256x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            data_15, parameter_148, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_15, parameter_148

        # pd_op.batch_norm_: (1x256x17x17xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (1x256x17x17xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.flatten: (1x256x4624xf32) <- (1x256x68x68xf32)
        flatten_0 = paddle._C_ops.flatten(batch_norm__0, 2, 3)

        # pd_op.transpose: (1x4624x256xf32) <- (1x256x4624xf32)
        transpose_0 = paddle._C_ops.transpose(flatten_0, [0, 2, 1])
        del flatten_0

        # pd_op.flatten: (1x256x1156xf32) <- (1x256x34x34xf32)
        flatten_1 = paddle._C_ops.flatten(batch_norm__6, 2, 3)

        # pd_op.transpose: (1x1156x256xf32) <- (1x256x1156xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_1, [0, 2, 1])
        del flatten_1

        # pd_op.flatten: (1x256x289xf32) <- (1x256x17x17xf32)
        flatten_2 = paddle._C_ops.flatten(batch_norm__12, 2, 3)

        # pd_op.transpose: (1x289x256xf32) <- (1x256x289xf32)
        ...
        # builtin.combine: ([1x4624x256xf32, 1x1156x256xf32, 1x289x256xf32]) <- (1x4624x256xf32, 1x1156x256xf32, 1x289x256xf32)
        combine_0 = [transpose_0, transpose_1, transpose_2]

        # pd_op.concat: (1x6069x256xf32) <- ([1x4624x256xf32, 1x1156x256xf32, 1x289x256xf32], 1xi32)
        ...
        # pd_op.unsqueeze: (1x68x68x2xf32) <- (68x68x2xf32, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(stack_4, full_int_array_1)
        del stack_4

        # pd_op.scale: (1x68x68x2xf32) <- (1x68x68x2xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(unsqueeze_0, full_6, float("0.5"), True)
        del unsqueeze_0

        # pd_op.divide: (1x68x68x2xf32) <- (1x68x68x2xf32, 2xf32)
        divide_1 = paddle._C_ops.divide(scale_5, cast_2)
        del cast_2, scale_5

        # pd_op.full_like: (1x68x68x2xf32) <- (1x68x68x2xf32, 1xf32)
        ...
        # builtin.combine: ([1x68x68x2xf32, 1x68x68x2xf32]) <- (1x68x68x2xf32, 1x68x68x2xf32)
        combine_6 = [divide_1, scale_7]
        del divide_1, scale_7

        # pd_op.concat: (1x68x68x4xf32) <- ([1x68x68x2xf32, 1x68x68x2xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_6, full_9)
        del combine_6

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_409 = [-1, 4624, 4]

        # pd_op.reshape: (1x4624x4xf32) <- (1x68x68x4xf32, 3xi64)
        ...
        # pd_op.unsqueeze: (1x34x34x2xf32) <- (34x34x2xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(stack_5, full_int_array_1)
        del stack_5

        # pd_op.scale: (1x34x34x2xf32) <- (1x34x34x2xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(unsqueeze_1, full_6, float("0.5"), True)
        del unsqueeze_1

        # pd_op.divide: (1x34x34x2xf32) <- (1x34x34x2xf32, 2xf32)
        divide_2 = paddle._C_ops.divide(scale_8, cast_3)
        del cast_3, scale_8

        # pd_op.full_like: (1x34x34x2xf32) <- (1x34x34x2xf32, 1xf32)
        ...
        # builtin.combine: ([1x34x34x2xf32, 1x34x34x2xf32]) <- (1x34x34x2xf32, 1x34x34x2xf32)
        combine_9 = [divide_2, scale_10]
        del divide_2, scale_10

        # pd_op.concat: (1x34x34x4xf32) <- ([1x34x34x2xf32, 1x34x34x2xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_9, full_9)
        del combine_9

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_410 = [-1, 1156, 4]

        # pd_op.reshape: (1x1156x4xf32) <- (1x34x34x4xf32, 3xi64)
        ...
        # pd_op.unsqueeze: (1x17x17x2xf32) <- (17x17x2xf32, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(stack_6, full_int_array_1)
        del stack_6

        # pd_op.scale: (1x17x17x2xf32) <- (1x17x17x2xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(unsqueeze_2, full_6, float("0.5"), True)
        del unsqueeze_2

        # pd_op.divide: (1x17x17x2xf32) <- (1x17x17x2xf32, 2xf32)
        divide_3 = paddle._C_ops.divide(scale_11, cast_4)
        del cast_4, scale_11

        # pd_op.full_like: (1x17x17x2xf32) <- (1x17x17x2xf32, 1xf32)
        ...
        # builtin.combine: ([1x17x17x2xf32, 1x17x17x2xf32]) <- (1x17x17x2xf32, 1x17x17x2xf32)
        combine_12 = [divide_3, scale_13]
        del divide_3, scale_13

        # pd_op.concat: (1x17x17x4xf32) <- ([1x17x17x2xf32, 1x17x17x2xf32], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_12, full_9)
        del combine_12

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_411 = [-1, 289, 4]

        # pd_op.reshape: (1x289x4xf32) <- (1x17x17x4xf32, 3xi64)
        reshape_6 = paddle._C_ops.reshape(concat_5, full_int_array_411)
        del concat_5, full_int_array_411

        # builtin.combine: ([1x4624x4xf32, 1x1156x4xf32, 1x289x4xf32]) <- (1x4624x4xf32, 1x1156x4xf32, 1x289x4xf32)
        combine_13 = [reshape_4, reshape_5, reshape_6]
        del reshape_4, reshape_5, reshape_6

        # pd_op.concat: (1x6069x4xf32) <- ([1x4624x4xf32, 1x1156x4xf32, 1x289x4xf32], 1xi32)
        ...
        # pd_op.greater_than: (1x6069x4xb) <- (1x6069x4xf32, xf32)
        ...
        # pd_op.full_like: (1x6069x4xf32) <- (1x6069x4xf32, 1xf32)
        ...
        # pd_op.add: (1x6069x4xf32) <- (1x6069x4xf32, xf32)
        add_3 = paddle._C_ops.add(full_like_3, full_like_4)
        del full_like_3, full_like_4

        # pd_op.add: (1x6069x4xf32) <- (1x6069x4xf32, 1x6069x1xf32)
        add_4 = paddle._C_ops.add(add_3, cast_5)
        del add_3, cast_5

        # pd_op.add: (1x6069x4xf32) <- (1x6069x4xf32, 1x6069x4xf32)
        add_5 = paddle._C_ops.add(log_1, add_4)
        del log_1

        # pd_op.add: (1x6069x4xf32) <- (xf32, 1x6069x4xf32)
        add_6 = paddle._C_ops.add(assign_value__3, add_4)
        del assign_value__3

        # pd_op.add: (1x6069x4xf32) <- (1x6069x1xf32, 1x6069x4xf32)
        add_7 = paddle._C_ops.add(cast_6, add_4)
        del add_4, cast_6

        # pd_op.cast: (1x6069x4xb) <- (1x6069x4xf32)
        cast_7 = paddle._C_ops.cast(add_7, paddle.bool)
        del add_7

        # pd_op.where: (1x6069x4xf32) <- (1x6069x4xb, 1x6069x4xf32, 1x6069x4xf32)
        ...
        # pd_op.full_like: (1x6069x256xf32) <- (1x6069x256xf32, 1xf32)
        ...
        # pd_op.add: (1x6069x256xf32) <- (1x6069x256xf32, xf32)
        add_8 = paddle._C_ops.add(full_like_6, full_like_7)
        del full_like_6, full_like_7

        # pd_op.add: (1x6069x256xf32) <- (1x6069x256xf32, 1x6069x1xf32)
        add_9 = paddle._C_ops.add(add_8, cast_8)
        del add_8, cast_8

        # pd_op.add: (1x6069x256xf32) <- (1x6069x256xf32, 1x6069x256xf32)
        add_10 = paddle._C_ops.add(concat_0, add_9)

        # pd_op.add: (1x6069x256xf32) <- (xf32, 1x6069x256xf32)
        add_11 = paddle._C_ops.add(assign_value__4, add_9)
        del assign_value__4

        # pd_op.add: (1x6069x256xf32) <- (1x6069x1xf32, 1x6069x256xf32)
        add_12 = paddle._C_ops.add(cast_9, add_9)
        del cast_9

        # pd_op.cast: (1x6069x256xb) <- (1x6069x256xf32)
        cast_10 = paddle._C_ops.cast(add_12, paddle.bool)
        del add_12

        # pd_op.where: (1x6069x256xf32) <- (1x6069x256xb, 1x6069x256xf32, 1x6069x256xf32)
        ...
        # pd_op.layer_norm: (1x6069x256xf32, 1x6069xf32, 1x6069xf32) <- (1x6069x256xf32, 256xf32, 256xf32)
        ...
        # pd_op.matmul: (1x6069x2xf32) <- (1x6069x256xf32, 256x2xf32)
        matmul_1 = paddle._C_ops.matmul(layer_norm_0, parameter_139, False, False)

        # pd_op.add: (1x6069x2xf32) <- (1x6069x2xf32, 2xf32)
        ...
        # pd_op.relu: (1x6069x256xf32) <- (1x6069x256xf32)
        ...
        # pd_op.topk: (1x300xf32, 1x300xi64) <- (1x6069xf32, 1xi32)
        ...
        # pd_op.gather_nd: (1x300x256xf32) <- (1x6069x256xf32, 1x300x2xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(layer_norm_0, stack_7)

        # pd_op.gather_nd: (1x300x4xf32) <- (1x6069x4xf32, 1x300x2xi64)
        ...
        # pd_op.flatten: (1x128x18496xf32) <- (1x128x136x136xf32)
        flatten_6 = paddle._C_ops.flatten(data_16, 2, 3)
        del data_16

        # pd_op.assign: (1x128x18496xf32) <- (1x128x18496xf32)
        ...
        # pd_op.bmm: (1x300x18496xf32) <- (1x300x128xf32, 1x128x18496xf32)
        bmm_0 = paddle._C_ops.bmm(add_21, flatten_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_413 = [1, 300, 136, 136]

        # pd_op.reshape: (1x300x136x136xf32) <- (1x300x18496xf32, 4xi64)
        ...
        # pd_op.greater_than: (1x300x136x136xb) <- (1x300x136x136xf32, xf32)
        ...
        # pd_op.cast: (1x300x136x136xf32) <- (1x300x136x136xb)
        cast_11 = paddle._C_ops.cast(greater_than_1, paddle.float32)

        # pd_op.multiply: (1x300x136x136xf32) <- (136x136xf32, 1x300x136x136xf32)
        multiply_3 = paddle._C_ops.multiply(split_9, cast_11)
        del cast_11, split_9

        # pd_op.flatten: (1x300x18496xf32) <- (1x300x136x136xf32)
        flatten_7 = paddle._C_ops.flatten(multiply_3, 2, 3)

        # pd_op.max: (1x300xf32) <- (1x300x18496xf32, 1xi64)
        ...
        # pd_op.full_like: (1x300x136x136xf32) <- (1x300x136x136xf32, 1xf32)
        ...
        # pd_op.full_like: (1x300x136x136xb) <- (1x300x136x136xb, 1xf32)
        ...
        # pd_op.add: (1x300x136x136xf32) <- (1x300x136x136xf32, xf32)
        add_22 = paddle._C_ops.add(full_like_9, full_like_10)
        del full_like_10, full_like_9

        # pd_op.add: (1x300x136x136xf32) <- (1x300x136x136xf32, 1x300x136x136xf32)
        ...
        # pd_op.add: (1x300x136x136xf32) <- (xf32, 1x300x136x136xf32)
        ...
        # pd_op.cast: (1x300x136x136xb) <- (1x300x136x136xf32)
        cast_14 = paddle._C_ops.cast(add_26, paddle.bool)
        del add_26

        # pd_op.where: (1x300x136x136xf32) <- (1x300x136x136xb, 1x300x136x136xf32, 1x300x136x136xf32)
        ...
        # pd_op.min: (1x300xf32) <- (1x300x18496xf32, 1xi64)
        ...
        # pd_op.any: (1x300xb) <- (1x300x136x136xb)
        ...
        assign_value__7 = paddle._C_ops.assign_value_(
            ...
            [4],
            paddle.int64,
            [float("136"), float("136"), float("136"), float("136")],
            paddle.framework._current_expected_place(),
        )
        del full_35
        ...
        # pd_op.bmm: (1x400x18496xf32) <- (1x400x128xf32, 1x128x18496xf32)
        bmm_1 = paddle._C_ops.bmm(add_36, flatten_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_414 = [1, 400, 136, 136]

        # pd_op.reshape: (1x400x136x136xf32) <- (1x400x18496xf32, 4xi64)
        ...
        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_419 = [1, 6069, 8, 32]
        ...
        # builtin.combine: ([1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32]) <- (1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32)
        combine_52 = [
            reshape_21,
            reshape_35,
            reshape_49,
        ...
        # pd_op.stack: (6x1x400x136x136xf32) <- ([1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32, 1x400x136x136xf32])
