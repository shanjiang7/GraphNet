...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.transpose: (2x10x-1xf32) <- (2x-1x10xf32)
        ...
        # pd_op.gather_nd: (2x-1x-1xf32) <- (2x10x-1xf32, 2x-1x2xi32)
        ...
        # pd_op.add: (2x-1x1x1xf32) <- (2x-1x1x1xf32, 2x-1x1x1xf32)
        ...
        # pd_op.scale: (2x-1x1x1xf32) <- (2x-1x1x1xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(add_1, full_11, float("0"), True)
        del add_1
        ...
        # pd_op.scale: (2x-1x1x1xf32) <- (2x-1x1x1xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(add_2, full_11, float("0"), True)
        del add_2, full_11

        # pd_op.subtract: (2x-1x-1x1xf32) <- (2x-1x1x1xf32, 1x1x-1x1xf32)
        subtract_8 = paddle._C_ops.subtract(scale_2, unsqueeze_4)

        # pd_op.subtract: (2x-1x-1x1xf32) <- (1x1x-1x1xf32, 2x-1x-1x1xf32)
        ...
        # pd_op.add: (2x-1x-1x1xf32) <- (2x-1x1x1xf32, 1x1x-1x1xf32)
        add_3 = paddle._C_ops.add(scale_2, unsqueeze_4)
        del scale_2

        # pd_op.subtract: (2x-1x-1x1xf32) <- (2x-1x-1x1xf32, 1x1x-1x1xf32)
        ...
        # pd_op.greater_than: (2x-1x-1xb) <- (2x-1x-1xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_1, full_10)
        del full_10, min_1
        ...
        # pd_op.sum: (2x-1x1xf32) <- (2x-1x-1xf32, 1xi64)
        ...
        # pd_op.equal: (2x-1x1xb) <- (2x-1x1xf32, xf32)
        equal_2 = paddle._C_ops.equal(sum_0, full_12)
        del sum_0

        # pd_op.add: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x-1xf32)
        add_5 = paddle._C_ops.add(multiply_1, multiply_3)

        # pd_op.full_like: (2x-1x-1xf32) <- (2x-1x-1xf32, 1xf32)
        ...
        # pd_op.add: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x1xf32)
        ...
        # pd_op.add: (2x-1x-1xf32) <- (2x-1x1xf32, 2x-1x-1xf32)
        add_10 = paddle._C_ops.add(cast_5, add_7)
        del add_7, cast_5

        # pd_op.cast: (2x-1x-1xb) <- (2x-1x-1xf32)
        ...
        topk_0, topk_1 = (lambda x, f: f(x))(
            paddle._C_ops.topk(where_0, full_13, -1, True, True),
        ...
        # pd_op.greater_than: (2x-1x-1xb) <- (2x-1x-1xf32, xf32)
        greater_than_3 = paddle._C_ops.greater_than(multiply_3, full_12)
        del multiply_3

        # pd_op.greater_than: (2x-1x-1xb) <- (2x-1x-1xf32, xf32)
        greater_than_4 = paddle._C_ops.greater_than(multiply_2, full_12)
        del full_12, multiply_2

        # pd_op.bitwise_or: (2x-1x-1xb) <- (2x-1x-1xb, 2x-1x-1xb)
        ...
        greater_than_0 = paddle._C_ops.greater_than(max_0, full_14)
        del divide_0, full_14, max_0, multiply_1, multiply_5, sum_2, unsqueeze_2
