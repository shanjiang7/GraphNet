...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.share_data_: (16x96x2xf32) <- (16x96x2xf32)
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(assign_10, full_int_array_3)

        # pd_op.unsqueeze: (16x96x1x4xf32) <- (16x96x4xf32, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(squeeze_0, full_int_array_3)
        del squeeze_0

        # pd_op.conv2d: (16x1x1x2xf32) <- (16x96x1x4xf32, 1x96x1x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            unsqueeze_2, unsqueeze_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.squeeze: (16x1x2xf32) <- (16x1x1x2xf32, 1xi64)
        ...
        # builtin.combine: ([16x1x2xf32, 16x1x2xf32]) <- (16x1x2xf32, 16x1x2xf32)
        combine_0 = [squeeze_1, share_data__2]

        # pd_op.concat: (16x2x2xf32) <- ([16x1x2xf32, 16x1x2xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_1)
        del combine_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_4 = [16, -1]

        # pd_op.reshape: (16x4xf32) <- (16x2x2xf32, 2xi64)
        reshape_0 = paddle._C_ops.reshape(concat_0, full_int_array_4)

        # pd_op.matmul: (16x32xf32) <- (16x4xf32, 4x32xf32)
        matmul_0 = paddle._C_ops.matmul(reshape_0, parameter_47, False, False)
        del parameter_47

        # pd_op.add: (16x32xf32) <- (16x32xf32, 32xf32)
        add_1 = paddle._C_ops.add(matmul_0, parameter_46)
        del parameter_46

        # pd_op.relu: (16x32xf32) <- (16x32xf32)
        relu_0 = paddle._C_ops.relu(add_1)
        del add_1

        # pd_op.matmul: (16x32xf32) <- (16x32xf32, 32x32xf32)
        ...
        # pd_op.matmul: (16x1xf32) <- (16x32xf32, 32x1xf32)
        ...
        # pd_op.unsqueeze: (16x96x2x1x1xf32) <- (16x96x2xf32, 2xi64)
        unsqueeze_3 = paddle._C_ops.unsqueeze(share_data__0, full_int_array_1)
        del share_data__0

        # pd_op.pad3d: (16x96x4x1x1xf32) <- (16x96x2x1x1xf32, 6xi64)
        pad3d_1 = paddle._C_ops.pad3d(
            unsqueeze_3, full_int_array_2, "circular", float("0"), "NCDHW"
        )
        del unsqueeze_3

        # pd_op.squeeze: (16x96x4xf32) <- (16x96x4x1x1xf32, 2xi64)
        squeeze_2 = paddle._C_ops.squeeze(pad3d_1, full_int_array_1)
        del pad3d_1

        # pd_op.assign: (1x96x3xf32) <- (1x96x3xf32)
        assign_29 = parameter_42
        del parameter_42

        # pd_op.unsqueeze: (1x96x1x3xf32) <- (1x96x3xf32, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(assign_29, full_int_array_3)

        # pd_op.unsqueeze: (16x96x1x4xf32) <- (16x96x4xf32, 1xi64)
        unsqueeze_5 = paddle._C_ops.unsqueeze(squeeze_2, full_int_array_3)
        del squeeze_2
        ...
        # pd_op.squeeze: (16x1x2xf32) <- (16x1x1x2xf32, 1xi64)
        squeeze_3 = paddle._C_ops.squeeze(conv2d_1, full_int_array_3)

        # builtin.combine: ([16x1x2xf32, 16x1x2xf32]) <- (16x1x2xf32, 16x1x2xf32)
        combine_1 = [squeeze_3, share_data__1]
        ...
        # pd_op.reshape: (16x4xf32) <- (16x2x2xf32, 2xi64)
        reshape_1 = paddle._C_ops.reshape(concat_1, full_int_array_4)
        ...
        # pd_op.matmul: (16x96xf32) <- (16x32xf32, 32x96xf32)
        ...
        unsqueeze_6 = paddle._C_ops.unsqueeze(transpose_0, full_int_array_1)
        del transpose_0

        # pd_op.pad3d: (16x2x98x1x1xf32) <- (16x2x96x1x1xf32, 6xi64)
        pad3d_2 = paddle._C_ops.pad3d(
            unsqueeze_6, full_int_array_2, "circular", float("0"), "NCDHW"
        )
        del full_int_array_2, unsqueeze_6

        # pd_op.squeeze: (16x2x98xf32) <- (16x2x98x1x1xf32, 2xi64)
        squeeze_4 = paddle._C_ops.squeeze(pad3d_2, full_int_array_1)
        del full_int_array_1, pad3d_2

        # pd_op.assign: (64x2x3xf32) <- (64x2x3xf32)
        assign_30 = parameter_36
        del parameter_36

        # pd_op.unsqueeze: (64x2x1x3xf32) <- (64x2x3xf32, 1xi64)
        unsqueeze_7 = paddle._C_ops.unsqueeze(assign_30, full_int_array_3)

        # pd_op.unsqueeze: (16x2x1x98xf32) <- (16x2x98xf32, 1xi64)
        unsqueeze_8 = paddle._C_ops.unsqueeze(squeeze_4, full_int_array_3)
        del squeeze_4

        # pd_op.conv2d: (16x64x1x96xf32) <- (16x2x1x98xf32, 64x2x1x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            unsqueeze_8, unsqueeze_7, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.squeeze: (16x64x96xf32) <- (16x64x1x96xf32, 1xi64)
        squeeze_5 = paddle._C_ops.squeeze(conv2d_2, full_int_array_3)

        # pd_op.transpose: (16x96x64xf32) <- (16x64x96xf32)
        ...
        slice_0 = paddle._C_ops.slice(
            data_1, [1], full_int_array_5, full_int_array_6, [1], []
        )
        del data_1, full_int_array_5, full_int_array_6

        # pd_op.add: (16x96x64xf32) <- (16x96x64xf32, 1x96x64xf32)
        add_5 = paddle._C_ops.add(transpose_1, slice_0)
        ...
        # pd_op.dropout: (16x96x64xf32, 16x96x64xui8) <- (16x96x64xf32, None, 1xf32)
        dropout_0, dropout_1 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_5, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_5

        # pd_op.matmul: (16x96x64xf32) <- (16x96x64xf32, 64x64xf32)
        matmul_6 = paddle._C_ops.matmul(dropout_0, parameter_35, False, False)
        del parameter_35

        # pd_op.add: (16x96x64xf32) <- (16x96x64xf32, 64xf32)
        add_6 = paddle._C_ops.add(matmul_6, parameter_34)
        del parameter_34

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_7 = [16, 96, 8, -1]

        # pd_op.reshape: (16x96x8x8xf32) <- (16x96x64xf32, 4xi64)
        ...
        # builtin.combine: ([16x96x8x8xf32, 16x96x8x8xf32]) <- (16x96x8x8xf32, 16x96x8x8xf32)
        combine_2 = [reshape_2, reshape_3]
        del reshape_2, reshape_3

        # pd_op.einsum: (16x8x96x96xf32, [0xf32, 0xf32], [16x96x8x8xf32, 16x96x8x8xf32]) <- ([16x96x8x8xf32, 16x96x8x8xf32])
        einsum_0, einsum_1, einsum_2 = (lambda x, f: f(x))(
            paddle._C_ops.einsum(combine_2, "blhe,bshe->bhls"),
        ...
        # builtin.split: (16x96x8x8xf32, 16x96x8x8xf32) <- ([16x96x8x8xf32, 16x96x8x8xf32])
        (
            split_2,
            split_3,
        ) = einsum_2
        ...
        scale_1 = paddle._C_ops.scale(add_9, full_3, float("0"), True)
        del add_9
        ...
        # builtin.combine: ([16x8x96x96xf32, 16x96x8x8xf32]) <- (16x8x96x96xf32, 16x96x8x8xf32)
        combine_3 = [dropout_2, reshape_4]
        del dropout_2, reshape_4

        # pd_op.einsum: (16x96x8x8xf32, [0xf32, 0xf32], [16x8x96x96xf32, 16x96x8x8xf32]) <- ([16x8x96x96xf32, 16x96x8x8xf32])
        einsum_3, einsum_4, einsum_5 = (lambda x, f: f(x))(
            paddle._C_ops.einsum(combine_3, "bhls,bshd->blhd"),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del combine_3
        ...
        # builtin.split: (16x8x96x96xf32, 16x96x8x8xf32) <- ([16x8x96x96xf32, 16x96x8x8xf32])
        (
            split_6,
            split_7,
        ) = einsum_5
        ...
        full_int_array_8 = [16, 96, -1]

        # pd_op.reshape: (16x96x64xf32) <- (16x96x8x8xf32, 3xi64)
        reshape_5 = paddle._C_ops.reshape(einsum_3, full_int_array_8)
        ...
        # pd_op.add: (16x96x64xf32) <- (16x96x64xf32, 16x96x64xf32)
        add_11 = paddle._C_ops.add(dropout_0, dropout_4)

        # pd_op.layer_norm: (16x96x64xf32, 16x96xf32, 16x96xf32) <- (16x96x64xf32, 64xf32, 64xf32)
        ...
        # pd_op.transpose: (16x64x96xf32) <- (16x96x64xf32)
        transpose_2 = paddle._C_ops.transpose(layer_norm_0, [0, 2, 1])

        # pd_op.assign: (64x64x1xf32) <- (64x64x1xf32)
        assign_40 = parameter_25
        del parameter_25

        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_13 = paddle._C_ops.unsqueeze(assign_40, full_int_array_3)

        # pd_op.unsqueeze: (16x64x1x96xf32) <- (16x64x96xf32, 1xi64)
        unsqueeze_14 = paddle._C_ops.unsqueeze(transpose_2, full_int_array_3)

        # pd_op.conv2d: (16x64x1x96xf32) <- (16x64x1x96xf32, 64x64x1x1xf32)
        ...
        reshape_6 = paddle._C_ops.reshape(parameter_24, full_int_array_9)
        del parameter_24
        ...
        # pd_op.squeeze: (16x64x96xf32) <- (16x64x1x96xf32, 1xi64)
        squeeze_6 = paddle._C_ops.squeeze(add_12, full_int_array_3)

        # pd_op.gelu: (16x64x96xf32) <- (16x64x96xf32)
        gelu_0 = paddle._C_ops.gelu(squeeze_6, False)

        # pd_op.dropout: (16x64x96xf32, 16x64x96xui8) <- (16x64x96xf32, None, 1xf32)
        dropout_6, dropout_7 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_0, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_0
        ...
        # pd_op.assign: (64x64x1xf32) <- (64x64x1xf32)
        assign_41 = parameter_23
        del parameter_23

        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_15 = paddle._C_ops.unsqueeze(assign_41, full_int_array_3)

        # pd_op.unsqueeze: (16x64x1x96xf32) <- (16x64x96xf32, 1xi64)
        unsqueeze_16 = paddle._C_ops.unsqueeze(dropout_6, full_int_array_3)
        ...
        # pd_op.reshape: (1x64x1x1xf32) <- (64xf32, 4xi64)
        reshape_7 = paddle._C_ops.reshape(parameter_22, full_int_array_9)
        del parameter_22
        ...
        # pd_op.squeeze: (16x64x96xf32) <- (16x64x1x96xf32, 1xi64)
        squeeze_7 = paddle._C_ops.squeeze(add_13, full_int_array_3)
        ...
        dropout_8, dropout_9 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_3, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del transpose_3
        ...
        # pd_op.reshape: (16x96x8x8xf32) <- (16x96x64xf32, 4xi64)
        reshape_9 = paddle._C_ops.reshape(add_16, full_int_array_7)
        ...
        # pd_op.reshape: (16x96x8x8xf32) <- (16x96x64xf32, 4xi64)
        reshape_10 = paddle._C_ops.reshape(add_17, full_int_array_7)
        ...
        # pd_op.scale: (16x8x96x96xf32) <- (16x8x96x96xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(add_18, full_3, float("0"), True)
        del add_18
        ...
        # builtin.combine: ([16x8x96x96xf32, 16x96x8x8xf32]) <- (16x8x96x96xf32, 16x96x8x8xf32)
        combine_5 = [dropout_10, reshape_10]
        ...
        # pd_op.reshape: (16x96x64xf32) <- (16x96x8x8xf32, 3xi64)
        reshape_11 = paddle._C_ops.reshape(einsum_9, full_int_array_8)
        ...
        # pd_op.assign: (64x64x1xf32) <- (64x64x1xf32)
        assign_42 = parameter_9
        del parameter_9

        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_21 = paddle._C_ops.unsqueeze(assign_42, full_int_array_3)

        # pd_op.unsqueeze: (16x64x1x96xf32) <- (16x64x96xf32, 1xi64)
        unsqueeze_22 = paddle._C_ops.unsqueeze(transpose_4, full_int_array_3)
        ...
        # pd_op.reshape: (1x64x1x1xf32) <- (64xf32, 4xi64)
        reshape_12 = paddle._C_ops.reshape(parameter_8, full_int_array_9)
        del parameter_8
        ...
        # pd_op.squeeze: (16x64x96xf32) <- (16x64x1x96xf32, 1xi64)
        squeeze_8 = paddle._C_ops.squeeze(add_21, full_int_array_3)
        ...
        dropout_14, dropout_15 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_1, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_1
        ...
        # pd_op.assign: (64x64x1xf32) <- (64x64x1xf32)
        assign_43 = parameter_7
        del parameter_7

        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_23 = paddle._C_ops.unsqueeze(assign_43, full_int_array_3)

        # pd_op.unsqueeze: (16x64x1x96xf32) <- (16x64x96xf32, 1xi64)
        unsqueeze_24 = paddle._C_ops.unsqueeze(dropout_14, full_int_array_3)
        ...
        # pd_op.reshape: (1x64x1x1xf32) <- (64xf32, 4xi64)
        reshape_13 = paddle._C_ops.reshape(parameter_6, full_int_array_9)
        del full_int_array_9, parameter_6

        # pd_op.add: (16x64x1x96xf32) <- (16x64x1x96xf32, 1x64x1x1xf32)
        add_22 = paddle._C_ops.add(conv2d_6, reshape_13)

        # pd_op.squeeze: (16x64x96xf32) <- (16x64x1x96xf32, 1xi64)
        squeeze_9 = paddle._C_ops.squeeze(add_22, full_int_array_3)
        ...
        dropout_16, dropout_17 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_5, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del transpose_5
        ...
        # pd_op.matmul: (16x96x2xf32) <- (16x96x64xf32, 64x2xf32)
        matmul_14 = paddle._C_ops.matmul(layer_norm_12, parameter_1, False, False)
        del parameter_1

        # pd_op.add: (16x96x2xf32) <- (16x96x2xf32, 2xf32)
