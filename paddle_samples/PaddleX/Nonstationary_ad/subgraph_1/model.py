...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(assign_10, full_int_array_4)
        ...
        # pd_op.unsqueeze: (1x96x1x3xf32) <- (1x96x3xf32, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(assign_29, full_int_array_4)
        ...
        unsqueeze_7 = paddle._C_ops.unsqueeze(assign_30, full_int_array_4)
        ...
        dropout_0, dropout_1 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_5, None, full_3, False, "upscale_in_train", 0, False
            ),
        ...
        dropout_4, dropout_5 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_10, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_10
        ...
        unsqueeze_13 = paddle._C_ops.unsqueeze(assign_40, full_int_array_4)
        ...
        dropout_6, dropout_7 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_0, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_0
        ...
        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_15 = paddle._C_ops.unsqueeze(assign_41, full_int_array_4)
        ...
        dropout_8, dropout_9 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_3, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del transpose_3
        ...
        dropout_10, dropout_11 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                softmax_1, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        ...
        dropout_12, dropout_13 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_19, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_19
        ...
        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_21 = paddle._C_ops.unsqueeze(assign_42, full_int_array_4)
        ...
        dropout_14, dropout_15 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_1, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_1
        ...
        # pd_op.unsqueeze: (64x64x1x1xf32) <- (64x64x1xf32, 1xi64)
        unsqueeze_23 = paddle._C_ops.unsqueeze(assign_43, full_int_array_4)
        ...
        dropout_16, dropout_17 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_5, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del transpose_5
