...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x32x304x304xf32) <- (2x3x608x608xf32, 32x3x3x3xf32)
        ...
        # pd_op.hardswish: (2x32x304x304xf32) <- (2x32x304x304xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (2x32x304x304xf32) <- (2x32x304x304xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x64x304x304xf32) <- (2x32x304x304xf32, 64x32x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_511, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_511

        # pd_op.batch_norm_: (2x64x304x304xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (2x64x304x304xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (2x64x304x304xf32) <- (2x64x304x304xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (2x64x152x152xf32) <- (2x64x304x304xf32, 64x1x3x3xf32)
        ...
        # pd_op.hardswish: (2x64x152x152xf32) <- (2x64x152x152xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (2x128x152x152xf32) <- (2x64x152x152xf32, 128x64x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_501, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_501

        # pd_op.batch_norm_: (2x128x152x152xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (2x128x152x152xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (2x128x152x152xf32) <- (2x128x152x152xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (2x128x152x152xf32) <- (2x128x152x152xf32, 128x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x128x152x152xf32) <- (2x128x152x152xf32, 128x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x128x76x76xf32) <- (2x128x152x152xf32, 128x1x3x3xf32)
        ...
        # pd_op.hardswish: (2x128x76x76xf32) <- (2x128x76x76xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (2x256x76x76xf32) <- (2x128x76x76xf32, 256x128x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            hardswish_7, parameter_481, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_481

        # pd_op.batch_norm_: (2x256x76x76xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (2x256x76x76xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.hardswish: (2x256x76x76xf32) <- (2x256x76x76xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)

        # pd_op.depthwise_conv2d: (2x256x76x76xf32) <- (2x256x76x76xf32, 256x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x256x76x76xf32) <- (2x256x76x76xf32, 256x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x256x38x38xf32) <- (2x256x76x76xf32, 256x1x3x3xf32)
        ...
        # pd_op.hardswish: (2x256x38x38xf32) <- (2x256x38x38xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (2x512x38x38xf32) <- (2x256x38x38xf32, 512x256x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_461, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_461

        # pd_op.batch_norm_: (2x512x38x38xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (2x512x38x38xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (2x512x38x38xf32) <- (2x512x38x38xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (2x512x38x38xf32) <- (2x512x38x38xf32, 512x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x512x38x38xf32) <- (2x512x38x38xf32, 512x512x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x512x19x19xf32) <- (2x512x38x38xf32, 512x1x5x5xf32)
        ...
        # pd_op.hardswish: (2x512x19x19xf32) <- (2x512x19x19xf32)
        ...
        # pd_op.pool2d: (2x512x1x1xf32) <- (2x512x19x19xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x128x1x1xf32) <- (2x512x1x1xf32, 128x512x1x1xf32)
        ...
        # pd_op.conv2d: (2x512x1x1xf32) <- (2x128x1x1xf32, 512x128x1x1xf32)
        ...
        # pd_op.add: (2x512x1x1xf32) <- (2x512x1x1xf32, 1x512x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_13, reshape_1)

        # pd_op.hardsigmoid: (2x512x1x1xf32) <- (2x512x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            add_1, float("0.166667"), float("0.5")
        )
        del add_1

        # pd_op.multiply: (2x512x19x19xf32) <- (2x512x19x19xf32, 2x512x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (2x1024x19x19xf32) <- (2x512x19x19xf32, 1024x512x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_397, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_397

        # pd_op.batch_norm_: (2x1024x19x19xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32, -1xui8) <- (2x1024x19x19xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (2x1024x19x19xf32) <- (2x1024x19x19xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (2x1024x19x19xf32) <- (2x1024x19x19xf32, 1024x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x1024x1x1xf32) <- (2x1024x19x19xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x256x1x1xf32) <- (2x1024x1x1xf32, 256x1024x1x1xf32)
        ...
        # pd_op.multiply: (2x1024x19x19xf32) <- (2x1024x19x19xf32, 2x1024x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (2x1024x19x19xf32) <- (2x1024x19x19xf32, 1024x1024x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x76x76xf32) <- (2x256x76x76xf32, 160x256x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            hardswish_10, parameter_378, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_378

        # pd_op.batch_norm_: (2x160x76x76xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x76x76xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.hardswish: (2x160x76x76xf32) <- (2x160x76x76xf32)
        hardswish_27 = paddle._C_ops.hardswish(batch_norm__162)

        # pd_op.conv2d: (2x160x38x38xf32) <- (2x512x38x38xf32, 160x512x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            hardswish_22, parameter_373, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_373

        # pd_op.batch_norm_: (2x160x38x38xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x38x38xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.hardswish: (2x160x38x38xf32) <- (2x160x38x38xf32)
        hardswish_28 = paddle._C_ops.hardswish(batch_norm__168)

        # pd_op.conv2d: (2x160x19x19xf32) <- (2x1024x19x19xf32, 160x1024x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_26, parameter_368, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_368

        # pd_op.batch_norm_: (2x160x19x19xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x19x19xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (2x160x19x19xf32) <- (2x160x19x19xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.nearest_interp: (2x160x38x38xf32) <- (2x160x19x19xf32, None, None, None)
        ...
        # builtin.combine: ([2x160x38x38xf32, 2x160x38x38xf32]) <- (2x160x38x38xf32, 2x160x38x38xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (2x320x38x38xf32) <- ([2x160x38x38xf32, 2x160x38x38xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0

        # pd_op.depthwise_conv2d: (2x320x38x38xf32) <- (2x320x38x38xf32, 320x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_363, [1, 1], [2, 2], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        del parameter_363

        # pd_op.batch_norm_: (2x320x38x38xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (2x320x38x38xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        (
            batch_norm__180,
            batch_norm__181,
            batch_norm__182,
        ...
        # pd_op.hardswish: (2x320x38x38xf32) <- (2x320x38x38xf32)
        hardswish_30 = paddle._C_ops.hardswish(batch_norm__180)

        # pd_op.conv2d: (2x320x38x38xf32) <- (2x320x38x38xf32, 320x320x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x38x38xf32) <- (2x320x38x38xf32, 160x320x1x1xf32)
        ...
        # pd_op.nearest_interp: (2x160x76x76xf32) <- (2x160x38x38xf32, None, None, None)
        ...
        # builtin.combine: ([2x160x76x76xf32, 2x160x76x76xf32]) <- (2x160x76x76xf32, 2x160x76x76xf32)
        combine_1 = [nearest_interp_1, hardswish_27]

        # pd_op.concat: (2x320x76x76xf32) <- ([2x160x76x76xf32, 2x160x76x76xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (2x320x76x76xf32) <- (2x320x76x76xf32, 320x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            concat_4, parameter_343, [1, 1], [2, 2], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        del parameter_343

        # pd_op.batch_norm_: (2x320x76x76xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (2x320x76x76xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (2x320x76x76xf32) <- (2x320x76x76xf32)
        hardswish_34 = paddle._C_ops.hardswish(batch_norm__204)

        # pd_op.conv2d: (2x320x76x76xf32) <- (2x320x76x76xf32, 320x320x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x76x76xf32) <- (2x320x76x76xf32, 160x320x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x38x38xf32) <- (2x160x76x76xf32, 160x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x160x38x38xf32) <- (2x160x38x38xf32, 160x160x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x19x19xf32) <- (2x160x38x38xf32, 160x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x160x19x19xf32) <- (2x160x19x19xf32, 160x160x1x1xf32)
        ...
        # builtin.combine: ([2x160x19x19xf32, 2x160x19x19xf32]) <- (2x160x19x19xf32, 2x160x19x19xf32)
        combine_3 = [hardswish_45, hardswish_29]

        # pd_op.concat: (2x320x19x19xf32) <- ([2x160x19x19xf32, 2x160x19x19xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_3, full_0)
        del combine_3

        # pd_op.depthwise_conv2d: (2x320x19x19xf32) <- (2x320x19x19xf32, 320x1x5x5xf32)
        depthwise_conv2d_21 = paddle._C_ops.depthwise_conv2d(
            concat_6, parameter_283, [1, 1], [2, 2], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        del parameter_283

        # pd_op.batch_norm_: (2x320x19x19xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (2x320x19x19xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.hardswish: (2x320x19x19xf32) <- (2x320x19x19xf32)
        hardswish_46 = paddle._C_ops.hardswish(batch_norm__276)

        # pd_op.conv2d: (2x320x19x19xf32) <- (2x320x19x19xf32, 320x320x1x1xf32)
        ...
        # pd_op.conv2d: (2x160x19x19xf32) <- (2x320x19x19xf32, 160x320x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x10x10xf32) <- (2x160x19x19xf32, 160x1x5x5xf32)
        depthwise_conv2d_23 = paddle._C_ops.depthwise_conv2d(
            hardswish_29, parameter_263, [2, 2], [2, 2], "EXPLICIT", 160, [1, 1], "NCHW"
        )
        del parameter_263

        # pd_op.batch_norm_: (2x160x10x10xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (2x160x10x10xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        (
            batch_norm__300,
            batch_norm__301,
            batch_norm__302,
        ...
        # pd_op.hardswish: (2x160x10x10xf32) <- (2x160x10x10xf32)
        hardswish_50 = paddle._C_ops.hardswish(batch_norm__300)

        # pd_op.conv2d: (2x160x10x10xf32) <- (2x160x10x10xf32, 160x160x1x1xf32)
        ...
        # pd_op.add: (2x160x10x10xf32) <- (2x160x10x10xf32, 2x160x10x10xf32)
        add_4 = paddle._C_ops.add(hardswish_51, hardswish_53)

        # pd_op.shape64: (4xi64) <- (2x160x76x76xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x76x76xf32) <- (2x160x76x76xf32, 160x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x160x76x76xf32) <- (2x160x76x76xf32, 160x160x1x1xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x76x76xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x76x76xf32) <- (2x160x76x76xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x76x76xf32) <- (2x160x76x76xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x76x76xf32) <- (2x11x76x76xf32, 1x11x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_39, reshape_5)

        # pd_op.conv2d: (2x32x76x76xf32) <- (2x160x76x76xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x76x76xf32) <- (2x32x76x76xf32, 1x32x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_40, reshape_6)

        # pd_op.conv2d: (2x1x76x76xf32) <- (2x160x76x76xf32, 1x160x5x5xf32)
        conv2d_41 = paddle._C_ops.conv2d(
            hardswish_61, parameter_192, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_192

        # pd_op.batch_norm_: (2x1x76x76xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x76x76xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__378,
            batch_norm__379,
            batch_norm__380,
        ...
        # pd_op.hardswish: (2x1x76x76xf32) <- (2x1x76x76xf32)
        hardswish_63 = paddle._C_ops.hardswish(batch_norm__378)

        # pd_op.conv2d: (2x1x76x76xf32) <- (2x1x76x76xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x76x76xf32) <- (2x1x76x76xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__384)
        del batch_norm__384

        # pd_op.sigmoid: (2x11x76x76xf32) <- (2x11x76x76xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_6)
        del add_6

        # pd_op.multiply: (2x11x76x76xf32) <- (2x11x76x76xf32, 2x1x76x76xf32)
        ...
        # pd_op.scale: (2x11x76x76xf32) <- (2x11x76x76xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(multiply_3, full_1, float("1e-09"), True)
        del multiply_3

        # pd_op.sqrt: (2x11x76x76xf32) <- (2x11x76x76xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_0)
        del scale_0

        # pd_op.transpose: (2x76x76x11xf32) <- (2x11x76x76xf32)
        transpose_0 = paddle._C_ops.transpose(sqrt_0, [0, 2, 3, 1])

        # pd_op.transpose: (2x76x76x32xf32) <- (2x32x76x76xf32)
        ...
        # pd_op.flatten: (5776xf32) <- (76x76xf32)
        ...
        # builtin.combine: ([5776xf32, 5776xf32]) <- (5776xf32, 5776xf32)
        combine_5 = [flatten_1, flatten_0]
        del flatten_0, flatten_1

        # pd_op.stack: (5776x2xf32) <- ([5776xf32, 5776xf32])
        ...
        # pd_op.reshape: (2x5776x11xf32) <- (2x76x76x11xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([2x5776x2xf32, 2x5776x2xf32]) <- (2x5776x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_10, 2, full_6)
        del reshape_10

        # builtin.split: (2x5776x2xf32, 2x5776x2xf32) <- ([2x5776x2xf32, 2x5776x2xf32])
        (
            split_2,
            split_3,
        ) = split_with_num_0
        ...
        # pd_op.scale: (2x5776x2xf32) <- (2x5776x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_2, full_7, float("0"), True)
        del split_2

        # pd_op.add: (2x5776x2xf32) <- (2x5776x2xf32, 5776x2xf32)
        ...
        # builtin.combine: ([2x5776x2xf32, 2x5776x2xf32]) <- (2x5776x2xf32, 2x5776x2xf32)
        combine_6 = [add_8, add_9]

        # pd_op.concat: (2x5776x4xf32) <- ([2x5776x2xf32, 2x5776x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_8)
        del combine_6

        # pd_op.flatten: (2x11x5776xf32) <- (2x11x76x76xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (2x5776x11xf32) <- (2x11x5776xf32)
        transpose_2 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])
        del flatten_2

        # pd_op.flatten: (2x32x5776xf32) <- (2x32x76x76xf32)
        flatten_3 = paddle._C_ops.flatten(add_7, 2, 3)

        # pd_op.transpose: (2x5776x32xf32) <- (2x32x5776xf32)
        ...
        # pd_op.scale: (2x5776x4xf32) <- (2x5776x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_7, full_9, float("0"), True)
        del concat_7

        # pd_op.shape64: (4xi64) <- (2x160x38x38xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x38x38xf32) <- (2x160x38x38xf32, 160x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x38x38xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x38x38xf32) <- (2x160x38x38xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x38x38xf32) <- (2x160x38x38xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x38x38xf32) <- (2x11x38x38xf32, 1x11x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_49, reshape_12)

        # pd_op.conv2d: (2x32x38x38xf32) <- (2x160x38x38xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x38x38xf32) <- (2x32x38x38xf32, 1x32x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_50, reshape_13)

        # pd_op.conv2d: (2x1x38x38xf32) <- (2x160x38x38xf32, 1x160x5x5xf32)
        conv2d_51 = paddle._C_ops.conv2d(
            hardswish_71, parameter_131, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_131

        # pd_op.batch_norm_: (2x1x38x38xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x38x38xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__444,
            batch_norm__445,
            batch_norm__446,
        ...
        # pd_op.hardswish: (2x1x38x38xf32) <- (2x1x38x38xf32)
        hardswish_73 = paddle._C_ops.hardswish(batch_norm__444)

        # pd_op.conv2d: (2x1x38x38xf32) <- (2x1x38x38xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x38x38xf32) <- (2x1x38x38xf32)
        sigmoid_4 = paddle._C_ops.sigmoid(batch_norm__450)
        del batch_norm__450

        # pd_op.sigmoid: (2x11x38x38xf32) <- (2x11x38x38xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_11)
        del add_11

        # pd_op.multiply: (2x11x38x38xf32) <- (2x11x38x38xf32, 2x1x38x38xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (2x11x38x38xf32) <- (2x11x38x38xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)
        del multiply_5

        # pd_op.sqrt: (2x11x38x38xf32) <- (2x11x38x38xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_6)
        del scale_6

        # pd_op.transpose: (2x38x38x11xf32) <- (2x11x38x38xf32)
        transpose_4 = paddle._C_ops.transpose(sqrt_1, [0, 2, 3, 1])

        # pd_op.transpose: (2x38x38x32xf32) <- (2x32x38x38xf32)
        ...
        # pd_op.flatten: (1444xf32) <- (38x38xf32)
        ...
        # pd_op.scale: (2x1444x2xf32) <- (2x1444x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_6, full_7, float("0"), True)
        del split_6

        # pd_op.add: (2x1444x2xf32) <- (2x1444x2xf32, 1444x2xf32)
        add_13 = paddle._C_ops.add(scale_10, stack_1)

        # pd_op.add: (2x1444x2xf32) <- (2x1444x2xf32, 1444x2xf32)
        add_14 = paddle._C_ops.add(split_7, stack_1)

        # builtin.combine: ([2x1444x2xf32, 2x1444x2xf32]) <- (2x1444x2xf32, 2x1444x2xf32)
        combine_9 = [add_13, add_14]

        # pd_op.concat: (2x1444x4xf32) <- ([2x1444x2xf32, 2x1444x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_8)
        del combine_9

        # pd_op.flatten: (2x11x1444xf32) <- (2x11x38x38xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (2x1444x11xf32) <- (2x11x1444xf32)
        transpose_6 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])
        del flatten_6

        # pd_op.flatten: (2x32x1444xf32) <- (2x32x38x38xf32)
        flatten_7 = paddle._C_ops.flatten(add_12, 2, 3)

        # pd_op.transpose: (2x1444x32xf32) <- (2x32x1444xf32)
        ...
        # pd_op.scale: (2x1444x4xf32) <- (2x1444x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_8, full_12, float("0"), True)
        del concat_8

        # pd_op.shape64: (4xi64) <- (2x160x19x19xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x19x19xf32) <- (2x160x19x19xf32, 160x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x19x19xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x19x19xf32) <- (2x160x19x19xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x19x19xf32) <- (2x160x19x19xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x19x19xf32) <- (2x11x19x19xf32, 1x11x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_59, reshape_19)

        # pd_op.conv2d: (2x32x19x19xf32) <- (2x160x19x19xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x19x19xf32) <- (2x32x19x19xf32, 1x32x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_60, reshape_20)

        # pd_op.conv2d: (2x1x19x19xf32) <- (2x160x19x19xf32, 1x160x5x5xf32)
        conv2d_61 = paddle._C_ops.conv2d(
            hardswish_81, parameter_70, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_70

        # pd_op.batch_norm_: (2x1x19x19xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x19x19xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__510,
            batch_norm__511,
            batch_norm__512,
        ...
        # pd_op.hardswish: (2x1x19x19xf32) <- (2x1x19x19xf32)
        hardswish_83 = paddle._C_ops.hardswish(batch_norm__510)

        # pd_op.conv2d: (2x1x19x19xf32) <- (2x1x19x19xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x19x19xf32) <- (2x1x19x19xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__516)
        del batch_norm__516

        # pd_op.sigmoid: (2x11x19x19xf32) <- (2x11x19x19xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_16)
        del add_16

        # pd_op.multiply: (2x11x19x19xf32) <- (2x11x19x19xf32, 2x1x19x19xf32)
        multiply_7 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (2x11x19x19xf32) <- (2x11x19x19xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_7, full_1, float("1e-09"), True)
        del multiply_7

        # pd_op.sqrt: (2x11x19x19xf32) <- (2x11x19x19xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_12)
        del scale_12

        # pd_op.transpose: (2x19x19x11xf32) <- (2x11x19x19xf32)
        transpose_8 = paddle._C_ops.transpose(sqrt_2, [0, 2, 3, 1])

        # pd_op.transpose: (2x19x19x32xf32) <- (2x32x19x19xf32)
        ...
        # pd_op.scale: (2x361x2xf32) <- (2x361x2xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(split_10, full_7, float("0"), True)
        del split_10

        # pd_op.add: (2x361x2xf32) <- (2x361x2xf32, 361x2xf32)
        add_18 = paddle._C_ops.add(scale_16, stack_2)

        # pd_op.add: (2x361x2xf32) <- (2x361x2xf32, 361x2xf32)
        add_19 = paddle._C_ops.add(split_11, stack_2)

        # builtin.combine: ([2x361x2xf32, 2x361x2xf32]) <- (2x361x2xf32, 2x361x2xf32)
        combine_12 = [add_18, add_19]

        # pd_op.concat: (2x361x4xf32) <- ([2x361x2xf32, 2x361x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_8)
        del combine_12

        # pd_op.flatten: (2x11x361xf32) <- (2x11x19x19xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (2x361x11xf32) <- (2x11x361xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])
        del flatten_10

        # pd_op.flatten: (2x32x361xf32) <- (2x32x19x19xf32)
        flatten_11 = paddle._C_ops.flatten(add_17, 2, 3)

        # pd_op.transpose: (2x361x32xf32) <- (2x32x361xf32)
        ...
        # pd_op.scale: (2x361x4xf32) <- (2x361x4xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(concat_9, full_15, float("0"), True)
        del concat_9

        # pd_op.shape64: (4xi64) <- (2x160x10x10xf32)
        ...
        # pd_op.depthwise_conv2d: (2x160x10x10xf32) <- (2x160x10x10xf32, 160x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x160x1x1xf32) <- (2x160x10x10xf32, 2xi64)
        ...
        # pd_op.multiply: (2x160x10x10xf32) <- (2x160x10x10xf32, 2x160x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x10x10xf32) <- (2x160x10x10xf32, 11x160x1x1xf32)
        ...
        # pd_op.add: (2x11x10x10xf32) <- (2x11x10x10xf32, 1x11x1x1xf32)
        add_21 = paddle._C_ops.add(conv2d_69, reshape_26)

        # pd_op.conv2d: (2x32x10x10xf32) <- (2x160x10x10xf32, 32x160x1x1xf32)
        ...
        # pd_op.add: (2x32x10x10xf32) <- (2x32x10x10xf32, 1x32x1x1xf32)
        add_22 = paddle._C_ops.add(conv2d_70, reshape_27)

        # pd_op.conv2d: (2x1x10x10xf32) <- (2x160x10x10xf32, 1x160x5x5xf32)
        conv2d_71 = paddle._C_ops.conv2d(
            hardswish_91, parameter_9, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_9

        # pd_op.batch_norm_: (2x1x10x10xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x10x10xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__576,
            batch_norm__577,
            batch_norm__578,
        ...
        # pd_op.hardswish: (2x1x10x10xf32) <- (2x1x10x10xf32)
        hardswish_93 = paddle._C_ops.hardswish(batch_norm__576)

        # pd_op.conv2d: (2x1x10x10xf32) <- (2x1x10x10xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x10x10xf32) <- (2x1x10x10xf32)
        sigmoid_10 = paddle._C_ops.sigmoid(batch_norm__582)
        del batch_norm__582

        # pd_op.sigmoid: (2x11x10x10xf32) <- (2x11x10x10xf32)
        sigmoid_11 = paddle._C_ops.sigmoid(add_21)
        del add_21

        # pd_op.multiply: (2x11x10x10xf32) <- (2x11x10x10xf32, 2x1x10x10xf32)
        multiply_9 = paddle._C_ops.multiply(sigmoid_11, sigmoid_10)

        # pd_op.scale: (2x11x10x10xf32) <- (2x11x10x10xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(multiply_9, full_1, float("1e-09"), True)
        del multiply_9

        # pd_op.sqrt: (2x11x10x10xf32) <- (2x11x10x10xf32)
        sqrt_3 = paddle._C_ops.sqrt(scale_18)
        del scale_18

        # pd_op.transpose: (2x10x10x11xf32) <- (2x11x10x10xf32)
        transpose_12 = paddle._C_ops.transpose(sqrt_3, [0, 2, 3, 1])

        # pd_op.transpose: (2x10x10x32xf32) <- (2x32x10x10xf32)
        ...
        # pd_op.add: (2x100x2xf32) <- (2x100x2xf32, 100x2xf32)
        ...
        # pd_op.flatten: (2x11x100xf32) <- (2x11x10x10xf32)
        flatten_14 = paddle._C_ops.flatten(sqrt_3, 2, 3)

        # pd_op.transpose: (2x100x11xf32) <- (2x11x100xf32)
        transpose_14 = paddle._C_ops.transpose(flatten_14, [0, 2, 1])
        del flatten_14

        # pd_op.flatten: (2x32x100xf32) <- (2x32x10x10xf32)
        flatten_15 = paddle._C_ops.flatten(add_22, 2, 3)

        # pd_op.transpose: (2x100x32xf32) <- (2x32x100xf32)
        ...
        # builtin.combine: ([2x5776x11xf32, 2x1444x11xf32, 2x361x11xf32, 2x100x11xf32]) <- (2x5776x11xf32, 2x1444x11xf32, 2x361x11xf32, 2x100x11xf32)
        combine_16 = [transpose_2, transpose_6, transpose_10, transpose_14]

        # pd_op.concat: (2x7681x11xf32) <- ([2x5776x11xf32, 2x1444x11xf32, 2x361x11xf32, 2x100x11xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_16, full_0)
        del combine_16

        # builtin.combine: ([2x5776x4xf32, 2x1444x4xf32, 2x361x4xf32, 2x100x4xf32]) <- (2x5776x4xf32, 2x1444x4xf32, 2x361x4xf32, 2x100x4xf32)
        combine_17 = [scale_5, scale_11, scale_17, scale_23]

        # pd_op.concat: (2x7681x4xf32) <- ([2x5776x4xf32, 2x1444x4xf32, 2x361x4xf32, 2x100x4xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_17, full_0)
        del combine_17

        # builtin.combine: ([2x5776x32xf32, 2x1444x32xf32, 2x361x32xf32, 2x100x32xf32]) <- (2x5776x32xf32, 2x1444x32xf32, 2x361x32xf32, 2x100x32xf32)
        combine_18 = [transpose_3, transpose_7, transpose_11, transpose_15]

        # pd_op.concat: (2x7681x32xf32) <- ([2x5776x32xf32, 2x1444x32xf32, 2x361x32xf32, 2x100x32xf32], 1xi32)
