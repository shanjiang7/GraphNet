...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.transpose: (2x11x6885xf32) <- (2x6885x11xf32)
        ...
        # pd_op.gather_nd: (2x2x6885xf32) <- (2x11x6885xf32, 2x2x2xi32)
        gather_nd_0 = paddle._C_ops.gather_nd(transpose_0, stack_0)
        del stack_0, transpose_0

        # pd_op.pow: (2x2x6885xf32) <- (2x2x6885xf32)
        ...
        # pd_op.topk: (2x2x13xf32, 2x2x13xi64) <- (2x2x6885xf32, 1xi32)
        ...
        # pd_op.one_hot: (2x2x13x6885xf32) <- (2x2x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x2x6885xf32) <- (2x2x13x6885xf32, 1xi64)
