...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        full_int_array_4 = [-1, 11, 6400]

        # pd_op.reshape: (-1x11x6400xf32) <- (-1x11x80x80xf32, 3xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_7 = [-1, 11, 1600]

        # pd_op.reshape: (-1x11x1600xf32) <- (-1x11x40x40xf32, 3xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_9 = [-1, 11, 400]

        # pd_op.reshape: (-1x11x400xf32) <- (-1x11x20x20xf32, 3xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_11 = [-1, 11, 100]

        # pd_op.reshape: (-1x11x100xf32) <- (-1x11x10x10xf32, 3xi64)
        ...
        # builtin.combine: ([-1x11x6400xf32, -1x11x1600xf32, -1x11x400xf32, -1x11x100xf32]) <- (-1x11x6400xf32, -1x11x1600xf32, -1x11x400xf32, -1x11x100xf32)
        combine_4 = [reshape_7, reshape_13, reshape_19, reshape_25]
        del reshape_13, reshape_19, reshape_25, reshape_7

        # pd_op.concat: (-1x11x8500xf32) <- ([-1x11x6400xf32, -1x11x1600xf32, -1x11x400xf32, -1x11x100xf32], 1xi32)
