...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        where_0 = paddle._C_ops.where(greater_than_0, data_0, full_0)
        del full_0, greater_than_0
        ...
        reshape_0 = paddle._C_ops.reshape(data_0, full_int_array_3)
        del data_0, full_int_array_3
        ...
        gather_0 = paddle._C_ops.gather(concat_2, slice_4, full_3)
        del concat_2
        ...
        scale_0 = paddle._C_ops.scale(slice_4, full_6, float("0"), True)
        del full_6, slice_4

        # pd_op.add: (-1xi64) <- (-1xi64, -1xi64)
        add_0 = paddle._C_ops.add(scale_0, slice_3)
        del scale_0

        # pd_op.gather: (-1xf32) <- (7745xf32, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(concat_3, add_0, full_3)
        del add_0, concat_1, concat_3, full_3, slice_3

        return gather_0, gather_1, cast_0, cast_1
