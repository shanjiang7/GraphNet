...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.unsqueeze: (1x65x200x232xf32) <- (65x200x232xf32, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_0, full_int_array_0)
        del data_0

        # pd_op.bilinear_interp: (1x65x800x928xf32) <- (1x65x200x232xf32, None, None, None)
        ...
        # pd_op.cast: (xi64) <- (xi32)
        cast_3 = paddle._C_ops.cast(data_4, paddle.int64)
        del data_4
        ...
        # pd_op.slice: (1x65x-1x-1xf32) <- (1x65x800x928xf32, 2xi64, 2xi64)
        ...
        # pd_op.bilinear_interp: (1x65x-1x-1xf32) <- (1x65x-1x-1xf32, 2xi32, None, None)
        bilinear_interp_1 = paddle._C_ops.bilinear_interp(
            slice_0, cast_4, None, None, "NCHW", -1, -1, -1, [], "bilinear", False, 0
        )
        del cast_4, slice_0

        # pd_op.squeeze: (65x-1x-1xf32) <- (1x65x-1x-1xf32, 1xi64)
        ...
        # pd_op.greater_than: (65x-1x-1xb) <- (65x-1x-1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(squeeze_0, full_1)
        del full_1, squeeze_0

        # pd_op.cast: (65x-1x-1xui8) <- (65x-1x-1xb)
