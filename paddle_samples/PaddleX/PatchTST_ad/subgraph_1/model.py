    ...
    def forward(
        ...
        dropout_0, dropout_1 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_1, None, full_16, True, "upscale_in_train", 0, False
            ),
        ...
        dropout_4, dropout_5 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                dropout_2, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del dropout_2
        ...
        del parameter_70, parameter_71, parameter_72, parameter_73, transpose_9
        ...
        dropout_6, dropout_7 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_0, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_0
        ...
        del dropout_6, parameter_67

        # pd_op.add: (-1x12x16xf32) <- (-1x12x16xf32, 16xf32)
        add_8 = paddle._C_ops.add(matmul_8, parameter_66)
        del matmul_8, parameter_66

        # pd_op.dropout: (-1x12x16xf32, -1x12x16xui8) <- (-1x12x16xf32, None, 1xf32)
        dropout_8, dropout_9 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_8, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_8
        ...
        del parameter_62, parameter_63, parameter_64, parameter_65, transpose_11
        ...
        del parameter_55, reshape_8

        # pd_op.add: (-1x-1x16xf32) <- (-1x-1x16xf32, 16xf32)
        add_14 = paddle._C_ops.add(matmul_14, parameter_54)
        del matmul_14, parameter_54

        # pd_op.dropout: (-1x-1x16xf32, -1x-1x16xui8) <- (-1x-1x16xf32, None, 1xf32)
        dropout_10, dropout_11 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_14, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_14
        ...
        dropout_12, dropout_13 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                dropout_10, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del dropout_10
        ...
        del parameter_50, parameter_51, parameter_52, parameter_53, transpose_17
        ...
        dropout_14, dropout_15 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_1, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_1
        ...
        del dropout_14, parameter_47

        # pd_op.add: (-1x12x16xf32) <- (-1x12x16xf32, 16xf32)
        add_17 = paddle._C_ops.add(matmul_16, parameter_46)
        del matmul_16, parameter_46

        # pd_op.dropout: (-1x12x16xf32, -1x12x16xui8) <- (-1x12x16xf32, None, 1xf32)
        dropout_16, dropout_17 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_17, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_17
        ...
        del parameter_42, parameter_43, parameter_44, parameter_45, transpose_19
        ...
        del parameter_35, reshape_12

        # pd_op.add: (-1x-1x16xf32) <- (-1x-1x16xf32, 16xf32)
        add_23 = paddle._C_ops.add(matmul_22, parameter_34)
        del matmul_22, parameter_34

        # pd_op.dropout: (-1x-1x16xf32, -1x-1x16xui8) <- (-1x-1x16xf32, None, 1xf32)
        dropout_18, dropout_19 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_23, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_23
        ...
        dropout_20, dropout_21 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                dropout_18, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del dropout_18
        ...
        del parameter_30, parameter_31, parameter_32, parameter_33, transpose_25
        ...
        dropout_22, dropout_23 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_2, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_2
        ...
        del dropout_22, parameter_27

        # pd_op.add: (-1x12x16xf32) <- (-1x12x16xf32, 16xf32)
        add_26 = paddle._C_ops.add(matmul_24, parameter_26)
        del matmul_24, parameter_26

        # pd_op.dropout: (-1x12x16xf32, -1x12x16xui8) <- (-1x12x16xf32, None, 1xf32)
        dropout_24, dropout_25 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_26, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_26
        ...
        del parameter_22, parameter_23, parameter_24, parameter_25, transpose_27
        ...
        dropout_28, dropout_29 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                dropout_26, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del dropout_26
        ...
        del parameter_10, parameter_11, parameter_12, parameter_13, transpose_33
        ...
        dropout_30, dropout_31 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_3, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_3
        ...
        del dropout_30, parameter_7

        # pd_op.add: (-1x12x16xf32) <- (-1x12x16xf32, 16xf32)
        add_35 = paddle._C_ops.add(matmul_32, parameter_6)
        del matmul_32, parameter_6

        # pd_op.dropout: (-1x12x16xf32, -1x12x16xui8) <- (-1x12x16xf32, None, 1xf32)
        dropout_32, dropout_33 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_35, None, full_16, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_35, full_16
        ...
        del parameter_2, parameter_3, parameter_4, parameter_5, transpose_35
        ...
        del full_int_array_16, transpose_36
        ...
        del assign_0, share_data__0, share_data__1, transpose_39
