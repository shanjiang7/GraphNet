...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.cast: (-1x192x32xf32) <- (-1x192x32xf32)
        ...
        # builtin.combine: ([-1x192x32xf32, -1x-1x32xf32]) <- (-1x192x32xf32, -1x-1x32xf32)
        combine_1 = [cast_1, cast_2]
        del cast_1, cast_2

        # pd_op.concat: (-1x-1x32xf32) <- ([-1x192x32xf32, -1x-1x32xf32], 1xi32)
        ...
        # pd_op.conv2d: (-1x32x-1x-1xf32) <- (-1x32x-1x-1xf32, 32x32x9x9xf32)
        ...
        # pd_op.conv2d: (-1x32x-1x-1xf32) <- (-1x32x-1x-1xf32, 32x32x11x11xf32)
