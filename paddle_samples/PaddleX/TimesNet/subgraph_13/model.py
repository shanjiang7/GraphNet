...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x32x1x96xf32) <- (-1x1x1x98xf32, 32x1x1x3xf32)
        ...
        # pd_op.matmul: (-1x96x32xf32) <- (-1x96x4xf32, 4x32xf32)
        ...
        # pd_op.add: (-1x96x32xf32) <- (-1x96x32xf32, 1x96x32xf32)
        add_1 = paddle._C_ops.add(add_0, slice_1)
        del add_0, slice_1
