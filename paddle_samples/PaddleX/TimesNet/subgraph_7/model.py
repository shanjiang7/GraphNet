...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, parameter_1, data_0, data_1, data_2):
        # pd_op.matmul: (-1x192x1xf32) <- (-1x192x32xf32, 32x1xf32)
        matmul_0 = paddle._C_ops.matmul(data_0, parameter_1, False, False)
        del data_0, parameter_1

        # pd_op.add: (-1x192x1xf32) <- (-1x192x1xf32, 1xf32)
        ...
        # pd_op.slice: (-1x1xf32) <- (-1x1x1xf32, 1xi64, 1xi64)
        ...
        full_int_array_2 = [1, 192, 1]

        # pd_op.tile: (-1x192x1xf32) <- (-1x1x1xf32, 3xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_0, full_int_array_2)
        del unsqueeze_0

        # pd_op.multiply: (-1x192x1xf32) <- (-1x192x1xf32, -1x192x1xf32)
