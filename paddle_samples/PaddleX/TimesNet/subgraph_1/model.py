...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.cast: (16x192x32xf32) <- (16x192x32xf32)
        ...
        # builtin.combine: ([16x192x32xf32, 16x-1x32xf32]) <- (16x192x32xf32, 16x-1x32xf32)
        combine_1 = [cast_1, cast_2]

        # pd_op.concat: (16x-1x32xf32) <- ([16x192x32xf32, 16x-1x32xf32], 1xi32)
