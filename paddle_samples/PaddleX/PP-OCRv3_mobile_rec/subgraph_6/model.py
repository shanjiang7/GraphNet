...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x16x24x160xf32) <- (-1x3x48x320xf32, 16x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_195, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_195

        # pd_op.batch_norm_: (-1x16x24x160xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (-1x16x24x160xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (-1x16x24x160xf32) <- (-1x16x24x160xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)
        del batch_norm__0

        # pd_op.depthwise_conv2d: (-1x16x24x160xf32) <- (-1x16x24x160xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x32x24x160xf32) <- (-1x16x24x160xf32, 32x16x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_185, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_1, parameter_185

        # pd_op.batch_norm_: (-1x32x24x160xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (-1x32x24x160xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (-1x32x24x160xf32) <- (-1x32x24x160xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)
        del batch_norm__12

        # pd_op.depthwise_conv2d: (-1x32x24x160xf32) <- (-1x32x24x160xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x64x24x160xf32) <- (-1x32x24x160xf32, 64x32x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_175, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_3, parameter_175

        # pd_op.batch_norm_: (-1x64x24x160xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (-1x64x24x160xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (-1x64x24x160xf32) <- (-1x64x24x160xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)
        del batch_norm__24

        # pd_op.depthwise_conv2d: (-1x64x24x160xf32) <- (-1x64x24x160xf32, 64x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x64x24x160xf32) <- (-1x64x24x160xf32, 64x64x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x64x12x160xf32) <- (-1x64x24x160xf32, 64x1x3x3xf32)
        ...
        # pd_op.batch_norm_: (-1x64x12x160xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (-1x64x12x160xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (-1x64x12x160xf32) <- (-1x64x12x160xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)
        del batch_norm__42

        # pd_op.conv2d: (-1x128x12x160xf32) <- (-1x64x12x160xf32, 128x64x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            hardswish_7, parameter_155, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_7, parameter_155

        # pd_op.batch_norm_: (-1x128x12x160xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (-1x128x12x160xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.hardswish: (-1x128x12x160xf32) <- (-1x128x12x160xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)
        del batch_norm__48

        # pd_op.depthwise_conv2d: (-1x128x12x160xf32) <- (-1x128x12x160xf32, 128x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x128x12x160xf32) <- (-1x128x12x160xf32, 128x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x128x6x160xf32) <- (-1x128x12x160xf32, 128x1x3x3xf32)
        ...
        # pd_op.batch_norm_: (-1x128x6x160xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (-1x128x6x160xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (-1x128x6x160xf32) <- (-1x128x6x160xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)
        del batch_norm__66

        # pd_op.conv2d: (-1x256x6x160xf32) <- (-1x128x6x160xf32, 256x128x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_135, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_11, parameter_135

        # pd_op.batch_norm_: (-1x256x6x160xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (-1x256x6x160xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (-1x256x6x160xf32) <- (-1x256x6x160xf32)
        ...
        # pd_op.conv2d: (-1x256x6x160xf32) <- (-1x256x6x160xf32, 256x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x256x3x160xf32) <- (-1x256x6x160xf32, 256x1x5x5xf32)
        ...
        # pd_op.batch_norm_: (-1x256x3x160xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (-1x256x3x160xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (-1x256x3x160xf32) <- (-1x256x3x160xf32)
        ...
        # pd_op.pool2d: (-1x256x1x1xf32) <- (-1x256x3x160xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x256x3x160xf32) <- (-1x256x3x160xf32, -1x256x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)
        del hardsigmoid_0, hardswish_23

        # pd_op.conv2d: (-1x512x3x160xf32) <- (-1x256x3x160xf32, 512x256x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_71, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del multiply_0, parameter_71

        # pd_op.batch_norm_: (-1x512x3x160xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (-1x512x3x160xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (-1x512x3x160xf32) <- (-1x512x3x160xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)
        del batch_norm__144

        # pd_op.depthwise_conv2d: (-1x512x3x80xf32) <- (-1x512x3x160xf32, 512x1x5x5xf32)
        ...
        # pd_op.batch_norm_: (-1x512x3x80xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (-1x512x3x80xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__150,
            batch_norm__151,
            batch_norm__152,
        ...
        # pd_op.hardswish: (-1x512x3x80xf32) <- (-1x512x3x80xf32)
        hardswish_25 = paddle._C_ops.hardswish(batch_norm__150)
        del batch_norm__150

        # pd_op.pool2d: (-1x512x1x1xf32) <- (-1x512x3x80xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x512x3x80xf32) <- (-1x512x3x80xf32, -1x512x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)
        del hardsigmoid_1, hardswish_25

        # pd_op.conv2d: (-1x512x3x80xf32) <- (-1x512x3x80xf32, 512x512x1x1xf32)
        ...
        # pd_op.pool2d: (-1x512x1x40xf32) <- (-1x512x3x80xf32, 2xi64)
        ...
        # pd_op.assign: (-1x512x1x40xf32) <- (-1x512x1x40xf32)
        assign_0 = pool2d_2
        del pool2d_2

        # pd_op.conv2d: (-1x64x1x40xf32) <- (-1x512x1x40xf32, 64x512x3x3xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            assign_0, parameter_52, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_52

        # pd_op.batch_norm_: (-1x64x1x40xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (-1x64x1x40xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.swish: (-1x64x1x40xf32) <- (-1x64x1x40xf32)
        swish_0 = paddle._C_ops.swish(batch_norm__162)
        del batch_norm__162

        # pd_op.conv2d: (-1x120x1x40xf32) <- (-1x64x1x40xf32, 120x64x1x1xf32)
        ...
        full_int_array_5 = [0, -1, 3, 8, 15]

        # pd_op.reshape: (-1x-1x3x8x15xf32) <- (-1x40x360xf32, 5xi64)
        reshape_4 = paddle._C_ops.reshape(add_4, full_int_array_5)
        del add_4
        ...
        slice_2 = paddle._C_ops.slice(
            transpose_1, [0], full_int_array_4, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.reshape: (-1x-1x3x8x15xf32) <- (-1x40x360xf32, 5xi64)
        reshape_6 = paddle._C_ops.reshape(add_10, full_int_array_5)
        del add_10, full_int_array_5
        ...
        slice_5 = paddle._C_ops.slice(
            transpose_4, [0], full_int_array_4, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.conv2d: (-1x512x1x40xf32) <- (-1x120x1x40xf32, 512x120x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            transpose_7, parameter_16, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_16, transpose_7

        # pd_op.batch_norm_: (-1x512x1x40xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (-1x512x1x40xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.swish: (-1x512x1x40xf32) <- (-1x512x1x40xf32)
        ...
        # builtin.combine: ([-1x512x1x40xf32, -1x512x1x40xf32]) <- (-1x512x1x40xf32, -1x512x1x40xf32)
        combine_0 = [assign_0, swish_4]
        del assign_0, swish_4

        # pd_op.concat: (-1x1024x1x40xf32) <- ([-1x512x1x40xf32, -1x512x1x40xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_2)
        del combine_0, full_2

        # pd_op.conv2d: (-1x64x1x40xf32) <- (-1x1024x1x40xf32, 64x1024x3x3xf32)
        ...
        # pd_op.conv2d: (-1x64x1x40xf32) <- (-1x64x1x40xf32, 64x64x1x1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x64x1x40xf32)
