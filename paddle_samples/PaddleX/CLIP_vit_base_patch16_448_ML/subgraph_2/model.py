...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (8x768x28x28xf32) <- (8x3x448x448xf32, 768x3x16x16xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_3, parameter_170, [16, 16], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_3, parameter_170

        # pd_op.flatten: (8x768x784xf32) <- (8x768x28x28xf32)
        flatten_1 = paddle._C_ops.flatten(conv2d_0, 2, 3)

        # pd_op.transpose: (8x784x768xf32) <- (8x768x784xf32)
        ...
        # pd_op.expand: (8x1x768xf32) <- (1x1x768xf32, 3xi64)
        ...
        # builtin.combine: ([8x1x768xf32, 8x784x768xf32]) <- (8x1x768xf32, 8x784x768xf32)
        combine_0 = [expand_0, transpose_0]

        # pd_op.concat: (8x785x768xf32) <- ([8x1x768xf32, 8x784x768xf32], 1xi32)
        ...
        full_int_array_4 = [-1, 14, 14, 768]

        # pd_op.reshape: (1x14x14x768xf32) <- (1x196x768xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(slice_1, full_int_array_4)
        ...
        combine_1 = [slice_0, cast_1]

        # pd_op.concat: (1x785x768xf32) <- ([1x1x768xf32, 1x784x768xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.add: (8x785x768xf32) <- (8x785x768xf32, 1x785x768xf32)
        add_0 = paddle._C_ops.add(concat_0, concat_1)

        # pd_op.layer_norm: (8x785x768xf32, 8x785xf32, 8x785xf32) <- (8x785x768xf32, 768xf32, 768xf32)
        ...
        # pd_op.matmul: (8x785x2304xf32) <- (8x785x768xf32, 768x2304xf32)
        matmul_0 = paddle._C_ops.matmul(layer_norm_3, parameter_165, False, False)
        del parameter_165

        # pd_op.add: (8x785x2304xf32) <- (8x785x2304xf32, 2304xf32)
        add_1 = paddle._C_ops.add(matmul_0, parameter_164)
        del parameter_164

        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_5 = [-1, 785, 3, 12, 64]

        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_1 = paddle._C_ops.reshape(add_1, full_int_array_5)

        # pd_op.transpose: (3x8x12x785x64xf32) <- (8x785x3x12x64xf32)
        transpose_3 = paddle._C_ops.transpose(reshape_1, [2, 0, 3, 1, 4])
        del reshape_1

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        ...
        slice_3 = paddle._C_ops.slice(
            transpose_3, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        slice_4 = paddle._C_ops.slice(
            transpose_3, [0], full_int_array_6, full_int_array_7, [1], [0]
        )

        # pd_op.transpose: (8x12x64x785xf32) <- (8x12x785x64xf32)
        transpose_4 = paddle._C_ops.transpose(slice_3, [0, 1, 3, 2])
        del slice_3

        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        ...
        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(matmul_1, full_1, float("0"), True)
        del matmul_1

        # pd_op.softmax: (8x12x785x785xf32) <- (8x12x785x785xf32)
        softmax_0 = paddle._C_ops.softmax(scale_0, -1)
        del scale_0

        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_2 = paddle._C_ops.matmul(softmax_0, slice_4, False, False)

        # pd_op.transpose: (8x785x12x64xf32) <- (8x12x785x64xf32)
        transpose_5 = paddle._C_ops.transpose(matmul_2, [0, 2, 1, 3])
        del matmul_2

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_8 = [-1, 785, 768]

        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(transpose_5, full_int_array_8)

        # pd_op.matmul: (8x785x768xf32) <- (8x785x768xf32, 768x768xf32)
        matmul_3 = paddle._C_ops.matmul(reshape_2, parameter_163, False, False)
        del parameter_163

        # pd_op.add: (8x785x768xf32) <- (8x785x768xf32, 768xf32)
        add_2 = paddle._C_ops.add(matmul_3, parameter_162)
        del parameter_162

        # pd_op.add: (8x785x768xf32) <- (8x785x768xf32, 8x785x768xf32)
        ...
        # pd_op.matmul: (8x785x3072xf32) <- (8x785x768xf32, 768x3072xf32)
        matmul_4 = paddle._C_ops.matmul(layer_norm_6, parameter_159, False, False)
        del parameter_159

        # pd_op.add: (8x785x3072xf32) <- (8x785x3072xf32, 3072xf32)
        add_4 = paddle._C_ops.add(matmul_4, parameter_158)
        del parameter_158

        # pd_op.gelu: (8x785x3072xf32) <- (8x785x3072xf32)
        gelu_0 = paddle._C_ops.gelu(add_4, False)

        # pd_op.matmul: (8x785x768xf32) <- (8x785x3072xf32, 3072x768xf32)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_3 = paddle._C_ops.reshape(add_7, full_int_array_5)
        ...
        slice_6 = paddle._C_ops.slice(
            transpose_6, [0], full_int_array_2, full_int_array_6, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_7 = paddle._C_ops.slice(
            transpose_6, [0], full_int_array_6, full_int_array_7, [1], [0]
        )
        ...
        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(matmul_7, full_1, float("0"), True)
        del matmul_7
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_4 = paddle._C_ops.reshape(transpose_8, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_5 = paddle._C_ops.reshape(add_13, full_int_array_5)
        ...
        slice_9 = paddle._C_ops.slice(
            transpose_9, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(matmul_13, full_1, float("0"), True)
        del matmul_13
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_14 = paddle._C_ops.matmul(softmax_2, slice_10, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_6 = paddle._C_ops.reshape(transpose_11, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_7 = paddle._C_ops.reshape(add_19, full_int_array_5)
        ...
        slice_12 = paddle._C_ops.slice(
            transpose_12, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_19 = paddle._C_ops.matmul(slice_11, transpose_13, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(matmul_19, full_1, float("0"), True)
        del matmul_19
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_20 = paddle._C_ops.matmul(softmax_3, slice_13, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_8 = paddle._C_ops.reshape(transpose_14, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_9 = paddle._C_ops.reshape(add_25, full_int_array_5)
        ...
        slice_15 = paddle._C_ops.slice(
            transpose_15, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_25 = paddle._C_ops.matmul(slice_14, transpose_16, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(matmul_25, full_1, float("0"), True)
        del matmul_25
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_26 = paddle._C_ops.matmul(softmax_4, slice_16, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_10 = paddle._C_ops.reshape(transpose_17, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_11 = paddle._C_ops.reshape(add_31, full_int_array_5)
        ...
        slice_17 = paddle._C_ops.slice(
            transpose_18, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_18 = paddle._C_ops.slice(
            transpose_18, [0], full_int_array_2, full_int_array_6, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_19 = paddle._C_ops.slice(
            transpose_18, [0], full_int_array_6, full_int_array_7, [1], [0]
        )
        ...
        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_31 = paddle._C_ops.matmul(slice_17, transpose_19, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(matmul_31, full_1, float("0"), True)
        del matmul_31
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_32 = paddle._C_ops.matmul(softmax_5, slice_19, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_12 = paddle._C_ops.reshape(transpose_20, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_13 = paddle._C_ops.reshape(add_37, full_int_array_5)
        ...
        slice_20 = paddle._C_ops.slice(
            transpose_21, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_21 = paddle._C_ops.slice(
            transpose_21, [0], full_int_array_2, full_int_array_6, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_22 = paddle._C_ops.slice(
            transpose_21, [0], full_int_array_6, full_int_array_7, [1], [0]
        )
        ...
        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_37 = paddle._C_ops.matmul(slice_20, transpose_22, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(matmul_37, full_1, float("0"), True)
        del matmul_37
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_38 = paddle._C_ops.matmul(softmax_6, slice_22, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_14 = paddle._C_ops.reshape(transpose_23, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_15 = paddle._C_ops.reshape(add_43, full_int_array_5)
        ...
        slice_23 = paddle._C_ops.slice(
            transpose_24, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_24 = paddle._C_ops.slice(
            transpose_24, [0], full_int_array_2, full_int_array_6, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_25 = paddle._C_ops.slice(
            transpose_24, [0], full_int_array_6, full_int_array_7, [1], [0]
        )
        ...
        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_43 = paddle._C_ops.matmul(slice_23, transpose_25, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(matmul_43, full_1, float("0"), True)
        del matmul_43
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_44 = paddle._C_ops.matmul(softmax_7, slice_25, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_16 = paddle._C_ops.reshape(transpose_26, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_17 = paddle._C_ops.reshape(add_49, full_int_array_5)
        ...
        slice_26 = paddle._C_ops.slice(
            transpose_27, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_27 = paddle._C_ops.slice(
            transpose_27, [0], full_int_array_2, full_int_array_6, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_28 = paddle._C_ops.slice(
            transpose_27, [0], full_int_array_6, full_int_array_7, [1], [0]
        )
        ...
        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_49 = paddle._C_ops.matmul(slice_26, transpose_28, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(matmul_49, full_1, float("0"), True)
        del matmul_49
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_50 = paddle._C_ops.matmul(softmax_8, slice_28, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_18 = paddle._C_ops.reshape(transpose_29, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_19 = paddle._C_ops.reshape(add_55, full_int_array_5)
        ...
        slice_30 = paddle._C_ops.slice(
            transpose_30, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.transpose: (8x12x64x785xf32) <- (8x12x785x64xf32)
        transpose_31 = paddle._C_ops.transpose(slice_30, [0, 1, 3, 2])
        del slice_30

        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_55 = paddle._C_ops.matmul(slice_29, transpose_31, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_9 = paddle._C_ops.scale(matmul_55, full_1, float("0"), True)
        del matmul_55
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_56 = paddle._C_ops.matmul(softmax_9, slice_31, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_20 = paddle._C_ops.reshape(transpose_32, full_int_array_8)
        ...
        # pd_op.reshape: (8x785x3x12x64xf32) <- (8x785x2304xf32, 5xi64)
        reshape_21 = paddle._C_ops.reshape(add_61, full_int_array_5)
        ...
        slice_32 = paddle._C_ops.slice(
            transpose_33, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_33 = paddle._C_ops.slice(
            transpose_33, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.transpose: (8x12x64x785xf32) <- (8x12x785x64xf32)
        transpose_34 = paddle._C_ops.transpose(slice_33, [0, 1, 3, 2])
        del slice_33

        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_61 = paddle._C_ops.matmul(slice_32, transpose_34, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(matmul_61, full_1, float("0"), True)
        del matmul_61
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_62 = paddle._C_ops.matmul(softmax_10, slice_34, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_22 = paddle._C_ops.reshape(transpose_35, full_int_array_8)
        ...
        slice_35 = paddle._C_ops.slice(
            transpose_36, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (8x12x785x64xf32) <- (3x8x12x785x64xf32, 1xi64, 1xi64)
        slice_36 = paddle._C_ops.slice(
            transpose_36, [0], full_int_array_2, full_int_array_6, [1], [0]
        )
        ...
        # pd_op.transpose: (8x12x64x785xf32) <- (8x12x785x64xf32)
        transpose_37 = paddle._C_ops.transpose(slice_36, [0, 1, 3, 2])
        del slice_36

        # pd_op.matmul: (8x12x785x785xf32) <- (8x12x785x64xf32, 8x12x64x785xf32)
        matmul_67 = paddle._C_ops.matmul(slice_35, transpose_37, False, False)

        # pd_op.scale: (8x12x785x785xf32) <- (8x12x785x785xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(matmul_67, full_1, float("0"), True)
        del matmul_67
        ...
        # pd_op.matmul: (8x12x785x64xf32) <- (8x12x785x785xf32, 8x12x785x64xf32)
        matmul_68 = paddle._C_ops.matmul(softmax_11, slice_37, False, False)
        ...
        # pd_op.reshape: (8x785x768xf32) <- (8x785x12x64xf32, 3xi64)
        reshape_24 = paddle._C_ops.reshape(transpose_38, full_int_array_8)
        ...
        # pd_op.slice: (8x784x768xf32) <- (8x785x768xf32, 1xi64, 1xi64)
        slice_38 = paddle._C_ops.slice(
            add_72, [1], full_int_array_2, full_int_array_3, [1], []
        )

        # pd_op.slice: (8x768xf32) <- (8x784x768xf32, 1xi64, 1xi64)
        slice_39 = paddle._C_ops.slice(
            slice_38, [1], full_int_array_1, full_int_array_2, [1], [1]
        )

        # pd_op.slice: (8x783x768xf32) <- (8x784x768xf32, 1xi64, 1xi64)
        slice_40 = paddle._C_ops.slice(
            slice_38, [1], full_int_array_2, full_int_array_3, [1], []
        )

        # pd_op.layer_norm: (8x768xf32, 8xf32, 8xf32) <- (8x768xf32, 768xf32, 768xf32)
        layer_norm_75, layer_norm_76, layer_norm_77 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                slice_39, parameter_23, parameter_22, float("1e-05"), 1
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_9 = [8, 768, -1, 1]

        # pd_op.reshape: (8x768x1x1xf32) <- (8x768xf32, 4xi64)
        reshape_25 = paddle._C_ops.reshape(layer_norm_75, full_int_array_9)
        ...
        # pd_op.reshape: (8x1x8x96xf32) <- (8x1x768xf32, 4xi64)
        reshape_28 = paddle._C_ops.reshape(add_76, full_int_array_12)

        # pd_op.transpose: (8x8x1x96xf32) <- (8x1x8x96xf32)
        transpose_41 = paddle._C_ops.transpose(reshape_28, [0, 2, 1, 3])
        del reshape_28

        # pd_op.reshape: (8x1x8x96xf32) <- (8x1x768xf32, 4xi64)
        reshape_29 = paddle._C_ops.reshape(add_77, full_int_array_12)
        ...
        scale_12 = paddle._C_ops.scale(transpose_40, full_3, float("0"), True)
        del transpose_40

        # pd_op.matmul: (8x8x33x1xf32) <- (8x8x33x96xf32, 8x8x1x96xf32)
        matmul_75 = paddle._C_ops.matmul(scale_12, transpose_41, False, True)

        # pd_op.softmax: (8x8x33x1xf32) <- (8x8x33x1xf32)
        softmax_12 = paddle._C_ops.softmax(matmul_75, -1)
        del matmul_75

        # pd_op.dropout: (8x8x33x1xf32, 8x8x33x1xui8) <- (8x8x33x1xf32, None, 1xf32)
        dropout_2, dropout_3 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                softmax_12, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )

        # pd_op.matmul: (8x8x33x96xf32) <- (8x8x33x1xf32, 8x8x1x96xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_13 = [0, 0, 768]

        # pd_op.reshape: (8x33x768xf32) <- (8x33x8x96xf32, 3xi64)
        reshape_30 = paddle._C_ops.reshape(transpose_43, full_int_array_13)
        ...
        dropout_4, dropout_5 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_78, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_78
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(flatten_4, full_int_array_14)
        ...
        reshape_31 = paddle._C_ops.reshape(parameter_0, full_int_array_10)
        del full_int_array_10, parameter_0
