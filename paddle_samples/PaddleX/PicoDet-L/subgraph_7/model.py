...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.hardswish: (8x32x-1x-1xf32) <- (8x32x-1x-1xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (8x32x-1x-1xf32) <- (8x32x-1x-1xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x64x-1x-1xf32) <- (8x32x-1x-1xf32, 64x32x1x1xf32)
        ...
        # pd_op.hardswish: (8x64x-1x-1xf32) <- (8x64x-1x-1xf32)
        ...
        # pd_op.conv2d: (8x128x-1x-1xf32) <- (8x64x-1x-1xf32, 128x64x1x1xf32)
        ...
        # pd_op.hardswish: (8x128x-1x-1xf32) <- (8x128x-1x-1xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (8x128x-1x-1xf32) <- (8x128x-1x-1xf32, 128x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x128x-1x-1xf32) <- (8x128x-1x-1xf32, 128x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x256x-1x-1xf32) <- (8x128x-1x-1xf32, 256x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x256x-1x-1xf32) <- (8x256x-1x-1xf32, 256x1x3x3xf32)
        ...
        # pd_op.pool2d: (8x512x1x1xf32) <- (8x512x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (8x512x-1x-1xf32) <- (8x512x-1x-1xf32, 8x512x1x1xf32)
        ...
        # pd_op.hardswish: (8x1024x-1x-1xf32) <- (8x1024x-1x-1xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (8x1024x-1x-1xf32) <- (8x1024x-1x-1xf32, 1024x1x5x5xf32)
        ...
        # pd_op.pool2d: (8x1024x1x1xf32) <- (8x1024x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (8x1024x-1x-1xf32) <- (8x1024x-1x-1xf32, 8x1024x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (8x1024x-1x-1xf32) <- (8x1024x-1x-1xf32, 1024x1024x1x1xf32)
