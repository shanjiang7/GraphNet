...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.unsqueeze: (1x6885x4xf32) <- (6885x4xf32, 1xi64)
        ...
        # pd_op.slice: (1x6885x2xf32) <- (1x6885x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (8x6885x2xf32) <- (8x1x2xf32, 1x6885x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (8x6885x2xf32) <- (8x1x2xf32, 1x6885x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (8x6885x2xf32) <- (8x6885x2xf32, 8x6885x2xf32)
        ...
        # pd_op.clip: (8x6885x2xf32) <- (8x6885x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (8x6885xf32) <- (8x6885x2xf32, 1xi64)
        ...
        # pd_op.scale: (8x6885xf32) <- (8x6885xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-10"), True)
        del full_2, subtract_3

        # pd_op.divide: (8x6885xf32) <- (8x6885xf32, 8x6885xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [8, -1, 6885]

        # pd_op.reshape: (8x1x6885xf32) <- (8x6885xf32, 3xi64)
