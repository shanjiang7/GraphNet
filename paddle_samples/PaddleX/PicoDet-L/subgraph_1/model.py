...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.transpose: (8x4x-1xf32) <- (8x-1x4xf32)
        ...
        # pd_op.gather_nd: (8x-1x-1xf32) <- (8x4x-1xf32, 8x-1x2xi32)
        ...
        # pd_op.topk: (8x-1x13xf32, 8x-1x13xi64) <- (8x-1x-1xf32, 1xi32)
        ...
        # pd_op.one_hot: (8x-1x13x-1xf32) <- (8x-1x13xi64, xi64)
        ...
        # pd_op.sum: (8x-1x-1xf32) <- (8x-1x13x-1xf32, 1xi64)
