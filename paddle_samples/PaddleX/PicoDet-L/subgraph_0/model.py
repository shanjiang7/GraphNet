...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (8x32x320x320xf32) <- (8x3x640x640xf32, 32x3x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (8x32x320x320xf32) <- (8x32x320x320xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x64x320x320xf32) <- (8x32x320x320xf32, 64x32x1x1xf32)
        ...
        # pd_op.hardswish: (8x64x320x320xf32) <- (8x64x320x320xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)
        del batch_norm__12

        # pd_op.depthwise_conv2d: (8x64x160x160xf32) <- (8x64x320x320xf32, 64x1x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (8x128x80x80xf32) <- (8x128x160x160xf32, 128x1x3x3xf32)
        ...
        # pd_op.batch_norm_: (8x128x80x80xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (8x128x80x80xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (8x128x80x80xf32) <- (8x128x80x80xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)
        del batch_norm__42

        # pd_op.conv2d: (8x256x80x80xf32) <- (8x128x80x80xf32, 256x128x1x1xf32)
        ...
        # pd_op.hardswish: (8x256x80x80xf32) <- (8x256x80x80xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)
        del batch_norm__48

        # pd_op.depthwise_conv2d: (8x256x80x80xf32) <- (8x256x80x80xf32, 256x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x256x80x80xf32) <- (8x256x80x80xf32, 256x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x256x40x40xf32) <- (8x256x80x80xf32, 256x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_466, [2, 2], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_466

        # pd_op.batch_norm_: (8x256x40x40xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (8x256x40x40xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (8x256x40x40xf32) <- (8x256x40x40xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)
        del batch_norm__66

        # pd_op.conv2d: (8x512x40x40xf32) <- (8x256x40x40xf32, 512x256x1x1xf32)
        ...
        # pd_op.hardswish: (8x512x40x40xf32) <- (8x512x40x40xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)
        del batch_norm__72

        # pd_op.depthwise_conv2d: (8x512x40x40xf32) <- (8x512x40x40xf32, 512x1x5x5xf32)
        ...
        # pd_op.conv2d: (8x512x40x40xf32) <- (8x512x40x40xf32, 512x512x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x512x20x20xf32) <- (8x512x40x40xf32, 512x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_406, [2, 2], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        del parameter_406

        # pd_op.batch_norm_: (8x512x20x20xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (8x512x20x20xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (8x512x20x20xf32) <- (8x512x20x20xf32)
        ...
        # pd_op.pool2d: (8x512x1x1xf32) <- (8x512x20x20xf32, 2xi64)
        ...
        # pd_op.multiply: (8x512x20x20xf32) <- (8x512x20x20xf32, 8x512x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)
        del hardsigmoid_0, hardswish_23

        # pd_op.conv2d: (8x1024x20x20xf32) <- (8x512x20x20xf32, 1024x512x1x1xf32)
        ...
        # pd_op.hardswish: (8x1024x20x20xf32) <- (8x1024x20x20xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)
        del batch_norm__144

        # pd_op.depthwise_conv2d: (8x1024x20x20xf32) <- (8x1024x20x20xf32, 1024x1x5x5xf32)
        ...
        # pd_op.conv2d: (8x1024x20x20xf32) <- (8x1024x20x20xf32, 1024x1024x1x1xf32)
        ...
        full_int_array_2 = [-1, 4, 6400]

        # pd_op.reshape: (8x4x6400xf32) <- (8x4x80x80xf32, 3xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_4 = [-1, 6400, 4]

        # pd_op.reshape: (8x6400x4xf32) <- (204800xf32, 3xi64)
        ...
        # builtin.combine: ([8x4x6400xf32, 8x4x1600xf32, 8x4x400xf32, 8x4x100xf32]) <- (8x4x6400xf32, 8x4x1600xf32, 8x4x400xf32, 8x4x100xf32)
        combine_4 = [reshape_7, reshape_13, reshape_19, reshape_25]
        del reshape_13, reshape_19, reshape_25, reshape_7

        # pd_op.concat: (8x4x8500xf32) <- ([8x4x6400xf32, 8x4x1600xf32, 8x4x400xf32, 8x4x100xf32], 1xi32)
        ...
        # pd_op.split_with_num: ([8x8500x2xf32, 8x8500x2xf32]) <- (8x8500x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(concat_5, 2, full_3)
        del concat_5, full_3

        # builtin.split: (8x8500x2xf32, 8x8500x2xf32) <- ([8x8500x2xf32, 8x8500x2xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.scale: (8x8500x2xf32) <- (8x8500x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_0, full_4, float("0"), True)
        del full_4, split_0

        # pd_op.add: (8x8500x2xf32) <- (8x8500x2xf32, 8500x2xf32)
        ...
        # builtin.combine: ([8x8500x2xf32, 8x8500x2xf32]) <- (8x8500x2xf32, 8x8500x2xf32)
        combine_6 = [add_17, add_18]
        del add_17, add_18

        # pd_op.concat: (8x8500x4xf32) <- ([8x8500x2xf32, 8x8500x2xf32], 1xi32)
