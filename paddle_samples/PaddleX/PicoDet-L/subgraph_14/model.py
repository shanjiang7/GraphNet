...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.maximum: (8x-1x6885x2xf32) <- (8x-1x1x2xf32, 8x1x6885x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (8x-1x6885x2xf32) <- (8x-1x1x2xf32, 8x1x6885x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (8x-1x6885x2xf32) <- (8x-1x6885x2xf32, 8x-1x6885x2xf32)
        ...
        # pd_op.clip: (8x-1x6885x2xf32) <- (8x-1x6885x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (8x-1x6885xf32) <- (8x-1x6885x2xf32, 1xi64)
        ...
        # pd_op.add: (8x-1x6885xf32) <- (8x-1x1xf32, 8x1x6885xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (8x-1x6885xf32) <- (8x-1x6885xf32, 8x-1x6885xf32)
        ...
        # pd_op.scale: (8x-1x6885xf32) <- (8x-1x6885xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_3, float("1e-09"), True)
        del full_3, subtract_3

        # pd_op.divide: (8x-1x6885xf32) <- (8x-1x6885xf32, 8x-1x6885xf32)
        ...
        # pd_op.subtract: (8x-1x6885x1xf32) <- (1x1x6885x1xf32, 8x-1x1x1xf32)
        ...
        # pd_op.subtract: (8x-1x6885x1xf32) <- (8x-1x1x1xf32, 1x1x6885x1xf32)
        ...
        # builtin.combine: ([8x-1x6885x1xf32, 8x-1x6885x1xf32, 8x-1x6885x1xf32, 8x-1x6885x1xf32]) <- (8x-1x6885x1xf32, 8x-1x6885x1xf32, 8x-1x6885x1xf32, 8x-1x6885x1xf32)
        combine_2 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (8x-1x6885x4xf32) <- ([8x-1x6885x1xf32, 8x-1x6885x1xf32, 8x-1x6885x1xf32, 8x-1x6885x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_2, full_9)
        del combine_2, full_9

        # pd_op.min: (8x-1x6885xf32) <- (8x-1x6885x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (8x-1x6885xb) <- (8x-1x6885xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_10)
        del full_10, min_0

        # pd_op.cast: (8x-1x6885xf32) <- (8x-1x6885xb)
        ...
        # pd_op.shape64: (3xi64) <- (8x-1x6885xf32)
        ...
        # pd_op.topk: (8x-1x13xf32, 8x-1x13xi64) <- (8x-1x6885xf32, 1xi32)
        ...
        # pd_op.one_hot: (8x-1x13x6885xf32) <- (8x-1x13xi64, 1xi32)
        ...
        # pd_op.sum: (8x-1x6885xf32) <- (8x-1x13x6885xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_6, None, False)
        del one_hot_0
        ...
        # pd_op.sum: (8x6885xf32) <- (8x-1x6885xf32, 1xi64)
        sum_1 = paddle._C_ops.sum(multiply_4, full_int_array_6, None, False)
        ...
        max_0 = paddle._C_ops.max(sum_1, full_int_array_7, False)
        ...
        del divide_0, full_13, max_0, multiply_0, multiply_4, sum_1, unsqueeze_2
