    ...
    def forward(
        ...
        dropout_0, dropout_1 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                data_1, None, full_0, True, "upscale_in_train", 0, False
            ),
        ...
        del add_0, parameter_16, parameter_17
        ...
        del full_int_array_1, unsqueeze_2
        ...
        dropout_4, dropout_5 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_5, None, full_0, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_5
        ...
        del add_6, parameter_6, parameter_7
        ...
        unsqueeze_4 = paddle._C_ops.unsqueeze(assign_0, full_int_array_4)
        del assign_0
        ...
        assign_1 = parameter_3
        del parameter_3

        # pd_op.unsqueeze: (512x2048x1x1xf32) <- (512x2048x1xf32, 1xi64)
        unsqueeze_6 = paddle._C_ops.unsqueeze(assign_1, full_int_array_4)
        del assign_1
        ...
        dropout_8, dropout_9 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_1, None, full_0, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del full_0, transpose_1
        ...
        del add_9, parameter_0, parameter_1
