...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(assign_2, full_int_array_9)
        del assign_2
        ...
        del parameter_46, relu_0

        # pd_op.add: (-1x256xf32) <- (-1x256xf32, 256xf32)
        add_1 = paddle._C_ops.add(matmul_1, parameter_45)
        del matmul_1, parameter_45
        ...
        # pd_op.assign: (1x96x3xf32) <- (1x96x3xf32)
        assign_3 = parameter_43
        del parameter_43

        # pd_op.unsqueeze: (1x96x1x3xf32) <- (1x96x3xf32, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(assign_3, full_int_array_9)
        del assign_3
        ...
        del parameter_40, relu_2

        # pd_op.add: (-1x256xf32) <- (-1x256xf32, 256xf32)
        add_3 = paddle._C_ops.add(matmul_4, parameter_39)
        del matmul_4, parameter_39
        ...
        assign_4 = parameter_37
        del parameter_37

        # pd_op.unsqueeze: (512x1x1x3xf32) <- (512x1x3xf32, 1xi64)
        unsqueeze_7 = paddle._C_ops.unsqueeze(assign_4, full_int_array_9)
        del assign_4
        ...
        dropout_1, dropout_2 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_5, None, full_6, True, "upscale_in_train", 0, False
            ),
        ...
        dropout_3, dropout_4 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                softmax_0, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del softmax_0
        ...
        dropout_5, dropout_6 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_10, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_10
        ...
        unsqueeze_13 = paddle._C_ops.unsqueeze(assign_5, full_int_array_9)
        del assign_5
        ...
        dropout_7, dropout_8 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_0, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_0
        ...
        unsqueeze_15 = paddle._C_ops.unsqueeze(assign_6, full_int_array_9)
        del assign_6
        ...
        dropout_9, dropout_10 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_3, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del transpose_3
        ...
        dropout_11, dropout_12 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                softmax_1, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del softmax_1
        ...
        del matmul_14, parameter_12

        # pd_op.dropout: (-1x96x512xf32, -1x96x512xui8) <- (-1x96x512xf32, None, 1xf32)
        dropout_13, dropout_14 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_19, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_19
        ...
        # pd_op.unsqueeze: (2048x512x1x1xf32) <- (2048x512x1xf32, 1xi64)
        unsqueeze_21 = paddle._C_ops.unsqueeze(assign_7, full_int_array_9)
        del assign_7
        ...
        dropout_15, dropout_16 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                gelu_1, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del gelu_1
        ...
        # pd_op.unsqueeze: (512x2048x1x1xf32) <- (512x2048x1xf32, 1xi64)
        unsqueeze_23 = paddle._C_ops.unsqueeze(assign_8, full_int_array_9)
        del assign_8
        ...
        dropout_17, dropout_18 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                transpose_5, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del transpose_5
        ...
        del layer_norm_10, parameter_2, parameter_3

        # pd_op.transpose: (-1x1x144xf32) <- (-1x144x1xf32)
        transpose_6 = paddle._C_ops.transpose(assign_1, [0, 2, 1])
        ...
        # pd_op.assign: (512x1x3xf32) <- (512x1x3xf32)
        assign_9 = parameter_1
        del parameter_1

        # pd_op.unsqueeze: (512x1x1x3xf32) <- (512x1x3xf32, 1xi64)
        unsqueeze_26 = paddle._C_ops.unsqueeze(assign_9, full_int_array_9)
        del assign_9
        ...
        dropout_0, dropout_19 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_25, None, full_6, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_25, exp_0, full_6, matmul_5, share_data__1, share_data__2

        return dropout_0, layer_norm_0
