...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_29 = paddle._C_ops.add(full_4, uniform_2)
        del uniform_2
        ...
        # pd_op.divide: (128x64x28x28xf32) <- (128x64x28x28xf32, xf32)
        divide_2 = paddle._C_ops.divide(add_28, full_4)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_72 = paddle._C_ops.add(full_10, uniform_8)
        del uniform_8
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_8 = paddle._C_ops.divide(add_71, full_10)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_79 = paddle._C_ops.add(full_11, uniform_9)
        del uniform_9
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_9 = paddle._C_ops.divide(add_78, full_11)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_86 = paddle._C_ops.add(full_12, uniform_10)
        del uniform_10
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_10 = paddle._C_ops.divide(add_85, full_12)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_94 = paddle._C_ops.add(full_13, uniform_11)
        del uniform_11
        ...
        divide_11 = paddle._C_ops.divide(add_93, full_13)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_101 = paddle._C_ops.add(full_14, uniform_12)
        del uniform_12
        ...
        # pd_op.divide: (128x256x7x7xf32) <- (128x256x7x7xf32, xf32)
        divide_12 = paddle._C_ops.divide(add_100, full_14)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_108 = paddle._C_ops.add(full_15, uniform_13)
        del uniform_13
        ...
        # pd_op.divide: (128x256x7x7xf32) <- (128x256x7x7xf32, xf32)
        divide_13 = paddle._C_ops.divide(add_107, full_15)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_115 = paddle._C_ops.add(full_16, uniform_14)
        del uniform_14
        ...
        # pd_op.divide: (128x256x7x7xf32) <- (128x256x7x7xf32, xf32)
        divide_14 = paddle._C_ops.divide(add_114, full_16)
