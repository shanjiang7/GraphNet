...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.divide: (128x256x28x28xf32) <- (128x256x28x28xf32, xf32)
        divide_1 = paddle._C_ops.divide(conv2d_10, full_4)
        ...
        split_9 = paddle._C_ops.split(batch_norm__30, full_int_array_3, full_0)
        ...
        divide_2 = paddle._C_ops.divide(conv2d_14, full_5)
        ...
        # pd_op.divide: (128x512x14x14xf32) <- (128x512x14x14xf32, xf32)
        divide_3 = paddle._C_ops.divide(conv2d_17, full_6)
        ...
        # pd_op.divide: (128x512x14x14xf32) <- (128x512x14x14xf32, xf32)
        divide_4 = paddle._C_ops.divide(conv2d_20, full_7)
        ...
        # pd_op.divide: (128x512x14x14xf32) <- (128x512x14x14xf32, xf32)
        divide_5 = paddle._C_ops.divide(conv2d_23, full_8)
        ...
        # pd_op.split: ([128x128x14x14xf32, 128x384x14x14xf32]) <- (128x512x14x14xf32, 2xi64, 1xi32)
        split_21 = paddle._C_ops.split(add_13, full_int_array_3, full_0)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_4 = [256, 768]

        # pd_op.split: ([128x256x7x7xf32, 128x768x7x7xf32]) <- (128x1024x7x7xf32, 2xi64, 1xi32)
        split_48 = paddle._C_ops.split(batch_norm__114, full_int_array_4, full_0)
        ...
        divide_15 = paddle._C_ops.divide(conv2d_54, full_18)
        ...
        del full_2, full_3, full_int_array_2
        ...
        # pd_op.divide: (128x1024x7x7xf32) <- (128x1024x7x7xf32, xf32)
        divide_16 = paddle._C_ops.divide(conv2d_57, full_19)
