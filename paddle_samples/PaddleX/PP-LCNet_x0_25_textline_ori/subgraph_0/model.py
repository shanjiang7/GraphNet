...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (32x8x40x80xf32) <- (32x3x80x160xf32, 8x3x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (32x8x40x80xf32) <- (32x8x40x80xf32, 8x1x3x3xf32)
        ...
        # pd_op.conv2d: (32x8x40x80xf32) <- (32x8x40x80xf32, 8x8x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x8x20x80xf32) <- (32x8x40x80xf32, 8x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 1], [1, 1], "EXPLICIT", 8, [1, 1], "NCHW"
        )
        del parameter_130

        # pd_op.batch_norm_: (32x8x20x80xf32, 8xf32, 8xf32, 8xf32, 8xf32, -1xui8) <- (32x8x20x80xf32, 8xf32, 8xf32, 8xf32, 8xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (32x8x20x80xf32) <- (32x8x20x80xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (32x16x20x80xf32) <- (32x8x20x80xf32, 16x8x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x16x20x80xf32) <- (32x16x20x80xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (32x16x20x80xf32) <- (32x16x20x80xf32, 16x16x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x16x10x80xf32) <- (32x16x20x80xf32, 16x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 1], [1, 1], "EXPLICIT", 16, [1, 1], "NCHW"
        )
        del parameter_110

        # pd_op.batch_norm_: (32x16x10x80xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (32x16x10x80xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (32x16x10x80xf32) <- (32x16x10x80xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (32x32x10x80xf32) <- (32x16x10x80xf32, 32x16x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x32x10x80xf32) <- (32x32x10x80xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (32x32x10x80xf32) <- (32x32x10x80xf32, 32x32x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x32x5x80xf32) <- (32x32x10x80xf32, 32x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        del parameter_90

        # pd_op.batch_norm_: (32x32x5x80xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (32x32x5x80xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (32x32x5x80xf32) <- (32x32x5x80xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (32x64x5x80xf32) <- (32x32x5x80xf32, 64x32x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x64x5x80xf32) <- (32x64x5x80xf32, 64x1x5x5xf32)
        ...
        # pd_op.conv2d: (32x64x5x80xf32) <- (32x64x5x80xf32, 64x64x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (32x64x3x80xf32) <- (32x64x5x80xf32, 64x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del parameter_30

        # pd_op.batch_norm_: (32x64x3x80xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (32x64x3x80xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (32x64x3x80xf32) <- (32x64x3x80xf32)
        ...
        # pd_op.pool2d: (32x64x1x1xf32) <- (32x64x3x80xf32, 2xi64)
        ...
        # pd_op.multiply: (32x64x3x80xf32) <- (32x64x3x80xf32, 32x64x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (32x128x3x80xf32) <- (32x64x3x80xf32, 128x64x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_21

        # pd_op.batch_norm_: (32x128x3x80xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (32x128x3x80xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (32x128x3x80xf32) <- (32x128x3x80xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (32x128x3x80xf32) <- (32x128x3x80xf32, 128x1x5x5xf32)
        ...
        # pd_op.pool2d: (32x128x1x1xf32) <- (32x128x3x80xf32, 2xi64)
        ...
        # pd_op.multiply: (32x128x3x80xf32) <- (32x128x3x80xf32, 32x128x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (32x128x3x80xf32) <- (32x128x3x80xf32, 128x128x1x1xf32)
        ...
        # pd_op.conv2d: (32x1280x1x1xf32) <- (32x128x1x1xf32, 1280x128x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            pool2d_2, parameter_2, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_2

        # pd_op.hardswish: (32x1280x1x1xf32) <- (32x1280x1x1xf32)
        ...
        # pd_op.dropout: (32x1280x1x1xf32, 32x1280x1x1xui8) <- (32x1280x1x1xf32, None, 1xf32)
        ...
        # pd_op.matmul: (32x2xf32) <- (32x1280xf32, 1280x2xf32)
