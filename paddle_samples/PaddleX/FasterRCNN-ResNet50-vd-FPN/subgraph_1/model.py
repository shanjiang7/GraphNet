...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        full_like_0 = paddle._C_ops.full_like(
            data_2, full_1, paddle.int32, paddle.framework._current_expected_place()
        )
        del full_1

        # pd_op.scatter: (-1xi32) <- (-1xi32, 252xi32, 252xi32)
        scatter_1 = paddle._C_ops.scatter(full_with_tensor_0, data_2, full_like_0, True)
        del data_2, full_like_0, full_with_tensor_0
        ...
        full_like_1 = paddle._C_ops.full_like(
            data_1, full_2, paddle.int32, paddle.framework._current_expected_place()
        )

        # pd_op.scatter: (-1xi32) <- (-1xi32, 4xi32, 4xi32)
        scatter_0 = paddle._C_ops.scatter(scatter_1, data_1, full_like_1, True)
        del data_1, full_like_1, scatter_1
        ...
        gather_0 = paddle._C_ops.gather(data_3, data_4, full_3)
        del data_3, data_4, full_3
        ...
        slice_2 = paddle._C_ops.slice(
            data_5, [1], full_int_array_1, full_int_array_4, [1], [1]
        )
