...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.greater_than: (1x-1x21504xb) <- (1x-1x21504xf32, xf32)
        ...
        # pd_op.full_like: (1x-1x21504xf32) <- (1x-1x21504xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_1, full_1, paddle.float32, paddle.framework._current_expected_place()
        )
        del full_1

        # pd_op.where: (1x-1x21504xf32) <- (1x-1x21504xb, 1x-1x21504xf32, 1x-1x21504xf32)
        where_0 = paddle._C_ops.where(greater_than_1, full_like_0, data_1)
        del data_1, full_like_0, greater_than_1
        ...
        # pd_op.gather_nd: (1x-1x21504xf32) <- (1x15x21504xf32, 1x-1x2xi32)
        gather_nd_0 = paddle._C_ops.gather_nd(transpose_0, stack_1)
        del stack_1, transpose_0

        # pd_op.pow: (1x-1x21504xf32) <- (1x-1x21504xf32)
        ...
        # pd_op.split_with_num: ([1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32]) <- (1x-1x5xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(data_5, 5, full_5)
        del data_5

        # builtin.split: (1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32) <- ([1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32, 1x-1x1xf32])
        (
            split_0,
            split_1,
            split_2,
        ...
        reshape_0 = paddle._C_ops.reshape(assign_value__0, full_int_array_1)
        del assign_value__0

        # pd_op.multiply: (1x-1x4xf32) <- (1x1x4xf32, 1x-1x1xf32)
        ...
        # pd_op.reshape: (1x1x4xf32) <- (4xf32, 3xi64)
        reshape_1 = paddle._C_ops.reshape(assign_value__1, full_int_array_1)
        del assign_value__1, full_int_array_1
        ...
        combine_2 = [multiply_1, multiply_2]
        del multiply_1, multiply_2

        # pd_op.stack: (1x-1x4x2xf32) <- ([1x-1x4xf32, 1x-1x4xf32])
        stack_2 = paddle._C_ops.stack(combine_2, -1)
        del combine_2

        # pd_op.sin: (1x-1x1xf32) <- (1x-1x1xf32)
        sin_0 = paddle._C_ops.sin(split_4)

        # pd_op.cos: (1x-1x1xf32) <- (1x-1x1xf32)
        ...
        combine_3 = [cos_0, sin_0]

        # pd_op.concat: (1x-1x2xf32) <- ([1x-1x1xf32, 1x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_3, full_8)
        del combine_3
        ...
        scale_0 = paddle._C_ops.scale(sin_0, full_9, float("0"), True)
        del full_9, sin_0

        # builtin.combine: ([1x-1x1xf32, 1x-1x1xf32]) <- (1x-1x1xf32, 1x-1x1xf32)
        combine_4 = [scale_0, cos_0]
        del cos_0, scale_0

        # pd_op.concat: (1x-1x2xf32) <- ([1x-1x1xf32, 1x-1x1xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_4, full_8)
        del combine_4, full_8

        # builtin.combine: ([1x-1x2xf32, 1x-1x2xf32]) <- (1x-1x2xf32, 1x-1x2xf32)
        combine_5 = [concat_0, concat_1]
        del concat_0, concat_1

        # pd_op.stack: (1x-1x2x2xf32) <- ([1x-1x2xf32, 1x-1x2xf32])
        stack_3 = paddle._C_ops.stack(combine_5, -2)
        del combine_5

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_2 = [-1, 4, 2]

        # pd_op.reshape: (-1x4x2xf32) <- (1x-1x4x2xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(stack_2, full_int_array_2)
        del full_int_array_2, stack_2

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_3 = [-1, 2, 2]

        # pd_op.reshape: (-1x2x2xf32) <- (1x-1x2x2xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(stack_3, full_int_array_3)
        del full_int_array_3, stack_3

        # pd_op.bmm: (-1x4x2xf32) <- (-1x4x2xf32, -1x2x2xf32)
        bmm_0 = paddle._C_ops.bmm(reshape_2, reshape_3)
        del reshape_2, reshape_3

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_4 = [1, -1, 4, 2]

        # pd_op.reshape: (1x-1x4x2xf32) <- (-1x4x2xf32, 4xi64)
        reshape_4 = paddle._C_ops.reshape(bmm_0, full_int_array_4)
        ...
        # pd_op.slice: (1x-1x4xf32) <- (1x-1x4x2xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            reshape_4, [3], full_int_array_5, full_int_array_6, [1], [3]
        )
        ...
        # pd_op.set_value_with_tensor_: (1x-1x4x2xf32) <- (1x-1x4x2xf32, 1x-1x4xf32, 1xi64, 1xi64, 1xi64)
        ...
        slice_1 = paddle._C_ops.slice(
            set_value_with_tensor__0, [3], full_int_array_6, full_int_array_7, [1], [3]
        )
        ...
        del add_1, set_value_with_tensor__0

        # pd_op.unsqueeze: (1x1x21504x2xf32) <- (1x21504x2xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_4, full_int_array_5)
        del data_4, full_int_array_5

        # pd_op.split_with_num: ([1x-1x1x2xf32, 1x-1x1x2xf32, 1x-1x1x2xf32, 1x-1x1x2xf32]) <- (1x-1x4x2xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(
            set_value_with_tensor__1, 4, full_5
        )
        del full_5

        # builtin.split: (1x-1x1x2xf32, 1x-1x1x2xf32, 1x-1x1x2xf32, 1x-1x1x2xf32) <- ([1x-1x1x2xf32, 1x-1x1x2xf32, 1x-1x1x2xf32, 1x-1x1x2xf32])
        (
            split_5,
            split_6,
            split_7,
        ...
        # pd_op.subtract: (1x-1x21504x2xf32) <- (1x1x21504x2xf32, 1x-1x1x2xf32)
        subtract_2 = paddle._C_ops.subtract(unsqueeze_1, split_5)
        del split_5, unsqueeze_1

        # pd_op.multiply: (1x-1x1x2xf32) <- (1x-1x1x2xf32, 1x-1x1x2xf32)
        multiply_3 = paddle._C_ops.multiply(subtract_0, subtract_0)

        # pd_op.sum: (1x-1x1xf32) <- (1x-1x1x2xf32, 1xi64)
        ...
        # pd_op.multiply: (1x-1x21504x2xf32) <- (1x-1x21504x2xf32, 1x-1x1x2xf32)
        multiply_5 = paddle._C_ops.multiply(subtract_2, subtract_0)
        del subtract_0

        # pd_op.sum: (1x-1x21504xf32) <- (1x-1x21504x2xf32, 1xi64)
        ...
        # pd_op.greater_equal: (1x-1x21504xb) <- (1x-1x21504xf32, xf32)
        greater_equal_0 = paddle._C_ops.greater_equal(sum_2, full_10)

        # pd_op.less_equal: (1x-1x21504xb) <- (1x-1x21504xf32, 1x-1x1xf32)
        less_equal_0 = paddle._C_ops.less_equal(sum_2, sum_0)
        del sum_0, sum_2

        # pd_op.bitwise_and: (1x-1x21504xb) <- (1x-1x21504xb, 1x-1x21504xb)
        bitwise_and_0 = paddle._C_ops.bitwise_and(greater_equal_0, less_equal_0)
        del greater_equal_0, less_equal_0

        # pd_op.greater_equal: (1x-1x21504xb) <- (1x-1x21504xf32, xf32)
        greater_equal_1 = paddle._C_ops.greater_equal(sum_3, full_10)
        del full_10
        ...
        # pd_op.cast: (1x-1x21504xf32) <- (1x-1x21504xb)
        ...
        # pd_op.shape64: (3xi64) <- (1x-1x21504xf32)
        shape64_0 = paddle._C_ops.shape64(multiply_7)
        ...
        # pd_op.topk: (1x-1x13xf32, 1x-1x13xi64) <- (1x-1x21504xf32, 1xi32)
        topk_0, topk_1 = (lambda x, f: f(x))(
            paddle._C_ops.topk(multiply_7, full_11, -1, True, True),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del full_11, multiply_7
        ...
        # pd_op.one_hot: (1x-1x13x21504xf32) <- (1x-1x13xi64, 1xi32)
        ...
        # pd_op.sum: (1x-1x21504xf32) <- (1x-1x13x21504xf32, 1xi64)
        sum_4 = paddle._C_ops.sum(one_hot_0, full_int_array_8, None, False)
        del one_hot_0

        # pd_op.multiply: (1x-1x21504xf32) <- (1x-1x21504xf32, 1x-1x1xf32)
        multiply_8 = paddle._C_ops.multiply(sum_4, data_6)
        del sum_4
        ...
        # pd_op.multiply: (1x-1x21504xf32) <- (1x-1x21504xf32, 1x-1x1xf32)
        multiply_10 = paddle._C_ops.multiply(multiply_9, data_6)
        del data_6, multiply_9

        # pd_op.sum: (1x21504xf32) <- (1x-1x21504xf32, 1xi64)
        sum_5 = paddle._C_ops.sum(multiply_10, full_int_array_8, None, False)
        ...
        max_0 = paddle._C_ops.max(sum_5, full_int_array_9, False)
