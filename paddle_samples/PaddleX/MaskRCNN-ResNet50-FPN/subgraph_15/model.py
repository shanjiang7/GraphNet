...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.full_like: (244xi32) <- (244xi32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_1, full_1, paddle.int32, paddle.framework._current_expected_place()
        )
        del full_1

        # pd_op.scatter: (220968xi32) <- (220968xi32, 244xi32, 244xi32)
        ...
        # pd_op.gather: (220968x4xf32) <- (1x4xf32, 220968xi64, 1xi32)
        ...
        # pd_op.scale: (220968xf32) <- (220968xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_0, full_4, float("0"), True)

        # pd_op.add: (220968xf32) <- (220968xf32, 220968xf32)
        ...
        # pd_op.divide: (220968xf32) <- (220968xf32, 220968xf32)
        ...
        # pd_op.log: (220968xf32) <- (220968xf32)
        ...
        # builtin.combine: ([220968xf32, 220968xf32, 220968xf32, 220968xf32]) <- (220968xf32, 220968xf32, 220968xf32, 220968xf32)
        combine_0 = [divide_0, divide_1, scale_6, scale_7]
        del divide_0, divide_1, scale_6, scale_7

        # pd_op.stack: (220968x4xf32) <- ([220968xf32, 220968xf32, 220968xf32, 220968xf32])
