...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.strided_slice: (1000x1xf32) <- (1000x4xf32, 1xi64, 1xi64, 1xi64)
        ...
        # pd_op.clip: (1000x1xf32) <- (1000x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (1000x1xf32) <- (1000x1xf32, 1000x1xf32)
        ...
        # pd_op.exp: (1000x1xf32) <- (1000x1xf32)
        ...
        # pd_op.expand: (1000x4x4xf32) <- (1000x1x4xf32, 3xi64)
