...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        gather_0 = paddle._C_ops.gather(data_4, data_2, full_1)
        del data_2, data_4, full_1
        ...
        equal_2 = paddle._C_ops.equal(data_3, full_2)
        del full_2
        ...
        # pd_op.equal: (-1xb) <- (-1xi32, xi32)
        equal_3 = paddle._C_ops.equal(data_3, full_5)
        del data_3, full_5
        ...
        arange_0 = paddle.arange(full_7, data_1, full_8, dtype="int64")
        del data_1, full_7, full_8
