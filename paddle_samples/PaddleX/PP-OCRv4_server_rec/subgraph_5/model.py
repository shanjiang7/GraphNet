...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        full_int_array_7 = [0, -1, 120]

        # pd_op.reshape: (4x40x120xf32) <- (4x40x8x15xf32, 3xi64)
        reshape_1 = paddle._C_ops.reshape(transpose_3, full_int_array_7)
        ...
        dropout_2, dropout_3 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_2, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_2
        ...
        dropout_4, dropout_5 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                swish_2, None, full_3, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del swish_2
        ...
        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_8 = [0, -1, 3, 8, 15]

        # pd_op.reshape: (4x40x3x8x15xf32) <- (4x40x360xf32, 5xi64)
        reshape_2 = paddle._C_ops.reshape(add_7, full_int_array_8)
        ...
        slice_3 = paddle._C_ops.slice(
            transpose_4, [0], full_int_array_9, full_int_array_10, [1], [0]
        )
        ...
        # pd_op.scale: (4x8x40x15xf32) <- (4x8x40x15xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(slice_3, full_5, float("0"), True)
        del full_5, slice_3
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_15 = [0, -1, 120]

        # pd_op.reshape: (4x40x120xf32) <- (4x40x8x15xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_6, full_int_array_15)
        ...
        dropout_10, dropout_11 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_8, None, full_7, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_8
        ...
        dropout_12, dropout_13 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                swish_3, None, full_8, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del swish_3
        ...
        dropout_14, dropout_15 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_11, None, full_9, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_11
        ...
        full_int_array_16 = [0, 1, 40, 120]

        # pd_op.reshape: (4x1x40x120xf32) <- (4x40x120xf32, 4xi64)
        reshape_4 = paddle._C_ops.reshape(layer_norm_12, full_int_array_16)
        ...
        squeeze_0 = paddle._C_ops.squeeze(swish_6, full_int_array_17)
