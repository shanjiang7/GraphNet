...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        slice_4 = paddle._C_ops.slice(data_3, [0], full_int_array_8, stack_1, [-1], [])
        del data_3, full_int_array_8, stack_1

        # pd_op.add: (-1x-1x384xf32) <- (-1x-1x384xf32, -1x1x384xf32)
        add_0 = paddle._C_ops.add(transpose_1, slice_4)
        ...
        del full_int_array_10, full_int_array_9, shape64_1
        ...
        slice_6 = paddle._C_ops.slice(
            shape64_2, [0], full_int_array_11, full_int_array_12, [1], [0]
        )
        del full_int_array_11, full_int_array_12, shape64_2

        # builtin.combine: ([xi64, xi64]) <- (xi64, xi64)
        combine_2 = [slice_6, slice_6]
        ...
        unsqueeze_0 = paddle._C_ops.unsqueeze(add_1, full_int_array_13)
        del add_1, full_int_array_13
        ...
        combine_4 = [full_5, slice_6, full_6, full_7, full_8]
        ...
        slice_8 = paddle._C_ops.slice(
            transpose_3, [0], full_int_array_16, full_int_array_17, [1], [0]
        )
        del full_int_array_16, full_int_array_17
        ...
        transpose_4 = paddle._C_ops.transpose(slice_8, [0, 1, 3, 2])
        del slice_8

        # pd_op.matmul: (-1x12x-1x-1xf32) <- (-1x12x-1x32xf32, -1x12x32x-1xf32)
        matmul_3 = paddle._C_ops.matmul(slice_7, transpose_4, False, False)
        ...
        matmul_4 = paddle._C_ops.matmul(softmax_0, slice_9, False, False)
        ...
        combine_5 = [full_10, slice_6, full_11]
        del full_10, full_11, slice_6
        ...
        slice_10 = paddle._C_ops.slice(
            shape64_3, [0], full_int_array_20, full_int_array_21, [1], [0]
        )
        del full_int_array_20, full_int_array_21, shape64_3
        ...
        slice_11 = paddle._C_ops.slice(
            shape64_4, [0], full_int_array_22, full_int_array_23, [1], [0]
        )
        del full_int_array_22, full_int_array_23, shape64_4

        # pd_op.shape64: (3xi64) <- (-1x40x384xf32)
        shape64_5 = paddle._C_ops.shape64(matmul_1)
        ...
        slice_12 = paddle._C_ops.slice(
            shape64_5, [0], full_int_array_24, full_int_array_25, [1], [0]
        )
        del full_int_array_24, full_int_array_25, shape64_5
        ...
        combine_6 = [full_13, slice_11, full_14, full_15]
        ...
        full_int_array_26 = [0, 40, 2, 12, 32]

        # pd_op.reshape: (-1x40x2x12x32xf32) <- (-1x40x768xf32, 5xi64)
        reshape_3 = paddle._C_ops.reshape(add_7, full_int_array_26)
        ...
        matmul_9 = paddle._C_ops.matmul(softmax_1, slice_14, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_7 = [full_17, slice_11, full_18]
        del full_17, full_18, slice_11
        ...
        slice_15 = paddle._C_ops.slice(
            shape64_6, [0], full_int_array_31, full_int_array_32, [1], [0]
        )
        del full_int_array_31, full_int_array_32, shape64_6
        ...
        slice_16 = paddle._C_ops.slice(
            shape64_7, [0], full_int_array_33, full_int_array_34, [1], [0]
        )
        del full_int_array_33, full_int_array_34, shape64_7
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_8 = [full_23, slice_16, full_24, full_25, full_26]
        ...
        del full_int_array_39, full_int_array_40

        # pd_op.transpose: (-1x12x32x-1xf32) <- (-1x12x-1x32xf32)
        transpose_11 = paddle._C_ops.transpose(slice_18, [0, 1, 3, 2])
        del slice_18

        # pd_op.matmul: (-1x12x-1x-1xf32) <- (-1x12x-1x32xf32, -1x12x32x-1xf32)
        matmul_14 = paddle._C_ops.matmul(slice_17, transpose_11, False, False)
        ...
        # pd_op.matmul: (-1x12x-1x32xf32) <- (-1x12x-1x-1xf32, -1x12x-1x32xf32)
        matmul_15 = paddle._C_ops.matmul(softmax_2, slice_19, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_9 = [full_28, slice_16, full_29]
        del full_28, full_29, slice_16
        ...
        slice_20 = paddle._C_ops.slice(
            shape64_8, [0], full_int_array_41, full_int_array_42, [1], [0]
        )
        del full_int_array_41, full_int_array_42, shape64_8
        ...
        slice_21 = paddle._C_ops.slice(
            shape64_9, [0], full_int_array_43, full_int_array_44, [1], [0]
        )
        del full_int_array_43, full_int_array_44, shape64_9
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [full_31, slice_21, full_32, full_33]
        ...
        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_45 = [0, 40, 2, 12, 32]

        # pd_op.reshape: (-1x40x2x12x32xf32) <- (-1x40x768xf32, 5xi64)
        reshape_8 = paddle._C_ops.reshape(add_18, full_int_array_45)
        ...
        slice_22 = paddle._C_ops.slice(
            transpose_14, [0], full_int_array_46, full_int_array_47, [1], [0]
        )
        ...
        slice_23 = paddle._C_ops.slice(
            transpose_14, [0], full_int_array_48, full_int_array_49, [1], [0]
        )
        del full_int_array_48, full_int_array_49

        # pd_op.transpose: (-1x12x32x40xf32) <- (-1x12x40x32xf32)
        transpose_15 = paddle._C_ops.transpose(slice_22, [0, 1, 3, 2])
        del slice_22
        ...
        # pd_op.matmul: (-1x12x-1x32xf32) <- (-1x12x-1x40xf32, -1x12x40x32xf32)
        matmul_20 = paddle._C_ops.matmul(softmax_3, slice_23, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_11 = [full_35, slice_21, full_36]
        del full_35, full_36, slice_21
        ...
        slice_24 = paddle._C_ops.slice(
            shape64_10, [0], full_int_array_50, full_int_array_51, [1], [0]
        )
        del full_int_array_50, full_int_array_51, shape64_10
        ...
        slice_25 = paddle._C_ops.slice(
            shape64_11, [0], full_int_array_52, full_int_array_53, [1], [0]
        )
        del full_int_array_52, full_int_array_53, shape64_11
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_12 = [full_41, slice_25, full_42, full_43, full_44]
        ...
        slice_26 = paddle._C_ops.slice(
            transpose_17, [0], full_int_array_54, full_int_array_55, [1], [0]
        )
        ...
        slice_27 = paddle._C_ops.slice(
            transpose_17, [0], full_int_array_56, full_int_array_57, [1], [0]
        )
        del full_int_array_56, full_int_array_57
        ...
        slice_28 = paddle._C_ops.slice(
            transpose_17, [0], full_int_array_58, full_int_array_59, [1], [0]
        )
        del full_int_array_58, full_int_array_59

        # pd_op.transpose: (-1x12x32x-1xf32) <- (-1x12x-1x32xf32)
        transpose_18 = paddle._C_ops.transpose(slice_27, [0, 1, 3, 2])
        del slice_27

        # pd_op.matmul: (-1x12x-1x-1xf32) <- (-1x12x-1x32xf32, -1x12x32x-1xf32)
        matmul_25 = paddle._C_ops.matmul(slice_26, transpose_18, False, False)
        ...
        # pd_op.matmul: (-1x12x-1x32xf32) <- (-1x12x-1x-1xf32, -1x12x-1x32xf32)
        matmul_26 = paddle._C_ops.matmul(softmax_4, slice_28, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_13 = [full_46, slice_25, full_47]
        del full_46, full_47, slice_25
        ...
        slice_29 = paddle._C_ops.slice(
            shape64_12, [0], full_int_array_60, full_int_array_61, [1], [0]
        )
        del full_int_array_60, full_int_array_61, shape64_12
        ...
        slice_30 = paddle._C_ops.slice(
            shape64_13, [0], full_int_array_62, full_int_array_63, [1], [0]
        )
        del full_int_array_62, full_int_array_63, shape64_13
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_14 = [full_49, slice_30, full_50, full_51]
        ...
        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_64 = [0, 40, 2, 12, 32]

        # pd_op.reshape: (-1x40x2x12x32xf32) <- (-1x40x768xf32, 5xi64)
        reshape_13 = paddle._C_ops.reshape(add_29, full_int_array_64)
        ...
        slice_31 = paddle._C_ops.slice(
            transpose_21, [0], full_int_array_65, full_int_array_66, [1], [0]
        )
        ...
        slice_32 = paddle._C_ops.slice(
            transpose_21, [0], full_int_array_67, full_int_array_68, [1], [0]
        )
        del full_int_array_67, full_int_array_68

        # pd_op.transpose: (-1x12x32x40xf32) <- (-1x12x40x32xf32)
        transpose_22 = paddle._C_ops.transpose(slice_31, [0, 1, 3, 2])
        del slice_31
        ...
        # pd_op.matmul: (-1x12x-1x32xf32) <- (-1x12x-1x40xf32, -1x12x40x32xf32)
        matmul_31 = paddle._C_ops.matmul(softmax_5, slice_32, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_15 = [full_53, slice_30, full_54]
        del full_53, full_54, slice_30
        ...
        slice_33 = paddle._C_ops.slice(
            shape64_14, [0], full_int_array_69, full_int_array_70, [1], [0]
        )
        del full_int_array_69, full_int_array_70, shape64_14
        ...
        slice_34 = paddle._C_ops.slice(
            shape64_15, [0], full_int_array_71, full_int_array_72, [1], [0]
        )
        del full_int_array_71, full_int_array_72, shape64_15
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_16 = [full_59, slice_34, full_60, full_61, full_62]
        ...
        slice_35 = paddle._C_ops.slice(
            transpose_24, [0], full_int_array_73, full_int_array_74, [1], [0]
        )
        del full_int_array_73, full_int_array_74
        ...
        slice_36 = paddle._C_ops.slice(
            transpose_24, [0], full_int_array_75, full_int_array_76, [1], [0]
        )
        ...
        slice_37 = paddle._C_ops.slice(
            transpose_24, [0], full_int_array_77, full_int_array_78, [1], [0]
        )
        del full_int_array_77, full_int_array_78

        # pd_op.transpose: (-1x12x32x-1xf32) <- (-1x12x-1x32xf32)
        transpose_25 = paddle._C_ops.transpose(slice_36, [0, 1, 3, 2])
        del slice_36

        # pd_op.matmul: (-1x12x-1x-1xf32) <- (-1x12x-1x32xf32, -1x12x32x-1xf32)
        matmul_36 = paddle._C_ops.matmul(slice_35, transpose_25, False, False)
        ...
        # pd_op.matmul: (-1x12x-1x32xf32) <- (-1x12x-1x-1xf32, -1x12x-1x32xf32)
        matmul_37 = paddle._C_ops.matmul(softmax_6, slice_37, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_17 = [full_64, slice_34, full_65]
        del full_64, full_65, slice_34
        ...
        slice_38 = paddle._C_ops.slice(
            shape64_16, [0], full_int_array_79, full_int_array_80, [1], [0]
        )
        del full_int_array_79, full_int_array_80, shape64_16
        ...
        slice_39 = paddle._C_ops.slice(
            shape64_17, [0], full_int_array_81, full_int_array_82, [1], [0]
        )
        del full_int_array_81, full_int_array_82, shape64_17
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_18 = [full_67, slice_39, full_68, full_69]
        ...
        # pd_op.full_int_array: (5xi64) <- ()
        full_int_array_83 = [0, 40, 2, 12, 32]

        # pd_op.reshape: (-1x40x2x12x32xf32) <- (-1x40x768xf32, 5xi64)
        reshape_18 = paddle._C_ops.reshape(add_40, full_int_array_83)
        ...
        slice_40 = paddle._C_ops.slice(
            transpose_28, [0], full_int_array_84, full_int_array_85, [1], [0]
        )
        ...
        slice_41 = paddle._C_ops.slice(
            transpose_28, [0], full_int_array_86, full_int_array_87, [1], [0]
        )
        ...
        # pd_op.matmul: (-1x12x-1x32xf32) <- (-1x12x-1x40xf32, -1x12x40x32xf32)
        matmul_42 = paddle._C_ops.matmul(softmax_7, slice_41, False, False)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_19 = [full_71, slice_39, full_72]
        del full_71, full_72, slice_39
