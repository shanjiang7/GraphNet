...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (128x32x112x112xf32) <- (128x8x112x112xf32, 32x8x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x32x56x56xf32) <- (128x32x112x112xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x16x56x56xf32) <- (128x32x56x56xf32, 16x32x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_239, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_239

        # pd_op.batch_norm_: (128x16x56x56xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (128x16x56x56xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__36,
            batch_norm__37,
            batch_norm__38,
        ...
        # pd_op.conv2d: (128x40x56x56xf32) <- (128x16x56x56xf32, 40x16x1x1xf32)
        ...
        # pd_op.relu: (128x40x56x56xf32) <- (128x40x56x56xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__42)
        del batch_norm__42

        # pd_op.depthwise_conv2d: (128x40x56x56xf32) <- (128x40x56x56xf32, 40x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x16x56x56xf32) <- (128x40x56x56xf32, 16x40x1x1xf32)
        ...
        # pd_op.add: (128x16x56x56xf32) <- (128x16x56x56xf32, 128x16x56x56xf32)
        ...
        # pd_op.depthwise_conv2d: (128x40x28x28xf32) <- (128x40x56x56xf32, 40x1x5x5xf32)
        ...
        # pd_op.conv2d: (128x24x28x28xf32) <- (128x40x28x28xf32, 24x40x1x1xf32)
        ...
        # pd_op.conv2d: (128x64x28x28xf32) <- (128x24x28x28xf32, 64x24x1x1xf32)
        ...
        # pd_op.pool2d: (128x64x1x1xf32) <- (128x64x28x28xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x16x1x1xf32) <- (128x64x1x1xf32, 16x64x1x1xf32)
        ...
        # pd_op.add: (128x16x1x1xf32) <- (128x16x1x1xf32, 1x16x1x1xf32)
        add_5 = paddle._C_ops.add(conv2d_12, reshape_2)

        # pd_op.relu: (128x16x1x1xf32) <- (128x16x1x1xf32)
        relu_11 = paddle._C_ops.relu(add_5)
        del add_5

        # pd_op.conv2d: (128x64x1x1xf32) <- (128x16x1x1xf32, 64x16x1x1xf32)
        ...
        # pd_op.hardsigmoid: (128x64x1x1xf32) <- (128x64x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(add_6, float("0.2"), float("0.5"))
        del add_6

        # pd_op.multiply: (128x64x28x28xf32) <- (128x64x28x28xf32, 128x64x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(relu_10, hardsigmoid_1)

        # pd_op.conv2d: (128x24x28x28xf32) <- (128x64x28x28xf32, 24x64x1x1xf32)
        ...
        # pd_op.add: (128x24x28x28xf32) <- (128x24x28x28xf32, 128x24x28x28xf32)
        ...
        # pd_op.conv2d: (128x120x28x28xf32) <- (128x24x28x28xf32, 120x24x1x1xf32)
        ...
        # pd_op.hardswish: (128x120x28x28xf32) <- (128x120x28x28xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__114)

        # pd_op.depthwise_conv2d: (128x120x14x14xf32) <- (128x120x28x28xf32, 120x1x3x3xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_1, parameter_157, [2, 2], [1, 1], "EXPLICIT", 120, [1, 1], "NCHW"
        )
        del parameter_157

        # pd_op.batch_norm_: (128x120x14x14xf32, 120xf32, 120xf32, 120xf32, 120xf32, -1xui8) <- (128x120x14x14xf32, 120xf32, 120xf32, 120xf32, 120xf32)
        (
            batch_norm__120,
            batch_norm__121,
            batch_norm__122,
        ...
        # pd_op.hardswish: (128x120x14x14xf32) <- (128x120x14x14xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__120)

        # pd_op.conv2d: (128x40x14x14xf32) <- (128x120x14x14xf32, 40x120x1x1xf32)
        ...
        # pd_op.conv2d: (128x104x14x14xf32) <- (128x40x14x14xf32, 104x40x1x1xf32)
        ...
        # pd_op.hardswish: (128x104x14x14xf32) <- (128x104x14x14xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__132)

        # pd_op.depthwise_conv2d: (128x104x14x14xf32) <- (128x104x14x14xf32, 104x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x40x14x14xf32) <- (128x104x14x14xf32, 40x104x1x1xf32)
        ...
        # pd_op.conv2d: (128x96x14x14xf32) <- (128x40x14x14xf32, 96x40x1x1xf32)
        ...
        # pd_op.hardswish: (128x96x14x14xf32) <- (128x96x14x14xf32)
        ...
        # pd_op.conv2d: (128x40x14x14xf32) <- (128x96x14x14xf32, 40x96x1x1xf32)
        ...
        # pd_op.conv2d: (128x240x14x14xf32) <- (128x40x14x14xf32, 240x40x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x240x14x14xf32) <- (128x240x14x14xf32, 240x1x3x3xf32)
        ...
        # pd_op.pool2d: (128x240x1x1xf32) <- (128x240x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x60x1x1xf32) <- (128x240x1x1xf32, 60x240x1x1xf32)
        ...
        # pd_op.add: (128x60x1x1xf32) <- (128x60x1x1xf32, 1x60x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_28, reshape_6)

        # pd_op.relu: (128x60x1x1xf32) <- (128x60x1x1xf32)
        relu_15 = paddle._C_ops.relu(add_14)
        del add_14

        # pd_op.conv2d: (128x240x1x1xf32) <- (128x60x1x1xf32, 240x60x1x1xf32)
        ...
        # pd_op.hardsigmoid: (128x240x1x1xf32) <- (128x240x1x1xf32)
        hardsigmoid_3 = paddle._C_ops.hardsigmoid(add_15, float("0.2"), float("0.5"))
        del add_15

        # pd_op.multiply: (128x240x14x14xf32) <- (128x240x14x14xf32, 128x240x1x1xf32)
        multiply_3 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_3)

        # pd_op.conv2d: (128x56x14x14xf32) <- (128x240x14x14xf32, 56x240x1x1xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            multiply_3, parameter_88, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_88

        # pd_op.batch_norm_: (128x56x14x14xf32, 56xf32, 56xf32, 56xf32, 56xf32, -1xui8) <- (128x56x14x14xf32, 56xf32, 56xf32, 56xf32, 56xf32)
        (
            batch_norm__198,
            batch_norm__199,
            batch_norm__200,
        ...
        # pd_op.conv2d: (128x336x14x14xf32) <- (128x56x14x14xf32, 336x56x1x1xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            batch_norm__198, parameter_83, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_83

        # pd_op.batch_norm_: (128x336x14x14xf32, 336xf32, 336xf32, 336xf32, 336xf32, -1xui8) <- (128x336x14x14xf32, 336xf32, 336xf32, 336xf32, 336xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (128x336x14x14xf32) <- (128x336x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__204)

        # pd_op.depthwise_conv2d: (128x336x14x14xf32) <- (128x336x14x14xf32, 336x1x3x3xf32)
        ...
        # pd_op.pool2d: (128x336x1x1xf32) <- (128x336x14x14xf32, 2xi64)
        ...
        # pd_op.multiply: (128x336x14x14xf32) <- (128x336x14x14xf32, 128x336x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_4)

        # pd_op.conv2d: (128x56x14x14xf32) <- (128x336x14x14xf32, 56x336x1x1xf32)
        ...
        # pd_op.add: (128x56x14x14xf32) <- (128x56x14x14xf32, 128x56x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (128x336x7x7xf32) <- (128x336x14x14xf32, 336x1x5x5xf32)
        ...
        # pd_op.conv2d: (128x80x7x7xf32) <- (128x336x7x7xf32, 80x336x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            multiply_5, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_50

        # pd_op.batch_norm_: (128x80x7x7xf32, 80xf32, 80xf32, 80xf32, 80xf32, -1xui8) <- (128x80x7x7xf32, 80xf32, 80xf32, 80xf32, 80xf32)
        (
            batch_norm__234,
            batch_norm__235,
            batch_norm__236,
        ...
        # pd_op.conv2d: (128x480x7x7xf32) <- (128x80x7x7xf32, 480x80x1x1xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            batch_norm__234, parameter_45, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_45

        # pd_op.batch_norm_: (128x480x7x7xf32, 480xf32, 480xf32, 480xf32, 480xf32, -1xui8) <- (128x480x7x7xf32, 480xf32, 480xf32, 480xf32, 480xf32)
        (
            batch_norm__240,
            batch_norm__241,
            batch_norm__242,
        ...
        # pd_op.hardswish: (128x480x7x7xf32) <- (128x480x7x7xf32)
        hardswish_15 = paddle._C_ops.hardswish(batch_norm__240)

        # pd_op.depthwise_conv2d: (128x480x7x7xf32) <- (128x480x7x7xf32, 480x1x5x5xf32)
        ...
        # pd_op.pool2d: (128x480x1x1xf32) <- (128x480x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (128x480x7x7xf32) <- (128x480x7x7xf32, 128x480x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(hardswish_16, hardsigmoid_6)

        # pd_op.conv2d: (128x80x7x7xf32) <- (128x480x7x7xf32, 80x480x1x1xf32)
        ...
        # pd_op.add: (128x80x7x7xf32) <- (128x80x7x7xf32, 128x80x7x7xf32)
        ...
        # pd_op.conv2d: (128x1280x1x1xf32) <- (128x480x1x1xf32, 1280x480x1x1xf32)
