...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        equal_0 = paddle._C_ops.equal(multiply_0, full_0)
        del multiply_0
        ...
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_2, full_int_array_3)
        del data_2
        ...
        clip_0 = paddle._C_ops.clip(subtract_4, full_1, full_2)
        del full_2, subtract_4
        ...
        greater_than_0 = paddle._C_ops.greater_than(prod_0, full_3)
        del full_3

        # pd_op.unsqueeze: (-1x1xf32) <- (-1xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(multiply_1, full_int_array_3)
        del full_int_array_3, multiply_1

        # pd_op.add: (-1x-1xf32) <- (-1x1xf32, -1xf32)
        add_0 = paddle._C_ops.add(unsqueeze_1, multiply_2)
        del multiply_2, unsqueeze_1
        ...
        full_like_0 = paddle._C_ops.full_like(
            prod_0, full_1, paddle.float32, paddle.framework._current_expected_place()
        )
        del full_1, prod_0
