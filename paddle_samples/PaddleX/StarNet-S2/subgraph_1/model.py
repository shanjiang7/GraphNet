...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        shape64_0 = paddle._C_ops.shape64(add_14)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_30 = paddle._C_ops.add(full_5, uniform_2)
        del uniform_2
        ...
        divide_2 = paddle._C_ops.divide(add_29, full_5)
        ...
        shape64_8 = paddle._C_ops.shape64(add_72)
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_73 = paddle._C_ops.add(full_11, uniform_8)
        del uniform_8
        ...
        divide_8 = paddle._C_ops.divide(add_72, full_11)
        ...
        # pd_op.shape64: (4xi64) <- (-1x256x7x7xf32)
        shape64_9 = paddle._C_ops.shape64(add_79)

        # pd_op.slice: (xi64) <- (4xi64, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            shape64_9, [0], full_int_array_1, full_int_array_2, [1], [0]
        )
        del full_int_array_1, full_int_array_2, shape64_9
        ...
        # pd_op.add: (-1x1x1x1xf32) <- (xf32, -1x1x1x1xf32)
        add_80 = paddle._C_ops.add(full_12, uniform_9)
        del uniform_9
        ...
        # pd_op.divide: (-1x256x7x7xf32) <- (-1x256x7x7xf32, xf32)
        divide_9 = paddle._C_ops.divide(add_79, full_12)
