...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_15 = paddle._C_ops.add(full_0, uniform_0)
        del uniform_0
        ...
        divide_0 = paddle._C_ops.divide(add_14, full_0)
        ...
        add_16 = paddle._C_ops.add(batch_norm__24, multiply_2)

        # pd_op.depthwise_conv2d: (128x64x28x28xf32) <- (128x64x28x28xf32, 64x1x7x7xf32)
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            add_16, parameter_179, [1, 1], [3, 3], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del parameter_179
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_22 = paddle._C_ops.add(full_3, uniform_1)
        del uniform_1
        ...
        # pd_op.divide: (128x64x28x28xf32) <- (128x64x28x28xf32, xf32)
        divide_1 = paddle._C_ops.divide(add_21, full_3)

        # pd_op.multiply: (128x64x28x28xf32) <- (128x64x28x28xf32, 128x1x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(divide_1, floor_1)

        # pd_op.add: (128x64x28x28xf32) <- (128x64x28x28xf32, 128x64x28x28xf32)
        add_23 = paddle._C_ops.add(add_16, multiply_4)

        # pd_op.conv2d: (128x128x14x14xf32) <- (128x64x28x28xf32, 128x64x3x3xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            add_23, parameter_161, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_161
        ...
        add_24 = paddle._C_ops.add(conv2d_12, reshape_18)
        ...
        # pd_op.add: (128x128x14x14xf32) <- (128x128x14x14xf32, 1x128x1x1xf32)
        add_25 = paddle._C_ops.add(depthwise_conv2d_6, reshape_19)
        ...
        relu6_4 = paddle._C_ops.relu6(add_26)
        del add_26

        # pd_op.multiply: (128x512x14x14xf32) <- (128x512x14x14xf32, 128x512x14x14xf32)
        multiply_5 = paddle._C_ops.multiply(relu6_4, add_27)
        ...
        # pd_op.add: (128x128x14x14xf32) <- (128x128x14x14xf32, 1x128x1x1xf32)
        add_28 = paddle._C_ops.add(conv2d_15, reshape_22)
        ...
        # pd_op.add: (128x128x14x14xf32) <- (128x128x14x14xf32, 1x128x1x1xf32)
        add_29 = paddle._C_ops.add(depthwise_conv2d_7, reshape_23)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_30 = paddle._C_ops.add(full_4, uniform_2)
        del uniform_2

        # pd_op.floor: (128x1x1x1xf32) <- (128x1x1x1xf32)
        floor_2 = paddle._C_ops.floor(add_30)
        del add_30

        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_2 = paddle._C_ops.divide(add_29, full_4)
        ...
        add_31 = paddle._C_ops.add(batch_norm__54, multiply_6)

        # pd_op.depthwise_conv2d: (128x128x14x14xf32) <- (128x128x14x14xf32, 128x1x7x7xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            add_31, parameter_137, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_137
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_37 = paddle._C_ops.add(full_5, uniform_3)
        del uniform_3
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_3 = paddle._C_ops.divide(add_36, full_5)

        # pd_op.multiply: (128x128x14x14xf32) <- (128x128x14x14xf32, 128x1x1x1xf32)
        multiply_8 = paddle._C_ops.multiply(divide_3, floor_3)

        # pd_op.add: (128x128x14x14xf32) <- (128x128x14x14xf32, 128x128x14x14xf32)
        add_38 = paddle._C_ops.add(add_31, multiply_8)

        # pd_op.depthwise_conv2d: (128x128x14x14xf32) <- (128x128x14x14xf32, 128x1x7x7xf32)
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            add_38, parameter_119, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_119
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_44 = paddle._C_ops.add(full_6, uniform_4)
        del uniform_4
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_4 = paddle._C_ops.divide(add_43, full_6)
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            add_45, parameter_101, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_101
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_51 = paddle._C_ops.add(full_7, uniform_5)
        del uniform_5
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_5 = paddle._C_ops.divide(add_50, full_7)
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            add_52, parameter_83, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_83
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_58 = paddle._C_ops.add(full_8, uniform_6)
        del uniform_6
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_6 = paddle._C_ops.divide(add_57, full_8)
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            add_59, parameter_65, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_65
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_65 = paddle._C_ops.add(full_9, uniform_7)
        del uniform_7
        ...
        # pd_op.divide: (128x128x14x14xf32) <- (128x128x14x14xf32, xf32)
        divide_7 = paddle._C_ops.divide(add_64, full_9)
        ...
        conv2d_31 = paddle._C_ops.conv2d(
            add_66, parameter_47, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_47
        ...
        add_67 = paddle._C_ops.add(conv2d_31, reshape_49)
        ...
        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 1x256x1x1xf32)
        add_68 = paddle._C_ops.add(depthwise_conv2d_18, reshape_50)
        ...
        relu6_10 = paddle._C_ops.relu6(add_69)
        del add_69

        # pd_op.multiply: (128x1024x7x7xf32) <- (128x1024x7x7xf32, 128x1024x7x7xf32)
        multiply_17 = paddle._C_ops.multiply(relu6_10, add_70)
        ...
        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 1x256x1x1xf32)
        add_71 = paddle._C_ops.add(conv2d_34, reshape_53)
        ...
        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 1x256x1x1xf32)
        add_72 = paddle._C_ops.add(depthwise_conv2d_19, reshape_54)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_73 = paddle._C_ops.add(full_10, uniform_8)
        del uniform_8

        # pd_op.floor: (128x1x1x1xf32) <- (128x1x1x1xf32)
        floor_8 = paddle._C_ops.floor(add_73)
        del add_73

        # pd_op.divide: (128x256x7x7xf32) <- (128x256x7x7xf32, xf32)
        divide_8 = paddle._C_ops.divide(add_72, full_10)
        ...
        add_74 = paddle._C_ops.add(batch_norm__132, multiply_18)

        # pd_op.depthwise_conv2d: (128x256x7x7xf32) <- (128x256x7x7xf32, 256x1x7x7xf32)
        depthwise_conv2d_20 = paddle._C_ops.depthwise_conv2d(
            add_74, parameter_23, [1, 1], [3, 3], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_23
        ...
        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 1x256x1x1xf32)
        add_75 = paddle._C_ops.add(depthwise_conv2d_20, reshape_55)
        ...
        # pd_op.relu6: (128x1024x7x7xf32) <- (128x1024x7x7xf32)
        relu6_11 = paddle._C_ops.relu6(add_76)
        del add_76

        # pd_op.multiply: (128x1024x7x7xf32) <- (128x1024x7x7xf32, 128x1024x7x7xf32)
        multiply_19 = paddle._C_ops.multiply(relu6_11, add_77)
        ...
        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 1x256x1x1xf32)
        add_78 = paddle._C_ops.add(conv2d_37, reshape_58)
        ...
        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 1x256x1x1xf32)
        add_79 = paddle._C_ops.add(depthwise_conv2d_21, reshape_59)
        ...
        # pd_op.add: (128x1x1x1xf32) <- (xf32, 128x1x1x1xf32)
        add_80 = paddle._C_ops.add(full_11, uniform_9)
        del uniform_9

        # pd_op.floor: (128x1x1x1xf32) <- (128x1x1x1xf32)
        floor_9 = paddle._C_ops.floor(add_80)
        del add_80

        # pd_op.divide: (128x256x7x7xf32) <- (128x256x7x7xf32, xf32)
        divide_9 = paddle._C_ops.divide(add_79, full_11)

        # pd_op.multiply: (128x256x7x7xf32) <- (128x256x7x7xf32, 128x1x1x1xf32)
        multiply_20 = paddle._C_ops.multiply(divide_9, floor_9)

        # pd_op.add: (128x256x7x7xf32) <- (128x256x7x7xf32, 128x256x7x7xf32)
        add_81 = paddle._C_ops.add(add_74, multiply_20)
