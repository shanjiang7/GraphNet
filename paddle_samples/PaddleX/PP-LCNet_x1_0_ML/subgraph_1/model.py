...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        del conv2d_0, parameter_161, parameter_162, parameter_163, parameter_164
        ...
        # pd_op.conv2d: (-1x32x224x224xf32) <- (-1x16x224x224xf32, 32x16x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_155, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_1, parameter_155
        ...
        del conv2d_1, parameter_151, parameter_152, parameter_153, parameter_154

        # pd_op.hardswish: (-1x32x224x224xf32) <- (-1x32x224x224xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)
        del batch_norm__12

        # pd_op.depthwise_conv2d: (-1x32x112x112xf32) <- (-1x32x224x224xf32, 32x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_150, [2, 2], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        del hardswish_2, parameter_150
        ...
        del conv2d_2, parameter_141, parameter_142, parameter_143, parameter_144
        ...
        del conv2d_3, parameter_131, parameter_132, parameter_133, parameter_134
        ...
        del conv2d_4, parameter_121, parameter_122, parameter_123, parameter_124
        ...
        del conv2d_5, parameter_111, parameter_112, parameter_113, parameter_114
        ...
        del hardswish_10, parameter_110
        ...
        del hardswish_11, parameter_105
        ...
        del depthwise_conv2d_6, parameter_96, parameter_97, parameter_98, parameter_99
        ...
        del conv2d_7, parameter_91, parameter_92, parameter_93, parameter_94
        ...
        del depthwise_conv2d_7, parameter_86, parameter_87, parameter_88, parameter_89
        ...
        del conv2d_8, parameter_81, parameter_82, parameter_83, parameter_84
        ...
        del depthwise_conv2d_8, parameter_76, parameter_77, parameter_78, parameter_79
        ...
        del conv2d_9, parameter_71, parameter_72, parameter_73, parameter_74
        ...
        del depthwise_conv2d_9, parameter_66, parameter_67, parameter_68, parameter_69
        ...
        del conv2d_10, parameter_61, parameter_62, parameter_63, parameter_64
        ...
        del depthwise_conv2d_10, parameter_56, parameter_57, parameter_58, parameter_59
        ...
        del conv2d_11, parameter_51, parameter_52, parameter_53, parameter_54
        ...
        del depthwise_conv2d_11, parameter_46, parameter_47, parameter_48, parameter_49
        ...
        del conv2d_14, parameter_37, parameter_38, parameter_39, parameter_40
        ...
        del depthwise_conv2d_12, parameter_32, parameter_33, parameter_34, parameter_35
        ...
        del conv2d_17, parameter_23, parameter_24, parameter_25, parameter_26

        # pd_op.hardswish: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        hardswish_26 = paddle._C_ops.hardswish(batch_norm__156)
        del batch_norm__156

        # pd_op.conv2d: (-1x1280x14x14xf32) <- (-1x512x14x14xf32, 1280x512x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            hardswish_26, parameter_22, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_26, parameter_22

        # pd_op.hardswish: (-1x1280x14x14xf32) <- (-1x1280x14x14xf32)
        ...
        # pd_op.dropout: (-1x1280x14x14xf32, -1x1280x14x14xui8) <- (-1x1280x14x14xf32, None, 1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x1280x14x14xf32)
        shape64_0 = paddle._C_ops.shape64(dropout_0)
        ...
        del full_int_array_3, shape64_0

        # pd_op.conv2d: (-1x768x14x14xf32) <- (-1x1280x14x14xf32, 768x1280x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            dropout_0, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del dropout_0, parameter_21
        ...
        del add_5, parameter_18, parameter_19
        ...
        dropout_6, dropout_7 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_9, None, full_2, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_9
        ...
        del add_10, parameter_8, parameter_9
        ...
        dropout_10, dropout_11 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_12, None, full_2, True, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_12, full_2
        ...
        del add_13, parameter_2, parameter_3
