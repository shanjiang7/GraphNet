...
class Program_weight_tensor_parameter_4:
    ...
    shape = [64, 96, 3, 3]
    dtype = "float32"
    min_val = float("-0.19692")
    max_val = float("0.219965")
    mean = float("-8.73558e-05")
    std = float("0.0481147")
    data = None
...
class Program_weight_tensor_parameter_14:
    ...
    shape = [2, 4, 3, 3]
    dtype = "float32"
    min_val = float("-0.391965")
    max_val = float("0.554701")
    mean = float("0.0153291")
    std = float("0.194837")
    data = None
...
class Program_weight_tensor_parameter_19:
    ...
    shape = [96, 256, 3, 3]
    dtype = "float32"
    min_val = float("-0.135008")
    max_val = float("0.130858")
    mean = float("-1.25321e-05")
    std = float("0.0295028")
    data = None
...
class Program_weight_tensor_parameter_24:
    ...
    shape = [96, 128, 3, 3]
    dtype = "float32"
    min_val = float("-0.171958")
    max_val = float("0.183286")
    mean = float("-3.20855e-05")
    std = float("0.0417275")
    data = None
...
class Program_weight_tensor_parameter_34:
    ...
    shape = [2, 4, 3, 3]
    dtype = "float32"
    min_val = float("-0.486806")
    max_val = float("0.496488")
    mean = float("-0.023577")
    std = float("0.2206")
    data = None
...
class Program_weight_tensor_parameter_39:
    ...
    shape = [128, 512, 3, 3]
    dtype = "float32"
    min_val = float("-0.100363")
    max_val = float("0.0924996")
    mean = float("1.9028e-05")
    std = float("0.0208593")
    data = None
...
class Program_weight_tensor_parameter_44:
    ...
    shape = [128, 128, 3, 3]
    dtype = "float32"
    min_val = float("-0.179717")
    max_val = float("0.188631")
    mean = float("0.000261782")
    std = float("0.0416946")
    data = None
...
class Program_weight_tensor_parameter_54:
    ...
    shape = [2, 4, 3, 3]
    dtype = "float32"
    min_val = float("-0.453525")
    max_val = float("0.606318")
    mean = float("0.00484681")
    std = float("0.207531")
    data = None
...
class Program_weight_tensor_parameter_59:
    ...
    shape = [128, 1024, 3, 3]
    dtype = "float32"
    min_val = float("-0.0689184")
    max_val = float("0.068997")
    mean = float("6.37439e-06")
    std = float("0.0147209")
    data = None
...
class Program_weight_tensor_parameter_65:
    ...
    shape = [128, 128, 3, 3]
    dtype = "float32"
    min_val = float("-0.194398")
    max_val = float("0.17823")
    mean = float("-0.000125998")
    std = float("0.0417424")
    data = None
...
class Program_weight_tensor_parameter_71:
    ...
    shape = [128, 1024, 1, 1]
    dtype = "float32"
    min_val = float("-0.182235")
    max_val = float("0.174141")
    mean = float("-0.000234451")
    std = float("0.0440979")
    data = None
...
class Program_weight_tensor_parameter_77:
    ...
    shape = [128, 1024, 1, 1]
    dtype = "float32"
    min_val = float("-0.211263")
    max_val = float("0.182735")
    mean = float("3.57154e-05")
    std = float("0.0443523")
    data = None
...
class Program_weight_tensor_parameter_83:
    ...
    shape = [128, 1024, 1, 1]
    dtype = "float32"
    min_val = float("-0.20468")
    max_val = float("0.189669")
    mean = float("0.000125873")
    std = float("0.0443069")
    data = None
