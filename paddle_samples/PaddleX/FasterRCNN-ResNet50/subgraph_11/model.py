...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.strided_slice: (-1x4xf32) <- (-1x16xf32, 1xi64, 1xi64, 1xi64)
        ...
        # pd_op.clip: (-1x4xf32) <- (-1x4xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        ...
        # pd_op.add: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        ...
        # pd_op.stack: (-1x4x4xf32) <- ([-1x4xf32, -1x4xf32, -1x4xf32, -1x4xf32])
        ...
        # pd_op.shape64: (3xi64) <- (-1x4x4xf32)
        shape64_0 = paddle._C_ops.shape64(stack_2)
        ...
        combine_4 = [slice_7, full_7, full_7]
        del full_7, slice_7
        ...
        # pd_op.expand: (-1x4x4xf32) <- (-1x4x4xf32, 3xi64)
        expand_1 = paddle._C_ops.expand(stack_2, stack_3)
        del stack_2, stack_3
        ...
        # pd_op.unsqueeze: (-1x1xf32) <- (-1xf32, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(slice_8, full_int_array_1)
        del slice_8
        ...
        # pd_op.unsqueeze: (-1x1xf32) <- (-1xf32, 1xi64)
        unsqueeze_5 = paddle._C_ops.unsqueeze(slice_9, full_int_array_1)
        del slice_9
        ...
        # pd_op.slice: (-1x4xf32) <- (-1x4x4xf32, 1xi64, 1xi64)
        slice_10 = paddle._C_ops.slice(
            expand_1, [2], full_int_array_0, full_int_array_1, [1], [2]
        )
        del full_int_array_0

        # pd_op.minimum: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        minimum_0 = paddle._C_ops.minimum(slice_10, unsqueeze_5)
        del slice_10

        # pd_op.maximum: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        ...
        # pd_op.minimum: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        minimum_1 = paddle._C_ops.minimum(slice_11, unsqueeze_4)
        del slice_11
        ...
        # pd_op.minimum: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        minimum_2 = paddle._C_ops.minimum(slice_12, unsqueeze_5)
        del slice_12, unsqueeze_5
        ...
        # pd_op.minimum: (-1x4xf32) <- (-1x4xf32, -1x1xf32)
        minimum_3 = paddle._C_ops.minimum(slice_13, unsqueeze_4)
        del slice_13, unsqueeze_4
        ...
        # builtin.combine: ([-1x4xf32, -1x4xf32, -1x4xf32, -1x4xf32]) <- (-1x4xf32, -1x4xf32, -1x4xf32, -1x4xf32)
        combine_5 = [maximum_0, maximum_1, maximum_2, maximum_3]
