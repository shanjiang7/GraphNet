...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.scatter: (35280xi32) <- (35280xi32, 254xi32, 254xi32)
        ...
        # pd_op.scatter: (35280xi32) <- (35280xi32, 2xi32, 2xi32)
        ...
        # pd_op.gather: (35280x4xf32) <- (1x4xf32, 35280xi64, 1xi32)
        ...
        # pd_op.scale: (35280xf32) <- (35280xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_0, full_4, float("0"), True)

        # pd_op.add: (35280xf32) <- (35280xf32, 35280xf32)
        ...
        # pd_op.divide: (35280xf32) <- (35280xf32, 35280xf32)
        ...
        # builtin.combine: ([35280xf32, 35280xf32, 35280xf32, 35280xf32]) <- (35280xf32, 35280xf32, 35280xf32, 35280xf32)
        combine_0 = [divide_0, divide_1, scale_6, scale_7]
        del divide_0, divide_1, scale_6, scale_7

        # pd_op.stack: (35280x4xf32) <- ([35280xf32, 35280xf32, 35280xf32, 35280xf32])
