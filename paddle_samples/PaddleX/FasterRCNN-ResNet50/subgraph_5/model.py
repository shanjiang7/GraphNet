...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_with_tensor: (-1xi32) <- (1xf32, 1xi64)
        full_with_tensor_0 = paddle._C_ops.full_with_tensor(
            full_0, stack_1, paddle.int32
        )
        del full_0, stack_1
        ...
        full_like_0 = paddle._C_ops.full_like(
            data_5, full_2, paddle.int32, paddle.framework._current_expected_place()
        )
        del full_2

        # pd_op.scatter: (-1xi32) <- (-1xi32, -1xi32, -1xi32)
        scatter_1 = paddle._C_ops.scatter(full_with_tensor_0, data_5, full_like_0, True)
        del data_5, full_like_0, full_with_tensor_0
        ...
        full_like_1 = paddle._C_ops.full_like(
            data_4, full_3, paddle.int32, paddle.framework._current_expected_place()
        )

        # pd_op.scatter: (-1xi32) <- (-1xi32, -1xi32, -1xi32)
        scatter_0 = paddle._C_ops.scatter(scatter_1, data_4, full_like_1, True)
        del data_4, full_like_1, scatter_1

        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_2 = paddle._C_ops.equal(data_3, full_1)
        del data_3
        ...
        gather_0 = paddle._C_ops.gather(data_6, data_7, full_4)
        del data_6, data_7, full_4
        ...
        slice_1 = paddle._C_ops.slice(
            data_8, [1], full_int_array_2, full_int_array_3, [1], [1]
        )
        ...
        slice_2 = paddle._C_ops.slice(
            data_8, [1], full_int_array_1, full_int_array_4, [1], [1]
        )
