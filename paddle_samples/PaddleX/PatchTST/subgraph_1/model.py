...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.transpose: (16x96x1xf32) <- (16x1x96xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_4 = [16, 1, 16]

        # pd_op.slice: (16x1x16xf32) <- (16x1x104xf32, 3xi64, 3xi64)
        ...
        # builtin.combine: ([16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32]) <- (16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32)
        combine_0 = [
            slice_0,
            slice_1,
            slice_2,
        ...
        # pd_op.stack: (16x1x16x12xf32) <- ([16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32, 16x1x16xf32])
        stack_0 = paddle._C_ops.stack(combine_0, -1)
        del combine_0

        # pd_op.transpose: (16x1x12x16xf32) <- (16x1x16x12xf32)
        transpose_4 = paddle._C_ops.transpose(stack_0, [0, 1, 3, 2])
        del stack_0

        # pd_op.matmul: (16x1x12x16xf32) <- (16x1x12x16xf32, 16x16xf32)
        matmul_0 = paddle._C_ops.matmul(transpose_4, parameter_63, False, False)
        del parameter_63

        # pd_op.add: (16x1x12x16xf32) <- (16x1x12x16xf32, 16xf32)
        add_0 = paddle._C_ops.add(matmul_0, parameter_62)
        del parameter_62

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_27 = [16, 12, 16]

        # pd_op.reshape: (16x12x16xf32) <- (16x1x12x16xf32, 3xi64)
        reshape_0 = paddle._C_ops.reshape(add_0, full_int_array_27)
        del full_int_array_27

        # pd_op.add: (16x12x16xf32) <- (16x12x16xf32, 12x16xf32)
        ...
        # pd_op.dropout: (16x12x16xf32, 16x12x16xui8) <- (16x12x16xf32, None, 1xf32)
        ...
        # pd_op.matmul: (16x12x16xf32) <- (16x12x16xf32, 16x16xf32)
        matmul_1 = paddle._C_ops.matmul(dropout_0, parameter_61, False, False)
        del parameter_61

        # pd_op.add: (16x12x16xf32) <- (16x12x16xf32, 16xf32)
        add_2 = paddle._C_ops.add(matmul_1, parameter_60)
        del parameter_60

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_28 = [16, -1, 4, 4]

        # pd_op.reshape: (16x12x4x4xf32) <- (16x12x16xf32, 4xi64)
        reshape_1 = paddle._C_ops.reshape(add_2, full_int_array_28)

        # pd_op.transpose: (16x4x12x4xf32) <- (16x12x4x4xf32)
        ...
        # pd_op.transpose: (16x4x4x12xf32) <- (16x12x4x4xf32)
        ...
        # pd_op.matmul: (16x4x12x12xf32) <- (16x4x12x4xf32, 16x4x4x12xf32)
        matmul_4 = paddle._C_ops.matmul(transpose_5, transpose_6, False, False)

        # pd_op.multiply: (16x4x12x12xf32) <- (16x4x12x12xf32, xf32)
        multiply_0 = paddle._C_ops.multiply(matmul_4, data_1)
        del data_1

        # pd_op.softmax: (16x4x12x12xf32) <- (16x4x12x12xf32)
        softmax_0 = paddle._C_ops.softmax(multiply_0, -1)

        # pd_op.matmul: (16x4x12x4xf32) <- (16x4x12x12xf32, 16x4x12x4xf32)
        matmul_5 = paddle._C_ops.matmul(softmax_0, transpose_7, False, False)

        # pd_op.transpose: (16x12x4x4xf32) <- (16x4x12x4xf32)
        transpose_8 = paddle._C_ops.transpose(matmul_5, [0, 2, 1, 3])
        del matmul_5

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_29 = [16, -1, 16]

        # pd_op.reshape: (16x12x16xf32) <- (16x12x4x4xf32, 3xi64)
        ...
        # pd_op.add: (16x12x16xf32) <- (16x12x16xf32, 16x12x16xf32)
        add_6 = paddle._C_ops.add(dropout_0, dropout_4)

        # pd_op.transpose: (16x16x12xf32) <- (16x12x16xf32)
        transpose_9 = paddle._C_ops.transpose(add_6, [0, 2, 1])
        del add_6

        # pd_op.batch_norm_: (16x16x12xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (16x16x12xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.transpose: (16x12x16xf32) <- (16x16x12xf32)
        transpose_10 = paddle._C_ops.transpose(batch_norm__0, [0, 2, 1])
        del batch_norm__0

        # pd_op.matmul: (16x12x128xf32) <- (16x12x16xf32, 16x128xf32)
        ...
        # pd_op.gelu: (16x12x128xf32) <- (16x12x128xf32)
        ...
        # pd_op.matmul: (16x12x16xf32) <- (16x12x128xf32, 128x16xf32)
        ...
        # pd_op.add: (16x4x12x12xf32) <- (16x4x12x12xf32, 16x4x12x12xf32)
        ...
        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_30 = [-1, 1, 12, 16]

        # pd_op.reshape: (16x1x12x16xf32) <- (16x12x16xf32, 4xi64)
        reshape_13 = paddle._C_ops.reshape(transpose_28, full_int_array_30)
        del full_int_array_30

        # pd_op.transpose: (16x1x16x12xf32) <- (16x1x12x16xf32)
        transpose_29 = paddle._C_ops.transpose(reshape_13, [0, 1, 3, 2])
        del reshape_13

        # pd_op.flatten: (16x1x192xf32) <- (16x1x16x12xf32)
        flatten_0 = paddle._C_ops.flatten(transpose_29, 2, 3)

        # pd_op.matmul: (16x1x96xf32) <- (16x1x192xf32, 192x96xf32)
        matmul_25 = paddle._C_ops.matmul(flatten_0, parameter_1, False, False)
        del parameter_1

        # pd_op.add: (16x1x96xf32) <- (16x1x96xf32, 96xf32)
        ...
        # pd_op.multiply: (16x96x1xf32) <- (16x96x1xf32, 16x1x1xf32)
