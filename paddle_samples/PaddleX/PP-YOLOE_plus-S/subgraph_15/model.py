...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.unsqueeze: (1x7581x4xf32) <- (7581x4xf32, 1xi64)
        ...
        # pd_op.slice: (1x7581x2xf32) <- (1x7581x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (8x7581x2xf32) <- (8x1x2xf32, 1x7581x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (8x7581x2xf32) <- (8x1x2xf32, 1x7581x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (8x7581x2xf32) <- (8x7581x2xf32, 8x7581x2xf32)
        ...
        # pd_op.clip: (8x7581x2xf32) <- (8x7581x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (8x7581xf32) <- (8x7581x2xf32, 1xi64)
        ...
        # pd_op.scale: (8x7581xf32) <- (8x7581xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-10"), True)
        del full_2, subtract_3

        # pd_op.divide: (8x7581xf32) <- (8x7581xf32, 8x7581xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [8, -1, 7581]

        # pd_op.reshape: (8x1x7581xf32) <- (8x7581xf32, 3xi64)
        ...
        # pd_op.slice: (7581xf32) <- (7581x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.add: (7581xf32) <- (7581xf32, 7581xf32)
        add_3 = paddle._C_ops.add(slice_8, slice_9)
        del slice_8, slice_9

        # pd_op.scale: (7581xf32) <- (7581xf32, 1xf32)
        ...
        # builtin.combine: ([7581xf32, 7581xf32]) <- (7581xf32, 7581xf32)
        combine_1 = [scale_3, scale_4]
        del scale_3, scale_4

        # pd_op.stack: (7581x2xf32) <- ([7581xf32, 7581xf32])
        stack_1 = paddle._C_ops.stack(combine_1, -1)
        del combine_1

        # pd_op.unsqueeze: (1x7581x2xf32) <- (7581x2xf32, 1xi64)
        unsqueeze_3 = paddle._C_ops.unsqueeze(stack_1, full_int_array_2)
        del full_int_array_2

        # pd_op.subtract: (8x7581x2xf32) <- (8x1x2xf32, 1x7581x2xf32)
        subtract_4 = paddle._C_ops.subtract(unsqueeze_2, unsqueeze_3)
        del unsqueeze_2, unsqueeze_3

        # pd_op.p_norm: (8x7581xf32) <- (8x7581x2xf32)
