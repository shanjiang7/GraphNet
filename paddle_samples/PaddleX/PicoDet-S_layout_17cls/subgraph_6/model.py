...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.maximum: (2x12x6150x2xf32) <- (2x12x1x2xf32, 2x1x6150x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (2x12x6150x2xf32) <- (2x12x1x2xf32, 2x1x6150x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (2x12x6150x2xf32) <- (2x12x6150x2xf32, 2x12x6150x2xf32)
        ...
        # pd_op.clip: (2x12x6150x2xf32) <- (2x12x6150x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (2x12x6150xf32) <- (2x12x6150x2xf32, 1xi64)
        ...
        # pd_op.add: (2x12x6150xf32) <- (2x12x1xf32, 2x1x6150xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (2x12x6150xf32) <- (2x12x6150xf32, 2x12x6150xf32)
        ...
        # pd_op.scale: (2x12x6150xf32) <- (2x12x6150xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)
        del full_2, subtract_3

        # pd_op.divide: (2x12x6150xf32) <- (2x12x6150xf32, 2x12x6150xf32)
        ...
        # pd_op.gather_nd: (2x12x6150xf32) <- (2x11x6150xf32, 2x12x2xi32)
        gather_nd_0 = paddle._C_ops.gather_nd(transpose_0, stack_0)
        del stack_0, transpose_0

        # pd_op.pow: (2x12x6150xf32) <- (2x12x6150xf32)
        ...
        # pd_op.subtract: (2x12x6150x1xf32) <- (1x1x6150x1xf32, 2x12x1x1xf32)
        ...
        # pd_op.subtract: (2x12x6150x1xf32) <- (2x12x1x1xf32, 1x1x6150x1xf32)
        ...
        # builtin.combine: ([2x12x6150x1xf32, 2x12x6150x1xf32, 2x12x6150x1xf32, 2x12x6150x1xf32]) <- (2x12x6150x1xf32, 2x12x6150x1xf32, 2x12x6150x1xf32, 2x12x6150x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (2x12x6150x4xf32) <- ([2x12x6150x1xf32, 2x12x6150x1xf32, 2x12x6150x1xf32, 2x12x6150x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.min: (2x12x6150xf32) <- (2x12x6150x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x12x6150xb) <- (2x12x6150xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)
        del full_8, min_0

        # pd_op.cast: (2x12x6150xf32) <- (2x12x6150xb)
        ...
        # pd_op.topk: (2x12x13xf32, 2x12x13xi64) <- (2x12x6150xf32, 1xi32)
        ...
        # pd_op.one_hot: (2x12x13x6150xf32) <- (2x12x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x12x6150xf32) <- (2x12x13x6150xf32, 1xi64)
        ...
        # pd_op.sum: (2x6150xf32) <- (2x12x6150xf32, 1xi64)
