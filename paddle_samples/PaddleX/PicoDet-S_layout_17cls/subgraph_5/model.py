...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x16x272x272xf32) <- (2x3x544x544xf32, 16x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_441, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_441

        # pd_op.batch_norm_: (2x16x272x272xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (2x16x272x272xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (2x16x272x272xf32) <- (2x16x272x272xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (2x16x272x272xf32) <- (2x16x272x272xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x24x272x272xf32) <- (2x16x272x272xf32, 24x16x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_431, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_431

        # pd_op.batch_norm_: (2x24x272x272xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (2x24x272x272xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (2x24x272x272xf32) <- (2x24x272x272xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (2x24x136x136xf32) <- (2x24x272x272xf32, 24x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_426, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_426

        # pd_op.batch_norm_: (2x24x136x136xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (2x24x136x136xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (2x24x136x136xf32) <- (2x24x136x136xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (2x48x136x136xf32) <- (2x24x136x136xf32, 48x24x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_421, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_421

        # pd_op.batch_norm_: (2x48x136x136xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (2x48x136x136xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (2x48x136x136xf32) <- (2x48x136x136xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (2x48x136x136xf32) <- (2x48x136x136xf32, 48x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x48x136x136xf32) <- (2x48x136x136xf32, 48x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x48x68x68xf32) <- (2x48x136x136xf32, 48x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_406, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del parameter_406

        # pd_op.batch_norm_: (2x48x68x68xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (2x48x68x68xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (2x48x68x68xf32) <- (2x48x68x68xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (2x96x68x68xf32) <- (2x48x68x68xf32, 96x48x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            hardswish_7, parameter_401, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_401

        # pd_op.batch_norm_: (2x96x68x68xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x68x68xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.hardswish: (2x96x68x68xf32) <- (2x96x68x68xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)

        # pd_op.depthwise_conv2d: (2x96x68x68xf32) <- (2x96x68x68xf32, 96x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x96x68x68xf32) <- (2x96x68x68xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x34x34xf32) <- (2x96x68x68xf32, 96x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_386, [2, 2], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_386

        # pd_op.batch_norm_: (2x96x34x34xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x34x34xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (2x96x34x34xf32) <- (2x96x34x34xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (2x192x34x34xf32) <- (2x96x34x34xf32, 192x96x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_381, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_381

        # pd_op.batch_norm_: (2x192x34x34xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (2x192x34x34xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (2x192x34x34xf32) <- (2x192x34x34xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (2x192x34x34xf32) <- (2x192x34x34xf32, 192x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x192x34x34xf32) <- (2x192x34x34xf32, 192x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x192x17x17xf32) <- (2x192x34x34xf32, 192x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_326, [2, 2], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_326

        # pd_op.batch_norm_: (2x192x17x17xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (2x192x17x17xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (2x192x17x17xf32) <- (2x192x17x17xf32)
        ...
        # pd_op.pool2d: (2x192x1x1xf32) <- (2x192x17x17xf32, 2xi64)
        ...
        # pd_op.multiply: (2x192x17x17xf32) <- (2x192x17x17xf32, 2x192x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (2x384x17x17xf32) <- (2x192x17x17xf32, 384x192x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_317, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_317

        # pd_op.batch_norm_: (2x384x17x17xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (2x384x17x17xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (2x384x17x17xf32) <- (2x384x17x17xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (2x384x17x17xf32) <- (2x384x17x17xf32, 384x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x384x1x1xf32) <- (2x384x17x17xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x96x1x1xf32) <- (2x384x1x1xf32, 96x384x1x1xf32)
        ...
        # pd_op.multiply: (2x384x17x17xf32) <- (2x384x17x17xf32, 2x384x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (2x384x17x17xf32) <- (2x384x17x17xf32, 384x384x1x1xf32)
        ...
        # pd_op.conv2d: (2x96x34x34xf32) <- (2x192x34x34xf32, 96x192x1x1xf32)
        ...
        # pd_op.conv2d: (2x96x17x17xf32) <- (2x384x17x17xf32, 96x384x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_26, parameter_288, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_288

        # pd_op.batch_norm_: (2x96x17x17xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x17x17xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (2x96x17x17xf32) <- (2x96x17x17xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.nearest_interp: (2x96x34x34xf32) <- (2x96x17x17xf32, None, None, None)
        ...
        # builtin.combine: ([2x96x34x34xf32, 2x96x34x34xf32]) <- (2x96x34x34xf32, 2x96x34x34xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (2x192x34x34xf32) <- ([2x96x34x34xf32, 2x96x34x34xf32], 1xi32)
        ...
        # pd_op.nearest_interp: (2x96x68x68xf32) <- (2x96x34x34xf32, None, None, None)
        ...
        # builtin.combine: ([2x96x68x68xf32, 2x96x68x68xf32]) <- (2x96x68x68xf32, 2x96x68x68xf32)
        combine_1 = [nearest_interp_1, hardswish_27]

        # pd_op.concat: (2x192x68x68xf32) <- ([2x96x68x68xf32, 2x96x68x68xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (2x192x68x68xf32) <- (2x192x68x68xf32, 192x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            concat_4, parameter_263, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_263

        # pd_op.batch_norm_: (2x192x68x68xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (2x192x68x68xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (2x192x68x68xf32) <- (2x192x68x68xf32)
        hardswish_34 = paddle._C_ops.hardswish(batch_norm__204)

        # pd_op.conv2d: (2x192x68x68xf32) <- (2x192x68x68xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (2x96x68x68xf32) <- (2x192x68x68xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x34x34xf32) <- (2x96x68x68xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x96x34x34xf32) <- (2x96x34x34xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x17x17xf32) <- (2x96x34x34xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x96x17x17xf32) <- (2x96x17x17xf32, 96x96x1x1xf32)
        ...
        # builtin.combine: ([2x96x17x17xf32, 2x96x17x17xf32]) <- (2x96x17x17xf32, 2x96x17x17xf32)
        combine_3 = [hardswish_45, hardswish_29]

        # pd_op.concat: (2x192x17x17xf32) <- ([2x96x17x17xf32, 2x96x17x17xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_3, full_0)
        del combine_3

        # pd_op.depthwise_conv2d: (2x192x17x17xf32) <- (2x192x17x17xf32, 192x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x192x17x17xf32) <- (2x192x17x17xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (2x96x17x17xf32) <- (2x192x17x17xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x9x9xf32) <- (2x96x17x17xf32, 96x1x5x5xf32)
        depthwise_conv2d_23 = paddle._C_ops.depthwise_conv2d(
            hardswish_29, parameter_183, [2, 2], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_183

        # pd_op.batch_norm_: (2x96x9x9xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x9x9xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__300,
            batch_norm__301,
            batch_norm__302,
        ...
        # pd_op.hardswish: (2x96x9x9xf32) <- (2x96x9x9xf32)
        hardswish_50 = paddle._C_ops.hardswish(batch_norm__300)

        # pd_op.conv2d: (2x96x9x9xf32) <- (2x96x9x9xf32, 96x96x1x1xf32)
        ...
        # pd_op.add: (2x96x9x9xf32) <- (2x96x9x9xf32, 2x96x9x9xf32)
        add_4 = paddle._C_ops.add(hardswish_51, hardswish_53)

        # pd_op.shape64: (4xi64) <- (2x96x68x68xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x68x68xf32) <- (2x96x68x68xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x68x68xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x68x68xf32) <- (2x96x68x68xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x68x68xf32) <- (2x96x68x68xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x68x68xf32) <- (2x11x68x68xf32, 1x11x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_37, reshape_5)

        # pd_op.conv2d: (2x32x68x68xf32) <- (2x96x68x68xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x68x68xf32) <- (2x32x68x68xf32, 1x32x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_38, reshape_6)

        # pd_op.conv2d: (2x1x68x68xf32) <- (2x96x68x68xf32, 1x96x5x5xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            hardswish_57, parameter_132, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_132

        # pd_op.batch_norm_: (2x1x68x68xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x68x68xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__354,
            batch_norm__355,
            batch_norm__356,
        ...
        # pd_op.hardswish: (2x1x68x68xf32) <- (2x1x68x68xf32)
        hardswish_59 = paddle._C_ops.hardswish(batch_norm__354)

        # pd_op.conv2d: (2x1x68x68xf32) <- (2x1x68x68xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x68x68xf32) <- (2x1x68x68xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__360)
        del batch_norm__360

        # pd_op.sigmoid: (2x11x68x68xf32) <- (2x11x68x68xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_6)
        del add_6

        # pd_op.multiply: (2x11x68x68xf32) <- (2x11x68x68xf32, 2x1x68x68xf32)
        ...
        # pd_op.scale: (2x11x68x68xf32) <- (2x11x68x68xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(multiply_3, full_1, float("1e-09"), True)
        del multiply_3

        # pd_op.sqrt: (2x11x68x68xf32) <- (2x11x68x68xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_0)
        del scale_0

        # pd_op.transpose: (2x68x68x11xf32) <- (2x11x68x68xf32)
        ...
        # pd_op.flatten: (4624xf32) <- (68x68xf32)
        ...
        # builtin.combine: ([4624xf32, 4624xf32]) <- (4624xf32, 4624xf32)
        combine_5 = [flatten_1, flatten_0]
        del flatten_0, flatten_1

        # pd_op.stack: (4624x2xf32) <- ([4624xf32, 4624xf32])
        ...
        # pd_op.reshape: (2x4624x11xf32) <- (2x68x68x11xf32, 3xi64)
        ...
        # pd_op.reshape: (9248x4xf32) <- (36992xf32, 2xi64)
        reshape_9 = paddle._C_ops.reshape(matmul_0, full_int_array_9)

        # pd_op.scale: (9248x4xf32) <- (9248x4xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(reshape_9, full_5, float("0"), True)
        del full_5, reshape_9

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_10 = [2, 4624, 4]

        # pd_op.reshape: (2x4624x4xf32) <- (9248x4xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([2x4624x2xf32, 2x4624x2xf32]) <- (2x4624x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_10, 2, full_6)
        del reshape_10

        # builtin.split: (2x4624x2xf32, 2x4624x2xf32) <- ([2x4624x2xf32, 2x4624x2xf32])
        (
            split_2,
            split_3,
        ) = split_with_num_0
        ...
        # pd_op.scale: (2x4624x2xf32) <- (2x4624x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_2, full_7, float("0"), True)
        del split_2

        # pd_op.add: (2x4624x2xf32) <- (2x4624x2xf32, 4624x2xf32)
        ...
        # builtin.combine: ([2x4624x2xf32, 2x4624x2xf32]) <- (2x4624x2xf32, 2x4624x2xf32)
        combine_6 = [add_8, add_9]

        # pd_op.concat: (2x4624x4xf32) <- ([2x4624x2xf32, 2x4624x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_8)
        del combine_6

        # pd_op.flatten: (2x11x4624xf32) <- (2x11x68x68xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (2x4624x11xf32) <- (2x11x4624xf32)
        transpose_2 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])
        del flatten_2

        # pd_op.flatten: (2x32x4624xf32) <- (2x32x68x68xf32)
        flatten_3 = paddle._C_ops.flatten(add_7, 2, 3)

        # pd_op.transpose: (2x4624x32xf32) <- (2x32x4624xf32)
        ...
        # pd_op.scale: (2x4624x4xf32) <- (2x4624x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_7, full_9, float("0"), True)
        del concat_7

        # pd_op.shape64: (4xi64) <- (2x96x34x34xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x34x34xf32) <- (2x96x34x34xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x34x34xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x34x34xf32) <- (2x96x34x34xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x34x34xf32) <- (2x96x34x34xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x34x34xf32) <- (2x11x34x34xf32, 1x11x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_45, reshape_12)

        # pd_op.conv2d: (2x32x34x34xf32) <- (2x96x34x34xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x34x34xf32) <- (2x32x34x34xf32, 1x32x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_46, reshape_13)

        # pd_op.conv2d: (2x1x34x34xf32) <- (2x96x34x34xf32, 1x96x5x5xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            hardswish_63, parameter_91, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_91

        # pd_op.batch_norm_: (2x1x34x34xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x34x34xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__396,
            batch_norm__397,
            batch_norm__398,
        ...
        # pd_op.hardswish: (2x1x34x34xf32) <- (2x1x34x34xf32)
        hardswish_65 = paddle._C_ops.hardswish(batch_norm__396)

        # pd_op.conv2d: (2x1x34x34xf32) <- (2x1x34x34xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x34x34xf32) <- (2x1x34x34xf32)
        sigmoid_4 = paddle._C_ops.sigmoid(batch_norm__402)
        del batch_norm__402

        # pd_op.sigmoid: (2x11x34x34xf32) <- (2x11x34x34xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_11)
        del add_11

        # pd_op.multiply: (2x11x34x34xf32) <- (2x11x34x34xf32, 2x1x34x34xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (2x11x34x34xf32) <- (2x11x34x34xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)
        del multiply_5

        # pd_op.sqrt: (2x11x34x34xf32) <- (2x11x34x34xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_6)
        del scale_6

        # pd_op.transpose: (2x34x34x11xf32) <- (2x11x34x34xf32)
        ...
        # builtin.combine: ([1156xf32, 1156xf32]) <- (1156xf32, 1156xf32)
        combine_8 = [flatten_5, flatten_4]
        del flatten_4, flatten_5

        # pd_op.stack: (1156x2xf32) <- ([1156xf32, 1156xf32])
        stack_1 = paddle._C_ops.stack(combine_8, -1)
        del combine_8

        # pd_op.reshape: (2x1156x11xf32) <- (2x34x34x11xf32, 3xi64)
        ...
        # pd_op.scale: (2x1156x2xf32) <- (2x1156x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_6, full_7, float("0"), True)
        del split_6

        # pd_op.add: (2x1156x2xf32) <- (2x1156x2xf32, 1156x2xf32)
        add_13 = paddle._C_ops.add(scale_10, stack_1)

        # pd_op.add: (2x1156x2xf32) <- (2x1156x2xf32, 1156x2xf32)
        add_14 = paddle._C_ops.add(split_7, stack_1)

        # builtin.combine: ([2x1156x2xf32, 2x1156x2xf32]) <- (2x1156x2xf32, 2x1156x2xf32)
        combine_9 = [add_13, add_14]

        # pd_op.concat: (2x1156x4xf32) <- ([2x1156x2xf32, 2x1156x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_8)
        del combine_9

        # pd_op.flatten: (2x11x1156xf32) <- (2x11x34x34xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (2x1156x11xf32) <- (2x11x1156xf32)
        transpose_6 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])
        del flatten_6

        # pd_op.flatten: (2x32x1156xf32) <- (2x32x34x34xf32)
        flatten_7 = paddle._C_ops.flatten(add_12, 2, 3)

        # pd_op.transpose: (2x1156x32xf32) <- (2x32x1156xf32)
        ...
        # pd_op.scale: (2x1156x4xf32) <- (2x1156x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_8, full_12, float("0"), True)
        del concat_8

        # pd_op.shape64: (4xi64) <- (2x96x17x17xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x17x17xf32) <- (2x96x17x17xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x17x17xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x17x17xf32) <- (2x96x17x17xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x17x17xf32) <- (2x96x17x17xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x17x17xf32) <- (2x11x17x17xf32, 1x11x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_53, reshape_19)

        # pd_op.conv2d: (2x32x17x17xf32) <- (2x96x17x17xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x17x17xf32) <- (2x32x17x17xf32, 1x32x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_54, reshape_20)

        # pd_op.conv2d: (2x1x17x17xf32) <- (2x96x17x17xf32, 1x96x5x5xf32)
        conv2d_55 = paddle._C_ops.conv2d(
            hardswish_69, parameter_50, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_50

        # pd_op.batch_norm_: (2x1x17x17xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x17x17xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__438,
            batch_norm__439,
            batch_norm__440,
        ...
        # pd_op.hardswish: (2x1x17x17xf32) <- (2x1x17x17xf32)
        hardswish_71 = paddle._C_ops.hardswish(batch_norm__438)

        # pd_op.conv2d: (2x1x17x17xf32) <- (2x1x17x17xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x1x17x17xf32) <- (2x1x17x17xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__444)
        del batch_norm__444

        # pd_op.sigmoid: (2x11x17x17xf32) <- (2x11x17x17xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_16)
        del add_16

        # pd_op.multiply: (2x11x17x17xf32) <- (2x11x17x17xf32, 2x1x17x17xf32)
        multiply_7 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (2x11x17x17xf32) <- (2x11x17x17xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_7, full_1, float("1e-09"), True)
        del multiply_7

        # pd_op.sqrt: (2x11x17x17xf32) <- (2x11x17x17xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_12)
        del scale_12

        # pd_op.transpose: (2x17x17x11xf32) <- (2x11x17x17xf32)
        ...
        # builtin.combine: ([289xf32, 289xf32]) <- (289xf32, 289xf32)
        combine_11 = [flatten_9, flatten_8]
        del flatten_8, flatten_9

        # pd_op.stack: (289x2xf32) <- ([289xf32, 289xf32])
        stack_2 = paddle._C_ops.stack(combine_11, -1)
        del combine_11

        # pd_op.reshape: (2x289x11xf32) <- (2x17x17x11xf32, 3xi64)
        ...
        # pd_op.scale: (2x289x2xf32) <- (2x289x2xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(split_10, full_7, float("0"), True)
        del split_10

        # pd_op.add: (2x289x2xf32) <- (2x289x2xf32, 289x2xf32)
        add_18 = paddle._C_ops.add(scale_16, stack_2)

        # pd_op.add: (2x289x2xf32) <- (2x289x2xf32, 289x2xf32)
        add_19 = paddle._C_ops.add(split_11, stack_2)

        # builtin.combine: ([2x289x2xf32, 2x289x2xf32]) <- (2x289x2xf32, 2x289x2xf32)
        combine_12 = [add_18, add_19]

        # pd_op.concat: (2x289x4xf32) <- ([2x289x2xf32, 2x289x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_8)
        del combine_12

        # pd_op.flatten: (2x11x289xf32) <- (2x11x17x17xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (2x289x11xf32) <- (2x11x289xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])
        del flatten_10

        # pd_op.flatten: (2x32x289xf32) <- (2x32x17x17xf32)
        flatten_11 = paddle._C_ops.flatten(add_17, 2, 3)

        # pd_op.transpose: (2x289x32xf32) <- (2x32x289xf32)
        ...
        # pd_op.scale: (2x289x4xf32) <- (2x289x4xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(concat_9, full_15, float("0"), True)
        del concat_9

        # pd_op.shape64: (4xi64) <- (2x96x9x9xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x9x9xf32) <- (2x96x9x9xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x9x9xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x9x9xf32) <- (2x96x9x9xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x9x9xf32) <- (2x96x9x9xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x9x9xf32) <- (2x11x9x9xf32, 1x11x1x1xf32)
        add_21 = paddle._C_ops.add(conv2d_61, reshape_26)

        # pd_op.conv2d: (2x32x9x9xf32) <- (2x96x9x9xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x9x9xf32) <- (2x32x9x9xf32, 1x32x1x1xf32)
        add_22 = paddle._C_ops.add(conv2d_62, reshape_27)

        # pd_op.conv2d: (2x1x9x9xf32) <- (2x96x9x9xf32, 1x96x5x5xf32)
        conv2d_63 = paddle._C_ops.conv2d(
            hardswish_75, parameter_9, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_9

        # pd_op.batch_norm_: (2x1x9x9xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x9x9xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__480,
            batch_norm__481,
            batch_norm__482,
        ...
        # pd_op.hardswish: (2x1x9x9xf32) <- (2x1x9x9xf32)
        hardswish_77 = paddle._C_ops.hardswish(batch_norm__480)

        # pd_op.conv2d: (2x1x9x9xf32) <- (2x1x9x9xf32, 1x1x1x1xf32)
        ...
        # pd_op.scale: (2x81x4xf32) <- (2x81x4xf32, 1xf32)
        scale_23 = paddle._C_ops.scale(concat_10, full_18, float("0"), True)
        del concat_10

        # builtin.combine: ([2x4624x11xf32, 2x1156x11xf32, 2x289x11xf32, 2x81x11xf32]) <- (2x4624x11xf32, 2x1156x11xf32, 2x289x11xf32, 2x81x11xf32)
        combine_16 = [transpose_2, transpose_6, transpose_10, transpose_14]

        # pd_op.concat: (2x6150x11xf32) <- ([2x4624x11xf32, 2x1156x11xf32, 2x289x11xf32, 2x81x11xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_16, full_0)
        del combine_16

        # builtin.combine: ([2x4624x4xf32, 2x1156x4xf32, 2x289x4xf32, 2x81x4xf32]) <- (2x4624x4xf32, 2x1156x4xf32, 2x289x4xf32, 2x81x4xf32)
        combine_17 = [scale_5, scale_11, scale_17, scale_23]

        # pd_op.concat: (2x6150x4xf32) <- ([2x4624x4xf32, 2x1156x4xf32, 2x289x4xf32, 2x81x4xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_17, full_0)
        del combine_17

        # builtin.combine: ([2x4624x32xf32, 2x1156x32xf32, 2x289x32xf32, 2x81x32xf32]) <- (2x4624x32xf32, 2x1156x32xf32, 2x289x32xf32, 2x81x32xf32)
        combine_18 = [transpose_3, transpose_7, transpose_11, transpose_15]

        # pd_op.concat: (2x6150x32xf32) <- ([2x4624x32xf32, 2x1156x32xf32, 2x289x32xf32, 2x81x32xf32], 1xi32)
