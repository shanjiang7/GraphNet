...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x8x240x240xf32) <- (4x3x480x480xf32, 8x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_441, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_441

        # pd_op.batch_norm_: (4x8x240x240xf32, 8xf32, 8xf32, 8xf32, 8xf32, -1xui8) <- (4x8x240x240xf32, 8xf32, 8xf32, 8xf32, 8xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (4x8x240x240xf32) <- (4x8x240x240xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (4x8x240x240xf32) <- (4x8x240x240xf32, 8x1x3x3xf32)
        ...
        # pd_op.conv2d: (4x16x240x240xf32) <- (4x8x240x240xf32, 16x8x1x1xf32)
        ...
        # pd_op.hardswish: (4x16x240x240xf32) <- (4x16x240x240xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (4x16x120x120xf32) <- (4x16x240x240xf32, 16x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_426, [2, 2], [1, 1], "EXPLICIT", 16, [1, 1], "NCHW"
        )
        del parameter_426

        # pd_op.batch_norm_: (4x16x120x120xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (4x16x120x120xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (4x16x120x120xf32) <- (4x16x120x120xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (4x24x120x120xf32) <- (4x16x120x120xf32, 24x16x1x1xf32)
        ...
        # pd_op.hardswish: (4x24x120x120xf32) <- (4x24x120x120xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (4x24x120x120xf32) <- (4x24x120x120xf32, 24x1x3x3xf32)
        ...
        # pd_op.conv2d: (4x24x120x120xf32) <- (4x24x120x120xf32, 24x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x24x60x60xf32) <- (4x24x120x120xf32, 24x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_406, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_406

        # pd_op.batch_norm_: (4x24x60x60xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (4x24x60x60xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (4x24x60x60xf32) <- (4x24x60x60xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (4x48x60x60xf32) <- (4x24x60x60xf32, 48x24x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            hardswish_7, parameter_401, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_401

        # pd_op.batch_norm_: (4x48x60x60xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (4x48x60x60xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.hardswish: (4x48x60x60xf32) <- (4x48x60x60xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)

        # pd_op.depthwise_conv2d: (4x48x60x60xf32) <- (4x48x60x60xf32, 48x1x3x3xf32)
        ...
        # pd_op.conv2d: (4x48x60x60xf32) <- (4x48x60x60xf32, 48x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x48x30x30xf32) <- (4x48x60x60xf32, 48x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_386, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del parameter_386

        # pd_op.batch_norm_: (4x48x30x30xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (4x48x30x30xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (4x48x30x30xf32) <- (4x48x30x30xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (4x88x30x30xf32) <- (4x48x30x30xf32, 88x48x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_381, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_381

        # pd_op.batch_norm_: (4x88x30x30xf32, 88xf32, 88xf32, 88xf32, 88xf32, -1xui8) <- (4x88x30x30xf32, 88xf32, 88xf32, 88xf32, 88xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (4x88x30x30xf32) <- (4x88x30x30xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (4x88x30x30xf32) <- (4x88x30x30xf32, 88x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x88x30x30xf32) <- (4x88x30x30xf32, 88x88x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x88x15x15xf32) <- (4x88x30x30xf32, 88x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_326, [2, 2], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        del parameter_326

        # pd_op.batch_norm_: (4x88x15x15xf32, 88xf32, 88xf32, 88xf32, 88xf32, -1xui8) <- (4x88x15x15xf32, 88xf32, 88xf32, 88xf32, 88xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (4x88x15x15xf32) <- (4x88x15x15xf32)
        ...
        # pd_op.pool2d: (4x88x1x1xf32) <- (4x88x15x15xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x22x1x1xf32) <- (4x88x1x1xf32, 22x88x1x1xf32)
        ...
        # pd_op.add: (4x22x1x1xf32) <- (4x22x1x1xf32, 1x22x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_12, reshape_0)

        # pd_op.relu: (4x22x1x1xf32) <- (4x22x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_0)
        del add_0

        # pd_op.conv2d: (4x88x1x1xf32) <- (4x22x1x1xf32, 88x22x1x1xf32)
        ...
        # pd_op.add: (4x88x1x1xf32) <- (4x88x1x1xf32, 1x88x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_13, reshape_1)

        # pd_op.hardsigmoid: (4x88x1x1xf32) <- (4x88x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            add_1, float("0.166667"), float("0.5")
        )
        del add_1

        # pd_op.multiply: (4x88x15x15xf32) <- (4x88x15x15xf32, 4x88x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (4x176x15x15xf32) <- (4x88x15x15xf32, 176x88x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_317, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_317

        # pd_op.batch_norm_: (4x176x15x15xf32, 176xf32, 176xf32, 176xf32, 176xf32, -1xui8) <- (4x176x15x15xf32, 176xf32, 176xf32, 176xf32, 176xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (4x176x15x15xf32) <- (4x176x15x15xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (4x176x15x15xf32) <- (4x176x15x15xf32, 176x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x176x1x1xf32) <- (4x176x15x15xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x44x1x1xf32) <- (4x176x1x1xf32, 44x176x1x1xf32)
        ...
        # pd_op.multiply: (4x176x15x15xf32) <- (4x176x15x15xf32, 4x176x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (4x176x15x15xf32) <- (4x176x15x15xf32, 176x176x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x60x60xf32) <- (4x48x60x60xf32, 96x48x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x30x30xf32) <- (4x88x30x30xf32, 96x88x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            hardswish_22, parameter_293, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_293

        # pd_op.batch_norm_: (4x96x30x30xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x30x30xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.hardswish: (4x96x30x30xf32) <- (4x96x30x30xf32)
        hardswish_28 = paddle._C_ops.hardswish(batch_norm__168)

        # pd_op.conv2d: (4x96x15x15xf32) <- (4x176x15x15xf32, 96x176x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_26, parameter_288, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_288

        # pd_op.batch_norm_: (4x96x15x15xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x15x15xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (4x96x15x15xf32) <- (4x96x15x15xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.nearest_interp: (4x96x30x30xf32) <- (4x96x15x15xf32, None, None, None)
        ...
        # builtin.combine: ([4x96x30x30xf32, 4x96x30x30xf32]) <- (4x96x30x30xf32, 4x96x30x30xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (4x192x30x30xf32) <- ([4x96x30x30xf32, 4x96x30x30xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0

        # pd_op.depthwise_conv2d: (4x192x30x30xf32) <- (4x192x30x30xf32, 192x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_283, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_283

        # pd_op.batch_norm_: (4x192x30x30xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x30x30xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__180,
            batch_norm__181,
            batch_norm__182,
        ...
        # pd_op.hardswish: (4x192x30x30xf32) <- (4x192x30x30xf32)
        hardswish_30 = paddle._C_ops.hardswish(batch_norm__180)

        # pd_op.conv2d: (4x192x30x30xf32) <- (4x192x30x30xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x30x30xf32) <- (4x192x30x30xf32, 96x192x1x1xf32)
        ...
        # builtin.combine: ([4x96x60x60xf32, 4x96x60x60xf32]) <- (4x96x60x60xf32, 4x96x60x60xf32)
        combine_1 = [nearest_interp_1, hardswish_27]

        # pd_op.concat: (4x192x60x60xf32) <- ([4x96x60x60xf32, 4x96x60x60xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (4x192x60x60xf32) <- (4x192x60x60xf32, 192x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            concat_4, parameter_263, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_263

        # pd_op.batch_norm_: (4x192x60x60xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x60x60xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (4x192x60x60xf32) <- (4x192x60x60xf32)
        hardswish_34 = paddle._C_ops.hardswish(batch_norm__204)

        # pd_op.conv2d: (4x192x60x60xf32) <- (4x192x60x60xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x60x60xf32) <- (4x192x60x60xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x30x30xf32) <- (4x96x60x60xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x30x30xf32) <- (4x96x30x30xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x15x15xf32) <- (4x96x30x30xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x15x15xf32) <- (4x96x15x15xf32, 96x96x1x1xf32)
        ...
        # builtin.combine: ([4x96x15x15xf32, 4x96x15x15xf32]) <- (4x96x15x15xf32, 4x96x15x15xf32)
        combine_3 = [hardswish_45, hardswish_29]

        # pd_op.concat: (4x192x15x15xf32) <- ([4x96x15x15xf32, 4x96x15x15xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_3, full_0)
        del combine_3

        # pd_op.depthwise_conv2d: (4x192x15x15xf32) <- (4x192x15x15xf32, 192x1x5x5xf32)
        depthwise_conv2d_21 = paddle._C_ops.depthwise_conv2d(
            concat_6, parameter_203, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_203

        # pd_op.batch_norm_: (4x192x15x15xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x15x15xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.hardswish: (4x192x15x15xf32) <- (4x192x15x15xf32)
        hardswish_46 = paddle._C_ops.hardswish(batch_norm__276)

        # pd_op.conv2d: (4x192x15x15xf32) <- (4x192x15x15xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x15x15xf32) <- (4x192x15x15xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x8x8xf32) <- (4x96x15x15xf32, 96x1x5x5xf32)
        depthwise_conv2d_23 = paddle._C_ops.depthwise_conv2d(
            hardswish_29, parameter_183, [2, 2], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_183

        # pd_op.batch_norm_: (4x96x8x8xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x8x8xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__300,
            batch_norm__301,
            batch_norm__302,
        ...
        # pd_op.hardswish: (4x96x8x8xf32) <- (4x96x8x8xf32)
        hardswish_50 = paddle._C_ops.hardswish(batch_norm__300)

        # pd_op.conv2d: (4x96x8x8xf32) <- (4x96x8x8xf32, 96x96x1x1xf32)
        ...
        # pd_op.add: (4x96x8x8xf32) <- (4x96x8x8xf32, 4x96x8x8xf32)
        add_4 = paddle._C_ops.add(hardswish_51, hardswish_53)

        # pd_op.shape64: (4xi64) <- (4x96x60x60xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x60x60xf32) <- (4x96x60x60xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x60x60xf32) <- (4x96x60x60xf32, 96x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x60x60xf32) <- (4x96x60x60xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x60x60xf32) <- (4x4x60x60xf32, 1x4x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_37, reshape_5)

        # pd_op.conv2d: (4x32x60x60xf32) <- (4x96x60x60xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x60x60xf32) <- (4x32x60x60xf32, 1x32x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_38, reshape_6)

        # pd_op.conv2d: (4x1x60x60xf32) <- (4x96x60x60xf32, 1x96x5x5xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            hardswish_57, parameter_132, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_132

        # pd_op.batch_norm_: (4x1x60x60xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x60x60xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__354,
            batch_norm__355,
            batch_norm__356,
        ...
        # pd_op.hardswish: (4x1x60x60xf32) <- (4x1x60x60xf32)
        hardswish_59 = paddle._C_ops.hardswish(batch_norm__354)

        # pd_op.conv2d: (4x1x60x60xf32) <- (4x1x60x60xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (4x1x60x60xf32) <- (4x1x60x60xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__360)
        del batch_norm__360

        # pd_op.sigmoid: (4x4x60x60xf32) <- (4x4x60x60xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_6)
        del add_6

        # pd_op.multiply: (4x4x60x60xf32) <- (4x4x60x60xf32, 4x1x60x60xf32)
        ...
        # pd_op.scale: (4x4x60x60xf32) <- (4x4x60x60xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(multiply_3, full_1, float("1e-09"), True)
        del multiply_3

        # pd_op.sqrt: (4x4x60x60xf32) <- (4x4x60x60xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_0)
        del scale_0

        # pd_op.transpose: (4x60x60x4xf32) <- (4x4x60x60xf32)
        transpose_0 = paddle._C_ops.transpose(sqrt_0, [0, 2, 3, 1])

        # pd_op.transpose: (4x60x60x32xf32) <- (4x32x60x60xf32)
        ...
        # pd_op.flatten: (3600xf32) <- (60x60xf32)
        ...
        # builtin.combine: ([3600xf32, 3600xf32]) <- (3600xf32, 3600xf32)
        combine_5 = [flatten_1, flatten_0]
        del flatten_0, flatten_1

        # pd_op.stack: (3600x2xf32) <- ([3600xf32, 3600xf32])
        ...
        # pd_op.reshape: (4x3600x4xf32) <- (4x60x60x4xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([4x3600x2xf32, 4x3600x2xf32]) <- (4x3600x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_10, 2, full_6)
        del reshape_10

        # builtin.split: (4x3600x2xf32, 4x3600x2xf32) <- ([4x3600x2xf32, 4x3600x2xf32])
        (
            split_2,
            split_3,
        ) = split_with_num_0
        ...
        # pd_op.scale: (4x3600x2xf32) <- (4x3600x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_2, full_7, float("0"), True)
        del split_2

        # pd_op.add: (4x3600x2xf32) <- (4x3600x2xf32, 3600x2xf32)
        ...
        # builtin.combine: ([4x3600x2xf32, 4x3600x2xf32]) <- (4x3600x2xf32, 4x3600x2xf32)
        combine_6 = [add_8, add_9]

        # pd_op.concat: (4x3600x4xf32) <- ([4x3600x2xf32, 4x3600x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_8)
        del combine_6

        # pd_op.flatten: (4x4x3600xf32) <- (4x4x60x60xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (4x3600x4xf32) <- (4x4x3600xf32)
        transpose_2 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])
        del flatten_2

        # pd_op.flatten: (4x32x3600xf32) <- (4x32x60x60xf32)
        flatten_3 = paddle._C_ops.flatten(add_7, 2, 3)

        # pd_op.transpose: (4x3600x32xf32) <- (4x32x3600xf32)
        ...
        # pd_op.scale: (4x3600x4xf32) <- (4x3600x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_7, full_9, float("0"), True)
        del concat_7

        # pd_op.shape64: (4xi64) <- (4x96x30x30xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x30x30xf32) <- (4x96x30x30xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x4x30x30xf32) <- (4x96x30x30xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x30x30xf32) <- (4x4x30x30xf32, 1x4x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_45, reshape_12)

        # pd_op.conv2d: (4x32x30x30xf32) <- (4x96x30x30xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x30x30xf32) <- (4x32x30x30xf32, 1x32x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_46, reshape_13)

        # pd_op.conv2d: (4x1x30x30xf32) <- (4x96x30x30xf32, 1x96x5x5xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            hardswish_63, parameter_91, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_91

        # pd_op.batch_norm_: (4x1x30x30xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x30x30xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__396,
            batch_norm__397,
            batch_norm__398,
        ...
        # pd_op.hardswish: (4x1x30x30xf32) <- (4x1x30x30xf32)
        hardswish_65 = paddle._C_ops.hardswish(batch_norm__396)

        # pd_op.conv2d: (4x1x30x30xf32) <- (4x1x30x30xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (4x1x30x30xf32) <- (4x1x30x30xf32)
        sigmoid_4 = paddle._C_ops.sigmoid(batch_norm__402)
        del batch_norm__402

        # pd_op.sigmoid: (4x4x30x30xf32) <- (4x4x30x30xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_11)
        del add_11

        # pd_op.multiply: (4x4x30x30xf32) <- (4x4x30x30xf32, 4x1x30x30xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (4x4x30x30xf32) <- (4x4x30x30xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)
        del multiply_5

        # pd_op.sqrt: (4x4x30x30xf32) <- (4x4x30x30xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_6)
        del scale_6

        # pd_op.transpose: (4x30x30x4xf32) <- (4x4x30x30xf32)
        transpose_4 = paddle._C_ops.transpose(sqrt_1, [0, 2, 3, 1])

        # pd_op.transpose: (4x30x30x32xf32) <- (4x32x30x30xf32)
        ...
        # pd_op.flatten: (900xf32) <- (30x30xf32)
        ...
        # pd_op.scale: (4x900x2xf32) <- (4x900x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_6, full_7, float("0"), True)
        del split_6

        # pd_op.add: (4x900x2xf32) <- (4x900x2xf32, 900x2xf32)
        add_13 = paddle._C_ops.add(scale_10, stack_1)

        # pd_op.add: (4x900x2xf32) <- (4x900x2xf32, 900x2xf32)
        add_14 = paddle._C_ops.add(split_7, stack_1)

        # builtin.combine: ([4x900x2xf32, 4x900x2xf32]) <- (4x900x2xf32, 4x900x2xf32)
        combine_9 = [add_13, add_14]

        # pd_op.concat: (4x900x4xf32) <- ([4x900x2xf32, 4x900x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_8)
        del combine_9

        # pd_op.flatten: (4x4x900xf32) <- (4x4x30x30xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (4x900x4xf32) <- (4x4x900xf32)
        transpose_6 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])
        del flatten_6

        # pd_op.flatten: (4x32x900xf32) <- (4x32x30x30xf32)
        flatten_7 = paddle._C_ops.flatten(add_12, 2, 3)

        # pd_op.transpose: (4x900x32xf32) <- (4x32x900xf32)
        ...
        # pd_op.scale: (4x900x4xf32) <- (4x900x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_8, full_12, float("0"), True)
        del concat_8

        # pd_op.shape64: (4xi64) <- (4x96x15x15xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x15x15xf32) <- (4x96x15x15xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x15x15xf32, 2xi64)
        ...
        # pd_op.multiply: (4x96x15x15xf32) <- (4x96x15x15xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x15x15xf32) <- (4x96x15x15xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x15x15xf32) <- (4x4x15x15xf32, 1x4x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_53, reshape_19)

        # pd_op.conv2d: (4x32x15x15xf32) <- (4x96x15x15xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x15x15xf32) <- (4x32x15x15xf32, 1x32x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_54, reshape_20)

        # pd_op.conv2d: (4x1x15x15xf32) <- (4x96x15x15xf32, 1x96x5x5xf32)
        conv2d_55 = paddle._C_ops.conv2d(
            hardswish_69, parameter_50, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_50

        # pd_op.batch_norm_: (4x1x15x15xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x15x15xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__438,
            batch_norm__439,
            batch_norm__440,
        ...
        # pd_op.hardswish: (4x1x15x15xf32) <- (4x1x15x15xf32)
        hardswish_71 = paddle._C_ops.hardswish(batch_norm__438)

        # pd_op.conv2d: (4x1x15x15xf32) <- (4x1x15x15xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (4x1x15x15xf32) <- (4x1x15x15xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__444)
        del batch_norm__444

        # pd_op.sigmoid: (4x4x15x15xf32) <- (4x4x15x15xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_16)
        del add_16

        # pd_op.multiply: (4x4x15x15xf32) <- (4x4x15x15xf32, 4x1x15x15xf32)
        multiply_7 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (4x4x15x15xf32) <- (4x4x15x15xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_7, full_1, float("1e-09"), True)
        del multiply_7

        # pd_op.sqrt: (4x4x15x15xf32) <- (4x4x15x15xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_12)
        del scale_12

        # pd_op.transpose: (4x15x15x4xf32) <- (4x4x15x15xf32)
        transpose_8 = paddle._C_ops.transpose(sqrt_2, [0, 2, 3, 1])

        # pd_op.transpose: (4x15x15x32xf32) <- (4x32x15x15xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_12 = [4, 225, 4]

        # pd_op.reshape: (4x225x4xf32) <- (900x4xf32, 3xi64)
        reshape_24 = paddle._C_ops.reshape(scale_15, full_int_array_12)
        del full_int_array_12

        # pd_op.split_with_num: ([4x225x2xf32, 4x225x2xf32]) <- (4x225x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(reshape_24, 2, full_6)
        del reshape_24

        # builtin.split: (4x225x2xf32, 4x225x2xf32) <- ([4x225x2xf32, 4x225x2xf32])
        (
            split_10,
            split_11,
        ) = split_with_num_2
        ...
        # pd_op.scale: (4x225x2xf32) <- (4x225x2xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(split_10, full_7, float("0"), True)
        del split_10

        # pd_op.add: (4x225x2xf32) <- (4x225x2xf32, 225x2xf32)
        add_18 = paddle._C_ops.add(scale_16, stack_2)

        # pd_op.add: (4x225x2xf32) <- (4x225x2xf32, 225x2xf32)
        add_19 = paddle._C_ops.add(split_11, stack_2)

        # builtin.combine: ([4x225x2xf32, 4x225x2xf32]) <- (4x225x2xf32, 4x225x2xf32)
        combine_12 = [add_18, add_19]

        # pd_op.concat: (4x225x4xf32) <- ([4x225x2xf32, 4x225x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_8)
        del combine_12

        # pd_op.flatten: (4x4x225xf32) <- (4x4x15x15xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (4x225x4xf32) <- (4x4x225xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])
        del flatten_10

        # pd_op.flatten: (4x32x225xf32) <- (4x32x15x15xf32)
        flatten_11 = paddle._C_ops.flatten(add_17, 2, 3)

        # pd_op.transpose: (4x225x32xf32) <- (4x32x225xf32)
        ...
        # pd_op.scale: (4x225x4xf32) <- (4x225x4xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(concat_9, full_15, float("0"), True)
        del concat_9

        # pd_op.shape64: (4xi64) <- (4x96x8x8xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x8x8xf32) <- (4x96x8x8xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x8x8xf32, 2xi64)
        ...
        # pd_op.multiply: (4x96x8x8xf32) <- (4x96x8x8xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x8x8xf32) <- (4x96x8x8xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x8x8xf32) <- (4x4x8x8xf32, 1x4x1x1xf32)
        add_21 = paddle._C_ops.add(conv2d_61, reshape_26)

        # pd_op.conv2d: (4x32x8x8xf32) <- (4x96x8x8xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x8x8xf32) <- (4x32x8x8xf32, 1x32x1x1xf32)
        add_22 = paddle._C_ops.add(conv2d_62, reshape_27)

        # pd_op.conv2d: (4x1x8x8xf32) <- (4x96x8x8xf32, 1x96x5x5xf32)
        conv2d_63 = paddle._C_ops.conv2d(
            hardswish_75, parameter_9, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_9

        # pd_op.batch_norm_: (4x1x8x8xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x8x8xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__480,
            batch_norm__481,
            batch_norm__482,
        ...
        # pd_op.hardswish: (4x1x8x8xf32) <- (4x1x8x8xf32)
        hardswish_77 = paddle._C_ops.hardswish(batch_norm__480)

        # pd_op.conv2d: (4x1x8x8xf32) <- (4x1x8x8xf32, 1x1x1x1xf32)
        ...
        # pd_op.scale: (4x64x4xf32) <- (4x64x4xf32, 1xf32)
        scale_23 = paddle._C_ops.scale(concat_10, full_18, float("0"), True)
        del concat_10

        # builtin.combine: ([4x3600x4xf32, 4x900x4xf32, 4x225x4xf32, 4x64x4xf32]) <- (4x3600x4xf32, 4x900x4xf32, 4x225x4xf32, 4x64x4xf32)
        combine_16 = [transpose_2, transpose_6, transpose_10, transpose_14]

        # pd_op.concat: (4x4789x4xf32) <- ([4x3600x4xf32, 4x900x4xf32, 4x225x4xf32, 4x64x4xf32], 1xi32)
        ...
        # builtin.combine: ([4x3600x32xf32, 4x900x32xf32, 4x225x32xf32, 4x64x32xf32]) <- (4x3600x32xf32, 4x900x32xf32, 4x225x32xf32, 4x64x32xf32)
        combine_18 = [transpose_3, transpose_7, transpose_11, transpose_15]

        # pd_op.concat: (4x4789x32xf32) <- ([4x3600x32xf32, 4x900x32xf32, 4x225x32xf32, 4x64x32xf32], 1xi32)
