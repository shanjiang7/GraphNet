...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.maximum: (4x2x2577x2xf32) <- (4x2x1x2xf32, 4x1x2577x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (4x2x2577x2xf32) <- (4x2x1x2xf32, 4x1x2577x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (4x2x2577x2xf32) <- (4x2x2577x2xf32, 4x2x2577x2xf32)
        ...
        # pd_op.clip: (4x2x2577x2xf32) <- (4x2x2577x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (4x2x2577xf32) <- (4x2x2577x2xf32, 1xi64)
        ...
        # pd_op.add: (4x2x2577xf32) <- (4x2x1xf32, 4x1x2577xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (4x2x2577xf32) <- (4x2x2577xf32, 4x2x2577xf32)
        ...
        # pd_op.scale: (4x2x2577xf32) <- (4x2x2577xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)
        del full_2, subtract_3

        # pd_op.divide: (4x2x2577xf32) <- (4x2x2577xf32, 4x2x2577xf32)
        ...
        # pd_op.split_with_num: ([4x2x1x1xf32, 4x2x1x1xf32, 4x2x1x1xf32, 4x2x1x1xf32]) <- (4x2x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_0, 4, full_6)
        del full_6, unsqueeze_0

        # builtin.split: (4x2x1x1xf32, 4x2x1x1xf32, 4x2x1x1xf32, 4x2x1x1xf32) <- ([4x2x1x1xf32, 4x2x1x1xf32, 4x2x1x1xf32, 4x2x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (4x2x2577x1xf32) <- (1x1x2577x1xf32, 4x2x1x1xf32)
        ...
        # pd_op.subtract: (4x2x2577x1xf32) <- (4x2x1x1xf32, 1x1x2577x1xf32)
        ...
        # builtin.combine: ([4x2x2577x1xf32, 4x2x2577x1xf32, 4x2x2577x1xf32, 4x2x2577x1xf32]) <- (4x2x2577x1xf32, 4x2x2577x1xf32, 4x2x2577x1xf32, 4x2x2577x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (4x2x2577x4xf32) <- ([4x2x2577x1xf32, 4x2x2577x1xf32, 4x2x2577x1xf32, 4x2x2577x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.min: (4x2x2577xf32) <- (4x2x2577x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (4x2x2577xb) <- (4x2x2577xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)
        del full_8, min_0

        # pd_op.cast: (4x2x2577xf32) <- (4x2x2577xb)
        ...
        # pd_op.topk: (4x2x13xf32, 4x2x13xi64) <- (4x2x2577xf32, 1xi32)
        ...
        # pd_op.one_hot: (4x2x13x2577xf32) <- (4x2x13xi64, 1xi32)
        ...
        # pd_op.sum: (4x2x2577xf32) <- (4x2x13x2577xf32, 1xi64)
        ...
        # pd_op.sum: (4x2577xf32) <- (4x2x2577xf32, 1xi64)
