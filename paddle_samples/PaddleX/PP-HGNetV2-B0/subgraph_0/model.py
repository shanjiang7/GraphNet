...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        multiply_0 = paddle._C_ops.multiply(data_24, relu_0)
        del data_24

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_1 = paddle._C_ops.add(multiply_0, data_25)
        del data_25
        ...
        multiply_1 = paddle._C_ops.multiply(data_26, relu_1)
        del data_26

        # pd_op.add: (-1x8x112x112xf32) <- (-1x8x112x112xf32, 1xf32)
        add_2 = paddle._C_ops.add(multiply_1, data_27)
        del data_27
        ...
        # pd_op.multiply: (-1x16x112x112xf32) <- (1xf32, -1x16x112x112xf32)
        multiply_2 = paddle._C_ops.multiply(data_28, relu_2)
        del data_28

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_3 = paddle._C_ops.add(multiply_2, data_29)
        del data_29
        ...
        multiply_3 = paddle._C_ops.multiply(data_30, relu_3)
        del data_30

        # pd_op.add: (-1x16x56x56xf32) <- (-1x16x56x56xf32, 1xf32)
        add_4 = paddle._C_ops.add(multiply_3, data_31)
        del data_31
        ...
        # pd_op.multiply: (-1x16x56x56xf32) <- (1xf32, -1x16x56x56xf32)
        multiply_4 = paddle._C_ops.multiply(data_32, relu_4)
        del data_32

        # pd_op.add: (-1x16x56x56xf32) <- (-1x16x56x56xf32, 1xf32)
        add_5 = paddle._C_ops.add(multiply_4, data_33)
        del data_33
        ...
        # pd_op.multiply: (-1x16x56x56xf32) <- (1xf32, -1x16x56x56xf32)
        multiply_5 = paddle._C_ops.multiply(data_34, relu_5)
        del data_34

        # pd_op.add: (-1x16x56x56xf32) <- (-1x16x56x56xf32, 1xf32)
        add_6 = paddle._C_ops.add(multiply_5, data_35)
        del data_35
        ...
        # pd_op.multiply: (-1x16x56x56xf32) <- (1xf32, -1x16x56x56xf32)
        multiply_6 = paddle._C_ops.multiply(data_36, relu_6)
        del data_36

        # pd_op.add: (-1x16x56x56xf32) <- (-1x16x56x56xf32, 1xf32)
        add_7 = paddle._C_ops.add(multiply_6, data_37)
        del data_37
        ...
        # pd_op.multiply: (-1x16x56x56xf32) <- (1xf32, -1x16x56x56xf32)
        multiply_7 = paddle._C_ops.multiply(data_38, relu_7)
        del data_38

        # pd_op.add: (-1x16x56x56xf32) <- (-1x16x56x56xf32, 1xf32)
        add_8 = paddle._C_ops.add(multiply_7, data_39)
        del data_39
        ...
        multiply_8 = paddle._C_ops.multiply(data_40, relu_8)
        del data_40

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_9 = paddle._C_ops.add(multiply_8, data_41)
        del data_41
        ...
        multiply_9 = paddle._C_ops.multiply(data_42, relu_9)
        del data_42

        # pd_op.add: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 1xf32)
        add_10 = paddle._C_ops.add(multiply_9, data_43)
        del data_43
        ...
        multiply_10 = paddle._C_ops.multiply(data_44, relu_10)
        del data_44

        # pd_op.add: (-1x32x28x28xf32) <- (-1x32x28x28xf32, 1xf32)
        add_11 = paddle._C_ops.add(multiply_10, data_45)
        del data_45
        ...
        # pd_op.multiply: (-1x32x28x28xf32) <- (1xf32, -1x32x28x28xf32)
        multiply_11 = paddle._C_ops.multiply(data_46, relu_11)
        del data_46

        # pd_op.add: (-1x32x28x28xf32) <- (-1x32x28x28xf32, 1xf32)
        add_12 = paddle._C_ops.add(multiply_11, data_47)
        del data_47
        ...
        # pd_op.multiply: (-1x32x28x28xf32) <- (1xf32, -1x32x28x28xf32)
        multiply_12 = paddle._C_ops.multiply(data_48, relu_12)
        del data_48

        # pd_op.add: (-1x32x28x28xf32) <- (-1x32x28x28xf32, 1xf32)
        add_13 = paddle._C_ops.add(multiply_12, data_49)
        del data_49
        ...
        multiply_13 = paddle._C_ops.multiply(data_50, relu_13)
        del data_50

        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 1xf32)
        add_14 = paddle._C_ops.add(multiply_13, data_51)
        del data_51
        ...
        multiply_14 = paddle._C_ops.multiply(data_52, relu_14)
        del data_52

        # pd_op.add: (-1x256x28x28xf32) <- (-1x256x28x28xf32, 1xf32)
        add_15 = paddle._C_ops.add(multiply_14, data_53)
        del data_53
        ...
        multiply_15 = paddle._C_ops.multiply(data_54, relu_15)
        del data_54

        # pd_op.add: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 1xf32)
        add_16 = paddle._C_ops.add(multiply_15, data_55)
        del data_55
        ...
        # pd_op.multiply: (-1x64x14x14xf32) <- (1xf32, -1x64x14x14xf32)
        multiply_16 = paddle._C_ops.multiply(data_56, relu_16)
        del data_56

        # pd_op.add: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 1xf32)
        add_17 = paddle._C_ops.add(multiply_16, data_57)
        del data_57
        ...
        # pd_op.multiply: (-1x64x14x14xf32) <- (1xf32, -1x64x14x14xf32)
        multiply_17 = paddle._C_ops.multiply(data_58, relu_17)
        del data_58

        # pd_op.add: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 1xf32)
        add_18 = paddle._C_ops.add(multiply_17, data_59)
        del data_59
        ...
        multiply_18 = paddle._C_ops.multiply(data_60, relu_18)
        del data_60

        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 1xf32)
        add_19 = paddle._C_ops.add(multiply_18, data_61)
        del data_61
        ...
        multiply_19 = paddle._C_ops.multiply(data_0, relu_19)
        del data_0

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_20 = paddle._C_ops.add(multiply_19, data_1)
        del data_1
        ...
        # pd_op.multiply: (-1x64x14x14xf32) <- (1xf32, -1x64x14x14xf32)
        multiply_20 = paddle._C_ops.multiply(data_2, relu_20)
        del data_2

        # pd_op.add: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 1xf32)
        add_21 = paddle._C_ops.add(multiply_20, data_3)
        del data_3
        ...
        # pd_op.multiply: (-1x64x14x14xf32) <- (1xf32, -1x64x14x14xf32)
        multiply_21 = paddle._C_ops.multiply(data_4, relu_21)
        del data_4

        # pd_op.add: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 1xf32)
        add_22 = paddle._C_ops.add(multiply_21, data_5)
        del data_5
        ...
        # pd_op.multiply: (-1x64x14x14xf32) <- (1xf32, -1x64x14x14xf32)
        multiply_22 = paddle._C_ops.multiply(data_6, relu_22)
        del data_6

        # pd_op.add: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 1xf32)
        add_23 = paddle._C_ops.add(multiply_22, data_7)
        del data_7
        ...
        # pd_op.multiply: (-1x256x14x14xf32) <- (1xf32, -1x256x14x14xf32)
        multiply_23 = paddle._C_ops.multiply(data_8, relu_23)
        del data_8

        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 1xf32)
        add_24 = paddle._C_ops.add(multiply_23, data_9)
        del data_9
        ...
        # pd_op.multiply: (-1x512x14x14xf32) <- (1xf32, -1x512x14x14xf32)
        multiply_24 = paddle._C_ops.multiply(data_10, relu_24)
        del data_10

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_25 = paddle._C_ops.add(multiply_24, data_11)
        del data_11
        ...
        multiply_25 = paddle._C_ops.multiply(data_12, relu_25)
        del data_12

        # pd_op.add: (-1x128x7x7xf32) <- (-1x128x7x7xf32, 1xf32)
        add_27 = paddle._C_ops.add(multiply_25, data_13)
        del data_13
        ...
        # pd_op.multiply: (-1x128x7x7xf32) <- (1xf32, -1x128x7x7xf32)
        multiply_26 = paddle._C_ops.multiply(data_14, relu_26)
        del data_14

        # pd_op.add: (-1x128x7x7xf32) <- (-1x128x7x7xf32, 1xf32)
        add_28 = paddle._C_ops.add(multiply_26, data_15)
        del data_15
        ...
        # pd_op.multiply: (-1x128x7x7xf32) <- (1xf32, -1x128x7x7xf32)
        multiply_27 = paddle._C_ops.multiply(data_16, relu_27)
        del data_16

        # pd_op.add: (-1x128x7x7xf32) <- (-1x128x7x7xf32, 1xf32)
        add_29 = paddle._C_ops.add(multiply_27, data_17)
        del data_17
        ...
        multiply_28 = paddle._C_ops.multiply(data_18, relu_28)
        del data_18

        # pd_op.add: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 1xf32)
        add_30 = paddle._C_ops.add(multiply_28, data_19)
        del data_19
        ...
        multiply_29 = paddle._C_ops.multiply(data_20, relu_29)
        del data_20

        # pd_op.add: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32, 1xf32)
        add_31 = paddle._C_ops.add(multiply_29, data_21)
        del data_21
        ...
        multiply_30 = paddle._C_ops.multiply(data_22, relu_30)
        del data_22

        # pd_op.add: (-1x2048x1x1xf32) <- (-1x2048x1x1xf32, 1xf32)
        add_32 = paddle._C_ops.add(multiply_30, data_23)
        del data_23
