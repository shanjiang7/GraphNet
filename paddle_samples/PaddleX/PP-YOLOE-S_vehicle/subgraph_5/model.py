...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.unsqueeze: (2x1x7581x4xf32) <- (2x7581x4xf32, 1xi64)
        ...
        # pd_op.slice: (2x1x1x2xf32) <- (2x1x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.slice: (2x1x7581x2xf32) <- (2x1x7581x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (2x1x7581x2xf32) <- (2x1x1x2xf32, 2x1x7581x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (2x1x7581x2xf32) <- (2x1x1x2xf32, 2x1x7581x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (2x1x7581x2xf32) <- (2x1x7581x2xf32, 2x1x7581x2xf32)
        ...
        # pd_op.clip: (2x1x7581x2xf32) <- (2x1x7581x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (2x1x7581xf32) <- (2x1x7581x2xf32, 1xi64)
        prod_0 = paddle._C_ops.prod(clip_0, full_int_array_4, False, False)
        del clip_0

        # pd_op.subtract: (2x1x1x2xf32) <- (2x1x1x2xf32, 2x1x1x2xf32)
        subtract_1 = paddle._C_ops.subtract(slice_1, slice_0)
        del slice_0, slice_1

        # pd_op.clip: (2x1x1x2xf32) <- (2x1x1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, full_0, full_1)
        del subtract_1

        # pd_op.prod: (2x1x1xf32) <- (2x1x1x2xf32, 1xi64)
        ...
        # pd_op.add: (2x1x7581xf32) <- (2x1x1xf32, 2x1x7581xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (2x1x7581xf32) <- (2x1x7581xf32, 2x1x7581xf32)
        ...
        # pd_op.scale: (2x1x7581xf32) <- (2x1x7581xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)
        del full_2, subtract_3

        # pd_op.divide: (2x1x7581xf32) <- (2x1x7581xf32, 2x1x7581xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.transpose: (2x4x7581xf32) <- (2x7581x4xf32)
        ...
        # pd_op.unsqueeze: (1x1x7581x2xf32) <- (7581x2xf32, 2xi64)
        ...
        # pd_op.split_with_num: ([1x1x7581x1xf32, 1x1x7581x1xf32]) <- (1x1x7581x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_3, 2, full_6)
        del unsqueeze_3

        # builtin.split: (1x1x7581x1xf32, 1x1x7581x1xf32) <- ([1x1x7581x1xf32, 1x1x7581x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.split_with_num: ([2x1x1x1xf32, 2x1x1x1xf32, 2x1x1x1xf32, 2x1x1x1xf32]) <- (2x1x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_0, 4, full_6)
        del full_6, unsqueeze_0

        # builtin.split: (2x1x1x1xf32, 2x1x1x1xf32, 2x1x1x1xf32, 2x1x1x1xf32) <- ([2x1x1x1xf32, 2x1x1x1xf32, 2x1x1x1xf32, 2x1x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (2x1x7581x1xf32) <- (2x1x1x1xf32, 1x1x7581x1xf32)
        ...
        # builtin.combine: ([2x1x7581x1xf32, 2x1x7581x1xf32, 2x1x7581x1xf32, 2x1x7581x1xf32]) <- (2x1x7581x1xf32, 2x1x7581x1xf32, 2x1x7581x1xf32, 2x1x7581x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (2x1x7581x4xf32) <- ([2x1x7581x1xf32, 2x1x7581x1xf32, 2x1x7581x1xf32, 2x1x7581x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.min: (2x1x7581xf32) <- (2x1x7581x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x1x7581xb) <- (2x1x7581xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)
        del full_8, min_0

        # pd_op.cast: (2x1x7581xf32) <- (2x1x7581xb)
        ...
        # pd_op.topk: (2x1x13xf32, 2x1x13xi64) <- (2x1x7581xf32, 1xi32)
        ...
        full_10 = paddle._C_ops.full(
            [1], float("7581"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (2x1x13x7581xf32) <- (2x1x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x1x7581xf32) <- (2x1x13x7581xf32, 1xi64)
        ...
        # pd_op.sum: (2x7581xf32) <- (2x1x7581xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (2x7581xf32, 0xi64)
