...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.unsqueeze: (4x4x1x4xf32) <- (4x4x4xf32, 1xi64)
        ...
        # pd_op.slice: (4x4x1x2xf32) <- (4x4x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (4x4x2577x2xf32) <- (4x4x1x2xf32, 4x1x2577x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (4x4x2577x2xf32) <- (4x4x1x2xf32, 4x1x2577x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (4x4x2577x2xf32) <- (4x4x2577x2xf32, 4x4x2577x2xf32)
        ...
        # pd_op.clip: (4x4x2577x2xf32) <- (4x4x2577x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.prod: (4x4x2577xf32) <- (4x4x2577x2xf32, 1xi64)
        prod_0 = paddle._C_ops.prod(clip_0, full_int_array_4, False, False)
        del clip_0

        # pd_op.subtract: (4x4x1x2xf32) <- (4x4x1x2xf32, 4x4x1x2xf32)
        subtract_1 = paddle._C_ops.subtract(slice_1, slice_0)
        del slice_0, slice_1

        # pd_op.clip: (4x4x1x2xf32) <- (4x4x1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, full_0, full_1)
        del subtract_1

        # pd_op.prod: (4x4x1xf32) <- (4x4x1x2xf32, 1xi64)
        ...
        # pd_op.add: (4x4x2577xf32) <- (4x4x1xf32, 4x1x2577xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (4x4x2577xf32) <- (4x4x2577xf32, 4x4x2577xf32)
        ...
        # pd_op.scale: (4x4x2577xf32) <- (4x4x2577xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)
        del full_2, subtract_3

        # pd_op.divide: (4x4x2577xf32) <- (4x4x2577xf32, 4x4x2577xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.transpose: (4x4x2577xf32) <- (4x2577x4xf32)
        ...
        # pd_op.unsqueeze: (1x1x2577x2xf32) <- (2577x2xf32, 2xi64)
        ...
        # pd_op.split_with_num: ([1x1x2577x1xf32, 1x1x2577x1xf32]) <- (1x1x2577x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_3, 2, full_6)
        del unsqueeze_3

        # builtin.split: (1x1x2577x1xf32, 1x1x2577x1xf32) <- ([1x1x2577x1xf32, 1x1x2577x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.split_with_num: ([4x4x1x1xf32, 4x4x1x1xf32, 4x4x1x1xf32, 4x4x1x1xf32]) <- (4x4x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_0, 4, full_6)
        del full_6, unsqueeze_0

        # builtin.split: (4x4x1x1xf32, 4x4x1x1xf32, 4x4x1x1xf32, 4x4x1x1xf32) <- ([4x4x1x1xf32, 4x4x1x1xf32, 4x4x1x1xf32, 4x4x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (4x4x2577x1xf32) <- (1x1x2577x1xf32, 4x4x1x1xf32)
        ...
        # pd_op.subtract: (4x4x2577x1xf32) <- (4x4x1x1xf32, 1x1x2577x1xf32)
        ...
        # builtin.combine: ([4x4x2577x1xf32, 4x4x2577x1xf32, 4x4x2577x1xf32, 4x4x2577x1xf32]) <- (4x4x2577x1xf32, 4x4x2577x1xf32, 4x4x2577x1xf32, 4x4x2577x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (4x4x2577x4xf32) <- ([4x4x2577x1xf32, 4x4x2577x1xf32, 4x4x2577x1xf32, 4x4x2577x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.min: (4x4x2577xf32) <- (4x4x2577x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (4x4x2577xb) <- (4x4x2577xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)
        del full_8, min_0

        # pd_op.cast: (4x4x2577xf32) <- (4x4x2577xb)
        ...
        # pd_op.topk: (4x4x13xf32, 4x4x13xi64) <- (4x4x2577xf32, 1xi32)
        ...
        full_10 = paddle._C_ops.full(
            [1], float("2577"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (4x4x13x2577xf32) <- (4x4x13xi64, 1xi32)
        ...
        # pd_op.sum: (4x4x2577xf32) <- (4x4x13x2577xf32, 1xi64)
        ...
        # pd_op.sum: (4x2577xf32) <- (4x4x2577xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (4x2577xf32, 0xi64)
