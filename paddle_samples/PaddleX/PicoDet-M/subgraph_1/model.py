...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x24x-1x-1xf32) <- (4x3x-1x-1xf32, 24x3x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32, 96x1x3x3xf32)
        ...
        # pd_op.pool2d: (4x384x1x1xf32) <- (4x384x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (4x384x-1x-1xf32) <- (4x384x-1x-1xf32, 4x384x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (4x768x-1x-1xf32) <- (4x384x-1x-1xf32, 768x384x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_397, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_397

        # pd_op.batch_norm_: (4x768x-1x-1xf32, 768xf32, 768xf32, 768xf32, 768xf32, -1xui8) <- (4x768x-1x-1xf32, 768xf32, 768xf32, 768xf32, 768xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (4x768x-1x-1xf32) <- (4x768x-1x-1xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (4x768x-1x-1xf32) <- (4x768x-1x-1xf32, 768x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x768x1x1xf32) <- (4x768x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (4x768x-1x-1xf32) <- (4x768x-1x-1xf32, 4x768x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (4x768x-1x-1xf32) <- (4x768x-1x-1xf32, 768x768x1x1xf32)
        ...
        # pd_op.multiply: (4x128x-1x-1xf32) <- (4x128x-1x-1xf32, 4x128x1x1xf32)
        multiply_8 = paddle._C_ops.multiply(hardswish_81, sigmoid_6)

        # pd_op.conv2d: (4x128x-1x-1xf32) <- (4x128x-1x-1xf32, 128x128x1x1xf32)
        conv2d_58 = paddle._C_ops.conv2d(
            multiply_8, parameter_79, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_79
        ...
        # pd_op.multiply: (4x128x-1x-1xf32) <- (4x128x-1x-1xf32, 4x128x1x1xf32)
        multiply_11 = paddle._C_ops.multiply(hardswish_91, sigmoid_9)
