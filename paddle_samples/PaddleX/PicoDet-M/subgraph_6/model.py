...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.transpose: (4x4x-1xf32) <- (4x-1x4xf32)
        ...
        # pd_op.tile: (4x-1xi32) <- (4x1xi32, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_2, stack_0)
        del stack_0

        # pd_op.squeeze: (4x-1xi32) <- (4x-1x1xi32, 1xi64)
        squeeze_0 = paddle._C_ops.squeeze(data_4, full_int_array_4)
        del data_4

        # builtin.combine: ([4x-1xi32, 4x-1xi32]) <- (4x-1xi32, 4x-1xi32)
        combine_1 = [tile_0, squeeze_0]
        del squeeze_0, tile_0

        # pd_op.stack: (4x-1x2xi32) <- ([4x-1xi32, 4x-1xi32])
        stack_1 = paddle._C_ops.stack(combine_1, -1)
        del combine_1

        # pd_op.gather_nd: (4x-1x-1xf32) <- (4x4x-1xf32, 4x-1x2xi32)
        ...
        # pd_op.topk: (4x-1x13xf32, 4x-1x13xi64) <- (4x-1x-1xf32, 1xi32)
        ...
        # pd_op.one_hot: (4x-1x13x-1xf32) <- (4x-1x13xi64, xi64)
        ...
        # pd_op.sum: (4x-1x-1xf32) <- (4x-1x13x-1xf32, 1xi64)
