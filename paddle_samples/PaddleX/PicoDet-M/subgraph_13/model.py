...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x24x240x240xf32) <- (4x3x480x480xf32, 24x3x3x3xf32)
        ...
        # pd_op.hardswish: (4x24x240x240xf32) <- (4x24x240x240xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (4x24x240x240xf32) <- (4x24x240x240xf32, 24x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            hardswish_0, parameter_516, [1, 1], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del parameter_516
        ...
        # pd_op.conv2d: (4x48x240x240xf32) <- (4x24x240x240xf32, 48x24x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_511, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_511

        # pd_op.batch_norm_: (4x48x240x240xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (4x48x240x240xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (4x48x240x240xf32) <- (4x48x240x240xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (4x48x120x120xf32) <- (4x48x240x240xf32, 48x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_506, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del parameter_506

        # pd_op.batch_norm_: (4x48x120x120xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (4x48x120x120xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (4x48x120x120xf32) <- (4x48x120x120xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (4x96x120x120xf32) <- (4x48x120x120xf32, 96x48x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_501, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_501

        # pd_op.batch_norm_: (4x96x120x120xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x120x120xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (4x96x120x120xf32) <- (4x96x120x120xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (4x96x120x120xf32) <- (4x96x120x120xf32, 96x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_4, parameter_496, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_496
        ...
        # pd_op.conv2d: (4x96x120x120xf32) <- (4x96x120x120xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x60x60xf32) <- (4x96x120x120xf32, 96x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_486, [2, 2], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del parameter_486
        ...
        # pd_op.conv2d: (4x192x60x60xf32) <- (4x96x60x60xf32, 192x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x192x60x60xf32) <- (4x192x60x60xf32, 192x1x3x3xf32)
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_8, parameter_476, [1, 1], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_476
        ...
        # pd_op.depthwise_conv2d: (4x192x30x30xf32) <- (4x192x60x60xf32, 192x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_466, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del parameter_466
        ...
        # pd_op.conv2d: (4x384x30x30xf32) <- (4x192x30x30xf32, 384x192x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_461, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_461

        # pd_op.batch_norm_: (4x384x30x30xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (4x384x30x30xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (4x384x30x30xf32) <- (4x384x30x30xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (4x384x30x30xf32) <- (4x384x30x30xf32, 384x1x5x5xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_12, parameter_456, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_456
        ...
        # pd_op.conv2d: (4x384x30x30xf32) <- (4x384x30x30xf32, 384x384x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_14, parameter_446, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_446
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_16, parameter_436, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_436
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_18, parameter_426, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_426
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_20, parameter_416, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_416
        ...
        # pd_op.depthwise_conv2d: (4x384x15x15xf32) <- (4x384x30x30xf32, 384x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_406, [2, 2], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_406

        # pd_op.batch_norm_: (4x384x15x15xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (4x384x15x15xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (4x384x15x15xf32) <- (4x384x15x15xf32)
        ...
        # pd_op.pool2d: (4x384x1x1xf32) <- (4x384x15x15xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x96x1x1xf32) <- (4x384x1x1xf32, 96x384x1x1xf32)
        ...
        # pd_op.multiply: (4x384x15x15xf32) <- (4x384x15x15xf32, 4x384x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (4x768x15x15xf32) <- (4x384x15x15xf32, 768x384x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_397, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_397

        # pd_op.batch_norm_: (4x768x15x15xf32, 768xf32, 768xf32, 768xf32, 768xf32, -1xui8) <- (4x768x15x15xf32, 768xf32, 768xf32, 768xf32, 768xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (4x768x15x15xf32) <- (4x768x15x15xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (4x768x15x15xf32) <- (4x768x15x15xf32, 768x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_24, parameter_392, [1, 1], [2, 2], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        del parameter_392
        ...
        # pd_op.pool2d: (4x768x1x1xf32) <- (4x768x15x15xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x192x1x1xf32) <- (4x768x1x1xf32, 192x768x1x1xf32)
        ...
        # pd_op.relu: (4x192x1x1xf32) <- (4x192x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_2)
        del add_2

        # pd_op.conv2d: (4x768x1x1xf32) <- (4x192x1x1xf32, 768x192x1x1xf32)
        ...
        # pd_op.hardsigmoid: (4x768x1x1xf32) <- (4x768x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(
            add_3, float("0.166667"), float("0.5")
        )
        del add_3

        # pd_op.multiply: (4x768x15x15xf32) <- (4x768x15x15xf32, 4x768x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (4x768x15x15xf32) <- (4x768x15x15xf32, 768x768x1x1xf32)
        ...
        # pd_op.conv2d: (4x128x60x60xf32) <- (4x192x60x60xf32, 128x192x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            hardswish_10, parameter_378, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_378

        # pd_op.batch_norm_: (4x128x60x60xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x60x60xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.hardswish: (4x128x60x60xf32) <- (4x128x60x60xf32)
        hardswish_27 = paddle._C_ops.hardswish(batch_norm__162)

        # pd_op.conv2d: (4x128x30x30xf32) <- (4x384x30x30xf32, 128x384x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            hardswish_22, parameter_373, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_373

        # pd_op.batch_norm_: (4x128x30x30xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x30x30xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.hardswish: (4x128x30x30xf32) <- (4x128x30x30xf32)
        hardswish_28 = paddle._C_ops.hardswish(batch_norm__168)

        # pd_op.conv2d: (4x128x15x15xf32) <- (4x768x15x15xf32, 128x768x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_26, parameter_368, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_368

        # pd_op.batch_norm_: (4x128x15x15xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x15x15xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (4x128x15x15xf32) <- (4x128x15x15xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.nearest_interp: (4x128x30x30xf32) <- (4x128x15x15xf32, None, None, None)
        ...
        # builtin.combine: ([4x128x30x30xf32, 4x128x30x30xf32]) <- (4x128x30x30xf32, 4x128x30x30xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (4x256x30x30xf32) <- ([4x128x30x30xf32, 4x128x30x30xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0

        # pd_op.depthwise_conv2d: (4x256x30x30xf32) <- (4x256x30x30xf32, 256x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_363, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_363

        # pd_op.batch_norm_: (4x256x30x30xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x30x30xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__180,
            batch_norm__181,
            batch_norm__182,
        ...
        # pd_op.hardswish: (4x256x30x30xf32) <- (4x256x30x30xf32)
        hardswish_30 = paddle._C_ops.hardswish(batch_norm__180)

        # pd_op.conv2d: (4x256x30x30xf32) <- (4x256x30x30xf32, 256x256x1x1xf32)
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            hardswish_31, parameter_353, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_353
        ...
        # pd_op.conv2d: (4x128x30x30xf32) <- (4x256x30x30xf32, 128x256x1x1xf32)
        ...
        # pd_op.nearest_interp: (4x128x60x60xf32) <- (4x128x30x30xf32, None, None, None)
        ...
        # builtin.combine: ([4x128x60x60xf32, 4x128x60x60xf32]) <- (4x128x60x60xf32, 4x128x60x60xf32)
        combine_1 = [nearest_interp_1, hardswish_27]

        # pd_op.concat: (4x256x60x60xf32) <- ([4x128x60x60xf32, 4x128x60x60xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (4x256x60x60xf32) <- (4x256x60x60xf32, 256x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            concat_4, parameter_343, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_343

        # pd_op.batch_norm_: (4x256x60x60xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x60x60xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (4x256x60x60xf32) <- (4x256x60x60xf32)
        hardswish_34 = paddle._C_ops.hardswish(batch_norm__204)

        # pd_op.conv2d: (4x256x60x60xf32) <- (4x256x60x60xf32, 256x256x1x1xf32)
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            hardswish_35, parameter_333, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_333
        ...
        # pd_op.conv2d: (4x128x60x60xf32) <- (4x256x60x60xf32, 128x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x128x30x30xf32) <- (4x128x60x60xf32, 128x1x5x5xf32)
        depthwise_conv2d_17 = paddle._C_ops.depthwise_conv2d(
            hardswish_37, parameter_323, [2, 2], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_323
        ...
        # pd_op.conv2d: (4x128x30x30xf32) <- (4x128x30x30xf32, 128x128x1x1xf32)
        ...
        depthwise_conv2d_18 = paddle._C_ops.depthwise_conv2d(
            concat_5, parameter_313, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_313
        ...
        depthwise_conv2d_19 = paddle._C_ops.depthwise_conv2d(
            hardswish_41, parameter_303, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_303
        ...
        # pd_op.depthwise_conv2d: (4x128x15x15xf32) <- (4x128x30x30xf32, 128x1x5x5xf32)
        depthwise_conv2d_20 = paddle._C_ops.depthwise_conv2d(
            hardswish_43, parameter_293, [2, 2], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_293
        ...
        # pd_op.conv2d: (4x128x15x15xf32) <- (4x128x15x15xf32, 128x128x1x1xf32)
        ...
        # builtin.combine: ([4x128x15x15xf32, 4x128x15x15xf32]) <- (4x128x15x15xf32, 4x128x15x15xf32)
        combine_3 = [hardswish_45, hardswish_29]

        # pd_op.concat: (4x256x15x15xf32) <- ([4x128x15x15xf32, 4x128x15x15xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_3, full_0)
        del combine_3

        # pd_op.depthwise_conv2d: (4x256x15x15xf32) <- (4x256x15x15xf32, 256x1x5x5xf32)
        depthwise_conv2d_21 = paddle._C_ops.depthwise_conv2d(
            concat_6, parameter_283, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_283

        # pd_op.batch_norm_: (4x256x15x15xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x15x15xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.hardswish: (4x256x15x15xf32) <- (4x256x15x15xf32)
        hardswish_46 = paddle._C_ops.hardswish(batch_norm__276)

        # pd_op.conv2d: (4x256x15x15xf32) <- (4x256x15x15xf32, 256x256x1x1xf32)
        ...
        depthwise_conv2d_22 = paddle._C_ops.depthwise_conv2d(
            hardswish_47, parameter_273, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_273
        ...
        # pd_op.conv2d: (4x128x15x15xf32) <- (4x256x15x15xf32, 128x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x128x8x8xf32) <- (4x128x15x15xf32, 128x1x5x5xf32)
        depthwise_conv2d_23 = paddle._C_ops.depthwise_conv2d(
            hardswish_29, parameter_263, [2, 2], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_263

        # pd_op.batch_norm_: (4x128x8x8xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x8x8xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__300,
            batch_norm__301,
            batch_norm__302,
        ...
        # pd_op.hardswish: (4x128x8x8xf32) <- (4x128x8x8xf32)
        hardswish_50 = paddle._C_ops.hardswish(batch_norm__300)

        # pd_op.conv2d: (4x128x8x8xf32) <- (4x128x8x8xf32, 128x128x1x1xf32)
        ...
        depthwise_conv2d_24 = paddle._C_ops.depthwise_conv2d(
            hardswish_49, parameter_253, [2, 2], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_253
        ...
        # pd_op.add: (4x128x8x8xf32) <- (4x128x8x8xf32, 4x128x8x8xf32)
        add_4 = paddle._C_ops.add(hardswish_51, hardswish_53)

        # pd_op.shape64: (4xi64) <- (4x128x60x60xf32)
        ...
        # pd_op.depthwise_conv2d: (4x128x60x60xf32) <- (4x128x60x60xf32, 128x1x5x5xf32)
        depthwise_conv2d_25 = paddle._C_ops.depthwise_conv2d(
            hardswish_37, parameter_243, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_243
        ...
        # pd_op.conv2d: (4x128x60x60xf32) <- (4x128x60x60xf32, 128x128x1x1xf32)
        ...
        depthwise_conv2d_26 = paddle._C_ops.depthwise_conv2d(
            hardswish_55, parameter_233, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_233
        ...
        depthwise_conv2d_27 = paddle._C_ops.depthwise_conv2d(
            hardswish_57, parameter_223, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_223
        ...
        depthwise_conv2d_28 = paddle._C_ops.depthwise_conv2d(
            hardswish_59, parameter_213, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_213
        ...
        # pd_op.pool2d: (4x128x1x1xf32) <- (4x128x60x60xf32, 2xi64)
        ...
        # pd_op.multiply: (4x128x60x60xf32) <- (4x128x60x60xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x60x60xf32) <- (4x128x60x60xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x32x60x60xf32) <- (4x128x60x60xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x1x60x60xf32) <- (4x128x60x60xf32, 1x128x5x5xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x128x30x30xf32)
        ...
        # pd_op.depthwise_conv2d: (4x128x30x30xf32) <- (4x128x30x30xf32, 128x1x5x5xf32)
        depthwise_conv2d_29 = paddle._C_ops.depthwise_conv2d(
            hardswish_43, parameter_182, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_182
        ...
        depthwise_conv2d_30 = paddle._C_ops.depthwise_conv2d(
            hardswish_65, parameter_172, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_172
        ...
        depthwise_conv2d_31 = paddle._C_ops.depthwise_conv2d(
            hardswish_67, parameter_162, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_162
        ...
        depthwise_conv2d_32 = paddle._C_ops.depthwise_conv2d(
            hardswish_69, parameter_152, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_152
        ...
        # pd_op.pool2d: (4x128x1x1xf32) <- (4x128x30x30xf32, 2xi64)
        ...
        # pd_op.multiply: (4x128x30x30xf32) <- (4x128x30x30xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x30x30xf32) <- (4x128x30x30xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x32x30x30xf32) <- (4x128x30x30xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x1x30x30xf32) <- (4x128x30x30xf32, 1x128x5x5xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x128x15x15xf32)
        ...
        # pd_op.depthwise_conv2d: (4x128x15x15xf32) <- (4x128x15x15xf32, 128x1x5x5xf32)
        depthwise_conv2d_33 = paddle._C_ops.depthwise_conv2d(
            hardswish_49, parameter_121, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_121
        ...
        depthwise_conv2d_34 = paddle._C_ops.depthwise_conv2d(
            hardswish_75, parameter_111, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_111
        ...
        depthwise_conv2d_35 = paddle._C_ops.depthwise_conv2d(
            hardswish_77, parameter_101, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_101
        ...
        depthwise_conv2d_36 = paddle._C_ops.depthwise_conv2d(
            hardswish_79, parameter_91, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_91
        ...
        # pd_op.pool2d: (4x128x1x1xf32) <- (4x128x15x15xf32, 2xi64)
        ...
        # pd_op.multiply: (4x128x15x15xf32) <- (4x128x15x15xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x15x15xf32) <- (4x128x15x15xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x32x15x15xf32) <- (4x128x15x15xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x1x15x15xf32) <- (4x128x15x15xf32, 1x128x5x5xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x128x8x8xf32)
        ...
        # pd_op.depthwise_conv2d: (4x128x8x8xf32) <- (4x128x8x8xf32, 128x1x5x5xf32)
        depthwise_conv2d_37 = paddle._C_ops.depthwise_conv2d(
            add_4, parameter_60, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_60
        ...
        depthwise_conv2d_38 = paddle._C_ops.depthwise_conv2d(
            hardswish_85, parameter_50, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_50
        ...
        depthwise_conv2d_39 = paddle._C_ops.depthwise_conv2d(
            hardswish_87, parameter_40, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_40
        ...
        depthwise_conv2d_40 = paddle._C_ops.depthwise_conv2d(
            hardswish_89, parameter_30, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_30
        ...
        # pd_op.pool2d: (4x128x1x1xf32) <- (4x128x8x8xf32, 2xi64)
        ...
        # pd_op.multiply: (4x128x8x8xf32) <- (4x128x8x8xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x8x8xf32) <- (4x128x8x8xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x32x8x8xf32) <- (4x128x8x8xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (4x1x8x8xf32) <- (4x128x8x8xf32, 1x128x5x5xf32)
