...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        combine_0 = [full_3, full_4, data_0]
        del data_0, full_3, full_4
        ...
        slice_9 = paddle._C_ops.slice(
            data_1, [1], full_int_array_3, full_int_array_6, [1], [1]
        )
        ...
        slice_11 = paddle._C_ops.slice(
            data_1, [1], full_int_array_6, full_int_array_7, [1], [1]
        )
        del data_1, full_int_array_6, full_int_array_7
