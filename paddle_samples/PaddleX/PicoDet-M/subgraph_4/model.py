...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (8x24x208x208xf32) <- (8x3x416x416xf32, 24x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_521, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_521

        # pd_op.batch_norm_: (8x24x208x208xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (8x24x208x208xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (8x24x208x208xf32) <- (8x24x208x208xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)
        del batch_norm__0

        # pd_op.depthwise_conv2d: (8x24x208x208xf32) <- (8x24x208x208xf32, 24x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x48x208x208xf32) <- (8x24x208x208xf32, 48x24x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_511, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_1, parameter_511

        # pd_op.batch_norm_: (8x48x208x208xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (8x48x208x208xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (8x48x208x208xf32) <- (8x48x208x208xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)
        del batch_norm__12

        # pd_op.depthwise_conv2d: (8x48x104x104xf32) <- (8x48x208x208xf32, 48x1x3x3xf32)
        ...
        # pd_op.batch_norm_: (8x48x104x104xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (8x48x104x104xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (8x48x104x104xf32) <- (8x48x104x104xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)
        del batch_norm__18

        # pd_op.conv2d: (8x96x104x104xf32) <- (8x48x104x104xf32, 96x48x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_501, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_3, parameter_501

        # pd_op.batch_norm_: (8x96x104x104xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (8x96x104x104xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (8x96x104x104xf32) <- (8x96x104x104xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)
        del batch_norm__24

        # pd_op.depthwise_conv2d: (8x96x104x104xf32) <- (8x96x104x104xf32, 96x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x96x104x104xf32) <- (8x96x104x104xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x96x52x52xf32) <- (8x96x104x104xf32, 96x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x192x52x52xf32) <- (8x96x52x52xf32, 192x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x192x52x52xf32) <- (8x192x52x52xf32, 192x1x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (8x192x26x26xf32) <- (8x192x52x52xf32, 192x1x3x3xf32)
        ...
        # pd_op.conv2d: (8x384x26x26xf32) <- (8x192x26x26xf32, 384x192x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_461, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_11, parameter_461

        # pd_op.batch_norm_: (8x384x26x26xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (8x384x26x26xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (8x384x26x26xf32) <- (8x384x26x26xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)
        del batch_norm__72

        # pd_op.depthwise_conv2d: (8x384x26x26xf32) <- (8x384x26x26xf32, 384x1x5x5xf32)
        ...
        # pd_op.conv2d: (8x384x26x26xf32) <- (8x384x26x26xf32, 384x384x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x384x13x13xf32) <- (8x384x26x26xf32, 384x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_406, [2, 2], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del parameter_406

        # pd_op.batch_norm_: (8x384x13x13xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (8x384x13x13xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (8x384x13x13xf32) <- (8x384x13x13xf32)
        ...
        # pd_op.pool2d: (8x384x1x1xf32) <- (8x384x13x13xf32, 2xi64)
        ...
        # pd_op.multiply: (8x384x13x13xf32) <- (8x384x13x13xf32, 8x384x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)
        del hardsigmoid_0, hardswish_23

        # pd_op.conv2d: (8x768x13x13xf32) <- (8x384x13x13xf32, 768x384x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_1, parameter_397, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del multiply_1, parameter_397

        # pd_op.batch_norm_: (8x768x13x13xf32, 768xf32, 768xf32, 768xf32, 768xf32, -1xui8) <- (8x768x13x13xf32, 768xf32, 768xf32, 768xf32, 768xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (8x768x13x13xf32) <- (8x768x13x13xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)
        del batch_norm__144

        # pd_op.depthwise_conv2d: (8x768x13x13xf32) <- (8x768x13x13xf32, 768x1x5x5xf32)
        ...
        # pd_op.pool2d: (8x768x1x1xf32) <- (8x768x13x13xf32, 2xi64)
        ...
        # pd_op.conv2d: (8x192x1x1xf32) <- (8x768x1x1xf32, 192x768x1x1xf32)
        ...
        # pd_op.relu: (8x192x1x1xf32) <- (8x192x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_2)
        del add_2

        # pd_op.conv2d: (8x768x1x1xf32) <- (8x192x1x1xf32, 768x192x1x1xf32)
        ...
        # pd_op.multiply: (8x768x13x13xf32) <- (8x768x13x13xf32, 8x768x1x1xf32)
        multiply_2 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)
        del hardsigmoid_1, hardswish_25

        # pd_op.conv2d: (8x768x13x13xf32) <- (8x768x13x13xf32, 768x768x1x1xf32)
        ...
        # pd_op.conv2d: (8x128x52x52xf32) <- (8x192x52x52xf32, 128x192x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            hardswish_10, parameter_378, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_10, parameter_378

        # pd_op.batch_norm_: (8x128x52x52xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (8x128x52x52xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.hardswish: (8x128x52x52xf32) <- (8x128x52x52xf32)
        hardswish_27 = paddle._C_ops.hardswish(batch_norm__162)
        del batch_norm__162

        # pd_op.conv2d: (8x128x26x26xf32) <- (8x384x26x26xf32, 128x384x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            hardswish_22, parameter_373, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_22, parameter_373

        # pd_op.batch_norm_: (8x128x26x26xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (8x128x26x26xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.hardswish: (8x128x26x26xf32) <- (8x128x26x26xf32)
        hardswish_28 = paddle._C_ops.hardswish(batch_norm__168)
        del batch_norm__168

        # pd_op.conv2d: (8x128x13x13xf32) <- (8x768x13x13xf32, 128x768x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_26, parameter_368, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del hardswish_26, parameter_368

        # pd_op.batch_norm_: (8x128x13x13xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (8x128x13x13xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (8x128x13x13xf32) <- (8x128x13x13xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__174)
        del batch_norm__174

        # pd_op.nearest_interp: (8x128x26x26xf32) <- (8x128x13x13xf32, None, None, None)
        ...
        # builtin.combine: ([8x128x26x26xf32, 8x128x26x26xf32]) <- (8x128x26x26xf32, 8x128x26x26xf32)
        combine_0 = [nearest_interp_0, hardswish_28]
        del hardswish_28, nearest_interp_0

        # pd_op.concat: (8x256x26x26xf32) <- ([8x128x26x26xf32, 8x128x26x26xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0

        # pd_op.depthwise_conv2d: (8x256x26x26xf32) <- (8x256x26x26xf32, 256x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            concat_1, parameter_363, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del concat_1, parameter_363

        # pd_op.batch_norm_: (8x256x26x26xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (8x256x26x26xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__180,
            batch_norm__181,
            batch_norm__182,
        ...
        # pd_op.hardswish: (8x256x26x26xf32) <- (8x256x26x26xf32)
        hardswish_30 = paddle._C_ops.hardswish(batch_norm__180)
        del batch_norm__180

        # pd_op.conv2d: (8x256x26x26xf32) <- (8x256x26x26xf32, 256x256x1x1xf32)
        ...
        # pd_op.conv2d: (8x128x26x26xf32) <- (8x256x26x26xf32, 128x256x1x1xf32)
        ...
        # pd_op.nearest_interp: (8x128x52x52xf32) <- (8x128x26x26xf32, None, None, None)
        ...
        # builtin.combine: ([8x128x52x52xf32, 8x128x52x52xf32]) <- (8x128x52x52xf32, 8x128x52x52xf32)
        combine_1 = [nearest_interp_1, hardswish_27]
        del hardswish_27, nearest_interp_1

        # pd_op.concat: (8x256x52x52xf32) <- ([8x128x52x52xf32, 8x128x52x52xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (8x256x52x52xf32) <- (8x256x52x52xf32, 256x1x5x5xf32)
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            concat_2, parameter_343, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del concat_2, parameter_343

        # pd_op.batch_norm_: (8x256x52x52xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (8x256x52x52xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__204,
            batch_norm__205,
            batch_norm__206,
        ...
        # pd_op.hardswish: (8x256x52x52xf32) <- (8x256x52x52xf32)
        hardswish_34 = paddle._C_ops.hardswish(batch_norm__204)
        del batch_norm__204

        # pd_op.conv2d: (8x256x52x52xf32) <- (8x256x52x52xf32, 256x256x1x1xf32)
        ...
        # pd_op.conv2d: (8x128x52x52xf32) <- (8x256x52x52xf32, 128x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x128x26x26xf32) <- (8x128x52x52xf32, 128x1x5x5xf32)
        ...
        # pd_op.conv2d: (8x128x26x26xf32) <- (8x128x26x26xf32, 128x128x1x1xf32)
        ...
        depthwise_conv2d_18 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_313, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (8x128x13x13xf32) <- (8x128x26x26xf32, 128x1x5x5xf32)
        ...
        # pd_op.conv2d: (8x128x13x13xf32) <- (8x128x13x13xf32, 128x128x1x1xf32)
        ...
        # builtin.combine: ([8x128x13x13xf32, 8x128x13x13xf32]) <- (8x128x13x13xf32, 8x128x13x13xf32)
        combine_3 = [hardswish_45, hardswish_29]
        del hardswish_45

        # pd_op.concat: (8x256x13x13xf32) <- ([8x128x13x13xf32, 8x128x13x13xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_3, full_0)
        del combine_3

        # pd_op.depthwise_conv2d: (8x256x13x13xf32) <- (8x256x13x13xf32, 256x1x5x5xf32)
        depthwise_conv2d_21 = paddle._C_ops.depthwise_conv2d(
            concat_4, parameter_283, [1, 1], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del concat_4, parameter_283

        # pd_op.batch_norm_: (8x256x13x13xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (8x256x13x13xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.hardswish: (8x256x13x13xf32) <- (8x256x13x13xf32)
        hardswish_46 = paddle._C_ops.hardswish(batch_norm__276)
        del batch_norm__276

        # pd_op.conv2d: (8x256x13x13xf32) <- (8x256x13x13xf32, 256x256x1x1xf32)
        ...
        # pd_op.conv2d: (8x128x13x13xf32) <- (8x256x13x13xf32, 128x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (8x128x7x7xf32) <- (8x128x13x13xf32, 128x1x5x5xf32)
        ...
        # pd_op.batch_norm_: (8x128x7x7xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (8x128x7x7xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__300,
            batch_norm__301,
            batch_norm__302,
        ...
        # pd_op.hardswish: (8x128x7x7xf32) <- (8x128x7x7xf32)
        hardswish_50 = paddle._C_ops.hardswish(batch_norm__300)
        del batch_norm__300

        # pd_op.conv2d: (8x128x7x7xf32) <- (8x128x7x7xf32, 128x128x1x1xf32)
        ...
        # pd_op.add: (8x128x7x7xf32) <- (8x128x7x7xf32, 8x128x7x7xf32)
        add_4 = paddle._C_ops.add(hardswish_51, hardswish_53)
        del hardswish_51, hardswish_53

        # pd_op.depthwise_conv2d: (8x128x52x52xf32) <- (8x128x52x52xf32, 128x1x5x5xf32)
        ...
        # pd_op.conv2d: (8x128x52x52xf32) <- (8x128x52x52xf32, 128x128x1x1xf32)
        ...
        # pd_op.pool2d: (8x128x1x1xf32) <- (8x128x52x52xf32, 2xi64)
        ...
        # pd_op.conv2d: (8x128x1x1xf32) <- (8x128x1x1xf32, 128x128x1x1xf32)
        ...
        # pd_op.sigmoid: (8x128x1x1xf32) <- (8x128x1x1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(add_5)
        del add_5

        # pd_op.multiply: (8x128x52x52xf32) <- (8x128x52x52xf32, 8x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x4x52x52xf32) <- (8x128x52x52xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x32x52x52xf32) <- (8x128x52x52xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x1x52x52xf32) <- (8x128x52x52xf32, 1x128x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (8x128x26x26xf32) <- (8x128x26x26xf32, 128x1x5x5xf32)
        ...
        # pd_op.pool2d: (8x128x1x1xf32) <- (8x128x26x26xf32, 2xi64)
        ...
        # pd_op.multiply: (8x128x26x26xf32) <- (8x128x26x26xf32, 8x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x4x26x26xf32) <- (8x128x26x26xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x32x26x26xf32) <- (8x128x26x26xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x1x26x26xf32) <- (8x128x26x26xf32, 1x128x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (8x128x13x13xf32) <- (8x128x13x13xf32, 128x1x5x5xf32)
        ...
        # pd_op.pool2d: (8x128x1x1xf32) <- (8x128x13x13xf32, 2xi64)
        ...
        # pd_op.multiply: (8x128x13x13xf32) <- (8x128x13x13xf32, 8x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x4x13x13xf32) <- (8x128x13x13xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x32x13x13xf32) <- (8x128x13x13xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x1x13x13xf32) <- (8x128x13x13xf32, 1x128x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (8x128x7x7xf32) <- (8x128x7x7xf32, 128x1x5x5xf32)
        ...
        # pd_op.pool2d: (8x128x1x1xf32) <- (8x128x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (8x128x7x7xf32) <- (8x128x7x7xf32, 8x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x4x7x7xf32) <- (8x128x7x7xf32, 4x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x32x7x7xf32) <- (8x128x7x7xf32, 32x128x1x1xf32)
        ...
        # pd_op.conv2d: (8x1x7x7xf32) <- (8x128x7x7xf32, 1x128x5x5xf32)
