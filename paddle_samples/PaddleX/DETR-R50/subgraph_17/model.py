...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        scale_1 = paddle._C_ops.scale(data_0, full_0, float("0"), True)
        del data_0
        ...
        equal_0 = paddle._C_ops.equal(add_2, full_1)
        del add_2
        ...
        slice_0 = paddle._C_ops.slice(
            data_12, [0], full_int_array_0, full_int_array_1, [1], [0]
        )

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_0 = paddle._C_ops.greater_than(data_4, full_1)
        del data_4
        ...
        gather_0 = paddle._C_ops.gather(slice_0, data_17, full_2)
        del data_17
        ...
        slice_1 = paddle._C_ops.slice(
            data_12, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_1 = paddle._C_ops.greater_than(data_5, full_1)
        del data_5
        ...
        # pd_op.gather: (-1x4xf32) <- (100x4xf32, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(slice_1, data_19, full_2)
        del data_19
        ...
        slice_2 = paddle._C_ops.slice(
            data_12, [0], full_int_array_2, full_int_array_3, [1], [0]
        )

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_2 = paddle._C_ops.greater_than(data_6, full_1)
        del data_6
        ...
        # pd_op.gather: (-1x4xf32) <- (100x4xf32, -1xi64, 1xi32)
        gather_2 = paddle._C_ops.gather(slice_2, data_21, full_2)
        del data_21
        ...
        slice_3 = paddle._C_ops.slice(
            data_12, [0], full_int_array_3, full_int_array_4, [1], [0]
        )
        del data_12

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_3 = paddle._C_ops.greater_than(data_7, full_1)
        del data_7
        ...
        # pd_op.gather: (-1x4xf32) <- (100x4xf32, -1xi64, 1xi32)
        gather_3 = paddle._C_ops.gather(slice_3, data_23, full_2)
        del data_23
        ...
        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_4 = paddle._C_ops.greater_than(data_8, full_1)
        del data_8
        ...
        gather_4 = paddle._C_ops.gather(data_13, data_18, full_2)
        del data_13, data_18

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_5 = paddle._C_ops.greater_than(data_9, full_1)
        del data_9
        ...
        # pd_op.gather: (-1x4xf32) <- (-1x4xf32, -1xi64, 1xi32)
        gather_5 = paddle._C_ops.gather(data_14, data_20, full_2)
        del data_14, data_20

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_6 = paddle._C_ops.greater_than(data_10, full_1)
        del data_10

        # pd_op.cast: (xi64) <- (xb)
        cast_14 = paddle._C_ops.cast(greater_than_6, paddle.int64)
        del greater_than_6

        # pd_op.not_equal: (xb) <- (xi64, xi64)
        not_equal_7 = paddle._C_ops.not_equal(cast_14, full_1)
        del cast_14

        # pd_op.cast: (xi64) <- (xb)
        cast_15 = paddle._C_ops.cast(not_equal_7, paddle.int64)
        del not_equal_7

        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_8 = paddle._C_ops.equal(cast_15, full_1)
        del cast_15

        # pd_op.gather: (-1x4xf32) <- (-1x4xf32, -1xi64, 1xi32)
        gather_6 = paddle._C_ops.gather(data_15, data_22, full_2)
        del data_15, data_22

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_7 = paddle._C_ops.greater_than(data_11, full_1)
        del data_11

        # pd_op.cast: (xi64) <- (xb)
        cast_16 = paddle._C_ops.cast(greater_than_7, paddle.int64)
        del greater_than_7

        # pd_op.not_equal: (xb) <- (xi64, xi64)
        not_equal_8 = paddle._C_ops.not_equal(cast_16, full_1)
        del cast_16

        # pd_op.cast: (xi64) <- (xb)
        cast_17 = paddle._C_ops.cast(not_equal_8, paddle.int64)
        del not_equal_8

        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_9 = paddle._C_ops.equal(cast_17, full_1)
        del cast_17, full_1

        # pd_op.gather: (-1x4xf32) <- (-1x4xf32, -1xi64, 1xi32)
        gather_7 = paddle._C_ops.gather(data_16, data_24, full_2)
        del data_16, data_24
        ...
        divide_0 = paddle._C_ops.divide(scale_2, data_25)
        ...
        add_3 = paddle._C_ops.add(split_0, scale_3)
        ...
        # pd_op.add: (-1x2xf32) <- (-1x2xf32, -1x2xf32)
        add_4 = paddle._C_ops.add(split_2, scale_4)
        del scale_4, split_2

        # builtin.combine: ([-1x2xf32, -1x2xf32]) <- (-1x2xf32, -1x2xf32)
        combine_3 = [subtract_2, add_4]
        del add_4, subtract_2
        ...
        add_5 = paddle._C_ops.add(multiply_1, multiply_2)

        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_9 = paddle._C_ops.subtract(add_5, multiply_0)
        ...
        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_3 = paddle._C_ops.divide(sum_1, data_25)
        del data_25
