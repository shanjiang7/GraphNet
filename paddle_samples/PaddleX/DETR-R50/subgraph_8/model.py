...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_2 = paddle._C_ops.scale(add_0, full_0, float("1"), True)
        del add_0

        # pd_op.cast: (xf32) <- (xi64)
        cast_0 = paddle._C_ops.cast(scale_2, paddle.float32)
        del scale_2
        ...
        del assign_1, assign_2, data_3, full_int_array_0, full_int_array_1
