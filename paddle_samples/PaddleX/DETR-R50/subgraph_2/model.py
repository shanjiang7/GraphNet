...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        scale_1 = paddle._C_ops.scale(data_0, full_1, float("2"), True)
        del data_0
        ...
        greater_than_0 = paddle._C_ops.greater_than(scale_2, full_2)
        del scale_2
        ...
        full_like_2 = paddle._C_ops.full_like(
            data_8, full_4, paddle.int64, paddle.framework._current_expected_place()
        )
        ...
        full_like_3 = paddle._C_ops.full_like(
            data_10, full_5, paddle.int64, paddle.framework._current_expected_place()
        )
        del full_5
        ...
        scale_3 = paddle._C_ops.scale(concat_0, full_7, float("0"), True)
        del concat_0, full_7

        # pd_op.add: (-1xi64) <- (-1xi64, -1xi64)
        add_0 = paddle._C_ops.add(concat_1, scale_3)
        del concat_1, scale_3

        # pd_op.gather: (1x1xi32) <- (1x1xi32, 1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(data_17, data_5, full_6)
        del data_17

        # pd_op.gather: (1x1xi32) <- (1x1xi32, 1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(data_18, data_7, full_6)
        del data_18

        # pd_op.gather: (-1x1xi32) <- (-1x1xi32, -1xi64, 1xi32)
        gather_2 = paddle._C_ops.gather(data_19, data_9, full_6)
        del data_19

        # pd_op.gather: (1x1xi32) <- (1x1xi32, 1xi64, 1xi32)
        gather_3 = paddle._C_ops.gather(data_20, data_11, full_6)
        del data_20
        ...
        scatter_0 = paddle._C_ops.scatter(reshape_0, add_0, cast_2, True)
        del add_0, cast_2, reshape_0
        ...
        cross_entropy_with_softmax_0, cross_entropy_with_softmax_1 = (
            ...
            paddle._C_ops.cross_entropy_with_softmax(
                data_16, unsqueeze_0, False, True, True, -100, -1
            ),
        ...
        gather_nd_0 = paddle._C_ops.gather_nd(data_23, multiply_0)
        del data_23, multiply_0
        ...
        add_1 = paddle._C_ops.add(sum_1, cast_5)
        del cast_5, sum_1
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_4 = paddle._C_ops.scale(data_1, full_1, float("2"), True)
        del data_1
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_2 = paddle._C_ops.equal(scale_5, full_2)
        del scale_5
        ...
        slice_0 = paddle._C_ops.slice(
            data_22, [0], full_int_array_5, full_int_array_6, [1], [0]
        )

        # pd_op.gather: (1x4xf32) <- (100x4xf32, 1xi64, 1xi32)
        gather_4 = paddle._C_ops.gather(slice_0, data_4, full_6)
        del data_4
        ...
        slice_1 = paddle._C_ops.slice(
            data_22, [0], full_int_array_6, full_int_array_7, [1], [0]
        )

        # pd_op.gather: (1x4xf32) <- (100x4xf32, 1xi64, 1xi32)
        gather_5 = paddle._C_ops.gather(slice_1, data_6, full_6)
        del data_6
        ...
        slice_2 = paddle._C_ops.slice(
            data_22, [0], full_int_array_7, full_int_array_8, [1], [0]
        )

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_1 = paddle._C_ops.greater_than(data_2, full_2)
        del data_2
        ...
        # pd_op.gather: (-1x4xf32) <- (100x4xf32, -1xi64, 1xi32)
        gather_6 = paddle._C_ops.gather(slice_2, data_8, full_6)
        del data_8
        ...
        slice_3 = paddle._C_ops.slice(
            data_22, [0], full_int_array_8, full_int_array_9, [1], [0]
        )
        del data_22

        # pd_op.gather: (1x4xf32) <- (100x4xf32, 1xi64, 1xi32)
        gather_7 = paddle._C_ops.gather(slice_3, data_10, full_6)
        del data_10
        ...
        gather_8 = paddle._C_ops.gather(data_12, data_5, full_6)
        del data_12, data_5

        # pd_op.gather: (1x4xf32) <- (1x4xf32, 1xi64, 1xi32)
        gather_9 = paddle._C_ops.gather(data_13, data_7, full_6)
        del data_13, data_7

        # pd_op.greater_than: (xb) <- (xi64, xi64)
        greater_than_2 = paddle._C_ops.greater_than(data_3, full_2)
        del data_3
        ...
        # pd_op.gather: (-1x4xf32) <- (-1x4xf32, -1xi64, 1xi32)
        gather_10 = paddle._C_ops.gather(data_14, data_9, full_6)
        del data_14, data_9

        # pd_op.gather: (1x4xf32) <- (1x4xf32, 1xi64, 1xi32)
        gather_11 = paddle._C_ops.gather(data_15, data_11, full_6)
        del data_11, data_15
        ...
        scale_6 = paddle._C_ops.scale(sum_2, full_10, float("0"), True)
        del sum_2

        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_0 = paddle._C_ops.divide(scale_6, data_21)
        ...
        scale_7 = paddle._C_ops.scale(split_1, full_12, float("0"), True)
        del split_1
        ...
        subtract_1 = paddle._C_ops.subtract(split_0, scale_7)

        # pd_op.add: (-1x2xf32) <- (-1x2xf32, -1x2xf32)
        add_2 = paddle._C_ops.add(split_0, scale_7)
        ...
        # pd_op.scale: (-1x2xf32) <- (-1x2xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(split_3, full_12, float("0"), True)
        del split_3

        # pd_op.subtract: (-1x2xf32) <- (-1x2xf32, -1x2xf32)
        subtract_2 = paddle._C_ops.subtract(split_2, scale_8)

        # pd_op.add: (-1x2xf32) <- (-1x2xf32, -1x2xf32)
        add_3 = paddle._C_ops.add(split_2, scale_8)
        del scale_8, split_2
        ...
        scale_9 = paddle._C_ops.scale(subtract_9, full_1, float("1e-10"), True)
        del subtract_9

        # pd_op.divide: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        divide_2 = paddle._C_ops.divide(multiply_3, scale_9)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(multiply_6, full_1, float("1e-10"), True)
        del multiply_6

        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_12 = paddle._C_ops.subtract(scale_10, scale_9)

        # pd_op.divide: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        divide_3 = paddle._C_ops.divide(subtract_12, scale_10)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(subtract_13, full_15, float("1"), True)
        del subtract_13

        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(scale_11, full_1, float("0"), True)
        del full_1, scale_11

        # pd_op.sum: (xf32) <- (-1x1xf32, 0xi64)
        sum_3 = paddle._C_ops.sum(scale_12, full_int_array_4, None, False)

        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_4 = paddle._C_ops.divide(sum_3, data_21)
        del data_21
