...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        scale_0 = paddle._C_ops.scale(data_0, full_1, float("1"), True)
        del data_0
        ...
        greater_than_0 = paddle._C_ops.greater_than(add_1, full_2)
        del add_1
        ...
        del data_10, data_12, data_14, data_8
        ...
        add_2 = paddle._C_ops.add(concat_1, scale_1)
        del concat_1, scale_1

        # pd_op.gather: (1x1xi32) <- (1x1xi32, 1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(data_4, data_9, full_6)
        del data_4, data_9

        # pd_op.gather: (-1x1xi32) <- (-1x1xi32, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(data_5, data_11, full_6)
        del data_11, data_5

        # pd_op.gather: (-1x1xi32) <- (-1x1xi32, -1xi64, 1xi32)
        gather_2 = paddle._C_ops.gather(data_6, data_13, full_6)
        del data_13, data_6

        # pd_op.gather: (-1x1xi32) <- (-1x1xi32, -1xi64, 1xi32)
        gather_3 = paddle._C_ops.gather(data_7, data_15, full_6)
        del data_15, data_7
        ...
        scatter_0 = paddle._C_ops.scatter(reshape_0, add_2, cast_2, True)
        del add_2, cast_2, reshape_0
        ...
        cross_entropy_with_softmax_0, cross_entropy_with_softmax_1 = (
            ...
            paddle._C_ops.cross_entropy_with_softmax(
                data_3, unsqueeze_0, False, True, True, -100, -1
            ),
        ...
        gather_nd_0 = paddle._C_ops.gather_nd(data_16, multiply_0)
        del data_16, multiply_0
        ...
        add_3 = paddle._C_ops.add(sum_1, cast_5)
        del cast_5, sum_1

        # pd_op.divide: (xf32) <- (xf32, xf32)
        divide_0 = paddle._C_ops.divide(sum_0, add_3)
        del (
            add_3,
