...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x256x248x-1xf32) <- (4x256x248x-1xf32, 256x256x3x3xf32)
        ...
        # pd_op.add: (4x256x248x-1xf32) <- (4x256x248x-1xf32, 1x256x1x1xf32)
        add_10 = paddle._C_ops.add(conv2d_0, reshape_5)

        # pd_op.relu: (4x256x248x-1xf32) <- (4x256x248x-1xf32)
        relu_0 = paddle._C_ops.relu(add_10)
        del add_10

        # pd_op.conv2d: (4x256x124x-1xf32) <- (4x256x124x-1xf32, 256x256x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            data_1, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_1

        # pd_op.add: (4x256x124x-1xf32) <- (4x256x124x-1xf32, 1x256x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_1, reshape_5)

        # pd_op.relu: (4x256x124x-1xf32) <- (4x256x124x-1xf32)
        relu_1 = paddle._C_ops.relu(add_11)
        del add_11

        # pd_op.conv2d: (4x256x62x-1xf32) <- (4x256x62x-1xf32, 256x256x3x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            data_2, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_2

        # pd_op.add: (4x256x62x-1xf32) <- (4x256x62x-1xf32, 1x256x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_2, reshape_5)

        # pd_op.relu: (4x256x62x-1xf32) <- (4x256x62x-1xf32)
        relu_2 = paddle._C_ops.relu(add_12)
        del add_12

        # pd_op.conv2d: (4x256x31x-1xf32) <- (4x256x31x-1xf32, 256x256x3x3xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            data_3, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_3

        # pd_op.add: (4x256x31x-1xf32) <- (4x256x31x-1xf32, 1x256x1x1xf32)
        add_13 = paddle._C_ops.add(conv2d_3, reshape_5)

        # pd_op.relu: (4x256x31x-1xf32) <- (4x256x31x-1xf32)
        ...
        # pd_op.conv2d: (4x3x248x-1xf32) <- (4x256x248x-1xf32, 3x256x1x1xf32)
        ...
        # pd_op.add: (4x3x248x-1xf32) <- (4x3x248x-1xf32, 1x3x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_5, reshape_6)

        # pd_op.conv2d: (4x12x248x-1xf32) <- (4x256x248x-1xf32, 12x256x1x1xf32)
        ...
        # pd_op.add: (4x12x248x-1xf32) <- (4x12x248x-1xf32, 1x12x1x1xf32)
        add_5 = paddle._C_ops.add(conv2d_6, reshape_7)

        # pd_op.conv2d: (4x3x124x-1xf32) <- (4x256x124x-1xf32, 3x256x1x1xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            relu_1, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (4x3x124x-1xf32) <- (4x3x124x-1xf32, 1x3x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_7, reshape_6)

        # pd_op.conv2d: (4x12x124x-1xf32) <- (4x256x124x-1xf32, 12x256x1x1xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            relu_1, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (4x12x124x-1xf32) <- (4x12x124x-1xf32, 1x12x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_8, reshape_7)

        # pd_op.conv2d: (4x3x62x-1xf32) <- (4x256x62x-1xf32, 3x256x1x1xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            relu_2, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (4x3x62x-1xf32) <- (4x3x62x-1xf32, 1x3x1x1xf32)
        add_2 = paddle._C_ops.add(conv2d_9, reshape_6)

        # pd_op.conv2d: (4x12x62x-1xf32) <- (4x256x62x-1xf32, 12x256x1x1xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            relu_2, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (4x12x62x-1xf32) <- (4x12x62x-1xf32, 1x12x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_10, reshape_7)

        # pd_op.conv2d: (4x3x31x-1xf32) <- (4x256x31x-1xf32, 3x256x1x1xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            relu_3, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (4x3x31x-1xf32) <- (4x3x31x-1xf32, 1x3x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_11, reshape_6)

        # pd_op.conv2d: (4x12x31x-1xf32) <- (4x256x31x-1xf32, 12x256x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            relu_3, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (4x12x31x-1xf32) <- (4x12x31x-1xf32, 1x12x1x1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x256x248x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x256x124x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x256x62x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x256x31x-1xf32)
        ...
        del full_int_array_1, full_int_array_2, shape64_4
        ...
        # builtin.combine: ([248xf32, -1xf32]) <- (248xf32, -1xf32)
        combine_0 = [arange_1, arange_0]
        del arange_0, arange_1

        # pd_op.meshgrid: ([248x-1xf32, 248x-1xf32]) <- ([248xf32, -1xf32])
        meshgrid_0 = paddle._C_ops.meshgrid(combine_0)
        del combine_0

        # builtin.split: (248x-1xf32, 248x-1xf32) <- ([248x-1xf32, 248x-1xf32])
        (
            split_0,
            split_1,
        ) = meshgrid_0
        ...
        # pd_op.reshape: (-1xf32) <- (248x-1xf32, 1xi64)
        ...
        reshape_0 = paddle._C_ops.reshape(add_15, full_int_array_6)
        del add_15
        ...
        # builtin.combine: ([124xf32, -1xf32]) <- (124xf32, -1xf32)
        combine_2 = [arange_3, arange_2]
        del arange_2, arange_3

        # pd_op.meshgrid: ([124x-1xf32, 124x-1xf32]) <- ([124xf32, -1xf32])
        meshgrid_1 = paddle._C_ops.meshgrid(combine_2)
        del combine_2

        # builtin.split: (124x-1xf32, 124x-1xf32) <- ([124x-1xf32, 124x-1xf32])
        (
            split_2,
            split_3,
        ) = meshgrid_1
        ...
        # pd_op.reshape: (-1xf32) <- (124x-1xf32, 1xi64)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_1 = paddle._C_ops.reshape(add_16, full_int_array_6)
        del add_16
        ...
        # builtin.combine: ([62xf32, -1xf32]) <- (62xf32, -1xf32)
        combine_4 = [arange_5, arange_4]
        del arange_4, arange_5

        # pd_op.meshgrid: ([62x-1xf32, 62x-1xf32]) <- ([62xf32, -1xf32])
        meshgrid_2 = paddle._C_ops.meshgrid(combine_4)
        del combine_4

        # builtin.split: (62x-1xf32, 62x-1xf32) <- ([62x-1xf32, 62x-1xf32])
        (
            split_4,
            split_5,
        ) = meshgrid_2
        ...
        # pd_op.reshape: (-1xf32) <- (62x-1xf32, 1xi64)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_2 = paddle._C_ops.reshape(add_17, full_int_array_6)
        del add_17
        ...
        # builtin.combine: ([31xf32, -1xf32]) <- (31xf32, -1xf32)
        combine_6 = [arange_7, arange_6]
        del arange_6, arange_7

        # pd_op.meshgrid: ([31x-1xf32, 31x-1xf32]) <- ([31xf32, -1xf32])
        meshgrid_3 = paddle._C_ops.meshgrid(combine_6)
        del combine_6

        # builtin.split: (31x-1xf32, 31x-1xf32) <- ([31x-1xf32, 31x-1xf32])
        (
            split_6,
            split_7,
        ) = meshgrid_3
        ...
        # pd_op.reshape: (-1xf32) <- (31x-1xf32, 1xi64)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_3 = paddle._C_ops.reshape(add_18, full_int_array_6)
        del add_18
        ...
        arange_9 = paddle.arange(full_2, full_12, full_13, dtype="float32")
        del full_12, full_13, full_2
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_4 = paddle._C_ops.reshape(add_19, full_int_array_6)
        del (
            add_19,
            assign_0,
            assign_1,
