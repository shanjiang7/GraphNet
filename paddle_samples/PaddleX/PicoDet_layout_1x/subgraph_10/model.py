...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.sigmoid: (-1x11xf32) <- (-1x11xf32)
        ...
        # pd_op.sigmoid_cross_entropy_with_logits: (-1x11xf32) <- (-1x11xf32, -1x11xf32, None)
        ...
        full_4 = paddle._C_ops.full(
            [1], float("0.00283286"), paddle.float32, paddle.core.CPUPlace()
        )
