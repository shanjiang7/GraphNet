...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        divide_0 = paddle._C_ops.divide(multiply_3, maximum_2)
        del multiply_3
        ...
        # pd_op.clip: (-1x-1x2xf32) <- (-1x-1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_6, full_3, full_4)
        del full_3, full_4, subtract_6
        ...
        del clip_1, full_int_array_0, full_int_array_3
        ...
        # pd_op.maximum: (-1x-1xf32) <- (-1x-1xf32, 1xf32)
        maximum_3 = paddle._C_ops.maximum(multiply_4, assign_value__0)
        del assign_value__0, multiply_4
        ...
        scale_0 = paddle._C_ops.scale(subtract_8, full_6, float("1"), True)
        del full_6, subtract_8
