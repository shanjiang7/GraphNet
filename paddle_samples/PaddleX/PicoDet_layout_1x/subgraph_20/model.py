...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.tile: (10105x-1xf32) <- (10105x1xf32, 2xi64)
        ...
        # pd_op.subtract: (10105x-1xf32) <- (10105x-1xf32, -1xf32)
        ...
        # pd_op.subtract: (10105x-1xf32) <- (-1xf32, 10105x-1xf32)
        ...
        # builtin.combine: ([10105x-1xf32, 10105x-1xf32, 10105x-1xf32, 10105x-1xf32]) <- (10105x-1xf32, 10105x-1xf32, 10105x-1xf32, 10105x-1xf32)
        combine_1 = [subtract_0, subtract_1, subtract_2, subtract_3]
        del subtract_0, subtract_1, subtract_2, subtract_3

        # pd_op.stack: (10105x4x-1xf32) <- ([10105x-1xf32, 10105x-1xf32, 10105x-1xf32, 10105x-1xf32])
        stack_1 = paddle._C_ops.stack(combine_1, 1)
        del combine_1

        # pd_op.min: (10105x-1xf32) <- (10105x4x-1xf32, 1xi64)
        ...
        # pd_op.greater_than: (10105x-1xb) <- (10105x-1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_2)
        del min_0

        # pd_op.sum: (10105xi64) <- (10105x-1xb, 1xi64)
        ...
        # pd_op.scale: (10105x-1xf32) <- (10105x-1xf32, 1xf32)
        ...
        # pd_op.add: (10105x-1xf32) <- (-1xf32, 10105x-1xf32)
        ...
        # pd_op.subtract: (10105x-1xf32) <- (10105x-1xf32, 10105x-1xf32)
        ...
        # pd_op.cast: (10105x-1xi64) <- (10105x-1xb)
        ...
        # pd_op.gather: (-1x-1xi64) <- (10105x-1xi64, -1xi64, 1xi32)
