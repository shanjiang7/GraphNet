...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        # pd_op.cast: (11664x11xf32) <- (11664x11xf64)
        ...
        # pd_op.greater_than: (11664x11xb) <- (11664x11xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_0)

        # pd_op.cast: (11664x11xf32) <- (11664x11xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)
        del greater_than_0

        # pd_op.multiply: (11664x11xf32) <- (11664x11xf32, 11664x11xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)
        del cast_1

        # pd_op.subtract: (11664x11xf32) <- (11664x11xf32, 11664x11xf32)
        subtract_0 = paddle._C_ops.subtract(data_1, cast_0)

        # pd_op.abs: (11664x11xf32) <- (11664x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)
        del subtract_0

        # pd_op.pow: (11664x11xf32) <- (11664x11xf32)
        ...
        # pd_op.scale: (11664x11xf32) <- (11664x11xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)
        del full_1, pow_0

        # pd_op.less_equal: (11664x11xb) <- (11664x11xf32, xf32)
        ...
        # pd_op.add: (11664x11xf32) <- (11664x11xf32, 11664x11xf32)
        add_1 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (11664x11xf32) <- (11664x11xf32, 11664x11xf32)
        ...
        # pd_op.sum: (11664xf32) <- (11664x11xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(multiply_2, full_int_array_0, None, False)
        del multiply_2

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [5832, 2]

        # pd_op.reshape: (5832x2xf32) <- (11664xf32, 2xi64)
        ...
        # pd_op.scale: (5832x2xf32) <- (5832x2xf32, 1xf32)
        ...
        # pd_op.add: (5832x2xf32) <- (5832x2xf32, 5832x2xf32)
        add_3 = paddle._C_ops.add(scale_2, scale_3)
        del scale_2, scale_3

        # pd_op.logical_not: (5832x2xb) <- (5832x2xb)
        logical_not_0 = paddle._C_ops.logical_not(data_4)
        del data_4

        # pd_op.cast: (5832x2xf32) <- (5832x2xb)
