...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.share_data_: (2x300x4xf32) <- (2x300x4xf32)
        ...
        # pd_op.gather: (1x4xf32) <- (300x4xf32, 1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(slice_1, data_2, full_0)
        del slice_1
        ...
        # pd_op.gather: (1x4xf32) <- (1x4xf32, 1xi64, 1xi32)
        gather_3 = paddle._C_ops.gather(data_5, data_3, full_0)
        del data_5
        ...
        # pd_op.split_with_num: ([2x2xf32, 2x2xf32]) <- (2x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(concat_0, 2, full_1)
        del concat_0

        # builtin.split: (2x2xf32, 2x2xf32) <- ([2x2xf32, 2x2xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.scale: (2x2xf32) <- (2x2xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(split_1, full_2, float("0"), True)

        # pd_op.subtract: (2x2xf32) <- (2x2xf32, 2x2xf32)
        ...
        # pd_op.add: (2x2xf32) <- (2x2xf32, 2x2xf32)
        ...
        # builtin.combine: ([2x2xf32, 2x2xf32]) <- (2x2xf32, 2x2xf32)
        combine_2 = [subtract_0, add_0]
        del add_0, subtract_0

        # pd_op.concat: (2x4xf32) <- ([2x2xf32, 2x2xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_2, full_3)
        del combine_2

        # pd_op.split_with_num: ([2x1xf32, 2x1xf32, 2x1xf32, 2x1xf32]) <- (2x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(concat_2, 4, full_1)
        del concat_2

        # builtin.split: (2x1xf32, 2x1xf32, 2x1xf32, 2x1xf32) <- ([2x1xf32, 2x1xf32, 2x1xf32, 2x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        full_like_1 = paddle._C_ops.full_like(
            data_2, full_6, paddle.int64, paddle.framework._current_expected_place()
        )

        # builtin.combine: ([1xi64, 1xi64]) <- (1xi64, 1xi64)
        combine_4 = [full_like_0, full_like_1]
        ...
        gather_4 = paddle._C_ops.gather(data_7, data_1, full_0)
        del data_7

        # pd_op.gather: (1x1xi32) <- (1x1xi32, 1xi64, 1xi32)
        gather_5 = paddle._C_ops.gather(data_8, data_3, full_0)
        del data_8

        # builtin.combine: ([1x1xi32, 1x1xi32]) <- (1x1xi32, 1x1xi32)
        combine_6 = [gather_4, gather_5]
        ...
        # pd_op.reshape: (600x1xi64) <- (2x300xi64, 2xi64)
        reshape_0 = paddle._C_ops.reshape(full_7, full_int_array_3)
        del full_7
        ...
        # pd_op.scatter: (600x1xi64) <- (600x1xi64, 2xi64, 2x1xi64)
        scatter_0 = paddle._C_ops.scatter(reshape_0, add_3, cast_0, True)
        del cast_0, reshape_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_4 = [2, 300]

        # pd_op.reshape: (2x300xi64) <- (600x1xi64, 2xi64)
        reshape_1 = paddle._C_ops.reshape(scatter_0, full_int_array_4)
        del full_int_array_4, scatter_0
        ...
        # pd_op.one_hot: (2x300x3xf32) <- (2x300xi64, 1xi32)
        ...
        # pd_op.slice: (2x300x2xf32) <- (2x300x3xf32, 1xi64, 1xi64)
        slice_2 = paddle._C_ops.slice(
            one_hot_0, [2], full_int_array_0, full_int_array_5, [1], []
        )
        del one_hot_0

        # pd_op.full: (2x300xf32) <- ()
        ...
        # pd_op.reshape: (600x1xf32) <- (2x300xf32, 2xi64)
        reshape_2 = paddle._C_ops.reshape(full_10, full_int_array_3)
        del full_10, full_int_array_3

        # pd_op.scatter: (600x1xf32) <- (600x1xf32, 2xi64, 2x1xf32)
        scatter_1 = paddle._C_ops.scatter(reshape_2, add_3, divide_2, True)
        del add_3, divide_2, reshape_2

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [2, 300, 1]

        # pd_op.reshape: (2x300x1xf32) <- (600x1xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(scatter_1, full_int_array_6)
        del full_int_array_6, scatter_1

        # pd_op.multiply: (2x300x2xf32) <- (2x300x1xf32, 2x300x2xf32)
        multiply_3 = paddle._C_ops.multiply(reshape_3, slice_2)
        del reshape_3
        ...
        scale_8 = paddle._C_ops.scale(data_9, full_11, float("0"), True)
        del full_11
        ...
        # pd_op.scale: (2x300x2xf32) <- (2x300x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(slice_2, full_12, float("1"), True)
        ...
        add_4 = paddle._C_ops.add(multiply_4, slice_2)
        ...
        # pd_op.mean: (2x2xf32) <- (2x300x2xf32, 1xi64)
        ...
        sum_0 = paddle._C_ops.sum(mean_0, full_int_array_7, None, False)
        ...
        # pd_op.gather: (1x4xf32) <- (300x4xf32, 1xi64, 1xi32)
        gather_6 = paddle._C_ops.gather(slice_3, data_0, full_0)

        # pd_op.slice: (300x4xf32) <- (2x300x4xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            data_10, [0], full_int_array_1, full_int_array_2, [1], [0]
        )
        del data_10

        # pd_op.gather: (1x4xf32) <- (300x4xf32, 1xi64, 1xi32)
        gather_7 = paddle._C_ops.gather(slice_4, data_2, full_0)

        # builtin.combine: ([1x4xf32, 1x4xf32]) <- (1x4xf32, 1x4xf32)
        combine_7 = [gather_6, gather_7]

        # pd_op.concat: (2x4xf32) <- ([1x4xf32, 1x4xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_7, full_0)
        del combine_7

        # pd_op.subtract: (2x4xf32) <- (2x4xf32, 2x4xf32)
        subtract_9 = paddle._C_ops.subtract(concat_7, concat_1)
        del concat_1

        # pd_op.abs: (2x4xf32) <- (2x4xf32)
        abs_0 = paddle._C_ops.abs(subtract_9)

        # pd_op.sum: (xf32) <- (2x4xf32, 0xi64)
        sum_1 = paddle._C_ops.sum(abs_0, full_int_array_7, None, False)
        ...
        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_0 = paddle._C_ops.divide(scale_11, data_9)
        ...
        # pd_op.sum: (xf32) <- (2x1xf32, 0xi64)
        sum_2 = paddle._C_ops.sum(scale_16, full_int_array_7, None, False)

        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_6 = paddle._C_ops.divide(sum_2, data_9)
        ...
        # pd_op.slice: (300x192x192xf32) <- (2x300x192x192xf32, 1xi64, 1xi64)
        slice_5 = paddle._C_ops.slice(
            data_11, [0], full_int_array_0, full_int_array_1, [1], [0]
        )
        del full_int_array_0

        # pd_op.gather: (1x192x192xf32) <- (300x192x192xf32, 1xi64, 1xi32)
        gather_8 = paddle._C_ops.gather(slice_5, data_0, full_0)
        del data_0

        # pd_op.slice: (300x192x192xf32) <- (2x300x192x192xf32, 1xi64, 1xi64)
        slice_6 = paddle._C_ops.slice(
            data_11, [0], full_int_array_1, full_int_array_2, [1], [0]
        )
        del data_11, full_int_array_2

        # pd_op.gather: (1x192x192xf32) <- (300x192x192xf32, 1xi64, 1xi32)
        gather_9 = paddle._C_ops.gather(slice_6, data_2, full_0)
        del data_2

        # builtin.combine: ([1x192x192xf32, 1x192x192xf32]) <- (1x192x192xf32, 1x192x192xf32)
        combine_9 = [gather_8, gather_9]

        # pd_op.concat: (2x192x192xf32) <- ([1x192x192xf32, 1x192x192xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_9, full_0)
        del combine_9

        # pd_op.gather: (1x768x768xf32) <- (1x768x768xf32, 1xi64, 1xi32)
        gather_10 = paddle._C_ops.gather(data_12, data_1, full_0)
        del data_1, data_12

        # pd_op.gather: (1x768x768xf32) <- (1x768x768xf32, 1xi64, 1xi32)
        gather_11 = paddle._C_ops.gather(data_13, data_3, full_0)
        del data_13, data_3

        # builtin.combine: ([1x768x768xf32, 1x768x768xf32]) <- (1x768x768xf32, 1x768x768xf32)
        combine_10 = [gather_10, gather_11]
        del gather_10, gather_11

        # pd_op.concat: (2x768x768xf32) <- ([1x768x768xf32, 1x768x768xf32], 1xi32)
        concat_10 = paddle._C_ops.concat(combine_10, full_0)
        del combine_10, full_0

        # pd_op.share_data_: (2x192x192xf32) <- (2x192x192xf32)
        share_data__1 = concat_9.detach()

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_8 = [2, 1, 37632, 2]
        ...
        # pd_op.unsqueeze: (2x1x192x192xf32) <- (2x192x192xf32, 1xi64)
        ...
        # pd_op.grid_sample: (2x1x1x37632xf32) <- (2x1x192x192xf32, 2x1x37632x2xf32)
        ...
        arange_0 = paddle.arange(full_18, full_19, full_20, dtype="int64")
        del full_18, full_19, full_20
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_10 = [1, 9408]

        # pd_op.tile: (2x9408xi64) <- (2x1xi64, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_1, full_int_array_10)
        del full_int_array_10, unsqueeze_1
        ...
        # pd_op.unsqueeze: (2x1x12544x2xf32) <- (2x12544x2xf32, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(concat_11, full_int_array_1)
        del concat_11

        # pd_op.scale: (2x1x12544x2xf32) <- (2x1x12544x2xf32, 1xf32)
        ...
        # pd_op.grid_sample: (2x1x1x12544xf32) <- (2x1x192x192xf32, 2x1x12544x2xf32)
        grid_sample_1 = paddle._C_ops.grid_sample(
            unsqueeze_3, scale_21, "bilinear", "zeros", False
        )

        # pd_op.squeeze: (2x12544xf32) <- (2x1x1x12544xf32, 2xi64)
        squeeze_2 = paddle._C_ops.squeeze(grid_sample_1, full_int_array_9)

        # pd_op.unsqueeze: (2x1x768x768xf32) <- (2x768x768xf32, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(concat_10, full_int_array_1)
        del concat_10

        # pd_op.grid_sample: (2x1x1x12544xf32) <- (2x1x768x768xf32, 2x1x12544x2xf32)
        ...
        # pd_op.squeeze: (2x12544xf32) <- (2x1x1x12544xf32, 2xi64)
        squeeze_3 = paddle._C_ops.squeeze(grid_sample_2, full_int_array_9)
        del full_int_array_9, grid_sample_2

        # pd_op.share_data_: (2x12544xf32) <- (2x12544xf32)
        share_data__2 = squeeze_3.detach()
        del squeeze_3

        # pd_op.sigmoid_cross_entropy_with_logits: (2x12544xf32) <- (2x12544xf32, 2x12544xf32, None)
        ...
        # pd_op.mean: (2xf32) <- (2x12544xf32, 1xi64)
        mean_1 = paddle._C_ops.mean(
            sigmoid_cross_entropy_with_logits_1, full_int_array_1, False
        )

        # pd_op.sum: (xf32) <- (2xf32, 0xi64)
        sum_3 = paddle._C_ops.sum(mean_1, full_int_array_7, None, False)
        ...
        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_1 = paddle._C_ops.divide(scale_22, data_9)

        # pd_op.sigmoid: (2x12544xf32) <- (2x12544xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(squeeze_2)

        # pd_op.flatten: (2x12544xf32) <- (2x12544xf32)
        flatten_0 = paddle._C_ops.flatten(sigmoid_1, 1, 1)

        # pd_op.flatten: (2x12544xf32) <- (2x12544xf32)
        flatten_1 = paddle._C_ops.flatten(share_data__2, 1, 1)

        # pd_op.multiply: (2x12544xf32) <- (2x12544xf32, 2x12544xf32)
        multiply_9 = paddle._C_ops.multiply(flatten_0, flatten_1)

        # pd_op.sum: (2xf32) <- (2x12544xf32, 1xi64)
        ...
        # pd_op.sum: (2xf32) <- (2x12544xf32, 1xi64)
        sum_5 = paddle._C_ops.sum(flatten_0, full_int_array_5, None, False)

        # pd_op.sum: (2xf32) <- (2x12544xf32, 1xi64)
        sum_6 = paddle._C_ops.sum(flatten_1, full_int_array_5, None, False)
        ...
        # pd_op.divide: (2xf32) <- (2xf32, 2xf32)
        ...
        # pd_op.sum: (xf32) <- (2xf32, 0xi64)
        sum_7 = paddle._C_ops.sum(scale_26, full_int_array_7, None, False)

        # pd_op.divide: (1xf32) <- (xf32, 1xf32)
        divide_8 = paddle._C_ops.divide(sum_7, data_9)
        del data_9
