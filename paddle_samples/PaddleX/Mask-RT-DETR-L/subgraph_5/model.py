...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.slice: (300x-1x-1xf32) <- (2x300x-1x-1xf32, 1xi64, 1xi64)
        ...
        # pd_op.concat: (2x-1x-1xf32) <- ([1x-1x-1xf32, 1x-1x-1xf32], 1xi32)
        ...
        # pd_op.share_data_: (2x-1x-1xf32) <- (2x-1x-1xf32)
        ...
        slice_8 = paddle._C_ops.slice(
            shape64_1, [0], full_int_array_2, full_int_array_8, [1], [0]
        )
        del full_int_array_2, full_int_array_8, shape64_1

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_9 = [2, 1, 37632, 2]
        ...
        # pd_op.unsqueeze: (2x1x-1x-1xf32) <- (2x-1x-1xf32, 1xi64)
        ...
        # pd_op.grid_sample: (2x1x1x37632xf32) <- (2x1x-1x-1xf32, 2x1x37632x2xf32)
        ...
        # pd_op.grid_sample: (2x1x1x12544xf32) <- (2x1x-1x-1xf32, 2x1x12544x2xf32)
