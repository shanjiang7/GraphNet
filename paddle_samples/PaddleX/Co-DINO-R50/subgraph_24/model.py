...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.scatter: (411075xi32) <- (411075xi32, 253xi32, 253xi32)
        ...
        # pd_op.scatter: (411075xi32) <- (411075xi32, 3xi32, 3xi32)
        ...
        # pd_op.gather: (411075x4xf32) <- (1x4xf32, 411075xi64, 1xi32)
        ...
        # pd_op.scale: (411075xf32) <- (411075xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_0, full_4, float("0"), True)

        # pd_op.add: (411075xf32) <- (411075xf32, 411075xf32)
        ...
        # pd_op.divide: (411075xf32) <- (411075xf32, 411075xf32)
        ...
        # pd_op.log: (411075xf32) <- (411075xf32)
        ...
        # builtin.combine: ([411075xf32, 411075xf32, 411075xf32, 411075xf32]) <- (411075xf32, 411075xf32, 411075xf32, 411075xf32)
        combine_0 = [divide_0, divide_1, scale_6, scale_7]
        del divide_0, divide_1, scale_6, scale_7

        # pd_op.stack: (411075x4xf32) <- ([411075xf32, 411075xf32, 411075xf32, 411075xf32])
