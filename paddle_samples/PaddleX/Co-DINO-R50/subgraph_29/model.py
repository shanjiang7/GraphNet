...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.share_data_: (1x1100x4xf32) <- (1x1100x4xf32)
        ...
        # pd_op.unsqueeze: (1x1100x1x4xf32) <- (1x1100x4xf32, 1xi64)
        ...
        # pd_op.multiply: (1x1100x5x4xf32) <- (1x1100x1x4xf32, 1x1x5x4xf32)
        ...
        # pd_op.slice: (1x1100x4xf32) <- (1x1100x5x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.split_with_num: ([1x1100x1xf32, 1x1100x1xf32, 1x1100x1xf32, 1x1100x1xf32]) <- (1x1100x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(slice_0, 4, full_8)
        del slice_0

        # builtin.split: (1x1100x1xf32, 1x1100x1xf32, 1x1100x1xf32, 1x1100x1xf32) <- ([1x1100x1xf32, 1x1100x1xf32, 1x1100x1xf32, 1x1100x1xf32])
        (
            split_0,
            split_1,
            split_2,
        ...
        # pd_op.multiply: (1x1100x128xf32) <- (1x1100x1xf32, 128xf32)
        ...
        # pd_op.cos: (1x1100x64xf32) <- (1x1100x64xf32)
        cos_0 = paddle._C_ops.cos(strided_slice_1)
        del strided_slice_1

        # builtin.combine: ([1x1100x64xf32, 1x1100x64xf32]) <- (1x1100x64xf32, 1x1100x64xf32)
        combine_0 = [sin_0, cos_0]
        del cos_0, sin_0

        # pd_op.stack: (1x1100x64x2xf32) <- ([1x1100x64xf32, 1x1100x64xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 3)
        del combine_0

        # pd_op.flatten: (1x1100x128xf32) <- (1x1100x64x2xf32)
        ...
        # builtin.combine: ([1x1100x128xf32, 1x1100x128xf32, 1x1100x128xf32, 1x1100x128xf32]) <- (1x1100x128xf32, 1x1100x128xf32, 1x1100x128xf32, 1x1100x128xf32)
        combine_4 = [flatten_1, flatten_0, flatten_2, flatten_3]
        del flatten_0, flatten_1, flatten_2, flatten_3

        # pd_op.concat: (1x1100x512xf32) <- ([1x1100x128xf32, 1x1100x128xf32, 1x1100x128xf32, 1x1100x128xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_4, full_8)
        del combine_4, full_8

        # pd_op.matmul: (1x1100x256xf32) <- (1x1100x512xf32, 512x256xf32)
