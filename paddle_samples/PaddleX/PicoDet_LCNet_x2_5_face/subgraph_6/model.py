...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        # pd_op.sigmoid: (82944x1xf32) <- (82944x1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(data_0)

        # pd_op.cast: (82944x1xf32) <- (82944x1xf64)
        ...
        # pd_op.greater_than: (82944x1xb) <- (82944x1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_0)

        # pd_op.cast: (82944x1xf32) <- (82944x1xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)
        del greater_than_0

        # pd_op.multiply: (82944x1xf32) <- (82944x1xf32, 82944x1xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)
        del cast_1

        # pd_op.subtract: (82944x1xf32) <- (82944x1xf32, 82944x1xf32)
        subtract_0 = paddle._C_ops.subtract(sigmoid_0, cast_0)

        # pd_op.abs: (82944x1xf32) <- (82944x1xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)

        # pd_op.pow: (82944x1xf32) <- (82944x1xf32)
        ...
        # pd_op.scale: (82944x1xf32) <- (82944x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)
        del pow_0

        # pd_op.less_equal: (82944x1xb) <- (82944x1xf32, xf32)
        ...
        # pd_op.add: (82944x1xf32) <- (82944x1xf32, 82944x1xf32)
        ...
        # pd_op.sigmoid_cross_entropy_with_logits: (82944x1xf32) <- (82944x1xf32, 82944x1xf32, None)
        ...
        # pd_op.sum: (xf32) <- (82944x1xf32, 0xi64)
        sum_0 = paddle._C_ops.sum(scale_2, full_int_array_0, None, False)

        # pd_op.full: (1xf32) <- ()
        full_4 = paddle._C_ops.full(
            [1], float("0.00142248"), paddle.float32, paddle.core.CPUPlace()
        )
