...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        # pd_op.cast: (321491x1xf32) <- (321491x1xf64)
        ...
        # pd_op.greater_than: (321491x1xb) <- (321491x1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_0)

        # pd_op.cast: (321491x1xf32) <- (321491x1xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)
        del greater_than_0

        # pd_op.multiply: (321491x1xf32) <- (321491x1xf32, 321491x1xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)
        del cast_1

        # pd_op.subtract: (321491x1xf32) <- (321491x1xf32, 321491x1xf32)
        subtract_0 = paddle._C_ops.subtract(data_1, cast_0)

        # pd_op.abs: (321491x1xf32) <- (321491x1xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)
        del subtract_0

        # pd_op.pow: (321491x1xf32) <- (321491x1xf32)
        ...
        # pd_op.scale: (321491x1xf32) <- (321491x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)
        del full_1, pow_0

        # pd_op.less_equal: (321491x1xb) <- (321491x1xf32, xf32)
        ...
        # pd_op.add: (321491x1xf32) <- (321491x1xf32, 321491x1xf32)
        add_1 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (321491x1xf32) <- (321491x1xf32, 321491x1xf32)
        ...
        # pd_op.sum: (321491xf32) <- (321491x1xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(multiply_2, full_int_array_0, None, False)
        del multiply_2

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [5449, 59]

        # pd_op.reshape: (5449x59xf32) <- (321491xf32, 2xi64)
        reshape_0 = paddle._C_ops.reshape(sum_0, full_int_array_1)
        del full_int_array_1, sum_0
        ...
        # pd_op.slice: (5449xf32) <- (5449x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (5449xf32) <- (5449xf32, 5449xf32)
        ...
        # pd_op.multiply: (5449xf32) <- (5449xf32, 5449xf32)
        multiply_3 = paddle._C_ops.multiply(subtract_1, subtract_2)
        del subtract_1, subtract_2

        # pd_op.slice: (59xf32) <- (59x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (59xf32) <- (59xf32, 59xf32)
        ...
        # pd_op.minimum: (5449x59x2xf32) <- (5449x1x2xf32, 59x2xf32)
        minimum_0 = paddle._C_ops.minimum(reshape_2, slice_11)

        # pd_op.subtract: (5449x59x2xf32) <- (5449x59x2xf32, 5449x59x2xf32)
        ...
        # pd_op.clip: (5449x59x2xf32) <- (5449x59x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_5, full_2, full_3)
        del subtract_5

        # pd_op.slice: (5449x59xf32) <- (5449x59x2xf32, 1xi64, 1xi64)
        ...
        # pd_op.multiply: (5449x59xf32) <- (5449x59xf32, 5449x59xf32)
        multiply_5 = paddle._C_ops.multiply(slice_12, slice_13)
        del slice_12, slice_13

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_8 = [5449, 1]

        # pd_op.reshape: (5449x1xf32) <- (5449xf32, 2xi64)
        reshape_3 = paddle._C_ops.reshape(multiply_3, full_int_array_8)
        del full_int_array_8, multiply_3

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_9 = [1, 59]

        # pd_op.reshape: (1x59xf32) <- (59xf32, 2xi64)
        reshape_4 = paddle._C_ops.reshape(multiply_4, full_int_array_9)
        del full_int_array_9, multiply_4

        # pd_op.add: (5449x59xf32) <- (5449x1xf32, 1x59xf32)
        add_2 = paddle._C_ops.add(reshape_3, reshape_4)
        del reshape_3, reshape_4

        # pd_op.subtract: (5449x59xf32) <- (5449x59xf32, 5449x59xf32)
        ...
        # pd_op.maximum: (5449x59xf32) <- (5449x59xf32, 1xf32)
        maximum_2 = paddle._C_ops.maximum(subtract_6, assign_value__0)
        del subtract_6

        # pd_op.divide: (5449x59xf32) <- (5449x59xf32, 5449x59xf32)
        ...
        # pd_op.scale: (5449x59xf32) <- (5449x59xf32, 1xf32)
        ...
        # pd_op.add: (5449x59xf32) <- (5449x59xf32, 5449x59xf32)
        add_3 = paddle._C_ops.add(scale_2, scale_3)
        del scale_2, scale_3

        # pd_op.logical_not: (5449x59xb) <- (5449x59xb)
        logical_not_0 = paddle._C_ops.logical_not(data_4)
        del data_4

        # pd_op.cast: (5449x59xf32) <- (5449x59xb)
