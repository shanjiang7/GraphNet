...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x4x-1x-1xf32) <- (1x256x-1x-1xf32, 4x256x3x3xf32)
        ...
        # pd_op.multiply: (1x4x-1x-1xf32) <- (1x4x-1x-1xf32, 1xf32)
        ...
        # pd_op.relu: (1x4x-1x-1xf32) <- (1x4x-1x-1xf32)
        ...
        # pd_op.scale: (1x4x-1x-1xf32) <- (1x4x-1x-1xf32, 1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_1 = paddle._C_ops.shape64(add_31)
        del add_31
        ...
        scale_10 = paddle._C_ops.scale(slice_1, full_0, float("0"), True)
        ...
        arange_0 = paddle.arange(full_5, scale_10, full_6, dtype="int64")
        del scale_10

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_11 = paddle._C_ops.scale(slice_0, full_0, float("0"), True)
        del full_0

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_1 = paddle.arange(full_5, scale_11, full_6, dtype="int64")
        del full_6, scale_11

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_5 = [0]

        # pd_op.unsqueeze: (1x-1xi64) <- (-1xi64, 1xi64)
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(arange_1, full_int_array_6)
        del arange_1
        ...
        # pd_op.expand: (-1x-1xi64) <- (1x-1xi64, 2xi64)
        expand_0 = paddle._C_ops.expand(unsqueeze_0, stack_0)
        ...
        # pd_op.expand: (-1x-1xi64) <- (-1x1xi64, 2xi64)
        expand_1 = paddle._C_ops.expand(unsqueeze_1, stack_1)
        del stack_1, unsqueeze_1

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_7 = [-1]

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_19 = paddle._C_ops.reshape(expand_0, full_int_array_7)
        del expand_0

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_20 = paddle._C_ops.reshape(expand_1, full_int_array_7)
        del expand_1

        # builtin.combine: ([-1xi64, -1xi64]) <- (-1xi64, -1xi64)
        combine_2 = [reshape_19, reshape_20]
        ...
        # pd_op.cast: (-1x2xf32) <- (-1x2xi64)
        cast_0 = paddle._C_ops.cast(stack_2, paddle.float32)
        del stack_2
        ...
        scale_0 = paddle._C_ops.scale(cast_0, full_7, float("4"), True)
        del cast_0

        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_2 = paddle._C_ops.shape64(add_32)
        ...
        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_3 = paddle._C_ops.shape64(add_32)
        del add_32
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_12 = paddle._C_ops.scale(slice_3, full_1, float("0"), True)

        # pd_op.full: (1xi64) <- ()
        full_8 = paddle._C_ops.full(
            [1], float("16"), paddle.int64, paddle.core.CPUPlace()
        )

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_2 = paddle.arange(full_5, scale_12, full_8, dtype="int64")
        del scale_12

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_13 = paddle._C_ops.scale(slice_2, full_1, float("0"), True)
        del full_1

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_3 = paddle.arange(full_5, scale_13, full_8, dtype="int64")
        del full_8, scale_13

        # pd_op.unsqueeze: (1x-1xi64) <- (-1xi64, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(arange_2, full_int_array_5)
        del arange_2

        # pd_op.unsqueeze: (-1x1xi64) <- (-1xi64, 1xi64)
        unsqueeze_3 = paddle._C_ops.unsqueeze(arange_3, full_int_array_6)
        del arange_3
        ...
        # pd_op.expand: (-1x-1xi64) <- (1x-1xi64, 2xi64)
        expand_2 = paddle._C_ops.expand(unsqueeze_2, stack_3)
        del stack_3, unsqueeze_2
        ...
        # pd_op.expand: (-1x-1xi64) <- (-1x1xi64, 2xi64)
        expand_3 = paddle._C_ops.expand(unsqueeze_3, stack_4)
        del stack_4, unsqueeze_3

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_21 = paddle._C_ops.reshape(expand_2, full_int_array_7)
        del expand_2

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_22 = paddle._C_ops.reshape(expand_3, full_int_array_7)
        del expand_3

        # builtin.combine: ([-1xi64, -1xi64]) <- (-1xi64, -1xi64)
        combine_5 = [reshape_21, reshape_22]
        ...
        # pd_op.cast: (-1x2xf32) <- (-1x2xi64)
        cast_1 = paddle._C_ops.cast(stack_5, paddle.float32)
        del stack_5

        # pd_op.scale: (-1x2xf32) <- (-1x2xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(cast_1, full_7, float("8"), True)
        del cast_1

        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_4 = paddle._C_ops.shape64(add_33)
        ...
        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_5 = paddle._C_ops.shape64(add_33)
        del add_33
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_14 = paddle._C_ops.scale(slice_5, full_2, float("0"), True)

        # pd_op.full: (1xi64) <- ()
        full_9 = paddle._C_ops.full(
            [1], float("32"), paddle.int64, paddle.core.CPUPlace()
        )

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_4 = paddle.arange(full_5, scale_14, full_9, dtype="int64")
        del scale_14

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_15 = paddle._C_ops.scale(slice_4, full_2, float("0"), True)
        del full_2

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_5 = paddle.arange(full_5, scale_15, full_9, dtype="int64")
        del full_9, scale_15

        # pd_op.unsqueeze: (1x-1xi64) <- (-1xi64, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(arange_4, full_int_array_5)
        del arange_4

        # pd_op.unsqueeze: (-1x1xi64) <- (-1xi64, 1xi64)
        unsqueeze_5 = paddle._C_ops.unsqueeze(arange_5, full_int_array_6)
        del arange_5
        ...
        # pd_op.expand: (-1x-1xi64) <- (1x-1xi64, 2xi64)
        expand_4 = paddle._C_ops.expand(unsqueeze_4, stack_6)
        del stack_6, unsqueeze_4
        ...
        # pd_op.expand: (-1x-1xi64) <- (-1x1xi64, 2xi64)
        expand_5 = paddle._C_ops.expand(unsqueeze_5, stack_7)
        del stack_7, unsqueeze_5

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_23 = paddle._C_ops.reshape(expand_4, full_int_array_7)
        del expand_4

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_24 = paddle._C_ops.reshape(expand_5, full_int_array_7)
        del expand_5

        # builtin.combine: ([-1xi64, -1xi64]) <- (-1xi64, -1xi64)
        combine_8 = [reshape_23, reshape_24]
        ...
        # pd_op.cast: (-1x2xf32) <- (-1x2xi64)
        cast_2 = paddle._C_ops.cast(stack_8, paddle.float32)
        del stack_8

        # pd_op.scale: (-1x2xf32) <- (-1x2xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(cast_2, full_7, float("16"), True)
        del cast_2

        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_6 = paddle._C_ops.shape64(add_34)
        ...
        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_7 = paddle._C_ops.shape64(add_34)
        del add_34
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_16 = paddle._C_ops.scale(slice_7, full_3, float("0"), True)

        # pd_op.full: (1xi64) <- ()
        full_10 = paddle._C_ops.full(
            [1], float("64"), paddle.int64, paddle.core.CPUPlace()
        )

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_6 = paddle.arange(full_5, scale_16, full_10, dtype="int64")
        del scale_16

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_17 = paddle._C_ops.scale(slice_6, full_3, float("0"), True)
        del full_3

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_7 = paddle.arange(full_5, scale_17, full_10, dtype="int64")
        del full_10, scale_17

        # pd_op.unsqueeze: (1x-1xi64) <- (-1xi64, 1xi64)
        unsqueeze_6 = paddle._C_ops.unsqueeze(arange_6, full_int_array_5)
        del arange_6

        # pd_op.unsqueeze: (-1x1xi64) <- (-1xi64, 1xi64)
        unsqueeze_7 = paddle._C_ops.unsqueeze(arange_7, full_int_array_6)
        del arange_7
        ...
        # pd_op.expand: (-1x-1xi64) <- (1x-1xi64, 2xi64)
        expand_6 = paddle._C_ops.expand(unsqueeze_6, stack_9)
        del stack_9, unsqueeze_6
        ...
        # pd_op.expand: (-1x-1xi64) <- (-1x1xi64, 2xi64)
        expand_7 = paddle._C_ops.expand(unsqueeze_7, stack_10)
        del stack_10, unsqueeze_7

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_25 = paddle._C_ops.reshape(expand_6, full_int_array_7)
        del expand_6

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_26 = paddle._C_ops.reshape(expand_7, full_int_array_7)
        del expand_7

        # builtin.combine: ([-1xi64, -1xi64]) <- (-1xi64, -1xi64)
        combine_11 = [reshape_25, reshape_26]
        ...
        # pd_op.cast: (-1x2xf32) <- (-1x2xi64)
        cast_3 = paddle._C_ops.cast(stack_11, paddle.float32)
        del stack_11

        # pd_op.scale: (-1x2xf32) <- (-1x2xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(cast_3, full_7, float("32"), True)
        del cast_3
        ...
        del full_int_array_2, shape64_8

        # pd_op.shape64: (4xi64) <- (1x256x-1x-1xf32)
        shape64_9 = paddle._C_ops.shape64(add_35)
        del add_35
        ...
        del full_int_array_3, full_int_array_4, shape64_9

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_18 = paddle._C_ops.scale(slice_9, full_4, float("0"), True)

        # pd_op.full: (1xi64) <- ()
        full_11 = paddle._C_ops.full(
            [1], float("128"), paddle.int64, paddle.core.CPUPlace()
        )

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_8 = paddle.arange(full_5, scale_18, full_11, dtype="int64")
        del scale_18

        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_19 = paddle._C_ops.scale(slice_8, full_4, float("0"), True)
        del full_4

        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_9 = paddle.arange(full_5, scale_19, full_11, dtype="int64")
        del full_11, full_5, scale_19

        # pd_op.unsqueeze: (1x-1xi64) <- (-1xi64, 1xi64)
        unsqueeze_8 = paddle._C_ops.unsqueeze(arange_8, full_int_array_5)
        del arange_8, full_int_array_5

        # pd_op.unsqueeze: (-1x1xi64) <- (-1xi64, 1xi64)
        unsqueeze_9 = paddle._C_ops.unsqueeze(arange_9, full_int_array_6)
        del arange_9, full_int_array_6
        ...
        # pd_op.expand: (-1x-1xi64) <- (1x-1xi64, 2xi64)
        expand_8 = paddle._C_ops.expand(unsqueeze_8, stack_12)
        del stack_12, unsqueeze_8
        ...
        # pd_op.expand: (-1x-1xi64) <- (-1x1xi64, 2xi64)
        expand_9 = paddle._C_ops.expand(unsqueeze_9, stack_13)
        del stack_13, unsqueeze_9

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_27 = paddle._C_ops.reshape(expand_8, full_int_array_7)
        del expand_8

        # pd_op.reshape: (-1xi64) <- (-1x-1xi64, 1xi64)
        reshape_28 = paddle._C_ops.reshape(expand_9, full_int_array_7)
        del expand_9, full_int_array_7

        # builtin.combine: ([-1xi64, -1xi64]) <- (-1xi64, -1xi64)
        combine_14 = [reshape_27, reshape_28]
        ...
        # pd_op.cast: (-1x2xf32) <- (-1x2xi64)
        cast_4 = paddle._C_ops.cast(stack_14, paddle.float32)
        del stack_14

        # pd_op.scale: (-1x2xf32) <- (-1x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(cast_4, full_7, float("64"), True)
        del cast_4, full_7
