...
class Program_weight_tensor_parameter_14:
    ...
    max_val = float("0.0938921")
    mean = float("-0.000495255")
    std = float("0.0313968")
    data = None
...
class Program_weight_tensor_parameter_152:
    ...
    max_val = float("0.80138")
    mean = float("0.00578093")
    std = float("0.26017")
    data = None
...
class Program_weight_tensor_parameter_157:
    ...
    max_val = float("0.974158")
    mean = float("-0.0450661")
    std = float("0.448236")
    data = None
