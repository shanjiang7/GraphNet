...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.slice: (1x-1x160x160xf32) <- (-1x1x-1x160x160xf32, 1xi64, 1xi64)
        ...
        # pd_op.gather: (-1x160x160xf32) <- (-1x160x160xf32, -1xi64, 1xi32)
        gather_4 = paddle._C_ops.gather(slice_5, data_7, full_1)
        del data_7

        # builtin.combine: ([-1x160x160xf32]) <- (-1x160x160xf32)
        combine_12 = [gather_4]

        # pd_op.concat: (-1x160x160xf32) <- ([-1x160x160xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_1)
        del combine_12

        # pd_op.gather: (-1x640x640xf32) <- (1x640x640xf32, -1xi64, 1xi32)
        ...
        # pd_op.concat: (-1x640x640xf32) <- ([-1x640x640xf32], 1xi32)
        ...
        # pd_op.grid_sample: (-1x1x1x12544xf32) <- (-1x1x160x160xf32, -1x1x12544x2xf32)
        ...
        # pd_op.unsqueeze: (-1x1x640x640xf32) <- (-1x640x640xf32, 1xi64)
        unsqueeze_4 = paddle._C_ops.unsqueeze(concat_10, full_int_array_1)
        del concat_10

        # pd_op.grid_sample: (-1x1x1x12544xf32) <- (-1x1x640x640xf32, -1x1x12544x2xf32)
