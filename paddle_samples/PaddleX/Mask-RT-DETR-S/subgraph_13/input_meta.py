...
class Program_weight_tensor_data_1:
    ...
    shape = [1, 100, 4]
    dtype = "float32"
    min_val = float("9.15261e-08")
    max_val = float("0.999994")
    mean = float("0.626426")
    std = float("0.259718")
    data = None
...
class Program_weight_tensor_data_2:
    ...
    shape = [1, 100, 2]
    dtype = "float32"
    min_val = float("-5.6096")
    max_val = float("-4.31093")
    mean = float("-5.08135")
    std = float("0.215957")
    data = None
...
class Program_weight_tensor_data_3:
    ...
    shape = [1, 4]
    dtype = "float32"
    data = [0.5, 0.544476, 1.0, 0.911047]
...
class Program_weight_tensor_data_5:
    ...
    shape = [1, 100, 192, 192]
    dtype = "float32"
    min_val = float("-1563.42")
    max_val = float("10.2972")
    mean = float("-16.1917")
    std = float("31.7569")
    data = None
