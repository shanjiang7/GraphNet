...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.flatten: (2x1024x256xf32) <- (2x1024x16x16xf32)
        flatten_0 = paddle._C_ops.flatten(data_10, 2, 3)
        del data_10

        # pd_op.transpose: (2x256x1024xf32) <- (2x1024x256xf32)
        ...
        # pd_op.matmul: (256x256xf32) <- (256x1xf32, 1x256xf32)
        ...
        # pd_op.sin: (256x256xf32) <- (256x256xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (256x256xf32) <- (256x256xf32)
        ...
        # builtin.combine: ([256x256xf32, 256x256xf32, 256x256xf32, 256x256xf32]) <- (256x256xf32, 256x256xf32, 256x256xf32, 256x256xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]
        del cos_0, cos_1, sin_0, sin_1

        # pd_op.concat: (256x1024xf32) <- ([256x256xf32, 256x256xf32, 256x256xf32, 256x256xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1

        # pd_op.unsqueeze: (1x256x1024xf32) <- (256x1024xf32, 1xi64)
        ...
        # pd_op.matmul: (2x256x1024xf32) <- (2x256x1024xf32, 1024x1024xf32)
        matmul_2 = paddle._C_ops.matmul(add_0, slice_0, False, False)

        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_1 = paddle._C_ops.add(matmul_2, slice_1)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_3 = [0, 0, 4, 256]

        # pd_op.reshape: (2x256x4x256xf32) <- (2x256x1024xf32, 4xi64)
        ...
        # pd_op.matmul: (2x4x256x256xf32) <- (2x4x256x256xf32, 2x4x256x256xf32)
        ...
        # pd_op.scale: (2x4x256x256xf32) <- (2x4x256x256xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(matmul_5, full_8, float("0"), True)
        del matmul_5

        # pd_op.softmax: (2x4x256x256xf32) <- (2x4x256x256xf32)
        ...
        # pd_op.dropout: (2x4x256x256xf32, 2x4x256x256xui8) <- (2x4x256x256xf32, None, 1xf32)
        ...
        # pd_op.transpose: (2x256x4x256xf32) <- (2x4x256x256xf32)
        ...
        # pd_op.reshape: (2x256x1024xf32) <- (2x256x4x256xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_4, full_int_array_6)

        # pd_op.matmul: (2x256x1024xf32) <- (2x256x1024xf32, 1024x1024xf32)
        matmul_7 = paddle._C_ops.matmul(reshape_3, parameter_364, False, False)
        del parameter_364

        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_4 = paddle._C_ops.add(matmul_7, parameter_363)
        del parameter_363

        # pd_op.dropout: (2x256x1024xf32, 2x256x1024xui8) <- (2x256x1024xf32, None, 1xf32)
        ...
        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 2x256x1024xf32)
        add_5 = paddle._C_ops.add(transpose_0, dropout_2)

        # pd_op.layer_norm: (2x256x1024xf32, 2x256xf32, 2x256xf32) <- (2x256x1024xf32, 1024xf32, 1024xf32)
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_5, parameter_362, parameter_361, float("1e-05"), 2
            ),
        ...
        # pd_op.add: (2x256x2048xf32) <- (2x256x2048xf32, 2048xf32)
        add_6 = paddle._C_ops.add(matmul_8, parameter_359)
        del parameter_359

        # pd_op.gelu: (2x256x2048xf32) <- (2x256x2048xf32)
        gelu_0 = paddle._C_ops.gelu(add_6, False)

        # pd_op.dropout: (2x256x2048xf32, 2x256x2048xui8) <- (2x256x2048xf32, None, 1xf32)
        ...
        # pd_op.matmul: (2x256x1024xf32) <- (2x256x2048xf32, 2048x1024xf32)
        matmul_9 = paddle._C_ops.matmul(dropout_4, parameter_358, False, False)
        del parameter_358

        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_7 = paddle._C_ops.add(matmul_9, parameter_357)
        del parameter_357
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_8, parameter_356, parameter_355, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (2x256x1024xf32) <- (2x256x1024xf32, 1024x1024xf32)
        matmul_15 = paddle._C_ops.matmul(reshape_7, parameter_354, False, False)
        del parameter_354

        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_13 = paddle._C_ops.add(matmul_15, parameter_353)
        del parameter_353
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_14, parameter_352, parameter_351, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (2x256x2048xf32) <- (2x256x2048xf32, 2048xf32)
        add_15 = paddle._C_ops.add(matmul_16, parameter_349)
        del parameter_349
        ...
        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_16 = paddle._C_ops.add(matmul_17, parameter_347)
        del parameter_347
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_17, parameter_346, parameter_345, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (2x256x1024xf32) <- (2x256x1024xf32, 1024x1024xf32)
        matmul_23 = paddle._C_ops.matmul(reshape_11, parameter_344, False, False)
        del parameter_344

        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_22 = paddle._C_ops.add(matmul_23, parameter_343)
        del parameter_343
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_23, parameter_342, parameter_341, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (2x256x2048xf32) <- (2x256x2048xf32, 2048xf32)
        add_24 = paddle._C_ops.add(matmul_24, parameter_339)
        del parameter_339
        ...
        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_25 = paddle._C_ops.add(matmul_25, parameter_337)
        del parameter_337
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_26, parameter_336, parameter_335, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (2x256x1024xf32) <- (2x256x1024xf32, 1024x1024xf32)
        matmul_31 = paddle._C_ops.matmul(reshape_15, parameter_334, False, False)
        del parameter_334

        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_31 = paddle._C_ops.add(matmul_31, parameter_333)
        del parameter_333
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_32, parameter_332, parameter_331, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (2x256x2048xf32) <- (2x256x2048xf32, 2048xf32)
        add_33 = paddle._C_ops.add(matmul_32, parameter_329)
        del parameter_329
        ...
        # pd_op.add: (2x256x1024xf32) <- (2x256x1024xf32, 1024xf32)
        add_34 = paddle._C_ops.add(matmul_33, parameter_327)
        del parameter_327
        ...
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_35, parameter_326, parameter_325, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del parameter_325, parameter_326

        # pd_op.transpose: (2x1024x256xf32) <- (2x256x1024xf32)
        transpose_17 = paddle._C_ops.transpose(layer_norm_21, [0, 2, 1])
        del layer_norm_21

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_7 = [2, 1024, 16, 16]

        # pd_op.reshape: (2x1024x16x16xf32) <- (2x1024x256xf32, 4xi64)
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            reshape_16, parameter_324, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_324
        ...
        conv2d_1 = paddle._C_ops.conv2d(
            reshape_16, parameter_319, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_319
        ...
        conv2d_2 = paddle._C_ops.conv2d(
            swish_2, parameter_314, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_314
        ...
        conv2d_3 = paddle._C_ops.conv2d(
            swish_3, parameter_309, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_309
        ...
        conv2d_4 = paddle._C_ops.conv2d(
            swish_3, parameter_304, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_304
        ...
        conv2d_5 = paddle._C_ops.conv2d(
            swish_4, parameter_299, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_299
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            swish_5, parameter_294, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_294
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            swish_5, parameter_289, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_289
        ...
        # pd_op.add: (2x384x16x16xf32) <- (2x384x16x16xf32, 2x384x16x16xf32)
        add_37 = paddle._C_ops.add(batch_norm__36, batch_norm__42)

        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_6 = paddle._C_ops.swish(add_37)
        ...
        combine_2 = [swish_6, pool2d_0, pool2d_1, pool2d_2]
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            concat_1, parameter_284, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_284
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            swish_7, parameter_279, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_279
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            swish_8, parameter_274, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_274
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            swish_8, parameter_269, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_269
        ...
        # pd_op.add: (2x384x16x16xf32) <- (2x384x16x16xf32, 2x384x16x16xf32)
        add_38 = paddle._C_ops.add(batch_norm__60, batch_norm__66)

        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_9 = paddle._C_ops.swish(add_38)

        # builtin.combine: ([2x384x16x16xf32, 2x384x16x16xf32]) <- (2x384x16x16xf32, 2x384x16x16xf32)
        combine_3 = [swish_1, swish_9]
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            concat_2, parameter_264, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_264
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            swish_10, parameter_259, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_259
        ...
        # builtin.combine: ([2x384x32x32xf32, 2x512x-1x-1xf32]) <- (2x384x32x32xf32, 2x512x-1x-1xf32)
        combine_4 = [nearest_interp_0, data_9]
        del data_9

        # pd_op.concat: (2x896x32x32xf32) <- ([2x384x32x32xf32, 2x512x-1x-1xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_4, full_7)
        del combine_4

        # pd_op.conv2d: (2x192x32x32xf32) <- (2x896x32x32xf32, 192x896x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            concat_3, parameter_254, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_254
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            concat_3, parameter_249, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_249
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            swish_13, parameter_244, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_244
        ...
        conv2d_17 = paddle._C_ops.conv2d(
            swish_14, parameter_239, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_239
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            swish_14, parameter_234, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_234
        ...
        add_39 = paddle._C_ops.add(batch_norm__102, batch_norm__108)

        # pd_op.swish: (2x192x32x32xf32) <- (2x192x32x32xf32)
        swish_15 = paddle._C_ops.swish(add_39)

        # pd_op.conv2d: (2x192x32x32xf32) <- (2x192x32x32xf32, 192x192x3x3xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            swish_15, parameter_229, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_229
        ...
        conv2d_20 = paddle._C_ops.conv2d(
            swish_16, parameter_224, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_224
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            swish_16, parameter_219, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_219
        ...
        # pd_op.add: (2x192x32x32xf32) <- (2x192x32x32xf32, 2x192x32x32xf32)
        add_40 = paddle._C_ops.add(batch_norm__120, batch_norm__126)

        # pd_op.swish: (2x192x32x32xf32) <- (2x192x32x32xf32)
        swish_17 = paddle._C_ops.swish(add_40)

        # pd_op.conv2d: (2x192x32x32xf32) <- (2x192x32x32xf32, 192x192x3x3xf32)
        conv2d_22 = paddle._C_ops.conv2d(
            swish_17, parameter_214, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_214
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            swish_18, parameter_209, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_209
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            swish_18, parameter_204, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_204
        ...
        # pd_op.add: (2x192x32x32xf32) <- (2x192x32x32xf32, 2x192x32x32xf32)
        add_41 = paddle._C_ops.add(batch_norm__138, batch_norm__144)

        # pd_op.swish: (2x192x32x32xf32) <- (2x192x32x32xf32)
        swish_19 = paddle._C_ops.swish(add_41)

        # builtin.combine: ([2x192x32x32xf32, 2x192x32x32xf32]) <- (2x192x32x32xf32, 2x192x32x32xf32)
        combine_5 = [swish_12, swish_19]
        ...
        conv2d_26 = paddle._C_ops.conv2d(
            swish_20, parameter_194, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_194
        ...
        # builtin.combine: ([2x192x64x64xf32, 2x256x-1x-1xf32]) <- (2x192x64x64xf32, 2x256x-1x-1xf32)
        combine_6 = [nearest_interp_1, data_8]
        del data_8

        # pd_op.concat: (2x448x64x64xf32) <- ([2x192x64x64xf32, 2x256x-1x-1xf32], 1xi32)
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            concat_5, parameter_189, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_189
        ...
        conv2d_28 = paddle._C_ops.conv2d(
            concat_5, parameter_184, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_184
        ...
        conv2d_29 = paddle._C_ops.conv2d(
            swish_23, parameter_179, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_179
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            swish_24, parameter_174, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_174
        ...
        conv2d_31 = paddle._C_ops.conv2d(
            swish_24, parameter_169, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_169
        ...
        add_42 = paddle._C_ops.add(batch_norm__180, batch_norm__186)

        # pd_op.swish: (2x96x64x64xf32) <- (2x96x64x64xf32)
        swish_25 = paddle._C_ops.swish(add_42)

        # pd_op.conv2d: (2x96x64x64xf32) <- (2x96x64x64xf32, 96x96x3x3xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            swish_25, parameter_164, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_164
        ...
        # pd_op.swish: (2x96x64x64xf32) <- (2x96x64x64xf32)
        swish_26 = paddle._C_ops.swish(batch_norm__192)

        # pd_op.conv2d: (2x96x64x64xf32) <- (2x96x64x64xf32, 96x96x3x3xf32)
        conv2d_33 = paddle._C_ops.conv2d(
            swish_26, parameter_159, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_159
        ...
        conv2d_34 = paddle._C_ops.conv2d(
            swish_26, parameter_154, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_154
        ...
        # pd_op.add: (2x96x64x64xf32) <- (2x96x64x64xf32, 2x96x64x64xf32)
        add_43 = paddle._C_ops.add(batch_norm__198, batch_norm__204)

        # pd_op.swish: (2x96x64x64xf32) <- (2x96x64x64xf32)
        swish_27 = paddle._C_ops.swish(add_43)

        # pd_op.conv2d: (2x96x64x64xf32) <- (2x96x64x64xf32, 96x96x3x3xf32)
        conv2d_35 = paddle._C_ops.conv2d(
            swish_27, parameter_149, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_149
        ...
        # pd_op.swish: (2x96x64x64xf32) <- (2x96x64x64xf32)
        swish_28 = paddle._C_ops.swish(batch_norm__210)

        # pd_op.conv2d: (2x96x64x64xf32) <- (2x96x64x64xf32, 96x96x3x3xf32)
        conv2d_36 = paddle._C_ops.conv2d(
            swish_28, parameter_144, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_144
        ...
        conv2d_37 = paddle._C_ops.conv2d(
            swish_28, parameter_139, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_139
        ...
        # pd_op.add: (2x96x64x64xf32) <- (2x96x64x64xf32, 2x96x64x64xf32)
        add_44 = paddle._C_ops.add(batch_norm__216, batch_norm__222)

        # pd_op.swish: (2x96x64x64xf32) <- (2x96x64x64xf32)
        swish_29 = paddle._C_ops.swish(add_44)

        # builtin.combine: ([2x96x64x64xf32, 2x96x64x64xf32]) <- (2x96x64x64xf32, 2x96x64x64xf32)
        combine_7 = [swish_22, swish_29]
        ...
        conv2d_39 = paddle._C_ops.conv2d(
            swish_30, parameter_129, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_129
        ...
        conv2d_42 = paddle._C_ops.conv2d(
            swish_33, parameter_114, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_114
        ...
        # pd_op.swish: (2x192x32x32xf32) <- (2x192x32x32xf32)
        swish_34 = paddle._C_ops.swish(batch_norm__252)

        # pd_op.conv2d: (2x192x32x32xf32) <- (2x192x32x32xf32, 192x192x3x3xf32)
        conv2d_43 = paddle._C_ops.conv2d(
            swish_34, parameter_109, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_109
        ...
        conv2d_44 = paddle._C_ops.conv2d(
            swish_34, parameter_104, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_104
        ...
        # pd_op.add: (2x192x32x32xf32) <- (2x192x32x32xf32, 2x192x32x32xf32)
        add_45 = paddle._C_ops.add(batch_norm__258, batch_norm__264)
        ...
        conv2d_45 = paddle._C_ops.conv2d(
            swish_35, parameter_99, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_99
        ...
        conv2d_46 = paddle._C_ops.conv2d(
            swish_36, parameter_94, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_94
        ...
        conv2d_47 = paddle._C_ops.conv2d(
            swish_36, parameter_89, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_89
        ...
        # pd_op.add: (2x192x32x32xf32) <- (2x192x32x32xf32, 2x192x32x32xf32)
        add_46 = paddle._C_ops.add(batch_norm__276, batch_norm__282)

        # pd_op.swish: (2x192x32x32xf32) <- (2x192x32x32xf32)
        swish_37 = paddle._C_ops.swish(add_46)

        # pd_op.conv2d: (2x192x32x32xf32) <- (2x192x32x32xf32, 192x192x3x3xf32)
        conv2d_48 = paddle._C_ops.conv2d(
            swish_37, parameter_84, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_84
        ...
        conv2d_49 = paddle._C_ops.conv2d(
            swish_38, parameter_79, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_79
        ...
        conv2d_50 = paddle._C_ops.conv2d(
            swish_38, parameter_74, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_74
        ...
        conv2d_52 = paddle._C_ops.conv2d(
            swish_40, parameter_64, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_64
        ...
        conv2d_53 = paddle._C_ops.conv2d(
            concat_9, parameter_59, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_59
        ...
        conv2d_54 = paddle._C_ops.conv2d(
            concat_9, parameter_54, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_54
        ...
        conv2d_55 = paddle._C_ops.conv2d(
            swish_43, parameter_49, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_49
        ...
        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_44 = paddle._C_ops.swish(batch_norm__330)

        # pd_op.conv2d: (2x384x16x16xf32) <- (2x384x16x16xf32, 384x384x3x3xf32)
        conv2d_56 = paddle._C_ops.conv2d(
            swish_44, parameter_44, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_44
        ...
        conv2d_57 = paddle._C_ops.conv2d(
            swish_44, parameter_39, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_39
        ...
        # pd_op.add: (2x384x16x16xf32) <- (2x384x16x16xf32, 2x384x16x16xf32)
        add_48 = paddle._C_ops.add(batch_norm__336, batch_norm__342)

        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_45 = paddle._C_ops.swish(add_48)

        # pd_op.conv2d: (2x384x16x16xf32) <- (2x384x16x16xf32, 384x384x3x3xf32)
        conv2d_58 = paddle._C_ops.conv2d(
            swish_45, parameter_34, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_34
        ...
        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_46 = paddle._C_ops.swish(batch_norm__348)

        # pd_op.conv2d: (2x384x16x16xf32) <- (2x384x16x16xf32, 384x384x3x3xf32)
        conv2d_59 = paddle._C_ops.conv2d(
            swish_46, parameter_29, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_29
        ...
        conv2d_60 = paddle._C_ops.conv2d(
            swish_46, parameter_24, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_24
        ...
        # pd_op.add: (2x384x16x16xf32) <- (2x384x16x16xf32, 2x384x16x16xf32)
        add_49 = paddle._C_ops.add(batch_norm__354, batch_norm__360)

        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_47 = paddle._C_ops.swish(add_49)

        # pd_op.conv2d: (2x384x16x16xf32) <- (2x384x16x16xf32, 384x384x3x3xf32)
        conv2d_61 = paddle._C_ops.conv2d(
            swish_47, parameter_19, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_19
        ...
        conv2d_62 = paddle._C_ops.conv2d(
            swish_48, parameter_14, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_14
        ...
        conv2d_63 = paddle._C_ops.conv2d(
            swish_48, parameter_9, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_9
        ...
        # pd_op.add: (2x384x16x16xf32) <- (2x384x16x16xf32, 2x384x16x16xf32)
        add_50 = paddle._C_ops.add(batch_norm__372, batch_norm__378)

        # pd_op.swish: (2x384x16x16xf32) <- (2x384x16x16xf32)
        swish_49 = paddle._C_ops.swish(add_50)

        # builtin.combine: ([2x384x16x16xf32, 2x384x16x16xf32]) <- (2x384x16x16xf32, 2x384x16x16xf32)
        combine_11 = [swish_42, swish_49]
        ...
        # pd_op.swish: (2x768x16x16xf32) <- (2x768x16x16xf32)
        swish_0 = paddle._C_ops.swish(batch_norm__384)
        del (
            add_0,
            add_1,
            add_10,
