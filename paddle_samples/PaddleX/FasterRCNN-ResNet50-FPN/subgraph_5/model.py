...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        del full_int_array_4, full_int_array_5, shape64_4
        ...
        reshape_8 = paddle._C_ops.reshape(split_1, full_int_array_6)
        del split_1

        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_9 = paddle._C_ops.reshape(split_0, full_int_array_6)
        del split_0
        ...
        full_int_array_7 = [-1, 1, 4]

        # pd_op.reshape: (-1x1x4xf32) <- (-1x4xf32, 3xi64)
        reshape_10 = paddle._C_ops.reshape(stack_0, full_int_array_7)
        del stack_0
        ...
        reshape_11 = paddle._C_ops.reshape(data_5, full_int_array_8)
        del data_5
        ...
        reshape_0 = paddle._C_ops.reshape(add_15, full_int_array_9)
        del add_15
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_2 = paddle._C_ops.scale(slice_5, full_2, float("0"), True)
        del slice_5
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_3 = paddle._C_ops.scale(slice_4, full_2, float("0"), True)
        del slice_4
        ...
        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_12 = paddle._C_ops.reshape(split_3, full_int_array_6)
        del split_3

        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_13 = paddle._C_ops.reshape(split_2, full_int_array_6)
        del split_2
        ...
        # pd_op.reshape: (-1x1x4xf32) <- (-1x4xf32, 3xi64)
        reshape_14 = paddle._C_ops.reshape(stack_1, full_int_array_7)
        del stack_1

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_15 = paddle._C_ops.reshape(data_6, full_int_array_8)
        del data_6
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_1 = paddle._C_ops.reshape(add_16, full_int_array_9)
        del add_16
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_4 = paddle._C_ops.scale(slice_8, full_3, float("0"), True)
        del slice_8
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_5 = paddle._C_ops.scale(slice_7, full_3, float("0"), True)
        del slice_7
        ...
        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_16 = paddle._C_ops.reshape(split_5, full_int_array_6)
        del split_5

        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_17 = paddle._C_ops.reshape(split_4, full_int_array_6)
        del split_4
        ...
        # pd_op.reshape: (-1x1x4xf32) <- (-1x4xf32, 3xi64)
        reshape_18 = paddle._C_ops.reshape(stack_2, full_int_array_7)
        del stack_2

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_19 = paddle._C_ops.reshape(data_7, full_int_array_8)
        del data_7
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_2 = paddle._C_ops.reshape(add_17, full_int_array_9)
        del add_17
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_6 = paddle._C_ops.scale(slice_11, full_4, float("0"), True)
        del slice_11
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_7 = paddle._C_ops.scale(slice_10, full_4, float("0"), True)
        del slice_10
        ...
        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_20 = paddle._C_ops.reshape(split_7, full_int_array_6)
        del split_7

        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_21 = paddle._C_ops.reshape(split_6, full_int_array_6)
        del split_6
        ...
        # pd_op.reshape: (-1x1x4xf32) <- (-1x4xf32, 3xi64)
        reshape_22 = paddle._C_ops.reshape(stack_3, full_int_array_7)
        del stack_3

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_23 = paddle._C_ops.reshape(data_8, full_int_array_8)
        del data_8
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_3 = paddle._C_ops.reshape(add_18, full_int_array_9)
        del add_18
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_8 = paddle._C_ops.scale(slice_14, full_5, float("0"), True)
        del slice_14
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_9 = paddle._C_ops.scale(slice_13, full_5, float("0"), True)
        del slice_13
        ...
        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_24 = paddle._C_ops.reshape(split_9, full_int_array_6)
        del split_9

        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_25 = paddle._C_ops.reshape(split_8, full_int_array_6)
        del full_int_array_6, split_8
        ...
        # pd_op.reshape: (-1x1x4xf32) <- (-1x4xf32, 3xi64)
        reshape_26 = paddle._C_ops.reshape(stack_4, full_int_array_7)
        del full_int_array_7, stack_4

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_27 = paddle._C_ops.reshape(data_9, full_int_array_8)
        del data_9, full_int_array_8
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_4 = paddle._C_ops.reshape(add_19, full_int_array_9)
        del add_19, full_int_array_9
