...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.strided_slice: (1000x4xf32) <- (1000x16xf32, 1xi64, 1xi64, 1xi64)
        ...
        # pd_op.scale: (1000x4xf32) <- (1000x4xf32, 1xf32)
        ...
        # pd_op.clip: (1000x4xf32) <- (1000x4xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (1000x4xf32) <- (1000x4xf32, 1000x1xf32)
        ...
        # pd_op.add: (1000x4xf32) <- (1000x4xf32, 1000x1xf32)
        ...
        # pd_op.exp: (1000x4xf32) <- (1000x4xf32)
        ...
        # pd_op.subtract: (1000x4xf32) <- (1000x4xf32, 1000x4xf32)
        ...
        # pd_op.add: (1000x4xf32) <- (1000x4xf32, 1000x4xf32)
        ...
        # builtin.combine: ([1000x4xf32, 1000x4xf32, 1000x4xf32, 1000x4xf32]) <- (1000x4xf32, 1000x4xf32, 1000x4xf32, 1000x4xf32)
        combine_3 = [subtract_2, subtract_3, add_4, add_5]
        del add_4, add_5, subtract_2, subtract_3

        # pd_op.stack: (1000x4x4xf32) <- ([1000x4xf32, 1000x4xf32, 1000x4xf32, 1000x4xf32])
        ...
        # pd_op.slice: (1000x4xf32) <- (1000x5xf32, 1xi64, 1xi64)
        ...
        full_int_array_7 = [1000, 4, 4]

        # pd_op.expand: (1000x4x4xf32) <- (1000x4x4xf32, 3xi64)
        ...
        # pd_op.slice: (1000x4xf32) <- (1000x4x4xf32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            expand_1, [2], full_int_array_0, full_int_array_1, [1], [2]
        )
        del full_int_array_0

        # pd_op.minimum: (1000x4xf32) <- (1000x4xf32, -1x1xf32)
        minimum_0 = paddle._C_ops.minimum(slice_9, unsqueeze_5)
        del slice_9

        # pd_op.maximum: (1000x4xf32) <- (1000x4xf32, -1x1xf32)
