...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (154x32x144x144xf32) <- (154x3x288x288xf32, 32x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_261, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_261

        # pd_op.batch_norm_: (154x32x144x144xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (154x32x144x144xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.relu: (154x32x144x144xf32) <- (154x32x144x144xf32)
        relu_0 = paddle._C_ops.relu(batch_norm__0)
        del batch_norm__0

        # pd_op.depthwise_conv2d: (154x32x144x144xf32) <- (154x32x144x144xf32, 32x1x3x3xf32)
        ...
        # pd_op.conv2d: (154x64x144x144xf32) <- (154x32x144x144xf32, 64x32x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            relu_1, parameter_251, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_251

        # pd_op.batch_norm_: (154x64x144x144xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (154x64x144x144xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.relu: (154x64x144x144xf32) <- (154x64x144x144xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__12)
        del batch_norm__12

        # pd_op.depthwise_conv2d: (154x64x72x72xf32) <- (154x64x144x144xf32, 64x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_2, parameter_246, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del parameter_246

        # pd_op.batch_norm_: (154x64x72x72xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (154x64x72x72xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.relu: (154x64x72x72xf32) <- (154x64x72x72xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__18)
        del batch_norm__18

        # pd_op.conv2d: (154x128x72x72xf32) <- (154x64x72x72xf32, 128x64x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_3, parameter_241, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_241

        # pd_op.batch_norm_: (154x128x72x72xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (154x128x72x72xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.relu: (154x128x72x72xf32) <- (154x128x72x72xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__24)
        del batch_norm__24

        # pd_op.depthwise_conv2d: (154x128x72x72xf32) <- (154x128x72x72xf32, 128x1x3x3xf32)
        ...
        # pd_op.conv2d: (154x128x72x72xf32) <- (154x128x72x72xf32, 128x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (154x128x36x36xf32) <- (154x128x72x72xf32, 128x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_226, [2, 2], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        del parameter_226

        # pd_op.batch_norm_: (154x128x36x36xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (154x128x36x36xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.relu: (154x128x36x36xf32) <- (154x128x36x36xf32)
        relu_7 = paddle._C_ops.relu(batch_norm__42)
        del batch_norm__42

        # pd_op.conv2d: (154x256x36x36xf32) <- (154x128x36x36xf32, 256x128x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_7, parameter_221, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_221

        # pd_op.batch_norm_: (154x256x36x36xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (154x256x36x36xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.relu: (154x256x36x36xf32) <- (154x256x36x36xf32)
        relu_8 = paddle._C_ops.relu(batch_norm__48)
        del batch_norm__48

        # pd_op.depthwise_conv2d: (154x256x36x36xf32) <- (154x256x36x36xf32, 256x1x3x3xf32)
        ...
        # pd_op.conv2d: (154x256x36x36xf32) <- (154x256x36x36xf32, 256x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (154x256x18x18xf32) <- (154x256x36x36xf32, 256x1x5x5xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu_10, parameter_206, [2, 2], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        del parameter_206

        # pd_op.batch_norm_: (154x256x18x18xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (154x256x18x18xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.depthwise_conv2d: (154x256x18x18xf32) <- (154x256x36x36xf32, 256x1x3x3xf32)
        ...
        # pd_op.add: (154x256x18x18xf32) <- (154x256x18x18xf32, 154x256x18x18xf32)
        add_1 = paddle._C_ops.add(batch_norm__66, batch_norm__72)

        # pd_op.relu: (154x256x18x18xf32) <- (154x256x18x18xf32)
        ...
        # pd_op.pool2d: (154x256x1x1xf32) <- (154x256x18x18xf32, 2xi64)
        ...
        # pd_op.conv2d: (154x64x1x1xf32) <- (154x256x1x1xf32, 64x256x1x1xf32)
        ...
        # pd_op.add: (154x64x1x1xf32) <- (154x64x1x1xf32, 1x64x1x1xf32)
        add_2 = paddle._C_ops.add(conv2d_6, reshape_0)

        # pd_op.relu: (154x64x1x1xf32) <- (154x64x1x1xf32)
        relu_12 = paddle._C_ops.relu(add_2)
        del add_2

        # pd_op.conv2d: (154x256x1x1xf32) <- (154x64x1x1xf32, 256x64x1x1xf32)
        ...
        # pd_op.add: (154x256x1x1xf32) <- (154x256x1x1xf32, 1x256x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_7, reshape_1)

        # pd_op.sigmoid: (154x256x1x1xf32) <- (154x256x1x1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(add_3)
        del add_3

        # pd_op.multiply: (154x256x18x18xf32) <- (154x256x18x18xf32, 154x256x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(relu_11, sigmoid_0)

        # pd_op.conv2d: (154x256x18x18xf32) <- (154x256x18x18xf32, 256x256x1x1xf32)
        ...
        # pd_op.conv2d: (154x512x18x18xf32) <- (154x256x18x18xf32, 512x256x1x1xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            relu_13, parameter_187, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_187

        # pd_op.batch_norm_: (154x512x18x18xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (154x512x18x18xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__84,
            batch_norm__85,
            batch_norm__86,
        ...
        # pd_op.relu: (154x512x18x18xf32) <- (154x512x18x18xf32)
        relu_14 = paddle._C_ops.relu(batch_norm__84)
        del batch_norm__84

        # pd_op.depthwise_conv2d: (154x512x18x18xf32) <- (154x512x18x18xf32, 512x1x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (154x512x18x18xf32) <- (154x512x18x18xf32, 512x1x3x3xf32)
        ...
        # pd_op.add: (154x512x18x18xf32) <- (154x512x18x18xf32, 154x512x18x18xf32)
        add_4 = paddle._C_ops.add(batch_norm__90, batch_norm__96)

        # pd_op.depthwise_conv2d: (154x512x18x18xf32) <- (154x512x18x18xf32, 512x1x1x1xf32)
        ...
        # pd_op.pool2d: (154x512x1x1xf32) <- (154x512x18x18xf32, 2xi64)
        ...
        # pd_op.conv2d: (154x128x1x1xf32) <- (154x512x1x1xf32, 128x512x1x1xf32)
        ...
        # pd_op.add: (154x128x1x1xf32) <- (154x128x1x1xf32, 1x128x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_10, reshape_2)

        # pd_op.relu: (154x128x1x1xf32) <- (154x128x1x1xf32)
        relu_16 = paddle._C_ops.relu(add_6)
        del add_6

        # pd_op.conv2d: (154x512x1x1xf32) <- (154x128x1x1xf32, 512x128x1x1xf32)
        ...
        # pd_op.add: (154x512x1x1xf32) <- (154x512x1x1xf32, 1x512x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_11, reshape_3)

        # pd_op.sigmoid: (154x512x1x1xf32) <- (154x512x1x1xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(add_7)
        del add_7

        # pd_op.multiply: (154x512x18x18xf32) <- (154x512x18x18xf32, 154x512x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(relu_15, sigmoid_1)

        # pd_op.conv2d: (154x256x18x18xf32) <- (154x512x18x18xf32, 256x512x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (154x512x9x9xf32) <- (154x512x18x18xf32, 512x1x5x5xf32)
        depthwise_conv2d_22 = paddle._C_ops.depthwise_conv2d(
            relu_34, parameter_37, [2, 2], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        del parameter_37

        # pd_op.batch_norm_: (154x512x9x9xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (154x512x9x9xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__240,
            batch_norm__241,
            batch_norm__242,
        ...
        # pd_op.depthwise_conv2d: (154x512x9x9xf32) <- (154x512x18x18xf32, 512x1x3x3xf32)
        ...
        # pd_op.add: (154x512x9x9xf32) <- (154x512x9x9xf32, 154x512x9x9xf32)
        add_24 = paddle._C_ops.add(batch_norm__240, batch_norm__246)

        # pd_op.relu: (154x512x9x9xf32) <- (154x512x9x9xf32)
        relu_35 = paddle._C_ops.relu(add_24)
        del add_24

        # pd_op.conv2d: (154x1024x9x9xf32) <- (154x512x9x9xf32, 1024x512x1x1xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            relu_35, parameter_27, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_27

        # pd_op.batch_norm_: (154x1024x9x9xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32, -1xui8) <- (154x1024x9x9xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32)
        (
            batch_norm__252,
            batch_norm__253,
            batch_norm__254,
        ...
        # pd_op.relu: (154x1024x9x9xf32) <- (154x1024x9x9xf32)
        relu_36 = paddle._C_ops.relu(batch_norm__252)
        del batch_norm__252

        # pd_op.depthwise_conv2d: (154x1024x9x9xf32) <- (154x1024x9x9xf32, 1024x1x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (154x1024x9x9xf32) <- (154x1024x9x9xf32, 1024x1x3x3xf32)
        ...
        # pd_op.add: (154x1024x9x9xf32) <- (154x1024x9x9xf32, 154x1024x9x9xf32)
        add_25 = paddle._C_ops.add(batch_norm__258, batch_norm__264)

        # pd_op.depthwise_conv2d: (154x1024x9x9xf32) <- (154x1024x9x9xf32, 1024x1x1x1xf32)
        ...
        # pd_op.conv2d: (154x1024x9x9xf32) <- (154x1024x9x9xf32, 1024x1024x1x1xf32)
        ...
        # pd_op.pool2d: (154x1024x1x1xf32) <- (154x1024x9x9xf32, 2xi64)
        ...
        # pd_op.conv2d: (154x1280x1x1xf32) <- (154x1024x1x1xf32, 1280x1024x1x1xf32)
