...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        multiply_0 = paddle._C_ops.multiply(data_26, relu_0)
        del data_26

        # pd_op.add: (-1x16x224x224xf32) <- (-1x16x224x224xf32, 1xf32)
        add_0 = paddle._C_ops.add(multiply_0, data_27)
        del data_27
        ...
        multiply_1 = paddle._C_ops.multiply(data_28, relu_1)
        del data_28

        # pd_op.add: (-1x8x224x224xf32) <- (-1x8x224x224xf32, 1xf32)
        add_1 = paddle._C_ops.add(multiply_1, data_29)
        del data_29
        ...
        # pd_op.multiply: (-1x16x224x224xf32) <- (1xf32, -1x16x224x224xf32)
        multiply_2 = paddle._C_ops.multiply(data_30, relu_2)
        del data_30

        # pd_op.add: (-1x16x224x224xf32) <- (-1x16x224x224xf32, 1xf32)
        add_2 = paddle._C_ops.add(multiply_2, data_31)
        del data_31
        ...
        multiply_3 = paddle._C_ops.multiply(data_32, relu_3)
        del data_32

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_3 = paddle._C_ops.add(multiply_3, data_33)
        del data_33
        ...
        # pd_op.multiply: (-1x16x112x112xf32) <- (1xf32, -1x16x112x112xf32)
        multiply_4 = paddle._C_ops.multiply(data_34, relu_4)
        del data_34

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_4 = paddle._C_ops.add(multiply_4, data_35)
        del data_35
        ...
        # pd_op.multiply: (-1x16x112x112xf32) <- (1xf32, -1x16x112x112xf32)
        multiply_5 = paddle._C_ops.multiply(data_36, relu_5)
        del data_36

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_5 = paddle._C_ops.add(multiply_5, data_37)
        del data_37
        ...
        # pd_op.multiply: (-1x16x112x112xf32) <- (1xf32, -1x16x112x112xf32)
        multiply_6 = paddle._C_ops.multiply(data_38, relu_6)
        del data_38

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_6 = paddle._C_ops.add(multiply_6, data_39)
        del data_39
        ...
        # pd_op.multiply: (-1x16x112x112xf32) <- (1xf32, -1x16x112x112xf32)
        multiply_7 = paddle._C_ops.multiply(data_40, relu_7)
        del data_40

        # pd_op.add: (-1x16x112x112xf32) <- (-1x16x112x112xf32, 1xf32)
        add_7 = paddle._C_ops.add(multiply_7, data_41)
        del data_41
        ...
        multiply_8 = paddle._C_ops.multiply(data_42, relu_8)
        del data_42

        # pd_op.add: (-1x32x112x112xf32) <- (-1x32x112x112xf32, 1xf32)
        add_8 = paddle._C_ops.add(multiply_8, data_43)
        del data_43
        ...
        multiply_9 = paddle._C_ops.multiply(data_44, relu_9)
        del data_44

        # pd_op.add: (-1x64x112x112xf32) <- (-1x64x112x112xf32, 1xf32)
        add_9 = paddle._C_ops.add(multiply_9, data_45)
        del data_45
        ...
        multiply_10 = paddle._C_ops.multiply(data_46, relu_10)
        del data_46

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_10 = paddle._C_ops.add(multiply_10, data_47)
        del data_47
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_11 = paddle._C_ops.multiply(data_48, relu_11)
        del data_48

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_11 = paddle._C_ops.add(multiply_11, data_49)
        del data_49
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_12 = paddle._C_ops.multiply(data_50, relu_12)
        del data_50

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_12 = paddle._C_ops.add(multiply_12, data_51)
        del data_51
        ...
        multiply_13 = paddle._C_ops.multiply(data_52, relu_13)
        del data_52

        # pd_op.add: (-1x128x56x56xf32) <- (-1x128x56x56xf32, 1xf32)
        add_13 = paddle._C_ops.add(multiply_13, data_53)
        del data_53
        ...
        multiply_14 = paddle._C_ops.multiply(data_54, relu_14)
        del data_54

        # pd_op.add: (-1x256x56x56xf32) <- (-1x256x56x56xf32, 1xf32)
        add_14 = paddle._C_ops.add(multiply_14, data_55)
        del data_55
        ...
        multiply_15 = paddle._C_ops.multiply(data_56, relu_15)
        del data_56

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_15 = paddle._C_ops.add(multiply_15, data_57)
        del data_57
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_16 = paddle._C_ops.multiply(data_58, relu_16)
        del data_58

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_16 = paddle._C_ops.add(multiply_16, data_59)
        del data_59
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_17 = paddle._C_ops.multiply(data_60, relu_17)
        del data_60

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_17 = paddle._C_ops.add(multiply_17, data_61)
        del data_61
        ...
        multiply_18 = paddle._C_ops.multiply(data_62, relu_18)
        del data_62

        # pd_op.add: (-1x256x28x28xf32) <- (-1x256x28x28xf32, 1xf32)
        add_18 = paddle._C_ops.add(multiply_18, data_0)
        del data_0
        ...
        multiply_19 = paddle._C_ops.multiply(data_1, relu_19)
        del data_1

        # pd_op.add: (-1x512x28x28xf32) <- (-1x512x28x28xf32, 1xf32)
        add_19 = paddle._C_ops.add(multiply_19, data_2)
        del data_2
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_20 = paddle._C_ops.multiply(data_3, relu_20)
        del data_3

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_20 = paddle._C_ops.add(multiply_20, data_4)
        del data_4
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_21 = paddle._C_ops.multiply(data_5, relu_21)
        del data_5

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_21 = paddle._C_ops.add(multiply_21, data_6)
        del data_6
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_22 = paddle._C_ops.multiply(data_7, relu_22)
        del data_7

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_22 = paddle._C_ops.add(multiply_22, data_8)
        del data_8
        ...
        # pd_op.multiply: (-1x256x28x28xf32) <- (1xf32, -1x256x28x28xf32)
        multiply_23 = paddle._C_ops.multiply(data_9, relu_23)
        del data_9

        # pd_op.add: (-1x256x28x28xf32) <- (-1x256x28x28xf32, 1xf32)
        add_23 = paddle._C_ops.add(multiply_23, data_10)
        del data_10
        ...
        # pd_op.multiply: (-1x512x28x28xf32) <- (1xf32, -1x512x28x28xf32)
        multiply_24 = paddle._C_ops.multiply(data_11, relu_24)
        del data_11

        # pd_op.add: (-1x512x28x28xf32) <- (-1x512x28x28xf32, 1xf32)
        add_24 = paddle._C_ops.add(multiply_24, data_12)
        del data_12
        ...
        multiply_25 = paddle._C_ops.multiply(data_13, relu_25)
        del data_13

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_26 = paddle._C_ops.add(multiply_25, data_14)
        del data_14
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_26 = paddle._C_ops.multiply(data_15, relu_26)
        del data_15

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_27 = paddle._C_ops.add(multiply_26, data_16)
        del data_16
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_27 = paddle._C_ops.multiply(data_17, relu_27)
        del data_17

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_28 = paddle._C_ops.add(multiply_27, data_18)
        del data_18
        ...
        multiply_28 = paddle._C_ops.multiply(data_19, relu_28)
        del data_19

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_29 = paddle._C_ops.add(multiply_28, data_20)
        del data_20
        ...
        multiply_29 = paddle._C_ops.multiply(data_21, relu_29)
        del data_21

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, 1xf32)
        add_30 = paddle._C_ops.add(multiply_29, data_22)
        del data_22
        ...
        multiply_30 = paddle._C_ops.multiply(data_23, relu_30)
        del data_23

        # pd_op.add: (-1x2048x14x14xf32) <- (-1x2048x14x14xf32, 1xf32)
        add_31 = paddle._C_ops.add(multiply_30, data_24)
        del data_24
        ...
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_25, full_int_array_1)
        del data_25, full_int_array_1
        ...
        dropout_4, dropout_5 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_37, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_37
        ...
        dropout_6, dropout_7 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                relu_32, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
