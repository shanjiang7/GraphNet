...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (2x512x256xf32) <- (2x512x512xf32, 512x256xf32)
        ...
        # pd_op.matmul: (2x2048x256xf32) <- (2x2048x320xf32, 320x256xf32)
        ...
        # pd_op.matmul: (2x8192x256xf32) <- (2x8192x128xf32, 128x256xf32)
