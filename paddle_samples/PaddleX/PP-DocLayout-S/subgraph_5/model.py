...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x16x224x224xf32) <- (1x3x448x448xf32, 16x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_441, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_441

        # pd_op.batch_norm_: (1x16x224x224xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (1x16x224x224xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (1x16x224x224xf32) <- (1x16x224x224xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (1x16x224x224xf32) <- (1x16x224x224xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (1x24x224x224xf32) <- (1x16x224x224xf32, 24x16x1x1xf32)
        ...
        # pd_op.hardswish: (1x24x224x224xf32) <- (1x24x224x224xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (1x24x112x112xf32) <- (1x24x224x224xf32, 24x1x3x3xf32)
        ...
        # pd_op.depthwise_conv2d: (1x192x28x28xf32) <- (1x192x28x28xf32, 192x1x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (1x192x14x14xf32) <- (1x192x28x28xf32, 192x1x5x5xf32)
        ...
        # pd_op.pool2d: (1x192x1x1xf32) <- (1x192x14x14xf32, 2xi64)
        ...
        # pd_op.multiply: (1x192x14x14xf32) <- (1x192x14x14xf32, 1x192x1x1xf32)
        ...
        # pd_op.pool2d: (1x384x1x1xf32) <- (1x384x14x14xf32, 2xi64)
        ...
        # pd_op.multiply: (1x384x14x14xf32) <- (1x384x14x14xf32, 1x384x1x1xf32)
        ...
        # pd_op.conv2d: (1x96x28x28xf32) <- (1x192x28x28xf32, 96x192x1x1xf32)
        ...
        # pd_op.nearest_interp: (1x96x28x28xf32) <- (1x96x14x14xf32, None, None, None)
        ...
        # builtin.combine: ([1x96x28x28xf32, 1x96x28x28xf32]) <- (1x96x28x28xf32, 1x96x28x28xf32)
        combine_0 = [nearest_interp_0, hardswish_28]

        # pd_op.concat: (1x192x28x28xf32) <- ([1x96x28x28xf32, 1x96x28x28xf32], 1xi32)
        ...
        # pd_op.nearest_interp: (1x96x56x56xf32) <- (1x96x28x28xf32, None, None, None)
        ...
        # builtin.combine: ([1x96x56x56xf32, 1x96x56x56xf32]) <- (1x96x56x56xf32, 1x96x56x56xf32)
        combine_1 = [nearest_interp_1, hardswish_27]

        # pd_op.concat: (1x192x56x56xf32) <- ([1x96x56x56xf32, 1x96x56x56xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_1, full_0)
        del combine_1

        # pd_op.depthwise_conv2d: (1x192x56x56xf32) <- (1x192x56x56xf32, 192x1x5x5xf32)
        ...
        # pd_op.hardswish: (1x192x56x56xf32) <- (1x192x56x56xf32)
        ...
        # pd_op.depthwise_conv2d: (1x96x28x28xf32) <- (1x96x56x56xf32, 96x1x5x5xf32)
        ...
        # builtin.combine: ([1x96x14x14xf32, 1x96x14x14xf32]) <- (1x96x14x14xf32, 1x96x14x14xf32)
        combine_3 = [hardswish_45, hardswish_29]

        # pd_op.concat: (1x192x14x14xf32) <- ([1x96x14x14xf32, 1x96x14x14xf32], 1xi32)
        ...
        # pd_op.conv2d: (1x96x14x14xf32) <- (1x192x14x14xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (1x96x7x7xf32) <- (1x96x14x14xf32, 96x1x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (1x96x56x56xf32) <- (1x96x56x56xf32, 96x1x5x5xf32)
        ...
        # pd_op.multiply: (1x96x56x56xf32) <- (1x96x56x56xf32, 1x96x1x1xf32)
        ...
        # pd_op.conv2d: (1x11x56x56xf32) <- (1x96x56x56xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (1x11x56x56xf32) <- (1x11x56x56xf32, 1x11x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_37, reshape_5)

        # pd_op.conv2d: (1x32x56x56xf32) <- (1x96x56x56xf32, 32x96x1x1xf32)
        ...
        # pd_op.conv2d: (1x1x56x56xf32) <- (1x96x56x56xf32, 1x96x5x5xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            hardswish_57, parameter_132, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_132

        # pd_op.batch_norm_: (1x1x56x56xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (1x1x56x56xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__354,
            batch_norm__355,
            batch_norm__356,
        ...
        # pd_op.hardswish: (1x1x56x56xf32) <- (1x1x56x56xf32)
        hardswish_59 = paddle._C_ops.hardswish(batch_norm__354)

        # pd_op.conv2d: (1x1x56x56xf32) <- (1x1x56x56xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (1x1x56x56xf32) <- (1x1x56x56xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__360)
        del batch_norm__360

        # pd_op.sigmoid: (1x11x56x56xf32) <- (1x11x56x56xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_6)
        del add_6

        # pd_op.multiply: (1x11x56x56xf32) <- (1x11x56x56xf32, 1x1x56x56xf32)
        ...
        # pd_op.scale: (1x11x56x56xf32) <- (1x11x56x56xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(multiply_3, full_1, float("1e-09"), True)
        del multiply_3

        # pd_op.sqrt: (1x11x56x56xf32) <- (1x11x56x56xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_0)
        del scale_0

        # pd_op.transpose: (1x56x56x11xf32) <- (1x11x56x56xf32)
        transpose_0 = paddle._C_ops.transpose(sqrt_0, [0, 2, 3, 1])

        # pd_op.transpose: (1x56x56x32xf32) <- (1x32x56x56xf32)
        ...
        full_int_array_7 = [1, -1, 11]

        # pd_op.reshape: (1x3136x11xf32) <- (1x56x56x11xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([1x3136x2xf32, 1x3136x2xf32]) <- (1x3136x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_10, 2, full_6)
        del reshape_10

        # builtin.split: (1x3136x2xf32, 1x3136x2xf32) <- ([1x3136x2xf32, 1x3136x2xf32])
        (
            split_2,
            split_3,
        ) = split_with_num_0
        ...
        # pd_op.scale: (1x3136x2xf32) <- (1x3136x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_2, full_7, float("0"), True)
        del split_2

        # pd_op.add: (1x3136x2xf32) <- (1x3136x2xf32, 3136x2xf32)
        ...
        # builtin.combine: ([1x3136x2xf32, 1x3136x2xf32]) <- (1x3136x2xf32, 1x3136x2xf32)
        combine_6 = [add_8, add_9]

        # pd_op.concat: (1x3136x4xf32) <- ([1x3136x2xf32, 1x3136x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_8)
        del combine_6

        # pd_op.flatten: (1x11x3136xf32) <- (1x11x56x56xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (1x3136x11xf32) <- (1x11x3136xf32)
        transpose_2 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])
        del flatten_2

        # pd_op.flatten: (1x32x3136xf32) <- (1x32x56x56xf32)
        ...
        # pd_op.scale: (1x3136x4xf32) <- (1x3136x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_7, full_9, float("0"), True)
        del concat_7

        # pd_op.shape64: (4xi64) <- (1x96x28x28xf32)
        ...
        # pd_op.depthwise_conv2d: (1x96x28x28xf32) <- (1x96x28x28xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (1x96x1x1xf32) <- (1x96x28x28xf32, 2xi64)
        ...
        # pd_op.multiply: (1x96x28x28xf32) <- (1x96x28x28xf32, 1x96x1x1xf32)
        ...
        # pd_op.conv2d: (1x11x28x28xf32) <- (1x96x28x28xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (1x11x28x28xf32) <- (1x11x28x28xf32, 1x11x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_45, reshape_12)

        # pd_op.conv2d: (1x32x28x28xf32) <- (1x96x28x28xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (1x32x28x28xf32) <- (1x32x28x28xf32, 1x32x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_46, reshape_13)

        # pd_op.conv2d: (1x1x28x28xf32) <- (1x96x28x28xf32, 1x96x5x5xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            hardswish_63, parameter_91, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_91

        # pd_op.batch_norm_: (1x1x28x28xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (1x1x28x28xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__396,
            batch_norm__397,
            batch_norm__398,
        ...
        # pd_op.hardswish: (1x1x28x28xf32) <- (1x1x28x28xf32)
        hardswish_65 = paddle._C_ops.hardswish(batch_norm__396)

        # pd_op.conv2d: (1x1x28x28xf32) <- (1x1x28x28xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (1x1x28x28xf32) <- (1x1x28x28xf32)
        sigmoid_4 = paddle._C_ops.sigmoid(batch_norm__402)
        del batch_norm__402

        # pd_op.sigmoid: (1x11x28x28xf32) <- (1x11x28x28xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_11)
        del add_11

        # pd_op.multiply: (1x11x28x28xf32) <- (1x11x28x28xf32, 1x1x28x28xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (1x11x28x28xf32) <- (1x11x28x28xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)
        del multiply_5

        # pd_op.sqrt: (1x11x28x28xf32) <- (1x11x28x28xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_6)
        del scale_6

        # pd_op.transpose: (1x28x28x11xf32) <- (1x11x28x28xf32)
        transpose_4 = paddle._C_ops.transpose(sqrt_1, [0, 2, 3, 1])

        # pd_op.transpose: (1x28x28x32xf32) <- (1x32x28x28xf32)
        ...
        # pd_op.scale: (1x784x2xf32) <- (1x784x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_6, full_7, float("0"), True)
        del split_6

        # pd_op.add: (1x784x2xf32) <- (1x784x2xf32, 784x2xf32)
        add_13 = paddle._C_ops.add(scale_10, stack_1)

        # pd_op.add: (1x784x2xf32) <- (1x784x2xf32, 784x2xf32)
        add_14 = paddle._C_ops.add(split_7, stack_1)

        # builtin.combine: ([1x784x2xf32, 1x784x2xf32]) <- (1x784x2xf32, 1x784x2xf32)
        combine_9 = [add_13, add_14]

        # pd_op.concat: (1x784x4xf32) <- ([1x784x2xf32, 1x784x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_8)
        del combine_9

        # pd_op.flatten: (1x11x784xf32) <- (1x11x28x28xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (1x784x11xf32) <- (1x11x784xf32)
        transpose_6 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])
        del flatten_6

        # pd_op.flatten: (1x32x784xf32) <- (1x32x28x28xf32)
        flatten_7 = paddle._C_ops.flatten(add_12, 2, 3)

        # pd_op.transpose: (1x784x32xf32) <- (1x32x784xf32)
        ...
        # pd_op.scale: (1x784x4xf32) <- (1x784x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_8, full_12, float("0"), True)
        del concat_8

        # pd_op.shape64: (4xi64) <- (1x96x14x14xf32)
        ...
        # pd_op.conv2d: (1x11x14x14xf32) <- (1x96x14x14xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (1x11x14x14xf32) <- (1x11x14x14xf32, 1x11x1x1xf32)
        ...
        # pd_op.add: (1x32x14x14xf32) <- (1x32x14x14xf32, 1x32x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_54, reshape_20)

        # pd_op.conv2d: (1x1x14x14xf32) <- (1x96x14x14xf32, 1x96x5x5xf32)
        conv2d_55 = paddle._C_ops.conv2d(
            hardswish_69, parameter_50, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_50

        # pd_op.batch_norm_: (1x1x14x14xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (1x1x14x14xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__438,
            batch_norm__439,
            batch_norm__440,
        ...
        # pd_op.hardswish: (1x1x14x14xf32) <- (1x1x14x14xf32)
        hardswish_71 = paddle._C_ops.hardswish(batch_norm__438)

        # pd_op.conv2d: (1x1x14x14xf32) <- (1x1x14x14xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (1x1x14x14xf32) <- (1x1x14x14xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__444)
        del batch_norm__444

        # pd_op.sigmoid: (1x11x14x14xf32) <- (1x11x14x14xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_16)
        del add_16

        # pd_op.multiply: (1x11x14x14xf32) <- (1x11x14x14xf32, 1x1x14x14xf32)
        multiply_7 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (1x11x14x14xf32) <- (1x11x14x14xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_7, full_1, float("1e-09"), True)
        del multiply_7

        # pd_op.sqrt: (1x11x14x14xf32) <- (1x11x14x14xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_12)
        del scale_12

        # pd_op.transpose: (1x14x14x11xf32) <- (1x11x14x14xf32)
        transpose_8 = paddle._C_ops.transpose(sqrt_2, [0, 2, 3, 1])

        # pd_op.transpose: (1x14x14x32xf32) <- (1x32x14x14xf32)
        ...
        # pd_op.scale: (1x196x2xf32) <- (1x196x2xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(split_10, full_7, float("0"), True)
        del split_10

        # pd_op.add: (1x196x2xf32) <- (1x196x2xf32, 196x2xf32)
        add_18 = paddle._C_ops.add(scale_16, stack_2)

        # pd_op.add: (1x196x2xf32) <- (1x196x2xf32, 196x2xf32)
        add_19 = paddle._C_ops.add(split_11, stack_2)

        # builtin.combine: ([1x196x2xf32, 1x196x2xf32]) <- (1x196x2xf32, 1x196x2xf32)
        combine_12 = [add_18, add_19]

        # pd_op.concat: (1x196x4xf32) <- ([1x196x2xf32, 1x196x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_8)
        del combine_12

        # pd_op.flatten: (1x11x196xf32) <- (1x11x14x14xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (1x196x11xf32) <- (1x11x196xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])
        del flatten_10

        # pd_op.flatten: (1x32x196xf32) <- (1x32x14x14xf32)
        flatten_11 = paddle._C_ops.flatten(add_17, 2, 3)

        # pd_op.transpose: (1x196x32xf32) <- (1x32x196xf32)
        ...
        # pd_op.scale: (1x196x4xf32) <- (1x196x4xf32, 1xf32)
        ...
        # pd_op.conv2d: (1x11x7x7xf32) <- (1x96x7x7xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (1x11x7x7xf32) <- (1x11x7x7xf32, 1x11x1x1xf32)
        ...
        # pd_op.sigmoid: (1x11x7x7xf32) <- (1x11x7x7xf32)
        sigmoid_11 = paddle._C_ops.sigmoid(add_21)
        del add_21

        # pd_op.multiply: (1x11x7x7xf32) <- (1x11x7x7xf32, 1x1x7x7xf32)
        multiply_9 = paddle._C_ops.multiply(sigmoid_11, sigmoid_10)

        # pd_op.scale: (1x11x7x7xf32) <- (1x11x7x7xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(multiply_9, full_1, float("1e-09"), True)
        del multiply_9

        # pd_op.sqrt: (1x11x7x7xf32) <- (1x11x7x7xf32)
        sqrt_3 = paddle._C_ops.sqrt(scale_18)
        del scale_18

        # pd_op.transpose: (1x7x7x11xf32) <- (1x11x7x7xf32)
        ...
        # pd_op.scale: (1x49x4xf32) <- (1x49x4xf32, 1xf32)
        scale_23 = paddle._C_ops.scale(concat_10, full_18, float("0"), True)
        del concat_10

        # builtin.combine: ([1x3136x11xf32, 1x784x11xf32, 1x196x11xf32, 1x49x11xf32]) <- (1x3136x11xf32, 1x784x11xf32, 1x196x11xf32, 1x49x11xf32)
        combine_16 = [transpose_2, transpose_6, transpose_10, transpose_14]

        # pd_op.concat: (1x4165x11xf32) <- ([1x3136x11xf32, 1x784x11xf32, 1x196x11xf32, 1x49x11xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_16, full_0)
        del combine_16

        # builtin.combine: ([1x3136x4xf32, 1x784x4xf32, 1x196x4xf32, 1x49x4xf32]) <- (1x3136x4xf32, 1x784x4xf32, 1x196x4xf32, 1x49x4xf32)
        combine_17 = [scale_5, scale_11, scale_17, scale_23]

        # pd_op.concat: (1x4165x4xf32) <- ([1x3136x4xf32, 1x784x4xf32, 1x196x4xf32, 1x49x4xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_17, full_0)
        del combine_17

        # builtin.combine: ([1x3136x32xf32, 1x784x32xf32, 1x196x32xf32, 1x49x32xf32]) <- (1x3136x32xf32, 1x784x32xf32, 1x196x32xf32, 1x49x32xf32)
        combine_18 = [transpose_3, transpose_7, transpose_11, transpose_15]

        # pd_op.concat: (1x4165x32xf32) <- ([1x3136x32xf32, 1x784x32xf32, 1x196x32xf32, 1x49x32xf32], 1xi32)
