...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.unsqueeze: (2x21x1x4xf32) <- (2x21x4xf32, 1xi64)
        ...
        # pd_op.unsqueeze: (2x1x2100x4xf32) <- (2x2100x4xf32, 1xi64)
        ...
        # pd_op.slice: (2x21x1x2xf32) <- (2x21x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.slice: (2x1x2100x2xf32) <- (2x1x2100x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (2x21x2100x2xf32) <- (2x21x1x2xf32, 2x1x2100x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (2x21x2100x2xf32) <- (2x21x1x2xf32, 2x1x2100x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (2x21x2100x2xf32) <- (2x21x2100x2xf32, 2x21x2100x2xf32)
        ...
        # pd_op.clip: (2x21x2100x2xf32) <- (2x21x2100x2xf32, 1xf32, 1xf32)
        ...
        # pd_op.scale: (2x21x2100xf32) <- (2x21x2100xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)
        del full_2, subtract_3

        # pd_op.divide: (2x21x2100xf32) <- (2x21x2100xf32, 2x21x2100xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.transpose: (2x1x2100xf32) <- (2x2100x1xf32)
        ...
        # pd_op.unsqueeze: (1x1x2100x2xf32) <- (2100x2xf32, 2xi64)
        ...
        # pd_op.split_with_num: ([1x1x2100x1xf32, 1x1x2100x1xf32]) <- (1x1x2100x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_3, 2, full_6)
        del unsqueeze_3

        # builtin.split: (1x1x2100x1xf32, 1x1x2100x1xf32) <- ([1x1x2100x1xf32, 1x1x2100x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.split_with_num: ([2x21x1x1xf32, 2x21x1x1xf32, 2x21x1x1xf32, 2x21x1x1xf32]) <- (2x21x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_0, 4, full_6)
        del full_6, unsqueeze_0

        # builtin.split: (2x21x1x1xf32, 2x21x1x1xf32, 2x21x1x1xf32, 2x21x1x1xf32) <- ([2x21x1x1xf32, 2x21x1x1xf32, 2x21x1x1xf32, 2x21x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (2x21x2100x1xf32) <- (2x21x1x1xf32, 1x1x2100x1xf32)
        ...
        # builtin.combine: ([2x21x2100x1xf32, 2x21x2100x1xf32, 2x21x2100x1xf32, 2x21x2100x1xf32]) <- (2x21x2100x1xf32, 2x21x2100x1xf32, 2x21x2100x1xf32, 2x21x2100x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (2x21x2100x4xf32) <- ([2x21x2100x1xf32, 2x21x2100x1xf32, 2x21x2100x1xf32, 2x21x2100x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)
        del combine_1, full_7

        # pd_op.min: (2x21x2100xf32) <- (2x21x2100x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x21x2100xb) <- (2x21x2100xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)
        del full_8, min_0

        # pd_op.cast: (2x21x2100xf32) <- (2x21x2100xb)
        ...
        # pd_op.topk: (2x21x13xf32, 2x21x13xi64) <- (2x21x2100xf32, 1xi32)
        ...
        full_10 = paddle._C_ops.full(
            [1], float("2100"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (2x21x13x2100xf32) <- (2x21x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x21x2100xf32) <- (2x21x13x2100xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (2x2100xf32, 0xi64)
