...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        full_0 = paddle._C_ops.full(
            [], float("4632"), paddle.int64, paddle.framework._current_expected_place()
        )
        ...
        # pd_op.cast: (4632x11xf32) <- (4632x11xf64)
        ...
        # pd_op.greater_than: (4632x11xb) <- (4632x11xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_1)

        # pd_op.cast: (4632x11xf32) <- (4632x11xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)
        del greater_than_0

        # pd_op.multiply: (4632x11xf32) <- (4632x11xf32, 4632x11xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)
        del cast_1

        # pd_op.subtract: (4632x11xf32) <- (-1x11xf32, 4632x11xf32)
        subtract_0 = paddle._C_ops.subtract(data_6, cast_0)

        # pd_op.abs: (4632x11xf32) <- (4632x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)
        del subtract_0

        # pd_op.pow: (4632x11xf32) <- (4632x11xf32)
        ...
        # pd_op.scale: (4632x11xf32) <- (4632x11xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_2, float("0"), True)
        del full_2, pow_0

        # pd_op.less_equal: (4632x11xb) <- (4632x11xf32, xf32)
        ...
        # pd_op.add: (4632x11xf32) <- (4632x11xf32, 4632x11xf32)
        add_1 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (-1x11xf32) <- (-1x11xf32, 4632x11xf32)
        bce_loss_0 = paddle._C_ops.bce_loss(data_6, cast_0)
        del cast_0, data_6

        # pd_op.multiply: (4632x11xf32) <- (-1x11xf32, 4632x11xf32)
        ...
        # pd_op.sum: (4632xf32) <- (4632x11xf32, 1xi64)
        ...
        # pd_op.reshape: (-1x-1xf32) <- (4632xf32, 2xi64)
