...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        floor_divide_0 = paddle._C_ops.floor_divide(data_3, cast_0)
        del data_3
        ...
        combine_0 = [data_0, floor_divide_0, cast_0, full_0]
        del cast_0, floor_divide_0

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_0 = paddle._C_ops.stack(combine_0, 0)
        del combine_0

        # pd_op.reshape: (-1x-1x-1x32xf32) <- (-1x96x32xf32, 4xi64)
        ...
        combine_3 = [data_0, full_1, full_0]
        ...
        reshape_13 = paddle._C_ops.reshape(transpose_1, stack_3)
        del stack_3, transpose_1
        ...
        del full_int_array_2, full_int_array_3, reshape_13
