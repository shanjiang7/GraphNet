...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        cast_0 = paddle._C_ops.cast(data_2, paddle.int64)
        del data_2

        # pd_op.floor_divide: (xi64) <- (xi64, xi64)
        floor_divide_0 = paddle._C_ops.floor_divide(data_4, cast_0)
        ...
        subtract_0 = paddle._C_ops.subtract(multiply_0, data_4)
        del data_4
        ...
        combine_0 = [data_1, subtract_0, full_1]
        del data_1, subtract_0
        ...
        # pd_op.full_with_tensor: (-1x-1x32xf32) <- (1xf32, 3xi64)
        full_with_tensor_0 = paddle._C_ops.full_with_tensor(
            full_2, stack_0, paddle.float32
        )
        del full_2, stack_0

        # pd_op.cast: (-1x96x32xf32) <- (-1x96x32xf32)
        cast_1 = paddle._C_ops.cast(data_3, paddle.float32)
        del data_3

        # pd_op.cast: (-1x-1x32xf32) <- (-1x-1x32xf32)
        ...
        # builtin.combine: ([-1x96x32xf32, -1x-1x32xf32]) <- (-1x96x32xf32, -1x-1x32xf32)
        combine_1 = [cast_1, cast_2]
        del cast_1, cast_2

        # pd_op.concat: (-1x-1x32xf32) <- ([-1x96x32xf32, -1x-1x32xf32], 1xi32)
        ...
        combine_2 = [data_0, floor_divide_1, cast_0, full_1]
        del cast_0, floor_divide_1
        ...
        # pd_op.conv2d: (-1x64x-1x-1xf32) <- (-1x32x-1x-1xf32, 64x32x5x5xf32)
        ...
        # pd_op.conv2d: (-1x64x-1x-1xf32) <- (-1x32x-1x-1xf32, 64x32x7x7xf32)
        ...
        # pd_op.conv2d: (-1x64x-1x-1xf32) <- (-1x32x-1x-1xf32, 64x32x9x9xf32)
        ...
        # pd_op.conv2d: (-1x64x-1x-1xf32) <- (-1x32x-1x-1xf32, 64x32x11x11xf32)
        ...
        # builtin.combine: ([-1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32]) <- (-1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32)
        combine_3 = [add_0, add_1, add_2, add_3, add_4, add_5]
        del add_0, add_1, add_2, add_3, add_4, add_5

        # pd_op.stack: (-1x64x-1x-1x6xf32) <- ([-1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32, -1x64x-1x-1xf32])
        ...
        # pd_op.mean: (-1x64x-1x-1xf32) <- (-1x64x-1x-1x6xf32, 1xi64)
        mean_0 = paddle._C_ops.mean(stack_2, full_int_array_1, False)
        del stack_2

        # pd_op.gelu: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32)
        ...
        # pd_op.conv2d: (-1x32x-1x-1xf32) <- (-1x64x-1x-1xf32, 32x64x5x5xf32)
        ...
        # pd_op.conv2d: (-1x32x-1x-1xf32) <- (-1x64x-1x-1xf32, 32x64x7x7xf32)
        ...
        # pd_op.conv2d: (-1x32x-1x-1xf32) <- (-1x64x-1x-1xf32, 32x64x9x9xf32)
        ...
        # pd_op.conv2d: (-1x32x-1x-1xf32) <- (-1x64x-1x-1xf32, 32x64x11x11xf32)
        ...
        # pd_op.mean: (-1x32x-1x-1xf32) <- (-1x32x-1x-1x6xf32, 1xi64)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_5 = [data_0, full_4, full_1]
        del data_0, full_1, full_4

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_4 = paddle._C_ops.stack(combine_5, 0)
        del combine_5

        # pd_op.reshape: (-1x-1x32xf32) <- (-1x-1x-1x32xf32, 3xi64)
        reshape_13 = paddle._C_ops.reshape(transpose_1, stack_4)
        del stack_4, transpose_1
        ...
        # pd_op.slice: (-1x-1x32xf32) <- (-1x-1x32xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            reshape_13, [1], full_int_array_2, full_int_array_3, [1], []
        )
        del (
            full_int_array_2,
            full_int_array_3,
