    ...
    def forward(
        ...
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_1, parameter_111, parameter_110, float("1e-12"), 2
            ),
        ...
        add_2 = paddle._C_ops.add(matmul_0, parameter_108)
        del parameter_108
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_3 = paddle._C_ops.add(matmul_1, parameter_106)
        del parameter_106
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_4 = paddle._C_ops.add(matmul_2, parameter_104)
        del parameter_104
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_8 = paddle._C_ops.add(matmul_5, parameter_102)
        del parameter_102
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_9, parameter_97, parameter_96, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        add_10 = paddle._C_ops.add(matmul_6, parameter_100)
        del parameter_100
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_11 = paddle._C_ops.add(matmul_7, parameter_98)
        del parameter_98
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_12, parameter_95, parameter_94, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_13 = paddle._C_ops.add(matmul_8, parameter_92)
        del parameter_92
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_14 = paddle._C_ops.add(matmul_9, parameter_90)
        del parameter_90
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_15 = paddle._C_ops.add(matmul_10, parameter_88)
        del parameter_88
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_19 = paddle._C_ops.add(matmul_13, parameter_86)
        del parameter_86
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_20, parameter_81, parameter_80, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x1536xf32) <- (1x11x1536xf32, 1536xf32)
        add_21 = paddle._C_ops.add(matmul_14, parameter_84)
        del parameter_84
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_22 = paddle._C_ops.add(matmul_15, parameter_82)
        del parameter_82
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_23, parameter_79, parameter_78, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_24 = paddle._C_ops.add(matmul_16, parameter_76)
        del parameter_76
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_25 = paddle._C_ops.add(matmul_17, parameter_74)
        del parameter_74
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_26 = paddle._C_ops.add(matmul_18, parameter_72)
        del parameter_72
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_30 = paddle._C_ops.add(matmul_21, parameter_70)
        del parameter_70
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_31, parameter_65, parameter_64, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x1536xf32) <- (1x11x1536xf32, 1536xf32)
        add_32 = paddle._C_ops.add(matmul_22, parameter_68)
        del parameter_68
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_33 = paddle._C_ops.add(matmul_23, parameter_66)
        del parameter_66
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_34, parameter_63, parameter_62, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_35 = paddle._C_ops.add(matmul_24, parameter_60)
        del parameter_60
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_36 = paddle._C_ops.add(matmul_25, parameter_58)
        del parameter_58
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_37 = paddle._C_ops.add(matmul_26, parameter_56)
        del parameter_56
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_41 = paddle._C_ops.add(matmul_29, parameter_54)
        del parameter_54
        ...
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_42, parameter_49, parameter_48, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x1536xf32) <- (1x11x1536xf32, 1536xf32)
        add_43 = paddle._C_ops.add(matmul_30, parameter_52)
        del parameter_52
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_44 = paddle._C_ops.add(matmul_31, parameter_50)
        del parameter_50
        ...
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_45, parameter_47, parameter_46, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_46 = paddle._C_ops.add(matmul_32, parameter_44)
        del parameter_44
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_47 = paddle._C_ops.add(matmul_33, parameter_42)
        del parameter_42
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_48 = paddle._C_ops.add(matmul_34, parameter_40)
        del parameter_40
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_52 = paddle._C_ops.add(matmul_37, parameter_38)
        del parameter_38
        ...
        layer_norm_27, layer_norm_28, layer_norm_29 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_53, parameter_33, parameter_32, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x1536xf32) <- (1x11x1536xf32, 1536xf32)
        add_54 = paddle._C_ops.add(matmul_38, parameter_36)
        del parameter_36
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_55 = paddle._C_ops.add(matmul_39, parameter_34)
        del parameter_34
        ...
        layer_norm_30, layer_norm_31, layer_norm_32 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_56, parameter_31, parameter_30, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_57 = paddle._C_ops.add(matmul_40, parameter_28)
        del parameter_28
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_58 = paddle._C_ops.add(matmul_41, parameter_26)
        del parameter_26
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_59 = paddle._C_ops.add(matmul_42, parameter_24)
        del parameter_24
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_63 = paddle._C_ops.add(matmul_45, parameter_22)
        del parameter_22
        ...
        layer_norm_33, layer_norm_34, layer_norm_35 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_64, parameter_17, parameter_16, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x1536xf32) <- (1x11x1536xf32, 1536xf32)
        add_65 = paddle._C_ops.add(matmul_46, parameter_20)
        del parameter_20
        ...
        # pd_op.add: (1x11x384xf32) <- (1x11x384xf32, 384xf32)
        add_66 = paddle._C_ops.add(matmul_47, parameter_18)
        del parameter_18
        ...
        layer_norm_36, layer_norm_37, layer_norm_38 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_67, parameter_15, parameter_14, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        add_0 = paddle._C_ops.add(matmul_48, parameter_12)
        del (
            add_1,
            add_10,
            add_12,
