...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x27x768xf32) <- (1x27xi64, 21128x768xf32)
        ...
        # pd_op.embedding: (1x27x768xf32) <- (1x27xi64, 512x768xf32)
        embedding_1 = paddle._C_ops.embedding(scale_2, parameter_197, -1, False)
        del parameter_197, scale_2

        # pd_op.embedding: (1x27x768xf32) <- (1x27xi64, 2x768xf32)
        embedding_2 = paddle._C_ops.embedding(data_1, parameter_196, -1, False)
        del data_1, parameter_196

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 1x27x768xf32)
        ...
        # pd_op.layer_norm: (1x27x768xf32, 1x27xf32, 1x27xf32) <- (1x27x768xf32, 768xf32, 768xf32)
        ...
        # pd_op.dropout: (1x27x768xf32, 1x27x768xui8) <- (1x27x768xf32, None, 1xf32)
        ...
        # pd_op.matmul: (1x27x768xf32) <- (1x27x768xf32, 768x768xf32)
        matmul_0 = paddle._C_ops.matmul(dropout_0, parameter_193, False, False)
        del parameter_193

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        ...
        # pd_op.reshape: (1x27x12x64xf32) <- (1x27x768xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(add_2, full_int_array_1)
        del add_2

        # pd_op.transpose: (1x12x27x64xf32) <- (1x27x12x64xf32)
        ...
        # pd_op.scale: (1x12x27x64xf32) <- (1x12x27x64xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(transpose_0, full_5, float("0"), True)
        del transpose_0

        # pd_op.matmul: (1x12x27x27xf32) <- (1x12x27x64xf32, 1x12x27x64xf32)
        matmul_3 = paddle._C_ops.matmul(scale_3, transpose_1, False, True)
        del scale_3, transpose_1

        # pd_op.add: (1x12x27x27xf32) <- (1x12x27x27xf32, 1x1x1x27xf32)
        add_5 = paddle._C_ops.add(matmul_3, unsqueeze_0)
        del matmul_3

        # pd_op.softmax: (1x12x27x27xf32) <- (1x12x27x27xf32)
        softmax_0 = paddle._C_ops.softmax(add_5, -1)
        del add_5

        # pd_op.dropout: (1x12x27x27xf32, 1x12x27x27xui8) <- (1x12x27x27xf32, None, 1xf32)
        ...
        # pd_op.matmul: (1x12x27x64xf32) <- (1x12x27x27xf32, 1x12x27x64xf32)
        matmul_4 = paddle._C_ops.matmul(dropout_2, transpose_2, False, False)
        del dropout_2, transpose_2

        # pd_op.transpose: (1x27x12x64xf32) <- (1x12x27x64xf32)
        ...
        # pd_op.reshape: (1x27x768xf32) <- (1x27x12x64xf32, 3xi64)
        ...
        del add_7, parameter_180, parameter_181

        # pd_op.matmul: (1x27x3072xf32) <- (1x27x768xf32, 768x3072xf32)
        matmul_6 = paddle._C_ops.matmul(layer_norm_3, parameter_185, False, False)
        del parameter_185

        # pd_op.add: (1x27x3072xf32) <- (1x27x3072xf32, 3072xf32)
        add_8 = paddle._C_ops.add(matmul_6, parameter_184)
        del matmul_6, parameter_184

        # pd_op.gelu: (1x27x3072xf32) <- (1x27x3072xf32)
        gelu_0 = paddle._C_ops.gelu(add_8, False)
        del add_8

        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        ...
        del add_10, parameter_178, parameter_179
        ...
        del add_19, parameter_162, parameter_163
        ...
        del add_25, parameter_148, parameter_149
        ...
        del add_28, parameter_146, parameter_147
        ...
        del add_34, parameter_132, parameter_133
        ...
        del add_37, parameter_130, parameter_131
        ...
        del add_43, parameter_116, parameter_117
        ...
        del add_46, parameter_114, parameter_115
        ...
        del add_52, parameter_100, parameter_101
        ...
        del add_55, parameter_98, parameter_99
        ...
        del add_61, parameter_84, parameter_85
        ...
        del add_64, parameter_82, parameter_83
        ...
        del add_70, parameter_68, parameter_69
        ...
        del add_73, parameter_66, parameter_67
        ...
        del add_79, parameter_52, parameter_53
        ...
        del add_82, parameter_50, parameter_51
        ...
        del add_88, parameter_36, parameter_37
        ...
        del add_91, parameter_34, parameter_35
        ...
        del add_97, parameter_20, parameter_21
        ...
        del add_100, parameter_18, parameter_19
        ...
        del add_106, parameter_4, parameter_5
        ...
        del add_109, parameter_2, parameter_3
        ...
        # pd_op.slice: (1x768xf32) <- (1x27x768xf32, 1xi64, 1xi64)
