...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x128xf32, 128x2048xf32)
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x2048xf32, 2048x2048xf32)
        ...
        full_int_array_4 = [1, 11, 16, 128]

        # pd_op.reshape: (1x11x16x128xf32) <- (1x11x2048xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(add_3, full_int_array_4)
        del add_3

        # pd_op.transpose: (1x16x11x128xf32) <- (1x11x16x128xf32)
        ...
        # pd_op.matmul: (1x16x11x11xf32) <- (1x16x11x128xf32, 1x16x11x128xf32)
        ...
        # pd_op.matmul: (1x16x11x128xf32) <- (1x16x11x11xf32, 1x16x11x128xf32)
        matmul_5 = paddle._C_ops.matmul(softmax_0, transpose_2, False, False)
        del softmax_0, transpose_2

        # pd_op.transpose: (1x11x16x128xf32) <- (1x16x11x128xf32)
        ...
        # pd_op.reshape: (1x11x2048xf32) <- (1x11x16x128xf32, 3xi64)
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_8 = paddle._C_ops.add(add_2, add_7)
        del add_2, add_7

        # pd_op.layer_norm: (1x11x2048xf32, 1x11xf32, 1x11xf32) <- (1x11x2048xf32, 2048xf32, 2048xf32)
        ...
        # pd_op.matmul: (1x11x8192xf32) <- (1x11x2048xf32, 2048x8192xf32)
        matmul_7 = paddle._C_ops.matmul(layer_norm_3, parameter_6, False, False)

        # pd_op.add: (1x11x8192xf32) <- (1x11x8192xf32, 8192xf32)
        add_9 = paddle._C_ops.add(matmul_7, parameter_5)
        del matmul_7

        # pd_op.relu: (1x11x8192xf32) <- (1x11x8192xf32)
        relu_0 = paddle._C_ops.relu(add_9)
        del add_9

        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_14 = paddle._C_ops.scale(matmul_100, full_2, float("0"), True)
        del matmul_100
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_116 = paddle._C_ops.add(layer_norm_72, add_115)
        del add_115, layer_norm_72
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_104 = paddle._C_ops.matmul(relu_12, parameter_4, False, False)
        del relu_12
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_15 = paddle._C_ops.scale(matmul_108, full_2, float("0"), True)
        del matmul_108
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_125 = paddle._C_ops.add(layer_norm_78, add_124)
        del add_124, layer_norm_78
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_112 = paddle._C_ops.matmul(relu_13, parameter_4, False, False)
        del relu_13
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(matmul_116, full_2, float("0"), True)
        del matmul_116
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_134 = paddle._C_ops.add(layer_norm_84, add_133)
        del add_133, layer_norm_84
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_120 = paddle._C_ops.matmul(relu_14, parameter_4, False, False)
        del relu_14
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(matmul_124, full_2, float("0"), True)
        del matmul_124
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_143 = paddle._C_ops.add(layer_norm_90, add_142)
        del add_142, layer_norm_90
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_128 = paddle._C_ops.matmul(relu_15, parameter_4, False, False)
        del relu_15
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(matmul_132, full_2, float("0"), True)
        del matmul_132
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_152 = paddle._C_ops.add(layer_norm_96, add_151)
        del add_151, layer_norm_96
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_136 = paddle._C_ops.matmul(relu_16, parameter_4, False, False)
        del relu_16
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_19 = paddle._C_ops.scale(matmul_140, full_2, float("0"), True)
        del matmul_140
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_161 = paddle._C_ops.add(layer_norm_102, add_160)
        del add_160, layer_norm_102
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_144 = paddle._C_ops.matmul(relu_17, parameter_4, False, False)
        del relu_17
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_20 = paddle._C_ops.scale(matmul_148, full_2, float("0"), True)
        del matmul_148
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_170 = paddle._C_ops.add(layer_norm_108, add_169)
        del add_169, layer_norm_108
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_152 = paddle._C_ops.matmul(relu_18, parameter_4, False, False)
        del relu_18
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_21 = paddle._C_ops.scale(matmul_156, full_2, float("0"), True)
        del matmul_156
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_179 = paddle._C_ops.add(layer_norm_114, add_178)
        del add_178, layer_norm_114
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_160 = paddle._C_ops.matmul(relu_19, parameter_4, False, False)
        del relu_19
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_22 = paddle._C_ops.scale(matmul_164, full_2, float("0"), True)
        del matmul_164
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_188 = paddle._C_ops.add(layer_norm_120, add_187)
        del add_187, layer_norm_120
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_168 = paddle._C_ops.matmul(relu_20, parameter_4, False, False)
        del relu_20
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_23 = paddle._C_ops.scale(matmul_172, full_2, float("0"), True)
        del matmul_172
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_197 = paddle._C_ops.add(layer_norm_126, add_196)
        del add_196, layer_norm_126
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_176 = paddle._C_ops.matmul(relu_21, parameter_4, False, False)
        del relu_21
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_24 = paddle._C_ops.scale(matmul_180, full_2, float("0"), True)
        del matmul_180
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_206 = paddle._C_ops.add(layer_norm_132, add_205)
        del add_205, layer_norm_132
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_184 = paddle._C_ops.matmul(relu_22, parameter_4, False, False)
        del relu_22
        ...
        # pd_op.scale: (1x16x11x11xf32) <- (1x16x11x11xf32, 1xf32)
        scale_25 = paddle._C_ops.scale(matmul_188, full_2, float("0"), True)
        ...
        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 1x11x2048xf32)
        add_215 = paddle._C_ops.add(layer_norm_138, add_214)
        del add_214, layer_norm_138
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x8192xf32, 8192x2048xf32)
        matmul_192 = paddle._C_ops.matmul(relu_23, parameter_4, False, False)
        del parameter_4, relu_23
        ...
        # pd_op.slice: (1x2048xf32) <- (1x11x2048xf32, 1xi64, 1xi64)
