...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x11x384xf32) <- (1x11xi64, 40000x384xf32)
        ...
        # pd_op.embedding: (1x11x384xf32) <- (1x11xi64, 2048x384xf32)
        ...
        # pd_op.embedding: (1x11x384xf32) <- (1x11xi64, 4x384xf32)
        ...
        # pd_op.scale: (1x12x11x32xf32) <- (1x12x11x32xf32, 1xf32)
