...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x21x128xf32) <- (1x21xi64, 39981x128xf32)
        ...
        # pd_op.embedding: (1x21x128xf32) <- (1x21xi64, 2048x128xf32)
        ...
        # pd_op.embedding: (1x21x128xf32) <- (1x21xi64, 4x128xf32)
        ...
        # pd_op.matmul: (1x21x128xf32) <- (1x21x128xf32, 128x128xf32)
        ...
        # pd_op.scale: (1x2x21x64xf32) <- (1x2x21x64xf32, 1xf32)
        ...
        # pd_op.reshape: (1x21x128xf32) <- (1x21x2x64xf32, 3xi64)
        ...
        # pd_op.matmul: (1x21x512xf32) <- (1x21x128xf32, 128x512xf32)
        matmul_6 = paddle._C_ops.matmul(layer_norm_3, parameter_41, False, False)
        del parameter_41

        # pd_op.add: (1x21x512xf32) <- (1x21x512xf32, 512xf32)
        add_8 = paddle._C_ops.add(matmul_6, parameter_40)
        del parameter_40

        # pd_op.gelu: (1x21x512xf32) <- (1x21x512xf32)
        gelu_0 = paddle._C_ops.gelu(add_8, False)

        # pd_op.matmul: (1x21x128xf32) <- (1x21x512xf32, 512x128xf32)
        ...
        # pd_op.slice: (1x128xf32) <- (1x21x128xf32, 1xi64, 1xi64)
