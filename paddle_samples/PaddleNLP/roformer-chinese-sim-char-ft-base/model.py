...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_1 = paddle._C_ops.add(embedding_0, embedding_1)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_1, parameter_219, parameter_218, float("1e-12"), 2
            ),
        ...
        add_2 = paddle._C_ops.add(matmul_0, parameter_216)
        del parameter_216
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_3 = paddle._C_ops.add(matmul_1, parameter_214)
        del parameter_214
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_4 = paddle._C_ops.add(matmul_2, parameter_212)
        del parameter_212
        ...
        add_7 = paddle._C_ops.add(matmul_3, unsqueeze_0)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_8 = paddle._C_ops.add(matmul_5, parameter_210)
        del parameter_210
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_9 = paddle._C_ops.add(dropout_0, dropout_4)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_9, parameter_205, parameter_204, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        add_10 = paddle._C_ops.add(matmul_6, parameter_208)
        del parameter_208

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_0 = paddle._C_ops.gelu(add_10, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_11 = paddle._C_ops.add(matmul_7, parameter_206)
        del parameter_206
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_12, parameter_203, parameter_202, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_13 = paddle._C_ops.add(matmul_8, parameter_200)
        del parameter_200
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_14 = paddle._C_ops.add(matmul_9, parameter_198)
        del parameter_198
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_15 = paddle._C_ops.add(matmul_10, parameter_196)
        del parameter_196
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_16 = paddle._C_ops.add(multiply_10, multiply_11)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_2 = [subtract_2, add_16]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_18 = paddle._C_ops.add(matmul_11, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_1 = paddle._C_ops.softmax(add_18, -1)
        del add_18
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_19 = paddle._C_ops.add(matmul_13, parameter_194)
        del parameter_194
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_20 = paddle._C_ops.add(layer_norm_6, dropout_10)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_20, parameter_189, parameter_188, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_21 = paddle._C_ops.add(matmul_14, parameter_192)
        del parameter_192

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_1 = paddle._C_ops.gelu(add_21, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_22 = paddle._C_ops.add(matmul_15, parameter_190)
        del parameter_190
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_23 = paddle._C_ops.add(layer_norm_9, dropout_12)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_23, parameter_187, parameter_186, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_24 = paddle._C_ops.add(matmul_16, parameter_184)
        del parameter_184

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_8 = paddle._C_ops.reshape(add_24, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_25 = paddle._C_ops.add(matmul_17, parameter_182)
        del parameter_182
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_26 = paddle._C_ops.add(matmul_18, parameter_180)
        del parameter_180

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_9 = paddle._C_ops.reshape(add_25, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_10 = paddle._C_ops.reshape(add_26, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_27 = paddle._C_ops.add(multiply_18, multiply_19)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_4 = [subtract_4, add_27]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_28 = paddle._C_ops.add(multiply_22, multiply_23)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_5 = [subtract_5, add_28]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_29 = paddle._C_ops.add(matmul_19, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_2 = paddle._C_ops.softmax(add_29, -1)
        del add_29
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_30 = paddle._C_ops.add(matmul_21, parameter_178)
        del parameter_178

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_16, dropout_17 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_30, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_30
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_31 = paddle._C_ops.add(layer_norm_12, dropout_16)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_31, parameter_173, parameter_172, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_32 = paddle._C_ops.add(matmul_22, parameter_176)
        del parameter_176
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_33 = paddle._C_ops.add(matmul_23, parameter_174)
        del parameter_174
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_34 = paddle._C_ops.add(layer_norm_15, dropout_18)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_34, parameter_171, parameter_170, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_35 = paddle._C_ops.add(matmul_24, parameter_168)
        del parameter_168

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_12 = paddle._C_ops.reshape(add_35, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_36 = paddle._C_ops.add(matmul_25, parameter_166)
        del parameter_166
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_37 = paddle._C_ops.add(matmul_26, parameter_164)
        del parameter_164

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_13 = paddle._C_ops.reshape(add_36, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_14 = paddle._C_ops.reshape(add_37, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_38 = paddle._C_ops.add(multiply_26, multiply_27)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_6 = [subtract_6, add_38]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_39 = paddle._C_ops.add(multiply_30, multiply_31)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_7 = [subtract_7, add_39]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_40 = paddle._C_ops.add(matmul_27, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_3 = paddle._C_ops.softmax(add_40, -1)
        del add_40
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_41 = paddle._C_ops.add(matmul_29, parameter_162)
        del parameter_162

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_22, dropout_23 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_41, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_41
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_42 = paddle._C_ops.add(layer_norm_18, dropout_22)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_42, parameter_157, parameter_156, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_43 = paddle._C_ops.add(matmul_30, parameter_160)
        del parameter_160

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_3 = paddle._C_ops.gelu(add_43, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_44 = paddle._C_ops.add(matmul_31, parameter_158)
        del parameter_158

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_24, dropout_25 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_44, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_44
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_45 = paddle._C_ops.add(layer_norm_21, dropout_24)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_45, parameter_155, parameter_154, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_46 = paddle._C_ops.add(matmul_32, parameter_152)
        del parameter_152

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_16 = paddle._C_ops.reshape(add_46, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_47 = paddle._C_ops.add(matmul_33, parameter_150)
        del parameter_150
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_48 = paddle._C_ops.add(matmul_34, parameter_148)
        del parameter_148

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_17 = paddle._C_ops.reshape(add_47, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_18 = paddle._C_ops.reshape(add_48, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_49 = paddle._C_ops.add(multiply_34, multiply_35)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_8 = [subtract_8, add_49]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_50 = paddle._C_ops.add(multiply_38, multiply_39)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_9 = [subtract_9, add_50]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_51 = paddle._C_ops.add(matmul_35, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_4 = paddle._C_ops.softmax(add_51, -1)
        del add_51
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_52 = paddle._C_ops.add(matmul_37, parameter_146)
        del parameter_146

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_28, dropout_29 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_52, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_52
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_53 = paddle._C_ops.add(layer_norm_24, dropout_28)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_27, layer_norm_28, layer_norm_29 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_53, parameter_141, parameter_140, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_54 = paddle._C_ops.add(matmul_38, parameter_144)
        del parameter_144

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_4 = paddle._C_ops.gelu(add_54, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_55 = paddle._C_ops.add(matmul_39, parameter_142)
        del parameter_142

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_30, dropout_31 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_55, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_55
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_56 = paddle._C_ops.add(layer_norm_27, dropout_30)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_30, layer_norm_31, layer_norm_32 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_56, parameter_139, parameter_138, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_57 = paddle._C_ops.add(matmul_40, parameter_136)
        del parameter_136

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_20 = paddle._C_ops.reshape(add_57, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_58 = paddle._C_ops.add(matmul_41, parameter_134)
        del parameter_134
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_59 = paddle._C_ops.add(matmul_42, parameter_132)
        del parameter_132

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_21 = paddle._C_ops.reshape(add_58, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_22 = paddle._C_ops.reshape(add_59, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_60 = paddle._C_ops.add(multiply_42, multiply_43)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_10 = [subtract_10, add_60]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_61 = paddle._C_ops.add(multiply_46, multiply_47)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_11 = [subtract_11, add_61]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_62 = paddle._C_ops.add(matmul_43, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_5 = paddle._C_ops.softmax(add_62, -1)
        del add_62
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_63 = paddle._C_ops.add(matmul_45, parameter_130)
        del parameter_130

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_34, dropout_35 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_63, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_63
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_64 = paddle._C_ops.add(layer_norm_30, dropout_34)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_33, layer_norm_34, layer_norm_35 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_64, parameter_125, parameter_124, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_65 = paddle._C_ops.add(matmul_46, parameter_128)
        del parameter_128

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_5 = paddle._C_ops.gelu(add_65, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_66 = paddle._C_ops.add(matmul_47, parameter_126)
        del parameter_126

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_36, dropout_37 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_66, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_66
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_67 = paddle._C_ops.add(layer_norm_33, dropout_36)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_36, layer_norm_37, layer_norm_38 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_67, parameter_123, parameter_122, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_68 = paddle._C_ops.add(matmul_48, parameter_120)
        del parameter_120

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_24 = paddle._C_ops.reshape(add_68, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_69 = paddle._C_ops.add(matmul_49, parameter_118)
        del parameter_118
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_70 = paddle._C_ops.add(matmul_50, parameter_116)
        del parameter_116

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_25 = paddle._C_ops.reshape(add_69, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_26 = paddle._C_ops.reshape(add_70, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_71 = paddle._C_ops.add(multiply_50, multiply_51)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_12 = [subtract_12, add_71]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_72 = paddle._C_ops.add(multiply_54, multiply_55)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_13 = [subtract_13, add_72]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_73 = paddle._C_ops.add(matmul_51, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_6 = paddle._C_ops.softmax(add_73, -1)
        del add_73
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_74 = paddle._C_ops.add(matmul_53, parameter_114)
        del parameter_114

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_40, dropout_41 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_74, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_74
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_75 = paddle._C_ops.add(layer_norm_36, dropout_40)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_39, layer_norm_40, layer_norm_41 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_75, parameter_109, parameter_108, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_76 = paddle._C_ops.add(matmul_54, parameter_112)
        del parameter_112

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_6 = paddle._C_ops.gelu(add_76, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_77 = paddle._C_ops.add(matmul_55, parameter_110)
        del parameter_110

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_42, dropout_43 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_77, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_77
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_78 = paddle._C_ops.add(layer_norm_39, dropout_42)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_42, layer_norm_43, layer_norm_44 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_78, parameter_107, parameter_106, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_79 = paddle._C_ops.add(matmul_56, parameter_104)
        del parameter_104

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_28 = paddle._C_ops.reshape(add_79, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_80 = paddle._C_ops.add(matmul_57, parameter_102)
        del parameter_102
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_81 = paddle._C_ops.add(matmul_58, parameter_100)
        del parameter_100

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_29 = paddle._C_ops.reshape(add_80, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_30 = paddle._C_ops.reshape(add_81, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_82 = paddle._C_ops.add(multiply_58, multiply_59)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_14 = [subtract_14, add_82]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_83 = paddle._C_ops.add(multiply_62, multiply_63)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_15 = [subtract_15, add_83]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_84 = paddle._C_ops.add(matmul_59, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_7 = paddle._C_ops.softmax(add_84, -1)
        del add_84
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_85 = paddle._C_ops.add(matmul_61, parameter_98)
        del parameter_98

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_46, dropout_47 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_85, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_85
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_86 = paddle._C_ops.add(layer_norm_42, dropout_46)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_45, layer_norm_46, layer_norm_47 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_86, parameter_93, parameter_92, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_87 = paddle._C_ops.add(matmul_62, parameter_96)
        del parameter_96

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_7 = paddle._C_ops.gelu(add_87, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_88 = paddle._C_ops.add(matmul_63, parameter_94)
        del parameter_94

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_48, dropout_49 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_88, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_88
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_89 = paddle._C_ops.add(layer_norm_45, dropout_48)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_48, layer_norm_49, layer_norm_50 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_89, parameter_91, parameter_90, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_90 = paddle._C_ops.add(matmul_64, parameter_88)
        del parameter_88

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_32 = paddle._C_ops.reshape(add_90, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_91 = paddle._C_ops.add(matmul_65, parameter_86)
        del parameter_86
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_92 = paddle._C_ops.add(matmul_66, parameter_84)
        del parameter_84

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_33 = paddle._C_ops.reshape(add_91, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_34 = paddle._C_ops.reshape(add_92, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_93 = paddle._C_ops.add(multiply_66, multiply_67)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_16 = [subtract_16, add_93]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_94 = paddle._C_ops.add(multiply_70, multiply_71)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_17 = [subtract_17, add_94]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_95 = paddle._C_ops.add(matmul_67, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_8 = paddle._C_ops.softmax(add_95, -1)
        del add_95
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_96 = paddle._C_ops.add(matmul_69, parameter_82)
        del parameter_82
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_97 = paddle._C_ops.add(layer_norm_48, dropout_52)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_51, layer_norm_52, layer_norm_53 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_97, parameter_77, parameter_76, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_98 = paddle._C_ops.add(matmul_70, parameter_80)
        del parameter_80
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_99 = paddle._C_ops.add(matmul_71, parameter_78)
        del parameter_78

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_54, dropout_55 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_99, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_99
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_100 = paddle._C_ops.add(layer_norm_51, dropout_54)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_54, layer_norm_55, layer_norm_56 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_100, parameter_75, parameter_74, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_101 = paddle._C_ops.add(matmul_72, parameter_72)
        del parameter_72

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_36 = paddle._C_ops.reshape(add_101, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_102 = paddle._C_ops.add(matmul_73, parameter_70)
        del parameter_70
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_103 = paddle._C_ops.add(matmul_74, parameter_68)
        del parameter_68

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_37 = paddle._C_ops.reshape(add_102, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_38 = paddle._C_ops.reshape(add_103, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_104 = paddle._C_ops.add(multiply_74, multiply_75)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_18 = [subtract_18, add_104]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_105 = paddle._C_ops.add(multiply_78, multiply_79)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_19 = [subtract_19, add_105]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_106 = paddle._C_ops.add(matmul_75, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_9 = paddle._C_ops.softmax(add_106, -1)
        del add_106
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_107 = paddle._C_ops.add(matmul_77, parameter_66)
        del parameter_66

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_58, dropout_59 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_107, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_107
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_108 = paddle._C_ops.add(layer_norm_54, dropout_58)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_57, layer_norm_58, layer_norm_59 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_108, parameter_61, parameter_60, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_109 = paddle._C_ops.add(matmul_78, parameter_64)
        del parameter_64

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_9 = paddle._C_ops.gelu(add_109, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_110 = paddle._C_ops.add(matmul_79, parameter_62)
        del parameter_62

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_60, dropout_61 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_110, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_110
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_111 = paddle._C_ops.add(layer_norm_57, dropout_60)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_60, layer_norm_61, layer_norm_62 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_111, parameter_59, parameter_58, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_112 = paddle._C_ops.add(matmul_80, parameter_56)
        del parameter_56

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_40 = paddle._C_ops.reshape(add_112, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_113 = paddle._C_ops.add(matmul_81, parameter_54)
        del parameter_54
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_114 = paddle._C_ops.add(matmul_82, parameter_52)
        del parameter_52

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_41 = paddle._C_ops.reshape(add_113, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_42 = paddle._C_ops.reshape(add_114, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_115 = paddle._C_ops.add(multiply_82, multiply_83)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_20 = [subtract_20, add_115]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_116 = paddle._C_ops.add(multiply_86, multiply_87)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_21 = [subtract_21, add_116]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_117 = paddle._C_ops.add(matmul_83, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_10 = paddle._C_ops.softmax(add_117, -1)
        del add_117
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_118 = paddle._C_ops.add(matmul_85, parameter_50)
        del parameter_50

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_64, dropout_65 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_118, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_118
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_119 = paddle._C_ops.add(layer_norm_60, dropout_64)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_63, layer_norm_64, layer_norm_65 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_119, parameter_45, parameter_44, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_120 = paddle._C_ops.add(matmul_86, parameter_48)
        del parameter_48

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_10 = paddle._C_ops.gelu(add_120, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_121 = paddle._C_ops.add(matmul_87, parameter_46)
        del parameter_46

        # pd_op.dropout: (1x11x768xf32, 1x11x768xui8) <- (1x11x768xf32, None, 1xf32)
        dropout_66, dropout_67 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                add_121, None, full_2, False, "upscale_in_train", 0, False
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del add_121
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_122 = paddle._C_ops.add(layer_norm_63, dropout_66)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_66, layer_norm_67, layer_norm_68 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_122, parameter_43, parameter_42, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_123 = paddle._C_ops.add(matmul_88, parameter_40)
        del parameter_40

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_44 = paddle._C_ops.reshape(add_123, full_int_array_1)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_124 = paddle._C_ops.add(matmul_89, parameter_38)
        del parameter_38
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_125 = paddle._C_ops.add(matmul_90, parameter_36)
        del parameter_36

        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_45 = paddle._C_ops.reshape(add_124, full_int_array_1)
        ...
        # pd_op.reshape: (1x11x12x64xf32) <- (1x11x768xf32, 4xi64)
        reshape_46 = paddle._C_ops.reshape(add_125, full_int_array_1)
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_126 = paddle._C_ops.add(multiply_90, multiply_91)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_22 = [subtract_22, add_126]
        ...
        # pd_op.add: (1x12x11x32xf32) <- (1x12x11x32xf32, 1x12x11x32xf32)
        add_127 = paddle._C_ops.add(multiply_94, multiply_95)

        # builtin.combine: ([1x12x11x32xf32, 1x12x11x32xf32]) <- (1x12x11x32xf32, 1x12x11x32xf32)
        combine_23 = [subtract_23, add_127]
        ...
        # pd_op.add: (1x12x11x11xf32) <- (1x12x11x11xf32, 1x1x1x11xf32)
        add_128 = paddle._C_ops.add(matmul_91, unsqueeze_0)

        # pd_op.softmax: (1x12x11x11xf32) <- (1x12x11x11xf32)
        softmax_11 = paddle._C_ops.softmax(add_128, -1)
        del add_128
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_129 = paddle._C_ops.add(matmul_93, parameter_34)
        del parameter_34
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_130 = paddle._C_ops.add(layer_norm_66, dropout_70)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_69, layer_norm_70, layer_norm_71 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_130, parameter_29, parameter_28, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_131 = paddle._C_ops.add(matmul_94, parameter_32)
        del parameter_32

        # pd_op.gelu: (1x11x3072xf32) <- (1x11x3072xf32)
        gelu_11 = paddle._C_ops.gelu(add_131, False)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_132 = paddle._C_ops.add(matmul_95, parameter_30)
        del parameter_30
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 1x11x768xf32)
        add_133 = paddle._C_ops.add(layer_norm_69, dropout_72)

        # pd_op.layer_norm: (1x11x768xf32, 1x11xf32, 1x11xf32) <- (1x11x768xf32, 768xf32, 768xf32)
        layer_norm_72, layer_norm_73, layer_norm_74 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_133, parameter_27, parameter_26, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        add_0 = paddle._C_ops.add(matmul_96, parameter_24)
        del (
            add_1,
            add_10,
            add_100,
