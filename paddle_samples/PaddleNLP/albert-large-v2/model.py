...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (1x21x1024xf32) <- (1x21x128xf32, 128x1024xf32)
        ...
        # pd_op.scale: (1x21x4096xf32) <- (1x21x4096xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(add_9, full_3, float("0"), True)

        # pd_op.pow: (1x21x4096xf32) <- (1x21x4096xf32)
        ...
        # pd_op.tanh: (1x21x4096xf32) <- (1x21x4096xf32)
        ...
        # pd_op.multiply: (1x21x4096xf32) <- (1x21x4096xf32, 1x21x4096xf32)
