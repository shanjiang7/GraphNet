...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_70, 0, False)
        del parameter_70
        ...
        embedding_1 = paddle._C_ops.embedding(scale_2, parameter_69, -1, False)
        del parameter_69, scale_2

        # pd_op.embedding: (1x27x768xf32) <- (1x27xi64, 2x768xf32)
        embedding_2 = paddle._C_ops.embedding(data_1, parameter_68, -1, False)
        del data_1, parameter_68
        ...
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_1, parameter_67, parameter_66, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_1, parameter_66, parameter_67
        ...
        add_2 = paddle._C_ops.add(matmul_0, parameter_64)
        del matmul_0, parameter_64
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_3 = paddle._C_ops.add(matmul_1, parameter_62)
        del matmul_1, parameter_62
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_4 = paddle._C_ops.add(matmul_2, parameter_60)
        del matmul_2, parameter_60
        ...
        del parameter_59, reshape_3

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_6 = paddle._C_ops.add(matmul_5, parameter_58)
        del matmul_5, parameter_58
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_7, parameter_53, parameter_52, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_7, parameter_52, parameter_53
        ...
        add_8 = paddle._C_ops.add(matmul_6, parameter_56)
        del matmul_6, parameter_56
        ...
        del gelu_0, parameter_55

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_9 = paddle._C_ops.add(matmul_7, parameter_54)
        del matmul_7, parameter_54
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_10, parameter_51, parameter_50, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_10, parameter_50, parameter_51
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_11 = paddle._C_ops.add(matmul_8, parameter_48)
        del matmul_8, parameter_48
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_12 = paddle._C_ops.add(matmul_9, parameter_46)
        del matmul_9, parameter_46
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_13 = paddle._C_ops.add(matmul_10, parameter_44)
        del matmul_10, parameter_44
        ...
        del parameter_43, reshape_7

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_15 = paddle._C_ops.add(matmul_13, parameter_42)
        del matmul_13, parameter_42
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_16, parameter_37, parameter_36, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_16, parameter_36, parameter_37
        ...
        # pd_op.add: (1x27x3072xf32) <- (1x27x3072xf32, 3072xf32)
        add_17 = paddle._C_ops.add(matmul_14, parameter_40)
        del matmul_14, parameter_40
        ...
        del gelu_1, parameter_39

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_18 = paddle._C_ops.add(matmul_15, parameter_38)
        del matmul_15, parameter_38
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_19, parameter_35, parameter_34, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_19, parameter_34, parameter_35
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_20 = paddle._C_ops.add(matmul_16, parameter_32)
        del matmul_16, parameter_32
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_21 = paddle._C_ops.add(matmul_17, parameter_30)
        del matmul_17, parameter_30
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_22 = paddle._C_ops.add(matmul_18, parameter_28)
        del matmul_18, parameter_28
        ...
        del parameter_27, reshape_11

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_24 = paddle._C_ops.add(matmul_21, parameter_26)
        del matmul_21, parameter_26
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_25, parameter_21, parameter_20, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_25, parameter_20, parameter_21
        ...
        # pd_op.add: (1x27x3072xf32) <- (1x27x3072xf32, 3072xf32)
        add_26 = paddle._C_ops.add(matmul_22, parameter_24)
        del matmul_22, parameter_24
        ...
        del gelu_2, parameter_23

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_27 = paddle._C_ops.add(matmul_23, parameter_22)
        del matmul_23, parameter_22
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_28, parameter_19, parameter_18, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_28, parameter_18, parameter_19
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_29 = paddle._C_ops.add(matmul_24, parameter_16)
        del matmul_24, parameter_16
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_30 = paddle._C_ops.add(matmul_25, parameter_14)
        del matmul_25, parameter_14
        ...
        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_31 = paddle._C_ops.add(matmul_26, parameter_12)
        del matmul_26, parameter_12
        ...
        del parameter_11, reshape_15

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_33 = paddle._C_ops.add(matmul_29, parameter_10)
        del matmul_29, parameter_10
        ...
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_34, parameter_5, parameter_4, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_34, parameter_4, parameter_5
        ...
        del gelu_3, parameter_7

        # pd_op.add: (1x27x768xf32) <- (1x27x768xf32, 768xf32)
        add_36 = paddle._C_ops.add(matmul_31, parameter_6)
        del matmul_31, parameter_6
        ...
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_37, parameter_3, parameter_2, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_37, parameter_2, parameter_3
        ...
        add_38 = paddle._C_ops.add(matmul_32, parameter_0)
        del matmul_32, parameter_0
