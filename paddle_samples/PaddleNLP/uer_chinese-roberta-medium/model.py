...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x11x512xf32) <- (1x11xi64, 21128x512xf32)
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_134, -1, False)
        del data_0, parameter_134

        # pd_op.embedding: (1x11x512xf32) <- (1x11xi64, 512x512xf32)
        embedding_1 = paddle._C_ops.embedding(subtract_0, parameter_133, -1, False)
        del parameter_133

        # pd_op.embedding: (1x11x512xf32) <- (1x11xi64, 2x512xf32)
        embedding_2 = paddle._C_ops.embedding(data_1, parameter_132, -1, False)
        del data_1, parameter_132

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 1x11x512xf32)
        add_0 = paddle._C_ops.add(embedding_0, embedding_1)

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 1x11x512xf32)
        add_1 = paddle._C_ops.add(add_0, embedding_2)

        # pd_op.layer_norm: (1x11x512xf32, 1x11xf32, 1x11xf32) <- (1x11x512xf32, 512xf32, 512xf32)
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_1, parameter_131, parameter_130, float("1e-12"), 2
            ),
        ...
        # pd_op.dropout: (1x11x512xf32, 1x11x512xui8) <- (1x11x512xf32, None, 1xf32)
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_0 = paddle._C_ops.matmul(dropout_0, parameter_129, False, False)
        del parameter_129

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_2 = paddle._C_ops.add(matmul_0, parameter_128)
        del parameter_128

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_1 = [0, 0, 8, 64]

        # pd_op.reshape: (1x11x8x64xf32) <- (1x11x512xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(add_2, full_int_array_1)

        # pd_op.transpose: (1x8x11x64xf32) <- (1x11x8x64xf32)
        transpose_0 = paddle._C_ops.transpose(reshape_0, [0, 2, 1, 3])
        del reshape_0

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_1 = paddle._C_ops.matmul(dropout_0, parameter_127, False, False)
        del parameter_127

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_3 = paddle._C_ops.add(matmul_1, parameter_126)
        del parameter_126

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_2 = paddle._C_ops.matmul(dropout_0, parameter_125, False, False)
        del parameter_125

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_4 = paddle._C_ops.add(matmul_2, parameter_124)
        del parameter_124
        ...
        # pd_op.scale: (1x8x11x64xf32) <- (1x8x11x64xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(transpose_0, full_5, float("0"), True)
        del transpose_0

        # pd_op.matmul: (1x8x11x11xf32) <- (1x8x11x64xf32, 1x8x11x64xf32)
        matmul_3 = paddle._C_ops.matmul(scale_1, transpose_1, False, True)

        # pd_op.add: (1x8x11x11xf32) <- (1x8x11x11xf32, 1x1x1x11xf32)
        add_5 = paddle._C_ops.add(matmul_3, unsqueeze_0)

        # pd_op.softmax: (1x8x11x11xf32) <- (1x8x11x11xf32)
        softmax_0 = paddle._C_ops.softmax(add_5, -1)
        del add_5

        # pd_op.dropout: (1x8x11x11xf32, 1x8x11x11xui8) <- (1x8x11x11xf32, None, 1xf32)
        ...
        # pd_op.matmul: (1x8x11x64xf32) <- (1x8x11x11xf32, 1x8x11x64xf32)
        matmul_4 = paddle._C_ops.matmul(dropout_2, transpose_2, False, False)

        # pd_op.transpose: (1x11x8x64xf32) <- (1x8x11x64xf32)
        transpose_3 = paddle._C_ops.transpose(matmul_4, [0, 2, 1, 3])
        del matmul_4

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_2 = [0, 0, 512]

        # pd_op.reshape: (1x11x512xf32) <- (1x11x8x64xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_3, full_int_array_2)

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_5 = paddle._C_ops.matmul(reshape_3, parameter_123, False, False)
        del parameter_123

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_6 = paddle._C_ops.add(matmul_5, parameter_122)
        del parameter_122
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_7, parameter_117, parameter_116, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del parameter_116, parameter_117

        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_6 = paddle._C_ops.matmul(layer_norm_3, parameter_121, False, False)
        del parameter_121

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_8 = paddle._C_ops.add(matmul_6, parameter_120)
        del parameter_120

        # pd_op.gelu: (1x11x2048xf32) <- (1x11x2048xf32)
        gelu_0 = paddle._C_ops.gelu(add_8, False)

        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_7 = paddle._C_ops.matmul(gelu_0, parameter_119, False, False)
        del parameter_119

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_9 = paddle._C_ops.add(matmul_7, parameter_118)
        del parameter_118
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_10, parameter_115, parameter_114, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_8 = paddle._C_ops.matmul(layer_norm_6, parameter_113, False, False)
        del parameter_113

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_11 = paddle._C_ops.add(matmul_8, parameter_112)
        del parameter_112
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_9 = paddle._C_ops.matmul(layer_norm_6, parameter_111, False, False)
        del parameter_111

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_12 = paddle._C_ops.add(matmul_9, parameter_110)
        del parameter_110

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_10 = paddle._C_ops.matmul(layer_norm_6, parameter_109, False, False)
        del parameter_109

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_13 = paddle._C_ops.add(matmul_10, parameter_108)
        del parameter_108
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_13 = paddle._C_ops.matmul(reshape_7, parameter_107, False, False)
        del parameter_107

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_15 = paddle._C_ops.add(matmul_13, parameter_106)
        del parameter_106
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_16, parameter_101, parameter_100, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_14 = paddle._C_ops.matmul(layer_norm_9, parameter_105, False, False)
        del parameter_105

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_17 = paddle._C_ops.add(matmul_14, parameter_104)
        del parameter_104
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_15 = paddle._C_ops.matmul(gelu_1, parameter_103, False, False)
        del parameter_103

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_18 = paddle._C_ops.add(matmul_15, parameter_102)
        del parameter_102
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_19, parameter_99, parameter_98, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_16 = paddle._C_ops.matmul(layer_norm_12, parameter_97, False, False)
        del parameter_97

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_20 = paddle._C_ops.add(matmul_16, parameter_96)
        del parameter_96
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_17 = paddle._C_ops.matmul(layer_norm_12, parameter_95, False, False)
        del parameter_95

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_21 = paddle._C_ops.add(matmul_17, parameter_94)
        del parameter_94

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_18 = paddle._C_ops.matmul(layer_norm_12, parameter_93, False, False)
        del parameter_93

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_22 = paddle._C_ops.add(matmul_18, parameter_92)
        del parameter_92
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_21 = paddle._C_ops.matmul(reshape_11, parameter_91, False, False)
        del parameter_91

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_24 = paddle._C_ops.add(matmul_21, parameter_90)
        del parameter_90
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_25, parameter_85, parameter_84, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_22 = paddle._C_ops.matmul(layer_norm_15, parameter_89, False, False)
        del parameter_89

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_26 = paddle._C_ops.add(matmul_22, parameter_88)
        del parameter_88
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_23 = paddle._C_ops.matmul(gelu_2, parameter_87, False, False)
        del parameter_87

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_27 = paddle._C_ops.add(matmul_23, parameter_86)
        del parameter_86
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_28, parameter_83, parameter_82, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_24 = paddle._C_ops.matmul(layer_norm_18, parameter_81, False, False)
        del parameter_81

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_29 = paddle._C_ops.add(matmul_24, parameter_80)
        del parameter_80
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_25 = paddle._C_ops.matmul(layer_norm_18, parameter_79, False, False)
        del parameter_79

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_30 = paddle._C_ops.add(matmul_25, parameter_78)
        del parameter_78

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_26 = paddle._C_ops.matmul(layer_norm_18, parameter_77, False, False)
        del parameter_77

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_31 = paddle._C_ops.add(matmul_26, parameter_76)
        del parameter_76
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_29 = paddle._C_ops.matmul(reshape_15, parameter_75, False, False)
        del parameter_75

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_33 = paddle._C_ops.add(matmul_29, parameter_74)
        del parameter_74
        ...
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_34, parameter_69, parameter_68, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_30 = paddle._C_ops.matmul(layer_norm_21, parameter_73, False, False)
        del parameter_73

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_35 = paddle._C_ops.add(matmul_30, parameter_72)
        del parameter_72
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_31 = paddle._C_ops.matmul(gelu_3, parameter_71, False, False)
        del parameter_71

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_36 = paddle._C_ops.add(matmul_31, parameter_70)
        del parameter_70
        ...
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_37, parameter_67, parameter_66, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_32 = paddle._C_ops.matmul(layer_norm_24, parameter_65, False, False)
        del parameter_65

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_38 = paddle._C_ops.add(matmul_32, parameter_64)
        del parameter_64
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_33 = paddle._C_ops.matmul(layer_norm_24, parameter_63, False, False)
        del parameter_63

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_39 = paddle._C_ops.add(matmul_33, parameter_62)
        del parameter_62

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_34 = paddle._C_ops.matmul(layer_norm_24, parameter_61, False, False)
        del parameter_61

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_40 = paddle._C_ops.add(matmul_34, parameter_60)
        del parameter_60
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_37 = paddle._C_ops.matmul(reshape_19, parameter_59, False, False)
        del parameter_59

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_42 = paddle._C_ops.add(matmul_37, parameter_58)
        del parameter_58
        ...
        layer_norm_27, layer_norm_28, layer_norm_29 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_43, parameter_53, parameter_52, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_38 = paddle._C_ops.matmul(layer_norm_27, parameter_57, False, False)
        del parameter_57

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_44 = paddle._C_ops.add(matmul_38, parameter_56)
        del parameter_56
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_39 = paddle._C_ops.matmul(gelu_4, parameter_55, False, False)
        del parameter_55

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_45 = paddle._C_ops.add(matmul_39, parameter_54)
        del parameter_54
        ...
        layer_norm_30, layer_norm_31, layer_norm_32 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_46, parameter_51, parameter_50, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_40 = paddle._C_ops.matmul(layer_norm_30, parameter_49, False, False)
        del parameter_49

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_47 = paddle._C_ops.add(matmul_40, parameter_48)
        del parameter_48
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_41 = paddle._C_ops.matmul(layer_norm_30, parameter_47, False, False)
        del parameter_47

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_48 = paddle._C_ops.add(matmul_41, parameter_46)
        del parameter_46

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_42 = paddle._C_ops.matmul(layer_norm_30, parameter_45, False, False)
        del parameter_45

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_49 = paddle._C_ops.add(matmul_42, parameter_44)
        del parameter_44
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_45 = paddle._C_ops.matmul(reshape_23, parameter_43, False, False)
        del parameter_43

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_51 = paddle._C_ops.add(matmul_45, parameter_42)
        del parameter_42
        ...
        layer_norm_33, layer_norm_34, layer_norm_35 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_52, parameter_37, parameter_36, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_46 = paddle._C_ops.matmul(layer_norm_33, parameter_41, False, False)
        del parameter_41

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_53 = paddle._C_ops.add(matmul_46, parameter_40)
        del parameter_40
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_47 = paddle._C_ops.matmul(gelu_5, parameter_39, False, False)
        del parameter_39

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_54 = paddle._C_ops.add(matmul_47, parameter_38)
        del parameter_38
        ...
        layer_norm_36, layer_norm_37, layer_norm_38 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_55, parameter_35, parameter_34, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_48 = paddle._C_ops.matmul(layer_norm_36, parameter_33, False, False)
        del parameter_33

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_56 = paddle._C_ops.add(matmul_48, parameter_32)
        del parameter_32
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_49 = paddle._C_ops.matmul(layer_norm_36, parameter_31, False, False)
        del parameter_31

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_57 = paddle._C_ops.add(matmul_49, parameter_30)
        del parameter_30

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_50 = paddle._C_ops.matmul(layer_norm_36, parameter_29, False, False)
        del parameter_29

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_58 = paddle._C_ops.add(matmul_50, parameter_28)
        del parameter_28
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_53 = paddle._C_ops.matmul(reshape_27, parameter_27, False, False)
        del parameter_27

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_60 = paddle._C_ops.add(matmul_53, parameter_26)
        del parameter_26
        ...
        layer_norm_39, layer_norm_40, layer_norm_41 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_61, parameter_21, parameter_20, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_54 = paddle._C_ops.matmul(layer_norm_39, parameter_25, False, False)
        del parameter_25

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_62 = paddle._C_ops.add(matmul_54, parameter_24)
        del parameter_24
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_55 = paddle._C_ops.matmul(gelu_6, parameter_23, False, False)
        del parameter_23

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_63 = paddle._C_ops.add(matmul_55, parameter_22)
        del parameter_22
        ...
        layer_norm_42, layer_norm_43, layer_norm_44 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_64, parameter_19, parameter_18, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_56 = paddle._C_ops.matmul(layer_norm_42, parameter_17, False, False)
        del parameter_17

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_65 = paddle._C_ops.add(matmul_56, parameter_16)
        del parameter_16
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_57 = paddle._C_ops.matmul(layer_norm_42, parameter_15, False, False)
        del parameter_15

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_66 = paddle._C_ops.add(matmul_57, parameter_14)
        del parameter_14

        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_58 = paddle._C_ops.matmul(layer_norm_42, parameter_13, False, False)
        del parameter_13

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_67 = paddle._C_ops.add(matmul_58, parameter_12)
        del parameter_12
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x512xf32, 512x512xf32)
        matmul_61 = paddle._C_ops.matmul(reshape_31, parameter_11, False, False)
        del parameter_11

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_69 = paddle._C_ops.add(matmul_61, parameter_10)
        del parameter_10
        ...
        layer_norm_45, layer_norm_46, layer_norm_47 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_70, parameter_5, parameter_4, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.matmul: (1x11x2048xf32) <- (1x11x512xf32, 512x2048xf32)
        matmul_62 = paddle._C_ops.matmul(layer_norm_45, parameter_9, False, False)
        del parameter_9

        # pd_op.add: (1x11x2048xf32) <- (1x11x2048xf32, 2048xf32)
        add_71 = paddle._C_ops.add(matmul_62, parameter_8)
        del parameter_8
        ...
        # pd_op.matmul: (1x11x512xf32) <- (1x11x2048xf32, 2048x512xf32)
        matmul_63 = paddle._C_ops.matmul(gelu_7, parameter_7, False, False)
        del parameter_7

        # pd_op.add: (1x11x512xf32) <- (1x11x512xf32, 512xf32)
        add_72 = paddle._C_ops.add(matmul_63, parameter_6)
        del parameter_6
        ...
        layer_norm_48, layer_norm_49, layer_norm_50 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_73, parameter_3, parameter_2, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.slice: (1x512xf32) <- (1x11x512xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            layer_norm_48, [1], full_int_array_3, full_int_array_4, [1], [1]
        )

        # pd_op.matmul: (1x512xf32) <- (1x512xf32, 512x512xf32)
        matmul_64 = paddle._C_ops.matmul(slice_0, parameter_1, False, False)
        del parameter_1

        # pd_op.add: (1x512xf32) <- (1x512xf32, 512xf32)
        add_74 = paddle._C_ops.add(matmul_64, parameter_0)
        del parameter_0

        # pd_op.tanh: (1x512xf32) <- (1x512xf32)
        tanh_0 = paddle._C_ops.tanh(add_74)
        del (
            add_0,
            add_1,
            add_10,
