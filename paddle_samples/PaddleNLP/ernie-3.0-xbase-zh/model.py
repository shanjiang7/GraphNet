...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x11x1024xf32) <- (1x11xi64, 40000x1024xf32)
        ...
        # pd_op.embedding: (1x11x1024xf32) <- (1x11xi64, 2048x1024xf32)
        ...
        # pd_op.embedding: (1x11x1024xf32) <- (1x11xi64, 16x1024xf32)
        ...
        # pd_op.gelu: (1x11x4096xf32) <- (1x11x4096xf32)
