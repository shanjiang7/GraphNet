...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 40000x768xf32)
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_199, 0, False)
        ...
        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 2048x768xf32)
        embedding_1 = paddle._C_ops.embedding(subtract_0, parameter_198, -1, False)
        del parameter_198, subtract_0
        ...
        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 4x768xf32)
        embedding_2 = paddle._C_ops.embedding(data_1, parameter_197, -1, False)
        del data_1, parameter_197
        ...
        # pd_op.scale: (1x11xi64) <- (1x11xi64, 1xf32)
        scale_1 = paddle._C_ops.scale(full_2, full_4, float("0"), True)
        del full_2, full_4

        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 3x768xf32)
        embedding_3 = paddle._C_ops.embedding(scale_1, parameter_196, -1, False)
        del parameter_196, scale_1
        ...
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_2, parameter_195, parameter_194, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_2, parameter_194, parameter_195
        ...
        add_3 = paddle._C_ops.add(matmul_0, parameter_192)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_4 = paddle._C_ops.add(matmul_1, parameter_190)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_5 = paddle._C_ops.add(matmul_2, parameter_188)
        ...
        del parameter_187, reshape_3

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_7 = paddle._C_ops.add(matmul_5, parameter_186)
        del matmul_5, parameter_186
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_8, parameter_181, parameter_180, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_8, parameter_180, parameter_181
        ...
        add_9 = paddle._C_ops.add(matmul_6, parameter_184)
        ...
        del gelu_0, parameter_183

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_10 = paddle._C_ops.add(matmul_7, parameter_182)
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_11, parameter_179, parameter_178, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_11, parameter_178, parameter_179
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_12 = paddle._C_ops.add(matmul_8, parameter_176)
        del matmul_8, parameter_176
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_13 = paddle._C_ops.add(matmul_9, parameter_174)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_14 = paddle._C_ops.add(matmul_10, parameter_172)
        ...
        del parameter_171, reshape_7

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_16 = paddle._C_ops.add(matmul_13, parameter_170)
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_17, parameter_165, parameter_164, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_18 = paddle._C_ops.add(matmul_14, parameter_168)
        ...
        del gelu_1, parameter_167

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_19 = paddle._C_ops.add(matmul_15, parameter_166)
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_20, parameter_163, parameter_162, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_20, parameter_162, parameter_163
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_21 = paddle._C_ops.add(matmul_16, parameter_160)
        del matmul_16, parameter_160
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_22 = paddle._C_ops.add(matmul_17, parameter_158)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_23 = paddle._C_ops.add(matmul_18, parameter_156)
        ...
        del parameter_155, reshape_11

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_25 = paddle._C_ops.add(matmul_21, parameter_154)
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_26, parameter_149, parameter_148, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_26, parameter_148, parameter_149
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_27 = paddle._C_ops.add(matmul_22, parameter_152)
        ...
        del gelu_2, parameter_151

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_28 = paddle._C_ops.add(matmul_23, parameter_150)
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_29, parameter_147, parameter_146, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_29, parameter_146, parameter_147
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_30 = paddle._C_ops.add(matmul_24, parameter_144)
        del matmul_24, parameter_144
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_31 = paddle._C_ops.add(matmul_25, parameter_142)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_32 = paddle._C_ops.add(matmul_26, parameter_140)
        ...
        del parameter_139, reshape_15

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_34 = paddle._C_ops.add(matmul_29, parameter_138)
        del matmul_29, parameter_138
        ...
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_35, parameter_133, parameter_132, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_35, parameter_132, parameter_133
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_36 = paddle._C_ops.add(matmul_30, parameter_136)
        ...
        del gelu_3, parameter_135

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_37 = paddle._C_ops.add(matmul_31, parameter_134)
        ...
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_38, parameter_131, parameter_130, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_38, parameter_130, parameter_131
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_39 = paddle._C_ops.add(matmul_32, parameter_128)
        del matmul_32, parameter_128
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_40 = paddle._C_ops.add(matmul_33, parameter_126)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_41 = paddle._C_ops.add(matmul_34, parameter_124)
        ...
        del parameter_123, reshape_19

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_43 = paddle._C_ops.add(matmul_37, parameter_122)
        del matmul_37, parameter_122
        ...
        layer_norm_27, layer_norm_28, layer_norm_29 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_44, parameter_117, parameter_116, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_44, parameter_116, parameter_117
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_45 = paddle._C_ops.add(matmul_38, parameter_120)
        ...
        del gelu_4, parameter_119

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_46 = paddle._C_ops.add(matmul_39, parameter_118)
        ...
        layer_norm_30, layer_norm_31, layer_norm_32 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_47, parameter_115, parameter_114, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_47, parameter_114, parameter_115
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_48 = paddle._C_ops.add(matmul_40, parameter_112)
        del matmul_40, parameter_112
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_49 = paddle._C_ops.add(matmul_41, parameter_110)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_50 = paddle._C_ops.add(matmul_42, parameter_108)
        ...
        del parameter_107, reshape_23

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_52 = paddle._C_ops.add(matmul_45, parameter_106)
        ...
        layer_norm_33, layer_norm_34, layer_norm_35 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_53, parameter_101, parameter_100, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_53, parameter_100, parameter_101
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_54 = paddle._C_ops.add(matmul_46, parameter_104)
        ...
        del gelu_5, parameter_103

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_55 = paddle._C_ops.add(matmul_47, parameter_102)
        ...
        layer_norm_36, layer_norm_37, layer_norm_38 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_56, parameter_99, parameter_98, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_56, parameter_98, parameter_99
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_57 = paddle._C_ops.add(matmul_48, parameter_96)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_58 = paddle._C_ops.add(matmul_49, parameter_94)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_59 = paddle._C_ops.add(matmul_50, parameter_92)
        ...
        del parameter_91, reshape_27

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_61 = paddle._C_ops.add(matmul_53, parameter_90)
        del matmul_53, parameter_90
        ...
        layer_norm_39, layer_norm_40, layer_norm_41 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_62, parameter_85, parameter_84, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_62, parameter_84, parameter_85
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_63 = paddle._C_ops.add(matmul_54, parameter_88)
        ...
        del gelu_6, parameter_87

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_64 = paddle._C_ops.add(matmul_55, parameter_86)
        ...
        layer_norm_42, layer_norm_43, layer_norm_44 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_65, parameter_83, parameter_82, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_65, parameter_82, parameter_83
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_66 = paddle._C_ops.add(matmul_56, parameter_80)
        del matmul_56, parameter_80
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_67 = paddle._C_ops.add(matmul_57, parameter_78)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_68 = paddle._C_ops.add(matmul_58, parameter_76)
        ...
        del parameter_75, reshape_31

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_70 = paddle._C_ops.add(matmul_61, parameter_74)
        del matmul_61, parameter_74
        ...
        layer_norm_45, layer_norm_46, layer_norm_47 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_71, parameter_69, parameter_68, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_71, parameter_68, parameter_69
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_72 = paddle._C_ops.add(matmul_62, parameter_72)
        ...
        del gelu_7, parameter_71

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_73 = paddle._C_ops.add(matmul_63, parameter_70)
        ...
        layer_norm_48, layer_norm_49, layer_norm_50 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_74, parameter_67, parameter_66, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_74, parameter_66, parameter_67
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_75 = paddle._C_ops.add(matmul_64, parameter_64)
        del matmul_64, parameter_64
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_76 = paddle._C_ops.add(matmul_65, parameter_62)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_77 = paddle._C_ops.add(matmul_66, parameter_60)
        ...
        del parameter_59, reshape_35

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_79 = paddle._C_ops.add(matmul_69, parameter_58)
        del matmul_69, parameter_58
        ...
        layer_norm_51, layer_norm_52, layer_norm_53 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_80, parameter_53, parameter_52, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_80, parameter_52, parameter_53
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_81 = paddle._C_ops.add(matmul_70, parameter_56)
        ...
        del gelu_8, parameter_55

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_82 = paddle._C_ops.add(matmul_71, parameter_54)
        ...
        layer_norm_54, layer_norm_55, layer_norm_56 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_83, parameter_51, parameter_50, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_83, parameter_50, parameter_51
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_84 = paddle._C_ops.add(matmul_72, parameter_48)
        del matmul_72, parameter_48
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_85 = paddle._C_ops.add(matmul_73, parameter_46)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_86 = paddle._C_ops.add(matmul_74, parameter_44)
        ...
        del parameter_43, reshape_39

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_88 = paddle._C_ops.add(matmul_77, parameter_42)
        del matmul_77, parameter_42
        ...
        layer_norm_57, layer_norm_58, layer_norm_59 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_89, parameter_37, parameter_36, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_89, parameter_36, parameter_37
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_90 = paddle._C_ops.add(matmul_78, parameter_40)
        ...
        del gelu_9, parameter_39

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_91 = paddle._C_ops.add(matmul_79, parameter_38)
        ...
        layer_norm_60, layer_norm_61, layer_norm_62 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_92, parameter_35, parameter_34, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_92, parameter_34, parameter_35
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_93 = paddle._C_ops.add(matmul_80, parameter_32)
        del matmul_80, parameter_32
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_94 = paddle._C_ops.add(matmul_81, parameter_30)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_95 = paddle._C_ops.add(matmul_82, parameter_28)
        ...
        del parameter_27, reshape_43

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_97 = paddle._C_ops.add(matmul_85, parameter_26)
        del matmul_85, parameter_26
        ...
        layer_norm_63, layer_norm_64, layer_norm_65 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_98, parameter_21, parameter_20, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_98, parameter_20, parameter_21
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_99 = paddle._C_ops.add(matmul_86, parameter_24)
        ...
        del gelu_10, parameter_23

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_100 = paddle._C_ops.add(matmul_87, parameter_22)
        ...
        layer_norm_66, layer_norm_67, layer_norm_68 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_101, parameter_19, parameter_18, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_101, parameter_18, parameter_19
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_102 = paddle._C_ops.add(matmul_88, parameter_16)
        del matmul_88, parameter_16
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_103 = paddle._C_ops.add(matmul_89, parameter_14)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_104 = paddle._C_ops.add(matmul_90, parameter_12)
        ...
        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_106 = paddle._C_ops.add(matmul_93, parameter_10)
        del matmul_93, parameter_10
        ...
        layer_norm_69, layer_norm_70, layer_norm_71 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_107, parameter_5, parameter_4, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_107, parameter_4, parameter_5
        ...
        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_108 = paddle._C_ops.add(matmul_94, parameter_8)
        ...
        del gelu_11, parameter_7

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_109 = paddle._C_ops.add(matmul_95, parameter_6)
        ...
        layer_norm_72, layer_norm_73, layer_norm_74 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_110, parameter_3, parameter_2, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_110, parameter_2, parameter_3
        ...
        del full_int_array_3, full_int_array_4, layer_norm_72
        ...
        add_111 = paddle._C_ops.add(matmul_96, parameter_0)
        del matmul_96, parameter_0
