...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_118, -1, False)
        del data_0, parameter_118

        # pd_op.embedding: (1x21x768xf32) <- (1x21xi64, 512x768xf32)
        embedding_1 = paddle._C_ops.embedding(scale_1, parameter_117, -1, False)
        del parameter_117, scale_1

        # pd_op.embedding: (1x21x768xf32) <- (1x21xi64, 2x768xf32)
        embedding_2 = paddle._C_ops.embedding(data_1, parameter_116, -1, False)
        del data_1, parameter_116
        ...
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_1, parameter_115, parameter_114, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_1, parameter_114, parameter_115
        ...
        matmul_0 = paddle._C_ops.matmul(dropout_0, parameter_113, False, False)
        del parameter_113

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_2 = paddle._C_ops.add(matmul_0, parameter_112)
        del matmul_0, parameter_112
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_1 = paddle._C_ops.matmul(dropout_0, parameter_111, False, False)
        del parameter_111

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_3 = paddle._C_ops.add(matmul_1, parameter_110)
        del matmul_1, parameter_110

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_2 = paddle._C_ops.matmul(dropout_0, parameter_109, False, False)
        del parameter_109

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_4 = paddle._C_ops.add(matmul_2, parameter_108)
        del matmul_2, parameter_108
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_5 = paddle._C_ops.matmul(reshape_3, parameter_107, False, False)
        del parameter_107, reshape_3

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_6 = paddle._C_ops.add(matmul_5, parameter_106)
        del matmul_5, parameter_106
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_7, parameter_101, parameter_100, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_7, parameter_100, parameter_101

        # pd_op.matmul: (1x21x3072xf32) <- (1x21x768xf32, 768x3072xf32)
        matmul_6 = paddle._C_ops.matmul(layer_norm_3, parameter_105, False, False)
        del parameter_105

        # pd_op.add: (1x21x3072xf32) <- (1x21x3072xf32, 3072xf32)
        add_8 = paddle._C_ops.add(matmul_6, parameter_104)
        del matmul_6, parameter_104
        ...
        matmul_7 = paddle._C_ops.matmul(gelu_0, parameter_103, False, False)
        del gelu_0, parameter_103

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_9 = paddle._C_ops.add(matmul_7, parameter_102)
        del matmul_7, parameter_102
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_10, parameter_99, parameter_98, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_10, parameter_98, parameter_99

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_8 = paddle._C_ops.matmul(layer_norm_6, parameter_97, False, False)
        del parameter_97

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_11 = paddle._C_ops.add(matmul_8, parameter_96)
        del matmul_8, parameter_96
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_9 = paddle._C_ops.matmul(layer_norm_6, parameter_95, False, False)
        del parameter_95

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_12 = paddle._C_ops.add(matmul_9, parameter_94)
        del matmul_9, parameter_94

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_10 = paddle._C_ops.matmul(layer_norm_6, parameter_93, False, False)
        del parameter_93

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_13 = paddle._C_ops.add(matmul_10, parameter_92)
        del matmul_10, parameter_92
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_13 = paddle._C_ops.matmul(reshape_7, parameter_91, False, False)
        del parameter_91, reshape_7

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_15 = paddle._C_ops.add(matmul_13, parameter_90)
        del matmul_13, parameter_90
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_16, parameter_85, parameter_84, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_16, parameter_84, parameter_85

        # pd_op.matmul: (1x21x3072xf32) <- (1x21x768xf32, 768x3072xf32)
        matmul_14 = paddle._C_ops.matmul(layer_norm_9, parameter_89, False, False)
        del parameter_89

        # pd_op.add: (1x21x3072xf32) <- (1x21x3072xf32, 3072xf32)
        add_17 = paddle._C_ops.add(matmul_14, parameter_88)
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x3072xf32, 3072x768xf32)
        matmul_15 = paddle._C_ops.matmul(gelu_1, parameter_87, False, False)
        del gelu_1, parameter_87

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_18 = paddle._C_ops.add(matmul_15, parameter_86)
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_19, parameter_83, parameter_82, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_19, parameter_82, parameter_83

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_16 = paddle._C_ops.matmul(layer_norm_12, parameter_81, False, False)
        del parameter_81

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_20 = paddle._C_ops.add(matmul_16, parameter_80)
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_17 = paddle._C_ops.matmul(layer_norm_12, parameter_79, False, False)
        del parameter_79

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_21 = paddle._C_ops.add(matmul_17, parameter_78)
        del matmul_17, parameter_78

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_18 = paddle._C_ops.matmul(layer_norm_12, parameter_77, False, False)
        del parameter_77

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_22 = paddle._C_ops.add(matmul_18, parameter_76)
        del matmul_18, parameter_76
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_21 = paddle._C_ops.matmul(reshape_11, parameter_75, False, False)
        del parameter_75, reshape_11

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_24 = paddle._C_ops.add(matmul_21, parameter_74)
        del matmul_21, parameter_74
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_25, parameter_69, parameter_68, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_25, parameter_68, parameter_69

        # pd_op.matmul: (1x21x3072xf32) <- (1x21x768xf32, 768x3072xf32)
        matmul_22 = paddle._C_ops.matmul(layer_norm_15, parameter_73, False, False)
        del parameter_73

        # pd_op.add: (1x21x3072xf32) <- (1x21x3072xf32, 3072xf32)
        add_26 = paddle._C_ops.add(matmul_22, parameter_72)
        del matmul_22, parameter_72
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x3072xf32, 3072x768xf32)
        matmul_23 = paddle._C_ops.matmul(gelu_2, parameter_71, False, False)
        del gelu_2, parameter_71

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_27 = paddle._C_ops.add(matmul_23, parameter_70)
        del matmul_23, parameter_70
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_28, parameter_67, parameter_66, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_28, parameter_66, parameter_67

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_24 = paddle._C_ops.matmul(layer_norm_18, parameter_65, False, False)
        del parameter_65

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_29 = paddle._C_ops.add(matmul_24, parameter_64)
        del matmul_24, parameter_64
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_25 = paddle._C_ops.matmul(layer_norm_18, parameter_63, False, False)
        del parameter_63

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_30 = paddle._C_ops.add(matmul_25, parameter_62)
        del matmul_25, parameter_62

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_26 = paddle._C_ops.matmul(layer_norm_18, parameter_61, False, False)
        del parameter_61

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_31 = paddle._C_ops.add(matmul_26, parameter_60)
        del matmul_26, parameter_60
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_29 = paddle._C_ops.matmul(reshape_15, parameter_59, False, False)
        del parameter_59, reshape_15

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_33 = paddle._C_ops.add(matmul_29, parameter_58)
        del matmul_29, parameter_58
        ...
        layer_norm_21, layer_norm_22, layer_norm_23 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_34, parameter_53, parameter_52, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_34, parameter_52, parameter_53

        # pd_op.matmul: (1x21x3072xf32) <- (1x21x768xf32, 768x3072xf32)
        matmul_30 = paddle._C_ops.matmul(layer_norm_21, parameter_57, False, False)
        del parameter_57

        # pd_op.add: (1x21x3072xf32) <- (1x21x3072xf32, 3072xf32)
        add_35 = paddle._C_ops.add(matmul_30, parameter_56)
        del matmul_30, parameter_56
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x3072xf32, 3072x768xf32)
        matmul_31 = paddle._C_ops.matmul(gelu_3, parameter_55, False, False)
        del gelu_3, parameter_55

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_36 = paddle._C_ops.add(matmul_31, parameter_54)
        del matmul_31, parameter_54
        ...
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_37, parameter_51, parameter_50, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_37, parameter_50, parameter_51

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_32 = paddle._C_ops.matmul(layer_norm_24, parameter_49, False, False)
        del parameter_49

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_38 = paddle._C_ops.add(matmul_32, parameter_48)
        del matmul_32, parameter_48
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_33 = paddle._C_ops.matmul(layer_norm_24, parameter_47, False, False)
        del parameter_47

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_39 = paddle._C_ops.add(matmul_33, parameter_46)
        del matmul_33, parameter_46

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_34 = paddle._C_ops.matmul(layer_norm_24, parameter_45, False, False)
        del parameter_45

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_40 = paddle._C_ops.add(matmul_34, parameter_44)
        del matmul_34, parameter_44
        ...
        # pd_op.scale: (1x12x21x64xf32) <- (1x12x21x64xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(transpose_16, full_5, float("0"), True)
        del transpose_16
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_37 = paddle._C_ops.matmul(reshape_19, parameter_43, False, False)
        del parameter_43, reshape_19

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_42 = paddle._C_ops.add(matmul_37, parameter_42)
        del matmul_37, parameter_42
        ...
        layer_norm_27, layer_norm_28, layer_norm_29 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_43, parameter_37, parameter_36, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_43, parameter_36, parameter_37

        # pd_op.matmul: (1x21x3072xf32) <- (1x21x768xf32, 768x3072xf32)
        matmul_38 = paddle._C_ops.matmul(layer_norm_27, parameter_41, False, False)
        del parameter_41

        # pd_op.add: (1x21x3072xf32) <- (1x21x3072xf32, 3072xf32)
        add_44 = paddle._C_ops.add(matmul_38, parameter_40)
        del matmul_38, parameter_40
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x3072xf32, 3072x768xf32)
        matmul_39 = paddle._C_ops.matmul(gelu_4, parameter_39, False, False)
        del gelu_4, parameter_39

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_45 = paddle._C_ops.add(matmul_39, parameter_38)
        del matmul_39, parameter_38
        ...
        layer_norm_30, layer_norm_31, layer_norm_32 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_46, parameter_35, parameter_34, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_46, parameter_34, parameter_35

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_40 = paddle._C_ops.matmul(layer_norm_30, parameter_33, False, False)
        del parameter_33

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_47 = paddle._C_ops.add(matmul_40, parameter_32)
        del matmul_40, parameter_32
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_41 = paddle._C_ops.matmul(layer_norm_30, parameter_31, False, False)
        del parameter_31

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_48 = paddle._C_ops.add(matmul_41, parameter_30)
        del matmul_41, parameter_30

        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_42 = paddle._C_ops.matmul(layer_norm_30, parameter_29, False, False)
        del parameter_29

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_49 = paddle._C_ops.add(matmul_42, parameter_28)
        del matmul_42, parameter_28
        ...
        # pd_op.scale: (1x12x21x64xf32) <- (1x12x21x64xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(transpose_20, full_5, float("0"), True)
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x768xf32, 768x768xf32)
        matmul_45 = paddle._C_ops.matmul(reshape_23, parameter_27, False, False)
        del parameter_27, reshape_23

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_51 = paddle._C_ops.add(matmul_45, parameter_26)
        del matmul_45, parameter_26
        ...
        layer_norm_33, layer_norm_34, layer_norm_35 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_52, parameter_21, parameter_20, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_52, parameter_20, parameter_21

        # pd_op.matmul: (1x21x3072xf32) <- (1x21x768xf32, 768x3072xf32)
        matmul_46 = paddle._C_ops.matmul(layer_norm_33, parameter_25, False, False)
        del parameter_25

        # pd_op.add: (1x21x3072xf32) <- (1x21x3072xf32, 3072xf32)
        add_53 = paddle._C_ops.add(matmul_46, parameter_24)
        del matmul_46, parameter_24
        ...
        # pd_op.matmul: (1x21x768xf32) <- (1x21x3072xf32, 3072x768xf32)
        matmul_47 = paddle._C_ops.matmul(gelu_5, parameter_23, False, False)
        del gelu_5, parameter_23

        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_54 = paddle._C_ops.add(matmul_47, parameter_22)
        del matmul_47, parameter_22
        ...
        layer_norm_36, layer_norm_37, layer_norm_38 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_55, parameter_19, parameter_18, float("1e-12"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_55, parameter_18, parameter_19
        ...
        matmul_48 = paddle._C_ops.matmul(slice_0, parameter_17, False, False)
        del parameter_17, slice_0

        # pd_op.add: (1x768xf32) <- (1x768xf32, 768xf32)
        add_56 = paddle._C_ops.add(matmul_48, parameter_16)
        del matmul_48, parameter_16

        # pd_op.tanh: (1x768xf32) <- (1x768xf32)
        tanh_0 = paddle._C_ops.tanh(add_56)
        del add_56, layer_norm_36
