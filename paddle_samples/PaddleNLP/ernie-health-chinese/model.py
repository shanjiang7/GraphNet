...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 22608x768xf32)
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_196, -1, False)
        del data_0, parameter_196

        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 512x768xf32)
        embedding_1 = paddle._C_ops.embedding(subtract_0, parameter_195, -1, False)
        del parameter_195, subtract_0

        # pd_op.embedding: (1x11x768xf32) <- (1x11xi64, 2x768xf32)
        embedding_2 = paddle._C_ops.embedding(data_1, parameter_194, -1, False)
        del data_1, parameter_194
        ...
        layer_norm_1, layer_norm_2, layer_norm_3 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_1, parameter_193, parameter_192, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_1, parameter_192, parameter_193
        ...
        add_2 = paddle._C_ops.add(matmul_0, parameter_190)
        del matmul_0, parameter_190
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_1 = paddle._C_ops.matmul(dropout_0, parameter_189, False, False)
        del parameter_189

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_3 = paddle._C_ops.add(matmul_1, parameter_188)
        del matmul_1, parameter_188

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_2 = paddle._C_ops.matmul(dropout_0, parameter_187, False, False)
        del parameter_187

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_4 = paddle._C_ops.add(matmul_2, parameter_186)
        del matmul_2, parameter_186
        ...
        # pd_op.scale: (1x12x11x64xf32) <- (1x12x11x64xf32, 1xf32)
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_5 = paddle._C_ops.matmul(reshape_3, parameter_185, False, False)
        del parameter_185, reshape_3

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_6 = paddle._C_ops.add(matmul_5, parameter_184)
        del matmul_5, parameter_184
        ...
        layer_norm_4, layer_norm_5, layer_norm_6 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_7, parameter_179, parameter_178, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_7, parameter_178, parameter_179

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_6 = paddle._C_ops.matmul(layer_norm_4, parameter_183, False, False)
        del parameter_183

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_8 = paddle._C_ops.add(matmul_6, parameter_182)
        del matmul_6, parameter_182
        ...
        matmul_7 = paddle._C_ops.matmul(gelu_0, parameter_181, False, False)
        del gelu_0, parameter_181

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_9 = paddle._C_ops.add(matmul_7, parameter_180)
        ...
        layer_norm_7, layer_norm_8, layer_norm_9 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_10, parameter_177, parameter_176, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_10, parameter_176, parameter_177

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_8 = paddle._C_ops.matmul(layer_norm_7, parameter_175, False, False)
        del parameter_175

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_11 = paddle._C_ops.add(matmul_8, parameter_174)
        del matmul_8, parameter_174
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_9 = paddle._C_ops.matmul(layer_norm_7, parameter_173, False, False)
        del parameter_173

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_12 = paddle._C_ops.add(matmul_9, parameter_172)
        del matmul_9, parameter_172

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_10 = paddle._C_ops.matmul(layer_norm_7, parameter_171, False, False)
        del parameter_171

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_13 = paddle._C_ops.add(matmul_10, parameter_170)
        del matmul_10, parameter_170
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_13 = paddle._C_ops.matmul(reshape_7, parameter_169, False, False)
        del parameter_169, reshape_7

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_15 = paddle._C_ops.add(matmul_13, parameter_168)
        del matmul_13, parameter_168
        ...
        layer_norm_10, layer_norm_11, layer_norm_12 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_16, parameter_163, parameter_162, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_16, parameter_162, parameter_163

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_14 = paddle._C_ops.matmul(layer_norm_10, parameter_167, False, False)
        del parameter_167

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_17 = paddle._C_ops.add(matmul_14, parameter_166)
        del matmul_14, parameter_166
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_15 = paddle._C_ops.matmul(gelu_1, parameter_165, False, False)
        del gelu_1, parameter_165

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_18 = paddle._C_ops.add(matmul_15, parameter_164)
        del matmul_15, parameter_164
        ...
        layer_norm_13, layer_norm_14, layer_norm_15 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_19, parameter_161, parameter_160, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_19, parameter_160, parameter_161

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_16 = paddle._C_ops.matmul(layer_norm_13, parameter_159, False, False)
        del parameter_159

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_20 = paddle._C_ops.add(matmul_16, parameter_158)
        del matmul_16, parameter_158
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_17 = paddle._C_ops.matmul(layer_norm_13, parameter_157, False, False)
        del parameter_157

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_21 = paddle._C_ops.add(matmul_17, parameter_156)
        del matmul_17, parameter_156

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_18 = paddle._C_ops.matmul(layer_norm_13, parameter_155, False, False)
        del parameter_155

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_22 = paddle._C_ops.add(matmul_18, parameter_154)
        del matmul_18, parameter_154
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_21 = paddle._C_ops.matmul(reshape_11, parameter_153, False, False)
        del parameter_153, reshape_11

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_24 = paddle._C_ops.add(matmul_21, parameter_152)
        del matmul_21, parameter_152
        ...
        layer_norm_16, layer_norm_17, layer_norm_18 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_25, parameter_147, parameter_146, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_25, parameter_146, parameter_147

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_22 = paddle._C_ops.matmul(layer_norm_16, parameter_151, False, False)
        del parameter_151

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_26 = paddle._C_ops.add(matmul_22, parameter_150)
        del matmul_22, parameter_150
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_23 = paddle._C_ops.matmul(gelu_2, parameter_149, False, False)
        del gelu_2, parameter_149

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_27 = paddle._C_ops.add(matmul_23, parameter_148)
        del matmul_23, parameter_148
        ...
        layer_norm_19, layer_norm_20, layer_norm_21 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_28, parameter_145, parameter_144, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_28, parameter_144, parameter_145

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_24 = paddle._C_ops.matmul(layer_norm_19, parameter_143, False, False)
        del parameter_143

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_29 = paddle._C_ops.add(matmul_24, parameter_142)
        del matmul_24, parameter_142
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_25 = paddle._C_ops.matmul(layer_norm_19, parameter_141, False, False)
        del parameter_141

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_30 = paddle._C_ops.add(matmul_25, parameter_140)
        del matmul_25, parameter_140

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_26 = paddle._C_ops.matmul(layer_norm_19, parameter_139, False, False)
        del parameter_139

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_31 = paddle._C_ops.add(matmul_26, parameter_138)
        del matmul_26, parameter_138
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_29 = paddle._C_ops.matmul(reshape_15, parameter_137, False, False)
        del parameter_137, reshape_15

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_33 = paddle._C_ops.add(matmul_29, parameter_136)
        del matmul_29, parameter_136
        ...
        layer_norm_22, layer_norm_23, layer_norm_24 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_34, parameter_131, parameter_130, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_34, parameter_130, parameter_131

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_30 = paddle._C_ops.matmul(layer_norm_22, parameter_135, False, False)
        del parameter_135

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_35 = paddle._C_ops.add(matmul_30, parameter_134)
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_31 = paddle._C_ops.matmul(gelu_3, parameter_133, False, False)
        del gelu_3, parameter_133

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_36 = paddle._C_ops.add(matmul_31, parameter_132)
        del matmul_31, parameter_132
        ...
        layer_norm_25, layer_norm_26, layer_norm_27 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_37, parameter_129, parameter_128, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_37, parameter_128, parameter_129

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_32 = paddle._C_ops.matmul(layer_norm_25, parameter_127, False, False)
        del parameter_127

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_38 = paddle._C_ops.add(matmul_32, parameter_126)
        del matmul_32, parameter_126
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_33 = paddle._C_ops.matmul(layer_norm_25, parameter_125, False, False)
        del parameter_125

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_39 = paddle._C_ops.add(matmul_33, parameter_124)
        del matmul_33, parameter_124

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_34 = paddle._C_ops.matmul(layer_norm_25, parameter_123, False, False)
        del parameter_123

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_40 = paddle._C_ops.add(matmul_34, parameter_122)
        del matmul_34, parameter_122
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_37 = paddle._C_ops.matmul(reshape_19, parameter_121, False, False)
        del parameter_121, reshape_19

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_42 = paddle._C_ops.add(matmul_37, parameter_120)
        del matmul_37, parameter_120
        ...
        layer_norm_28, layer_norm_29, layer_norm_30 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_43, parameter_115, parameter_114, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_43, parameter_114, parameter_115

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_38 = paddle._C_ops.matmul(layer_norm_28, parameter_119, False, False)
        del parameter_119

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_44 = paddle._C_ops.add(matmul_38, parameter_118)
        del matmul_38, parameter_118
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_39 = paddle._C_ops.matmul(gelu_4, parameter_117, False, False)
        del gelu_4, parameter_117

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_45 = paddle._C_ops.add(matmul_39, parameter_116)
        del matmul_39, parameter_116
        ...
        layer_norm_31, layer_norm_32, layer_norm_33 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_46, parameter_113, parameter_112, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_46, parameter_112, parameter_113

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_40 = paddle._C_ops.matmul(layer_norm_31, parameter_111, False, False)
        del parameter_111

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_47 = paddle._C_ops.add(matmul_40, parameter_110)
        del matmul_40, parameter_110
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_41 = paddle._C_ops.matmul(layer_norm_31, parameter_109, False, False)
        del parameter_109

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_48 = paddle._C_ops.add(matmul_41, parameter_108)
        del matmul_41, parameter_108

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_42 = paddle._C_ops.matmul(layer_norm_31, parameter_107, False, False)
        del parameter_107

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_49 = paddle._C_ops.add(matmul_42, parameter_106)
        del matmul_42, parameter_106
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_45 = paddle._C_ops.matmul(reshape_23, parameter_105, False, False)
        del parameter_105, reshape_23

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_51 = paddle._C_ops.add(matmul_45, parameter_104)
        del matmul_45, parameter_104
        ...
        layer_norm_34, layer_norm_35, layer_norm_36 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_52, parameter_99, parameter_98, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_52, parameter_98, parameter_99

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_46 = paddle._C_ops.matmul(layer_norm_34, parameter_103, False, False)
        del parameter_103

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_53 = paddle._C_ops.add(matmul_46, parameter_102)
        del matmul_46, parameter_102
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_47 = paddle._C_ops.matmul(gelu_5, parameter_101, False, False)
        del gelu_5, parameter_101

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_54 = paddle._C_ops.add(matmul_47, parameter_100)
        del matmul_47, parameter_100
        ...
        layer_norm_37, layer_norm_38, layer_norm_39 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_55, parameter_97, parameter_96, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_55, parameter_96, parameter_97

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_48 = paddle._C_ops.matmul(layer_norm_37, parameter_95, False, False)
        del parameter_95

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_56 = paddle._C_ops.add(matmul_48, parameter_94)
        del matmul_48, parameter_94
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_49 = paddle._C_ops.matmul(layer_norm_37, parameter_93, False, False)
        del parameter_93

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_57 = paddle._C_ops.add(matmul_49, parameter_92)
        del matmul_49, parameter_92

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_50 = paddle._C_ops.matmul(layer_norm_37, parameter_91, False, False)
        del parameter_91

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_58 = paddle._C_ops.add(matmul_50, parameter_90)
        del matmul_50, parameter_90
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_53 = paddle._C_ops.matmul(reshape_27, parameter_89, False, False)
        del parameter_89, reshape_27

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_60 = paddle._C_ops.add(matmul_53, parameter_88)
        del matmul_53, parameter_88
        ...
        layer_norm_40, layer_norm_41, layer_norm_42 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_61, parameter_83, parameter_82, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_61, parameter_82, parameter_83

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_54 = paddle._C_ops.matmul(layer_norm_40, parameter_87, False, False)
        del parameter_87

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_62 = paddle._C_ops.add(matmul_54, parameter_86)
        del matmul_54, parameter_86
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_55 = paddle._C_ops.matmul(gelu_6, parameter_85, False, False)
        del gelu_6, parameter_85

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_63 = paddle._C_ops.add(matmul_55, parameter_84)
        del matmul_55, parameter_84
        ...
        layer_norm_43, layer_norm_44, layer_norm_45 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_64, parameter_81, parameter_80, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_64, parameter_80, parameter_81

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_56 = paddle._C_ops.matmul(layer_norm_43, parameter_79, False, False)
        del parameter_79

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_65 = paddle._C_ops.add(matmul_56, parameter_78)
        del matmul_56, parameter_78
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_57 = paddle._C_ops.matmul(layer_norm_43, parameter_77, False, False)
        del parameter_77

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_66 = paddle._C_ops.add(matmul_57, parameter_76)
        del matmul_57, parameter_76

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_58 = paddle._C_ops.matmul(layer_norm_43, parameter_75, False, False)
        del parameter_75

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_67 = paddle._C_ops.add(matmul_58, parameter_74)
        del matmul_58, parameter_74
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_61 = paddle._C_ops.matmul(reshape_31, parameter_73, False, False)
        del parameter_73, reshape_31

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_69 = paddle._C_ops.add(matmul_61, parameter_72)
        del matmul_61, parameter_72
        ...
        layer_norm_46, layer_norm_47, layer_norm_48 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_70, parameter_67, parameter_66, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_70, parameter_66, parameter_67

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_62 = paddle._C_ops.matmul(layer_norm_46, parameter_71, False, False)
        del parameter_71

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_71 = paddle._C_ops.add(matmul_62, parameter_70)
        del matmul_62, parameter_70
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_63 = paddle._C_ops.matmul(gelu_7, parameter_69, False, False)
        del gelu_7, parameter_69

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_72 = paddle._C_ops.add(matmul_63, parameter_68)
        del matmul_63, parameter_68
        ...
        layer_norm_49, layer_norm_50, layer_norm_51 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_73, parameter_65, parameter_64, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_73, parameter_64, parameter_65

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_64 = paddle._C_ops.matmul(layer_norm_49, parameter_63, False, False)
        del parameter_63

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_74 = paddle._C_ops.add(matmul_64, parameter_62)
        del matmul_64, parameter_62
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_65 = paddle._C_ops.matmul(layer_norm_49, parameter_61, False, False)
        del parameter_61

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_75 = paddle._C_ops.add(matmul_65, parameter_60)
        del matmul_65, parameter_60

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_66 = paddle._C_ops.matmul(layer_norm_49, parameter_59, False, False)
        del parameter_59

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_76 = paddle._C_ops.add(matmul_66, parameter_58)
        del matmul_66, parameter_58
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_69 = paddle._C_ops.matmul(reshape_35, parameter_57, False, False)
        del parameter_57, reshape_35

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_78 = paddle._C_ops.add(matmul_69, parameter_56)
        del matmul_69, parameter_56
        ...
        layer_norm_52, layer_norm_53, layer_norm_54 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_79, parameter_51, parameter_50, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_79, parameter_50, parameter_51

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_70 = paddle._C_ops.matmul(layer_norm_52, parameter_55, False, False)
        del parameter_55

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_80 = paddle._C_ops.add(matmul_70, parameter_54)
        del matmul_70, parameter_54
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_71 = paddle._C_ops.matmul(gelu_8, parameter_53, False, False)
        del gelu_8, parameter_53

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_81 = paddle._C_ops.add(matmul_71, parameter_52)
        del matmul_71, parameter_52
        ...
        layer_norm_55, layer_norm_56, layer_norm_57 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_82, parameter_49, parameter_48, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_82, parameter_48, parameter_49

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_72 = paddle._C_ops.matmul(layer_norm_55, parameter_47, False, False)
        del parameter_47

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_83 = paddle._C_ops.add(matmul_72, parameter_46)
        del matmul_72, parameter_46
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_73 = paddle._C_ops.matmul(layer_norm_55, parameter_45, False, False)
        del parameter_45

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_84 = paddle._C_ops.add(matmul_73, parameter_44)
        del matmul_73, parameter_44

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_74 = paddle._C_ops.matmul(layer_norm_55, parameter_43, False, False)
        del parameter_43

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_85 = paddle._C_ops.add(matmul_74, parameter_42)
        del matmul_74, parameter_42
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_77 = paddle._C_ops.matmul(reshape_39, parameter_41, False, False)
        del parameter_41, reshape_39

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_87 = paddle._C_ops.add(matmul_77, parameter_40)
        del matmul_77, parameter_40
        ...
        layer_norm_58, layer_norm_59, layer_norm_60 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_88, parameter_35, parameter_34, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_88, parameter_34, parameter_35

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_78 = paddle._C_ops.matmul(layer_norm_58, parameter_39, False, False)
        del parameter_39

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_89 = paddle._C_ops.add(matmul_78, parameter_38)
        del matmul_78, parameter_38
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_79 = paddle._C_ops.matmul(gelu_9, parameter_37, False, False)
        del gelu_9, parameter_37

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_90 = paddle._C_ops.add(matmul_79, parameter_36)
        del matmul_79, parameter_36
        ...
        layer_norm_61, layer_norm_62, layer_norm_63 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_91, parameter_33, parameter_32, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_91, parameter_32, parameter_33

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_80 = paddle._C_ops.matmul(layer_norm_61, parameter_31, False, False)
        del parameter_31

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_92 = paddle._C_ops.add(matmul_80, parameter_30)
        del matmul_80, parameter_30
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_81 = paddle._C_ops.matmul(layer_norm_61, parameter_29, False, False)
        del parameter_29

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_93 = paddle._C_ops.add(matmul_81, parameter_28)
        del matmul_81, parameter_28

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_82 = paddle._C_ops.matmul(layer_norm_61, parameter_27, False, False)
        del parameter_27

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_94 = paddle._C_ops.add(matmul_82, parameter_26)
        del matmul_82, parameter_26
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_85 = paddle._C_ops.matmul(reshape_43, parameter_25, False, False)
        del parameter_25, reshape_43

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_96 = paddle._C_ops.add(matmul_85, parameter_24)
        ...
        layer_norm_64, layer_norm_65, layer_norm_66 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_97, parameter_19, parameter_18, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_97, parameter_18, parameter_19

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_86 = paddle._C_ops.matmul(layer_norm_64, parameter_23, False, False)
        del parameter_23

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_98 = paddle._C_ops.add(matmul_86, parameter_22)
        del matmul_86, parameter_22
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_87 = paddle._C_ops.matmul(gelu_10, parameter_21, False, False)
        del gelu_10, parameter_21

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_99 = paddle._C_ops.add(matmul_87, parameter_20)
        del matmul_87, parameter_20
        ...
        layer_norm_67, layer_norm_68, layer_norm_69 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_100, parameter_17, parameter_16, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_100, parameter_16, parameter_17

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_88 = paddle._C_ops.matmul(layer_norm_67, parameter_15, False, False)
        del parameter_15

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_101 = paddle._C_ops.add(matmul_88, parameter_14)
        del matmul_88, parameter_14
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_89 = paddle._C_ops.matmul(layer_norm_67, parameter_13, False, False)
        del parameter_13

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_102 = paddle._C_ops.add(matmul_89, parameter_12)
        del matmul_89, parameter_12

        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_90 = paddle._C_ops.matmul(layer_norm_67, parameter_11, False, False)
        del parameter_11

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_103 = paddle._C_ops.add(matmul_90, parameter_10)
        del matmul_90, parameter_10
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x768xf32, 768x768xf32)
        matmul_93 = paddle._C_ops.matmul(reshape_47, parameter_9, False, False)
        del parameter_9, reshape_47

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_105 = paddle._C_ops.add(matmul_93, parameter_8)
        del matmul_93, parameter_8
        ...
        layer_norm_70, layer_norm_71, layer_norm_72 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_106, parameter_3, parameter_2, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_106, parameter_2, parameter_3

        # pd_op.matmul: (1x11x3072xf32) <- (1x11x768xf32, 768x3072xf32)
        matmul_94 = paddle._C_ops.matmul(layer_norm_70, parameter_7, False, False)
        del parameter_7

        # pd_op.add: (1x11x3072xf32) <- (1x11x3072xf32, 3072xf32)
        add_107 = paddle._C_ops.add(matmul_94, parameter_6)
        del matmul_94, parameter_6
        ...
        # pd_op.matmul: (1x11x768xf32) <- (1x11x3072xf32, 3072x768xf32)
        matmul_95 = paddle._C_ops.matmul(gelu_11, parameter_5, False, False)
        del gelu_11, parameter_5

        # pd_op.add: (1x11x768xf32) <- (1x11x768xf32, 768xf32)
        add_108 = paddle._C_ops.add(matmul_95, parameter_4)
        ...
        layer_norm_0, layer_norm_73, layer_norm_74 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_109, parameter_1, parameter_0, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        del add_109, parameter_0, parameter_1
