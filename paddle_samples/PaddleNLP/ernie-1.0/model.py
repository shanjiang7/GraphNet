...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x26x768xf32) <- (1x26xi64, 18000x768xf32)
        ...
        # pd_op.layer_norm: (1x26x768xf32, 1x26xf32, 1x26xf32) <- (1x26x768xf32, 768xf32, 768xf32)
        ...
        # pd_op.dropout: (1x26x768xf32, 1x26x768xui8) <- (1x26x768xf32, None, 1xf32)
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x768xf32, 768x768xf32)
        matmul_0 = paddle._C_ops.matmul(dropout_0, parameter_193, False, False)
        del parameter_193

        # pd_op.add: (1x26x768xf32) <- (1x26x768xf32, 768xf32)
        ...
        # pd_op.reshape: (1x26x12x64xf32) <- (1x26x768xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(add_2, full_int_array_1)
        del add_2

        # pd_op.transpose: (1x12x26x64xf32) <- (1x26x12x64xf32)
        ...
        # pd_op.scale: (1x12x26x64xf32) <- (1x12x26x64xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(transpose_0, full_5, float("0"), True)
        del transpose_0

        # pd_op.matmul: (1x12x26x26xf32) <- (1x12x26x64xf32, 1x12x26x64xf32)
        matmul_3 = paddle._C_ops.matmul(scale_1, transpose_1, False, True)
        del scale_1, transpose_1

        # pd_op.add: (1x12x26x26xf32) <- (1x12x26x26xf32, 1x1x1x26xf32)
        add_5 = paddle._C_ops.add(matmul_3, unsqueeze_0)
        del matmul_3

        # pd_op.softmax: (1x12x26x26xf32) <- (1x12x26x26xf32)
        softmax_0 = paddle._C_ops.softmax(add_5, -1)
        del add_5

        # pd_op.dropout: (1x12x26x26xf32, 1x12x26x26xui8) <- (1x12x26x26xf32, None, 1xf32)
        ...
        # pd_op.matmul: (1x12x26x64xf32) <- (1x12x26x26xf32, 1x12x26x64xf32)
        matmul_4 = paddle._C_ops.matmul(dropout_2, transpose_2, False, False)
        del dropout_2, transpose_2

        # pd_op.transpose: (1x26x12x64xf32) <- (1x12x26x64xf32)
        ...
        # pd_op.reshape: (1x26x768xf32) <- (1x26x12x64xf32, 3xi64)
        ...
        # pd_op.matmul: (1x26x3072xf32) <- (1x26x768xf32, 768x3072xf32)
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_7 = paddle._C_ops.matmul(relu_0, parameter_183, False, False)
        del parameter_183, relu_0
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_15 = paddle._C_ops.matmul(relu_1, parameter_167, False, False)
        del parameter_167, relu_1
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_23 = paddle._C_ops.matmul(relu_2, parameter_151, False, False)
        del parameter_151, relu_2
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_31 = paddle._C_ops.matmul(relu_3, parameter_135, False, False)
        del parameter_135, relu_3
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_39 = paddle._C_ops.matmul(relu_4, parameter_119, False, False)
        del parameter_119, relu_4
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_47 = paddle._C_ops.matmul(relu_5, parameter_103, False, False)
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_55 = paddle._C_ops.matmul(relu_6, parameter_87, False, False)
        del parameter_87, relu_6
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_63 = paddle._C_ops.matmul(relu_7, parameter_71, False, False)
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_71 = paddle._C_ops.matmul(relu_8, parameter_55, False, False)
        del parameter_55, relu_8
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_79 = paddle._C_ops.matmul(relu_9, parameter_39, False, False)
        del parameter_39, relu_9
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_87 = paddle._C_ops.matmul(relu_10, parameter_23, False, False)
        del parameter_23, relu_10
        ...
        # pd_op.matmul: (1x26x768xf32) <- (1x26x3072xf32, 3072x768xf32)
        matmul_95 = paddle._C_ops.matmul(relu_11, parameter_7, False, False)
        del parameter_7, relu_11
        ...
        # pd_op.slice: (1x768xf32) <- (1x26x768xf32, 1xi64, 1xi64)
