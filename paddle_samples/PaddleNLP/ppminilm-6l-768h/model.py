...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (1x27xi64) <- (1x27xi64, 1xf32)
        ...
        # pd_op.subtract: (1x27xi64) <- (1x27xi64, 1x27xi64)
        ...
        # pd_op.relu: (1x27x3072xf32) <- (1x27x3072xf32)
        relu_0 = paddle._C_ops.relu(add_8)
        del add_8

        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        matmul_7 = paddle._C_ops.matmul(relu_0, parameter_87, False, False)
        del parameter_87, relu_0
        ...
        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        matmul_15 = paddle._C_ops.matmul(relu_1, parameter_71, False, False)
        del parameter_71, relu_1
        ...
        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        matmul_23 = paddle._C_ops.matmul(relu_2, parameter_55, False, False)
        del parameter_55, relu_2
        ...
        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        matmul_31 = paddle._C_ops.matmul(relu_3, parameter_39, False, False)
        del parameter_39, relu_3
        ...
        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        matmul_39 = paddle._C_ops.matmul(relu_4, parameter_23, False, False)
        del parameter_23, relu_4
        ...
        # pd_op.matmul: (1x27x768xf32) <- (1x27x3072xf32, 3072x768xf32)
        matmul_47 = paddle._C_ops.matmul(relu_5, parameter_7, False, False)
        del parameter_7, relu_5
