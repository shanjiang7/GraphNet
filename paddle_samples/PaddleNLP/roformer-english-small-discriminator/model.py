...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.strided_slice: (1x4x21x32xf32) <- (1x4x21x64xf32, 1xi64, 1xi64, 1xi64)
        ...
        # pd_op.add: (1x4x21x32xf32) <- (1x4x21x32xf32, 1x4x21x32xf32)
        add_5 = paddle._C_ops.add(multiply_2, multiply_3)

        # builtin.combine: ([1x4x21x32xf32, 1x4x21x32xf32]) <- (1x4x21x32xf32, 1x4x21x32xf32)
        combine_0 = [subtract_0, add_5]

        # pd_op.stack: (1x4x21x32x2xf32) <- ([1x4x21x32xf32, 1x4x21x32xf32])
        stack_0 = paddle._C_ops.stack(combine_0, -1)
        del combine_0

        # pd_op.flatten: (1x4x21x64xf32) <- (1x4x21x32x2xf32)
