...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_70, -1, False)
        del data_0, parameter_70

        # pd_op.embedding: (1x11x512xf32) <- (1x11xi64, 512x512xf32)
        embedding_1 = paddle._C_ops.embedding(subtract_0, parameter_69, -1, False)
        del parameter_69
