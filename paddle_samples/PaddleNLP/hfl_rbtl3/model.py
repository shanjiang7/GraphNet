...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        embedding_1 = paddle._C_ops.embedding(scale_2, parameter_53, -1, False)
        del parameter_53, scale_2
        ...
        matmul_7 = paddle._C_ops.matmul(gelu_0, parameter_39, False, False)
        del gelu_0, parameter_39
        ...
        # pd_op.matmul: (1x27x1024xf32) <- (1x27x4096xf32, 4096x1024xf32)
        matmul_15 = paddle._C_ops.matmul(gelu_1, parameter_23, False, False)
        del gelu_1, parameter_23
        ...
        # pd_op.matmul: (1x27x1024xf32) <- (1x27x4096xf32, 4096x1024xf32)
        matmul_23 = paddle._C_ops.matmul(gelu_2, parameter_7, False, False)
        del gelu_2, parameter_7
