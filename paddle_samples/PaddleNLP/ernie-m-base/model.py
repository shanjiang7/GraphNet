...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.embedding: (1x21x768xf32) <- (1x21xi64, 250002x768xf32)
        embedding_0 = paddle._C_ops.embedding(data_0, parameter_197, -1, False)
        del data_0, parameter_197
        ...
        # pd_op.embedding: (1x21x768xf32) <- (1x21xi64, 514x768xf32)
        embedding_1 = paddle._C_ops.embedding(scale_1, parameter_196, -1, False)
        del parameter_196
        ...
        layer_norm_0, layer_norm_1, layer_norm_2 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_0, parameter_195, parameter_194, float("1e-05"), 2
            ),
        ...
        add_1 = paddle._C_ops.add(matmul_0, parameter_192)
        del parameter_192
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_2 = paddle._C_ops.add(matmul_1, parameter_190)
        del parameter_190
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_3 = paddle._C_ops.add(matmul_2, parameter_188)
        del parameter_188
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_5 = paddle._C_ops.add(matmul_5, parameter_186)
        del parameter_186
        ...
        layer_norm_3, layer_norm_4, layer_norm_5 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_6, parameter_181, parameter_180, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_8 = paddle._C_ops.add(matmul_7, parameter_182)
        del parameter_182
        ...
        layer_norm_6, layer_norm_7, layer_norm_8 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_9, parameter_179, parameter_178, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_10 = paddle._C_ops.add(matmul_8, parameter_176)
        del parameter_176
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_11 = paddle._C_ops.add(matmul_9, parameter_174)
        del parameter_174
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_12 = paddle._C_ops.add(matmul_10, parameter_172)
        del parameter_172
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_14 = paddle._C_ops.add(matmul_13, parameter_170)
        del parameter_170
        ...
        layer_norm_9, layer_norm_10, layer_norm_11 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_15, parameter_165, parameter_164, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_17 = paddle._C_ops.add(matmul_15, parameter_166)
        del parameter_166
        ...
        layer_norm_12, layer_norm_13, layer_norm_14 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_18, parameter_163, parameter_162, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_19 = paddle._C_ops.add(matmul_16, parameter_160)
        del parameter_160
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_20 = paddle._C_ops.add(matmul_17, parameter_158)
        del parameter_158
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_21 = paddle._C_ops.add(matmul_18, parameter_156)
        del parameter_156
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_23 = paddle._C_ops.add(matmul_21, parameter_154)
        del parameter_154
        ...
        layer_norm_15, layer_norm_16, layer_norm_17 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_24, parameter_149, parameter_148, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_26 = paddle._C_ops.add(matmul_23, parameter_150)
        del parameter_150
        ...
        layer_norm_18, layer_norm_19, layer_norm_20 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_27, parameter_147, parameter_146, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_28 = paddle._C_ops.add(matmul_24, parameter_144)
        del parameter_144
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_29 = paddle._C_ops.add(matmul_25, parameter_142)
        del parameter_142
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_30 = paddle._C_ops.add(matmul_26, parameter_140)
        del parameter_140
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_32 = paddle._C_ops.add(matmul_29, parameter_138)
        del parameter_138
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_35 = paddle._C_ops.add(matmul_31, parameter_134)
        del parameter_134
        ...
        layer_norm_24, layer_norm_25, layer_norm_26 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_36, parameter_131, parameter_130, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_37 = paddle._C_ops.add(matmul_32, parameter_128)
        del parameter_128
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_38 = paddle._C_ops.add(matmul_33, parameter_126)
        del parameter_126
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_39 = paddle._C_ops.add(matmul_34, parameter_124)
        del parameter_124
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_41 = paddle._C_ops.add(matmul_37, parameter_122)
        del parameter_122
        ...
        layer_norm_27, layer_norm_28, layer_norm_29 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_42, parameter_117, parameter_116, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_44 = paddle._C_ops.add(matmul_39, parameter_118)
        del parameter_118
        ...
        layer_norm_30, layer_norm_31, layer_norm_32 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_45, parameter_115, parameter_114, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_46 = paddle._C_ops.add(matmul_40, parameter_112)
        del parameter_112
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_47 = paddle._C_ops.add(matmul_41, parameter_110)
        del parameter_110
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_48 = paddle._C_ops.add(matmul_42, parameter_108)
        del parameter_108
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_50 = paddle._C_ops.add(matmul_45, parameter_106)
        del parameter_106
        ...
        layer_norm_33, layer_norm_34, layer_norm_35 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_51, parameter_101, parameter_100, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_53 = paddle._C_ops.add(matmul_47, parameter_102)
        del parameter_102
        ...
        layer_norm_36, layer_norm_37, layer_norm_38 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_54, parameter_99, parameter_98, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_55 = paddle._C_ops.add(matmul_48, parameter_96)
        del parameter_96
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_56 = paddle._C_ops.add(matmul_49, parameter_94)
        del parameter_94
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_57 = paddle._C_ops.add(matmul_50, parameter_92)
        del parameter_92
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_59 = paddle._C_ops.add(matmul_53, parameter_90)
        del parameter_90
        ...
        layer_norm_39, layer_norm_40, layer_norm_41 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_60, parameter_85, parameter_84, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_62 = paddle._C_ops.add(matmul_55, parameter_86)
        del parameter_86
        ...
        layer_norm_42, layer_norm_43, layer_norm_44 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_63, parameter_83, parameter_82, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_64 = paddle._C_ops.add(matmul_56, parameter_80)
        del parameter_80
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_65 = paddle._C_ops.add(matmul_57, parameter_78)
        del parameter_78
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_66 = paddle._C_ops.add(matmul_58, parameter_76)
        del parameter_76
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_68 = paddle._C_ops.add(matmul_61, parameter_74)
        del parameter_74
        ...
        layer_norm_45, layer_norm_46, layer_norm_47 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_69, parameter_69, parameter_68, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_71 = paddle._C_ops.add(matmul_63, parameter_70)
        del parameter_70
        ...
        layer_norm_48, layer_norm_49, layer_norm_50 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_72, parameter_67, parameter_66, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_73 = paddle._C_ops.add(matmul_64, parameter_64)
        del parameter_64
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_74 = paddle._C_ops.add(matmul_65, parameter_62)
        del parameter_62
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_75 = paddle._C_ops.add(matmul_66, parameter_60)
        del parameter_60
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_77 = paddle._C_ops.add(matmul_69, parameter_58)
        del parameter_58
        ...
        layer_norm_51, layer_norm_52, layer_norm_53 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_78, parameter_53, parameter_52, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_80 = paddle._C_ops.add(matmul_71, parameter_54)
        del parameter_54
        ...
        layer_norm_54, layer_norm_55, layer_norm_56 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_81, parameter_51, parameter_50, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_82 = paddle._C_ops.add(matmul_72, parameter_48)
        del parameter_48
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_83 = paddle._C_ops.add(matmul_73, parameter_46)
        del parameter_46
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_84 = paddle._C_ops.add(matmul_74, parameter_44)
        del parameter_44
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_86 = paddle._C_ops.add(matmul_77, parameter_42)
        del parameter_42
        ...
        layer_norm_57, layer_norm_58, layer_norm_59 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_87, parameter_37, parameter_36, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_89 = paddle._C_ops.add(matmul_79, parameter_38)
        del parameter_38
        ...
        layer_norm_60, layer_norm_61, layer_norm_62 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_90, parameter_35, parameter_34, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_91 = paddle._C_ops.add(matmul_80, parameter_32)
        del parameter_32
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_92 = paddle._C_ops.add(matmul_81, parameter_30)
        del parameter_30
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_93 = paddle._C_ops.add(matmul_82, parameter_28)
        del parameter_28
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_95 = paddle._C_ops.add(matmul_85, parameter_26)
        del parameter_26
        ...
        layer_norm_63, layer_norm_64, layer_norm_65 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_96, parameter_21, parameter_20, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_98 = paddle._C_ops.add(matmul_87, parameter_22)
        del parameter_22
        ...
        layer_norm_66, layer_norm_67, layer_norm_68 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_99, parameter_19, parameter_18, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_100 = paddle._C_ops.add(matmul_88, parameter_16)
        del parameter_16
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_101 = paddle._C_ops.add(matmul_89, parameter_14)
        del parameter_14
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_102 = paddle._C_ops.add(matmul_90, parameter_12)
        del parameter_12
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_104 = paddle._C_ops.add(matmul_93, parameter_10)
        del parameter_10
        ...
        layer_norm_69, layer_norm_70, layer_norm_71 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_105, parameter_5, parameter_4, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        # pd_op.add: (1x21x768xf32) <- (1x21x768xf32, 768xf32)
        add_107 = paddle._C_ops.add(matmul_95, parameter_6)
        del parameter_6
        ...
        layer_norm_72, layer_norm_73, layer_norm_74 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_108, parameter_3, parameter_2, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
        ...
        add_109 = paddle._C_ops.add(matmul_96, parameter_0)
        del parameter_0

        # pd_op.tanh: (1x768xf32) <- (1x768xf32)
        tanh_0 = paddle._C_ops.tanh(add_109)
        del (
            add_0,
            add_1,
            add_10,
