...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        L_self_modules_backbone_modules_conv2_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_backbone_modules_conv2_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_backbone_modules_conv2_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_backbone_modules_conv2_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_backbone_modules_conv2_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        ...
        l_self_modules_backbone_modules_conv2_modules_bn_buffers_running_mean_ = (
            L_self_modules_backbone_modules_conv2_modules_bn_buffers_running_mean_
        )
        l_self_modules_backbone_modules_conv2_modules_bn_buffers_running_var_ = (
            L_self_modules_backbone_modules_conv2_modules_bn_buffers_running_var_
        )
        l_self_modules_backbone_modules_conv2_modules_bn_parameters_weight_ = (
            L_self_modules_backbone_modules_conv2_modules_bn_parameters_weight_
        )
        l_self_modules_backbone_modules_conv2_modules_bn_parameters_bias_ = (
            L_self_modules_backbone_modules_conv2_modules_bn_parameters_bias_
        )
        ...
        x_136 = (
            ...
            l_self_modules_backbone_modules_conv2_modules_bn_parameters_weight_
        ) = l_self_modules_backbone_modules_conv2_modules_bn_parameters_bias_ = None
        x_138 = torch.nn.functional.hardtanh(x_137, 0.0, 6.0, True)
        x_137 = None
        feats = torch.conv2d(
            x_138,
            l_self_modules_head_modules_final_layer_parameters_weight_,
