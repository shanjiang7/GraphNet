...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        input_3 = torch._C._nn.avg_pool2d(out_29, 2, 2, 0, True, False, None)
        out_29 = None
        ...
        input_6 = torch._C._nn.avg_pool2d(out_109, 2, 2, 0, True, False, None)
        out_109 = None
        ...
        input_9 = torch._C._nn.avg_pool2d(out_469, 2, 2, 0, True, False, None)
        out_469 = None
