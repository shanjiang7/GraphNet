...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        y = mul_4 + mul_5
        mul_4 = mul_5 = None
        cat_24 = torch.cat([x_32, y], dim=1)
        x_32 = y = None
        xy = cat_24 + unsqueeze
        cat_24 = unsqueeze = None
        add_22 = lt + rb
        lt = rb = None
        cat_25 = torch.cat([xy, add_22], dim=1)
        xy = add_22 = None
        dbox = cat_25 * transpose_3
        cat_25 = None
        sigmoid_1 = cls.sigmoid()
        cls = None
        y_1 = torch.cat((dbox, sigmoid_1), 1)
        dbox = sigmoid_1 = None
        cat_27 = torch.cat([y_1, angle_1], 1)
        y_1 = None
        return (cat_27, xi, xi_1, xi_2, angle_1, transpose_3, transpose_2)
