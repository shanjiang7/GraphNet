...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_10 = input_45.view(1, 1, -1)
        input_45 = None
        angle = torch.cat([view_8, view_9, view_10], 2)
        ...
        truediv = sub_1 / 2
        sub_1 = None
        split_10 = truediv.split(1, dim=1)
        truediv = None
        xf = split_10[0]
        yf = split_10[1]
        split_10 = None
        ...
        y = mul_11 + mul_12
        mul_11 = mul_12 = None
        cat_25 = torch.cat([x_70, y], dim=1)
        x_70 = y = None
        xy = cat_25 + unsqueeze
        cat_25 = unsqueeze = None
        add_44 = lt + rb
        lt = rb = None
        cat_26 = torch.cat([xy, add_44], dim=1)
        xy = add_44 = None
        dbox = cat_26 * transpose_25
        cat_26 = None
        sigmoid_1 = cls.sigmoid()
        cls = None
        y_1 = torch.cat((dbox, sigmoid_1), 1)
        dbox = sigmoid_1 = None
        cat_28 = torch.cat([y_1, angle_1], 1)
        y_1 = None
        return (cat_28, xi, xi_1, xi_2, angle_1, transpose_25, transpose_24)
