...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        add_28 = mul_4 + sub_3
        mul_4 = sub_3 = None
        mul_5 = add_28 * transpose_3
        add_28 = None
        y_1[(slice(None, None, None), slice(1, None, 3))] = mul_5
        setitem_2 = y_1
        mul_5 = setitem_2 = None
        cat_31 = torch.cat([y, y_1], 1)
        y = y_1 = None
        return (cat_31, xi, xi_1, xi_2, kpt, transpose_3, transpose_2)
