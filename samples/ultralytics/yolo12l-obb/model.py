...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_20 = input_81.view(1, 1, -1)
        input_81 = None
        angle = torch.cat([view_18, view_19, view_20], 2)
        ...
        split_17 = view_28.split(2, dim=1)
        view_28 = None
        lt = split_17[0]
        rb = split_17[1]
        split_17 = None
        ...
        truediv = sub_1 / 2
        sub_1 = None
        split_18 = truediv.split(1, dim=1)
        truediv = None
        xf = split_18[0]
        yf = split_18[1]
        split_18 = None
        ...
        y = mul_21 + mul_22
        mul_21 = mul_22 = None
        cat_31 = torch.cat([x_114, y], dim=1)
        x_114 = y = None
        xy = cat_31 + unsqueeze
        cat_31 = unsqueeze = None
        add_82 = lt + rb
        lt = rb = None
        cat_32 = torch.cat([xy, add_82], dim=1)
        xy = add_82 = None
        dbox = cat_32 * transpose_49
        cat_32 = None
        sigmoid_1 = cls.sigmoid()
        cls = None
        y_1 = torch.cat((dbox, sigmoid_1), 1)
        dbox = sigmoid_1 = None
        cat_34 = torch.cat([y_1, angle_1], 1)
        y_1 = None
        return (cat_34, xi, xi_1, xi_2, angle_1, transpose_49, transpose_48)
