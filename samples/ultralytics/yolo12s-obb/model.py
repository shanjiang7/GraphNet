...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        y = mul_11 + mul_12
        mul_11 = mul_12 = None
        cat_23 = torch.cat([x_70, y], dim=1)
        x_70 = y = None
        xy = cat_23 + unsqueeze
        cat_23 = unsqueeze = None
        add_42 = lt + rb
        lt = rb = None
        cat_24 = torch.cat([xy, add_42], dim=1)
        xy = add_42 = None
        dbox = cat_24 * transpose_25
        cat_24 = None
        sigmoid_1 = cls.sigmoid()
        cls = None
        y_1 = torch.cat((dbox, sigmoid_1), 1)
        dbox = sigmoid_1 = None
        cat_26 = torch.cat([y_1, angle_1], 1)
        y_1 = None
        return (cat_26, xi, xi_1, xi_2, angle_1, transpose_25, transpose_24)
