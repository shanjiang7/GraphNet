...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_6 = input_45.view(1, 1, -1)
        input_45 = None
        angle = torch.cat([view_4, view_5, view_6], 2)
        ...
        view_7 = xi.view(1, 79, -1)
        view_8 = xi_1.view(1, 79, -1)
        view_9 = xi_2.view(1, 79, -1)
        ...
        y = mul_5 + mul_6
        mul_5 = mul_6 = None
        cat_37 = torch.cat([x_36, y], dim=1)
        x_36 = y = None
        xy = cat_37 + unsqueeze
        cat_37 = unsqueeze = None
        add_46 = lt + rb
        lt = rb = None
        cat_38 = torch.cat([xy, add_46], dim=1)
        xy = add_46 = None
        dbox = cat_38 * transpose_5
        cat_38 = None
        sigmoid_1 = cls.sigmoid()
        cls = None
        y_1 = torch.cat((dbox, sigmoid_1), 1)
        dbox = sigmoid_1 = None
        cat_40 = torch.cat([y_1, angle_1], 1)
        y_1 = None
        return (cat_40, xi, xi_1, xi_2, angle_1, transpose_5, transpose_4)
