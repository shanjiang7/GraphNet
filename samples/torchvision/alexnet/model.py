...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        input_12 = None
        x = torch.nn.functional.adaptive_avg_pool2d(input_13, (6, 6))
        input_13 = None
        x_1 = torch.flatten(x, 1)
        x = None
        input_14 = torch.nn.functional.dropout(x_1, 0.5, False, False)
        x_1 = None
        ...
        input_15 = None
        input_17 = torch.nn.functional.dropout(input_16, 0.5, False, False)
        input_16 = None
