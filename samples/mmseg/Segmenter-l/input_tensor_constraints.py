...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 1601, 1024], "L_self_modules_backbone_parameters_pos_embed_"),
    (
        [1024, 1024],
        "L_self_modules_decode_head_modules_classes_proj_parameters_weight_",
    ),
    ([1024], "L_self_modules_decode_head_modules_dec_proj_parameters_bias_"),
    ([1024, 1024], "L_self_modules_decode_head_modules_dec_proj_parameters_weight_"),
    ([1024], "L_self_modules_decode_head_modules_decoder_norm_parameters_bias_"),
    ([1024], "L_self_modules_decode_head_modules_decoder_norm_parameters_weight_"),
    (
        [1024],
    ...
    ([1024, 1024], "L_self_modules_decode_head_modules_patch_proj_parameters_weight_"),
    ([1, 150, 1024], "L_self_modules_decode_head_parameters_cls_emb_"),
]
