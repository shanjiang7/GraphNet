...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        L_self_modules_decode_head_modules_pam_in_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_decode_head_modules_pam_in_conv_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_in_conv_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_query_project_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_query_project_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_key_project_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_key_project_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_value_project_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_value_project_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_modules_gamma_parameters_scale_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_out_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_decode_head_modules_pam_out_conv_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_out_conv_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_conv_seg_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_pam_conv_seg_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_in_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_decode_head_modules_cam_in_conv_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_in_conv_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_modules_gamma_parameters_scale_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_out_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_decode_head_modules_cam_out_conv_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_out_conv_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_conv_seg_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cam_conv_seg_parameters_bias_: torch.nn.parameter.Parameter,
        ...
        l_self_modules_decode_head_modules_pam_in_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_pam_in_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_mean_ = L_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_mean_
        l_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_var_ = L_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_var_
        ...
        l_self_modules_decode_head_modules_pam_modules_query_project_parameters_weight_ = L_self_modules_decode_head_modules_pam_modules_query_project_parameters_weight_
        l_self_modules_decode_head_modules_pam_modules_query_project_parameters_bias_ = L_self_modules_decode_head_modules_pam_modules_query_project_parameters_bias_
        l_self_modules_decode_head_modules_pam_modules_key_project_parameters_weight_ = L_self_modules_decode_head_modules_pam_modules_key_project_parameters_weight_
        l_self_modules_decode_head_modules_pam_modules_key_project_parameters_bias_ = (
            L_self_modules_decode_head_modules_pam_modules_key_project_parameters_bias_
        )
        l_self_modules_decode_head_modules_pam_modules_value_project_parameters_weight_ = L_self_modules_decode_head_modules_pam_modules_value_project_parameters_weight_
        l_self_modules_decode_head_modules_pam_modules_value_project_parameters_bias_ = L_self_modules_decode_head_modules_pam_modules_value_project_parameters_bias_
        l_self_modules_decode_head_modules_pam_modules_gamma_parameters_scale_ = (
            L_self_modules_decode_head_modules_pam_modules_gamma_parameters_scale_
        )
        l_self_modules_decode_head_modules_pam_out_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_pam_out_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_mean_ = L_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_mean_
        l_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_var_ = L_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_var_
        l_self_modules_decode_head_modules_pam_out_conv_modules_bn_parameters_weight_ = L_self_modules_decode_head_modules_pam_out_conv_modules_bn_parameters_weight_
        ...
        l_self_modules_decode_head_modules_pam_conv_seg_parameters_bias_ = (
            L_self_modules_decode_head_modules_pam_conv_seg_parameters_bias_
        )
        l_self_modules_decode_head_modules_cam_in_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_cam_in_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_mean_ = L_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_mean_
        l_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_var_ = L_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_var_
        ...
        l_self_modules_decode_head_modules_cam_out_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_cam_out_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_mean_ = L_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_mean_
        l_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_var_ = L_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_var_
        l_self_modules_decode_head_modules_cam_out_conv_modules_bn_parameters_weight_ = L_self_modules_decode_head_modules_cam_out_conv_modules_bn_parameters_weight_
        ...
        l_self_modules_decode_head_modules_cam_conv_seg_parameters_bias_ = (
            L_self_modules_decode_head_modules_cam_conv_seg_parameters_bias_
        )
        ...
        x_1 = l_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_pam_in_conv_modules_bn_buffers_running_var_ = (
            l_self_modules_decode_head_modules_pam_in_conv_modules_bn_parameters_weight_
        ) = (
            l_self_modules_decode_head_modules_pam_in_conv_modules_bn_parameters_bias_
        ) = None
        ...
        l_self_modules_decode_head_modules_pam_modules_query_project_parameters_weight_ = l_self_modules_decode_head_modules_pam_modules_query_project_parameters_bias_ = (None)
        query_1 = query.reshape(1, 64, -1)
        query = None
        permute = query_1.permute(0, 2, 1)
        query_1 = None
        query_2 = permute.contiguous()
        permute = None
        key = torch.conv2d(
            x_3,
        ...
        l_self_modules_decode_head_modules_pam_modules_value_project_parameters_weight_ = l_self_modules_decode_head_modules_pam_modules_value_project_parameters_bias_ = (None)
        key_1 = key.reshape(1, 64, -1)
        key = None
        value_1 = value.reshape(1, 512, -1)
        value = None
        permute_1 = value_1.permute(0, 2, 1)
        value_1 = None
        value_2 = permute_1.contiguous()
        permute_1 = None
        sim_map = torch.matmul(query_2, key_1)
        query_2 = key_1 = None
        sim_map_1 = torch.nn.functional.softmax(sim_map, dim=-1)
        sim_map = None
        context = torch.matmul(sim_map_1, value_2)
        sim_map_1 = value_2 = None
        permute_2 = context.permute(0, 2, 1)
        context = None
        context_1 = permute_2.contiguous()
        permute_2 = None
        context_2 = context_1.reshape(1, -1, 64, 64)
        context_1 = None
        mul = (
            context_2
            * l_self_modules_decode_head_modules_pam_modules_gamma_parameters_scale_
        ...
        out_330 = l_self_modules_decode_head_modules_pam_out_conv_modules_conv_parameters_weight_ = (None)
        ...
        x_4 = l_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_pam_out_conv_modules_bn_buffers_running_var_ = l_self_modules_decode_head_modules_pam_out_conv_modules_bn_parameters_weight_ = (
            l_self_modules_decode_head_modules_pam_out_conv_modules_bn_parameters_bias_
        ) = None
        x_6 = torch.nn.functional.relu(x_5, inplace=True)
        x_5 = None
        feat = torch.nn.functional.dropout2d(x_6, 0.1, False, False)
        output = torch.conv2d(
            feat,
            l_self_modules_decode_head_modules_pam_conv_seg_parameters_weight_,
            l_self_modules_decode_head_modules_pam_conv_seg_parameters_bias_,
        ...
        feat = (
            l_self_modules_decode_head_modules_pam_conv_seg_parameters_weight_
        ) = l_self_modules_decode_head_modules_pam_conv_seg_parameters_bias_ = None
        x_7 = torch.conv2d(
            out_329,
        ...
        out_329 = l_self_modules_decode_head_modules_cam_in_conv_modules_conv_parameters_weight_ = (None)
        ...
        x_7 = l_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_cam_in_conv_modules_bn_buffers_running_var_ = (
            l_self_modules_decode_head_modules_cam_in_conv_modules_bn_parameters_weight_
        ) = (
            l_self_modules_decode_head_modules_cam_in_conv_modules_bn_parameters_bias_
        ) = None
        ...
        x_8 = None
        proj_query = x_9.view(1, 512, -1)
        view_1 = x_9.view(1, 512, -1)
        proj_key = view_1.permute(0, 2, 1)
        view_1 = None
        energy = torch.bmm(proj_query, proj_key)
        proj_query = proj_key = None
        max_1 = torch.max(energy, -1, keepdim=True)
        getitem = max_1[0]
        max_1 = None
        expand_as = getitem.expand_as(energy)
        getitem = None
        energy_new = expand_as - energy
        expand_as = energy = None
        attention = torch.nn.functional.softmax(energy_new, dim=-1)
        energy_new = None
        proj_value = x_9.view(1, 512, -1)
        out_331 = torch.bmm(attention, proj_value)
        attention = proj_value = None
        out_332 = out_331.view(1, 512, 64, 64)
        out_331 = None
        mul_1 = (
            out_332
            * l_self_modules_decode_head_modules_cam_modules_gamma_parameters_scale_
        ...
        out_333 = l_self_modules_decode_head_modules_cam_out_conv_modules_conv_parameters_weight_ = (None)
        ...
        x_10 = l_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_cam_out_conv_modules_bn_buffers_running_var_ = l_self_modules_decode_head_modules_cam_out_conv_modules_bn_parameters_weight_ = (
            l_self_modules_decode_head_modules_cam_out_conv_modules_bn_parameters_bias_
        ) = None
        x_12 = torch.nn.functional.relu(x_11, inplace=True)
        x_11 = None
        feat_1 = torch.nn.functional.dropout2d(x_12, 0.1, False, False)
        ...
        feat_1 = (
            l_self_modules_decode_head_modules_cam_conv_seg_parameters_weight_
        ) = l_self_modules_decode_head_modules_cam_conv_seg_parameters_bias_ = None
        feat_sum = x_6 + x_12
        x_6 = x_12 = None
        feat_2 = torch.nn.functional.dropout2d(feat_sum, 0.1, False, False)
        feat_sum = None
        ...
        return (output_2, output, output_1)
