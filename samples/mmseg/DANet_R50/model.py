...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        out_160 = l_self_modules_decode_head_modules_pam_out_conv_modules_conv_parameters_weight_ = (None)
        ...
        out_159 = l_self_modules_decode_head_modules_cam_in_conv_modules_conv_parameters_weight_ = (None)
        ...
        out_161 = torch.bmm(attention, proj_value)
        attention = proj_value = None
        out_162 = out_161.view(1, 512, 64, 64)
        out_161 = None
        mul_1 = (
            out_162
            * l_self_modules_decode_head_modules_cam_modules_gamma_parameters_scale_
        ...
        out_163 = l_self_modules_decode_head_modules_cam_out_conv_modules_conv_parameters_weight_ = (None)
