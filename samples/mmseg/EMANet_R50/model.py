...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        L_self_modules_decode_head_modules_ema_in_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_module_buffers_bases_: torch.Tensor,
        L_self_modules_decode_head_modules_ema_out_conv_modules_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_mean_: torch.Tensor,
        L_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_var_: torch.Tensor,
        L_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_bias_: torch.nn.parameter.Parameter,
        ...
        l_self_modules_decode_head_modules_ema_in_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_ema_in_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_mean_ = L_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_mean_
        l_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_var_ = L_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_var_
        l_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_weight_ = (
            L_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_weight_
        )
        l_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_bias_ = (
            L_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_bias_
        )
        l_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_bias_ = L_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_bias_
        l_self_modules_decode_head_modules_ema_module_buffers_bases_ = (
            L_self_modules_decode_head_modules_ema_module_buffers_bases_
        )
        l_self_modules_decode_head_modules_ema_out_conv_modules_conv_parameters_weight_ = L_self_modules_decode_head_modules_ema_out_conv_modules_conv_parameters_weight_
        l_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_mean_ = L_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_mean_
        l_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_var_ = L_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_var_
        l_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_weight_ = L_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_weight_
        l_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_bias_ = (
            L_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_bias_
        )
        ...
        x_2 = torch.nn.functional.batch_norm(
            x_1,
            l_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_mean_,
        ...
        x_1 = l_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_ema_in_conv_modules_bn_buffers_running_var_ = (
            l_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_weight_
        ) = (
            l_self_modules_decode_head_modules_ema_in_conv_modules_bn_parameters_bias_
        ) = None
        ...
        x_4 = torch.conv2d(
            x_3,
            l_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_weight_,
        ...
        l_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_weight_ = l_self_modules_decode_head_modules_ema_mid_conv_modules_conv_parameters_bias_ = (None)
        feats = x_4.view(1, 512, 4096)
        x_4 = None
        bases = l_self_modules_decode_head_modules_ema_module_buffers_bases_.repeat(
            1, 1, 1
        )
        l_self_modules_decode_head_modules_ema_module_buffers_bases_ = None
        attention = torch.functional.einsum("bcn,bck->bnk", feats, bases)
        bases = None
        attention_1 = torch.nn.functional.softmax(attention, dim=2)
        attention = None
        attention_normed = torch.nn.functional.normalize(attention_1, dim=1, p=1)
        attention_1 = None
        bases_1 = torch.functional.einsum("bcn,bnk->bck", feats, attention_normed)
        attention_normed = None
        bases_2 = torch.nn.functional.normalize(bases_1, dim=1, p=2)
        bases_1 = None
        attention_2 = torch.functional.einsum("bcn,bck->bnk", feats, bases_2)
        bases_2 = None
        attention_3 = torch.nn.functional.softmax(attention_2, dim=2)
        attention_2 = None
        attention_normed_1 = torch.nn.functional.normalize(attention_3, dim=1, p=1)
        attention_3 = None
        bases_3 = torch.functional.einsum("bcn,bnk->bck", feats, attention_normed_1)
        attention_normed_1 = None
        bases_4 = torch.nn.functional.normalize(bases_3, dim=1, p=2)
        bases_3 = None
        attention_4 = torch.functional.einsum("bcn,bck->bnk", feats, bases_4)
        bases_4 = None
        attention_5 = torch.nn.functional.softmax(attention_4, dim=2)
        attention_4 = None
        attention_normed_2 = torch.nn.functional.normalize(attention_5, dim=1, p=1)
        bases_5 = torch.functional.einsum("bcn,bnk->bck", feats, attention_normed_2)
        feats = attention_normed_2 = None
        bases_6 = torch.nn.functional.normalize(bases_5, dim=1, p=2)
        bases_5 = None
        feats_recon = torch.functional.einsum("bck,bnk->bcn", bases_6, attention_5)
        bases_6 = attention_5 = None
        feats_recon_1 = feats_recon.view(1, 512, 64, 64)
        feats_recon = None
        recon = torch.nn.functional.relu(feats_recon_1, inplace=True)
        feats_recon_1 = None
        x_5 = torch.conv2d(
            recon,
            l_self_modules_decode_head_modules_ema_out_conv_modules_conv_parameters_weight_,
            None,
            (1, 1),
            (0, 0),
            (1, 1),
        ...
        recon = l_self_modules_decode_head_modules_ema_out_conv_modules_conv_parameters_weight_ = (None)
        x_6 = torch.nn.functional.batch_norm(
            x_5,
            l_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_mean_,
            l_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_var_,
        ...
        x_5 = l_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_ema_out_conv_modules_bn_buffers_running_var_ = l_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_weight_ = (
            l_self_modules_decode_head_modules_ema_out_conv_modules_bn_parameters_bias_
        ) = None
        add = x_3 + x_6
        x_3 = x_6 = None
        ...
        x_7 = l_self_modules_decode_head_modules_bottleneck_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_bottleneck_modules_bn_buffers_running_var_ = (
            l_self_modules_decode_head_modules_bottleneck_modules_bn_parameters_weight_
        ) = (
            l_self_modules_decode_head_modules_bottleneck_modules_bn_parameters_bias_
        ) = None
        ...
        x_8 = None
        cat = torch.cat([out_159, x_9], dim=1)
        out_159 = x_9 = None
        x_10 = torch.conv2d(
            cat,
            l_self_modules_decode_head_modules_conv_cat_modules_conv_parameters_weight_,
        ...
        x_11 = None
        feat = torch.nn.functional.dropout2d(x_12, 0.1, False, False)
        x_12 = None
