...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        L_self_modules_decode_head_modules_cca_modules_query_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cca_modules_query_conv_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cca_modules_key_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cca_modules_key_conv_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cca_modules_value_conv_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cca_modules_value_conv_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_decode_head_modules_cca_modules_gamma_parameters_scale_: torch.nn.parameter.Parameter,
        ...
        l_self_modules_decode_head_modules_cca_modules_key_conv_parameters_bias_ = (
            L_self_modules_decode_head_modules_cca_modules_key_conv_parameters_bias_
        )
        ...
        einsum = torch.functional.einsum("bchw,bciw->bwhi", query, key)
        tensor = torch.tensor(-inf)
        to = tensor.to(device(type="cuda", index=0))
        tensor = None
        repeat = to.repeat(64)
        to = None
        diag = torch.diag(repeat, 0)
        repeat = None
        energy_H = einsum + diag
        einsum = diag = None
        energy_H_1 = energy_H.transpose(1, 2)
        energy_H = None
        energy_W = torch.functional.einsum("bchw,bchj->bhwj", query, key)
        query = key = None
        cat = torch.cat([energy_H_1, energy_W], dim=-1)
        energy_H_1 = energy_W = None
        attn = torch.nn.functional.softmax(cat, dim=-1)
        cat = None
        getitem = attn[(Ellipsis, slice(None, 64, None))]
        out_330 = torch.functional.einsum("bciw,bhwi->bchw", value, getitem)
        getitem = None
        getitem_1 = attn[(Ellipsis, slice(64, None, None))]
        attn = None
        einsum_3 = torch.functional.einsum("bchj,bhwj->bchw", value, getitem_1)
        value = getitem_1 = None
        out_330 += einsum_3
        out_331 = out_330
        out_330 = einsum_3 = None
        mul = (
            out_331
            * l_self_modules_decode_head_modules_cca_modules_gamma_parameters_scale_
        )
        ...
        out_332 = mul + x_3
        mul = x_3 = None
        out_333 = out_332.contiguous()
        out_332 = None
        query_1 = torch.conv2d(
            out_333,
            l_self_modules_decode_head_modules_cca_modules_query_conv_parameters_weight_,
            l_self_modules_decode_head_modules_cca_modules_query_conv_parameters_bias_,
            (1, 1),
        ...
        einsum_4 = torch.functional.einsum("bchw,bciw->bwhi", query_1, key_1)
        tensor_1 = torch.tensor(-inf)
        to_1 = tensor_1.to(device(type="cuda", index=0))
        tensor_1 = None
        repeat_1 = to_1.repeat(64)
        to_1 = None
        diag_1 = torch.diag(repeat_1, 0)
        repeat_1 = None
        energy_H_2 = einsum_4 + diag_1
        einsum_4 = diag_1 = None
        energy_H_3 = energy_H_2.transpose(1, 2)
        energy_H_2 = None
        energy_W_1 = torch.functional.einsum("bchw,bchj->bhwj", query_1, key_1)
        query_1 = key_1 = None
        cat_1 = torch.cat([energy_H_3, energy_W_1], dim=-1)
        energy_H_3 = energy_W_1 = None
        attn_1 = torch.nn.functional.softmax(cat_1, dim=-1)
        cat_1 = None
        getitem_2 = attn_1[(Ellipsis, slice(None, 64, None))]
        out_334 = torch.functional.einsum("bciw,bhwi->bchw", value_1, getitem_2)
        getitem_2 = None
        getitem_3 = attn_1[(Ellipsis, slice(64, None, None))]
        attn_1 = None
        einsum_7 = torch.functional.einsum("bchj,bhwj->bchw", value_1, getitem_3)
        value_1 = getitem_3 = None
        out_334 += einsum_7
        out_335 = out_334
        out_334 = einsum_7 = None
        mul_1 = (
            out_335
            * l_self_modules_decode_head_modules_cca_modules_gamma_parameters_scale_
        )
        ...
        out_336 = mul_1 + out_333
        mul_1 = out_333 = None
        out_337 = out_336.contiguous()
        out_336 = None
        x_4 = torch.conv2d(
            out_337,
        ...
        out_337 = l_self_modules_decode_head_modules_convs_modules_1_modules_conv_parameters_weight_ = (None)
        ...
        x_5 = None
        cat_2 = torch.cat([out_329, x_6], dim=1)
        out_329 = x_6 = None
        x_7 = torch.conv2d(
            cat_2,
            l_self_modules_decode_head_modules_conv_cat_modules_conv_parameters_weight_,
