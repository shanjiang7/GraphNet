...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        x_201 = l_self_modules_decode_head_modules_convs_modules_1_modules_conv_parameters_weight_ = (None)
        ...
        x_202 = l_self_modules_decode_head_modules_convs_modules_1_modules_bn_buffers_running_mean_ = l_self_modules_decode_head_modules_convs_modules_1_modules_bn_buffers_running_var_ = l_self_modules_decode_head_modules_convs_modules_1_modules_bn_parameters_weight_ = l_self_modules_decode_head_modules_convs_modules_1_modules_bn_parameters_bias_ = (None)
        x_204 = torch.nn.functional.relu(x_203, inplace=True)
        x_203 = None
        cat = torch.cat([out_297, x_204], dim=1)
        out_297 = x_204 = None
        x_205 = torch.conv2d(
            cat,
            l_self_modules_decode_head_modules_conv_cat_modules_conv_parameters_weight_,
        ...
        x_206 = None
        feat = torch.nn.functional.dropout2d(x_207, 0.1, False, False)
        x_207 = None
        output = torch.conv2d(
            feat,
            l_self_modules_decode_head_modules_conv_seg_parameters_weight_,
