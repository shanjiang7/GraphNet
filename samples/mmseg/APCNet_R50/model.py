...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        out_158 = None
        pooled_x = torch.nn.functional.adaptive_avg_pool2d(out_159, 1)
        x_1 = torch.conv2d(
            out_159,
        ...
        permute_1 = conv2d_58.permute(0, 2, 3, 1)
        conv2d_58 = None
        ...
        x_14 = None
        pooled_x_2 = torch.nn.functional.adaptive_avg_pool2d(out_159, 2)
        x_16 = torch.conv2d(
            out_159,
        ...
        permute_4 = conv2d_64.permute(0, 2, 3, 1)
        conv2d_64 = None
        ...
        x_29 = None
        pooled_x_4 = torch.nn.functional.adaptive_avg_pool2d(out_159, 3)
        x_31 = torch.conv2d(
            out_159,
        ...
        permute_7 = conv2d_70.permute(0, 2, 3, 1)
        conv2d_70 = None
        ...
        x_44 = None
        pooled_x_6 = torch.nn.functional.adaptive_avg_pool2d(out_159, 6)
        x_46 = torch.conv2d(
            out_159,
        ...
        permute_10 = conv2d_76.permute(0, 2, 3, 1)
        conv2d_76 = None
        ...
        x_59 = None
        acm_outs = torch.cat([out_159, x_15, x_30, x_45, x_60], dim=1)
        out_159 = x_15 = x_30 = x_45 = x_60 = None
        x_61 = torch.conv2d(
            acm_outs,
