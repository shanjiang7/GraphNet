...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        out_160 = torch.functional.einsum("bciw,bhwi->bchw", value, getitem)
        getitem = None
        ...
        out_164 = torch.functional.einsum("bciw,bhwi->bchw", value_1, getitem_2)
        getitem_2 = None
        ...
        out_167 = l_self_modules_decode_head_modules_convs_modules_1_modules_conv_parameters_weight_ = (None)
        ...
        x_5 = None
        cat_2 = torch.cat([out_159, x_6], dim=1)
        out_159 = x_6 = None
        x_7 = torch.conv2d(
            cat_2,
            l_self_modules_decode_head_modules_conv_cat_modules_conv_parameters_weight_,
