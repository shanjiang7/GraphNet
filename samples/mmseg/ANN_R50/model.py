...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        out_129 = l_self_modules_decode_head_modules_fusion_modules_stages_modules_0_modules_value_project_parameters_weight_ = l_self_modules_decode_head_modules_fusion_modules_stages_modules_0_modules_value_project_parameters_bias_ = (None)
        ...
        stack = None
        cat_2 = torch.cat([context_4, out_159], 1)
        context_4 = out_159 = None
        x_7 = torch.conv2d(
            cat_2,
