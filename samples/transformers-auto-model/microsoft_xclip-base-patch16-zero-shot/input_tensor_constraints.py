...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 32, 512], "L_self_modules_mit_parameters_position_embedding_"),
    (
        [512, 512],
    ...
    ([1, 197], "L_self_modules_vision_model_modules_embeddings_buffers_position_ids_"),
    (
        [768, 3, 16, 16],
