...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        hidden_state_1 = hidden_state.reshape(1, 24, 24, 1024)
        hidden_state = None
        ...
        input_2 = None
        hidden_state_4 = permute_2.reshape((1, 1024, 24, 24))
        permute_2 = None
        ...
        hidden_state_8 = hidden_state_7.reshape(1, 24, 24, 1024)
        hidden_state_7 = None
        ...
        input_4 = None
        hidden_state_11 = permute_5.reshape((1, 1024, 24, 24))
        permute_5 = None
        ...
        hidden_state_15 = hidden_state_14.reshape(1, 24, 24, 1024)
        ...
        input_6 = None
        hidden_state_18 = permute_8.reshape((1, 1024, 24, 24))
        permute_8 = None
        ...
        hidden_state_21 = hidden_state_20.reshape(1, 24, 24, 1024)
        ...
        input_8 = None
        hidden_state_24 = permute_11.reshape((1, 1024, 24, 24))
        permute_11 = None
