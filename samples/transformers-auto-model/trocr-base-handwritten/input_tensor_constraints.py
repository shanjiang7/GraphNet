...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 1, 768], "L_self_modules_encoder_modules_embeddings_parameters_cls_token_"),
    (
        [1, 577, 768],
    ...
    ([768], "L_self_modules_encoder_modules_layernorm_parameters_bias_"),
    ([768], "L_self_modules_encoder_modules_layernorm_parameters_weight_"),
    ([768], "L_self_modules_encoder_modules_pooler_modules_dense_parameters_bias_"),
    (
        [768, 768],
