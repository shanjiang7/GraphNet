...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        causal_mask = None
        arange_1 = torch.arange(15, device=device(type="cuda", index=0))
        ...
        arange_2 = torch.arange(
            14, dtype=torch.int64, device=device(type="cuda", index=0)
        )
        ...
        position_bias_2 = torch.zeros(
            (1, 12, 14, 14), device=device(type="cuda", index=0), dtype=torch.float32
        )
