...
dynamic_dim_constraint_input_shapes = [
    ...
    ([128], "L_self_modules_bert_modules_pooler_modules_dense_parameters_bias_"),
    ([128, 128], "L_self_modules_bert_modules_pooler_modules_dense_parameters_weight_"),
    ([1], "L_self_modules_classifier_parameters_bias_"),
    ([1, 128], "L_self_modules_classifier_parameters_weight_"),
