...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        attn_output = None
        attn_output_2 = attn_output_1.reshape(2, 34, 128)
        attn_output_1 = None
        ...
        attn_output_3 = None
        attn_output_5 = attn_output_4.reshape(2, 34, 128)
        attn_output_4 = None
