...
dynamic_dim_constraint_input_shapes = [
    ([1, 21], "L_kwargs_attention_mask_"),
    ([1, 21], "L_kwargs_input_ids_"),
    ([32000, 3200], "L_self_modules_lm_head_parameters_weight_"),
    ([32000, 3200], "L_self_modules_model_modules_embed_tokens_parameters_weight_"),
    (
        [3200],
    ...
    ([3200], "L_self_modules_model_modules_norm_parameters_weight_"),
    ([50], "L_self_modules_model_modules_rotary_emb_buffers_inv_freq_"),
]
