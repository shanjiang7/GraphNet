...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 1, 192], "L_self_modules_embeddings_parameters_cls_token_"),
    ([1, 100, 192], "L_self_modules_embeddings_parameters_detection_tokens_"),
    ([1, 4251, 192], "L_self_modules_embeddings_parameters_position_embeddings_"),
    (
        [192],
