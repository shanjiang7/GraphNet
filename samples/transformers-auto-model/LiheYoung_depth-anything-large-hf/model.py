...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        hidden_state_1 = hidden_state.reshape(1, 37, 37, 1024)
        hidden_state = None
        ...
        hidden_state_6 = hidden_state_5.reshape(1, 37, 37, 1024)
        hidden_state_5 = None
        ...
        hidden_state_11 = hidden_state_10.reshape(1, 37, 37, 1024)
        ...
        hidden_state_15 = hidden_state_14.reshape(1, 37, 37, 1024)
        ...
        relu_15 = torch.nn.functional.relu(predicted_depth_4, inplace=False)
        predicted_depth_4 = None
        predicted_depth_5 = relu_15 * 1
        relu_15 = None
