...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        hidden_state_1 = hidden_state.reshape(1, 54, 54, 1024)
        hidden_state = None
        ...
        hidden_state_6 = hidden_state_5.reshape(1, 54, 54, 1024)
        hidden_state_5 = None
        ...
        hidden_state_11 = hidden_state_10.reshape(1, 54, 54, 1024)
        ...
        hidden_state_15 = hidden_state_14.reshape(1, 54, 54, 1024)
        ...
        hidden_state_25 = torch.nn.functional.interpolate(
            hidden_state_24, size=(54, 54), mode="bilinear", align_corners=True
        )
        ...
        hidden_state_38 = torch.nn.functional.interpolate(
            hidden_state_37, size=(108, 108), mode="bilinear", align_corners=True
        )
        ...
        hidden_state_51 = torch.nn.functional.interpolate(
            hidden_state_50, size=(216, 216), mode="bilinear", align_corners=True
        )
        ...
        predicted_depth_1 = torch.nn.functional.interpolate(
            predicted_depth, (756, 756), mode="bilinear", align_corners=True
        )
        ...
        predicted_depth_5 = torch.sigmoid(predicted_depth_4)
