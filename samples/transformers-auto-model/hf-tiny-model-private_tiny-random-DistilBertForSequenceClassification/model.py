...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        transpose_3 = None
        attn_output_1 = contiguous.view(1, -1, 32)
        contiguous = None
        ...
        transpose_7 = None
        attn_output_4 = contiguous_1.view(1, -1, 32)
        contiguous_1 = None
        ...
        transpose_11 = None
        attn_output_7 = contiguous_2.view(1, -1, 32)
        contiguous_2 = None
        ...
        transpose_15 = None
        attn_output_10 = contiguous_3.view(1, -1, 32)
        contiguous_3 = None
