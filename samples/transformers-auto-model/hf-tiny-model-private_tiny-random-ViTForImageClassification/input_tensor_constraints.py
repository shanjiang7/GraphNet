...
dynamic_dim_constraint_input_shapes = [
    ...
    ([2, 32], "L_self_modules_classifier_parameters_weight_"),
    ...
    ([1, 1, 32], "L_self_modules_vit_modules_embeddings_parameters_cls_token_"),
    (
        [1, 226, 32],
    ...
    ([32], "L_self_modules_vit_modules_layernorm_parameters_bias_"),
    ([32], "L_self_modules_vit_modules_layernorm_parameters_weight_"),
]
