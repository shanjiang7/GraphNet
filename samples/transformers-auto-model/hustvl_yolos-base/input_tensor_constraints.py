...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 100, 768], "L_self_modules_embeddings_parameters_detection_tokens_"),
    ([1, 4301, 768], "L_self_modules_embeddings_parameters_position_embeddings_"),
    (
        [768],
    ...
    ([11, 1, 4301, 768], "L_self_modules_encoder_parameters_mid_position_embeddings_"),
