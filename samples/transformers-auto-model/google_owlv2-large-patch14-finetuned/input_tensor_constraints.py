...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 5185], "L_self_modules_vision_model_modules_embeddings_buffers_position_ids_"),
    (
        [1024, 3, 14, 14],
    ...
    ([1024], "L_self_modules_vision_model_modules_pre_layernorm_parameters_bias_"),
    ([1024], "L_self_modules_vision_model_modules_pre_layernorm_parameters_weight_"),
