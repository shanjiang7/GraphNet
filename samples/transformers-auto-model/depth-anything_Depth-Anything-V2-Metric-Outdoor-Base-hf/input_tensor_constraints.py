...
dynamic_dim_constraint_input_shapes = [
    ([64], "L_self_modules_head_modules_conv1_parameters_bias_"),
    ([64, 128, 3, 3], "L_self_modules_head_modules_conv1_parameters_weight_"),
    ([32], "L_self_modules_head_modules_conv2_parameters_bias_"),
    ([32, 64, 3, 3], "L_self_modules_head_modules_conv2_parameters_weight_"),
    ([1], "L_self_modules_head_modules_conv3_parameters_bias_"),
    ([1, 32, 1, 1], "L_self_modules_head_modules_conv3_parameters_weight_"),
    ([128, 96, 3, 3], "L_self_modules_neck_modules_convs_modules_0_parameters_weight_"),
    (
        [128, 192, 3, 3],
    ...
    ([S0, 1370, 768], "L_stack0_feature_maps_0_"),
    ([S0, 1370, 768], "L_stack0_feature_maps_1_"),
    ([S0, 1370, 768], "L_stack0_feature_maps_2_"),
    ([S0, 1370, 768], "L_stack0_feature_maps_3_"),
]
