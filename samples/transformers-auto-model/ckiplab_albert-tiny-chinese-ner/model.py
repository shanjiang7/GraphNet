...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        attention_output_2 = attention_output_1.reshape(1, 18, 312)
        ...
        projected_context_layer_dropout = torch.nn.functional.dropout(
            projected_context_layer, 0.0, False, False
        )
        ...
        attention_output_5 = attention_output_4.reshape(1, 18, 312)
        ...
        projected_context_layer_dropout_1 = torch.nn.functional.dropout(
            projected_context_layer_1, 0.0, False, False
        )
        ...
        attention_output_8 = attention_output_7.reshape(1, 18, 312)
        ...
        projected_context_layer_dropout_2 = torch.nn.functional.dropout(
            projected_context_layer_2, 0.0, False, False
        )
        ...
        attention_output_11 = attention_output_10.reshape(1, 18, 312)
        ...
        projected_context_layer_dropout_3 = torch.nn.functional.dropout(
            projected_context_layer_3, 0.0, False, False
        )
