...
dynamic_dim_constraint_symbol2example_value = {S0: 2, S1: 10}
...
dynamic_dim_constraint_input_shapes = [
    ...
    ([], "L_self_modules_fc_norm_eps"),
    ([32], "L_self_modules_fc_norm_parameters_bias_"),
    ([32], "L_self_modules_fc_norm_parameters_weight_"),
    (
        [32],
    ...
    ([1, 25, 32], "L_self_modules_videomae_modules_embeddings_position_embeddings"),
    (
        [32, 32],
