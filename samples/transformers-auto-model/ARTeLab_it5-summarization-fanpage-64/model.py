...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        cache_position = torch.arange(0, 24, device=device(type="cuda", index=0))
        ...
        causal_mask = None
        arange_1 = torch.arange(25, device=device(type="cuda", index=0))
        ...
        arange_2 = torch.arange(
            24, dtype=torch.int64, device=device(type="cuda", index=0)
        )
        ...
        position_bias_2 = torch.zeros(
            (1, 12, 24, 24), device=device(type="cuda", index=0), dtype=torch.float32
        )
