...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view = mixed_query_layer.view(1, -1, 2, 64)
        query_layer = view.transpose(1, 2)
        view = None
        view_1 = mixed_key_layer.view(1, -1, 2, 64)
        mixed_key_layer = None
        key_layer = view_1.transpose(1, 2)
        view_1 = None
        view_2 = mixed_value_layer.view(1, -1, 2, 64)
        ...
        conv_out_layer_1 = torch.reshape(conv_out_layer, [1, -1, 128])
        conv_out_layer = None
        ...
        conv_out_layer_4 = transpose_6.reshape(1, -1, 128, 9)
        transpose_6 = None
        ...
        conv_out_layer_7 = torch.reshape(conv_out_layer_6, [-1, 128])
        ...
        view_4 = mixed_query_layer_1.view(1, -1, 2, 64)
        query_layer_1 = view_4.transpose(1, 2)
        view_4 = None
        view_5 = mixed_key_layer_1.view(1, -1, 2, 64)
        mixed_key_layer_1 = None
        key_layer_1 = view_5.transpose(1, 2)
        view_5 = None
        view_6 = mixed_value_layer_1.view(1, -1, 2, 64)
        ...
        conv_out_layer_9 = torch.reshape(conv_out_layer_8, [1, -1, 128])
        ...
        conv_out_layer_12 = transpose_14.reshape(1, -1, 128, 9)
        transpose_14 = None
        ...
        conv_out_layer_15 = torch.reshape(conv_out_layer_14, [-1, 128])
        ...
        view_8 = mixed_query_layer_2.view(1, -1, 2, 64)
        query_layer_2 = view_8.transpose(1, 2)
        view_8 = None
        view_9 = mixed_key_layer_2.view(1, -1, 2, 64)
        mixed_key_layer_2 = None
        key_layer_2 = view_9.transpose(1, 2)
        view_9 = None
        view_10 = mixed_value_layer_2.view(1, -1, 2, 64)
        ...
        conv_out_layer_17 = torch.reshape(conv_out_layer_16, [1, -1, 128])
        ...
        conv_out_layer_20 = transpose_22.reshape(1, -1, 128, 9)
        transpose_22 = None
        ...
        conv_out_layer_23 = torch.reshape(conv_out_layer_22, [-1, 128])
        ...
        view_12 = mixed_query_layer_3.view(1, -1, 2, 64)
        query_layer_3 = view_12.transpose(1, 2)
        view_12 = None
        view_13 = mixed_key_layer_3.view(1, -1, 2, 64)
        mixed_key_layer_3 = None
        key_layer_3 = view_13.transpose(1, 2)
        view_13 = None
        view_14 = mixed_value_layer_3.view(1, -1, 2, 64)
        ...
        conv_out_layer_25 = torch.reshape(conv_out_layer_24, [1, -1, 128])
        ...
        conv_out_layer_28 = transpose_30.reshape(1, -1, 128, 9)
        transpose_30 = None
        ...
        conv_out_layer_31 = torch.reshape(conv_out_layer_30, [-1, 128])
        ...
        view_16 = mixed_query_layer_4.view(1, -1, 2, 64)
        query_layer_4 = view_16.transpose(1, 2)
        view_16 = None
        view_17 = mixed_key_layer_4.view(1, -1, 2, 64)
        mixed_key_layer_4 = None
        key_layer_4 = view_17.transpose(1, 2)
        view_17 = None
        view_18 = mixed_value_layer_4.view(1, -1, 2, 64)
        ...
        conv_out_layer_33 = torch.reshape(conv_out_layer_32, [1, -1, 128])
        ...
        conv_out_layer_36 = transpose_38.reshape(1, -1, 128, 9)
        transpose_38 = None
        ...
        conv_out_layer_39 = torch.reshape(conv_out_layer_38, [-1, 128])
        ...
        transpose_40 = hidden_states_40.transpose(1, 2)
        x_15 = torch.conv1d(
            transpose_40,
        ...
        view_20 = mixed_query_layer_5.view(1, -1, 2, 64)
        query_layer_5 = view_20.transpose(1, 2)
        view_20 = None
        view_21 = mixed_key_layer_5.view(1, -1, 2, 64)
        mixed_key_layer_5 = None
        key_layer_5 = view_21.transpose(1, 2)
        view_21 = None
        view_22 = mixed_value_layer_5.view(1, -1, 2, 64)
        ...
        conv_out_layer_41 = torch.reshape(conv_out_layer_40, [1, -1, 128])
        ...
        conv_out_layer_44 = transpose_46.reshape(1, -1, 128, 9)
        transpose_46 = None
        ...
        conv_out_layer_47 = torch.reshape(conv_out_layer_46, [-1, 128])
        ...
        add_18 = hidden_states_42 + hidden_states_40
        ...
        add_19 = hidden_states_47 + hidden_states_43
        ...
        transpose_48 = hidden_states_48.transpose(1, 2)
        x_18 = torch.conv1d(
            transpose_48,
        ...
        view_24 = mixed_query_layer_6.view(1, -1, 2, 64)
        query_layer_6 = view_24.transpose(1, 2)
        view_24 = None
        view_25 = mixed_key_layer_6.view(1, -1, 2, 64)
        mixed_key_layer_6 = None
        key_layer_6 = view_25.transpose(1, 2)
        view_25 = None
        view_26 = mixed_value_layer_6.view(1, -1, 2, 64)
        ...
        conv_out_layer_49 = torch.reshape(conv_out_layer_48, [1, -1, 128])
        ...
        conv_out_layer_52 = transpose_54.reshape(1, -1, 128, 9)
        transpose_54 = None
        ...
        conv_out_layer_55 = torch.reshape(conv_out_layer_54, [-1, 128])
        ...
        add_21 = hidden_states_50 + hidden_states_48
        ...
        add_22 = hidden_states_55 + hidden_states_51
        ...
        transpose_56 = hidden_states_56.transpose(1, 2)
        x_21 = torch.conv1d(
            transpose_56,
        ...
        view_28 = mixed_query_layer_7.view(1, -1, 2, 64)
        query_layer_7 = view_28.transpose(1, 2)
        view_28 = None
        view_29 = mixed_key_layer_7.view(1, -1, 2, 64)
        mixed_key_layer_7 = None
        key_layer_7 = view_29.transpose(1, 2)
        view_29 = None
        view_30 = mixed_value_layer_7.view(1, -1, 2, 64)
        ...
        conv_out_layer_57 = torch.reshape(conv_out_layer_56, [1, -1, 128])
        ...
        conv_out_layer_60 = transpose_62.reshape(1, -1, 128, 9)
        transpose_62 = None
        ...
        conv_out_layer_63 = torch.reshape(conv_out_layer_62, [-1, 128])
        ...
        add_24 = hidden_states_58 + hidden_states_56
        ...
        add_25 = hidden_states_63 + hidden_states_59
        ...
        transpose_64 = hidden_states_64.transpose(1, 2)
        x_24 = torch.conv1d(
            transpose_64,
        ...
        view_32 = mixed_query_layer_8.view(1, -1, 2, 64)
        query_layer_8 = view_32.transpose(1, 2)
        view_32 = None
        view_33 = mixed_key_layer_8.view(1, -1, 2, 64)
        mixed_key_layer_8 = None
        key_layer_8 = view_33.transpose(1, 2)
        view_33 = None
        view_34 = mixed_value_layer_8.view(1, -1, 2, 64)
        ...
        conv_out_layer_65 = torch.reshape(conv_out_layer_64, [1, -1, 128])
        ...
        conv_out_layer_68 = transpose_70.reshape(1, -1, 128, 9)
        transpose_70 = None
        ...
        conv_out_layer_71 = torch.reshape(conv_out_layer_70, [-1, 128])
        ...
        add_27 = hidden_states_66 + hidden_states_64
        ...
        add_28 = hidden_states_71 + hidden_states_67
        ...
        transpose_72 = hidden_states_72.transpose(1, 2)
        x_27 = torch.conv1d(
            transpose_72,
        ...
        view_36 = mixed_query_layer_9.view(1, -1, 2, 64)
        query_layer_9 = view_36.transpose(1, 2)
        view_36 = None
        view_37 = mixed_key_layer_9.view(1, -1, 2, 64)
        mixed_key_layer_9 = None
        key_layer_9 = view_37.transpose(1, 2)
        view_37 = None
        view_38 = mixed_value_layer_9.view(1, -1, 2, 64)
        ...
        conv_out_layer_73 = torch.reshape(conv_out_layer_72, [1, -1, 128])
        ...
        conv_out_layer_76 = transpose_78.reshape(1, -1, 128, 9)
        transpose_78 = None
        ...
        conv_out_layer_79 = torch.reshape(conv_out_layer_78, [-1, 128])
        ...
        add_30 = hidden_states_74 + hidden_states_72
        ...
        add_31 = hidden_states_79 + hidden_states_75
        ...
        transpose_80 = hidden_states_80.transpose(1, 2)
        x_30 = torch.conv1d(
            transpose_80,
        ...
        view_40 = mixed_query_layer_10.view(1, -1, 2, 64)
        query_layer_10 = view_40.transpose(1, 2)
        view_40 = None
        view_41 = mixed_key_layer_10.view(1, -1, 2, 64)
        mixed_key_layer_10 = None
        key_layer_10 = view_41.transpose(1, 2)
        view_41 = None
        view_42 = mixed_value_layer_10.view(1, -1, 2, 64)
        ...
        conv_out_layer_81 = torch.reshape(conv_out_layer_80, [1, -1, 128])
        ...
        conv_out_layer_84 = transpose_86.reshape(1, -1, 128, 9)
        transpose_86 = None
        ...
        conv_out_layer_87 = torch.reshape(conv_out_layer_86, [-1, 128])
        ...
        add_33 = hidden_states_82 + hidden_states_80
        ...
        add_34 = hidden_states_87 + hidden_states_83
        ...
        transpose_88 = hidden_states_88.transpose(1, 2)
        x_33 = torch.conv1d(
            transpose_88,
        ...
        view_44 = mixed_query_layer_11.view(1, -1, 2, 64)
        query_layer_11 = view_44.transpose(1, 2)
        view_44 = None
        view_45 = mixed_key_layer_11.view(1, -1, 2, 64)
        mixed_key_layer_11 = None
        key_layer_11 = view_45.transpose(1, 2)
        view_45 = None
        view_46 = mixed_value_layer_11.view(1, -1, 2, 64)
        ...
        conv_out_layer_89 = torch.reshape(conv_out_layer_88, [1, -1, 128])
        ...
        conv_out_layer_92 = transpose_94.reshape(1, -1, 128, 9)
        transpose_94 = None
        ...
        conv_out_layer_95 = torch.reshape(conv_out_layer_94, [-1, 128])
        ...
        add_36 = hidden_states_90 + hidden_states_88
        ...
        add_37 = hidden_states_95 + hidden_states_91
