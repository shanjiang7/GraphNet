...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 19], "L_input_ids_"),
    ([2050, 1024], "L_self_modules_model_modules_embed_positions_buffers_weights_"),
    ([50261, 1024], "L_self_modules_model_modules_embed_tokens_parameters_weight_"),
    ([1024], "L_self_modules_model_modules_layer_norm_parameters_bias_"),
    ([1024], "L_self_modules_model_modules_layer_norm_parameters_weight_"),
    (
        [4096],
