...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 10, 32], "L_self_modules_embeddings_parameters_detection_tokens_"),
    ([1, 236, 32], "L_self_modules_embeddings_parameters_position_embeddings_"),
    (
        [32],
    ...
    ([4, 1, 236, 32], "L_self_modules_encoder_parameters_mid_position_embeddings_"),
