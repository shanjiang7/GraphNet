...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        input_ids = None
        cache_position = torch.arange(0, 27, device=device(type="cpu"))
        ...
        attention_mask = None
        kv_arange = torch.arange(27, device=device(type="cpu"))
        kv_arange += 0
        ...
        result_1 = to_3 = None
        batched_outputs = torch._C._functorch._remove_batch_dim(result_2, 4, 27, 0)
        result_2 = None
