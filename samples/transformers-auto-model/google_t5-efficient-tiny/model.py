...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view = query_states.view(1, -1, 4, 64)
        query_states = None
        ...
        view_1 = key_states.view(1, -1, 4, 64)
        key_states = None
        key_states_1 = view_1.transpose(1, 2)
        view_1 = None
        view_2 = value_states.view(1, -1, 4, 64)
        value_states = None
        ...
        transpose_4 = None
        attn_output_2 = attn_output_1.view(1, -1, 256)
        attn_output_1 = None
        ...
        view_4 = query_states_2.view(1, -1, 4, 64)
        query_states_2 = None
        ...
        view_5 = key_states_2.view(1, -1, 4, 64)
        key_states_2 = None
        key_states_3 = view_5.transpose(1, 2)
        view_5 = None
        view_6 = value_states_2.view(1, -1, 4, 64)
        value_states_2 = None
        ...
        position_bias_2 = torch.zeros(
            (1, 4, 12, 12), device=device(type="cuda", index=0), dtype=torch.float32
        )
        ...
        transpose_9 = None
        attn_output_6 = attn_output_5.view(1, -1, 256)
        attn_output_5 = None
        ...
        view_8 = query_states_4.view(1, -1, 4, 64)
        query_states_4 = None
        ...
        view_9 = key_states_4.view(1, -1, 4, 64)
        key_states_4 = None
        key_states_5 = view_9.transpose(1, 2)
        view_9 = None
        view_10 = value_states_4.view(1, -1, 4, 64)
        value_states_4 = None
        ...
        transpose_14 = None
        attn_output_10 = attn_output_9.view(1, -1, 256)
        attn_output_9 = None
        ...
        view_12 = query_states_6.view(1, -1, 4, 64)
        query_states_6 = None
        ...
        view_13 = key_states_6.view(1, -1, 4, 64)
        key_states_6 = None
        key_states_7 = view_13.transpose(1, 2)
        view_13 = None
        view_14 = value_states_6.view(1, -1, 4, 64)
        value_states_6 = None
        ...
        transpose_19 = None
        attn_output_14 = attn_output_13.view(1, -1, 256)
        attn_output_13 = None
        ...
        view_16 = query_states_8.view(1, -1, 4, 64)
        query_states_8 = None
        ...
        view_17 = key_states_8.view(1, -1, 4, 64)
        key_states_8 = None
        key_states_9 = view_17.transpose(1, 2)
        view_17 = None
        view_18 = value_states_8.view(1, -1, 4, 64)
        value_states_8 = None
        ...
        transpose_24 = None
        attn_output_18 = attn_output_17.view(1, -1, 256)
        attn_output_17 = None
        ...
        view_20 = query_states_10.view(1, -1, 4, 64)
        ...
        view_21 = key_states_10.view(1, -1, 4, 64)
        key_states_10 = None
        key_states_11 = view_21.transpose(1, 2)
        view_21 = None
        view_22 = value_states_10.view(1, -1, 4, 64)
        ...
        transpose_29 = None
        attn_output_22 = attn_output_21.view(1, -1, 256)
        attn_output_21 = None
        ...
        view_24 = query_states_12.view(1, -1, 4, 64)
        ...
        view_25 = key_states_12.view(1, -1, 4, 64)
        key_states_12 = None
        key_states_13 = view_25.transpose(1, 2)
        view_25 = None
        view_26 = value_states_12.view(1, -1, 4, 64)
        ...
        transpose_34 = None
        attn_output_26 = attn_output_25.view(1, -1, 256)
        attn_output_25 = None
        ...
        view_28 = query_states_14.view(1, -1, 4, 64)
        ...
        view_29 = key_states_14.view(1, -1, 4, 64)
        key_states_14 = None
        key_states_15 = view_29.transpose(1, 2)
        view_29 = None
        view_30 = value_states_14.view(1, -1, 4, 64)
        ...
        transpose_39 = None
        attn_output_30 = attn_output_29.view(1, -1, 256)
        attn_output_29 = None
        ...
        hidden_states_38 = (
            l_self_modules_final_layer_norm_parameters_weight_ * hidden_states_37
        )
        l_self_modules_final_layer_norm_parameters_weight_ = hidden_states_37 = None
