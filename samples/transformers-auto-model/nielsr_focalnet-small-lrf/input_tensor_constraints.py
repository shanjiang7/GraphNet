...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1000, 768], "L_self_modules_classifier_parameters_weight_"),
    ([96], "L_self_modules_focalnet_modules_embeddings_modules_norm_parameters_bias_"),
    (
        [96],
    ...
    ([768], "L_self_modules_focalnet_modules_layernorm_parameters_bias_"),
    ([768], "L_self_modules_focalnet_modules_layernorm_parameters_weight_"),
]
