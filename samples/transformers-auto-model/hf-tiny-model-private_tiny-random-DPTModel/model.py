...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        posemb_tok = l_self_modules_embeddings_parameters_position_embeddings_[
            (slice(None, None, None), slice(None, 1, None))
        ]
        posemb_grid = l_self_modules_embeddings_parameters_position_embeddings_[
            (0, slice(1, None, None))
        ]
        l_self_modules_embeddings_parameters_position_embeddings_ = None
        reshape = posemb_grid.reshape(1, 2, 2, -1)
        posemb_grid = None
        posemb_grid_1 = reshape.permute(0, 3, 1, 2)
        reshape = None
        posemb_grid_2 = torch.nn.functional.interpolate(
            posemb_grid_1, size=(2, 2), mode="bilinear"
        )
        posemb_grid_1 = None
        permute_1 = posemb_grid_2.permute(0, 2, 3, 1)
        posemb_grid_2 = None
        posemb_grid_3 = permute_1.reshape(1, 4, -1)
        permute_1 = None
        posemb = torch.cat([posemb_tok, posemb_grid_3], dim=1)
        posemb_tok = posemb_grid_3 = None
        conv2d = torch.conv2d(
            l_pixel_values_,
        ...
        embeddings_2 = embeddings_1 + posemb
        embeddings_1 = posemb = None
        ...
        transpose_4 = None
        context_layer = attn_output_1.reshape((1, 5, 32))
        attn_output_1 = None
        ...
        transpose_8 = None
        context_layer_1 = attn_output_3.reshape((1, 5, 32))
        attn_output_3 = None
        ...
        transpose_12 = None
        context_layer_2 = attn_output_5.reshape((1, 5, 32))
        attn_output_5 = None
        ...
        transpose_16 = None
        context_layer_3 = attn_output_7.reshape((1, 5, 32))
        attn_output_7 = None
