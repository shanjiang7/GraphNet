...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        embeddings_3 = torch.nn.functional.dropout(embeddings_2, 0.144, False, False)
        embeddings_2 = None
        ...
        attn_output = None
        attn_output_2 = attn_output_1.reshape(1, 16, 384)
        attn_output_1 = None
        ...
        hidden_states_1 = torch.nn.functional.dropout(
            hidden_states, 0.144, False, False
        )
        hidden_states = None
        ...
        hidden_states_6 = torch.nn.functional.dropout(
            hidden_states_5, 0.144, False, False
        )
        ...
        attn_output_3 = None
        attn_output_5 = attn_output_4.reshape(1, 16, 384)
        attn_output_4 = None
        ...
        hidden_states_9 = torch.nn.functional.dropout(
            hidden_states_8, 0.144, False, False
        )
        ...
        hidden_states_14 = torch.nn.functional.dropout(
            hidden_states_13, 0.144, False, False
        )
        ...
        attn_output_6 = None
        attn_output_8 = attn_output_7.reshape(1, 16, 384)
        attn_output_7 = None
        ...
        hidden_states_17 = torch.nn.functional.dropout(
            hidden_states_16, 0.144, False, False
        )
        ...
        hidden_states_22 = torch.nn.functional.dropout(
            hidden_states_21, 0.144, False, False
        )
