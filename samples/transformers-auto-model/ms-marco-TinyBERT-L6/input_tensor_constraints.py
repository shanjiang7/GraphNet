...
dynamic_dim_constraint_input_shapes = [
    ...
    ([768], "L_self_modules_bert_modules_pooler_modules_dense_parameters_bias_"),
    ([768, 768], "L_self_modules_bert_modules_pooler_modules_dense_parameters_weight_"),
    ([1], "L_self_modules_classifier_parameters_bias_"),
    ([1, 768], "L_self_modules_classifier_parameters_weight_"),
