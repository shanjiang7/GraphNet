...
class Program_weight_tensor_meta_L_self_modules_embeddings_modules_x_position_embeddings_parameters_weight_:
    name = "L_self_modules_embeddings_modules_x_position_embeddings_parameters_weight_"
    shape = [1024, 768]
    dtype = "torch.float32"
    device = "cuda:0"
    mean = 0.000
...
class Program_weight_tensor_meta_L_self_modules_embeddings_modules_y_position_embeddings_parameters_weight_:
    name = "L_self_modules_embeddings_modules_y_position_embeddings_parameters_weight_"
    shape = [1024, 768]
    dtype = "torch.float32"
    device = "cuda:0"
    mean = 0.000
...
class Program_weight_tensor_meta_L_self_modules_embeddings_modules_h_position_embeddings_parameters_weight_:
    name = "L_self_modules_embeddings_modules_h_position_embeddings_parameters_weight_"
    shape = [1024, 768]
    dtype = "torch.float32"
    device = "cuda:0"
    mean = -0.000
...
class Program_weight_tensor_meta_L_self_modules_embeddings_modules_w_position_embeddings_parameters_weight_:
    name = "L_self_modules_embeddings_modules_w_position_embeddings_parameters_weight_"
    shape = [1024, 768]
    dtype = "torch.float32"
    device = "cuda:0"
    mean = -0.000
