...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 1, 768], "L_self_modules_vit_modules_embeddings_parameters_cls_token_"),
    (
        [1, 197, 768],
    ...
    ([768], "L_self_modules_vit_modules_layernorm_parameters_bias_"),
    ([768], "L_self_modules_vit_modules_layernorm_parameters_weight_"),
