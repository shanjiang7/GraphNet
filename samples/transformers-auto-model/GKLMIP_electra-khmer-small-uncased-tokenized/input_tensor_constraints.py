...
dynamic_dim_constraint_symbol2example_value = {S0: 1, S1: 14}
...
dynamic_dim_constraint_input_shapes = [
    ...
    ([512], "L_self_modules_embeddings_project_parameters_bias_"),
    ([512, 768], "L_self_modules_embeddings_project_parameters_weight_"),
    (
        [512],
