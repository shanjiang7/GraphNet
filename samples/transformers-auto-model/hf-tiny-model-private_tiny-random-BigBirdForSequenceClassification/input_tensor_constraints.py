...
dynamic_dim_constraint_input_shapes = [
    ...
    ([S0, 11], "L_input_ids_"),
    ([1, 256], "L_self_modules_embeddings_buffers_position_ids_"),
    ...
    ([32], "L_self_modules_pooler_parameters_bias_"),
    ([32, 32], "L_self_modules_pooler_parameters_weight_"),
    ([S0, 11], "L_token_type_ids_"),
]
