...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 32], "L_self_modules_mask_decoder_modules_iou_token_parameters_weight_"),
    ([4, 32], "L_self_modules_mask_decoder_modules_mask_tokens_parameters_weight_"),
    (
        [32],
    ...
    ([8], "L_self_modules_mask_decoder_modules_upscale_conv1_parameters_bias_"),
    (
        [32, 8, 2, 2],
        "L_self_modules_mask_decoder_modules_upscale_conv1_parameters_weight_",
    ),
    ([4], "L_self_modules_mask_decoder_modules_upscale_conv2_parameters_bias_"),
    (
        [8, 4, 2, 2],
    ...
    ([8], "L_self_modules_mask_decoder_modules_upscale_layer_norm_parameters_bias_"),
    ([8], "L_self_modules_mask_decoder_modules_upscale_layer_norm_parameters_weight_"),
    ([1, 32], "L_self_modules_prompt_encoder_modules_no_mask_embed_parameters_weight_"),
    ([2, 16], "L_self_modules_shared_image_embedding_buffers_positional_embedding_"),
    (
        [96],
    ...
    ([1, 64, 64, 96], "L_self_modules_vision_encoder_parameters_pos_embed_"),
]
