...
dynamic_dim_constraint_input_shapes = [
    ([2, 10], "L_kwargs_attention_mask_"),
    ([2, 10], "L_kwargs_input_ids_"),
    ...
    ([32], "L_self_modules_text_model_modules_final_layer_norm_parameters_bias_"),
    ([32], "L_self_modules_text_model_modules_final_layer_norm_parameters_weight_"),
