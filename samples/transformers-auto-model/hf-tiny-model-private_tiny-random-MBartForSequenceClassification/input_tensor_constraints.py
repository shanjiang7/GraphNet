...
dynamic_dim_constraint_input_shapes = [
    ...
    ([S0, 15, 16], "L_encoder_hidden_states_"),
    ([S0, 15, 16], "L_inputs_embeds_"),
    ([102, 16], "L_self_modules_embed_positions_parameters_weight_"),
    ([16], "L_self_modules_layer_norm_parameters_bias_"),
    ([16], "L_self_modules_layer_norm_parameters_weight_"),
