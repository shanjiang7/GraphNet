...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_1 = key_states.view(1, 22, -1, 4)
        key_states = None
        key_states_1 = view_1.transpose(1, 2)
        view_1 = None
        view_2 = value_states.view(1, 22, -1, 4)
        value_states = None
        ...
        view_4 = key_states_2.view(1, 22, -1, 4)
        key_states_2 = None
        key_states_3 = view_4.transpose(1, 2)
        view_4 = None
        view_5 = value_states_2.view(1, 22, -1, 4)
        value_states_2 = None
        ...
        view_6 = linear_10.view(1, 22, -1, 4)
        linear_10 = None
        ...
        view_7 = key_states_4.view(1, 22, -1, 4)
        key_states_4 = None
        key_states_5 = view_7.transpose(1, 2)
        view_7 = None
        view_8 = value_states_4.view(1, 22, -1, 4)
        value_states_4 = None
        ...
        view_9 = linear_14.view(1, 22, -1, 4)
        linear_14 = None
        ...
        view_10 = key_states_6.view(1, 22, -1, 4)
        key_states_6 = None
        key_states_7 = view_10.transpose(1, 2)
        view_10 = None
        view_11 = value_states_6.view(1, 22, -1, 4)
        value_states_6 = None
