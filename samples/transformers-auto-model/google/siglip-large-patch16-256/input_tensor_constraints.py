...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1024], "L_self_modules_text_model_modules_head_parameters_bias_"),
    ([1024, 1024], "L_self_modules_text_model_modules_head_parameters_weight_"),
    ...
    ([1, 1, 1024], "L_self_modules_vision_model_modules_head_parameters_probe_"),
