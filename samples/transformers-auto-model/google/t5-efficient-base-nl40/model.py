...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        scores_79 = scores_78
        scores_78 = position_bias_1 = None
        ...
        hidden_states_322 = (
            l_self_modules_final_layer_norm_parameters_weight_ * hidden_states_321
        )
        l_self_modules_final_layer_norm_parameters_weight_ = hidden_states_321 = None
        hidden_states_323 = torch.nn.functional.dropout(
            hidden_states_322, 0.1, False, False
        )
        hidden_states_322 = None
        return (hidden_states_323,)
