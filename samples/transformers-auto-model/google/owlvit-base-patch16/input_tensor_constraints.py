...
dynamic_dim_constraint_input_shapes = [
    ...
    ([512, 512], "L_self_modules_owlvit_modules_text_projection_parameters_weight_"),
    (
        [1, 2305],
    ...
    ([512, 768], "L_self_modules_owlvit_modules_visual_projection_parameters_weight_"),
