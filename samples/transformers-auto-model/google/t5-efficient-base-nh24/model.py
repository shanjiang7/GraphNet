...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_1 = query_states.view(1, -1, 24, 64)
        query_states = None
        ...
        view_2 = key_states.view(1, -1, 24, 64)
        key_states = None
        key_states_1 = view_2.transpose(1, 2)
        view_2 = None
        view_3 = value_states.view(1, -1, 24, 64)
        value_states = None
        ...
        view_5 = query_states_2.view(1, -1, 24, 64)
        query_states_2 = None
        ...
        view_6 = key_states_2.view(1, -1, 24, 64)
        key_states_2 = None
        key_states_3 = view_6.transpose(1, 2)
        view_6 = None
        view_7 = value_states_2.view(1, -1, 24, 64)
        value_states_2 = None
        ...
        view_9 = query_states_4.view(1, -1, 24, 64)
        query_states_4 = None
        ...
        view_10 = key_states_4.view(1, -1, 24, 64)
        key_states_4 = None
        key_states_5 = view_10.transpose(1, 2)
        view_10 = None
        view_11 = value_states_4.view(1, -1, 24, 64)
        value_states_4 = None
        ...
        view_13 = query_states_6.view(1, -1, 24, 64)
        query_states_6 = None
        ...
        view_14 = key_states_6.view(1, -1, 24, 64)
        key_states_6 = None
        key_states_7 = view_14.transpose(1, 2)
        view_14 = None
        view_15 = value_states_6.view(1, -1, 24, 64)
        value_states_6 = None
        ...
        view_17 = query_states_8.view(1, -1, 24, 64)
        query_states_8 = None
        ...
        view_18 = key_states_8.view(1, -1, 24, 64)
        key_states_8 = None
        key_states_9 = view_18.transpose(1, 2)
        view_18 = None
        view_19 = value_states_8.view(1, -1, 24, 64)
        value_states_8 = None
        ...
        view_21 = query_states_10.view(1, -1, 24, 64)
        ...
        view_22 = key_states_10.view(1, -1, 24, 64)
        key_states_10 = None
        key_states_11 = view_22.transpose(1, 2)
        view_22 = None
        view_23 = value_states_10.view(1, -1, 24, 64)
        ...
        view_25 = query_states_12.view(1, -1, 24, 64)
        ...
        view_26 = key_states_12.view(1, -1, 24, 64)
        key_states_12 = None
        key_states_13 = view_26.transpose(1, 2)
        view_26 = None
        view_27 = value_states_12.view(1, -1, 24, 64)
        ...
        view_29 = query_states_14.view(1, -1, 24, 64)
        ...
        view_30 = key_states_14.view(1, -1, 24, 64)
        key_states_14 = None
        key_states_15 = view_30.transpose(1, 2)
        view_30 = None
        view_31 = value_states_14.view(1, -1, 24, 64)
        ...
        view_33 = query_states_16.view(1, -1, 24, 64)
        ...
        view_34 = key_states_16.view(1, -1, 24, 64)
        key_states_16 = None
        key_states_17 = view_34.transpose(1, 2)
        view_34 = None
        view_35 = value_states_16.view(1, -1, 24, 64)
        ...
        view_37 = query_states_18.view(1, -1, 24, 64)
        ...
        view_38 = key_states_18.view(1, -1, 24, 64)
        key_states_18 = None
        key_states_19 = view_38.transpose(1, 2)
        view_38 = None
        view_39 = value_states_18.view(1, -1, 24, 64)
        ...
        view_41 = query_states_20.view(1, -1, 24, 64)
        ...
        view_42 = key_states_20.view(1, -1, 24, 64)
        key_states_20 = None
        key_states_21 = view_42.transpose(1, 2)
        view_42 = None
        view_43 = value_states_20.view(1, -1, 24, 64)
        ...
        view_45 = query_states_22.view(1, -1, 24, 64)
        ...
        view_46 = key_states_22.view(1, -1, 24, 64)
        key_states_22 = None
        key_states_23 = view_46.transpose(1, 2)
        view_46 = None
        view_47 = value_states_22.view(1, -1, 24, 64)
