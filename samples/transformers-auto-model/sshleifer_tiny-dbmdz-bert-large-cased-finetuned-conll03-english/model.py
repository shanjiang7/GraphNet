...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        attn_output = None
        attn_output_2 = attn_output_1.reshape(1, 13, 2)
        attn_output_1 = None
        ...
        attn_output_3 = None
        attn_output_5 = attn_output_4.reshape(1, 13, 2)
        attn_output_4 = None
