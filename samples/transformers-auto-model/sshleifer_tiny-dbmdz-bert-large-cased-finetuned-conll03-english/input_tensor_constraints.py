...
dynamic_dim_constraint_input_shapes = [
    ...
    ([2], "L_self_modules_embeddings_modules_LayerNorm_parameters_bias_"),
    ([2], "L_self_modules_embeddings_modules_LayerNorm_parameters_weight_"),
    (
        [512, 2],
    ...
    ([2], "L_self_modules_pooler_modules_dense_parameters_bias_"),
    ([2, 2], "L_self_modules_pooler_modules_dense_parameters_weight_"),
