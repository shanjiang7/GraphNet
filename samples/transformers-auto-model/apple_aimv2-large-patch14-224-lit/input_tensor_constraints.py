...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1, 1, 1024], "L_self_modules_image_encoder_modules_head_parameters_cls_token_"),
    (
        [1024],
    ...
    ([768, 1024], "L_self_modules_image_projector_parameters_weight_"),
    (
        [49408, 768],
    ...
    ([768, 768], "L_self_modules_text_projector_parameters_weight_"),
    ([], "L_self_parameters_log_logit_scale_"),
]
