...
dynamic_dim_constraint_input_shapes = [
    ...
    ([2, 1024], "L_self_modules_classifier_parameters_weight_"),
    (
        [1024],
    ...
    ([1024], "L_self_modules_videomae_modules_layernorm_parameters_bias_"),
    ([1024], "L_self_modules_videomae_modules_layernorm_parameters_weight_"),
]
