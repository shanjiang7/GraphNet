...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1000, 384], "L_self_modules_classifier_parameters_weight_"),
    (
        [384],
    ...
    ([1, 1, 384], "L_self_modules_vit_modules_embeddings_parameters_cls_token_"),
    (
        [1, 197, 384],
    ...
    ([384], "L_self_modules_vit_modules_layernorm_parameters_bias_"),
    ([384], "L_self_modules_vit_modules_layernorm_parameters_weight_"),
