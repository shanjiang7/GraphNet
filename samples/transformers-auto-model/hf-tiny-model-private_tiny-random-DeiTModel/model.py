...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        L_self_modules_embeddings_parameters_distillation_token_: torch.nn.parameter.Parameter,
        ...
        l_self_modules_embeddings_parameters_distillation_token_ = (
            L_self_modules_embeddings_parameters_distillation_token_
        )
        ...
        distillation_tokens = (
            l_self_modules_embeddings_parameters_distillation_token_.expand(1, -1, -1)
        )
        l_self_modules_embeddings_parameters_distillation_token_ = None
        embeddings = torch.cat((cls_tokens, distillation_tokens, x), dim=1)
        cls_tokens = distillation_tokens = x = None
        embeddings_1 = (
            embeddings + l_self_modules_embeddings_parameters_position_embeddings_
        )
        embeddings = l_self_modules_embeddings_parameters_position_embeddings_ = None
        ...
        transpose_4 = None
        context_layer = attn_output_1.reshape((1, 227, 32))
        attn_output_1 = None
        ...
        transpose_8 = None
        context_layer_1 = attn_output_3.reshape((1, 227, 32))
        attn_output_3 = None
        ...
        transpose_12 = None
        context_layer_2 = attn_output_5.reshape((1, 227, 32))
        attn_output_5 = None
        ...
        transpose_16 = None
        context_layer_3 = attn_output_7.reshape((1, 227, 32))
        attn_output_7 = None
        ...
        transpose_20 = None
        context_layer_4 = attn_output_9.reshape((1, 227, 32))
        attn_output_9 = None
