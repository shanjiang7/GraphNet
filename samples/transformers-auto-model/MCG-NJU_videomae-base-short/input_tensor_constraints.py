...
dynamic_dim_constraint_input_shapes = [
    ...
    ([2, 768], "L_self_modules_classifier_parameters_weight_"),
    (
        [768],
    ...
    ([1, 1568, 768], "L_self_modules_videomae_modules_embeddings_position_embeddings"),
    (
        [768, 768],
    ...
    ([768], "L_self_modules_videomae_modules_layernorm_parameters_bias_"),
    ([768], "L_self_modules_videomae_modules_layernorm_parameters_weight_"),
]
