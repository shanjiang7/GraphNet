...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1000, 192], "L_self_modules_classifier_parameters_weight_"),
    (
        [192],
    ...
    ([1, 1, 192], "L_self_modules_vit_modules_embeddings_parameters_cls_token_"),
    (
        [1, 197, 192],
    ...
    ([192], "L_self_modules_vit_modules_layernorm_parameters_bias_"),
    ([192], "L_self_modules_vit_modules_layernorm_parameters_weight_"),
