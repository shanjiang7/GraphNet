...
dynamic_dim_constraint_input_shapes = [
    ...
    ([256], "L_self_modules_input_proj_modules_0_modules_0_parameters_bias_"),
    (
        [256, 512, 1, 1],
        "L_self_modules_input_proj_modules_0_modules_0_parameters_weight_",
    ),
    ([256], "L_self_modules_input_proj_modules_0_modules_1_parameters_bias_"),
    ([256], "L_self_modules_input_proj_modules_0_modules_1_parameters_weight_"),
    ([256], "L_self_modules_input_proj_modules_1_modules_0_parameters_bias_"),
    (
        [256, 1024, 1, 1],
        "L_self_modules_input_proj_modules_1_modules_0_parameters_weight_",
    ),
    ([256], "L_self_modules_input_proj_modules_1_modules_1_parameters_bias_"),
    ([256], "L_self_modules_input_proj_modules_1_modules_1_parameters_weight_"),
    ([256], "L_self_modules_input_proj_modules_2_modules_0_parameters_bias_"),
    (
        [256, 2048, 1, 1],
        "L_self_modules_input_proj_modules_2_modules_0_parameters_weight_",
    ),
    ([256], "L_self_modules_input_proj_modules_2_modules_1_parameters_bias_"),
    ([256], "L_self_modules_input_proj_modules_2_modules_1_parameters_weight_"),
    ([256], "L_self_modules_input_proj_modules_3_modules_0_parameters_bias_"),
    (
        [256, 2048, 3, 3],
        "L_self_modules_input_proj_modules_3_modules_0_parameters_weight_",
    ),
    ([256], "L_self_modules_input_proj_modules_3_modules_1_parameters_bias_"),
    ([256], "L_self_modules_input_proj_modules_3_modules_1_parameters_weight_"),
    ([300, 512], "L_self_modules_query_position_embeddings_parameters_weight_"),
    ([2], "L_self_modules_reference_points_parameters_bias_"),
    ([2, 256], "L_self_modules_reference_points_parameters_weight_"),
    ([4, 256], "L_self_parameters_level_embed_"),
]
