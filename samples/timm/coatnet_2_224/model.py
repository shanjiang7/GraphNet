...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_1 = relative_position_bias.view((196, 196, 16))
        ...
        view_28 = conv2d_101.view(1, 32, 96, -1)
        conv2d_101 = None
        ...
        view_29 = relative_position_bias_28.view((49, 49, 32))
