...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1280, 1024, 1, 1], "L_self_modules_conv_head_parameters_weight_"),
    ([128], "L_self_modules_patch_embed_modules_norm_buffers_running_mean_"),
    ([128], "L_self_modules_patch_embed_modules_norm_buffers_running_var_"),
    ([128], "L_self_modules_patch_embed_modules_norm_parameters_bias_"),
    ([128], "L_self_modules_patch_embed_modules_norm_parameters_weight_"),
    ([128, 3, 4, 4], "L_self_modules_patch_embed_modules_proj_parameters_weight_"),
    (
        [256, 128, 1, 1],
