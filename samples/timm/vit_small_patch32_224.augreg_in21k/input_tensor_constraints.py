...
dynamic_dim_constraint_input_shapes = [
    ...
    ([21843, 384], "L_self_modules_head_parameters_weight_"),
    ...
    ([384, 3, 32, 32], "L_self_modules_patch_embed_modules_proj_parameters_weight_"),
    ([1, 1, 384], "L_self_parameters_cls_token_"),
    ([1, 50, 384], "L_self_parameters_pos_embed_"),
    ([1, 3, S0, S0], "L_x_"),
]
