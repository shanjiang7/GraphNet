...
dynamic_dim_constraint_input_shapes = [
    ...
    ([384], "L_self_modules_stem_modules_conv_parameters_bias_"),
    ([384, 3, 7, 7], "L_self_modules_stem_modules_conv_parameters_weight_"),
    ([384], "L_self_modules_stem_modules_norm_parameters_bias_"),
    ([384], "L_self_modules_stem_modules_norm_parameters_weight_"),
    ([S0, 3, 224, 224], "L_x_"),
]
