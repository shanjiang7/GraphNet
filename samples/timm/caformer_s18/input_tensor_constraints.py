...
dynamic_dim_constraint_input_shapes = [
    ([2048], "L_self_modules_head_modules_fc_modules_fc1_parameters_bias_"),
    ([2048, 512], "L_self_modules_head_modules_fc_modules_fc1_parameters_weight_"),
    ([1000], "L_self_modules_head_modules_fc_modules_fc2_parameters_bias_"),
    ([1000, 2048], "L_self_modules_head_modules_fc_modules_fc2_parameters_weight_"),
    ([2048], "L_self_modules_head_modules_fc_modules_norm_parameters_bias_"),
    ([2048], "L_self_modules_head_modules_fc_modules_norm_parameters_weight_"),
