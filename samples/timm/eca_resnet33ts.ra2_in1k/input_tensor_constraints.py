...
dynamic_dim_constraint_input_shapes = [
    ([1280], "L_self_modules_final_conv_modules_bn_buffers_running_mean_"),
    ([1280], "L_self_modules_final_conv_modules_bn_buffers_running_var_"),
    ([1280], "L_self_modules_final_conv_modules_bn_parameters_bias_"),
    ([1280], "L_self_modules_final_conv_modules_bn_parameters_weight_"),
    ([1280, 1536, 1, 1], "L_self_modules_final_conv_modules_conv_parameters_weight_"),
    ...
    (
        [1, 1, 5],
        "L_self_modules_stages_modules_1_modules_2_modules_attn_modules_conv_parameters_weight_",
    ),
    (
        [128],
    ...
    (
        [1, 1, 5],
        "L_self_modules_stages_modules_2_modules_2_modules_attn_modules_conv_parameters_weight_",
    ),
    (
        [384],
