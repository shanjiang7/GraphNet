...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        split_15 = torch.functional.split(x_66, (768, 480, 288), dim=-1)
        x_66 = None
        g_15 = split_15[0]
        i_15 = split_15[1]
        c_60 = split_15[2]
        ...
        split_16 = torch.functional.split(x_69, (768, 480, 288), dim=-1)
        x_69 = None
        g_16 = split_16[0]
        i_16 = split_16[1]
        c_64 = split_16[2]
        ...
        split_17 = torch.functional.split(x_72, (768, 480, 288), dim=-1)
        x_72 = None
        g_17 = split_17[0]
        i_17 = split_17[1]
        c_68 = split_17[2]
