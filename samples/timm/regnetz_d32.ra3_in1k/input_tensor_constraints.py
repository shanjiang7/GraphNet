...
dynamic_dim_constraint_input_shapes = [
    ([1792], "L_self_modules_final_conv_modules_bn_buffers_running_mean_"),
    ([1792], "L_self_modules_final_conv_modules_bn_buffers_running_var_"),
    ([1792], "L_self_modules_final_conv_modules_bn_parameters_bias_"),
    ([1792], "L_self_modules_final_conv_modules_bn_parameters_weight_"),
    ([1792, 384, 1, 1], "L_self_modules_final_conv_modules_conv_parameters_weight_"),
    ([1000], "L_self_modules_head_modules_fc_parameters_bias_"),
    ([1000, 1792], "L_self_modules_head_modules_fc_parameters_weight_"),
    (
        [64],
