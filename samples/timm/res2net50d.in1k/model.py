...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        sp_166 = None
        avg_pool2d_5 = torch._C._nn.avg_pool2d(getitem_55, 3, 2, 1, False, True, None)
        getitem_55 = None
        out_107 = torch.cat([sp_159, sp_163, sp_167, avg_pool2d_5], 1)
        sp_159 = sp_163 = sp_167 = avg_pool2d_5 = None
        ...
        input_16 = torch._C._nn.avg_pool2d(out_103, 2, 2, 0, True, False, None)
        out_103 = None
        ...
        out_126 = None
        x_3 = torch.nn.functional.adaptive_avg_pool2d(out_127, 1)
        out_127 = None
        x_4 = x_3.flatten(1, -1)
        x_3 = None
