...
dynamic_dim_constraint_input_shapes = [
    ...
    ([48, 24, 3, 3], "L_self_modules_stem_modules_1_parameters_weight_"),
    ([48], "L_self_modules_stem_modules_2_parameters_bias_"),
    ([48], "L_self_modules_stem_modules_2_parameters_weight_"),
    ([S0, 3, S1, S1], "L_x_"),
    ([], "s1"),
]
