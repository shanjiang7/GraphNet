...
dynamic_dim_constraint_input_shapes = [
    ...
    ([224], "L_self_modules_patch_embed_modules_0_modules_proj_parameters_bias_"),
    (
        [224, 3, 12, 12],
        "L_self_modules_patch_embed_modules_0_modules_proj_parameters_weight_",
    ),
    ([448], "L_self_modules_patch_embed_modules_1_modules_proj_parameters_bias_"),
    (
        [448, 3, 16, 16],
    ...
    ([1, 401, 224], "L_self_parameters_pos_embed_0_"),
    ([1, 197, 448], "L_self_parameters_pos_embed_1_"),
    ([1, 3, S0, S0], "L_x_"),
]
