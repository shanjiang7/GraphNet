...
dynamic_dim_constraint_input_shapes = [
    ...
    ([24], "L_self_modules_stem_modules_bn_buffers_running_mean_"),
    ([24], "L_self_modules_stem_modules_bn_buffers_running_var_"),
    ([24], "L_self_modules_stem_modules_bn_parameters_bias_"),
    ([24], "L_self_modules_stem_modules_bn_parameters_weight_"),
    ([24, 3, 3, 3], "L_self_modules_stem_modules_conv_parameters_weight_"),
    ([S0, 3, S1, S1], "L_x_"),
    ([], "s1"),
]
