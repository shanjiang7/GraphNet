...
dynamic_dim_constraint_input_shapes = [
    ([2304], "L_self_modules_final_conv_parameters_bias_"),
    ([2304, 1, 1, 1], "L_self_modules_final_conv_parameters_gain_"),
    ([2304, 1536, 1, 1], "L_self_modules_final_conv_parameters_weight_"),
