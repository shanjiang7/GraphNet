...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1024], "L_self_modules_blocks_modules_12_modules_norm_buffers_running_mean_"),
    ([1024], "L_self_modules_blocks_modules_12_modules_norm_buffers_running_var_"),
    ([1024], "L_self_modules_blocks_modules_12_modules_norm_parameters_bias_"),
    ([1024], "L_self_modules_blocks_modules_12_modules_norm_parameters_weight_"),
    (
        [1024, 1, 3, 3],
