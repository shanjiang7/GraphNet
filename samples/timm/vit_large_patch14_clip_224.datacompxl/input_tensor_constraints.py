...
dynamic_dim_constraint_input_shapes = [
    ...
    ([768], "L_self_modules_head_parameters_bias_"),
    ([768, 1024], "L_self_modules_head_parameters_weight_"),
    ([1024], "L_self_modules_norm_parameters_bias_"),
    ([1024], "L_self_modules_norm_parameters_weight_"),
    ([1024], "L_self_modules_norm_pre_parameters_bias_"),
    ([1024], "L_self_modules_norm_pre_parameters_weight_"),
