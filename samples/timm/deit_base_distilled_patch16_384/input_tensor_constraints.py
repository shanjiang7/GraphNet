...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1000], "L_self_modules_head_dist_parameters_bias_"),
    ([1000, 768], "L_self_modules_head_dist_parameters_weight_"),
    ...
    ([1, 1, 768], "L_self_parameters_dist_token_"),
    ([1, 578, 768], "L_self_parameters_pos_embed_"),
    ([1, 3, S0, S0], "L_x_"),
]
