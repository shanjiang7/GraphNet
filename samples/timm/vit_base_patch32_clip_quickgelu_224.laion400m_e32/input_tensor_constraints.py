...
dynamic_dim_constraint_input_shapes = [
    ...
    ([768], "L_self_modules_norm_pre_parameters_bias_"),
    ([768], "L_self_modules_norm_pre_parameters_weight_"),
    ([768, 3, 32, 32], "L_self_modules_patch_embed_modules_proj_parameters_weight_"),
    ([1, 1, 768], "L_self_parameters_cls_token_"),
    ([1, 50, 768], "L_self_parameters_pos_embed_"),
    ([1, 3, S0, S0], "L_x_"),
]
