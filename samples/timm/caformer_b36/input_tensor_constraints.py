...
dynamic_dim_constraint_input_shapes = [
    ([3072], "L_self_modules_head_modules_fc_modules_fc1_parameters_bias_"),
    ([3072, 768], "L_self_modules_head_modules_fc_modules_fc1_parameters_weight_"),
    ([1000], "L_self_modules_head_modules_fc_modules_fc2_parameters_bias_"),
    ([1000, 3072], "L_self_modules_head_modules_fc_modules_fc2_parameters_weight_"),
    ([3072], "L_self_modules_head_modules_fc_modules_norm_parameters_bias_"),
    ([3072], "L_self_modules_head_modules_fc_modules_norm_parameters_weight_"),
