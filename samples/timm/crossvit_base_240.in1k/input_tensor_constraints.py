...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1000, 384], "L_self_modules_head_modules_0_parameters_weight_"),
    ([1000], "L_self_modules_head_modules_1_parameters_bias_"),
    ([1000, 768], "L_self_modules_head_modules_1_parameters_weight_"),
    ([384], "L_self_modules_norm_modules_0_parameters_bias_"),
    ([384], "L_self_modules_norm_modules_0_parameters_weight_"),
    ([768], "L_self_modules_norm_modules_1_parameters_bias_"),
    ([768], "L_self_modules_norm_modules_1_parameters_weight_"),
    ([384], "L_self_modules_patch_embed_modules_0_modules_proj_parameters_bias_"),
    (
        [384, 3, 12, 12],
        "L_self_modules_patch_embed_modules_0_modules_proj_parameters_weight_",
    ),
    ([768], "L_self_modules_patch_embed_modules_1_modules_proj_parameters_bias_"),
    (
        [768, 3, 16, 16],
        "L_self_modules_patch_embed_modules_1_modules_proj_parameters_weight_",
    ),
    ([1, 1, 384], "L_self_parameters_cls_token_0_"),
    ([1, 1, 768], "L_self_parameters_cls_token_1_"),
    ([1, 401, 384], "L_self_parameters_pos_embed_0_"),
    ([1, 197, 768], "L_self_parameters_pos_embed_1_"),
    ([1, 3, S0, S0], "L_x_"),
]
