...
dynamic_dim_constraint_input_shapes = [
    ...
    ([1000, 320], "L_self_modules_head_modules_fc_parameters_weight_"),
    ([320], "L_self_modules_head_modules_norm_parameters_bias_"),
    ([320], "L_self_modules_head_modules_norm_parameters_weight_"),
    (
        [40],
    ...
    ([24, 3, 3, 3], "L_self_modules_stem_modules_0_parameters_weight_"),
    ([40], "L_self_modules_stem_modules_1_parameters_bias_"),
    ([40, 24, 3, 3], "L_self_modules_stem_modules_1_parameters_weight_"),
    ([40], "L_self_modules_stem_modules_2_parameters_bias_"),
    ([40], "L_self_modules_stem_modules_2_parameters_weight_"),
    ([S0, 3, S1, S1], "L_x_"),
    ([], "s1"),
]
