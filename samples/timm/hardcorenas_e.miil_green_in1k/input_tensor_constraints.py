...
dynamic_dim_constraint_input_shapes = [
    ...
    ([160], "L_self_modules_blocks_modules_2_modules_2_modules_bn1_parameters_bias_"),
    ([160], "L_self_modules_blocks_modules_2_modules_2_modules_bn1_parameters_weight_"),
    (
        [160],
    ...
    ([160], "L_self_modules_blocks_modules_2_modules_2_modules_bn2_parameters_bias_"),
    ([160], "L_self_modules_blocks_modules_2_modules_2_modules_bn2_parameters_weight_"),
    (
        [40],
