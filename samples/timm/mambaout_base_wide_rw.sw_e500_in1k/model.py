...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        split_34 = torch.functional.split(x_154, (2304, 1152, 1152), dim=-1)
        x_154 = None
        g_34 = split_34[0]
        i_34 = split_34[1]
        c_136 = split_34[2]
        ...
        split_35 = torch.functional.split(x_158, (2304, 1152, 1152), dim=-1)
        x_158 = None
        g_35 = split_35[0]
        i_35 = split_35[1]
        c_140 = split_35[2]
        ...
        split_36 = torch.functional.split(x_162, (2304, 1152, 1152), dim=-1)
        x_162 = None
        g_36 = split_36[0]
        i_36 = split_36[1]
        c_144 = split_36[2]
