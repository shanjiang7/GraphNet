...
dynamic_dim_constraint_input_shapes = [
    ...
    ([512], "L_instance_modules_layers_modules_10_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_11_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_12_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_13_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_14_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_15_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_16_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_17_modules_conv_scale_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_layers_modules_17_modules_norm_conv_parameters_bias_"),
    (
        [512],
    ...
    ([512], "L_instance_modules_pre_encode_modules_conv_modules_2_parameters_bias_"),
    (
        [512, 1, 3, 3],
        "L_instance_modules_pre_encode_modules_conv_modules_2_parameters_weight_",
    ),
    ([512], "L_instance_modules_pre_encode_modules_conv_modules_3_parameters_bias_"),
    (
        [512, 512, 1, 1],
    ...
    ([512, 10240], "L_instance_modules_pre_encode_modules_out_parameters_weight_"),
    ([512], "L_instance_modules_pre_ln_parameters_bias_"),
    ([512], "L_instance_modules_pre_ln_parameters_weight_"),
    ([512], "L_instance_modules_time_recovery_layer_parameters_bias_"),
    ([512, 512], "L_instance_modules_time_recovery_layer_parameters_weight_"),
    ([512], "L_instance_modules_time_reduce_layer_modules_dw_conv_parameters_bias_"),
    (
        [512, 1, 5],
        "L_instance_modules_time_reduce_layer_modules_dw_conv_parameters_weight_",
    ),
    ([512], "L_instance_modules_time_reduce_layer_modules_pw_conv_parameters_bias_"),
    (
        [512, 512, 1],
