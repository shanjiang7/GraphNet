...
dynamic_dim_constraint_input_shapes = [
    ...
    ([512], "L_instance_modules_layers_modules_17_modules_norm_out_parameters_bias_"),
    ([512], "L_instance_modules_layers_modules_17_modules_norm_out_parameters_weight_"),
    (
        [512],
